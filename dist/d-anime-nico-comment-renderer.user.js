...
(function () {
  ...
  const De={debug:"debug",info:"info",warn:"warn",error:"error"},P=t=>{const e=`[${t}]`,n={};return Object.keys(De).forEach(r=>{const i=De[r];n[r]=(...s)=>{(console[i]??console.log)(e,...s);};}),n};function Ee(){return typeof unsafeWindow<"u"?unsafeWindow:window}const Ht={small:.8,medium:1,big:1.4},zt={defont:'"MS PGothic","Hiragino Kaku Gothic ProN","Hiragino Kaku Gothic Pro","Yu Gothic UI","Yu Gothic","Meiryo","Segoe UI","Osaka","Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","IPAPGothic","TakaoPGothic","Roboto","Helvetica Neue","Helvetica","Arial","sans-serif"',gothic:'"Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","Yu Gothic","Yu Gothic Medium","Meiryo","MS PGothic","Hiragino Kaku Gothic ProN","Segoe UI","Helvetica","Arial","sans-serif"',mincho:'"MS PMincho","MS Mincho","Hiragino Mincho ProN","Hiragino Mincho Pro","Yu Mincho","Noto Serif CJK JP","Noto Serif JP","Source Han Serif JP","Times New Roman","serif"'},dt={white:"#FFFFFC",red:"#FF8888",pink:"#FFA5CC",orange:"#FFBA66",yellow:"#FFFFAA",green:"#88FF88",cyan:"#88FFFF",blue:"#8899FF",purple:"#D9A5FF",black:"#444444",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},Te=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,Nt=/^[,.:;]+/,Ot=/[,.:;]+$/,$t=t=>{const e=t.trim();return e?Te.test(e)?e:e.replace(Nt,"").replace(Ot,""):""},Bt=t=>Te.test(t)?t.toUpperCase():null,ht=t=>{const e=t.trim();if(!e)return null;const n=e.toLowerCase().endsWith("px")?e.slice(0,-2):e,r=Number.parseFloat(n);return Number.isFinite(r)?r:null},Wt=t=>{const e=t.trim();if(!e)return null;if(e.endsWith("%")){const n=Number.parseFloat(e.slice(0,-1));return Number.isFinite(n)?n/100:null}return ht(e)},qt=t=>Number.isFinite(t)?Math.min(100,Math.max(-100,t)):0,Ut=t=>!Number.isFinite(t)||t===0?1:Math.min(5,Math.max(.25,t)),Gt=t=>t==="naka"||t==="ue"||t==="shita",Kt=t=>t==="small"||t==="medium"||t==="big",jt=t=>t==="defont"||t==="gothic"||t==="mincho",Yt=t=>t in dt,Xt=(t,e)=>{let n="naka",r="medium",i="defont",s=null,a=1,o=null,l=false,d=0,h=1;for(const m of t){const y=$t(typeof m=="string"?m:"");if(!y)continue;if(Te.test(y)){const b=Bt(y);if(b){s=b;continue}}const g=y.toLowerCase();if(Gt(g)){n=g;continue}if(Kt(g)){r=g;continue}if(jt(g)){i=g;continue}if(Yt(g)){s=dt[g].toUpperCase();continue}if(g==="_live"){o=.5;continue}if(g==="invisible"){a=0,l=true;continue}if(g.startsWith("ls:")||g.startsWith("letterspacing:")){const b=y.indexOf(":");if(b>=0){const x=ht(y.slice(b+1));x!==null&&(d=qt(x));}continue}if(g.startsWith("lh:")||g.startsWith("lineheight:")){const b=y.indexOf(":");if(b>=0){const x=Wt(y.slice(b+1));x!==null&&(h=Ut(x));}continue}}const c=Math.max(0,Math.min(1,a)),p=(s??e.defaultColor).toUpperCase(),u=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:n,size:r,sizeScale:Ht[r],font:i,fontFamily:zt[i],resolvedColor:p,colorOverride:s,opacityMultiplier:c,opacityOverride:u,isInvisible:l,letterSpacing:d,lineHeight:h}},Jt=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,re=t=>t.length===1?t.repeat(2):t,N=t=>Number.parseInt(t,16),q=t=>!Number.isFinite(t)||t<=0?0:t>=1?1:t,pt=(t,e)=>{const n=Jt.exec(t);if(!n)return t;const r=n[1];let i,s,a,o=1;r.length===3||r.length===4?(i=N(re(r[0])),s=N(re(r[1])),a=N(re(r[2])),r.length===4&&(o=N(re(r[3]))/255)):(i=N(r.slice(0,2)),s=N(r.slice(2,4)),a=N(r.slice(4,6)),r.length===8&&(o=N(r.slice(6,8))/255));const l=q(o*q(e));return `rgba(${i}, ${s}, ${a}, ${l})`},Zt=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),ut=()=>Zt(),F=t=>t*1e3,Qt=t=>!Number.isFinite(t)||t<0?null:Math.round(t),ke=4e3,He=1800,en=3,tn=.25,nn=32,rn=48,le=120,sn=4e3,pe=120,an=800,on=2,Q=4e3,W=4e3,D=W+ke,ln=1e3,ze=1,mt=12,gt=24,I=.001,$=50,cn=5,dn=2,Ne=8,hn=12,Oe={debug:0,info:1,warn:2,error:3},pn=(t,e,n)=>{const r=[`[${e}]`,...n];switch(t){case "debug":console.debug(...r);break;case "info":console.info(...r);break;case "warn":console.warn(...r);break;case "error":console.error(...r);break;default:console.log(...r);}},ft=(t,e={})=>{const{level:n="info",emitter:r=pn}=e,i=Oe[n],s=(a,o)=>{Oe[a]<i||r(a,t,o);};return {debug:(...a)=>s("debug",a),info:(...a)=>s("info",a),warn:(...a)=>s("warn",a),error:(...a)=>s("error",a)}},Ve=ft("CommentEngine:Comment"),$e=new WeakMap,un=t=>{let e=$e.get(t);return e||(e=new Map,$e.set(t,e)),e},_e=(t,e)=>{if(!t)return 0;const n=`${t.font??""}::${e}`,r=un(t),i=r.get(n);if(i!==void 0)return i;const s=t.measureText(e).width;return r.set(n,s),s},mn=t=>{if(t.includes(`
`)){const e=t.split(/\r?\n/);return e.length>0?e:[""]}return [t]},Be=t=>Math.max(24,t),ue=(t,e)=>{let n=0;const r=t.letterSpacing;for(const a of t.lines){const o=_e(e,a),l=a.length>1?r*(a.length-1):0,d=Math.max(0,o+l);d>n&&(n=d);}t.width=n;const i=Math.max(1,Math.floor(t.fontSize*t.lineHeightMultiplier));t.lineHeightPx=i;const s=t.lines.length>1?(t.lines.length-1)*i:0;t.height=t.fontSize+s;},gn=(t,e,n,r,i)=>{try{if(!e)throw new Error("Canvas context is required");if(!Number.isFinite(n)||!Number.isFinite(r))throw new Error("Canvas dimensions must be numbers");if(!i)throw new Error("Prepare options are required");const s=Math.max(n,1),a=Be(Math.floor(r*.05)),o=Be(Math.floor(a*t.sizeScale));t.fontSize=o,e.font=`${t.fontSize}px ${t.fontFamily}`,t.lines=mn(t.text),ue(t,e);const l=!t.isScrolling&&(t.layout==="ue"||t.layout==="shita");if(l){const L=Math.max(1,s-Ne*2);if(t.width>L){const z=Math.max(hn,Math.min(t.fontSize,Math.floor(a*.6))),he=L/Math.max(t.width,1),j=Math.max(z,Math.floor(t.fontSize*Math.min(he,1)));j<t.fontSize&&(t.fontSize=j,e.font=`${t.fontSize}px ${t.fontFamily}`,ue(t,e));let Fe=0;for(;t.width>L&&t.fontSize>z&&Fe<5;){const Dt=L/Math.max(t.width,1),Re=Math.max(z,Math.floor(t.fontSize*Math.max(Dt,.7)));Re>=t.fontSize?t.fontSize=Math.max(z,t.fontSize-1):t.fontSize=Re,e.font=`${t.fontSize}px ${t.fontFamily}`,ue(t,e),Fe+=1;}}}if(!t.isScrolling){t.bufferWidth=0;const L=l?Ne:0,z=Math.max((s-t.width)/2,L),he=Math.max(L,s-t.width-L),j=Math.min(z,Math.max(he,L));t.virtualStartX=j,t.x=j,t.baseSpeed=0,t.speed=0,t.speedPixelsPerMs=0,t.visibleDurationMs=W,t.preCollisionDurationMs=W,t.totalDurationMs=W,t.reservationWidth=t.width,t.staticExpiryTimeMs=t.vposMs+W,t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;return}t.staticExpiryTimeMs=null;const d=_e(e,"??".repeat(150)),h=t.width*Math.max(i.bufferRatio,0);t.bufferWidth=Math.max(i.baseBufferPx,h);const c=Math.max(i.entryBufferPx,t.bufferWidth),p=t.scrollDirection,u=p==="rtl"?s+i.virtualExtension:-t.width-t.bufferWidth-i.virtualExtension,m=p==="rtl"?-t.width-t.bufferWidth-c:s+c,y=p==="rtl"?s+c:-c,g=p==="rtl"?u+t.width+t.bufferWidth:u-t.bufferWidth;t.virtualStartX=u,t.x=u,t.exitThreshold=m;const b=s>0?t.width/s:0,x=i.maxVisibleDurationMs===i.minVisibleDurationMs;let k=i.maxVisibleDurationMs;if(!x&&b>1){const L=Math.min(b,i.maxWidthRatio),z=i.maxVisibleDurationMs/Math.max(L,1);k=Math.max(i.minVisibleDurationMs,Math.floor(z));}const M=s+t.width+t.bufferWidth+c,At=Math.max(k,1),de=M/At,Lt=de*1e3/60;t.baseSpeed=Lt,t.speed=t.baseSpeed,t.speedPixelsPerMs=de;const Pt=Math.abs(m-u),Ft=p==="rtl"?Math.max(0,g-y):Math.max(0,y-g),Pe=Math.max(de,Number.EPSILON);t.visibleDurationMs=k,t.preCollisionDurationMs=Math.max(0,Math.ceil(Ft/Pe)),t.totalDurationMs=Math.max(t.preCollisionDurationMs,Math.ceil(Pt/Pe));const Rt=t.width+t.bufferWidth+c;t.reservationWidth=Math.min(d,Rt),t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;}catch(s){throw Ve.error("Comment.prepare",s,{text:t.text,visibleWidth:n,canvasHeight:r,hasContext:!!e}),s}},bt=5,H={enabled:false,maxLogsPerCategory:bt},ae=new Map,fn=t=>{if(t===void 0||!Number.isFinite(t))return bt;const e=Math.max(1,Math.floor(t));return Math.min(1e4,e)},bn=t=>{H.enabled=!!t.enabled,H.maxLogsPerCategory=fn(t.maxLogsPerCategory),H.enabled||ae.clear();},O=()=>H.enabled,vn=t=>{const e=ae.get(t)??0;return e>=H.maxLogsPerCategory?(e===H.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${t}]`,"Further logs suppressed."),ae.set(t,e+1)),false):(ae.set(t,e+1),true)},T=(t,...e)=>{H.enabled&&vn(t)&&console.debug(`[CommentOverlay][${t}]`,...e);},ne=(t,e=32)=>t.length<=e?t:`${t.slice(0,e)}…`,yn=(t,e)=>{H.enabled&&(console.group(`[CommentOverlay][state-dump] ${t}`),console.table({"Current Time":`${e.currentTime.toFixed(2)}ms`,Duration:`${e.duration.toFixed(2)}ms`,"Is Playing":e.isPlaying,"Epoch ID":e.epochId,"Total Comments":e.totalComments,"Active Comments":e.activeComments,"Reserved Lanes":e.reservedLanes,"Final Phase":e.finalPhaseActive,"Playback Begun":e.playbackHasBegun,"Is Stalled":e.isStalled}),console.groupEnd());},xn=(t,e,n)=>{H.enabled&&T("epoch-change",`Epoch changed: ${t} → ${e} (reason: ${n})`);},C={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},We=()=>{if(!O())return;const t=performance.now();if(t-C.lastReported<=5e3)return;const e=C.hits+C.misses,n=e>0?C.hits/e*100:0,r=C.creates>0?(C.totalCharactersDrawn/C.creates).toFixed(1):"0",i=C.outlineCallsInCache+C.outlineCallsInFallback,s=C.fillCallsInCache+C.fillCallsInFallback;console.log("[TextureCache Stats]",`
...
`;class ce extends Ae{static FAB_HOST_ID="danime-settings-fab-host";settingsManager;fetcher;searcher;settings;currentVideoInfo;hostElement=null;activeTab="search";modalElement=null;overlayElement=null;closeButtonElement=null;fabElement=null;fabHostElement=null;fabShadowRoot=null;fabTooltipEl=null;autoSearchTooltipHtml="";handleFabClick=e=>{e.preventDefault(),this.openSettingsModal();};handleOverlayClick=()=>{this.closeSettingsModal();};handleCloseClick=()=>{this.closeSettingsModal();};constructor(e,n=new K,r=new R){super(),this.settingsManager=e,this.fetcher=n,this.searcher=r,this.settings=this.settingsManager.getSettings(),this.currentVideoInfo=this.settingsManager.loadVideoData();}insertIntoMypage(){const e=document.querySelector(E.mypageHeaderTitle);e&&(this.hostElement=this.createSettingsUI(),e.parentElement?.insertBefore(this.hostElement,e.nextSibling));}addAutoCommentButtons(){document.querySelectorAll(E.mypageItem).forEach(n=>{if(n.dataset.autoFillEnabled==="true")return;const r=n.querySelector(E.mypageItemTitle),i=n.querySelector(E.mypageEpisodeNumber),s=n.querySelector(E.mypageEpisodeTitle);if(!r||!s)return;const a=r.textContent?.trim()??"",o=i?.textContent?.trim()??"",l=s.textContent?.trim()??"";if(!a)return;const d=document.createElement("div");d.style.marginTop="8px",d.style.display="block";const h=d.attachShadow({mode:"open"}),c=document.createElement("style");c.textContent=ee.getAutoButtonStyles(),h.appendChild(c);const p=document.createElement("button");p.className="auto-comment-button",p.title="検索フォームにタイトル・話数・エピソードタイトルを入力",p.setAttribute("aria-label","検索フォームにタイトル・話数・エピソードタイトルを入力"),p.innerHTML=`
      ...
      `,p.addEventListener("click",m=>{m.preventDefault(),m.stopPropagation(),this.openSettingsModal(false),this.queryModalElement(`${S.modalTabs}[data-tab="search"]`)?.click();const g=this.queryModalElement(S.searchAnimeTitle),b=this.queryModalElement(S.searchEpisodeNumber),x=this.queryModalElement(S.searchEpisodeTitle);g&&(g.value=a),b&&o&&(b.value=o),x&&l&&(x.value=l),g?.focus({preventScroll:true});const k=[a];o&&k.push(o),l&&k.push(l),v.show(`「${k.join(" ")}」を検索フォームに入力しました`,"success");}),h.appendChild(p);const u=s.parentElement;if(u){const m=u.querySelector(".iconContainer");m?u.insertBefore(d,m):u.appendChild(d);}n.dataset.autoFillEnabled="true";});}async waitMypageListStable(){}tryRestoreByDanimeIds(){return  false}createSettingsUI(){const e=document.createElement("div");e.className="nico-comment-shadow-host settings-host",this.createShadowDOM(e),this.addStyles(ee.getCommonStyles());const n=this.buildSettingsHtml();return this.setHTML(n),this.applySettingsToUI(),this.addStyles(it),this.setupEventListeners(),e}buildSettingsHtml(){const e=a=>typeof a=="number"?a.toLocaleString():"-",n=a=>{if(!a)return "-";try{return new Date(a).toLocaleDateString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return a}},r=this.currentVideoInfo,i=r?.thumbnail??"",s=!!r?.videoId;return `
            ...
            <div class="video-card__info">
              ...
              <div class="video-card__meta-row">
                <div class="video-card__id" title="動画ID">
                  <span class="video-card__id-icon" aria-hidden="true">${ds}</span>
                  <span class="sr-only">動画ID</span>
                  <span id="currentVideoId">${r?.videoId??"未設定"}</span>
                </div>
                <div class="video-card__date" title="投稿日">
                  <span class="video-card__date-icon" aria-hidden="true">${ps}</span>
              ...
              <div class="video-card__stats">
                ...
                <div class="video-card__stat" title="マイリスト数">
                  <span class="video-card__stat-icon" aria-hidden="true">${hs}</span>
...
`)}</textarea>
    ...
    `}setupEventListeners(){this.setupModalControls(),this.setupModalTabs(),this.setupAutoSearchToggle(),this.setupNgControls(),this.setupSaveButton(),this.setupSearch(),this.setupTooltipBadges();}setupModalControls(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick);const e=this.createOrUpdateFab(),n=this.queryModalElement(S.settingsModal),r=this.queryModalElement(S.closeSettingsModal),i=this.queryModalElement(S.modalOverlay);this.modalElement=n??null,this.closeButtonElement=r??null,this.overlayElement=i??null,!(!n||!r||!i||!e)&&(this.fabElement?.removeEventListener("click",this.handleFabClick),e.addEventListener("click",this.handleFabClick),e.setAttribute("aria-controls",n.id),e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false"),this.fabElement=e,r.addEventListener("click",this.handleCloseClick),i.addEventListener("click",this.handleOverlayClick),this.shadowRoot?.addEventListener("keydown",s=>{const a=s;a.key==="Escape"&&!this.modalElement?.classList.contains("hidden")&&(a.preventDefault(),this.closeSettingsModal());}),this.applySettingsToUI());}setupModalTabs(){const e=Array.from(this.queryModalSelectorAll(S.modalTabs)),n=Array.from(this.queryModalSelectorAll(S.modalPane));if(e.length===0||n.length===0)return;const r=i=>{e.forEach(s=>{const o=this.toModalTabKey(s.dataset.tab)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-selected",String(o)),s.setAttribute("tabindex",o?"0":"-1");}),n.forEach(s=>{const o=this.toModalTabKey(s.dataset.pane)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-hidden",String(!o));}),this.activeTab=i;};e.forEach(i=>{i.addEventListener("click",()=>{const s=this.toModalTabKey(i.dataset.tab);s&&r(s);}),i.addEventListener("keydown",s=>{const a=s;if(a.key!=="ArrowRight"&&a.key!=="ArrowLeft")return;a.preventDefault();const o=this.toModalTabKey(i.dataset.tab);if(!o)return;const l=a.key==="ArrowRight"?1:-1,d=(J.indexOf(o)+l+J.length)%J.length,h=J[d];r(h),e.find(p=>this.toModalTabKey(p.dataset.tab)===h)?.focus({preventScroll:true});});}),r(this.activeTab);}openSettingsModal(e=true){!this.modalElement||!this.fabElement||(this.modalElement.classList.remove("hidden"),this.modalElement.setAttribute("aria-hidden","false"),this.fabElement.setAttribute("aria-expanded","true"),e&&this.queryModalElement(`${S.modalTabs}.is-active`)?.focus({preventScroll:true}));}closeSettingsModal(){!this.modalElement||!this.fabElement||(this.modalElement.classList.add("hidden"),this.modalElement.setAttribute("aria-hidden","true"),this.fabElement.setAttribute("aria-expanded","false"),this.fabElement?.isConnected&&this.fabElement.focus({preventScroll:true}));}toModalTabKey(e){return e&&J.includes(e)?e:null}setupAutoSearchToggle(){const e=this.queryModalElement(S.autoSearchToggle),n=this.queryModalElement(S.autoSearchOptionRow);if(!e||!n)return;const r=()=>{this.settings.autoSearchEnabled=!this.settings.autoSearchEnabled,this.updateAutoSearchToggleState(),this.updateSearchSectionNote(),this.settingsManager.updateSettings(this.settings),v.show(this.settings.autoSearchEnabled?"自動検索を有効にしました":"自動検索を無効にしました（手動設定モード）","success");};n.addEventListener("click",i=>{i.target.closest(".playback-option__toggle")||r();}),n.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r());}),e.addEventListener("change",()=>{r();}),this.updateAutoSearchToggleState();}updateAutoSearchToggleState(){const e=this.settings.autoSearchEnabled,n=this.queryModalElement(S.autoSearchToggle),r=this.queryModalElement(S.autoSearchOptionRow),i=r?.querySelector(".playback-option__icon-wrapper");n&&(n.checked=e),r&&(r.classList.toggle("playback-option--active",e),r.setAttribute("aria-pressed",e?"true":"false")),i&&i.classList.toggle("playback-option__icon-wrapper--active",e);}buildAutoSearchTooltipHtml(){return this.settings.autoSearchEnabled?`<strong style="color:#7F5AF0;">自動設定機能が有効です</strong><br>
      ...
      `,e.appendChild(r);}const n=document.createElement("div");n.className="fab-floating-tooltip",e.appendChild(n),this.fabTooltipEl=n;}showFabTooltip(e,n,r){this.ensureFabTooltip();const i=this.fabTooltipEl;if(!i)return;const s=300,a=8,o=e.getBoundingClientRect();i.innerHTML=n,i.className=`fab-floating-tooltip fab-floating-tooltip--${r}`,i.style.display="block",i.style.width=`${s}px`;let l=o.right-s;l<a&&(l=a),l+s>window.innerWidth-a&&(l=window.innerWidth-s-a),i.style.left=`${l}px`,i.style.top="0px",requestAnimationFrame(()=>{if(i.style.display==="none")return;const d=i.offsetHeight,h=o.top-a,c=window.innerHeight-o.bottom-a;let p;h>=d?p=o.top-d-a:c>=d?p=o.bottom+a:p=Math.max(a,o.top-d-a),i.style.top=`${p}px`;});}hideFabTooltip(){this.fabTooltipEl&&(this.fabTooltipEl.style.display="none");}shieldTooltipHtml="<strong>公式動画セーフガード有効</strong><br>アニメタイトルを入力すると、投稿者名が「アニメタイトル」「アニメタイトル 第Nクール」「dアニメストア ニコニコ支店」の公式動画のみが優先表示されます。エピソード切替時も公式動画のみが自動選択されます。";setupTooltipBadges(){const e=this.queryModalElement("#autoSearchInfoBadge"),n=this.queryModalElement(".shield-badge");e&&(e.addEventListener("mouseenter",()=>{this.showFabTooltip(e,this.autoSearchTooltipHtml,"info");}),e.addEventListener("mouseleave",()=>this.hideFabTooltip()),e.addEventListener("focusin",()=>{this.showFabTooltip(e,this.autoSearchTooltipHtml,"info");}),e.addEventListener("focusout",()=>this.hideFabTooltip())),n&&(n.addEventListener("mouseenter",()=>{this.showFabTooltip(n,this.shieldTooltipHtml,"shield");}),n.addEventListener("mouseleave",()=>this.hideFabTooltip()),n.addEventListener("focusin",()=>{this.showFabTooltip(n,this.shieldTooltipHtml,"shield");}),n.addEventListener("focusout",()=>this.hideFabTooltip()));}setupNgControls(){const e=this.queryModalElement(S.ngWords);e&&e.classList.remove("hidden");const n=this.queryModalElement(S.ngRegexps);n&&n.classList.remove("hidden");}setupSaveButton(){const e=this.queryModalElement(S.saveButton);e&&e.addEventListener("click",()=>this.saveSettings());}setupSearch(){const e=this.queryModalElement(S.searchInput),n=this.queryModalElement(S.searchAnimeTitle),r=this.queryModalElement(S.searchEpisodeNumber),i=this.queryModalElement(S.searchEpisodeTitle),s=this.queryModalElement(S.searchButton),a=this.queryModalElement(S.openSearchPage),o=this.queryModalElement(S.searchModeToggle),l=this.settingsManager.loadManualSearchSettings();l&&(n&&(n.value=l.animeTitle),r&&(r.value=l.episodeNumber),i&&(i.value=l.episodeTitle));const d=()=>{const g=o?.checked??false,b=this.queryModalElement("#searchModeLabelStructured"),x=this.queryModalElement("#searchModeLabelFree");b&&b.classList.toggle("search-mode-switch__label--active",!g),x&&x.classList.toggle("search-mode-switch__label--active",g);},h=()=>{const g=o?.checked??false,b=this.queryModalElement(S.searchStructuredFields),x=this.queryModalElement(S.searchFreeInputArea);b&&(b.style.display=g?"none":""),x&&(x.style.display=g?"":"none"),d();};o?.addEventListener("change",h),h();const c=()=>o?.checked??false,p=()=>{if(c())return e?.value.trim()??"";const g=n?.value.trim()??"",b=r?.value.trim()??"",x=i?.value.trim()??"";return [g,b,x].filter(Boolean).join(" ")},u=()=>{if(c())return;const g=n?.value.trim()??"",b=r?.value.trim()??"",x=i?.value.trim()??"";(g||b)&&this.settingsManager.saveManualSearchSettings({animeTitle:g,episodeNumber:b,episodeTitle:x});},m=async()=>{const g=p();if(!g){v.show("検索キーワードを入力してください","warning");return}u();const b=c()?"":n?.value.trim()??"";await this.executeSearch(g,b);};s?.addEventListener("click",m);const y=g=>{g.key==="Enter"&&m();};e?.addEventListener("keydown",y),n?.addEventListener("keydown",y),r?.addEventListener("keydown",y),i?.addEventListener("keydown",y),a?.addEventListener("click",g=>{g.preventDefault();const b=p(),x=b?Vt(b):Je.searchBase;Ee().open(x,"_blank","noopener");});}async executeSearch(e,n){try{v.show(`「${e}」を検索中...`,"info");const r=await this.searcher.search(e);let i=r;if(n){const s=R.filterOfficialVideos(r,n);s.length>0?(i=s,X.info("SettingsUI.executeSearch:officialFiltered",{totalResults:r.length,officialResults:s.length,animeTitle:n})):(X.warn("SettingsUI.executeSearch:noOfficialVideos",{totalResults:r.length,animeTitle:n}),v.show("公式動画が見つかりませんでした。全ての検索結果を表示しています。","warning"));}return this.renderSearchResults(i,s=>this.renderSearchResultItem(s)),i.length===0&&v.show("検索結果が見つかりませんでした","warning"),i}catch(r){return X.error("SettingsUI.executeSearch",r),[]}}setSearchKeyword(e){const n=this.queryModalElement(S.searchInput);n&&(n.value=e,n.focus({preventScroll:true}));}renderSearchResults(e,n){const r=this.queryModalElement(S.searchResults);if(!r)return;r.innerHTML=e.map(s=>n(s)).join(""),r.querySelectorAll(".search-result-item").forEach((s,a)=>{s.addEventListener("click",()=>{const l=e[a];this.applySearchResult(l);});const o=s.querySelector(".open-search-page-direct-btn");o&&o.addEventListener("click",l=>{l.stopPropagation();});});}renderSearchResultItem(e){const n=this.formatSearchResultDate(e.postedAt),r=typeof e.similarity=="number"?`
...
`).map(r=>r.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings);}updateCurrentVideoInfo(e){this.currentVideoInfo=e,[["currentTitle",e.title??"-"],["currentVideoId",e.videoId??"-"],["currentOwner",e.owner?.nickname??e.channel?.name??"-"],["currentViewCount",this.formatNumber(e.viewCount)],["currentCommentCount",this.formatNumber(e.commentCount)],["currentMylistCount",this.formatNumber(e.mylistCount)],["currentPostedAt",this.formatSearchResultDate(e.postedAt)]].forEach(([a,o])=>{const l=this.querySelector(S[a]);l&&(l.textContent=o);});const r=this.querySelector(S.currentThumbnail);r&&e.thumbnail&&(r.src=e.thumbnail,r.alt=e.title??"サムネイル");const i=this.querySelector("#currentVideoAmbient");i&&e.thumbnail&&(i.style.backgroundImage=`url('${e.thumbnail}')`);const s=this.querySelector(".video-card");s&&s.classList.toggle("video-card--empty",!e.videoId);try{this.settingsManager.saveVideoData(e.title??"",e);}catch(a){X.error("SettingsUI.updateCurrentVideoInfo",a);}}formatNumber(e){return typeof e=="number"?e.toLocaleString():"-"}formatSearchResultDate(e){if(!e)return "-";const n=new Date(e);return Number.isNaN(n.getTime())?e:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(n)}destroy(){this.hideFabTooltip(),this.fabTooltipEl=null,this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),super.destroy();}createOrUpdateFab(){if(!document.body)return null;let e=this.fabHostElement;!e||!e.isConnected?(e?.remove(),e=document.createElement("div"),e.id=ce.FAB_HOST_ID,e.style.position="fixed",e.style.bottom="32px",e.style.right="32px",e.style.zIndex="2147483646",e.style.display="inline-block",this.fabShadowRoot=e.attachShadow({mode:"open"}),document.body.appendChild(e),this.fabHostElement=e):this.fabShadowRoot||(this.fabShadowRoot=e.shadowRoot??e.attachShadow({mode:"open"}));const n=this.fabShadowRoot;if(!n)return null;let r=n.querySelector("style[data-role='fab-base-style']");r||(r=document.createElement("style"),r.dataset.role="fab-base-style",r.textContent=ee.getCommonStyles(),n.appendChild(r));let i=n.querySelector("style[data-role='fab-style']");i||(i=document.createElement("style"),i.dataset.role="fab-style",i.textContent=`
    ...
    `}bindPanelEvents(e){const n=e.getElementById("pcb-visibility");n?.addEventListener("change",()=>{const d=e.getElementById("pcb-vis-icon");d&&(d.innerHTML=n.checked?te:oe),this.settingsManager.updateSettings({isCommentVisible:n.checked});});const r=e.getElementById("pcb-color");r?.addEventListener("input",()=>{this.settingsManager.updateSettings({commentColor:r.value});});const i=e.getElementById("pcb-opacity"),s=e.getElementById("pcb-opacity-val");i?.addEventListener("input",()=>{const d=parseFloat(i.value);s&&(s.textContent=`${Math.round(d*100)}%`),this.settingsManager.updateSettings({commentOpacity:d});});const a=e.getElementById("pcb-speed-mode"),o=e.getElementById("pcb-speed-range"),l=e.getElementById("pcb-speed-val");a?.addEventListener("change",()=>{o&&(o.disabled=!a.checked),this.settingsManager.updatePlaybackSettings({fixedModeEnabled:a.checked});}),o?.addEventListener("input",()=>{const d=parseFloat(o.value);l&&(l.textContent=`${d.toFixed(2)}×`),this.settingsManager.updatePlaybackSettings({fixedRate:d});});}openPanel(){if(this.isOpen)return;const e=this.panelShadowRoot?.querySelector(".panel"),n=this.btnWrapper?.querySelector("button");e&&(e.removeAttribute("hidden"),n?.setAttribute("aria-expanded","true"),this.isOpen=true);}closePanel(){const e=this.panelShadowRoot?.querySelector(".panel"),n=this.btnWrapper?.querySelector("button");e?.setAttribute("hidden",""),n?.setAttribute("aria-expanded","false"),this.isOpen=false;}scheduleHide(){this.cancelHideTimer(),this.mouseHideTimer=window.setTimeout(()=>{this.closePanel();},Es);}cancelHideTimer(){this.mouseHideTimer!==null&&(window.clearTimeout(this.mouseHideTimer),this.mouseHideTimer=null);}registerObservers(){this.settingsObserver=e=>{this.syncSettingsToPanel(e);},this.settingsManager.addObserver(this.settingsObserver),this.playbackObserver=e=>{this.syncPlaybackToPanel(e);},this.settingsManager.addPlaybackObserver(this.playbackObserver);}syncSettingsToPanel(e){const n=this.panelShadowRoot;if(!n)return;const r=n.getElementById("pcb-visibility");r&&(r.checked=e.isCommentVisible);const i=n.getElementById("pcb-vis-icon");i&&(i.innerHTML=e.isCommentVisible?te:oe);const s=n.getElementById("pcb-color");s&&(s.value=e.commentColor);const a=n.getElementById("pcb-opacity"),o=n.getElementById("pcb-opacity-val");a&&(a.value=String(e.commentOpacity??1)),o&&(o.textContent=`${Math.round((e.commentOpacity??1)*100)}%`);}syncPlaybackToPanel(e){const n=this.panelShadowRoot;if(!n)return;const r=n.getElementById("pcb-speed-mode");r&&(r.checked=e.fixedModeEnabled);const i=n.getElementById("pcb-speed-range");i&&(i.disabled=!e.fixedModeEnabled,i.value=e.fixedRate.toFixed(2));const s=n.getElementById("pcb-speed-val");s&&(s.textContent=`${e.fixedRate.toFixed(2)}×`);}}const ks=100,Vs=1e3,lt=3e3,_s=2e3,ct="cachedAnimeTitle",f=P("dAnime:WatchPageController");class Is{constructor(e){this.global=e;try{this.cachedAnimeTitle=U(ct,null),this.cachedAnimeTitle&&f.info("watchPageController:constructor:loadedCachedTitle",{cachedAnimeTitle:this.cachedAnimeTitle});}catch(n){f.error("watchPageController:constructor:loadCacheFailed",n),this.cachedAnimeTitle=null;}}initialized=false;switchDebounce=new Le(Vs);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;playbackRateController=null;playerControlButton=null;lastPartId=null;partIdMonitorIntervalId=null;isPartIdChanging=false;cachedAnimeTitle=null;lastEpisodeNumber=null;async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement();}async ensureDocumentReady(){document.readyState!=="complete"&&await new Promise(e=>{window.addEventListener("load",()=>e(),{once:true});});}waitForVideoElement(){if(this.initialized)return;const e=document.querySelector(E.watchVideoElement);if(!e){window.setTimeout(()=>this.waitForVideoElement(),ks);return}if(e.readyState===0){e.addEventListener("loadedmetadata",()=>{this.initializeWithVideo(e);},{once:true});return}this.initializeWithVideo(e);}async initializeWithVideo(e){if(!this.initialized){this.initialized=true;try{v.show("コメントローダーを初期化中...");const n=v.getInstance(),r=this.global.settingsManager??new Ie(n);this.global.settingsManager=r,this.global.instances.settingsManager=r,this.playerControlButton||(this.playerControlButton=new Ts(r),this.playerControlButton.mount());const i=r.loadSettings();if(!i.isCommentVisible){f.info("watchPageController:initializeWithVideo:skipDueToVisibility",{isCommentVisible:i.isCommentVisible}),v.show("コメントは非表示に設定されています。設定を変更するにはフローティングボタンをクリックしてください。","info");return}if(!i.autoSearchEnabled){f.info("watchPageController:initializeWithVideo:manualMode",{autoSearchEnabled:i.autoSearchEnabled});const u=r.loadVideoData();if(!u?.videoId){v.show("手動設定モードです。フローティングボタンから検索タブを開いて動画を選択してください。","info");return}f.info("watchPageController:initializeWithVideo:manualMode:loadSavedVideo",{videoId:u.videoId,title:u.title}),await this.loadCommentsFromSavedVideo(e,r,u);return}if(await this.waitForMetadataElements(),!await this.autoSetupComments(r))throw new Error("視聴ページからの自動取得に失敗しました。メタデータが取得できませんでした。");const a=r.loadVideoData();if(!a?.videoId)throw new Error("動画データが見つかりません。");const o=new K;this.global.instances.fetcher=o,await o.fetchApiData(a.videoId);const l=await o.fetchComments(),d=this.mergeSettings(r.loadSettings()),h=new Z(d);h.initialize(e),this.global.instances.renderer=h,this.currentVideoElement=e;const c=this.playbackRateController??new Me(r);this.playbackRateController=c,this.global.instances.playbackRateController=c,c.bind(e),r.addObserver(u=>{const m=this.mergeSettings(u);h.settings.isCommentVisible!==m.isCommentVisible&&h.setCommentVisibility(m.isCommentVisible),h.settings=m;}),l.forEach(u=>{h.addComment(u.text,u.vposMs,u.commands);});const p=new xe(h,o,r);p.startMonitoring(),this.global.instances.switchHandler=p,this.setupSwitchHandling(e,p),this.observeVideoElement(),this.startPartIdMonitoring(),v.show(`コメントの読み込みが完了しました（${l.length}件）`,"success");}catch(n){throw this.initialized=false,v.show(`初期化エラー: ${n.message}`,"error"),n}}}mergeSettings(e){const n=B();return {...n,...e,ngWords:[...e.ngWords??n.ngWords],ngRegexps:[...e.ngRegexps??n.ngRegexps]}}setupSwitchHandling(e,n){this.currentVideoElement=e,this.switchCallback=()=>{if(this.isPartIdChanging){f.info("watchPageController:switchBlocked",{reason:"partId change in progress"});return}const r=Date.now();if(r-this.lastSwitchTimestamp<lt){f.debug("watchPageController:switchCooldown",{timeSinceLastSwitch:r-this.lastSwitchTimestamp,cooldownMs:lt});return}this.lastSwitchTimestamp=r;const i=this.currentVideoElement;f.info("watchPageController:switchHandlerTriggered",{currentTime:i?.currentTime??null,duration:i?.duration??null}),n.onVideoSwitch(i);},this.global.utils.initializeWithVideo=async r=>{r&&(this.rebindVideoElement(r),this.playbackRateController?.bind(r),await n.onVideoSwitch(r));},this.currentVideoElement=e;}observeVideoElement(){const e=this.currentVideoElement;e&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{const n=document.querySelector(E.watchVideoElement);!n||n===this.currentVideoElement||this.rebindVideoElement(n);}),this.domMutationObserver.observe(document.body,{childList:true,subtree:true}),this.attachVideoEventListeners(e));}rebindVideoElement(e){this.detachVideoEventListeners(),this.currentVideoElement=e;const n=this.global.instances.renderer,r=this.global.instances.switchHandler;n&&(n.clearComments(),n.destroy(),n.initialize(e),n.resize()),this.playbackRateController?.bind(e),r&&(r.onVideoSwitch(e),this.setupSwitchHandling(e,r)),this.attachVideoEventListeners(e);}attachVideoEventListeners(e){this.detachVideoEventListeners(),Qe().attach(e);const r=()=>{this.switchCallback&&(f.info("watchPageController:eventTriggered",{currentTime:e.currentTime,duration:e.duration,ended:e.ended,paused:e.paused}),this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));};e.addEventListener("ended",r),e.addEventListener("loadedmetadata",r),e.addEventListener("emptied",r),this.videoEndedListener=r;}detachVideoEventListeners(){const e=this.currentVideoElement;Qe().detach(),e&&this.videoEndedListener&&(e.removeEventListener("ended",this.videoEndedListener),e.removeEventListener("loadedmetadata",this.videoEndedListener),e.removeEventListener("emptied",this.videoEndedListener)),this.videoEndedListener=null;}async waitForMetadataElements(e,n){const s=Date.now();for(let l=0;l<50;l++){const d=this.getCurrentPartId(),h=document.querySelector(E.watchPageAnimeTitle),c=document.querySelector(E.watchPageEpisodeNumber),p=document.querySelector(E.watchPageEpisodeTitle),u=h?.textContent?.trim()??"",m=c?.textContent?.trim()??"",y=p?.textContent?.trim()??"";if(l===0&&f.info("watchPageController:waitForMetadata:start",{currentPartId:d,expectedPartId:e,episodeNumber:m,episodeTitle:y,animeTitle:u||"(empty)",cachedAnimeTitle:this.cachedAnimeTitle||"(empty)",previousEpisodeNumber:n||"(none)"}),!e&&!this.cachedAnimeTitle&&l<20&&!u){await new Promise(M=>window.setTimeout(M,100));continue}if((!e||d===e)&&(m&&y)&&(!n||m!==n)){f.info("watchPageController:waitForMetadata:success",{attempts:l+1,waited:Date.now()-s,currentPartId:d,expectedPartId:e,episodeNumber:m,episodeTitle:y,animeTitle:u||"(empty)",previousEpisodeNumber:n||"(none)"});return}await new Promise(M=>window.setTimeout(M,100));}const a=document.querySelector(E.watchPageEpisodeNumber)?.textContent?.trim()??"",o=document.querySelector(E.watchPageEpisodeTitle)?.textContent?.trim()??"";throw f.error("watchPageController:waitForMetadata:timeout",{maxRetries:50,waited:Date.now()-s,currentPartId:this.getCurrentPartId(),expectedPartId:e,previousEpisodeNumber:n||"(none)",finalEpisodeNumber:a,finalEpisodeTitle:o}),new Error(`DOM更新のタイムアウト: partId=${e}, 前回エピソード="${n||"なし"}", 現在エピソード="${a}"`)}extractMetadataFromPage(){try{const e=document.querySelector(E.watchPageAnimeTitle),n=document.querySelector(E.watchPageEpisodeNumber),r=document.querySelector(E.watchPageEpisodeTitle);let i=e?.textContent?.trim()??"";const s=n?.textContent?.trim()??"",a=r?.textContent?.trim()??"";if(i){this.cachedAnimeTitle=i;try{G(ct,i),f.info("watchPageController:extractMetadata:cachedTitle",{animeTitle:i});}catch(o){f.error("watchPageController:extractMetadata:saveCacheFailed",o);}}else this.cachedAnimeTitle&&(i=this.cachedAnimeTitle,f.info("watchPageController:extractMetadata:usedCachedTitle",{cachedAnimeTitle:this.cachedAnimeTitle}));return f.info("watchPageController:extractMetadata:rawValues",{animeTitle:i||"(empty)",animeTitleElementExists:!!e,animeTitleFromCache:!e&&!!this.cachedAnimeTitle,episodeNumber:s,episodeNumberElementExists:!!n,episodeTitle:a,episodeTitleElementExists:!!r,currentPartId:this.getCurrentPartId()}),s?(i||f.warn("watchPageController:extractMetadata:noAnimeTitle",{hasCache:!!this.cachedAnimeTitle}),this.lastEpisodeNumber=s,{animeTitle:i,episodeNumber:s,episodeTitle:a}):(f.warn("watchPageController:extractMetadata:insufficient",{episodeNumber:s||"(empty)",episodeTitle:a||"(empty)"}),null)}catch(e){return f.error("watchPageController:extractMetadata:error",e),null}}async autoSetupComments(e){try{const n=this.extractMetadataFromPage();if(!n)return f.warn("watchPageController:autoSetup:noMetadata"),!1;if(!n.animeTitle)return f.warn("watchPageController:autoSetup:noAnimeTitle",{episodeNumber:n.episodeNumber,episodeTitle:n.episodeTitle,cachedAnimeTitle:this.cachedAnimeTitle}),v.show("アニメタイトルが取得できませんでした。検索精度が低下する可能性があります。","warning"),!1;const r=[n.animeTitle,n.episodeNumber,n.episodeTitle].filter(Boolean).join(" ");f.info("watchPageController:autoSetup",{keyword:r,animeTitle:n.animeTitle,episodeNumber:n.episodeNumber,episodeTitle:n.episodeTitle,usingCachedTitle:!!this.cachedAnimeTitle&&!n.animeTitle}),v.show(`「${r}」を検索中...`,"info");const s=await new R().search(r);if(s.length===0)return v.show("ニコニコ動画が見つかりませんでした","warning"),!1;const a=R.filterOfficialVideos(s,n.animeTitle);f.info("watchPageController:autoSetup:officialFilter",{totalResults:s.length,officialResults:a.length,animeTitle:n.animeTitle}),a.length===0&&(f.warn("watchPageController:autoSetup:noOfficialVideos",{animeTitle:n.animeTitle,firstResultOwner:s[0]?.owner?.nickname??s[0]?.channel?.name??"不明"}),v.show("公式動画が見つかりませんでした。検索結果の最初の動画を使用します。","warning"));const o=a.length>0?a[0]:s[0],d=await new K().fetchApiData(o.videoId),h={videoId:o.videoId,title:o.title,viewCount:d.video?.count?.view??o.viewCount,commentCount:d.video?.count?.comment??o.commentCount,mylistCount:d.video?.count?.mylist??o.mylistCount,postedAt:d.video?.registeredAt??o.postedAt,thumbnail:d.video?.thumbnail?.url??o.thumbnail,owner:d.owner??o.owner??null,channel:d.channel??o.channel??null};if(e.saveVideoData(o.title,h)){f.info("watchPageController:autoSetup:success",{videoId:o.videoId,title:o.title,commentCount:o.commentCount});const p=o.owner?.nickname||o.channel?.name||"不明",u=['<div style="font-weight: 600; margin-bottom: 8px;">ニコニコ動画を自動設定しました</div>','<div style="display: flex; align-items: center; gap: 6px; margin-top: 8px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${rt}</span>`,`  <span style="flex: 1; word-break: break-word;">${o.title}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 6px; margin-top: 4px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${we}</span>`,`  <span>${p}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">','  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Se}</span>`,`    <span>${o.viewCount.toLocaleString()}</span>`,"  </div>",'  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Ce}</span>`,`    <span>${o.commentCount.toLocaleString()}</span>`,"  </div>","</div>"].join("");return v.show(u,"success",5e3),!0}return !1}catch(n){return f.error("watchPageController:autoSetup:error",n),v.show(`自動設定エラー: ${n.message}`,"error"),false}}getCurrentPartId(){try{return new URLSearchParams(window.location.search).get("partId")}catch(e){return f.error("watchPageController:getCurrentPartId:error",e),null}}startPartIdMonitoring(){this.stopPartIdMonitoring(),this.lastPartId=this.getCurrentPartId(),this.partIdMonitorIntervalId=window.setInterval(()=>{this.checkPartIdChange();},_s);}stopPartIdMonitoring(){this.partIdMonitorIntervalId!==null&&(window.clearInterval(this.partIdMonitorIntervalId),this.partIdMonitorIntervalId=null);}async checkPartIdChange(){const e=this.getCurrentPartId();e===null||e===this.lastPartId||(f.warn("watchPageController:partIdChanged",{oldPartId:this.lastPartId,newPartId:e,url:window.location.href,timestamp:new Date().toISOString()}),this.lastPartId=e,await this.onPartIdChanged());}async waitForVideoReady(e){const i=Date.now();for(f.info("watchPageController:waitForVideoReady:start",{readyState:e.readyState,duration:e.duration,src:e.currentSrc});e.readyState<2&&Date.now()-i<5e3;)await new Promise(s=>window.setTimeout(s,100));f.info("watchPageController:waitForVideoReady:complete",{readyState:e.readyState,duration:e.duration,waited:Date.now()-i});}async onPartIdChanged(){this.isPartIdChanging=true;try{const e=this.global.settingsManager;if(!e){f.warn("watchPageController:onPartIdChanged:noSettingsManager");return}const n=e.getSettings();if(!n.isCommentVisible){f.info("watchPageController:onPartIdChanged:skipDueToVisibility",{isCommentVisible:n.isCommentVisible}),v.show("コメント非表示設定のためスキップしました","info");return}const r=this.lastEpisodeNumber??document.querySelector(E.watchPageEpisodeNumber)?.textContent?.trim()??null;if(!n.autoSearchEnabled){f.info("watchPageController:onPartIdChanged:manualMode",{autoSearchEnabled:n.autoSearchEnabled});const a=e.loadManualSearchSettings();if(!a?.animeTitle){v.show("手動設定モードです。フローティングボタンから検索タブを開いてアニメタイトルを設定してください。","info");const o=this.global.instances.renderer;o&&o.clearComments();return}await this.handleManualModeEpisodeSwitch(e,a.animeTitle,r);return}f.info("watchPageController:onPartIdChanged:start",{currentVideoElement:this.currentVideoElement?"present":"null",rendererExists:!!this.global.instances.renderer,switchHandlerExists:!!this.global.instances.switchHandler,isPartIdChanging:this.isPartIdChanging,newPartId:this.getCurrentPartId(),previousEpisodeNumber:r}),v.show("エピソード切り替えを検知しました...","info");const i=this.getCurrentPartId();f.info("watchPageController:onPartIdChanged:waitingForDomUpdate",{newPartId:i,previousEpisodeNumber:r});try{await this.waitForMetadataElements(i??void 0,r??void 0);}catch(a){f.error("watchPageController:onPartIdChanged:waitMetadataFailed",a),v.show(`DOM更新の待機に失敗しました: ${a.message}`,"error");return}const s=await this.autoSetupComments(e);if(f.info("watchPageController:onPartIdChanged:autoSetup",{success:s}),s){const a=e.loadVideoData();f.warn("watchPageController:onPartIdChanged:loadedVideoData",{videoId:a?.videoId??null,title:a?.title??null});const o=this.currentVideoElement??document.querySelector(E.watchVideoElement);if(f.warn("watchPageController:onPartIdChanged:videoElement",{videoElementFound:!!o,currentTime:o?.currentTime??null,duration:o?.duration??null,src:o?.currentSrc??null,readyState:o?.readyState??null}),o&&a?.videoId){await this.waitForVideoReady(o),o.dataset.videoId=a.videoId;const l=this.global.instances.renderer,d=this.global.instances.switchHandler;if(f.warn("watchPageController:onPartIdChanged:beforeSwitch",{rendererCommentCount:l?.getCommentsSnapshot().length??0,videoCurrentTime:o.currentTime,videoReadyState:o.readyState,videoSrc:o.currentSrc,videoId:a.videoId}),l&&d){f.warn("watchPageController:onPartIdChanged:destroyBefore",{commentsBeforeDestroy:l.getCommentsSnapshot().length,currentVideoSrc:l.getCurrentVideoSource(),videoElement:l.getVideoElement()?"attached":"detached"});const h=l.settings;l.destroy(),f.warn("watchPageController:onPartIdChanged:createNew",{savedSettings:h});const c=new Z(h,{loggerNamespace:"dAnime:CommentRenderer"});this.global.instances.renderer=c,f.warn("watchPageController:onPartIdChanged:reinitialize",{videoElementSrc:o.currentSrc,videoElementReadyState:o.readyState,videoElementCurrentTime:o.currentTime}),c.initialize(o),f.warn("watchPageController:onPartIdChanged:reinitializeComplete",{commentsAfterReinitialize:c.getCommentsSnapshot().length,newVideoSrc:c.getCurrentVideoSource()}),d.updateRenderer(c),d.resetVideoSource(),await d.onVideoSwitch(o),f.warn("watchPageController:onPartIdChanged:afterSwitch",{rendererCommentCount:c.getCommentsSnapshot().length,videoCurrentTime:o.currentTime,finalVideoSrc:c.getCurrentVideoSource()});}}}f.info("watchPageController:onPartIdChanged:complete");}catch(e){f.error("watchPageController:onPartIdChanged:error",e),v.show(`エピソード切り替えエラー: ${e.message}`,"error");}finally{this.isPartIdChanging=false,f.info("watchPageController:onPartIdChanged:flagReset",{isPartIdChanging:this.isPartIdChanging});}}async loadCommentsFromSavedVideo(e,n,r){try{const i=new K;this.global.instances.fetcher=i,await i.fetchApiData(r.videoId);const s=await i.fetchComments(),a=this.mergeSettings(n.loadSettings()),o=new Z(a);o.initialize(e),this.global.instances.renderer=o,this.currentVideoElement=e;const l=this.playbackRateController??new Me(n);this.playbackRateController=l,this.global.instances.playbackRateController=l,l.bind(e),n.addObserver(h=>{const c=this.mergeSettings(h);o.settings.isCommentVisible!==c.isCommentVisible&&o.setCommentVisibility(c.isCommentVisible),o.settings=c;}),s.forEach(h=>{o.addComment(h.text,h.vposMs,h.commands);});const d=new xe(o,i,n);d.startMonitoring(),this.global.instances.switchHandler=d,this.setupSwitchHandling(e,d),this.observeVideoElement(),this.startPartIdMonitoring(),v.show(`【手動設定モード】コメントの読み込みが完了しました（${s.length}件）
動画: ${r.title}`,"success");}catch(i){f.error("watchPageController:loadCommentsFromSavedVideo:error",i),v.show(`コメント読み込みエラー: ${i.message}
フローティングボタンから別の動画を選択してください。`,"error");}}async handleManualModeEpisodeSwitch(e,n,r){try{const i=this.getCurrentPartId();f.info("watchPageController:manualModeSwitch:waitingForDomUpdate",{newPartId:i,previousEpisodeNumber:r,savedAnimeTitle:n});try{await this.waitForMetadataElements(i??void 0,r??void 0);}catch(b){f.error("watchPageController:manualModeSwitch:waitMetadataFailed",b),v.show(`DOM更新の待機に失敗しました: ${b.message}`,"error");return}const s=document.querySelector(E.watchPageEpisodeNumber)?.textContent?.trim()??"";if(!s){f.warn("watchPageController:manualModeSwitch:noEpisodeNumber"),v.show("エピソード話数を取得できませんでした","warning");return}const a=`${n} ${s}`;f.info("watchPageController:manualModeSwitch:search",{keyword:a,savedAnimeTitle:n,newEpisodeNumber:s}),v.show(`「${a}」を検索中...`,"info");const l=await new R().search(a);if(l.length===0){v.show("ニコニコ動画が見つかりませんでした。手動で検索してください。","warning");const b=this.global.instances.renderer;b&&b.clearComments();return}const d=R.filterOfficialVideos(l,n);if(f.info("watchPageController:manualModeSwitch:officialFilter",{totalResults:l.length,officialResults:d.length,savedAnimeTitle:n}),d.length===0){v.show("公式動画が見つかりませんでした。手動で検索してください。","warning");const b=this.global.instances.renderer;b&&b.clearComments();return}const h=d[0],p=await new K().fetchApiData(h.videoId),u={videoId:h.videoId,title:h.title,viewCount:p.video?.count?.view??h.viewCount,commentCount:p.video?.count?.comment??h.commentCount,mylistCount:p.video?.count?.mylist??h.mylistCount,postedAt:p.video?.registeredAt??h.postedAt,thumbnail:p.video?.thumbnail?.url??h.thumbnail,owner:p.owner??h.owner??null,channel:p.channel??h.channel??null};e.saveVideoData(h.title,u),e.saveManualSearchSettings({animeTitle:n,episodeNumber:s,episodeTitle:""});const m=this.currentVideoElement??document.querySelector(E.watchVideoElement);if(m){await this.waitForVideoReady(m),m.dataset.videoId=h.videoId;const b=this.global.instances.renderer,x=this.global.instances.switchHandler;if(b&&x){const k=b.settings;b.destroy();const M=new Z(k,{loggerNamespace:"dAnime:CommentRenderer"});this.global.instances.renderer=M,M.initialize(m),x.updateRenderer(M),x.resetVideoSource(),await x.onVideoSwitch(m);}}const y=h.owner?.nickname??h.channel?.name??"不明",g=['<div style="font-weight: 600; margin-bottom: 8px;">次のエピソードを自動設定しました</div>','<div style="display: flex; align-items: center; gap: 6px; margin-top: 8px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${rt}</span>`,`  <span style="flex: 1; word-break: break-word;">${h.title}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 6px; margin-top: 4px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${we}</span>`,`  <span>${y}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">','  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Se}</span>`,`    <span>${h.viewCount.toLocaleString()}</span>`,"  </div>",'  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Ce}</span>`,`    <span>${h.commentCount.toLocaleString()}</span>`,"  </div>","</div>"].join("");v.show(g,"success",5e3),f.info("watchPageController:manualModeSwitch:success",{videoId:h.videoId,title:h.title,commentCount:h.commentCount});}catch(i){f.error("watchPageController:manualModeSwitch:error",i),v.show(`エピソード切り替えエラー: ${i.message}`,"error");}}}const As=100;class Ls{constructor(e){this.global=e;}initialize(){const e=v.getInstance(),n=this.global.settingsManager??new Ie(e);this.global.settingsManager=n,this.global.instances.settingsManager=n;const r=new ce(n);this.waitForHeader(r);}waitForHeader(e){if(!document.querySelector(E.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(e),As);return}e.insertIntoMypage(),e.addAutoCommentButtons(),this.observeList(e);}observeList(e){const n=document.querySelector(E.mypageListContainer);if(!n)return;new MutationObserver(()=>{try{e.addAutoCommentButtons();}catch(i){console.error("[MypageController] auto comment buttons update failed",i);}}).observe(n,{childList:true,subtree:true});}}class Ps{log;global=Cs();watchController=null;mypageController=null;constructor(){this.log=P("DanimeApp");}start(){this.log.info("starting renderer"),It.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener("load",()=>{this.initialize();});}async initialize(){if(!this.acquireInstanceLock()){this.log.info("renderer already initialized, skipping");return}const e=location.pathname.toLowerCase();try{e.includes("/animestore/sc_d_pc")?(this.watchController=new Is(this.global),await this.watchController.initialize()):e.includes("/animestore/mp_viw_pc")?(this.mypageController=new Ls(this.global),this.mypageController.initialize()):this.log.info("page not supported, initialization skipped");}catch(n){this.log.error("initialization failed",n);}}acquireInstanceLock(){const e=Ee();return e.__dAnimeNicoCommentRenderer2Instance=(e.__dAnimeNicoCommentRenderer2Instance??0)+1,e.__dAnimeNicoCommentRenderer2Instance===1}}const ve=P("dAnimeNicoCommentRenderer2");async function Fs(){ve.info("bootstrap start");try{new Ps().start(),ve.info("bootstrap completed");}catch(t){ve.error("bootstrap failed",t);}}Fs();
