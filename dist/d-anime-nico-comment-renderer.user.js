...
(function(){"use strict";var e={debug:`debug`,info:`info`,warn:`warn`,error:`error`},t={debug:10,info:20,warn:30,error:40},n=e=>t[e]>=t.warn,r=t=>{let r=`[${t}]`,i={};return Object.keys(e).forEach(a=>{let o=e[a];i[a]=(...e)=>{n(a,t)&&(console[o]??console.log)(r,...e)}}),i};function i(){return typeof unsafeWindow<`u`?unsafeWindow:window}var a={small:.6666666666666666,medium:1,big:1.4444444444444444},o={defont:`Arial,"ＭＳ Ｐゴシック","MS PGothic",MSPGothic,MS-PGothic`,gothic:`"游ゴシック体","游ゴシック","Yu Gothic",YuGothic,yugothic,YuGo-Medium,"宋体",SimSun,Arial,"ＭＳ Ｐゴシック","MS PGothic",MSPGothic,MS-PGothic`,mincho:`"游明朝体","游明朝","Yu Mincho",YuMincho,yumincho,YuMin-Medium,"宋体",SimSun,Arial,"ＭＳ Ｐゴシック","MS PGothic",MSPGothic,MS-PGothic`},s={defont:`600`,gothic:``,mincho:``},c={white:`#FFFFFF`,red:`#FF0000`,pink:`#FFA5CC`,orange:`#FFBA66`,yellow:`#FFFFAA`,green:`#00FF00`,cyan:`#88FFFF`,blue:`#8899FF`,purple:`#D9A5FF`,black:`#000000`,white2:`#CC9`,red2:`#C03`,pink2:`#F3C`,orange2:`#F60`,yellow2:`#990`,green2:`#0C6`,cyan2:`#0CC`,blue2:`#39F`,purple2:`#63C`,black2:`#666`},l=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,u=/^[,.:;]+/,d=/[,.:;]+$/,f=e=>{let t=e.trim();return t?l.test(t)?t:t.replace(u,``).replace(d,``):``},p=e=>l.test(e)?e.toUpperCase():null,m=e=>{let t=e.trim();if(!t)return null;let n=t.toLowerCase().endsWith(`px`)?t.slice(0,-2):t,r=Number.parseFloat(n);return Number.isFinite(r)?r:null},h=e=>{let t=e.trim();if(!t)return null;if(t.endsWith(`%`)){let e=Number.parseFloat(t.slice(0,-1));return Number.isFinite(e)?e/100:null}return m(t)},g=e=>Number.isFinite(e)?Math.min(100,Math.max(-100,e)):0,_=e=>!Number.isFinite(e)||e===0?1:Math.min(5,Math.max(.25,e)),v=e=>e===`naka`||e===`ue`||e===`shita`,ee=e=>e===`small`||e===`medium`||e===`big`,te=e=>e===`defont`||e===`gothic`||e===`mincho`,ne=e=>e in c,re=(e,t)=>{let n=`naka`,r=`medium`,i=`defont`,u=null,d=1,re=null,ie=!1,y=!1,b=!1,x=0,ae=1;for(let t of e){let e=f(typeof t==`string`?t:``);if(!e)continue;if(l.test(e)){let t=p(e);if(t){u=t;continue}}let a=e.toLowerCase();if(v(a)){n=a;continue}if(ee(a)){r=a;continue}if(te(a)){i=a;continue}if(ne(a)){u=c[a].toUpperCase();continue}if(a===`_live`){re=.5;continue}if(a===`invisible`){d=0,ie=!0;continue}if(a===`full`){y=!0;continue}if(a===`ender`){b=!0;continue}if(a.startsWith(`ls:`)||a.startsWith(`letterspacing:`)){let t=e.indexOf(`:`);if(t>=0){let n=m(e.slice(t+1));n!==null&&(x=g(n))}continue}if(a.startsWith(`lh:`)||a.startsWith(`lineheight:`)){let t=e.indexOf(`:`);if(t>=0){let n=h(e.slice(t+1));n!==null&&(ae=_(n))}continue}}let oe=Math.max(0,Math.min(1,d)),se=(u??t.defaultColor).toUpperCase(),S=typeof re==`number`?Math.max(0,Math.min(1,re)):null;return{layout:n,size:r,sizeScale:a[r],font:i,fontFamily:o[i],fontWeight:s[i],resolvedColor:se,colorOverride:u,opacityMultiplier:oe,opacityOverride:S,isInvisible:ie,isFull:y,isEnder:b,letterSpacing:x,lineHeight:ae}},ie=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,y=e=>e.length===1?e.repeat(2):e,b=e=>Number.parseInt(e,16),x=e=>!Number.isFinite(e)||e<=0?0:e>=1?1:e,ae=(e,t)=>{let n=ie.exec(e);if(!n)return e;let r=n[1],i,a,o,s=1;r.length===3||r.length===4?(i=b(y(r[0])),a=b(y(r[1])),o=b(y(r[2])),r.length===4&&(s=b(y(r[3]))/255)):(i=b(r.slice(0,2)),a=b(r.slice(2,4)),o=b(r.slice(4,6)),r.length===8&&(s=b(r.slice(6,8))/255));let c=x(s*x(t));return`rgba(${i}, ${a}, ${o}, ${c})`},oe=()=>({now:()=>typeof performance<`u`&&typeof performance.now==`function`?performance.now():Date.now()}),se=()=>oe(),S=e=>e*1e3,ce=e=>!Number.isFinite(e)||e<0?null:Math.round(e),le=6e3,ue=2700,de=3,fe=.35,pe=48,me=48,he=0,C=3e3,w=9e3,ge=240,_e=1,ve=12,T=.001,E=50,ye={debug:0,info:1,warn:2,error:3},be=(e,t,n)=>{let r=[`[${t}]`,...n];switch(e){case`debug`:console.debug(...r);break;case`info`:console.info(...r);break;case`warn`:console.warn(...r);break;case`error`:console.error(...r);break;default:console.log(...r)}},xe=(e,t={})=>{let{level:n=`info`,emitter:r=be}=t,i=ye[n],a=(t,n)=>{ye[t]<i||r(t,e,n)};return{debug:(...e)=>a(`debug`,e),info:(...e)=>a(`info`,e),warn:(...e)=>a(`warn`,e),error:(...e)=>a(`error`,e)}},Se=xe(`CommentEngine:Comment`),Ce=new WeakMap,we=e=>{let t=Ce.get(e);return t||(t=new Map,Ce.set(e,t)),t},Te=(e,t)=>{if(!e)return 0;let n=`${e.font??``}::${t}`,r=we(e),i=r.get(n);if(i!==void 0)return i;let a=e.measureText(t).width;return r.set(n,a),a},Ee=768,De=.1,Oe=e=>Math.max(1,e)/Ee*De,ke={small:{resizeAtLineCount:7,normal:{fontSize:36,blockHeight:46.4650603532791,lineAdvance:36.0867458283901},resized:{fontSize:20,blockHeight:25.9252893924713,lineAdvance:20.065746307373}},medium:{resizeAtLineCount:5,normal:{fontSize:54,blockHeight:68.1645984649658,lineAdvance:57.8541674613953},resized:{fontSize:28,blockHeight:35.4883227944374,lineAdvance:30.0388290286064}},big:{resizeAtLineCount:3,normal:{fontSize:78,blockHeight:98.6615376472473,lineAdvance:90.4781694412232},resized:{fontSize:40,blockHeight:52.1674284785986,lineAdvance:47.7538447529078}}},Ae=({canvasHeight:e,size:t,lineCount:n,isEnder:r,lineHeightMultiplier:i})=>{let a=Math.max(1,e),o=Math.max(1,Math.floor(n)),s=ke[t],c=!r&&o>=s.resizeAtLineCount,l=c?s.resized:s.normal,u=a/Ee,d=Math.max(1,l.fontSize*u),f=Math.abs(i-1)>2**-52,p=f?Math.max(1,d*i):Math.max(1,l.lineAdvance*u),m=d+(o-1)*p,h=(l.blockHeight+(o-1)*l.lineAdvance)*u;return{fontSize:d,lineAdvance:p,textHeight:m,slotHeight:f?m:Math.max(1,h-Oe(a)),wasResizedForLineCount:c}},je=1364,Me=1024,Ne=4e3,Pe=2e3,Fe=1e3,Ie=e=>Math.max(0,e)/2+3,Le=({visibleWidth:e,inkWidth:t,texturePaddingX:n,direction:r,traversalDurationMs:i=Ne})=>{let a=Math.max(1,e),o=Math.max(0,t),s=Math.max(0,n),c=Math.max(1,i),l=Me/je*a,u=(a-l)/2,d=(l+o)/c,f=d*Fe,p=r===`rtl`?u+l+s+f:u-o-s-f,m=r===`rtl`?-o-s:a+s,h=Math.abs(m-p)/Math.max(d,2**-52);return{renderLeft:u,renderWidth:l,pixelsPerMs:d,startX:p,exitX:m,collisionDurationMs:o/Math.max(d,2**-52),totalDurationMs:h}},Re=768,ze=.75,Be=10,Ve=2,He=(e,t)=>Math.floor((e+2**-52)/t)*t,Ue=({visibleWidth:e,canvasHeight:t,isFull:n,isEnder:r,lineCount:i,verticalFontSize:a,verticalTextWidth:o,originalFontSize:s,originalTextWidth:c})=>{let l=Math.max(.01,t/Re),u=Ve*l,d=Be*Ve*l,f=Math.max(1,e*(n?1:ze)),p=!r&&i>1&&o>f,m=p?s:a,h=p?c:o,g=p?f*2:f,_=m;h>g&&(_=He(g/h*m,u)),p&&!n&&(_-=u),_=Math.max(d,Math.min(m,_));let v=m>0?_/m*h:0,ee=1;return v>g&&_<=d+2**-52&&(ee=Math.max(.1,Math.floor(g/v*10)/10)),{fontSize:_,drawScale:ee,useOriginalMetrics:p,targetWidth:g}},We=e=>`${e.fontWeight?`${e.fontWeight} `:``}${e.fontSize}px ${e.fontFamily}`,Ge=`  `,Ke=e=>e.replaceAll(`	`,Ge),qe=e=>{let t=Ke(e);if(t.includes(`
`)){let e=t.split(/\r?\n/);return e.length>0?e:[``]}return[t]},Je=(e,t,n=Math.max(1,e.fontSize*e.lineHeightMultiplier))=>{let r=0,i=e.letterSpacing;for(let n of e.lines){let e=Te(t,n),a=n.length>1?i*(n.length-1):0,o=Math.max(0,e+a);o>r&&(r=o)}e.width=r,e.lineHeightPx=Math.max(1,n);let a=e.lines.length>1?(e.lines.length-1)*e.lineHeightPx:0;e.height=e.fontSize+a},Ye=(e,t,n)=>(t.font=`${e.fontWeight?`${e.fontWeight} `:``}${n}px ${e.fontFamily}`,Math.max(0,...e.lines.map(n=>{let r=n.length>1?e.letterSpacing*(n.length-1):0;return Math.max(0,Te(t,n)+r)}))),Xe=(e,t,n,r,i)=>{try{if(!t)throw Error(`Canvas context is required`);if(!Number.isFinite(n)||!Number.isFinite(r))throw Error(`Canvas dimensions must be numbers`);if(!i)throw Error(`Prepare options are required`);let a=Math.max(n,1);e.lines=qe(e.text);let o=Ae({canvasHeight:r,size:e.size,lineCount:e.lines.length,isEnder:e.isEnder,lineHeightMultiplier:e.lineHeightMultiplier});if(e.fontSize=o.fontSize,e.slotHeight=o.slotHeight,e.staticWidthScale=1,t.font=We(e),Je(e,t,o.lineAdvance),!e.isScrolling){let n=e.width,i=Ae({canvasHeight:r,size:e.size,lineCount:e.lines.length,isEnder:!0,lineHeightMultiplier:e.lineHeightMultiplier}),s=Ye(e,t,i.fontSize),c=Ue({visibleWidth:a,canvasHeight:r,isFull:e.isFull,isEnder:e.isEnder,lineCount:e.lines.length,verticalFontSize:o.fontSize,verticalTextWidth:n,originalFontSize:i.fontSize,originalTextWidth:s}),l=c.useOriginalMetrics?i:o,u=c.fontSize/Math.max(1,l.fontSize);e.fontSize=c.fontSize,e.staticWidthScale=c.drawScale,t.font=We(e),Je(e,t,l.lineAdvance*u),e.slotHeight=Math.max(1,l.slotHeight*u*c.drawScale)}if(!e.isScrolling){e.bufferWidth=0;let t=(a-e.width)/2;e.virtualStartX=t,e.x=t,e.baseSpeed=0,e.speed=0,e.speedPixelsPerMs=0,e.visibleDurationMs=C,e.preCollisionDurationMs=C,e.totalDurationMs=C,e.reservationWidth=e.width*e.staticWidthScale,e.staticExpiryTimeMs=e.vposMs+C,e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1;return}e.staticExpiryTimeMs=null;let s=i.maxVisibleDurationMs===i.minVisibleDurationMs?i.maxVisibleDurationMs:Ne,c=Ie(e.fontSize),l=Le({visibleWidth:a,inkWidth:e.width,texturePaddingX:c,direction:e.scrollDirection,traversalDurationMs:s});e.bufferWidth=0,e.virtualStartX=l.startX,e.x=l.startX,e.exitThreshold=l.exitX,e.baseSpeed=l.pixelsPerMs*1e3/60,e.speed=e.baseSpeed,e.speedPixelsPerMs=l.pixelsPerMs,e.visibleDurationMs=s,e.preCollisionDurationMs=Math.ceil(l.collisionDurationMs),e.totalDurationMs=Math.ceil(l.totalDurationMs),e.reservationWidth=e.width,e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1}catch(i){throw Se.error(`Comment.prepare`,i,{text:e.text,visibleWidth:n,canvasHeight:r,hasContext:!!t}),i}},Ze=5,D={enabled:!1,maxLogsPerCategory:Ze},Qe=new Map,$e=e=>e===void 0||!Number.isFinite(e)?Ze:Math.min(1e4,Math.max(1,Math.floor(e))),et=e=>{D.enabled=!!e.enabled,D.maxLogsPerCategory=$e(e.maxLogsPerCategory),D.enabled||Qe.clear()},O=()=>D.enabled,tt=e=>{let t=Qe.get(e)??0;return t>=D.maxLogsPerCategory?(t===D.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${e}]`,`Further logs suppressed.`),Qe.set(e,t+1)),!1):(Qe.set(e,t+1),!0)},k=(e,...t)=>{D.enabled&&tt(e)&&console.debug(`[CommentOverlay][${e}]`,...t)},A=(e,t=32)=>e.length<=t?e:`${e.slice(0,t)}…`,nt=(e,t)=>{D.enabled&&(console.group(`[CommentOverlay][state-dump] ${e}`),console.table({"Current Time":`${t.currentTime.toFixed(2)}ms`,Duration:`${t.duration.toFixed(2)}ms`,"Is Playing":t.isPlaying,"Epoch ID":t.epochId,"Total Comments":t.totalComments,"Active Comments":t.activeComments,"Reserved Lanes":t.reservedLanes,"Final Phase":t.finalPhaseActive,"Playback Begun":t.playbackHasBegun,"Is Stalled":t.isStalled}),console.groupEnd())},rt=(e,t,n)=>{D.enabled&&k(`epoch-change`,`Epoch changed: ${e} → ${t} (reason: ${n})`)},it=e=>{if(typeof e==`string`)return e;if(e!=null)return String(e)},at=()=>typeof performance<`u`&&typeof performance.now==`function`?performance.now():Date.now(),ot=e=>{if(typeof e.getTransform!=`function`)return;let t=e.getTransform();return[t.a,t.b,t.c,t.d,t.e,t.f]},st=e=>{let t=e.canvas;return t?{canvasWidth:t.width,canvasHeight:t.height}:{}},ct=e=>e?{...e.no===void 0?{}:{no:e.no},...e.fork===void 0?{}:{fork:e.fork},...e.source===void 0?{}:{source:e.source},...e.threadId===void 0?{}:{threadId:e.threadId},...e.date===void 0?{}:{date:e.date},...e.userIdHash===void 0?{}:{userIdHash:e.userIdHash}}:{},lt=e=>({text:e.text,vposMs:e.vposMs,...ct(e.meta),layout:e.layout,lane:e.lane,fontSize:e.fontSize,width:e.width,height:e.height,lineHeightPx:e.lineHeightPx,slotHeight:e.slotHeight,color:e.color,opacity:e.opacity,creationIndex:e.creationIndex}),ut=(e,t,n,r)=>{let i=globalThis.__COMMENT_OVERLAY_TRACE__;globalThis.__COMMENT_OVERLAY_TRACE_ENABLED__!==!0||typeof i!=`function`||i({source:`comment-overlay`,op:e,timestampMs:at(),font:t.font,fillStyle:it(t.fillStyle),strokeStyle:it(t.strokeStyle),lineWidth:t.lineWidth,lineJoin:t.lineJoin,globalAlpha:t.globalAlpha,shadowColor:t.shadowColor,shadowBlur:t.shadowBlur,shadowOffsetX:t.shadowOffsetX,shadowOffsetY:t.shadowOffsetY,transform:ot(t),...st(t),comment:lt(n),...r})},dt=(e,t,n)=>{let r=globalThis.__COMMENT_OVERLAY_TRACE__;globalThis.__COMMENT_OVERLAY_TRACE_ENABLED__!==!0||typeof r!=`function`||r({source:`comment-overlay`,op:e,timestampMs:at(),comment:lt(t),...n})},j={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},ft=()=>{if(!O())return;let e=performance.now();if(e-j.lastReported<=5e3)return;let t=j.hits+j.misses,n=t>0?j.hits/t*100:0,r=j.creates>0?(j.totalCharactersDrawn/j.creates).toFixed(1):`0`,i=j.outlineCallsInCache+j.outlineCallsInFallback,a=j.fillCallsInCache+j.fillCallsInFallback;console.log(`[TextureCache Stats]`,`
  Cache: Hits=${j.hits}, Misses=${j.misses}, Hit Rate=${n.toFixed(1)}%`,`
  Creates: ${j.creates}, Fallbacks: ${j.fallbacks}`,`
  Comments: Normal=${j.normalComments}, LetterSpacing=${j.letterSpacingComments}, MultiLine=${j.multiLineComments}`,`
  Draw Calls: Outline=${i}, Fill=${a}`,`
  Avg Characters/Comment: ${r}`),j.lastReported=e},pt=()=>typeof OffscreenCanvas<`u`,mt=(e,t,n)=>{if(e===`none`)return{blur:0,alpha:0};let r={light:.06,medium:.1,strong:.15}[e],i={light:.6,medium:.8,strong:.95}[e];return{blur:Math.max(2,t*r),alpha:x(n*i)}},ht=()=>2.8,gt=.5,_t=e=>{let t=e.trim().toLowerCase();if(t===`black`)return!0;let n=t.match(/^#([0-9a-f]{3,8})$/i);if(!n)return!1;let r=n[1],i=r.length===3||r.length===4,a=e=>e.length===1?`${e}${e}`:e,o=Number.parseInt(a(i?r[0]:r.slice(0,2)),16),s=Number.parseInt(a(i?r[1]:r.slice(2,4)),16),c=Number.parseInt(a(i?r[2]:r.slice(4,6)),16);return o===0&&s===0&&c===0},vt=e=>_t(e.color)?`rgba(255, 255, 255, 0.4)`:`rgba(0, 0, 0, 0.4)`,yt=(e,t)=>{if(!e.isScrolling)return t+e.fontSize;let n=e.fontSize<=18?e.fontSize*.08:0;return e.fontSize*1.5+n},bt=e=>{if(e.isScrolling&&e.lines.length>1){let t=Ie(e.fontSize);return{paddingX:t,paddingY:e.fontSize*.5,textureWidth:Math.ceil(e.width+t*2),textureHeight:Math.ceil(e.height+e.fontSize*1.25)}}if(!e.isScrolling){let t=Math.ceil(e.lines.length>1?e.height:e.height+e.fontSize/3);return{paddingX:0,paddingY:Math.max(0,(t-e.height)/2),textureWidth:Math.ceil(e.width+0),textureHeight:t}}let t=e.isScrolling?Ie(e.fontSize):Math.max(10,e.fontSize*.5),n=e.fontSize,r=e.isScrolling?Math.round(20/9*n):e.height+e.fontSize/3,i=Math.ceil(Math.max(e.height+Math.max(10,e.fontSize),r));return{paddingX:t,paddingY:e.isScrolling?e.fontSize*.5:Math.max(0,(i-e.height)/2),textureWidth:Math.ceil(e.width+t*2),textureHeight:i}},xt=e=>e.isScrolling?1:e.staticWidthScale,St=(e,t)=>e.isScrolling?1:t,Ct=(e,t,n,r,i)=>{let a=St(e,i),o=!e.isScrolling&&a!==1?t.width*(1-a)*gt:0;return{x:n-r+o,scaleX:a,scaleY:i}},wt=(e,t,n,r,i)=>(a,o,s,c=0)=>{if(a.length===0)return;let l=i+c,u=()=>{r===`cache`?s===`outline`?j.outlineCallsInCache++:j.fillCallsInCache++:s===`outline`?j.outlineCallsInFallback++:j.fillCallsInFallback++},d=(n,i,a)=>{if(u(),s===`outline`){t.strokeText(n,i,o),ut(`strokeText`,t,e,{text:n,x:i,y:o,meta:{statsTarget:r,mode:s,...a}});return}t.fillText(n,i,o),ut(`fillText`,t,e,{text:n,x:i,y:o,meta:{statsTarget:r,mode:s,...a}})};if(Math.abs(e.letterSpacing)<2**-52){d(a,l);return}let f=l;for(let t=0;t<a.length;t+=1){let r=a[t];d(r,f,{characterIndex:t});let i=Te(n,r);f+=i,t<a.length-1&&(f+=e.letterSpacing)}},Tt=e=>`v9::${e.text}::${e.fontSize}::${e.fontFamily}::${e.fontWeight}::${e.color}::${e.opacity}::${e.renderStyle}::${e.letterSpacing}::${e.lineHeightPx}::${e.width}::${e.height}::${e.staticWidthScale}::${e.lines.length}`,Et=(e,t)=>{if(!pt())return null;let n=Math.abs(e.letterSpacing)>=2**-52,r=e.lines.length>1;n&&j.letterSpacingComments++,r&&j.multiLineComments++,!n&&!r&&j.normalComments++,j.totalCharactersDrawn+=e.text.length;let{paddingX:i,paddingY:a,textureWidth:o,textureHeight:s}=bt(e),c=new OffscreenCanvas(o,s),l=c.getContext(`2d`);if(!l)return null;l.save(),l.font=We(e);let u=x(e.opacity),d=i,f=e.lines.length>0?e.lines:[e.text],p=e.lines.length>1&&e.lineHeightPx>0?e.lineHeightPx:e.fontSize,m=yt(e,a),h=wt(e,l,t,`cache`,d),g=ae(e.color,u),_=e.renderStyle===`outline-only`,v=_?{blur:0,alpha:0}:mt(e.shadowIntensity,e.fontSize,u);return O()&&console.log(`[Shadow Debug - Cache]`,`
  Text: "${e.text}"`,`
  FontSize: ${e.fontSize}`,`
  Shadow intensity: ${e.shadowIntensity}`,`
  Shadow blur: ${v.blur}px`,`
  Shadow alpha: ${v.alpha}`,`
  Fill style: ${g}`),l.save(),l.shadowColor=`rgba(0, 0, 0, ${v.alpha})`,l.shadowBlur=v.blur,l.shadowOffsetX=0,l.shadowOffsetY=0,l.lineJoin=`round`,l.lineWidth=ht(),l.strokeStyle=vt(e),l.fillStyle=g,_&&f.forEach((e,t)=>{let n=m+t*p;h(e,n,`outline`)}),f.forEach((e,t)=>{let n=m+t*p;h(e,n,`fill`)}),l.restore(),l.restore(),c},Dt=(e,t,n)=>{j.fallbacks++,t.save(),t.font=We(e);let r=x(e.opacity),i=n??e.x,a=e.lines.length>0?e.lines:[e.text],o=e.lines.length>1&&e.lineHeightPx>0?e.lineHeightPx:e.fontSize,s=e.y+e.fontSize;if(!e.isScrolling&&e.staticWidthScale!==1){let n=i+e.width/2;t.translate(n,e.y),t.scale(e.staticWidthScale,e.staticWidthScale),i=-e.width/2,s=e.fontSize}let c=wt(e,t,t,`fallback`,i),l=ae(e.color,r),u=e.renderStyle===`outline-only`,d=u?{blur:0,alpha:0}:mt(e.shadowIntensity,e.fontSize,r);O()&&console.log(`[Shadow Debug - Fallback]`,`
  Text: "${e.text}"`,`
  FontSize: ${e.fontSize}`,`
  Shadow intensity: ${e.shadowIntensity}`,`
  Shadow blur: ${d.blur}px`,`
  Shadow alpha: ${d.alpha}`,`
  Fill style: ${l}`),t.save(),t.shadowColor=`rgba(0, 0, 0, ${d.alpha})`,t.shadowBlur=d.blur,t.shadowOffsetX=0,t.shadowOffsetY=0,t.lineJoin=`round`,t.lineWidth=ht(),t.strokeStyle=vt(e),t.fillStyle=l,u&&a.forEach((e,t)=>{let n=s+t*o;c(e,n,`outline`)}),a.forEach((e,t)=>{let n=s+t*o;c(e,n,`fill`)}),t.restore(),t.restore()},Ot=(e,t,n)=>{try{if(!e.isActive||!t)return;let r=Tt(e),i=e.getCachedTexture();if(e.getTextureCacheKey()!==r||!i){j.misses++,j.creates++;let n=Et(e,t);e.setCachedTexture(n),e.setTextureCacheKey(r)}else j.hits++;let a=e.getCachedTexture();if(a){let r=n??e.x,{paddingX:i,paddingY:o}=bt(e),s=xt(e),c=Ct(e,a,r,i,s),l=c.x,u=e.y-o;c.scaleX===1&&c.scaleY===1?t.drawImage(a,l,u):t.drawImage(a,l,u,a.width*c.scaleX,a.height*c.scaleY),ut(`drawImage`,t,e,{x:l,y:u,width:a.width*c.scaleX,height:a.height*c.scaleY,sourceWidth:a.width,sourceHeight:a.height,meta:{statsTarget:`cache`,paddingX:i,paddingY:o,drawScale:s,drawScaleX:c.scaleX,drawScaleY:c.scaleY}}),ft();return}Dt(e,t,n),ft()}catch(r){Se.error(`Comment.draw`,r,{text:e.text,isActive:e.isActive,hasContext:!!t,interpolatedX:n})}},kt=e=>e===`ltr`?`ltr`:`rtl`,At=e=>e===`ltr`?1:-1,jt=class{text;vposMs;commands;layout;isScrolling;size;sizeScale;opacityMultiplier;opacityOverride;colorOverride;isInvisible;isFull;isEnder;meta;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily;fontWeight;opacity;activationTimeMs=null;staticExpiryTimeMs=null;isActive=!1;hasShown=!1;isPaused=!1;lastUpdateTime=0;reservationWidth=0;bufferWidth=0;visibleDurationMs=0;totalDurationMs=0;preCollisionDurationMs=0;speedPixelsPerMs=0;virtualStartX=0;exitThreshold=0;scrollDirection=`rtl`;renderStyle=`outline-only`;shadowIntensity=`medium`;creationIndex=0;letterSpacing=0;lineHeightMultiplier=1;lineHeightPx=0;slotHeight=0;staticWidthScale=1;lines=[];epochId=0;directionSign=-1;timeSource;lastSyncedSettingsVersion=-1;cachedTexture=null;textureCacheKey=``;constructor(e,t,n,r,i={},a=null){if(typeof e!=`string`)throw Error(`Comment text must be a string`);if(!Number.isFinite(t)||t<0)throw Error(`Comment vposMs must be a non-negative number`);this.text=e,this.vposMs=t,this.commands=Array.isArray(n)?[...n]:[],this.meta=a?{...a}:null;let o=re(this.commands,{defaultColor:r.commentColor});this.layout=o.layout,this.isScrolling=this.layout===`naka`,this.size=o.size,this.sizeScale=o.sizeScale,this.opacityMultiplier=o.opacityMultiplier,this.opacityOverride=o.opacityOverride,this.colorOverride=o.colorOverride,this.isInvisible=o.isInvisible,this.isFull=o.isFull,this.isEnder=o.isEnder,this.fontFamily=o.fontFamily,this.fontWeight=o.fontWeight,this.color=o.resolvedColor,this.opacity=this.getEffectiveOpacity(r.commentOpacity),this.renderStyle=r.renderStyle,this.shadowIntensity=r.shadowIntensity,this.letterSpacing=o.letterSpacing,this.lineHeightMultiplier=o.lineHeight,this.timeSource=i.timeSource??se(),this.applyScrollDirection(r.scrollDirection),this.syncWithSettings(r,i.settingsVersion)}prepare(e,t,n,r){Xe(this,e,t,n,r)}draw(e,t=null){Ot(this,e,t)}update(e=1,t=!1){try{if(!this.isActive){this.isPaused=t;return}let n=this.timeSource.now();if(!this.isScrolling){this.isPaused=t,this.lastUpdateTime=n;return}if(t){this.isPaused=!0,this.lastUpdateTime=n;return}let r=(n-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*e,this.x+=this.speed*r*this.directionSign,(this.scrollDirection===`rtl`&&this.x<=this.exitThreshold||this.scrollDirection===`ltr`&&this.x>=this.exitThreshold)&&(this.isActive=!1),this.lastUpdateTime=n,this.isPaused=!1}catch(n){Se.error(`Comment.update`,n,{text:this.text,playbackRate:e,isPaused:t,isActive:this.isActive})}}syncWithSettings(e,t){typeof t==`number`&&t===this.lastSyncedSettingsVersion||(this.color=this.getEffectiveColor(e.commentColor),this.opacity=this.getEffectiveOpacity(e.commentOpacity),this.applyScrollDirection(e.scrollDirection),this.renderStyle=e.renderStyle,this.shadowIntensity=e.shadowIntensity,typeof t==`number`&&(this.lastSyncedSettingsVersion=t))}getEffectiveColor(e){let t=this.colorOverride??e;return typeof t!=`string`||t.length===0?e:t.toUpperCase()}getEffectiveOpacity(e){if(typeof this.opacityOverride==`number`)return x(this.opacityOverride);let t=e*this.opacityMultiplier;return Number.isFinite(t)?x(t):0}markActivated(e){this.activationTimeMs=e}clearActivation(){this.activationTimeMs=null,this.isScrolling||(this.staticExpiryTimeMs=null),this.resetTextureCache()}hasStaticExpired(e){return this.isScrolling||this.staticExpiryTimeMs===null?!1:e>=this.staticExpiryTimeMs}getDirectionSign(){return this.directionSign}getTimeSource(){return this.timeSource}getTextureCacheKey(){return this.textureCacheKey}setTextureCacheKey(e){this.textureCacheKey=e}getCachedTexture(){return this.cachedTexture}setCachedTexture(e){this.cachedTexture=e}resetTextureCache(){this.cachedTexture=null,this.textureCacheKey=``}applyScrollDirection(e){let t=kt(e);this.scrollDirection=t,this.directionSign=At(t)}},Mt={commentColor:`#FFFFFF`,commentOpacity:1,isCommentVisible:!0,useContainerResizeObserver:!0,ngWords:[],ngRegexps:[],scrollDirection:`rtl`,renderStyle:`outline-only`,syncMode:`raf`,scrollVisibleDurationMs:null,useFixedLaneCount:!1,fixedLaneCount:12,useDprScaling:!0,shadowIntensity:`medium`},Nt=()=>({...Mt,ngWords:[...Mt.ngWords],ngRegexps:[...Mt.ngRegexps]}),Pt=e=>Number.isFinite(e)?e<=0?0:e>=1?1:e:1,Ft=e=>{let t=e.scrollVisibleDurationMs,n=t==null?null:Number.isFinite(t)?Math.max(1,Math.floor(t)):null;return{...e,scrollDirection:e.scrollDirection===`ltr`?`ltr`:`rtl`,commentOpacity:Pt(e.commentOpacity),renderStyle:e.renderStyle===`classic`?`classic`:`outline-only`,scrollVisibleDurationMs:n,syncMode:e.syncMode===`video-frame`?`video-frame`:`raf`,useDprScaling:!!e.useDprScaling}},It=e=>typeof window<`u`&&typeof window.requestAnimationFrame==`function`&&typeof window.cancelAnimationFrame==`function`?{request:e=>window.requestAnimationFrame(e),cancel:e=>window.cancelAnimationFrame(Number(e))}:{request:t=>globalThis.setTimeout(()=>{t(e.now())},16),cancel:e=>{globalThis.clearTimeout(e)}},Lt=()=>typeof document>`u`?()=>{throw Error(`Document is not available. Provide a custom createCanvasElement implementation.`)}:()=>document.createElement(`canvas`),Rt=e=>{if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.commentColor==`string`&&typeof t.commentOpacity==`number`&&typeof t.isCommentVisible==`boolean`},zt=e=>{let t=e.meta?.no;return typeof t==`number`&&Number.isFinite(t)?t:null},Bt=function(e){if(!Array.isArray(e)||e.length===0)return[];let t=[];this.commentDependencies.settingsVersion=this.settingsVersion;for(let n of e){let{text:e,vposMs:r,commands:i=[],meta:a=null}=n,o=A(e);if(this.isNGComment(e)){k(`comment-skip-ng`,{preview:o,vposMs:r});continue}let s=ce(r);if(s===null){this.log.warn(`CommentRenderer.addComment.invalidVpos`,{text:e,vposMs:r}),k(`comment-skip-invalid-vpos`,{preview:o,vposMs:r});continue}let c=a?.no===void 0?`fallback:${e}\0${s}`:`no:${a.source??``}:${a.fork??``}:${a.threadId??``}:${a.no}`,l=e=>e.meta?.no===void 0?`fallback:${e.text}\0${e.vposMs}`:`no:${e.meta.source??``}:${e.meta.fork??``}:${e.meta.threadId??``}:${e.meta.no}`;if(this.comments.some(e=>l(e)===c)||t.some(e=>l(e)===c)){k(`comment-skip-duplicate`,{preview:o,vposMs:s});continue}let u=new jt(e,s,i,this._settings,this.commentDependencies,a);u.creationIndex=this.commentSequence++,u.epochId=this.epochId,t.push(u),k(`comment-added`,{preview:o,vposMs:s,commands:u.commands.length,layout:u.layout,isScrolling:u.isScrolling,invisible:u.isInvisible})}return t.length===0?[]:(this.comments.push(...t),this.comments.sort((e,t)=>{let n=e.vposMs-t.vposMs;if(Math.abs(n)>T)return n;let r=zt(e),i=zt(t);return r!==null&&i!==null&&Math.abs(r-i)>T?r-i:e.creationIndex-t.creationIndex}),t)},Vt=function(e,t,n=[],r=null){let[i]=this.addComments([{text:e,vposMs:t,commands:n,meta:r}]);return i??null},Ht=function(){if(this.comments.length=0,this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.commentSequence=0,this.ctx&&this.canvas){let e=this.canvasDpr>0?this.canvasDpr:1,t=this.displayWidth>0?this.displayWidth:this.canvas.width/e,n=this.displayHeight>0?this.displayHeight:this.canvas.height/e;this.ctx.clearRect(0,0,t,n)}},Ut=function(){this.clearComments(),this.currentTime=0,this.resetFinalPhaseState(),this.playbackHasBegun=!1,this.skipDrawingForCurrentFrame=!1,this.isStalled=!1,this.pendingInitialSync=!1},Wt=function(){let e=this._settings,t=Array.isArray(e.ngWords)?e.ngWords:[];this.normalizedNgWords=t.filter(e=>typeof e==`string`);let n=Array.isArray(e.ngRegexps)?e.ngRegexps:[];this.compiledNgRegexps=n.map(e=>{if(typeof e!=`string`)return null;try{return new RegExp(e,`i`)}catch(t){return this.log.warn(`CommentRenderer.invalidNgRegexp`,t,{entry:e}),null}}).filter(e=>!!e)},Gt=function(e){return typeof e!=`string`||e.length===0?!1:this.normalizedNgWords.some(t=>t.length>0&&e.includes(t))?!0:this.compiledNgRegexps.some(t=>t.test(e))},Kt=e=>{e.prototype.addComments=Bt,e.prototype.addComment=Vt,e.prototype.clearComments=Ht,e.prototype.resetState=Ut,e.prototype.rebuildNgMatchers=Wt,e.prototype.isNGComment=Gt},qt=({vposMs:e,durationMs:t,isScrolling:n})=>{let r=Number.isFinite(t)&&t>0?Math.max(0,t-C):e,i=Math.min(e,r);return{displayVposMs:i,activationVposMs:n?Math.max(0,i-Pe):i}},Jt=function(){this.finalPhaseActive=!1,this.finalPhaseStartTime=null,this.finalPhaseScheduleDirty=!1,this.finalPhaseVposOverrides.clear()},Yt=function(e){let t=this.epochId;if(this.epochId+=1,rt(t,this.epochId,e),this.eventHooks.onEpochChange){let n={previousEpochId:t,newEpochId:this.epochId,reason:e,timestamp:this.timeSource.now()};try{this.eventHooks.onEpochChange(n)}catch(e){this.log.error(`CommentRenderer.incrementEpoch.callback`,e,{info:n})}}this.comments.forEach(e=>{e.epochId=this.epochId})},Xt=function(e){let t=this.timeSource.now();if(t-this.lastSnapshotEmitTime<this.snapshotEmitThrottleMs)return;let n={currentTime:this.currentTime,duration:this.duration,isPlaying:this.isPlaying,epochId:this.epochId,totalComments:this.comments.length,activeComments:this.activeComments.size,reservedLanes:this.reservedLanes.size,finalPhaseActive:this.finalPhaseActive,playbackHasBegun:this.playbackHasBegun,isStalled:this.isStalled};if(nt(e,n),this.eventHooks.onStateSnapshot)try{this.eventHooks.onStateSnapshot(n)}catch(e){this.log.error(`CommentRenderer.emitStateSnapshot.callback`,e)}this.lastSnapshotEmitTime=t},Zt=function(e){return qt({vposMs:e.vposMs,durationMs:this.duration,isScrolling:e.isScrolling}).activationVposMs},Qt=function(e){if(!e.isScrolling)return C;let t=[];return Number.isFinite(e.visibleDurationMs)&&e.visibleDurationMs>0&&t.push(e.visibleDurationMs),Number.isFinite(e.totalDurationMs)&&e.totalDurationMs>0&&t.push(e.totalDurationMs),t.length>0?Math.max(...t):le},$t=function(e){return this.getEffectiveCommentVpos(e)},en=function(){this.finalPhaseVposOverrides.clear(),this.finalPhaseScheduleDirty=!1},tn=e=>{e.prototype.resetFinalPhaseState=Jt,e.prototype.incrementEpoch=Yt,e.prototype.emitStateSnapshot=Xt,e.prototype.getEffectiveCommentVpos=Zt,e.prototype.getFinalPhaseDisplayDuration=Qt,e.prototype.resolveFinalPhaseVpos=$t,e.prototype.recomputeFinalPhaseTimeline=en},nn=function(){return!this.playbackHasBegun&&!this.isPlaying&&this.currentTime<=E},rn=function(){this.playbackHasBegun||(this.isPlaying||this.currentTime>E)&&(this.playbackHasBegun=!0)},an=e=>{e.prototype.shouldSuppressRendering=nn,e.prototype.updatePlaybackProgressState=rn},on=function(e){let t=this.videoElement,n=this.canvas,r=this.ctx;if(!t||!n||!r)return;let i=typeof e==`number`?e:S(t.currentTime);if(this.currentTime=i,this.playbackRate=t.playbackRate,this.isPlaying=!t.paused,this.updatePlaybackProgressState(),this.skipDrawingForCurrentFrame=this.shouldSuppressRendering(),this.skipDrawingForCurrentFrame)return;let a=this.canvasDpr>0?this.canvasDpr:1,o=this.displayWidth>0?this.displayWidth:n.width/a,s=this.displayHeight>0?this.displayHeight:n.height/a,c=this.buildPrepareOptions(o);this.pruneStaticLaneReservations(this.currentTime);for(let e of Array.from(this.activeComments)){let t=this.getEffectiveCommentVpos(e),n=t<this.currentTime-w,r=t>this.currentTime+w;if(n||r){e.isActive=!1,this.activeComments.delete(e),e.clearActivation(),e.lane>=0&&(e.layout===`ue`?this.releaseStaticLane(`ue`,e.lane):e.layout===`shita`&&this.releaseStaticLane(`shita`,e.lane));continue}e.isScrolling&&e.hasShown&&(e.scrollDirection===`rtl`&&e.x<=e.exitThreshold||e.scrollDirection===`ltr`&&e.x>=e.exitThreshold)&&(e.isActive=!1,this.activeComments.delete(e),e.clearActivation())}let l=this.getCommentsInTimeWindow(this.currentTime,w);for(let e of l){let t=O(),n=t?A(e.text):``;if(t&&k(`comment-evaluate`,{stage:`update`,preview:n,vposMs:e.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(e),currentTime:this.currentTime,isActive:e.isActive,hasShown:e.hasShown}),this.isNGComment(e.text)){t&&k(`comment-eval-skip`,{preview:n,vposMs:e.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(e),reason:`ng-runtime`});continue}if(e.isInvisible){t&&k(`comment-eval-skip`,{preview:n,vposMs:e.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(e),reason:`invisible`}),e.isActive=!1,this.activeComments.delete(e),e.hasShown=!0,e.clearActivation();continue}if(e.syncWithSettings(this._settings,this.settingsVersion),this.shouldActivateCommentAtTime(e,this.currentTime,n)&&this.activateComment(e,r,o,s,c,this.currentTime),e.isActive){if(e.layout!==`naka`&&e.hasStaticExpired(this.currentTime)){let t=e.layout===`ue`?`ue`:`shita`;this.releaseStaticLane(t,e.lane),e.isActive=!1,this.activeComments.delete(e),e.clearActivation();continue}if(e.layout===`naka`&&this.getEffectiveCommentVpos(e)>this.currentTime+E){e.x=e.virtualStartX,e.lastUpdateTime=this.timeSource.now();continue}if(e.hasShown=!0,e.update(this.playbackRate,!this.isPlaying),!e.isScrolling&&e.hasStaticExpired(this.currentTime)){let t=e.layout===`ue`?`ue`:`shita`;this.releaseStaticLane(t,e.lane),e.isActive=!1,this.activeComments.delete(e),e.clearActivation()}}}},sn=function(e){let t=this._settings.scrollVisibleDurationMs,n=le,r=ue;return t!==null&&(n=t,r=t),{visibleWidth:e,virtualExtension:ge,maxVisibleDurationMs:n,minVisibleDurationMs:r,maxWidthRatio:de,bufferRatio:fe,baseBufferPx:pe,entryBufferPx:me}},cn=function(e){let t=this.currentTime;this.pruneLaneReservations(t),this.pruneStaticLaneReservations(t);let n=this.createLaneReservation(e,t),r=[...this.reservedLanes.values()].flat().filter(e=>this.areReservationsConflicting(e,n)).sort((e,t)=>e.verticalStart-t.verticalStart),i=Math.max(1,e.slotHeight||e.height),a=Math.max(1,this.displayHeight||this.canvas?.height||i),o=this._settings.useFixedLaneCount?Math.min(a,Math.max(i,this.laneCount*this.laneHeight)):a,s=Oe(a),c=[],l=[],u=0,d=!1;for(;;){c.push(u);let e=u+i,t=r.find(t=>!(t.verticalEnd<u||e<t.verticalStart));if(!t)break;if(l.push(`${t.comment.creationIndex}@${t.comment.vposMs}:${t.verticalStart.toFixed(3)}-${t.verticalEnd.toFixed(3)}`),u=t.verticalEnd+s,u+i>=o){d=!0,u=Math.random()*(o-i);break}}return n.verticalStart=u,n.verticalEnd=u+i,this.storeLaneReservation(u,n),dt(`laneDecision`,e,{meta:{currentTimeMs:t,selectedLane:u,selectedTop:u,selectedBottom:u+i,slotHeight:i,usedFallback:d,candidateLanes:c.map(e=>e.toFixed(3)).join(`,`),availableLanes:u.toFixed(3),nextAvailableTimes:``,blockedBy:l.join(`,`),reservationStartTimeMs:Math.round(n.startTime),reservationEndTimeMs:Math.round(n.endTime),reservationTotalEndTimeMs:Math.round(n.totalEndTime),reservationWidth:Math.round(n.width)}}),u},ln=e=>{e.prototype.updateComments=on,e.prototype.buildPrepareOptions=sn,e.prototype.findAvailableLane=cn},un=function(e,t){let n=0,r=e.length;for(;n<r;){let i=Math.floor((n+r)/2),a=e[i];a!==void 0&&a.totalEndTime+he<=t?n=i+1:r=i}return n},dn=function(e){for(let[t,n]of this.reservedLanes.entries()){let r=this.findFirstValidReservationIndex(n,e);r>=n.length?this.reservedLanes.delete(t):r>0&&this.reservedLanes.set(t,n.slice(r))}},fn=function(e){let t=t=>t.filter(t=>t.releaseTime>e),n=t(this.topStaticLaneReservations),r=t(this.bottomStaticLaneReservations);this.topStaticLaneReservations.length=0,this.topStaticLaneReservations.push(...n),this.bottomStaticLaneReservations.length=0,this.bottomStaticLaneReservations.push(...r)},pn=e=>{e.prototype.findFirstValidReservationIndex=un,e.prototype.pruneLaneReservations=dn,e.prototype.pruneStaticLaneReservations=fn},mn=function(e){let t=0,n=this.comments.length;for(;t<n;){let r=Math.floor((t+n)/2),i=this.comments[r];i!==void 0&&i.vposMs<e?t=r+1:n=r}return t},hn=function(e,t){if(this.comments.length===0)return[];let n=e-t,r=e+t,i=Math.max(0,this.duration-C-Pe),a=this.duration>0&&r>=i,o=this.findCommentIndexAtOrAfter(n),s=[];for(let e=o;e<this.comments.length;e++){let t=this.comments[e];if(!t)continue;if(!a&&t.vposMs>r)break;let i=this.getEffectiveCommentVpos(t);i>=n&&i<=r&&s.push(t)}return s},gn=function(e){return e===`ue`?this.topStaticLaneReservations:this.bottomStaticLaneReservations},_n=function(e){return e===`ue`?this.topStaticLaneReservations.length:this.bottomStaticLaneReservations.length},vn=function(e){let t=e===`ue`?`shita`:`ue`,n=this.getStaticLaneDepth(t),r=this.laneCount-n;return r<=0?-1:r-1},yn=function(e){return Math.max(0,this.laneCount-1-e)},bn=function(e,t,n,r){let i=this.pendingStaticPlacementOffsets.get(r);if(i!==void 0)return this.pendingStaticPlacementOffsets.delete(r),i;let a=Math.max(1,n),o=Math.max(1,r.slotHeight||r.height),s=Oe(a);if(e===`ue`){let n=0,r=this.getStaticReservations(e).filter(e=>e.lane<t).sort((e,t)=>e.lane-t.lane);for(let e of r){let t=e.yEnd-e.yStart;n+=t+s}return n}let c=a,l=this.getStaticReservations(e).filter(e=>e.lane<t).sort((e,t)=>e.lane-t.lane);for(let e of l){let t=e.yEnd-e.yStart;c-=t+s}let u=c-o;return Math.max(0,u)},xn=function(){let e=new Set;for(let t of this.topStaticLaneReservations)e.add(t.lane);for(let t of this.bottomStaticLaneReservations)e.add(this.getGlobalLaneIndexForBottom(t.lane));return e},Sn=e=>{e.prototype.findCommentIndexAtOrAfter=mn,e.prototype.getCommentsInTimeWindow=hn,e.prototype.getStaticReservations=gn,e.prototype.getStaticLaneDepth=_n,e.prototype.getStaticLaneLimit=vn,e.prototype.getGlobalLaneIndexForBottom=yn,e.prototype.resolveStaticCommentOffset=bn,e.prototype.getStaticReservedLaneSet=xn},Cn=e=>Math.max(1,e.slotHeight||e.height),wn=({position:e,reservationHeight:t,displayHeight:n,reservations:r,currentTime:i,random:a=Math.random})=>{let o=Math.max(1,n),s=Math.max(1,t),c=Oe(o),l=r.filter(e=>e.releaseTime>i),u=e===`ue`?[0,...l.sort((e,t)=>e.yEnd-t.yEnd).map(e=>e.yEnd+c)]:[o-s,...l.sort((e,t)=>t.yStart-e.yStart).map(e=>e.yStart-c-s)];if(s<o){for(let e of u)if(!(e<0||e+s>o)&&!l.some(t=>!(e+s<=t.yStart||e>=t.yEnd)))return{y:e,usedFallback:!1};return{y:a()*(o-s),usedFallback:!0}}return{y:e===`ue`?0:o-s,usedFallback:l.length>0}},Tn=function(e,t,n=``){let r=n.length>0&&O(),i=this.resolveFinalPhaseVpos(e);return e.isInvisible?(r&&k(`comment-eval-skip`,{preview:n,vposMs:e.vposMs,effectiveVposMs:i,reason:`invisible`}),!1):e.isActive?(r&&k(`comment-eval-skip`,{preview:n,vposMs:e.vposMs,effectiveVposMs:i,reason:`already-active`}),!1):e.hasShown&&i<=t?(r&&k(`comment-eval-skip`,{preview:n,vposMs:e.vposMs,effectiveVposMs:i,reason:`already-shown`,currentTime:t}),!1):i>t+E?(r&&k(`comment-eval-pending`,{preview:n,vposMs:e.vposMs,effectiveVposMs:i,reason:`future`,currentTime:t}),!1):i<t-w?(r&&k(`comment-eval-skip`,{preview:n,vposMs:e.vposMs,effectiveVposMs:i,reason:`expired-window`,currentTime:t}),!1):!e.isScrolling&&i+C<=t?(r&&k(`comment-eval-skip`,{preview:n,vposMs:e.vposMs,effectiveVposMs:i,reason:`static-expired`,currentTime:t}),!1):(r&&k(`comment-eval-ready`,{preview:n,vposMs:e.vposMs,effectiveVposMs:i,currentTime:t}),!0)},En=function(e,t,n,r,i,a){e.prepare(t,n,r,i);let o=this.resolveFinalPhaseVpos(e);if(O()&&k(`comment-prepared`,{preview:A(e.text),layout:e.layout,isScrolling:e.isScrolling,width:e.width,height:e.height,bufferWidth:e.bufferWidth,visibleDurationMs:e.visibleDurationMs,effectiveVposMs:o}),e.layout===`naka`){let t=Math.max(0,a-o),n=e.speedPixelsPerMs*t;e.x=e.scrollDirection===`rtl`?e.virtualStartX-n:e.virtualStartX+n;let i=this.findAvailableLane(e),s=Math.max(1,this.laneHeight);e.lane=Math.max(0,Math.round(i/s));let c=Math.max(0,r-e.height);e.y=Math.max(0,Math.min(i,c))}else{let t=e.layout===`ue`?`ue`:`shita`,n=this.assignStaticLane(t,e,r,a),i=this.resolveStaticCommentOffset(t,n,r,e);e.x=e.virtualStartX,e.y=i,e.lane=t===`ue`?n:this.getGlobalLaneIndexForBottom(n),e.speed=0,e.baseSpeed=0,e.speedPixelsPerMs=0;let s=o+C;e.visibleDurationMs=Math.max(0,s-a),this.activeComments.add(e),e.isActive=!0,e.hasShown=!0,e.isPaused=!this.isPlaying,e.markActivated(a),e.lastUpdateTime=this.timeSource.now(),e.staticExpiryTimeMs=s,this.reserveStaticLane(t,e,n,s),O()&&k(`comment-activate-static`,{preview:A(e.text),lane:e.lane,position:t,displayEnd:s,effectiveVposMs:o});return}this.activeComments.add(e),e.isActive=!0,e.hasShown=!0,e.isPaused=!this.isPlaying,e.markActivated(a),e.lastUpdateTime=this.timeSource.now()},Dn=function(e,t,n,r){let i=this.getStaticReservations(e),a=wn({position:e,reservationHeight:Cn(t),displayHeight:n,reservations:i,currentTime:r});this.pendingStaticPlacementOffsets.set(t,a.y);let o=new Set(i.map(e=>e.lane)),s=0;for(;o.has(s);)s++;return s},On=function(e,t,n,r){let i=this.getStaticReservations(e),a=t.y,o=t.y+Cn(t);i.push({comment:t,releaseTime:r,yStart:a,yEnd:o,lane:n})},kn=function(e,t){if(t<0)return;let n=this.getStaticReservations(e),r=n.findIndex(n=>e===`shita`?this.getGlobalLaneIndexForBottom(n.lane)===t:n.lane===t);r>=0&&n.splice(r,1)},An=e=>{e.prototype.shouldActivateCommentAtTime=Tn,e.prototype.activateComment=En,e.prototype.assignStaticLane=Dn,e.prototype.reserveStaticLane=On,e.prototype.releaseStaticLane=kn},jn=.001,Mn=function(){return Array.from({length:this.laneCount},(e,t)=>t)},Nn=function(e,t){let n=this.reservedLanes.get(e);if(!n||n.length===0)return t;let r=n[this.findFirstValidReservationIndex(n,t)];return r?Math.max(t,r.endTime+he):t},Pn=function(e,t){let n=Math.max(e.speedPixelsPerMs,T),r=this.getEffectiveCommentVpos(e),i=Math.max(0,Number.isFinite(r)?r:t),a=Number.isFinite(e.width)&&e.width>0?e.width:e.reservationWidth,o=i+(n>0?Math.max(a,0)/n:e.preCollisionDurationMs)+he,s=i+e.totalDurationMs+he;return{comment:e,startTime:i,endTime:Math.max(i,o),totalEndTime:Math.max(i,s),startLeft:e.virtualStartX,width:a,speed:n,buffer:0,directionSign:e.getDirectionSign(),verticalStart:0,verticalEnd:Math.max(1,e.slotHeight||e.height)}},Fn=function(e,t,n){let r=Math.max(1,t.verticalEnd-t.verticalStart);return t.verticalStart=e,t.verticalEnd=e+r,[...this.reservedLanes.values()].flat().every(e=>e.totalEndTime<=n||e.verticalEnd<t.verticalStart||t.verticalEnd<e.verticalStart||!this.areReservationsConflicting(e,t))},In=function(e,t){let n=[...this.reservedLanes.get(e)??[],t].sort((e,t)=>e.totalEndTime-t.totalEndTime);this.reservedLanes.set(e,n)},Ln=function(e,t){if(e.directionSign===t.directionSign){let n=e.speed>0?Math.max(e.width,0)/e.speed:0,r=t.speed>0?Math.max(t.width,0)/t.speed:0,i=Math.max(n,r);return Math.abs(t.startTime-e.startTime)+jn<i}let n=Math.max(e.startTime,t.startTime),r=Math.min(e.endTime,t.endTime);if(n>=r)return!1;let i=new Set([n,r,n+(r-n)/2]),a=this.solveLeftRightEqualityTime(e,t);a!==null&&a>=n-T&&a<=r+T&&i.add(a);let o=this.solveLeftRightEqualityTime(t,e);o!==null&&o>=n-T&&o<=r+T&&i.add(o);for(let a of i){if(a<n-T||a>r+T)continue;let i=this.computeForwardGap(e,t,a),o=this.computeForwardGap(t,e,a);if(i<=-24&&o<=-24)return!0}return!1},Rn=function(e,t,n){let r=this.getBufferedEdges(e,n),i=this.getBufferedEdges(t,n);return r.left-i.right},zn=function(e,t){let n=Math.max(0,t-e.startTime),r=e.speed*n,i=e.startLeft+e.directionSign*r;return{left:i-e.buffer,right:i+e.width+e.buffer}},Bn=function(e,t){let n=e.directionSign,r=t.directionSign,i=r*t.speed-n*e.speed;if(Math.abs(i)<T)return null;let a=(t.startLeft+r*t.speed*t.startTime+t.width+t.buffer-e.startLeft-n*e.speed*e.startTime+e.buffer)/i;return Number.isFinite(a)?a:null},Vn=e=>{e.prototype.getLanePriorityOrder=Mn,e.prototype.getLaneNextAvailableTime=Nn,e.prototype.createLaneReservation=Pn,e.prototype.isLaneAvailable=Fn,e.prototype.storeLaneReservation=In,e.prototype.areReservationsConflicting=Ln,e.prototype.computeForwardGap=Rn,e.prototype.getBufferedEdges=zn,e.prototype.solveLeftRightEqualityTime=Bn},Hn=function(){let e=this.canvas,t=this.ctx;if(!e||!t)return;let n=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:e.width/n,i=this.displayHeight>0?this.displayHeight:e.height/n,a=this.timeSource.now();if(this.skipDrawingForCurrentFrame||this.shouldSuppressRendering()||this.isStalled){t.clearRect(0,0,r,i),this.lastDrawTime=a;return}t.clearRect(0,0,r,i);let o=Array.from(this.activeComments);if(this._settings.isCommentVisible){let e=(a-this.lastDrawTime)/16.666666666666668;o.sort((e,t)=>{let n=this.getEffectiveCommentVpos(e)-this.getEffectiveCommentVpos(t);return Math.abs(n)>T?n:e.isScrolling===t.isScrolling?e.creationIndex-t.creationIndex:e.isScrolling?1:-1}),o.forEach(n=>{let r=this.isPlaying&&!n.isPaused?n.x+n.getDirectionSign()*n.speed*e:n.x;n.draw(t,r)})}this.lastDrawTime=a},Un=function(e){let t=this.videoElement,n=this.canvas,r=this.ctx;if(!t||!n||!r)return;let i=typeof e==`number`?e:S(t.currentTime);this.currentTime=i,this.lastDrawTime=this.timeSource.now();let a=this.canvasDpr>0?this.canvasDpr:1,o=this.displayWidth>0?this.displayWidth:n.width/a,s=this.displayHeight>0?this.displayHeight:n.height/a,c=this.buildPrepareOptions(o);this.activeComments.forEach(e=>{e.isActive=!1,e.clearActivation()}),this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.getCommentsInTimeWindow(this.currentTime,w).forEach(e=>{if(this.isNGComment(e.text)||e.isInvisible){e.isActive=!1,this.activeComments.delete(e),e.clearActivation();return}if(e.syncWithSettings(this._settings,this.settingsVersion),e.isActive=!1,this.activeComments.delete(e),e.lane=-1,e.hasShown=!1,e.clearActivation(),this.shouldActivateCommentAtTime(e,this.currentTime)){this.activateComment(e,r,o,s,c,this.currentTime);return}this.getEffectiveCommentVpos(e)<this.currentTime-w?e.hasShown=!0:e.hasShown=!1})},Wn=e=>{e.prototype.draw=Hn,e.prototype.performInitialSync=Un},Gn=function(e){this.videoElement&&this._settings.isCommentVisible&&(this.pendingInitialSync&&=(this.performInitialSync(e),!1),this.updateComments(e),this.draw())},Kn=function(){let e=this.frameId;this.frameId=null,e!==null&&this.animationFrameProvider.cancel(e),this.processFrame(),this.scheduleNextFrame()},qn=function(e,t){this.videoFrameHandle=null;let n=typeof t?.mediaTime==`number`?t.mediaTime*1e3:void 0;this.processFrame(typeof n==`number`?n:void 0),this.scheduleNextFrame()},Jn=function(){if(this._settings.syncMode!==`video-frame`)return!1;let e=this.videoElement;return!!e&&typeof e.requestVideoFrameCallback==`function`&&typeof e.cancelVideoFrameCallback==`function`},Yn=function(){let e=this.videoElement;if(e){if(this.shouldUseVideoFrameCallback()){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback();let t=e.requestVideoFrameCallback;typeof t==`function`&&(this.videoFrameHandle=t.call(e,this.handleVideoFrame));return}this.cancelVideoFrameCallback(),this.frameId=this.animationFrameProvider.request(this.handleAnimationFrame)}},Xn=function(){this.frameId!==null&&(this.animationFrameProvider.cancel(this.frameId),this.frameId=null)},Zn=function(){if(this.videoFrameHandle===null)return;let e=this.videoElement;e&&typeof e.cancelVideoFrameCallback==`function`&&e.cancelVideoFrameCallback(this.videoFrameHandle),this.videoFrameHandle=null},Qn=function(){this.stopAnimation(),this.scheduleNextFrame()},$n=function(){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback()},er=function(){let e=this.canvas,t=this.ctx,n=this.videoElement;if(!e||!t||!n)return;let r=S(n.currentTime),i=Math.abs(r-this.currentTime),a=this.timeSource.now();if(a-this.lastPlayResumeTime<this.playResumeSeekIgnoreDurationMs){this.currentTime=r,this._settings.isCommentVisible&&(this.lastDrawTime=a,this.draw());return}let o=i>E;if(this.currentTime=r,this.resetFinalPhaseState(),this.updatePlaybackProgressState(),!o){this._settings.isCommentVisible&&(this.lastDrawTime=this.timeSource.now(),this.draw());return}this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0;let s=this.canvasDpr>0?this.canvasDpr:1,c=this.displayWidth>0?this.displayWidth:e.width/s,l=this.displayHeight>0?this.displayHeight:e.height/s,u=this.buildPrepareOptions(c);this.getCommentsInTimeWindow(this.currentTime,w).forEach(e=>{let n=O(),r=n?A(e.text):``;if(n&&k(`comment-evaluate`,{stage:`seek`,preview:r,vposMs:e.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(e),currentTime:this.currentTime,isActive:e.isActive,hasShown:e.hasShown}),this.isNGComment(e.text)){n&&k(`comment-eval-skip`,{preview:r,vposMs:e.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(e),reason:`ng-runtime`}),e.isActive=!1,this.activeComments.delete(e),e.clearActivation();return}if(e.isInvisible){n&&k(`comment-eval-skip`,{preview:r,vposMs:e.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(e),reason:`invisible`}),e.isActive=!1,this.activeComments.delete(e),e.hasShown=!0,e.clearActivation();return}if(e.syncWithSettings(this._settings,this.settingsVersion),e.isActive=!1,this.activeComments.delete(e),e.lane=-1,e.hasShown=!1,e.clearActivation(),this.shouldActivateCommentAtTime(e,this.currentTime,r)){this.activateComment(e,t,c,l,u,this.currentTime);return}this.getEffectiveCommentVpos(e)<this.currentTime-w?e.hasShown=!0:e.hasShown=!1}),this._settings.isCommentVisible&&(this.lastDrawTime=this.timeSource.now(),this.draw())},tr=e=>{e.prototype.processFrame=Gn,e.prototype.handleAnimationFrame=Kn,e.prototype.handleVideoFrame=qn,e.prototype.shouldUseVideoFrameCallback=Jn,e.prototype.scheduleNextFrame=Yn,e.prototype.cancelAnimationFrameRequest=Xn,e.prototype.cancelVideoFrameCallback=Zn,e.prototype.startAnimation=Qn,e.prototype.stopAnimation=$n,e.prototype.onSeek=er},nr=function(e,t){if(e)return e;if(t.parentElement)return t.parentElement;if(typeof document<`u`&&document.body)return document.body;throw Error(`Cannot resolve container element. Provide container explicitly when DOM is unavailable.`)},rr=function(e){if(typeof getComputedStyle==`function`){getComputedStyle(e).position===`static`&&(e.style.position=`relative`);return}e.style.position||(e.style.position=`relative`)},ir=function(e){try{this.destroyCanvasOnly();let t=e instanceof HTMLVideoElement?e:e.video,n=e instanceof HTMLVideoElement?e.parentElement:e.container??e.video.parentElement,r=this.resolveContainer(n??null,t);this.videoElement=t,this.containerElement=r,this.lastVideoSource=this.getCurrentVideoSource(),this.duration=Number.isFinite(t.duration)?S(t.duration):0,this.currentTime=S(t.currentTime),this.playbackRate=t.playbackRate,this.isPlaying=!t.paused,this.isStalled=!1,this.lastDrawTime=this.timeSource.now(),this.playbackHasBegun=this.isPlaying||this.currentTime>E,this.skipDrawingForCurrentFrame=this.shouldSuppressRendering();let i=this.createCanvasElement(),a=i.getContext(`2d`);if(!a)throw Error(`Failed to acquire 2D canvas context`);i.style.position=`absolute`,i.style.top=`0`,i.style.left=`0`,i.style.right=`0`,i.style.bottom=`0`,i.style.display=`block`,i.style.pointerEvents=`none`,i.style.zIndex=`2147483647`;let o=this.containerElement;o instanceof HTMLElement&&(this.ensureContainerPositioning(o),o.appendChild(i)),this.canvas=i,this.ctx=a,this.resize(),this.calculateLaneMetrics(),this.setupVideoEventListeners(t),this.setupResizeHandling(t),this.setupFullscreenHandling(),this.setupVideoChangeDetection(t,r),this.startAnimation(),this.setupVisibilityHandling()}catch(e){throw this.log.error(`CommentRenderer.initialize`,e),e}},ar=function(){this.stopAnimation(),this.cleanupResizeHandling(),this.runCleanupTasks(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.videoElement=null,this.containerElement=null,this.comments.length=0,this.activeComments.clear(),this.reservedLanes.clear(),this.resetFinalPhaseState(),this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1,this.commentSequence=0,this.playbackHasBegun=!1,this.skipDrawingForCurrentFrame=!1,this.isStalled=!1,this.pendingInitialSync=!1},or=function(){this.stopAnimation(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1,this.fullscreenActive=!1},sr=e=>{e.prototype.resolveContainer=nr,e.prototype.ensureContainerPositioning=rr,e.prototype.initialize=ir,e.prototype.destroy=ar,e.prototype.destroyCanvasOnly=or},cr=function(e){try{let t=()=>{this.isPlaying=!0,this.playbackHasBegun=!0;let e=this.timeSource.now();this.lastDrawTime=e,this.lastPlayResumeTime=e,this.comments.forEach(t=>{t.lastUpdateTime=e,t.isPaused=!1})},n=()=>{this.isPlaying=!1;let e=this.timeSource.now();this.comments.forEach(t=>{t.lastUpdateTime=e,t.isPaused=!0})},r=()=>{this.onSeek()},i=()=>{this.onSeek()},a=()=>{this.playbackRate=e.playbackRate;let t=this.timeSource.now();this.comments.forEach(e=>{e.lastUpdateTime=t})},o=()=>{this.handleVideoMetadataLoaded(e)},s=()=>{this.duration=Number.isFinite(e.duration)?S(e.duration):0},c=()=>{this.handleVideoSourceChange()},l=()=>{this.handleVideoStalled()},u=()=>{this.handleVideoCanPlay()},d=()=>{this.handleVideoCanPlay()};e.addEventListener(`play`,t),e.addEventListener(`pause`,n),e.addEventListener(`seeking`,r),e.addEventListener(`seeked`,i),e.addEventListener(`ratechange`,a),e.addEventListener(`loadedmetadata`,o),e.addEventListener(`durationchange`,s),e.addEventListener(`emptied`,c),e.addEventListener(`waiting`,l),e.addEventListener(`canplay`,u),e.addEventListener(`playing`,d),this.addCleanup(()=>e.removeEventListener(`play`,t)),this.addCleanup(()=>e.removeEventListener(`pause`,n)),this.addCleanup(()=>e.removeEventListener(`seeking`,r)),this.addCleanup(()=>e.removeEventListener(`seeked`,i)),this.addCleanup(()=>e.removeEventListener(`ratechange`,a)),this.addCleanup(()=>e.removeEventListener(`loadedmetadata`,o)),this.addCleanup(()=>e.removeEventListener(`durationchange`,s)),this.addCleanup(()=>e.removeEventListener(`emptied`,c)),this.addCleanup(()=>e.removeEventListener(`waiting`,l)),this.addCleanup(()=>e.removeEventListener(`canplay`,u)),this.addCleanup(()=>e.removeEventListener(`playing`,d))}catch(e){throw this.log.error(`CommentRenderer.setupVideoEventListeners`,e),e}},lr=function(e){this.lastVideoSource=this.getCurrentVideoSource(),this.incrementEpoch(`metadata-loaded`),this.handleVideoSourceChange(e),this.resize(),this.calculateLaneMetrics(),this.onSeek(),this.emitStateSnapshot(`metadata-loaded`)},ur=function(){let e=this.canvas,t=this.ctx;if(!e||!t)return;this.isStalled=!0;let n=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:e.width/n,i=this.displayHeight>0?this.displayHeight:e.height/n;t.clearRect(0,0,r,i),this.comments.forEach(e=>{e.isActive&&(e.lastUpdateTime=this.timeSource.now())})},dr=function(){this.isStalled&&(this.isStalled=!1,this.videoElement&&(this.currentTime=S(this.videoElement.currentTime),this.isPlaying=!this.videoElement.paused),this.lastDrawTime=this.timeSource.now())},fr=function(e){let t=e??this.videoElement;if(!t){this.lastVideoSource=null,this.isPlaying=!1,this.resetFinalPhaseState(),this.resetCommentActivity();return}let n=this.getCurrentVideoSource();n!==this.lastVideoSource&&(this.lastVideoSource=n,this.incrementEpoch(`source-change`),this.syncVideoState(t),this.resetFinalPhaseState(),this.resetCommentActivity(),this.emitStateSnapshot(`source-change`))},pr=function(e){this.duration=Number.isFinite(e.duration)?S(e.duration):0,this.currentTime=S(e.currentTime),this.playbackRate=e.playbackRate,this.isPlaying=!e.paused,this.isStalled=!1,this.playbackHasBegun=this.isPlaying||this.currentTime>E,this.lastDrawTime=this.timeSource.now()},mr=function(){let e=this.timeSource.now(),t=this.canvas,n=this.ctx;if(this.resetFinalPhaseState(),this.skipDrawingForCurrentFrame=!1,this.isStalled=!1,this.pendingInitialSync=!1,this.playbackHasBegun=this.isPlaying||this.currentTime>E,t&&n){let e=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:t.width/e,i=this.displayHeight>0?this.displayHeight:t.height/e;n.clearRect(0,0,r,i)}this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.comments.forEach(t=>{t.isActive=!1,t.isPaused=!this.isPlaying,t.hasShown=!1,t.lane=-1,t.x=t.virtualStartX,t.speed=t.baseSpeed,t.lastUpdateTime=e,t.clearActivation()}),this.activeComments.clear()},hr=function(e,t){if(typeof MutationObserver>`u`){this.log.debug(`MutationObserver is not available in this environment. Video change detection is disabled.`);return}let n=new MutationObserver(t=>{for(let n of t){if(n.type===`attributes`&&n.attributeName===`src`){let t=n.target,r=null,i=null;if((t instanceof HTMLVideoElement||t instanceof HTMLSourceElement)&&(r=typeof n.oldValue==`string`?n.oldValue:null,i=t.getAttribute(`src`)),r===i)continue;this.handleVideoSourceChange(e);return}if(n.type===`childList`){for(let t of n.addedNodes)if(t instanceof HTMLSourceElement){this.handleVideoSourceChange(e);return}for(let t of n.removedNodes)if(t instanceof HTMLSourceElement){this.handleVideoSourceChange(e);return}}}});n.observe(e,{attributes:!0,attributeFilter:[`src`],attributeOldValue:!0,childList:!0,subtree:!0}),this.addCleanup(()=>n.disconnect());let r=new MutationObserver(e=>{for(let t of e)if(t.type===`childList`){for(let e of t.addedNodes){let t=this.extractVideoElement(e);if(t&&t!==this.videoElement){this.initialize(t);return}}for(let e of t.removedNodes){if(e===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}if(e instanceof Element){let t=e.querySelector(`video`);if(t&&t===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}}}}});r.observe(t,{childList:!0,subtree:!0}),this.addCleanup(()=>r.disconnect())},gr=function(e){if(e instanceof HTMLVideoElement)return e;if(e instanceof Element){let t=e.querySelector(`video`);if(t instanceof HTMLVideoElement)return t}return null},_r=e=>{e.prototype.setupVideoEventListeners=cr,e.prototype.handleVideoMetadataLoaded=lr,e.prototype.handleVideoStalled=ur,e.prototype.handleVideoCanPlay=dr,e.prototype.handleVideoSourceChange=fr,e.prototype.syncVideoState=pr,e.prototype.resetCommentActivity=mr,e.prototype.setupVideoChangeDetection=hr,e.prototype.extractVideoElement=gr},vr=function(){if(typeof document>`u`||typeof document.addEventListener!=`function`||typeof document.removeEventListener!=`function`)return;let e=()=>{if(document.visibilityState!==`visible`){this.stopAnimation();return}this._settings.isCommentVisible&&(this.handleVisibilityRestore(),this.startAnimation())};document.addEventListener(`visibilitychange`,e),this.addCleanup(()=>document.removeEventListener(`visibilitychange`,e)),document.visibilityState!==`visible`&&this.stopAnimation()},yr=function(){let e=this.canvas,t=this.ctx,n=this.videoElement;!e||!t||!n||(this.currentTime=S(n.currentTime),this.lastDrawTime=this.timeSource.now(),this.isPlaying=!n.paused,this.isStalled=!1,this.pendingInitialSync=!0,this.resetFinalPhaseState(),this.updatePlaybackProgressState(),this.draw())},br=function(e){let t=this._settings.isCommentVisible;if(this._settings.isCommentVisible=e,t===e)return;this.settingsVersion+=1,this.commentDependencies.settingsVersion=this.settingsVersion;let n=this.canvas,r=this.ctx;if(!(!n||!r))if(e)this.lastDrawTime=this.timeSource.now(),this.pendingInitialSync=!0,this.scheduleNextFrame();else{let e=this.canvasDpr>0?this.canvasDpr:1,t=this.displayWidth>0?this.displayWidth:n.width/e,i=this.displayHeight>0?this.displayHeight:n.height/e;r.clearRect(0,0,t,i)}},xr=e=>{e.prototype.setupVisibilityHandling=vr,e.prototype.handleVisibilityRestore=yr,e.prototype.setCommentVisibility=br},Sr=768,Cr=68.1645984649658,wr=function(e,t){let n=this.videoElement,r=this.canvas,i=this.ctx;if(!n||!r)return;let a=(this.fullscreenActive&&r.parentElement instanceof HTMLElement?r.parentElement.getBoundingClientRect():null)??n.getBoundingClientRect(),o=this.canvasDpr>0?this.canvasDpr:1,s=this.displayWidth>0?this.displayWidth:r.width/o,c=this.displayHeight>0?this.displayHeight:r.height/o,l=e??a.width??s,u=t??a.height??c;if(!Number.isFinite(l)||!Number.isFinite(u)||l<=0||u<=0)return;let d=Math.max(1,Math.floor(l)),f=Math.max(1,Math.floor(u)),p=this._settings.useDprScaling?this.resolveDevicePixelRatio():1,m=Math.max(1,Math.round(d*p)),h=Math.max(1,Math.round(f*p));(this.displayWidth!==d||this.displayHeight!==f||Math.abs(this.canvasDpr-p)>2**-52||r.width!==m||r.height!==h)&&(this.displayWidth=d,this.displayHeight=f,this.canvasDpr=p,r.width=m,r.height=h,r.style.width=`${d}px`,r.style.height=`${f}px`,i&&(i.setTransform(1,0,0,1,0,0),this._settings.useDprScaling&&i.scale(p,p)),this.calculateLaneMetrics(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.performInitialSync(S(n.currentTime)),this.draw())},Tr=function(){if(typeof window>`u`)return 1;let e=Number(window.devicePixelRatio);return!Number.isFinite(e)||e<=0?1:e},Er=function(){let e=this.canvas;if(!e)return;let t=this.displayHeight>0?this.displayHeight:e.height/Math.max(this.canvasDpr,1);this.laneHeight=Cr/Sr*t;let n=Math.max(this.laneHeight,1),r=Math.floor(Math.max(0,t-n)/n);if(this._settings.useFixedLaneCount){let e=Number.isFinite(this._settings.fixedLaneCount)?Math.floor(this._settings.fixedLaneCount):ve,t=Math.max(_e,Math.min(r,e));this.laneCount=t}else this.laneCount=Math.max(_e,r);this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0},Dr=function(e){this.cleanupResizeHandling();let t=!1,n=()=>{if(t)return;t=!0;let e=()=>{t=!1,this.resize()};if(typeof requestAnimationFrame==`function`){requestAnimationFrame(e);return}e()};if(this._settings.useContainerResizeObserver&&this.isResizeObserverAvailable){let t=this.resolveResizeObserverTarget(e),n=new ResizeObserver(e=>{for(let t of e){let{width:e,height:n}=t.contentRect;e>0&&n>0?this.resize(e,n):this.resize()}});n.observe(t),this.resizeObserver=n,this.resizeObserverTarget=t}else this.log.debug(`Resize handling is disabled because neither ResizeObserver nor window APIs are available.`);typeof window<`u`&&typeof window.addEventListener==`function`&&(window.addEventListener(`resize`,n),this.addCleanup(()=>window.removeEventListener(`resize`,n)));let r=typeof window<`u`?window.visualViewport:void 0;r&&typeof r.addEventListener==`function`&&(r.addEventListener(`resize`,n),r.addEventListener(`scroll`,n),this.addCleanup(()=>{r.removeEventListener(`resize`,n),r.removeEventListener(`scroll`,n)}))},Or=function(){this.resizeObserver&&this.resizeObserverTarget&&this.resizeObserver.unobserve(this.resizeObserverTarget),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.resizeObserverTarget=null},kr=e=>{e.prototype.resize=wr,e.prototype.resolveDevicePixelRatio=Tr,e.prototype.calculateLaneMetrics=Er,e.prototype.setupResizeHandling=Dr,e.prototype.cleanupResizeHandling=Or},Ar=function(){if(typeof document>`u`||typeof document.addEventListener!=`function`||typeof document.removeEventListener!=`function`)return;let e=()=>{this.handleFullscreenChange()};[`fullscreenchange`,`webkitfullscreenchange`,`mozfullscreenchange`,`MSFullscreenChange`].forEach(t=>{document.addEventListener(t,e),this.addCleanup(()=>document.removeEventListener(t,e))}),this.handleFullscreenChange()},jr=e=>{let t=()=>{let t=e.getFullscreenElement();if(t instanceof HTMLElement){let n=t.getBoundingClientRect();e.resize(n.width,n.height);return}e.resize()};typeof requestAnimationFrame==`function`&&requestAnimationFrame(t),typeof setTimeout==`function`&&setTimeout(t,80)},Mr=function(e){return this.resolveFullscreenContainer(e)||(e.parentElement??e)},Nr=async function(){let e=this.canvas,t=this.videoElement;if(!e||!t)return;let n=this.containerElement??t.parentElement??null,r=this.getFullscreenElement(),i=this.resolveActiveOverlayContainer(t,n,r);if(!(i instanceof HTMLElement))return;e.parentElement===i?this.ensureContainerPositioning(i):(this.ensureContainerPositioning(i),i.appendChild(e));let a=r instanceof HTMLElement&&r.contains(t)?r:null,o=a!==null;if(this.fullscreenActive!==o&&(this.fullscreenActive=o,this.setupResizeHandling(t)),e.style.position=`absolute`,e.style.top=`0`,e.style.left=`0`,e.style.right=`0`,e.style.bottom=`0`,e.style.display=`block`,e.style.pointerEvents=`none`,e.style.zIndex=`2147483647`,a){let e=a.getBoundingClientRect();this.resize(e.width,e.height),jr(this);return}this.resize(),jr(this)},Pr=function(e){let t=this.getFullscreenElement();return t instanceof HTMLElement&&(t===e||t.contains(e))?t:null},Fr=function(e,t,n){return n instanceof HTMLElement&&n.contains(e)?n instanceof HTMLVideoElement&&t instanceof HTMLElement?t:n:t??null},Ir=function(){if(typeof document>`u`)return null;let e=document;return document.fullscreenElement??e.webkitFullscreenElement??e.mozFullScreenElement??e.msFullscreenElement??null},Lr=e=>{e.prototype.setupFullscreenHandling=Ar,e.prototype.resolveResizeObserverTarget=Mr,e.prototype.handleFullscreenChange=Nr,e.prototype.resolveFullscreenContainer=Pr,e.prototype.resolveActiveOverlayContainer=Fr,e.prototype.getFullscreenElement=Ir},Rr=function(e){this.cleanupTasks.push(e)},zr=function(){for(;this.cleanupTasks.length>0;){let e=this.cleanupTasks.pop();try{e?.()}catch(e){this.log.error(`CommentRenderer.cleanupTask`,e)}}},Br=e=>{e.prototype.addCleanup=Rr,e.prototype.runCleanupTasks=zr},M=class{_settings;comments=[];activeComments=new Set;reservedLanes=new Map;topStaticLaneReservations=[];bottomStaticLaneReservations=[];pendingStaticPlacementOffsets=new WeakMap;log;timeSource;animationFrameProvider;createCanvasElement;commentDependencies;settingsVersion=0;normalizedNgWords=[];compiledNgRegexps=[];canvas=null;ctx=null;videoElement=null;containerElement=null;fullscreenActive=!1;laneCount=ve;laneHeight=0;displayWidth=0;displayHeight=0;canvasDpr=1;currentTime=0;duration=0;playbackRate=1;isPlaying=!0;isStalled=!1;lastDrawTime=0;finalPhaseActive=!1;finalPhaseStartTime=null;finalPhaseScheduleDirty=!1;playbackHasBegun=!1;skipDrawingForCurrentFrame=!1;pendingInitialSync=!1;finalPhaseVposOverrides=new Map;frameId=null;videoFrameHandle=null;resizeObserver=null;resizeObserverTarget=null;isResizeObserverAvailable=typeof ResizeObserver<`u`;cleanupTasks=[];commentSequence=0;epochId=0;eventHooks;lastSnapshotEmitTime=0;snapshotEmitThrottleMs=1e3;lastPlayResumeTime=0;playResumeSeekIgnoreDurationMs=500;lastVideoSource=null;rebuildNgMatchers(){Wt.call(this)}constructor(e=null,t=void 0){let n,r;if(Rt(e))n=Ft({...e}),r=t??{};else{let i=e??t??{};r=typeof i==`object`?i:{},n=Ft(Nt())}this._settings=Ft(n),this.timeSource=r.timeSource??se(),this.animationFrameProvider=r.animationFrameProvider??It(this.timeSource),this.createCanvasElement=r.createCanvasElement??Lt(),this.commentDependencies={timeSource:this.timeSource,settingsVersion:this.settingsVersion},this.log=xe(r.loggerNamespace??`CommentRenderer`),this.eventHooks=r.eventHooks??{},this.handleAnimationFrame=this.handleAnimationFrame.bind(this),this.handleVideoFrame=this.handleVideoFrame.bind(this),this.rebuildNgMatchers(),r.debug&&et(r.debug)}get settings(){return this._settings}set settings(e){this._settings=Ft(e),this.settingsVersion+=1,this.commentDependencies.settingsVersion=this.settingsVersion,this.rebuildNgMatchers()}getVideoElement(){return this.videoElement}getCurrentVideoSource(){let e=this.videoElement;if(!e)return null;if(typeof e.currentSrc==`string`&&e.currentSrc.length>0)return e.currentSrc;let t=e.getAttribute(`src`);if(t&&t.length>0)return t;let n=e.querySelector(`source[src]`);return n&&typeof n.src==`string`?n.src:null}getCommentsSnapshot(){return[...this.comments]}};Kt(M),tn(M),an(M),ln(M),pn(M),Sn(M),An(M),Vn(M),Wn(M),tr(M),sr(M),_r(M),xr(M),kr(M),Lr(M),Br(M);var N=()=>({...Nt(),shadowIntensity:`strong`,autoSearchEnabled:!0}),Vr=`v7.6.6`,Hr=typeof GM_addStyle<`u`?GM_addStyle:void 0,P=typeof GM_getValue<`u`?GM_getValue:void 0,F=typeof GM_setValue<`u`?GM_setValue:void 0,Ur=typeof GM_xmlhttpRequest<`u`?GM_xmlhttpRequest:void 0,Wr=[`ja`,`en`,`zh-Hans`,`hi`,`es`,`fr`,`ar`,`pt`,`bn`,`ru`,`ur`],Gr=new Set([`ar`,`ur`]);function Kr(e){return Gr.has(e)?`rtl`:`ltr`}function qr(e,t,n){let r=e[n],i={},a=e;for(let e of t)i[e]={...r,...a[e]??{}};return i}function Jr(e,t){return qr(e,Wr,t)}function Yr(e,t){return e.replace(/\{([a-zA-Z0-9_]+)\}/g,(e,n)=>{let r=t[n];return r===void 0?e:String(r)})}function Xr(e){let t=Object.keys(e.translations),n=e.defaultLocale,r=n=>{let r=n.toLowerCase(),i=e.aliases?.[r];if(i)return i;let a=t.find(e=>e.toLowerCase()===r);if(a)return a;let o=r.split(`-`)[0];return t.find(e=>e.toLowerCase().split(`-`)[0]===o)??null},i=()=>{let t=navigator.languages.length>0?navigator.languages:[navigator.language];for(let e of t){let t=r(e);if(t)return t}return e.fallbackLocale},a=t=>e.translations[n]?.[t]||e.translations[e.fallbackLocale]?.[t]||(e.translations[e.defaultLocale]?.[t]??t);return{locales:t,getLocale:()=>n,setLocale:e=>{n=e},detectBrowserLocale:i,t:a,format:(e,t)=>Yr(a(e),t),getTranslations:(t=n)=>e.translations[t]??e.translations[e.fallbackLocale],getDirection:(e=n)=>Kr(e),getMissingTranslationKeys:t=>{let n=e.translations[e.fallbackLocale],r=e.translations[t];return Object.keys(n).filter(e=>!r[e])}}}var I=Xr({translations:Jr({ja:{color:`カラー`,commentColor:`コメントカラー`,commentOpacity:`不透明度`,commentSettings:`コメント設定`,commentSettingsPanel:`コメント設定パネル`,commentVisibility:`コメント表示`,commentVisibilityToggle:`コメント表示切替`,currentVideoUnset:`オーバーレイする動画が未設定です`,error:`エラー`,animeTitle:`アニメタイトル`,autoFillSearchForm:`検索フォームにタイトル・話数・エピソードタイトルを入力`,autoSearch:`自動検索`,autoSearchDescription:`視聴ページ表示時に自動でコメントを設定`,autoSearchDisabledManual:`自動検索を無効にしました（手動設定モード）`,autoSearchEnabled:`自動検索を有効にしました`,autoSearchInfo:`自動検索についての説明`,fixedPlaybackRate:`速度固定`,formInput:`フォーム入力`,freeInput:`自由入力`,idLoadFailed:`ID情報の読込に失敗しました`,idSaveFailed:`ID情報の保存に失敗しました`,info:`情報`,manualSearchLoadFailed:`検索設定の読込に失敗しました`,manualSearchSaveFailed:`検索設定の保存に失敗しました`,manualSearchPlaceholder:`検索キーワードを入力`,ngRegex:`NG正規表現`,ngRegexPlaceholder:`NG正規表現を1行ずつ入力`,ngTab:`NG`,ngWords:`NGワード`,ngWordsPlaceholder:`NGワードを1行ずつ入力`,noMessage:`メッセージはありません`,playbackRate:`再生速度`,playbackRateFixedToggle:`再生速度固定ON/OFF`,postedAt:`投稿日`,commentsSet:`「{title}」のコメントを設定しました`,autoSetupComplete:`ニコニコ動画を自動設定しました`,autoSetupError:`自動設定エラー: {message}`,commentsLoadComplete:`コメントの読み込みが完了しました（{count}件）`,commentsLoadErrorSelectAnother:`コメント読み込みエラー: {message}
...
`,V=class{static getCommonStyles(){return gi}static getNotificationStyles(){return _i}static getAutoButtonStyles(){return vi}},yi={success:`✔`,warning:`⚠`,error:`✖`,info:`ℹ`},H=class e extends hi{static instance=null;static notifications=[];hostElement=null;initialized=!1;static getInstance(){return this.instance||=new e,this.instance}static show(e,t=`info`,n=3e3){try{let r=this.getInstance();return r.initialize(),r.initialized?r.createNotification(e,t,n):null}catch(e){return console.error(`[NotificationManager] show failed`,e),null}}static removeNotification(e){this.getInstance().removeNotification(e.element)}show(t,n=`info`){e.show(t,n)}initialize(){if(!this.initialized)try{this.hostElement=document.createElement(`div`),this.hostElement.className=`nico-comment-shadow-host notification-host`,this.hostElement.style.cssText=[`position: fixed`,`top: 0`,`right: 0`,`z-index: 2147483647`,`pointer-events: none`].join(`;`),document.body.appendChild(this.hostElement),this.createShadowDOM(this.hostElement),this.addStyles(V.getNotificationStyles()),this.setHTML(`<div class="notification-container"></div>`),this.initialized=!0}catch(e){console.error(`[NotificationManager] initialize failed`,e),this.initialized=!1}}destroy(){e.notifications.forEach(e=>{e.timerId&&window.clearTimeout(e.timerId)}),e.notifications=[],this.hostElement?.parentNode&&this.hostElement.parentNode.removeChild(this.hostElement),this.hostElement=null,this.initialized=!1,e.instance=null}createNotification(t,n,r){try{let i=this.querySelector(`.notification-container`);if(!i)throw Error(`Notification container not found`);let a=yi[n]??yi.info,o=document.createElement(`div`);o.className=`notification-item ${n}`;let s=document.createElement(`div`);s.className=`notification-icon`,s.innerHTML=`<span>${a}</span>`,o.appendChild(s);let c=document.createElement(`div`);c.className=`notification-content`;let l=document.createElement(`div`);l.className=`notification-type`,l.textContent=Zr(n),c.appendChild(l);let u=document.createElement(`div`);u.className=`notification-message`,t.includes(`<`)?u.innerHTML=t||R(`noMessage`):u.innerHTML=(t||R(`noMessage`)).split(`
`).map(e=>e.trim()).filter(e=>e.length>0).join(`<br>`),c.appendChild(u),o.appendChild(c);let d=document.createElement(`button`);d.className=`notification-close`,d.innerHTML=`&times;`,d.addEventListener(`click`,()=>{this.removeNotification(o)}),o.appendChild(d),i.appendChild(o),requestAnimationFrame(()=>{o.classList.add(`show`)});let f={element:o,timerId:window.setTimeout(()=>{this.removeNotification(o)},r)};return e.notifications.push(f),f}catch(e){return console.error(`[NotificationManager] createNotification failed`,e),null}}removeNotification(t){if(!t)return;let n=e.notifications.find(e=>e.element===t);n?.timerId&&window.clearTimeout(n.timerId),t.classList.remove(`show`),window.setTimeout(()=>{try{t.remove(),e.notifications=e.notifications.filter(e=>e.element!==t)}catch(e){console.error(`[NotificationManager] removeNotification cleanup failed`,e)}},500)}},bi=`https://www.nicovideo.jp`,xi=`${bi}/search`,Si=`${bi}/watch`,Ci=`https://twitter.com`,wi=`https://t.co`,Ti={base:bi,searchBase:xi,watchBase:Si},Ei=e=>`${Si}/${e}`,Di=e=>`${xi}/${encodeURIComponent(e)}`;`${Ci}`,`${wi}`;var Oi=e=>new Promise((t,n)=>{Ur({url:e.url,method:e.method??`GET`,headers:e.headers,data:e.data,responseType:e.responseType??`text`,timeout:e.timeout,onprogress:e.onprogress,onload:e=>{t({status:e.status,statusText:e.statusText,response:e.response,finalUrl:e.finalUrl,headers:e.responseHeaders})},onerror:e=>{let t=e?.error??`unknown error`;n(Error(`GM_xmlhttpRequest failed: ${t}`))},ontimeout:()=>{n(Error(`GM_xmlhttpRequest timeout`))}})}),ki=r(`dAnime:NicoApiFetcher`),U=class{apiData=null;comments=null;get lastApiData(){return this.apiData}get cachedComments(){return this.comments}async fetchApiData(e){try{let t=(await Oi({method:`GET`,url:Ei(this.sanitizeVideoId(e)),headers:{Accept:`text/html`}})).response,n=new DOMParser().parseFromString(t,`text/html`).querySelector(`meta[name="server-response"]`);if(!n)throw Error(`API data element not found in response`);let r=n.getAttribute(`content`);if(!r)throw Error(`API data content is empty`);let i=this.decodeServerResponse(r),a=JSON.parse(i).data?.response;if(!a)throw Error(`Invalid API data structure`);return this.apiData=a,a}catch(e){throw ki.error(`NicoApiFetcher.fetchApiData`,e),e}}async fetchComments(){try{if(!this.apiData)throw Error(`API data must be fetched first`);let e=this.apiData.comment?.nvComment;if(!e?.server||!e.params||!e.threadKey)throw Error(`Required comment server data is missing`);let t=await Oi({method:`POST`,url:`${e.server}/v1/threads`,headers:{"Content-Type":`application/json`,"x-client-os-type":`others`,"X-Frontend-Id":`6`,"X-Frontend-Version":`0`},data:JSON.stringify({params:e.params,threadKey:e.threadKey,additionals:{}})}),n=(JSON.parse(t.response).data?.threads??[]).filter(e=>e.fork===`main`).sort((e,t)=>(t.commentCount||0)-(e.commentCount||0))[0];if(!n)throw Error(`Main thread not found in comment response`);let r=(n.comments??[]).map(e=>({text:e.body??``,vposMs:e.vposMs??0,commands:e.commands??[]}));return this.comments=r,r}catch(e){throw ki.error(`NicoApiFetcher.fetchComments`,e),e}}async fetchAllData(e){return await this.fetchApiData(e),this.fetchComments()}sanitizeVideoId(e){try{let t=encodeURIComponent(e);return t=t.replace(/%([0-9A-F]{2})/gi,(e,t)=>{let n=parseInt(t,16);return n>=65&&n<=90||n>=97&&n<=122||n>=48&&n<=57||n===45||n===95||n===46||n===126?String.fromCharCode(n):e}),t}catch(t){return ki.error(`NicoApiFetcher.sanitizeVideoId`,t,{videoId:e}),e}}decodeServerResponse(e){try{return decodeURIComponent(e)}catch(t){try{let t=e.replace(/%(?![0-9A-F]{2})/gi,`%25`);return decodeURIComponent(t)}catch{throw Error(`API data decode failed: ${t.message}`)}}}},Ai=r(`dAnime:NicoVideoSearcher`),ji=`dアニメストア ニコニコ支店`,W=class e{cache=new Map;static isOfficialVideo(e,t){let n=e.owner?.nickname??e.owner?.name??e.channel?.name??``;return!!(n===ji||n===t||n.startsWith(t+` `))}static filterOfficialVideos(t,n){return t.filter(t=>e.isOfficialVideo(t,n))}async search(e){if(!e.trim())return[];if(this.cache.has(e))return this.cache.get(e)??[];let t=Di(e),n=await this.fetchText(t),r=this.parseServerContext(n).map(t=>{let n=this.calculateLevenshteinDistance(e,t.title),r=Math.max(e.length,t.title.length),i=r>0?(1-n/r)*100:0;return{...t,levenshteinDistance:n,similarity:i}}),i=[],a=new Set;for(let e of r)e?.videoId&&(a.has(e.videoId)||(a.add(e.videoId),i.push(e)));return i.sort((e,t)=>{if(e.commentCount!==t.commentCount)return t.commentCount-e.commentCount;let n=e.similarity??-1,r=t.similarity??-1;return n===r?t.viewCount-e.viewCount:r-n}),this.cache.set(e,i),i}async fetchText(e){return(await Oi({method:`GET`,url:e})).response}parseServerContext(e){try{let t=new DOMParser().parseFromString(e,`text/html`).querySelector(`meta[name="server-response"]`);if(!t)return[];let n=t.getAttribute(`content`)??``,r=this.decodeHtmlEntities(n),i;try{i=JSON.parse(r)}catch(e){return Ai.error(`NicoVideoSearcher.parseServerContext`,e),[]}return this.extractVideoItems(i??{})}catch(e){return Ai.error(`NicoVideoSearcher.parseServerContext`,e),[]}}decodeHtmlEntities(e){if(!e)return``;let t=e.replace(/&quot;/g,`"`).replace(/&#39;/g,`'`).replace(/&amp;/g,`&`).replace(/&lt;/g,`<`).replace(/&gt;/g,`>`);return t=t.replace(/&#(\d+);/g,(e,t)=>String.fromCharCode(parseInt(t,10))),t=t.replace(/&#x([0-9a-fA-F]+);/g,(e,t)=>String.fromCharCode(parseInt(t,16))),t}extractVideoItems(e){let t=[],n=e=>{let n=(e?.id??e?.contentId??e?.watchId??``).toString();if(!n)return;let r=(e?.title??e?.shortTitle??``).toString(),i=e?.count??{},a=Number(i.view??e?.viewCounter??0)||0,o=Number(i.comment??e?.commentCounter??0)||0,s=Number(i.mylist??e?.mylistCounter??0)||0,c=e?.thumbnail??{},l=(c.nHdUrl||c.listingUrl||c.largeUrl||c.middleUrl||c.url||e?.thumbnailUrl||``).toString(),u=(e?.registeredAt||e?.startTime||e?.postedDateTime||``)?.toString?.()??``,d=e?.owner&&typeof e.owner==`object`?{nickname:(e.owner.nickname??e.owner.name??``)||void 0,name:(e.owner.name??e.owner.nickname??``)||void 0}:null,f=(e?.isChannelVideo||e?.owner?.ownerType===`channel`)&&e?.owner?{name:e.owner.name??``}:null;r&&t.push({videoId:n,title:r,viewCount:a,commentCount:o,mylistCount:s,thumbnail:l,postedAt:u,owner:d,channel:f})},r=e=>{if(!e)return;if(Array.isArray(e)){e.forEach(r);return}if(typeof e!=`object`||!e)return;let t=e;(t.id||t.contentId||t.watchId)&&n(t),Object.values(e).forEach(r)};return r(e),t}calculateLevenshteinDistance(e,t){let n=e?e.length:0,r=t?t.length:0;if(n===0)return r;if(r===0)return n;let i=Array(r+1);for(let e=0;e<=r;++e){let t=i[e]=Array(n+1);t[0]=e}let a=i[0];for(let e=1;e<=n;++e)a[e]=e;for(let a=1;a<=r;++a)for(let r=1;r<=n;++r){let n=e[r-1]===t[a-1]?0:1;i[a][r]=Math.min(i[a-1][r]+1,i[a][r-1]+1,i[a-1][r-1]+n)}return i[r][n]}},G={mypageHeaderTitle:`.p-mypageHeader__title`,mypageListContainer:`.p-mypageMain`,watchVideoElement:`video#video`,mypageItem:`.itemModule.list`,mypageItemTitle:`.line1`,mypageEpisodeNumber:`.number.line1 span`,mypageEpisodeTitle:`.episode.line1 span`,watchPageAnimeTitle:`.backInfoTxt1`,watchPageEpisodeNumber:`.backInfoTxt2`,watchPageEpisodeTitle:`.backInfoTxt3`,watchSettingButton:`.setting.mainButton`,watchButtonArea:`.buttonArea`},Mi=class{delay;timers=new Map;funcIds=new Map;nextId=1;constructor(e){this.delay=e}getFuncId(e){return this.funcIds.has(e)||this.funcIds.set(e,this.nextId++),this.funcIds.get(e)??0}exec(e){let t=this.getFuncId(e),n=Date.now(),r=this.timers.get(t)?.lastExec??0,i=n-r;if(i>this.delay)e(),this.timers.set(t,{lastExec:n});else{clearTimeout(this.timers.get(t)?.timerId??void 0);let n=setTimeout(()=>{e(),this.timers.set(t,{lastExec:Date.now()})},this.delay-i);this.timers.set(t,{timerId:n,lastExec:r})}}execOnce(e){let t=this.getFuncId(e),n=this.timers.get(t);if(n?.executedOnce){n.timerId&&clearTimeout(n.timerId);return}n?.timerId&&clearTimeout(n.timerId);let r=setTimeout(()=>{try{e()}finally{this.timers.set(t,{executedOnce:!0,lastExec:Date.now(),timerId:null})}},this.delay);this.timers.set(t,{timerId:r,executedOnce:!1,scheduled:!0})}cancel(e){let t=this.getFuncId(e),n=this.timers.get(t);n?.timerId&&clearTimeout(n.timerId),this.timers.delete(t)}resetExecution(e){let t=this.getFuncId(e),n=this.timers.get(t);n&&(n.timerId&&clearTimeout(n.timerId),this.timers.set(t,{executedOnce:!1,scheduled:!1}))}clearAll(){for(let[,e]of this.timers)e.timerId&&clearTimeout(e.timerId);this.timers.clear(),this.funcIds.clear()}},K=r(`dAnime:VideoEventLogger`),Ni=class{prefix;video=null;lastCurrentTime=0;eventListeners=new Map;isEnabled=!0;TRACKED_EVENTS=[`loadstart`,`loadedmetadata`,`loadeddata`,`canplay`,`canplaythrough`,`play`,`playing`,`pause`,`seeking`,`seeked`,`timeupdate`,`ended`,`emptied`,`stalled`,`suspend`,`waiting`,`error`,`abort`];constructor(e=``){this.prefix=e}enable(){this.isEnabled=!0,K.info(`${this.prefix}:enabled`)}disable(){this.isEnabled=!1,K.info(`${this.prefix}:disabled`)}attach(e){this.detach(),this.video=e,this.lastCurrentTime=e.currentTime,K.info(`${this.prefix}:attach`,{src:this.getVideoSource(e),duration:e.duration,currentTime:e.currentTime,readyState:e.readyState}),this.TRACKED_EVENTS.forEach(t=>{let n=()=>{this.handleEvent(t)};this.eventListeners.set(t,n),e.addEventListener(t,n)}),this.setupCurrentTimeWatcher()}detach(){this.video&&=(this.eventListeners.forEach((e,t)=>{this.video?.removeEventListener(t,e)}),this.eventListeners.clear(),K.info(`${this.prefix}:detach`,{src:this.getVideoSource(this.video),finalTime:this.video.currentTime}),null)}handleEvent(e){if(!this.isEnabled||!this.video)return;let t=this.video,n={event:e,currentTime:t.currentTime,duration:t.duration,readyState:t.readyState,paused:t.paused,ended:t.ended,src:this.getVideoSource(t),networkState:t.networkState,timestamp:Date.now()},r=Math.abs(t.currentTime-this.lastCurrentTime);if(e===`timeupdate`){r>.1&&(this.lastCurrentTime=t.currentTime);return}switch(r>.1?(K.info(`${this.prefix}:event:${e}`,{...n,timeDiff:r.toFixed(2),direction:t.currentTime>this.lastCurrentTime?`forward`:`backward`}),this.lastCurrentTime=t.currentTime):K.debug(`${this.prefix}:event:${e}`,n),e){case`error`:K.error(`${this.prefix}:videoError`,Error(`Video error detected`),{errorCode:t.error?.code??null,errorMessage:t.error?.message??null,...n});break;case`ended`:K.warn(`${this.prefix}:videoEnded`,{...n,message:`動画再生が終了しました`});break;case`emptied`:K.warn(`${this.prefix}:videoEmptied`,{...n,message:`動画要素が空になりました（src変更の可能性）`});break;case`seeking`:K.warn(`${this.prefix}:seeking`,{...n,from:this.lastCurrentTime,to:t.currentTime,diff:(t.currentTime-this.lastCurrentTime).toFixed(2)});break}}setupCurrentTimeWatcher(){if(!Object.getOwnPropertyDescriptor(HTMLMediaElement.prototype,`currentTime`)?.set){K.warn(`${this.prefix}:currentTimeWatcher:unsupported`);return}K.debug(`${this.prefix}:currentTimeWatcher:setup`)}logManualSeek(e,t,n){this.isEnabled&&K.warn(`${this.prefix}:manualSeek`,{from:e.toFixed(2),to:t.toFixed(2),diff:(t-e).toFixed(2),reason:n,stackTrace:Error().stack})}getVideoSource(e){let t=typeof e.currentSrc==`string`?e.currentSrc:``;if(t.length>0)return t.length>100?`${t.slice(0,100)}...`:t;let n=e.getAttribute(`src`)??``;return n.length>0?n.length>100?`${n.slice(0,100)}...`:n:null}},Pi=null;function Fi(){return Pi||=new Ni(`global`),Pi}var Ii=1e3,Li=100,Ri=30,zi=1e4,Bi=100,Vi=/watch\/(?:([a-z]{2}))?(\d+)/gi,q=r(`dAnime:VideoSwitchHandler`),Hi=e=>{if(!e?.video)return null;let t=e.video.registeredAt,n=t?new Date(t).toLocaleString(`ja-JP`,{year:`numeric`,month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`,hour12:!1}):void 0;return{videoId:e.video.id,title:e.video.title,viewCount:e.video.count?.view,mylistCount:e.video.count?.mylist,commentCount:e.video.count?.comment,postedAt:n,thumbnail:e.video.thumbnail?.url,owner:e.owner??null,channel:e.channel??null}},Ui=e=>{let t=[],n;for(;(n=Vi.exec(e))!==null;){let[,e=``,r=``]=n;r&&t.push(`${e}${r}`)}return t},Wi=class{renderer;fetcher;settingsManager;monitorInterval;nextVideoId=null;preloadedComments=null;lastPreloadedComments=null;lastVideoId=null;lastVideoSource=null;checkIntervalId=null;isSwitching=!1;debounce;videoEventLogger;constructor(e,t,n,r=Ii,i=Li){this.renderer=e,this.fetcher=t,this.settingsManager=n,this.monitorInterval=r,this.debounce=new Mi(i),this.videoEventLogger=new Ni(`VideoSwitchHandler`)}resetVideoSource(){q.info(`videoSwitch:resetVideoSource`,{previousSource:this.lastVideoSource,previousLastPreloadedCount:this.lastPreloadedComments?.length??0,previousPreloadedCount:this.preloadedComments?.length??0,previousNextVideoId:this.nextVideoId}),this.lastVideoSource=null,this.lastPreloadedComments=null,this.preloadedComments=null,this.nextVideoId=null}updateRenderer(e){q.info(`videoSwitch:updateRenderer`,{oldRendererExists:!!this.renderer,newRendererExists:!!e}),this.renderer=e}startMonitoring(){this.stopMonitoring(),this.checkIntervalId=window.setInterval(()=>{this.checkVideoEnd()},this.monitorInterval)}stopMonitoring(){this.checkIntervalId&&=(window.clearInterval(this.checkIntervalId),null)}async onVideoSwitch(e){if(this.isSwitching){q.warn(`videoSwitch:alreadySwitching`,{timestamp:Date.now()});return}this.isSwitching=!0;try{q.warn(`videoSwitch:entry`,{videoElementProvided:!!e,currentRendererComments:this.renderer.getCommentsSnapshot().length,lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId,lastVideoSource:this.lastVideoSource,rendererVideoElement:this.renderer.getVideoElement()?`attached`:`detached`,rendererVideoSrc:this.renderer.getCurrentVideoSource(),sampleCurrentComments:this.renderer.getCommentsSnapshot().slice(0,3).map(e=>({text:e.text?.substring(0,30),vposMs:e.vposMs}))});let t=await this.resolveVideoElement(e)??null;if(t?.ended){q.info(`videoSwitch:skipEndedVideo`,{currentTime:t.currentTime,duration:t.duration,paused:t.paused});return}let n=this.preloadedComments??this.lastPreloadedComments??null,r=t?.dataset?.videoId??t?.getAttribute?.(`data-video-id`)??null,i=this.nextVideoId??r??this.lastVideoId;if(q.warn(`videoSwitch:videoIdResolution`,{videoId:i??null,nextVideoId:this.nextVideoId,elementId:r,lastVideoId:this.lastVideoId,hasBackupPreloaded:!!n,backupPreloadedCount:n?.length??0}),!t||!i&&!n){q.warn(`videoSwitch:earlyReturn`,{reason:t?`no videoId and no backup`:`no video element`,hasVideoElement:!!t,hasVideoId:!!i,hasBackupPreloaded:!!n}),this.handleMissingVideoInfo(n);return}q.warn(`videoSwitch:start`,{videoId:i??null,elementVideoId:t.dataset?.videoId??null,preloadedCount:n?.length??0,currentTime:t.currentTime,duration:t.duration,readyState:t.readyState,currentSrc:t.currentSrc,lastVideoSource:this.lastVideoSource}),H.show(R(`videoSwitchDetected`),`info`),this.videoEventLogger.attach(t),this.resetRendererState(t);let a=this.renderer.getVideoElement();if(a!==t&&t)q.debug(`videoSwitch:rebind`,{previousSrc:this.renderer.getCurrentVideoSource(),newSrc:typeof t.currentSrc==`string`&&t.currentSrc.length>0?t.currentSrc:t.getAttribute(`src`)??null}),this.renderer.initialize(t);else if(a===t&&t&&this.hasVideoSourceChanged(t))q.debug(`videoSwitch:rebind:sameElement`,{previousSrc:this.lastVideoSource??null,newSrc:this.getVideoSource(t)}),this.renderer.clearComments(),this.renderer.destroy(),this.renderer.initialize(t);else if(!a&&!t){q.warn(`videoSwitch:missingVideoElement`,{lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId}),this.isSwitching=!1;return}let o=null;if(i){let e=this.fetcher.lastApiData;o=n&&e?.video?.id===i?e:await this.fetchVideoApiData(i,n),o&&(this.persistVideoMetadata(o),this.lastVideoId=i)}let s=await this.populateComments(i,n);s===0?(this.renderer.clearComments(),H.show(R(`commentsUnavailable`),`warning`),q.warn(`videoSwitch:commentsMissing`,{videoId:i??null})):q.warn(`videoSwitch:commentsLoaded`,{videoId:i??null,count:s}),this.nextVideoId=null,this.preloadedComments=null,this.lastVideoSource=this.getVideoSource(t);let c=this.renderer.getCommentsSnapshot();if(q.warn(`videoSwitch:complete`,{videoId:i??null,finalTime:t.currentTime,loadedCount:s,finalCommentsCount:c.length,rendererVideoSrc:this.renderer.getCurrentVideoSource(),sampleFinalComments:c.slice(0,5).map(e=>({text:e.text?.substring(0,30),vposMs:e.vposMs,vposSec:(e.vposMs/1e3).toFixed(2)}))}),o){let e=Hi(o);if(e){let t=L(`commentSourceUpdated`,{count:String(s),title:e.title??R(`unknownTitle`)});H.show(t,s>0?`success`:`warning`)}}}catch(e){q.error(`videoSwitch:error`,e,{nextVideoId:this.nextVideoId,lastVideoId:this.lastVideoId}),H.show(L(`videoSwitchError`,{message:e.message}),`error`),this.renderer.clearComments()}finally{this.isSwitching=!1}}async resolveVideoElement(e){if(e){let t=this.getVideoSource(e),n=this.lastVideoSource;return(!t||t===n)&&await this.waitForSourceChange(e),e}let t=Date.now()+zi,n=null;for(;Date.now()<t;){let e=document.querySelector(G.watchVideoElement);if(e){n=e;let t=this.hasVideoSourceChanged(e);if(e.readyState>=2||!e.paused||t)return t&&(this.lastVideoSource=null),e}await new Promise(e=>window.setTimeout(e,Bi))}return n}async waitForSourceChange(e){let t=this.getVideoSource(e);if(!t)return;let n=Date.now()+zi;for(;Date.now()<n;){let n=this.getVideoSource(e);if(n&&n!==t){this.lastVideoSource=null;return}await new Promise(e=>window.setTimeout(e,Bi))}}hasVideoSourceChanged(e){let t=this.getVideoSource(e);return t?!this.lastVideoSource||this.lastVideoSource!==t:!1}getVideoSource(e){if(!e)return null;let t=typeof e.currentSrc==`string`?e.currentSrc:``;if(t.length>0)return t;let n=e.getAttribute(`src`)??``;if(n.length>0)return n;let r=e.querySelector(`source[src]`);return r&&typeof r.src==`string`&&r.src.length>0?r.src:null}resetRendererState(e){let t=this.getVideoSource(e),n=this.lastVideoSource!==t,r=this.renderer.getCommentsSnapshot().length;q.warn(`videoSwitch:resetRendererState:before`,{currentTime:e.currentTime,duration:e.duration,src:t,lastSrc:this.lastVideoSource??null,sourceChanged:n,readyState:e.readyState,paused:e.paused,commentsCount:r}),q.warn(`videoSwitch:resetRendererState:clearingComments`,{commentsBeforeClear:r,sourceChanged:n,currentVideoSrc:this.renderer.getCurrentVideoSource()}),this.renderer.clearComments(),q.warn(`videoSwitch:resetRendererState:commentsCleared`,{commentsAfterClear:this.renderer.getCommentsSnapshot().length,rendererVideoSrc:this.renderer.getCurrentVideoSource()})}async checkVideoEnd(){let e=this.renderer.getVideoElement();!e||!Number.isFinite(e.duration)||e.duration-e.currentTime>Ri||(this.nextVideoId||this.debounce.execOnce(async()=>{await this.findNextVideoId()}),this.nextVideoId&&!this.preloadedComments&&this.debounce.execOnce(async()=>{await this.preloadComments()}))}handleMissingVideoInfo(e){q.warn(`videoSwitch:handleMissingVideoInfo`,{hasBackupPreloaded:!!e,backupPreloadedCount:e?.length??0,hasLastPreloadedComments:!!this.lastPreloadedComments,lastPreloadedCount:this.lastPreloadedComments?.length??0,willClearComments:!e&&!this.lastPreloadedComments}),!e&&!this.lastPreloadedComments?(q.warn(`videoSwitch:clearingCommentsInMissingInfo`,{currentCommentCount:this.renderer.getCommentsSnapshot().length}),this.renderer.clearComments(),H.show(R(`nextVideoCommentsUnavailableClear`),`warning`)):q.info(`videoSwitch:preservingComments`,{reason:`backup or last preloaded comments available`,currentCommentCount:this.renderer.getCommentsSnapshot().length})}async fetchVideoApiData(e,t){try{let t=await this.fetcher.fetchApiData(e);return q.debug(`videoSwitch:apiFetched`,{videoId:e}),t}catch(n){if(q.error(`videoSwitch:apiFetchError`,n,{videoId:e}),!t)throw n;return null}}persistVideoMetadata(e){let t=Hi(e);t&&this.settingsManager.saveVideoData(t.title??``,t)}async populateComments(e,t){let n=null;if(q.warn(`videoSwitch:populateComments:start`,{videoId:e,backupPreloadedCount:t?.length??0,hasBackupPreloaded:!!t}),Array.isArray(t)&&t.length>0)n=t,q.warn(`videoSwitch:populateComments:usingBackup`,{count:n.length});else if(e)try{q.warn(`videoSwitch:populateComments:fetching`,{videoId:e}),n=await this.fetcher.fetchComments(),q.warn(`videoSwitch:commentsFetched`,{videoId:e,count:n.length})}catch(t){q.error(`videoSwitch:commentsFetchError`,t,{videoId:e}),H.show(L(`commentFetchError`,{message:t.message}),`error`),n=null}if(!n||n.length===0)return q.warn(`videoSwitch:populateComments:noComments`),0;let r=n.filter(e=>!this.renderer.isNGComment(e.text));return q.warn(`videoSwitch:populateComments:addingToRenderer`,{filteredCount:r.length,totalCount:n.length,rendererCommentsBeforeAdd:this.renderer.getCommentsSnapshot().length,rendererVideoElement:this.renderer.getVideoElement()?`attached`:`detached`,rendererVideoSrc:this.renderer.getCurrentVideoSource()}),r.forEach((e,t)=>{this.renderer.addComment(e.text,e.vposMs,e.commands),t<3&&q.warn(`videoSwitch:populateComments:addedComment[${t}]`,{text:e.text.substring(0,30),vposMs:e.vposMs,vposSec:(e.vposMs/1e3).toFixed(2),commands:e.commands})}),q.warn(`videoSwitch:populateComments:complete`,{addedCount:r.length,rendererCommentsAfterAdd:this.renderer.getCommentsSnapshot().length,rendererVideoSrcAfterAdd:this.renderer.getCurrentVideoSource(),sampleComments:this.renderer.getCommentsSnapshot().slice(0,3).map(e=>({text:e.text?.substring(0,30),vposMs:e.vposMs}))}),this.lastPreloadedComments=[...r],r.length}async findNextVideoId(){try{let e=this.fetcher.lastApiData;if(!e)return;let t=e.series?.video?.next?.id;if(t){this.nextVideoId=t,q.debug(`videoSwitch:detectedNext`,{videoId:t});return}let n=e.video?.description??``;if(!n)return;let r=Ui(n);if(r.length===0)return;let i=[...r].sort((e,t)=>{let n=parseInt(e.replace(/^[a-z]{2}/i,``),10)||0;return(parseInt(t.replace(/^[a-z]{2}/i,``),10)||0)-n});this.nextVideoId=i[0]??null,this.nextVideoId&&q.debug(`videoSwitch:candidateFromDescription`,{candidate:this.nextVideoId})}catch(e){q.error(`videoSwitch:nextIdError`,e,{lastVideoId:this.lastVideoId})}}async preloadComments(){if(this.nextVideoId)try{let e=(await this.fetcher.fetchAllData(this.nextVideoId)).filter(e=>!this.renderer.isNGComment(e.text));this.preloadedComments=e.length>0?e:null,q.debug(`videoSwitch:preloaded`,{videoId:this.nextVideoId,count:e.length})}catch(e){q.error(`videoSwitch:preloadError`,e,{videoId:this.nextVideoId}),this.preloadedComments=null}}},Gi=`
.nico-comment-shadow-host {
  display: block;
  position: relative;
}
`,Ki=class{static initialize(){Hr(Gi)}},qi=`M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7.07,18.28C7.5,17.38 10.12,16.5 12,16.5C13.88,16.5 16.5,17.38 16.93,18.28C15.57,19.36 13.86,20 12,20C10.14,20 8.43,19.36 7.07,18.28M18.36,16.83C16.93,15.09 13.46,14.5 12,14.5C10.54,14.5 7.07,15.09 5.64,16.83C4.62,15.5 4,13.82 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,13.82 19.38,15.5 18.36,16.83M12,6C10.06,6 8.5,7.56 8.5,9.5C8.5,11.44 10.06,13 12,13C13.94,13 15.5,11.44 15.5,9.5C15.5,7.56 13.94,6 12,6M12,11A1.5,1.5 0 0,1 10.5,9.5A1.5,1.5 0 0,1 12,8A1.5,1.5 0 0,1 13.5,9.5A1.5,1.5 0 0,1 12,11Z`,Ji=`M13 14H11V9H13M13 18H11V16H13M1 21H23L12 2L1 21Z`,Yi=`M13,13H11V7H13M13,17H11V15H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z`,Xi=`M13 13H11V7H13M11 15H13V17H11M15.73 3H8.27L3 8.27V15.73L8.27 21H15.73L21 15.73V8.27L15.73 3Z`,Zi=`M19 2L14 6.5V17.5L19 13V2M6.5 5C4.55 5 2.45 5.4 1 6.5V21.16C1 21.41 1.25 21.66 1.5 21.66C1.6 21.66 1.65 21.59 1.75 21.59C3.1 20.94 5.05 20.5 6.5 20.5C8.45 20.5 10.55 20.9 12 22C13.35 21.15 15.8 20.5 17.5 20.5C19.15 20.5 20.85 20.81 22.25 21.56C22.35 21.61 22.4 21.59 22.5 21.59C22.75 21.59 23 21.34 23 21.09V6.5C22.4 6.05 21.75 5.75 21 5.5V19C19.9 18.65 18.7 18.5 17.5 18.5C15.8 18.5 13.35 19.15 12 20V6.5C10.55 5.4 8.45 5 6.5 5Z`,Qi=`M6 1V3H5C3.89 3 3 3.89 3 5V19C3 20.1 3.89 21 5 21H11.1C12.36 22.24 14.09 23 16 23C19.87 23 23 19.87 23 16C23 14.09 22.24 12.36 21 11.1V5C21 3.9 20.11 3 19 3H18V1H16V3H8V1M5 5H19V7H5M5 9H19V9.67C18.09 9.24 17.07 9 16 9C12.13 9 9 12.13 9 16C9 17.07 9.24 18.09 9.67 19H5M16 11.15C18.68 11.15 20.85 13.32 20.85 16C20.85 18.68 18.68 20.85 16 20.85C13.32 20.85 11.15 18.68 11.15 16C11.15 13.32 13.32 11.15 16 11.15M15 13V16.69L18.19 18.53L18.94 17.23L16.5 15.82V13Z`,$i=`M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z`,ea=`M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z`,ta=`M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z`,na=`M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10Z`,ra=`M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M5,5V7H19V5H5M5,9V11H13V9H5M5,13V15H15V13H5Z`,ia=`M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10M6,7H18V9H6V7M6,11H15V13H6V11Z`,aa=`M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z`,oa=`M15,9H5V5H15M12,19A3,3 0 0,1 9,16A3,3 0 0,1 12,13A3,3 0 0,1 15,16A3,3 0 0,1 12,19M17,3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V7L17,3Z`,sa=`M5,20H19V18H5M19,9H15V3H9V9H5L12,16L19,9Z`,ca=`M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9M12,4.5C17,4.5 21.27,7.61 23,12C21.27,16.39 17,19.5 12,19.5C7,19.5 2.73,16.39 1,12C2.73,7.61 7,4.5 12,4.5M3.18,12C4.83,15.36 8.24,17.5 12,17.5C15.76,17.5 19.17,15.36 20.82,12C19.17,8.64 15.76,6.5 12,6.5C8.24,6.5 4.83,8.64 3.18,12Z`,la=`M7,2V13H10V22L17,10H13L17,2H7Z`,ua=`M5,4V7H10.5V19H13.5V7H19V4H5Z`,da=`M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z`,fa=`M16,17H5V7H16L19.55,12M17.63,5.84C17.27,5.33 16.67,5 16,5H5A2,2 0 0,0 3,7V17A2,2 0 0,0 5,19H16C16.67,19 17.27,18.66 17.63,18.15L22,12L17.63,5.84Z`,pa=`M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z`,ma=`M21,16H3V4H21M21,2H3C1.89,2 1,2.89 1,4V16A2,2 0 0,0 3,18H10V20H8V22H16V20H14V18H21A2,2 0 0,0 23,16V4C23,2.89 22.1,2 21,2Z`,ha=`M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z`,ga=`M8,5.14V19.14L19,12.14L8,5.14Z`,_a=`M17 19.1L19.5 20.6L18.8 17.8L21 15.9L18.1 15.7L17 13L15.9 15.6L13 15.9L15.2 17.8L14.5 20.6L17 19.1M3 14H11V16H3V14M3 6H15V8H3V6M3 10H15V12H3V10Z`,va=`M17.65,6.35C16.2,4.9 14.21,4 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20C15.73,20 18.84,17.45 19.73,14H17.65C16.83,16.33 14.61,18 12,18A6,6 0 0,1 6,12A6,6 0 0,1 12,6C13.66,6 15.14,6.69 16.22,7.78L13,11H20V4L17.65,6.35Z`,ya=`M21,11C21,16.55 17.16,21.74 12,23C6.84,21.74 3,16.55 3,11V5L12,1L21,5V11M12,21C15.75,20 19,15.54 19,11.22V6.3L12,3.18L5,6.3V11.22C5,15.54 8.25,20 12,21M10,17L6,13L7.41,11.59L10,14.17L16.59,7.58L18,9`,ba=`M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z`,xa=`M12,18A6,6 0 0,1 6,12C6,11 6.25,10.03 6.7,9.2L5.24,7.74C4.46,8.97 4,10.43 4,12A8,8 0 0,0 12,20V23L16,19L12,15M12,4V1L8,5L12,9V6A6,6 0 0,1 18,12C18,13 17.75,13.97 17.3,14.8L18.76,16.26C19.54,15.03 20,13.57 20,12A8,8 0 0,0 12,4Z`,Sa=`M6,2V8H6V8L10,12L6,16V16H6V22H18V16H18V16L14,12L18,8V8H18V2H6M16,16.5V20H8V16.5L12,12.5L16,16.5M12,11.5L8,7.5V4H16V7.5L12,11.5Z`;function J(e,t=24){return`<svg xmlns="http://www.w3.org/2000/svg" width="${String(t)}" height="${String(t)}" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true" focusable="false"><path d="${e}"></path></svg>`}J(sa),J(oa),J(Sa),J(Zi);var Ca=J(ga);J(va),J(ma),J(aa),J(la);var wa=J(ta),Ta=J(ha),Ea=J(pa),Y=J(na),Da=J(fa),Oa=J(ua),ka=J(qi),Aa=J(ca),ja=J(ia),Ma=J(_a),Na=J(Qi),Pa=J(ra),Fa=J(ba);J(Xi),J($i),J(ea),J(Yi),J(Ji);var Ia=J(da),La=J(xa),Ra=J(ya),X=r(`dAnime:SettingsUI`),Z={searchInput:`#searchInput`,searchAnimeTitle:`#searchAnimeTitle`,searchEpisodeNumber:`#searchEpisodeNumber`,searchEpisodeTitle:`#searchEpisodeTitle`,searchButton:`#searchButton`,openSearchPage:`#openSearchPageDirect`,searchResults:`#searchResults`,saveButton:`#saveSettings`,autoSearchToggle:`#autoSearchToggle`,autoSearchOptionRow:`#autoSearchOptionRow`,currentTitle:`#currentTitle`,currentVideoId:`#currentVideoId`,currentOwner:`#currentOwner`,currentViewCount:`#currentViewCount`,currentCommentCount:`#currentCommentCount`,currentMylistCount:`#currentMylistCount`,currentPostedAt:`#currentPostedAt`,currentThumbnail:`#currentThumbnail`,ngWords:`#ngWords`,ngRegexps:`#ngRegexps`,showNgWords:`#showNgWords`,showNgRegexps:`#showNgRegexp`,settingsModal:`#settingsModal`,closeSettingsModal:`#closeSettingsModal`,modalOverlay:`.settings-modal__overlay`,modalTabs:`.settings-modal__tab`,modalPane:`.settings-modal__pane`,searchModeToggle:`#searchModeToggle`,searchStructuredFields:`#searchStructuredFields`,searchFreeInputArea:`#searchFreeInputArea`},Q=[`search`,`ng`],za=`
...
`,Va=class e extends hi{static FAB_HOST_ID=`danime-settings-fab-host`;settingsManager;fetcher;searcher;settings;currentVideoInfo;hostElement=null;activeTab=`search`;modalElement=null;overlayElement=null;closeButtonElement=null;fabElement=null;fabHostElement=null;fabShadowRoot=null;fabTooltipEl=null;autoSearchTooltipHtml=``;handleFabClick=e=>{e.preventDefault(),this.openSettingsModal()};handleOverlayClick=()=>{this.closeSettingsModal()};handleCloseClick=()=>{this.closeSettingsModal()};constructor(e,t=new U,n=new W){super(),this.settingsManager=e,this.fetcher=t,this.searcher=n,this.settings=this.settingsManager.getSettings(),this.currentVideoInfo=this.settingsManager.loadVideoData()}insertIntoMypage(){let e=document.querySelector(G.mypageHeaderTitle);e&&(this.hostElement=this.createSettingsUI(),e.parentElement?.insertBefore(this.hostElement,e.nextSibling))}addAutoCommentButtons(){document.querySelectorAll(G.mypageItem).forEach(e=>{if(e.dataset.autoFillEnabled===`true`)return;let t=e.querySelector(G.mypageItemTitle),n=e.querySelector(G.mypageEpisodeNumber),r=e.querySelector(G.mypageEpisodeTitle);if(!t||!r)return;let i=t.textContent?.trim()??``,a=n?.textContent?.trim()??``,o=r.textContent?.trim()??``;if(!i)return;let s=document.createElement(`div`);s.style.marginTop=`8px`,s.style.display=`block`;let c=s.attachShadow({mode:`open`}),l=document.createElement(`style`);l.textContent=V.getAutoButtonStyles(),c.appendChild(l);let u=document.createElement(`button`);u.className=`auto-comment-button`,u.title=R(`autoFillSearchForm`),u.setAttribute(`aria-label`,R(`autoFillSearchForm`)),u.innerHTML=`
        ...
        <span style="margin-left: 6px; font-size: 12px; font-weight: 500;">${R(`formInput`)}</span>
      `,u.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),this.openSettingsModal(!1),this.queryModalElement(`${Z.modalTabs}[data-tab="search"]`)?.click();let t=this.queryModalElement(Z.searchAnimeTitle),n=this.queryModalElement(Z.searchEpisodeNumber),r=this.queryModalElement(Z.searchEpisodeTitle);t&&(t.value=i),n&&a&&(n.value=a),r&&o&&(r.value=o),t?.focus({preventScroll:!0});let s=[i];a&&s.push(a),o&&s.push(o),H.show(L(`searchFormFilled`,{keyword:s.join(` `)}),`success`)}),c.appendChild(u);let d=r.parentElement;if(d){let e=d.querySelector(`.iconContainer`);e?d.insertBefore(s,e):d.appendChild(s)}e.dataset.autoFillEnabled=`true`})}async waitMypageListStable(){}tryRestoreByDanimeIds(){return!1}createSettingsUI(){let e=document.createElement(`div`);e.className=`nico-comment-shadow-host settings-host`,this.createShadowDOM(e),this.addStyles(V.getCommonStyles());let t=this.buildSettingsHtml();return this.setHTML(t),this.applySettingsToUI(),this.addStyles(za),this.setupEventListeners(),e}buildSettingsHtml(){let e=e=>typeof e==`number`?e.toLocaleString():`-`,t=e=>{if(!e)return`-`;try{return new Date(e).toLocaleDateString(`ja-JP`,{year:`numeric`,month:`2-digit`,day:`2-digit`})}catch{return e}},n=this.currentVideoInfo,r=n?.thumbnail??``;return`
      <div class="nico-comment-settings">
        <h2>
          <span class="settings-title">d-anime-nico-comment-renderer</span>
          <span class="version-badge" aria-label="Version">${Vr}</span>
        </h2>
        ...
        <div class="video-card${n?.videoId?``:` video-card--empty`}">
          ...
          <div class="video-card__body">
            ...
            <div class="video-card__thumbnail">
              <img id="currentThumbnail" src="${r}" alt="${R(`thumbnail`)}">
            </div>
            ...
            <div class="video-card__info">
              ...
              <div class="video-card__meta-row">
                <div class="video-card__id" title="${R(`videoId`)}">
                  <span class="video-card__id-icon" aria-hidden="true">${Da}</span>
                  <span class="sr-only">${R(`videoId`)}</span>
                  <span id="currentVideoId">${n?.videoId??R(`currentVideoUnset`)}</span>
                </div>
                <div class="video-card__date" title="${R(`postedAt`)}">
                  <span class="video-card__date-icon" aria-hidden="true">${Na}</span>
                  <span class="sr-only">${R(`postedAt`)}</span>
              ...
              <div class="video-card__main">
                <h3 class="video-card__title" id="currentTitle">${n?.title??R(`currentVideoUnset`)}</h3>
                <div class="video-card__owner" title="${R(`videoOwner`)}">
                  <span class="video-card__owner-icon" aria-hidden="true">${ka}</span>
                  <span class="sr-only">${R(`videoOwner`)}</span>
              ...
              <div class="video-card__stats">
                <div class="video-card__stat" title="${R(`viewCountLong`)}">
                  <span class="video-card__stat-icon" aria-hidden="true">${Aa}</span>
                  <span class="sr-only">${R(`viewCountLong`)}</span>
                  <span class="video-card__stat-value" id="currentViewCount">${e(n?.viewCount)}</span>
                </div>
                <div class="video-card__stat" title="${R(`commentCountLong`)}">
                  <span class="video-card__stat-icon" aria-hidden="true">${ja}</span>
                  <span class="sr-only">${R(`commentCountLong`)}</span>
                  <span class="video-card__stat-value" id="currentCommentCount">${e(n?.commentCount)}</span>
                </div>
                <div class="video-card__stat" title="${R(`mylistCountLong`)}">
                  <span class="video-card__stat-icon" aria-hidden="true">${Ma}</span>
                  <span class="sr-only">${R(`mylistCountLong`)}</span>
      ...
      <div id="settingsModal" class="settings-modal hidden" role="dialog" aria-modal="true" aria-labelledby="settingsModalTitle" aria-hidden="true">
        ...
        <div class="settings-modal__content">
          <header class="settings-modal__header">
            <h3 id="settingsModalTitle">${R(`settings`)}</h3>
            <button id="closeSettingsModal" class="settings-modal__close" type="button" aria-label="${R(`settingsClose`)}">
          ...
          <div class="settings-modal__tabs" role="tablist">
            <button class="settings-modal__tab is-active" type="button" data-tab="search" role="tab" aria-selected="true" aria-controls="settingsPaneSearch" id="settingsTabSearch">
              ...
              <span class="settings-modal__tab-label">${R(`searchTab`)}</span>
            </button>
            <button class="settings-modal__tab" type="button" data-tab="ng" role="tab" aria-selected="false" aria-controls="settingsPaneNg" id="settingsTabNg" tabindex="-1">
              <span class="settings-modal__tab-icon" aria-hidden="true">${Ea}</span>
              <span class="settings-modal__tab-label">${R(`ngTab`)}</span>
            </button>
          </div>
              ...
              <div class="setting-group search-section">
                ...
                >
                  ...
                  <div class="playback-option__text">
                    <span class="playback-option__title">${R(`autoSearch`)}</span>
                    <span class="playback-option__desc">${R(`autoSearchDescription`)}</span>
                  </div>
                  ...
                  <div class="info-badge" id="autoSearchInfoBadge" tabindex="0" aria-label="${R(`autoSearchInfo`)}">
                    ${Ia}
                  </div>
                </div>

                <div class="search-mode-switch">
                  <span class="search-mode-switch__label search-mode-switch__label--active" id="searchModeLabelStructured">${R(`structuredInput`)}</span>
                  <label class="search-mode-switch__toggle" aria-label="${R(`searchInputModeToggle`)}">
                  ...
                  <span class="search-mode-switch__label" id="searchModeLabelFree">${R(`freeInput`)}</span>
                </div>

                <div class="search-fields" id="searchStructuredFields">
                  <div class="search-field">
                    <label for="searchAnimeTitle" class="search-field__label">${R(`animeTitle`)}</label>
                    <input type="text" id="searchAnimeTitle" class="search-field__input" placeholder="${R(`searchAnimePlaceholder`)}">
                  </div>
                  <div class="search-field-row">
                    <div class="search-field search-field--half">
                      <label for="searchEpisodeNumber" class="search-field__label">${R(`episodeNumber`)}</label>
                      <input type="text" id="searchEpisodeNumber" class="search-field__input" placeholder="${R(`searchEpisodeNumberPlaceholder`)}">
                    </div>
                    <div class="search-field search-field--half">
                      <label for="searchEpisodeTitle" class="search-field__label">${R(`episodeTitleOptional`)}</label>
                      <input type="text" id="searchEpisodeTitle" class="search-field__input" placeholder="${R(`searchEpisodeTitlePlaceholder`)}">
                    </div>
                  </div>
                </div>
                ...
                <div class="search-free-input" id="searchFreeInputArea" style="display:none;">
                  <div class="search-field">
                    <label for="searchInput" class="search-field__label">${R(`searchFreeword`)}</label>
                    <input type="text" id="searchInput" class="search-field__input" placeholder="${R(`manualSearchPlaceholder`)}">
                  </div>
                </div>

                <div class="search-container">
                  <button id="searchButton">${R(`search`)}</button>
                  <button id="openSearchPageDirect" class="open-search-page-direct-btn">${R(`searchPage`)}</button>
                  <div class="shield-badge" tabindex="0" aria-label="${R(`officialVideoSafeguardInfo`)}">
                    ${Ra}
                  </div>
                </div>
            ...
            <section class="settings-modal__pane" data-pane="ng" role="tabpanel" id="settingsPaneNg" aria-labelledby="settingsTabNg" aria-hidden="true">
              <div class="setting-group ng-settings">
                <div class="ng-settings__column" aria-labelledby="ngWordsTitle">
                  <h3 id="ngWordsTitle" class="ng-settings__title">${R(`ngWords`)}</h3>
                  <textarea class="ng-settings__textarea" id="ngWords" placeholder="${R(`ngWordsPlaceholder`)}">${(this.settings.ngWords??[]).join(`
`)}</textarea>
                </div>
                <div class="ng-settings__column" aria-labelledby="ngRegexTitle">
                  <h3 id="ngRegexTitle" class="ng-settings__title">${R(`ngRegex`)}</h3>
                  <textarea class="ng-settings__textarea" id="ngRegexps" placeholder="${R(`ngRegexPlaceholder`)}">${(this.settings.ngRegexps??[]).join(`
`)}</textarea>
                </div>
              </div>
            </section>
    ...
    `}setupEventListeners(){this.setupModalControls(),this.setupModalTabs(),this.setupAutoSearchToggle(),this.setupNgControls(),this.setupSaveButton(),this.setupSearch(),this.setupTooltipBadges()}setupModalControls(){this.closeButtonElement?.removeEventListener(`click`,this.handleCloseClick),this.overlayElement?.removeEventListener(`click`,this.handleOverlayClick);let e=this.createOrUpdateFab(),t=this.queryModalElement(Z.settingsModal),n=this.queryModalElement(Z.closeSettingsModal),r=this.queryModalElement(Z.modalOverlay);this.modalElement=t??null,this.closeButtonElement=n??null,this.overlayElement=r??null,!(!t||!n||!r||!e)&&(this.fabElement?.removeEventListener(`click`,this.handleFabClick),e.addEventListener(`click`,this.handleFabClick),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-haspopup`,`dialog`),e.setAttribute(`aria-expanded`,`false`),this.fabElement=e,n.addEventListener(`click`,this.handleCloseClick),r.addEventListener(`click`,this.handleOverlayClick),this.shadowRoot?.addEventListener(`keydown`,e=>{let t=e;t.key===`Escape`&&!this.modalElement?.classList.contains(`hidden`)&&(t.preventDefault(),this.closeSettingsModal())}),this.applySettingsToUI())}setupModalTabs(){let e=Array.from(this.queryModalSelectorAll(Z.modalTabs)),t=Array.from(this.queryModalSelectorAll(Z.modalPane));if(e.length===0||t.length===0)return;let n=n=>{e.forEach(e=>{let t=this.toModalTabKey(e.dataset.tab)===n;e.classList.toggle(`is-active`,t),e.setAttribute(`aria-selected`,String(t)),e.setAttribute(`tabindex`,t?`0`:`-1`)}),t.forEach(e=>{let t=this.toModalTabKey(e.dataset.pane)===n;e.classList.toggle(`is-active`,t),e.setAttribute(`aria-hidden`,String(!t))}),this.activeTab=n};e.forEach(t=>{t.addEventListener(`click`,()=>{let e=this.toModalTabKey(t.dataset.tab);e&&n(e)}),t.addEventListener(`keydown`,r=>{let i=r;if(i.key!==`ArrowRight`&&i.key!==`ArrowLeft`)return;i.preventDefault();let a=this.toModalTabKey(t.dataset.tab);if(!a)return;let o=i.key===`ArrowRight`?1:-1,s=Q[(Q.indexOf(a)+o+Q.length)%Q.length];n(s),e.find(e=>this.toModalTabKey(e.dataset.tab)===s)?.focus({preventScroll:!0})})}),n(this.activeTab)}openSettingsModal(e=!0){!this.modalElement||!this.fabElement||(this.modalElement.classList.remove(`hidden`),this.modalElement.setAttribute(`aria-hidden`,`false`),this.fabElement.setAttribute(`aria-expanded`,`true`),e&&this.queryModalElement(`${Z.modalTabs}.is-active`)?.focus({preventScroll:!0}))}closeSettingsModal(){!this.modalElement||!this.fabElement||(this.modalElement.classList.add(`hidden`),this.modalElement.setAttribute(`aria-hidden`,`true`),this.fabElement.setAttribute(`aria-expanded`,`false`),this.fabElement?.isConnected&&this.fabElement.focus({preventScroll:!0}))}toModalTabKey(e){return e&&Q.includes(e)?e:null}setupAutoSearchToggle(){let e=this.queryModalElement(Z.autoSearchToggle),t=this.queryModalElement(Z.autoSearchOptionRow);if(!e||!t)return;let n=()=>{this.settings.autoSearchEnabled=!this.settings.autoSearchEnabled,this.updateAutoSearchToggleState(),this.updateSearchSectionNote(),this.settingsManager.updateSettings(this.settings),H.show(this.settings.autoSearchEnabled?R(`autoSearchEnabled`):R(`autoSearchDisabledManual`),`success`)};t.addEventListener(`click`,e=>{e.target.closest(`.playback-option__toggle`)||n()}),t.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),n())}),e.addEventListener(`change`,()=>{n()}),this.updateAutoSearchToggleState()}updateAutoSearchToggleState(){let e=this.settings.autoSearchEnabled,t=this.queryModalElement(Z.autoSearchToggle),n=this.queryModalElement(Z.autoSearchOptionRow),r=n?.querySelector(`.playback-option__icon-wrapper`);t&&(t.checked=e),n&&(n.classList.toggle(`playback-option--active`,e),n.setAttribute(`aria-pressed`,e?`true`:`false`)),r&&r.classList.toggle(`playback-option__icon-wrapper--active`,e)}buildAutoSearchTooltipHtml(){return this.settings.autoSearchEnabled?`<strong style="color:#7F5AF0;">自動設定機能が有効です</strong><br>
      ...
      <div class="search-result-item">
        ...
        <div class="search-result-info">
          ...
          <div class="stats">
            <span class="stat-icon" title="${R(`viewCount`)}">
              ${Ca}
            </span>
            <span>${e.viewCount.toLocaleString()}</span>
            <span style="margin: 0 8px;">/</span>
            <span class="stat-icon" title="${R(`commentCount`)}">
              ${Pa}
            </span>
            <span>${e.commentCount.toLocaleString()}</span>
            <span style="margin: 0 8px;">/</span>
            <span class="stat-icon" title="${R(`mylistCount`)}">
              ${Fa}
            </span>
...
`).map(e=>e.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings),H.show(R(`settingsSaved`),`success`)}updateCurrentVideoInfo(e){this.currentVideoInfo=e,[[`currentTitle`,e.title??`-`],[`currentVideoId`,e.videoId??`-`],[`currentOwner`,e.owner?.nickname??e.channel?.name??`-`],[`currentViewCount`,this.formatNumber(e.viewCount)],[`currentCommentCount`,this.formatNumber(e.commentCount)],[`currentMylistCount`,this.formatNumber(e.mylistCount)],[`currentPostedAt`,this.formatSearchResultDate(e.postedAt)]].forEach(([e,t])=>{let n=this.querySelector(Z[e]);n&&(n.textContent=t)});let t=this.querySelector(Z.currentThumbnail);t&&e.thumbnail&&(t.src=e.thumbnail,t.alt=e.title??R(`thumbnail`));let n=this.querySelector(`#currentVideoAmbient`);n&&e.thumbnail&&(n.style.backgroundImage=`url('${e.thumbnail}')`);let r=this.querySelector(`.video-card`);r&&r.classList.toggle(`video-card--empty`,!e.videoId);try{this.settingsManager.saveVideoData(e.title??``,e)}catch(e){X.error(`SettingsUI.updateCurrentVideoInfo`,e)}}formatNumber(e){return typeof e==`number`?e.toLocaleString():`-`}formatSearchResultDate(e){if(!e)return`-`;let t=new Date(e);return Number.isNaN(t.getTime())?e:new Intl.DateTimeFormat(`ja-JP`,{year:`numeric`,month:`2-digit`,day:`2-digit`,hour:`2-digit`,minute:`2-digit`,hourCycle:`h23`}).format(t)}destroy(){this.hideFabTooltip(),this.fabTooltipEl=null,this.closeButtonElement?.removeEventListener(`click`,this.handleCloseClick),this.overlayElement?.removeEventListener(`click`,this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),super.destroy()}createOrUpdateFab(){if(!document.body)return null;let t=this.fabHostElement;!t||!t.isConnected?(t?.remove(),t=document.createElement(`div`),t.id=e.FAB_HOST_ID,t.style.position=`fixed`,t.style.bottom=`32px`,t.style.right=`32px`,t.style.zIndex=`2147483646`,t.style.display=`inline-block`,this.fabShadowRoot=t.attachShadow({mode:`open`}),document.body.appendChild(t),this.fabHostElement=t):this.fabShadowRoot||=t.shadowRoot??t.attachShadow({mode:`open`});let n=this.fabShadowRoot;if(!n)return null;let r=n.querySelector(`style[data-role='fab-base-style']`);r||(r=document.createElement(`style`),r.dataset.role=`fab-base-style`,r.textContent=V.getCommonStyles(),n.appendChild(r));let i=n.querySelector(`style[data-role='fab-style']`);i||(i=document.createElement(`style`),i.dataset.role=`fab-style`,i.textContent=`
    ...
    `}buildPanelHTML(e,t){let n=e.isCommentVisible?Y:Ea,r=Math.round((e.commentOpacity??1)*100),i=t.fixedRate.toFixed(2),a=t.fixedModeEnabled?``:`disabled`;return`
      <p class="panel__title">${R(`commentSettings`)}</p>

      <div class="row">
        <span class="row__label">
          <span id="pcb-vis-icon">${n}</span>${R(`commentVisibility`)}
        </span>
        <label class="toggle" aria-label="${R(`commentVisibilityToggle`)}">
      ...
      <div class="row">
        <span class="row__label">${R(`color`)}</span>
        <input type="color" id="pcb-color" class="color-picker"
               value="${e.commentColor}" title="${R(`commentColor`)}">
      </div>

      <div class="row row--stacked">
        <span class="row__label">${R(`commentOpacity`)}</span>
      ...
      <p class="section-title">${R(`playbackRate`)}</p>

      <div class="row">
        <span class="row__label">${R(`fixedPlaybackRate`)}</span>
        <label class="toggle" aria-label="${R(`playbackRateFixedToggle`)}">
    ...
    `}bindPanelEvents(e){let t=e.getElementById(`pcb-visibility`);t?.addEventListener(`change`,()=>{let n=e.getElementById(`pcb-vis-icon`);n&&(n.innerHTML=t.checked?Y:Ea),this.settingsManager.updateSettings({isCommentVisible:t.checked})});let n=e.getElementById(`pcb-color`);n?.addEventListener(`input`,()=>{this.settingsManager.updateSettings({commentColor:n.value})});let r=e.getElementById(`pcb-opacity`),i=e.getElementById(`pcb-opacity-val`);r?.addEventListener(`input`,()=>{let e=parseFloat(r.value);i&&(i.textContent=`${Math.round(e*100)}%`),this.settingsManager.updateSettings({commentOpacity:e})});let a=e.getElementById(`pcb-speed-mode`),o=e.getElementById(`pcb-speed-range`),s=e.getElementById(`pcb-speed-val`);a?.addEventListener(`change`,()=>{o&&(o.disabled=!a.checked),this.settingsManager.updatePlaybackSettings({fixedModeEnabled:a.checked})}),o?.addEventListener(`input`,()=>{let e=parseFloat(o.value);s&&(s.textContent=`${e.toFixed(2)}×`),this.settingsManager.updatePlaybackSettings({fixedRate:e})})}openPanel(){if(this.isOpen)return;let e=this.panelShadowRoot?.querySelector(`.panel`),t=this.btnWrapper?.querySelector(`button`);e&&(e.removeAttribute(`hidden`),t?.setAttribute(`aria-expanded`,`true`),this.isOpen=!0)}closePanel(){let e=this.panelShadowRoot?.querySelector(`.panel`),t=this.btnWrapper?.querySelector(`button`);e?.setAttribute(`hidden`,``),t?.setAttribute(`aria-expanded`,`false`),this.isOpen=!1}scheduleHide(){this.cancelHideTimer(),this.mouseHideTimer=window.setTimeout(()=>{this.closePanel()},Qa)}cancelHideTimer(){this.mouseHideTimer!==null&&(window.clearTimeout(this.mouseHideTimer),this.mouseHideTimer=null)}registerObservers(){this.settingsObserver=e=>{this.syncSettingsToPanel(e)},this.settingsManager.addObserver(this.settingsObserver),this.playbackObserver=e=>{this.syncPlaybackToPanel(e)},this.settingsManager.addPlaybackObserver(this.playbackObserver)}syncSettingsToPanel(e){let t=this.panelShadowRoot;if(!t)return;let n=t.getElementById(`pcb-visibility`);n&&(n.checked=e.isCommentVisible);let r=t.getElementById(`pcb-vis-icon`);r&&(r.innerHTML=e.isCommentVisible?Y:Ea);let i=t.getElementById(`pcb-color`);i&&(i.value=e.commentColor);let a=t.getElementById(`pcb-opacity`),o=t.getElementById(`pcb-opacity-val`);a&&(a.value=String(e.commentOpacity??1)),o&&(o.textContent=`${Math.round((e.commentOpacity??1)*100)}%`)}syncPlaybackToPanel(e){let t=this.panelShadowRoot;if(!t)return;let n=t.getElementById(`pcb-speed-mode`);n&&(n.checked=e.fixedModeEnabled);let r=t.getElementById(`pcb-speed-range`);r&&(r.disabled=!e.fixedModeEnabled,r.value=e.fixedRate.toFixed(2));let i=t.getElementById(`pcb-speed-val`);i&&(i.textContent=`${e.fixedRate.toFixed(2)}×`)}},eo=e=>e.autoSearchEnabled?`auto`:`manual`,to=100,no=1e3,ro=3e3,io=2e3,ao=`cachedAnimeTitle`,$=r(`dAnime:WatchPageController`),oo=class{global;initialized=!1;switchDebounce=new Mi(no);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;playbackRateController=null;playerControlButton=null;lastPartId=null;partIdMonitorIntervalId=null;isPartIdChanging=!1;cachedAnimeTitle=null;lastEpisodeNumber=null;rendererSettingsObserver=null;constructor(e){this.global=e;try{this.cachedAnimeTitle=P(ao,null),this.cachedAnimeTitle&&$.info(`watchPageController:constructor:loadedCachedTitle`,{cachedAnimeTitle:this.cachedAnimeTitle})}catch(e){$.error(`watchPageController:constructor:loadCacheFailed`,e),this.cachedAnimeTitle=null}}async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement()}async ensureDocumentReady(){document.readyState!==`complete`&&await new Promise(e=>{window.addEventListener(`load`,()=>e(),{once:!0})})}waitForVideoElement(){if(this.initialized)return;let e=document.querySelector(G.watchVideoElement);if(!e){window.setTimeout(()=>this.waitForVideoElement(),to);return}if(e.readyState===0){e.addEventListener(`loadedmetadata`,()=>{this.initializeWithVideo(e)},{once:!0});return}this.initializeWithVideo(e)}async initializeWithVideo(e){if(!this.initialized){this.initialized=!0;try{H.show(R(`initializingCommentLoader`));let t=H.getInstance(),n=this.global.settingsManager??new si(t);this.global.settingsManager=n,this.global.instances.settingsManager=n,this.playerControlButton||(this.playerControlButton=new $a(n),this.playerControlButton.mount());let r=n.loadSettings();if(eo(r)===`manual`){$.info(`watchPageController:initializeWithVideo:manualMode`,{autoSearchEnabled:r.autoSearchEnabled});let t=n.loadVideoData();if(!t?.videoId){H.show(R(`manualModeSelectVideo`),`info`);return}$.info(`watchPageController:initializeWithVideo:manualMode:loadSavedVideo`,{videoId:t.videoId,title:t.title}),await this.loadCommentsFromSavedVideo(e,n,t);return}if(await this.waitForMetadataElements(),!await this.autoSetupComments(n))throw Error(R(`metadataAutoFetchFailed`));let i=n.loadVideoData();if(!i?.videoId)throw Error(R(`videoDataMissing`));let a=new U;this.global.instances.fetcher=a,await a.fetchApiData(i.videoId);let o=await a.fetchComments(),s=new B(this.mergeSettings(n.loadSettings()));s.initialize(e),this.global.instances.renderer=s,this.currentVideoElement=e;let c=this.playbackRateController??new Ka(n);this.playbackRateController=c,this.global.instances.playbackRateController=c,c.bind(e),this.ensureRendererSettingsObserver(n),this.applyRendererSettings(n.loadSettings()),o.forEach(e=>{s.addComment(e.text,e.vposMs,e.commands)});let l=new Wi(s,a,n);l.startMonitoring(),this.global.instances.switchHandler=l,this.setupSwitchHandling(e,l),this.observeVideoElement(),this.startPartIdMonitoring(),H.show(L(`commentsLoadComplete`,{count:String(o.length)}),`success`)}catch(e){throw this.initialized=!1,H.show(L(`initializationError`,{message:e.message}),`error`),e}}}mergeSettings(e){let t=N();return{...t,...e,ngWords:[...e.ngWords??t.ngWords],ngRegexps:[...e.ngRegexps??t.ngRegexps]}}ensureRendererSettingsObserver(e){this.rendererSettingsObserver||(this.rendererSettingsObserver=e=>{this.applyRendererSettings(e)},e.addObserver(this.rendererSettingsObserver))}applyRendererSettings(e){let t=this.global.instances.renderer;if(!t)return;let n=this.mergeSettings(e);t.settings.isCommentVisible!==n.isCommentVisible&&t.setCommentVisibility(n.isCommentVisible),t.settings=n}setupSwitchHandling(e,t){this.currentVideoElement=e,this.switchCallback=()=>{if(this.isPartIdChanging){$.info(`watchPageController:switchBlocked`,{reason:`partId change in progress`});return}let e=Date.now();if(e-this.lastSwitchTimestamp<ro){$.debug(`watchPageController:switchCooldown`,{timeSinceLastSwitch:e-this.lastSwitchTimestamp,cooldownMs:ro});return}this.lastSwitchTimestamp=e;let n=this.currentVideoElement;$.info(`watchPageController:switchHandlerTriggered`,{currentTime:n?.currentTime??null,duration:n?.duration??null}),t.onVideoSwitch(n)},this.global.utils.initializeWithVideo=async e=>{e&&(this.rebindVideoElement(e),this.playbackRateController?.bind(e),await t.onVideoSwitch(e))},this.currentVideoElement=e}observeVideoElement(){let e=this.currentVideoElement;e&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{let e=document.querySelector(G.watchVideoElement);!e||e===this.currentVideoElement||this.rebindVideoElement(e)}),this.domMutationObserver.observe(document.body,{childList:!0,subtree:!0}),this.attachVideoEventListeners(e))}rebindVideoElement(e){this.detachVideoEventListeners(),this.currentVideoElement=e;let t=this.global.instances.renderer,n=this.global.instances.switchHandler;t&&(t.clearComments(),t.destroy(),t.initialize(e),t.resize()),this.playbackRateController?.bind(e),n&&(n.onVideoSwitch(e),this.setupSwitchHandling(e,n)),this.attachVideoEventListeners(e)}attachVideoEventListeners(e){this.detachVideoEventListeners(),Fi().attach(e);let t=t=>{if(!this.switchCallback)return;let n=t.type,r=this.hasVideoSourceChanged(e);if(n===`ended`){$.info(`watchPageController:skipSwitchOnEnded`,{eventType:n,currentTime:e.currentTime,duration:e.duration,ended:e.ended,paused:e.paused,currentSrc:e.currentSrc||e.getAttribute(`src`)||null,sourceChanged:r});return}$.info(`watchPageController:eventTriggered`,{eventType:n,currentTime:e.currentTime,duration:e.duration,ended:e.ended,paused:e.paused,sourceChanged:r}),this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback)};e.addEventListener(`ended`,t),e.addEventListener(`loadedmetadata`,t),e.addEventListener(`emptied`,t),this.videoEndedListener=t}detachVideoEventListeners(){let e=this.currentVideoElement;Fi().detach(),e&&this.videoEndedListener&&(e.removeEventListener(`ended`,this.videoEndedListener),e.removeEventListener(`loadedmetadata`,this.videoEndedListener),e.removeEventListener(`emptied`,this.videoEndedListener)),this.videoEndedListener=null}hasVideoSourceChanged(e){let t=e.currentSrc||e.getAttribute(`src`)||e.querySelector(`source[src]`)?.getAttribute(`src`)||null,n=this.global.instances.renderer?.getCurrentVideoSource()??null;return t?!n||n!==t:!1}async waitForMetadataElements(e,t){let n=Date.now();for(let r=0;r<50;r++){let i=this.getCurrentPartId(),a=document.querySelector(G.watchPageAnimeTitle),o=document.querySelector(G.watchPageEpisodeNumber),s=document.querySelector(G.watchPageEpisodeTitle),c=a?.textContent?.trim()??``,l=o?.textContent?.trim()??``,u=s?.textContent?.trim()??``;if(r===0&&$.info(`watchPageController:waitForMetadata:start`,{currentPartId:i,expectedPartId:e,episodeNumber:l,episodeTitle:u,animeTitle:c||`(empty)`,cachedAnimeTitle:this.cachedAnimeTitle||`(empty)`,previousEpisodeNumber:t||`(none)`}),!e&&!this.cachedAnimeTitle&&r<20&&!c){await new Promise(e=>window.setTimeout(e,100));continue}if((!e||i===e)&&l&&u&&(!t||l!==t)){$.info(`watchPageController:waitForMetadata:success`,{attempts:r+1,waited:Date.now()-n,currentPartId:i,expectedPartId:e,episodeNumber:l,episodeTitle:u,animeTitle:c||`(empty)`,previousEpisodeNumber:t||`(none)`});return}await new Promise(e=>window.setTimeout(e,100))}let r=document.querySelector(G.watchPageEpisodeNumber)?.textContent?.trim()??``,i=document.querySelector(G.watchPageEpisodeTitle)?.textContent?.trim()??``;throw $.error(`watchPageController:waitForMetadata:timeout`,{maxRetries:50,waited:Date.now()-n,currentPartId:this.getCurrentPartId(),expectedPartId:e,previousEpisodeNumber:t||`(none)`,finalEpisodeNumber:r,finalEpisodeTitle:i}),Error(`DOM更新のタイムアウト: partId=${e}, 前回エピソード="${t||`なし`}", 現在エピソード="${r}"`)}extractMetadataFromPage(){try{let e=document.querySelector(G.watchPageAnimeTitle),t=document.querySelector(G.watchPageEpisodeNumber),n=document.querySelector(G.watchPageEpisodeTitle),r=e?.textContent?.trim()??``,i=t?.textContent?.trim()??``,a=n?.textContent?.trim()??``;if(r){this.cachedAnimeTitle=r;try{F(ao,r),$.info(`watchPageController:extractMetadata:cachedTitle`,{animeTitle:r})}catch(e){$.error(`watchPageController:extractMetadata:saveCacheFailed`,e)}}else this.cachedAnimeTitle&&(r=this.cachedAnimeTitle,$.info(`watchPageController:extractMetadata:usedCachedTitle`,{cachedAnimeTitle:this.cachedAnimeTitle}));return $.info(`watchPageController:extractMetadata:rawValues`,{animeTitle:r||`(empty)`,animeTitleElementExists:!!e,animeTitleFromCache:!e&&!!this.cachedAnimeTitle,episodeNumber:i,episodeNumberElementExists:!!t,episodeTitle:a,episodeTitleElementExists:!!n,currentPartId:this.getCurrentPartId()}),i?(r||$.warn(`watchPageController:extractMetadata:noAnimeTitle`,{hasCache:!!this.cachedAnimeTitle}),this.lastEpisodeNumber=i,{animeTitle:r,episodeNumber:i,episodeTitle:a}):($.warn(`watchPageController:extractMetadata:insufficient`,{episodeNumber:i||`(empty)`,episodeTitle:a||`(empty)`}),null)}catch(e){return $.error(`watchPageController:extractMetadata:error`,e),null}}async autoSetupComments(e){try{let t=this.extractMetadataFromPage();if(!t)return $.warn(`watchPageController:autoSetup:noMetadata`),!1;if(!t.animeTitle)return $.warn(`watchPageController:autoSetup:noAnimeTitle`,{episodeNumber:t.episodeNumber,episodeTitle:t.episodeTitle,cachedAnimeTitle:this.cachedAnimeTitle}),H.show(R(`noAnimeTitle`),`warning`),!1;let n=[t.animeTitle,t.episodeNumber,t.episodeTitle].filter(Boolean).join(` `);$.info(`watchPageController:autoSetup`,{keyword:n,animeTitle:t.animeTitle,episodeNumber:t.episodeNumber,episodeTitle:t.episodeTitle,usingCachedTitle:!!this.cachedAnimeTitle&&!t.animeTitle}),H.show(L(`searchingKeyword`,{keyword:n}),`info`);let r=await new W().search(n);if(r.length===0)return H.show(R(`niconicoNotFound`),`warning`),!1;let i=W.filterOfficialVideos(r,t.animeTitle);$.info(`watchPageController:autoSetup:officialFilter`,{totalResults:r.length,officialResults:i.length,animeTitle:t.animeTitle}),i.length===0&&($.warn(`watchPageController:autoSetup:noOfficialVideos`,{animeTitle:t.animeTitle,firstResultOwner:r[0]?.owner?.nickname??r[0]?.channel?.name??`不明`}),H.show(R(`officialVideoMissingUseFirst`),`warning`));let a=i.length>0?i[0]:r[0],o={videoId:a.videoId,title:a.title,viewCount:a.viewCount,commentCount:a.commentCount,mylistCount:a.mylistCount,postedAt:a.postedAt,thumbnail:a.thumbnail,owner:a.owner??null,channel:a.channel??null};if(e.saveVideoData(a.title,o)){$.info(`watchPageController:autoSetup:success`,{videoId:a.videoId,title:a.title,commentCount:a.commentCount});let e=a.owner?.nickname||a.channel?.name||`不明`,t=[`<div style="font-weight: 600; margin-bottom: 8px;">${R(`autoSetupComplete`)}</div>`,`<div style="display: flex; align-items: center; gap: 6px; margin-top: 8px;">`,`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Oa}</span>`,`  <span style="flex: 1; word-break: break-word;">${a.title}</span>`,`</div>`,`<div style="display: flex; align-items: center; gap: 6px; margin-top: 4px;">`,`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${ka}</span>`,`  <span>${e}</span>`,`</div>`,`<div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">`,`  <div style="display: flex; align-items: center; gap: 4px;">`,`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Aa}</span>`,`    <span>${a.viewCount.toLocaleString()}</span>`,`  </div>`,`  <div style="display: flex; align-items: center; gap: 4px;">`,`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${ja}</span>`,`    <span>${a.commentCount.toLocaleString()}</span>`,`  </div>`,`</div>`].join(``);return H.show(t,`success`,5e3),!0}return!1}catch(e){return $.error(`watchPageController:autoSetup:error`,e),H.show(L(`autoSetupError`,{message:e.message}),`error`),!1}}getCurrentPartId(){try{return new URLSearchParams(window.location.search).get(`partId`)}catch(e){return $.error(`watchPageController:getCurrentPartId:error`,e),null}}startPartIdMonitoring(){this.stopPartIdMonitoring(),this.lastPartId=this.getCurrentPartId(),this.partIdMonitorIntervalId=window.setInterval(()=>{this.checkPartIdChange()},io)}stopPartIdMonitoring(){this.partIdMonitorIntervalId!==null&&(window.clearInterval(this.partIdMonitorIntervalId),this.partIdMonitorIntervalId=null)}async checkPartIdChange(){let e=this.getCurrentPartId();e===null||e===this.lastPartId||($.warn(`watchPageController:partIdChanged`,{oldPartId:this.lastPartId,newPartId:e,url:window.location.href,timestamp:new Date().toISOString()}),this.lastPartId=e,await this.onPartIdChanged())}async waitForVideoReady(e){let t=Date.now();for($.info(`watchPageController:waitForVideoReady:start`,{readyState:e.readyState,duration:e.duration,src:e.currentSrc});e.readyState<2&&Date.now()-t<5e3;)await new Promise(e=>window.setTimeout(e,100));$.info(`watchPageController:waitForVideoReady:complete`,{readyState:e.readyState,duration:e.duration,waited:Date.now()-t})}async onPartIdChanged(){this.isPartIdChanging=!0;try{let e=this.global.settingsManager;if(!e){$.warn(`watchPageController:onPartIdChanged:noSettingsManager`);return}let t=e.getSettings(),n=this.lastEpisodeNumber??document.querySelector(G.watchPageEpisodeNumber)?.textContent?.trim()??null;if(eo(t)===`manual`){$.info(`watchPageController:onPartIdChanged:manualMode`,{autoSearchEnabled:t.autoSearchEnabled});let r=e.loadManualSearchSettings();if(!r?.animeTitle){H.show(R(`manualModeSelectAnimeTitle`),`info`);let e=this.global.instances.renderer;e&&e.clearComments();return}await this.handleManualModeEpisodeSwitch(e,r.animeTitle,n);return}$.info(`watchPageController:onPartIdChanged:start`,{currentVideoElement:this.currentVideoElement?`present`:`null`,rendererExists:!!this.global.instances.renderer,switchHandlerExists:!!this.global.instances.switchHandler,isPartIdChanging:this.isPartIdChanging,newPartId:this.getCurrentPartId(),previousEpisodeNumber:n}),H.show(R(`episodeChangeDetected`),`info`);let r=this.getCurrentPartId();$.info(`watchPageController:onPartIdChanged:waitingForDomUpdate`,{newPartId:r,previousEpisodeNumber:n});try{await this.waitForMetadataElements(r??void 0,n??void 0)}catch(e){$.error(`watchPageController:onPartIdChanged:waitMetadataFailed`,e),H.show(L(`domUpdateWaitFailed`,{message:e.message}),`error`);return}let i=await this.autoSetupComments(e);if($.info(`watchPageController:onPartIdChanged:autoSetup`,{success:i}),i){let t=e.loadVideoData();$.warn(`watchPageController:onPartIdChanged:loadedVideoData`,{videoId:t?.videoId??null,title:t?.title??null});let n=this.currentVideoElement??document.querySelector(G.watchVideoElement);if($.warn(`watchPageController:onPartIdChanged:videoElement`,{videoElementFound:!!n,currentTime:n?.currentTime??null,duration:n?.duration??null,src:n?.currentSrc??null,readyState:n?.readyState??null}),n&&t?.videoId){await this.waitForVideoReady(n),n.dataset.videoId=t.videoId;let e=this.global.instances.renderer,r=this.global.instances.switchHandler;if($.warn(`watchPageController:onPartIdChanged:beforeSwitch`,{rendererCommentCount:e?.getCommentsSnapshot().length??0,videoCurrentTime:n.currentTime,videoReadyState:n.readyState,videoSrc:n.currentSrc,videoId:t.videoId}),e&&r){$.warn(`watchPageController:onPartIdChanged:destroyBefore`,{commentsBeforeDestroy:e.getCommentsSnapshot().length,currentVideoSrc:e.getCurrentVideoSource(),videoElement:e.getVideoElement()?`attached`:`detached`});let t=e.settings;e.destroy(),$.warn(`watchPageController:onPartIdChanged:createNew`,{savedSettings:t});let i=new B(t,{loggerNamespace:`dAnime:CommentRenderer`});this.global.instances.renderer=i,$.warn(`watchPageController:onPartIdChanged:reinitialize`,{videoElementSrc:n.currentSrc,videoElementReadyState:n.readyState,videoElementCurrentTime:n.currentTime}),i.initialize(n),$.warn(`watchPageController:onPartIdChanged:reinitializeComplete`,{commentsAfterReinitialize:i.getCommentsSnapshot().length,newVideoSrc:i.getCurrentVideoSource()}),r.updateRenderer(i),r.resetVideoSource(),await r.onVideoSwitch(n),$.warn(`watchPageController:onPartIdChanged:afterSwitch`,{rendererCommentCount:i.getCommentsSnapshot().length,videoCurrentTime:n.currentTime,finalVideoSrc:i.getCurrentVideoSource()})}}}$.info(`watchPageController:onPartIdChanged:complete`)}catch(e){$.error(`watchPageController:onPartIdChanged:error`,e),H.show(L(`episodeSwitchError`,{message:e.message}),`error`)}finally{this.isPartIdChanging=!1,$.info(`watchPageController:onPartIdChanged:flagReset`,{isPartIdChanging:this.isPartIdChanging})}}async loadCommentsFromSavedVideo(e,t,n){try{let r=new U;this.global.instances.fetcher=r,await r.fetchApiData(n.videoId);let i=await r.fetchComments(),a=new B(this.mergeSettings(t.loadSettings()));a.initialize(e),this.global.instances.renderer=a,this.currentVideoElement=e;let o=this.playbackRateController??new Ka(t);this.playbackRateController=o,this.global.instances.playbackRateController=o,o.bind(e),this.ensureRendererSettingsObserver(t),this.applyRendererSettings(t.loadSettings()),i.forEach(e=>{a.addComment(e.text,e.vposMs,e.commands)});let s=new Wi(a,r,t);s.startMonitoring(),this.global.instances.switchHandler=s,this.setupSwitchHandling(e,s),this.observeVideoElement(),this.startPartIdMonitoring(),H.show(L(`manualModeCommentsLoadComplete`,{count:String(i.length),title:n.title}),`success`)}catch(e){$.error(`watchPageController:loadCommentsFromSavedVideo:error`,e),H.show(L(`commentsLoadErrorSelectAnother`,{message:e.message}),`error`)}}async handleManualModeEpisodeSwitch(e,t,n){try{let r=this.getCurrentPartId();$.info(`watchPageController:manualModeSwitch:waitingForDomUpdate`,{newPartId:r,previousEpisodeNumber:n,savedAnimeTitle:t});try{await this.waitForMetadataElements(r??void 0,n??void 0)}catch(e){$.error(`watchPageController:manualModeSwitch:waitMetadataFailed`,e),H.show(L(`domUpdateWaitFailed`,{message:e.message}),`error`);return}let i=document.querySelector(G.watchPageEpisodeNumber)?.textContent?.trim()??``;if(!i){$.warn(`watchPageController:manualModeSwitch:noEpisodeNumber`),H.show(R(`episodeNumberMissing`),`warning`);return}let a=`${t} ${i}`;$.info(`watchPageController:manualModeSwitch:search`,{keyword:a,savedAnimeTitle:t,newEpisodeNumber:i}),H.show(L(`searchingKeyword`,{keyword:a}),`info`);let o=await new W().search(a);if(o.length===0){H.show(R(`niconicoNotFoundManual`),`warning`);let e=this.global.instances.renderer;e&&e.clearComments();return}let s=W.filterOfficialVideos(o,t);if($.info(`watchPageController:manualModeSwitch:officialFilter`,{totalResults:o.length,officialResults:s.length,savedAnimeTitle:t}),s.length===0){H.show(R(`officialVideoMissingManual`),`warning`);let e=this.global.instances.renderer;e&&e.clearComments();return}let c=s[0],l={videoId:c.videoId,title:c.title,viewCount:c.viewCount,commentCount:c.commentCount,mylistCount:c.mylistCount,postedAt:c.postedAt,thumbnail:c.thumbnail,owner:c.owner??null,channel:c.channel??null};e.saveVideoData(c.title,l),e.saveManualSearchSettings({animeTitle:t,episodeNumber:i,episodeTitle:``});let u=this.currentVideoElement??document.querySelector(G.watchVideoElement);if(u){await this.waitForVideoReady(u),u.dataset.videoId=c.videoId;let e=this.global.instances.renderer,t=this.global.instances.switchHandler;if(e&&t){let n=e.settings;e.destroy();let r=new B(n,{loggerNamespace:`dAnime:CommentRenderer`});this.global.instances.renderer=r,r.initialize(u),t.updateRenderer(r),t.resetVideoSource(),await t.onVideoSwitch(u)}}let d=c.owner?.nickname??c.channel?.name??`不明`,f=[`<div style="font-weight: 600; margin-bottom: 8px;">${R(`nextEpisodeAutoSetupComplete`)}</div>`,`<div style="display: flex; align-items: center; gap: 6px; margin-top: 8px;">`,`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Oa}</span>`,`  <span style="flex: 1; word-break: break-word;">${c.title}</span>`,`</div>`,`<div style="display: flex; align-items: center; gap: 6px; margin-top: 4px;">`,`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${ka}</span>`,`  <span>${d}</span>`,`</div>`,`<div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">`,`  <div style="display: flex; align-items: center; gap: 4px;">`,`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Aa}</span>`,`    <span>${c.viewCount.toLocaleString()}</span>`,`  </div>`,`  <div style="display: flex; align-items: center; gap: 4px;">`,`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${ja}</span>`,`    <span>${c.commentCount.toLocaleString()}</span>`,`  </div>`,`</div>`].join(``);H.show(f,`success`,5e3),$.info(`watchPageController:manualModeSwitch:success`,{videoId:c.videoId,title:c.title,commentCount:c.commentCount})}catch(e){$.error(`watchPageController:manualModeSwitch:error`,e),H.show(L(`episodeSwitchError`,{message:e.message}),`error`)}}},so=100,co=class{global;constructor(e){this.global=e}initialize(){let e=H.getInstance(),t=this.global.settingsManager??new si(e);this.global.settingsManager=t,this.global.instances.settingsManager=t;let n=new Va(t);this.waitForHeader(n)}waitForHeader(e){if(!document.querySelector(G.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(e),so);return}e.insertIntoMypage(),e.addAutoCommentButtons(),this.observeList(e)}observeList(e){let t=document.querySelector(G.mypageListContainer);t&&new MutationObserver(()=>{try{e.addAutoCommentButtons()}catch(e){console.error(`[MypageController] auto comment buttons update failed`,e)}}).observe(t,{childList:!0,subtree:!0})}},lo=class{log;global=Ja();watchController=null;mypageController=null;constructor(){this.log=r(`DanimeApp`)}start(){this.log.info(`starting renderer`),Ki.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener(`load`,()=>{this.initialize()})}async initialize(){if(!this.acquireInstanceLock()){this.log.info(`renderer already initialized, skipping`);return}let e=location.pathname.toLowerCase();try{e.includes(`/animestore/sc_d_pc`)?(this.watchController=new oo(this.global),await this.watchController.initialize()):e.includes(`/animestore/mp_viw_pc`)?(this.mypageController=new co(this.global),this.mypageController.initialize()):this.log.info(`page not supported, initialization skipped`)}catch(e){this.log.error(`initialization failed`,e)}}acquireInstanceLock(){let e=i();return e.__dAnimeNicoCommentRenderer2Instance=(e.__dAnimeNicoCommentRenderer2Instance??0)+1,e.__dAnimeNicoCommentRenderer2Instance===1}},uo=r(`dAnimeNicoCommentRenderer2`);async function fo(){uo.info(`bootstrap start`);try{new lo().start(),uo.info(`bootstrap completed`)}catch(e){uo.error(`bootstrap failed`,e)}}fo()})();
