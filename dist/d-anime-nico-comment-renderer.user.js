...
(function () {
  ...
  const Pt={debug:"debug",info:"info",warn:"warn",error:"error"},F=e=>{const t=`[${e}]`,n={};return Object.keys(Pt).forEach(i=>{const r=Pt[i];n[i]=(...s)=>{(console[r]??console.log)(t,...s);};}),n};function vt(){return typeof unsafeWindow<"u"?unsafeWindow:window}const De={small:.8,medium:1,big:1.4},He={defont:'"MS PGothic","Hiragino Kaku Gothic ProN","Hiragino Kaku Gothic Pro","Yu Gothic UI","Yu Gothic","Meiryo","Segoe UI","Osaka","Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","IPAPGothic","TakaoPGothic","Roboto","Helvetica Neue","Helvetica","Arial","sans-serif"',gothic:'"Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","Yu Gothic","Yu Gothic Medium","Meiryo","MS PGothic","Hiragino Kaku Gothic ProN","Segoe UI","Helvetica","Arial","sans-serif"',mincho:'"MS PMincho","MS Mincho","Hiragino Mincho ProN","Hiragino Mincho Pro","Yu Mincho","Noto Serif CJK JP","Noto Serif JP","Source Han Serif JP","Times New Roman","serif"'},ne={white:"#FFFFFC",red:"#FF8888",pink:"#FFA5CC",orange:"#FFBA66",yellow:"#FFFFAA",green:"#88FF88",cyan:"#88FFFF",blue:"#8899FF",purple:"#D9A5FF",black:"#444444",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},xt=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,Oe=/^[,.:;]+/,Ne=/[,.:;]+$/,ze=e=>{const t=e.trim();return t?xt.test(t)?t:t.replace(Oe,"").replace(Ne,""):""},$e=e=>xt.test(e)?e.toUpperCase():null,ie=e=>{const t=e.trim();if(!t)return null;const n=t.toLowerCase().endsWith("px")?t.slice(0,-2):t,i=Number.parseFloat(n);return Number.isFinite(i)?i:null},We=e=>{const t=e.trim();if(!t)return null;if(t.endsWith("%")){const n=Number.parseFloat(t.slice(0,-1));return Number.isFinite(n)?n/100:null}return ie(t)},qe=e=>Number.isFinite(e)?Math.min(100,Math.max(-100,e)):0,Be=e=>!Number.isFinite(e)||e===0?1:Math.min(5,Math.max(.25,e)),Ue=e=>e==="naka"||e==="ue"||e==="shita",Ge=e=>e==="small"||e==="medium"||e==="big",Ke=e=>e==="defont"||e==="gothic"||e==="mincho",Ye=e=>e in ne,je=(e,t)=>{let n="naka",i="medium",r="defont",s=null,a=1,o=null,l=false,d=0,u=1;for(const m of e){const y=ze(typeof m=="string"?m:"");if(!y)continue;if(xt.test(y)){const C=$e(y);if(C){s=C;continue}}const b=y.toLowerCase();if(Ue(b)){n=b;continue}if(Ge(b)){i=b;continue}if(Ke(b)){r=b;continue}if(Ye(b)){s=ne[b].toUpperCase();continue}if(b==="_live"){o=.5;continue}if(b==="invisible"){a=0,l=true;continue}if(b.startsWith("ls:")||b.startsWith("letterspacing:")){const C=y.indexOf(":");if(C>=0){const x=ie(y.slice(C+1));x!==null&&(d=qe(x));}continue}if(b.startsWith("lh:")||b.startsWith("lineheight:")){const C=y.indexOf(":");if(C>=0){const x=We(y.slice(C+1));x!==null&&(u=Be(x));}continue}}const c=Math.max(0,Math.min(1,a)),h=(s??t.defaultColor).toUpperCase(),p=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:n,size:i,sizeScale:De[i],font:r,fontFamily:He[r],resolvedColor:h,colorOverride:s,opacityMultiplier:c,opacityOverride:p,isInvisible:l,letterSpacing:d,lineHeight:u}},Xe=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,J=e=>e.length===1?e.repeat(2):e,O=e=>Number.parseInt(e,16),q=e=>!Number.isFinite(e)||e<=0?0:e>=1?1:e,re=(e,t)=>{const n=Xe.exec(e);if(!n)return e;const i=n[1];let r,s,a,o=1;i.length===3||i.length===4?(r=O(J(i[0])),s=O(J(i[1])),a=O(J(i[2])),i.length===4&&(o=O(J(i[3]))/255)):(r=O(i.slice(0,2)),s=O(i.slice(2,4)),a=O(i.slice(4,6)),i.length===8&&(o=O(i.slice(6,8))/255));const l=q(o*q(t));return `rgba(${r}, ${s}, ${a}, ${l})`},Je=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),se=()=>Je(),R=e=>e*1e3,Ze=e=>!Number.isFinite(e)||e<0?null:Math.round(e),wt=4e3,It=1800,Qe=3,tn=.25,en=32,nn=48,rt=120,rn=4e3,dt=120,sn=800,an=2,K=4e3,W=4e3,_=W+wt,on=1e3,Rt=1,ae=12,oe=24,T=.001,z=50,ln=5,cn=2,Ft=8,dn=12,hn=500,un=3e3,_t={debug:0,info:1,warn:2,error:3},pn=(e,t,n)=>{const i=[`[${t}]`,...n];switch(e){case "debug":console.debug(...i);break;case "info":console.info(...i);break;case "warn":console.warn(...i);break;case "error":console.error(...i);break;default:console.log(...i);}},le=(e,t={})=>{const{level:n="info",emitter:i=pn}=t,r=_t[n],s=(a,o)=>{_t[a]<r||i(a,e,o);};return {debug:(...a)=>s("debug",a),info:(...a)=>s("info",a),warn:(...a)=>s("warn",a),error:(...a)=>s("error",a)}},St=le("CommentEngine:Comment"),Dt=new WeakMap,mn=e=>{let t=Dt.get(e);return t||(t=new Map,Dt.set(e,t)),t},Ct=(e,t)=>{if(!e)return 0;const n=`${e.font??""}::${t}`,i=mn(e),r=i.get(n);if(r!==void 0)return r;const s=e.measureText(t).width;return i.set(n,s),s},gn=e=>{if(e.includes(`
`)){const t=e.split(/\r?\n/);return t.length>0?t:[""]}return [e]},Ht=e=>Math.max(24,e),ht=(e,t)=>{let n=0;const i=e.letterSpacing;for(const a of e.lines){const o=Ct(t,a),l=a.length>1?i*(a.length-1):0,d=Math.max(0,o+l);d>n&&(n=d);}e.width=n;const r=Math.max(1,Math.floor(e.fontSize*e.lineHeightMultiplier));e.lineHeightPx=r;const s=e.lines.length>1?(e.lines.length-1)*r:0;e.height=e.fontSize+s;},fn=(e,t,n,i,r)=>{try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(n)||!Number.isFinite(i))throw new Error("Canvas dimensions must be numbers");if(!r)throw new Error("Prepare options are required");const s=Math.max(n,1),a=Ht(Math.floor(i*.05)),o=Ht(Math.floor(a*e.sizeScale));e.fontSize=o,t.font=`${e.fontSize}px ${e.fontFamily}`,e.lines=gn(e.text),ht(e,t);const l=!e.isScrolling&&(e.layout==="ue"||e.layout==="shita");if(l){const P=Math.max(1,s-Ft*2);if(e.width>P){const H=Math.max(dn,Math.min(e.fontSize,Math.floor(a*.6))),ct=P/Math.max(e.width,1),B=Math.max(H,Math.floor(e.fontSize*Math.min(ct,1)));B<e.fontSize&&(e.fontSize=B,t.font=`${e.fontSize}px ${e.fontFamily}`,ht(e,t));let At=0;for(;e.width>P&&e.fontSize>H&&At<5;){const _e=P/Math.max(e.width,1),Lt=Math.max(H,Math.floor(e.fontSize*Math.max(_e,.7)));Lt>=e.fontSize?e.fontSize=Math.max(H,e.fontSize-1):e.fontSize=Lt,t.font=`${e.fontSize}px ${e.fontFamily}`,ht(e,t),At+=1;}}}if(!e.isScrolling){e.bufferWidth=0;const P=l?Ft:0,H=Math.max((s-e.width)/2,P),ct=Math.max(P,s-e.width-P),B=Math.min(H,Math.max(ct,P));e.virtualStartX=B,e.x=B,e.baseSpeed=0,e.speed=0,e.speedPixelsPerMs=0,e.visibleDurationMs=W,e.preCollisionDurationMs=W,e.totalDurationMs=W,e.reservationWidth=e.width,e.staticExpiryTimeMs=e.vposMs+W,e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1;return}e.staticExpiryTimeMs=null;const d=Ct(t,"??".repeat(150)),u=e.width*Math.max(r.bufferRatio,0);e.bufferWidth=Math.max(r.baseBufferPx,u);const c=Math.max(r.entryBufferPx,e.bufferWidth),h=e.scrollDirection,p=h==="rtl"?s+r.virtualExtension:-e.width-e.bufferWidth-r.virtualExtension,m=h==="rtl"?-e.width-e.bufferWidth-c:s+c,y=h==="rtl"?s+c:-c,b=h==="rtl"?p+e.width+e.bufferWidth:p-e.bufferWidth;e.virtualStartX=p,e.x=p,e.exitThreshold=m;const C=s>0?e.width/s:0,x=r.maxVisibleDurationMs===r.minVisibleDurationMs;let L=r.maxVisibleDurationMs;if(!x&&C>1){const P=Math.min(C,r.maxWidthRatio),H=r.maxVisibleDurationMs/Math.max(P,1);L=Math.max(r.minVisibleDurationMs,Math.floor(H));}const E=s+e.width+e.bufferWidth+c,Le=Math.max(L,1),lt=E/Le,Pe=lt*1e3/60;e.baseSpeed=Pe,e.speed=e.baseSpeed,e.speedPixelsPerMs=lt;const Ie=Math.abs(m-p),Re=h==="rtl"?Math.max(0,b-y):Math.max(0,y-b),Vt=Math.max(lt,Number.EPSILON);e.visibleDurationMs=L,e.preCollisionDurationMs=Math.max(0,Math.ceil(Re/Vt)),e.totalDurationMs=Math.max(e.preCollisionDurationMs,Math.ceil(Ie/Vt));const Fe=e.width+e.bufferWidth+c;e.reservationWidth=Math.min(d,Fe),e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1;}catch(s){throw St.error("Comment.prepare",s,{text:e.text,visibleWidth:n,canvasHeight:i,hasContext:!!t}),s}},ce=5,D={enabled:false,maxLogsPerCategory:ce},it=new Map,bn=e=>{if(e===void 0||!Number.isFinite(e))return ce;const t=Math.max(1,Math.floor(e));return Math.min(1e4,t)},yn=e=>{D.enabled=!!e.enabled,D.maxLogsPerCategory=bn(e.maxLogsPerCategory),D.enabled||it.clear();},N=()=>D.enabled,vn=e=>{const t=it.get(e)??0;return t>=D.maxLogsPerCategory?(t===D.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${e}]`,"Further logs suppressed."),it.set(e,t+1)),false):(it.set(e,t+1),true)},S=(e,...t)=>{D.enabled&&vn(e)&&console.debug(`[CommentOverlay][${e}]`,...t);},Y=(e,t=32)=>e.length<=t?e:`${e.slice(0,t)}…`,xn=(e,t)=>{D.enabled&&(console.group(`[CommentOverlay][state-dump] ${e}`),console.table({"Current Time":`${t.currentTime.toFixed(2)}ms`,Duration:`${t.duration.toFixed(2)}ms`,"Is Playing":t.isPlaying,"Epoch ID":t.epochId,"Total Comments":t.totalComments,"Active Comments":t.activeComments,"Reserved Lanes":t.reservedLanes,"Final Phase":t.finalPhaseActive,"Playback Begun":t.playbackHasBegun,"Is Stalled":t.isStalled}),console.groupEnd());},wn=(e,t,n)=>{D.enabled&&S("epoch-change",`Epoch changed: ${e} → ${t} (reason: ${n})`);},v={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},Ot=()=>{if(!N())return;const e=performance.now();if(e-v.lastReported<=5e3)return;const t=v.hits+v.misses,n=t>0?v.hits/t*100:0,i=v.creates>0?(v.totalCharactersDrawn/v.creates).toFixed(1):"0",r=v.outlineCallsInCache+v.outlineCallsInFallback,s=v.fillCallsInCache+v.fillCallsInFallback;console.log("[TextureCache Stats]",`
