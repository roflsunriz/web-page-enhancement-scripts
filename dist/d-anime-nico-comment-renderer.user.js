...
(function () {
  ...
  const Re={debug:"debug",info:"info",warn:"warn",error:"error"},F=t=>{const e=`[${t}]`,n={};return Object.keys(Re).forEach(r=>{const i=Re[r];n[r]=(...s)=>{(console[i]??console.log)(e,...s);};}),n};function Me(){return typeof unsafeWindow<"u"?unsafeWindow:window}const Dt={small:.8,medium:1,big:1.4},Nt={defont:'"MS PGothic","Hiragino Kaku Gothic ProN","Hiragino Kaku Gothic Pro","Yu Gothic UI","Yu Gothic","Meiryo","Segoe UI","Osaka","Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","IPAPGothic","TakaoPGothic","Roboto","Helvetica Neue","Helvetica","Arial","sans-serif"',gothic:'"Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","Yu Gothic","Yu Gothic Medium","Meiryo","MS PGothic","Hiragino Kaku Gothic ProN","Segoe UI","Helvetica","Arial","sans-serif"',mincho:'"MS PMincho","MS Mincho","Hiragino Mincho ProN","Hiragino Mincho Pro","Yu Mincho","Noto Serif CJK JP","Noto Serif JP","Source Han Serif JP","Times New Roman","serif"'},ot={white:"#FFFFFC",red:"#FF8888",pink:"#FFA5CC",orange:"#FFBA66",yellow:"#FFFFAA",green:"#88FF88",cyan:"#88FFFF",blue:"#8899FF",purple:"#D9A5FF",black:"#444444",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},Ee=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,Ht=/^[,.:;]+/,zt=/[,.:;]+$/,Ot=t=>{const e=t.trim();return e?Ee.test(e)?e:e.replace(Ht,"").replace(zt,""):""},$t=t=>Ee.test(t)?t.toUpperCase():null,lt=t=>{const e=t.trim();if(!e)return null;const n=e.toLowerCase().endsWith("px")?e.slice(0,-2):e,r=Number.parseFloat(n);return Number.isFinite(r)?r:null},Wt=t=>{const e=t.trim();if(!e)return null;if(e.endsWith("%")){const n=Number.parseFloat(e.slice(0,-1));return Number.isFinite(n)?n/100:null}return lt(e)},qt=t=>Number.isFinite(t)?Math.min(100,Math.max(-100,t)):0,Bt=t=>!Number.isFinite(t)||t===0?1:Math.min(5,Math.max(.25,t)),Ut=t=>t==="naka"||t==="ue"||t==="shita",Gt=t=>t==="small"||t==="medium"||t==="big",Kt=t=>t==="defont"||t==="gothic"||t==="mincho",jt=t=>t in ot,Yt=(t,e)=>{let n="naka",r="medium",i="defont",s=null,a=1,o=null,l=false,d=0,h=1;for(const m of t){const y=Ot(typeof m=="string"?m:"");if(!y)continue;if(Ee.test(y)){const w=$t(y);if(w){s=w;continue}}const x=y.toLowerCase();if(Ut(x)){n=x;continue}if(Gt(x)){r=x;continue}if(Kt(x)){i=x;continue}if(jt(x)){s=ot[x].toUpperCase();continue}if(x==="_live"){o=.5;continue}if(x==="invisible"){a=0,l=true;continue}if(x.startsWith("ls:")||x.startsWith("letterspacing:")){const w=y.indexOf(":");if(w>=0){const C=lt(y.slice(w+1));C!==null&&(d=qt(C));}continue}if(x.startsWith("lh:")||x.startsWith("lineheight:")){const w=y.indexOf(":");if(w>=0){const C=Wt(y.slice(w+1));C!==null&&(h=Bt(C));}continue}}const c=Math.max(0,Math.min(1,a)),p=(s??e.defaultColor).toUpperCase(),u=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:n,size:r,sizeScale:Dt[r],font:i,fontFamily:Nt[i],resolvedColor:p,colorOverride:s,opacityMultiplier:c,opacityOverride:u,isInvisible:l,letterSpacing:d,lineHeight:h}},Xt=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,ee=t=>t.length===1?t.repeat(2):t,z=t=>Number.parseInt(t,16),B=t=>!Number.isFinite(t)||t<=0?0:t>=1?1:t,ct=(t,e)=>{const n=Xt.exec(t);if(!n)return t;const r=n[1];let i,s,a,o=1;r.length===3||r.length===4?(i=z(ee(r[0])),s=z(ee(r[1])),a=z(ee(r[2])),r.length===4&&(o=z(ee(r[3]))/255)):(i=z(r.slice(0,2)),s=z(r.slice(2,4)),a=z(r.slice(4,6)),r.length===8&&(o=z(r.slice(6,8))/255));const l=B(o*B(e));return `rgba(${i}, ${s}, ${a}, ${l})`},Jt=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),dt=()=>Jt(),L=t=>t*1e3,Zt=t=>!Number.isFinite(t)||t<0?null:Math.round(t),ke=4e3,De=1800,Qt=3,en=.25,tn=32,nn=48,le=120,rn=4e3,ue=120,sn=800,an=2,J=4e3,q=4e3,D=q+ke,on=1e3,Ne=1,ht=12,pt=24,_=.001,$=50,ln=5,cn=2,He=8,dn=12,ze={debug:0,info:1,warn:2,error:3},hn=(t,e,n)=>{const r=[`[${e}]`,...n];switch(t){case "debug":console.debug(...r);break;case "info":console.info(...r);break;case "warn":console.warn(...r);break;case "error":console.error(...r);break;default:console.log(...r);}},ut=(t,e={})=>{const{level:n="info",emitter:r=hn}=e,i=ze[n],s=(a,o)=>{ze[a]<i||r(a,t,o);};return {debug:(...a)=>s("debug",a),info:(...a)=>s("info",a),warn:(...a)=>s("warn",a),error:(...a)=>s("error",a)}},Te=ut("CommentEngine:Comment"),Oe=new WeakMap,pn=t=>{let e=Oe.get(t);return e||(e=new Map,Oe.set(t,e)),e},_e=(t,e)=>{if(!t)return 0;const n=`${t.font??""}::${e}`,r=pn(t),i=r.get(n);if(i!==void 0)return i;const s=t.measureText(e).width;return r.set(n,s),s},un=t=>{if(t.includes(`
`)){const e=t.split(/\r?\n/);return e.length>0?e:[""]}return [t]},$e=t=>Math.max(24,t),me=(t,e)=>{let n=0;const r=t.letterSpacing;for(const a of t.lines){const o=_e(e,a),l=a.length>1?r*(a.length-1):0,d=Math.max(0,o+l);d>n&&(n=d);}t.width=n;const i=Math.max(1,Math.floor(t.fontSize*t.lineHeightMultiplier));t.lineHeightPx=i;const s=t.lines.length>1?(t.lines.length-1)*i:0;t.height=t.fontSize+s;},mn=(t,e,n,r,i)=>{try{if(!e)throw new Error("Canvas context is required");if(!Number.isFinite(n)||!Number.isFinite(r))throw new Error("Canvas dimensions must be numbers");if(!i)throw new Error("Prepare options are required");const s=Math.max(n,1),a=$e(Math.floor(r*.05)),o=$e(Math.floor(a*t.sizeScale));t.fontSize=o,e.font=`${t.fontSize}px ${t.fontFamily}`,t.lines=un(t.text),me(t,e);const l=!t.isScrolling&&(t.layout==="ue"||t.layout==="shita");if(l){const A=Math.max(1,s-He*2);if(t.width>A){const H=Math.max(dn,Math.min(t.fontSize,Math.floor(a*.6))),pe=A/Math.max(t.width,1),j=Math.max(H,Math.floor(t.fontSize*Math.min(pe,1)));j<t.fontSize&&(t.fontSize=j,e.font=`${t.fontSize}px ${t.fontFamily}`,me(t,e));let Le=0;for(;t.width>A&&t.fontSize>H&&Le<5;){const Rt=A/Math.max(t.width,1),Fe=Math.max(H,Math.floor(t.fontSize*Math.max(Rt,.7)));Fe>=t.fontSize?t.fontSize=Math.max(H,t.fontSize-1):t.fontSize=Fe,e.font=`${t.fontSize}px ${t.fontFamily}`,me(t,e),Le+=1;}}}if(!t.isScrolling){t.bufferWidth=0;const A=l?He:0,H=Math.max((s-t.width)/2,A),pe=Math.max(A,s-t.width-A),j=Math.min(H,Math.max(pe,A));t.virtualStartX=j,t.x=j,t.baseSpeed=0,t.speed=0,t.speedPixelsPerMs=0,t.visibleDurationMs=q,t.preCollisionDurationMs=q,t.totalDurationMs=q,t.reservationWidth=t.width,t.staticExpiryTimeMs=t.vposMs+q,t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;return}t.staticExpiryTimeMs=null;const d=_e(e,"??".repeat(150)),h=t.width*Math.max(i.bufferRatio,0);t.bufferWidth=Math.max(i.baseBufferPx,h);const c=Math.max(i.entryBufferPx,t.bufferWidth),p=t.scrollDirection,u=p==="rtl"?s+i.virtualExtension:-t.width-t.bufferWidth-i.virtualExtension,m=p==="rtl"?-t.width-t.bufferWidth-c:s+c,y=p==="rtl"?s+c:-c,x=p==="rtl"?u+t.width+t.bufferWidth:u-t.bufferWidth;t.virtualStartX=u,t.x=u,t.exitThreshold=m;const w=s>0?t.width/s:0,C=i.maxVisibleDurationMs===i.minVisibleDurationMs;let I=i.maxVisibleDurationMs;if(!C&&w>1){const A=Math.min(w,i.maxWidthRatio),H=i.maxVisibleDurationMs/Math.max(A,1);I=Math.max(i.minVisibleDurationMs,Math.floor(H));}const M=s+t.width+t.bufferWidth+c,It=Math.max(I,1),he=M/It,Pt=he*1e3/60;t.baseSpeed=Pt,t.speed=t.baseSpeed,t.speedPixelsPerMs=he;const At=Math.abs(m-u),Lt=p==="rtl"?Math.max(0,x-y):Math.max(0,y-x),Ae=Math.max(he,Number.EPSILON);t.visibleDurationMs=I,t.preCollisionDurationMs=Math.max(0,Math.ceil(Lt/Ae)),t.totalDurationMs=Math.max(t.preCollisionDurationMs,Math.ceil(At/Ae));const Ft=t.width+t.bufferWidth+c;t.reservationWidth=Math.min(d,Ft),t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;}catch(s){throw Te.error("Comment.prepare",s,{text:t.text,visibleWidth:n,canvasHeight:r,hasContext:!!e}),s}},mt=5,N={enabled:false,maxLogsPerCategory:mt},ae=new Map,gn=t=>{if(t===void 0||!Number.isFinite(t))return mt;const e=Math.max(1,Math.floor(t));return Math.min(1e4,e)},fn=t=>{N.enabled=!!t.enabled,N.maxLogsPerCategory=gn(t.maxLogsPerCategory),N.enabled||ae.clear();},O=()=>N.enabled,bn=t=>{const e=ae.get(t)??0;return e>=N.maxLogsPerCategory?(e===N.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${t}]`,"Further logs suppressed."),ae.set(t,e+1)),false):(ae.set(t,e+1),true)},E=(t,...e)=>{N.enabled&&bn(t)&&console.debug(`[CommentOverlay][${t}]`,...e);},Q=(t,e=32)=>t.length<=e?t:`${t.slice(0,e)}…`,yn=(t,e)=>{N.enabled&&(console.group(`[CommentOverlay][state-dump] ${t}`),console.table({"Current Time":`${e.currentTime.toFixed(2)}ms`,Duration:`${e.duration.toFixed(2)}ms`,"Is Playing":e.isPlaying,"Epoch ID":e.epochId,"Total Comments":e.totalComments,"Active Comments":e.activeComments,"Reserved Lanes":e.reservedLanes,"Final Phase":e.finalPhaseActive,"Playback Begun":e.playbackHasBegun,"Is Stalled":e.isStalled}),console.groupEnd());},vn=(t,e,n)=>{N.enabled&&E("epoch-change",`Epoch changed: ${t} → ${e} (reason: ${n})`);},S={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},We=()=>{if(!O())return;const t=performance.now();if(t-S.lastReported<=5e3)return;const e=S.hits+S.misses,n=e>0?S.hits/e*100:0,r=S.creates>0?(S.totalCharactersDrawn/S.creates).toFixed(1):"0",i=S.outlineCallsInCache+S.outlineCallsInFallback,s=S.fillCallsInCache+S.fillCallsInFallback;console.log("[TextureCache Stats]",`
  Cache: Hits=${S.hits}, Misses=${S.misses}, Hit Rate=${n.toFixed(1)}%`,`
...
`;class ce{static getCommonStyles(){return Pi}static getNotificationStyles(){return Ai}static getAutoButtonStyles(){return Li}}const Ye={success:"✔",warning:"⚠",error:"✖",info:"ℹ"};class f extends Ie{static instance=null;static notifications=[];hostElement=null;initialized=false;static getInstance(){return this.instance||(this.instance=new f),this.instance}static show(e,n="info",r=3e3){try{const i=this.getInstance();return i.initialize(),i.initialized?i.createNotification(e,n,r):null}catch(i){return console.error("[NotificationManager] show failed",i),null}}static removeNotification(e){this.getInstance().removeNotification(e.element);}show(e,n="info"){f.show(e,n);}initialize(){if(!this.initialized)try{this.hostElement=document.createElement("div"),this.hostElement.className="nico-comment-shadow-host notification-host",this.hostElement.style.cssText=["position: fixed","top: 0","right: 0","z-index: 2147483647","pointer-events: none"].join(";"),document.body.appendChild(this.hostElement),this.createShadowDOM(this.hostElement),this.addStyles(ce.getNotificationStyles()),this.setHTML('<div class="notification-container"></div>'),this.initialized=!0;}catch(e){console.error("[NotificationManager] initialize failed",e),this.initialized=false;}}destroy(){f.notifications.forEach(e=>{e.timerId&&window.clearTimeout(e.timerId);}),f.notifications=[],this.hostElement?.parentNode&&this.hostElement.parentNode.removeChild(this.hostElement),this.hostElement=null,this.initialized=false,f.instance=null;}createNotification(e,n,r){try{const i=this.querySelector(".notification-container");if(!i)throw new Error("Notification container not found");const s=Ye[n]??Ye.info,a=document.createElement("div");a.className=`notification-item ${n}`;const o=document.createElement("div");o.className="notification-icon",o.innerHTML=`<span>${s}</span>`,a.appendChild(o);const l=document.createElement("div");l.className="notification-content";const d=document.createElement("div");d.className="notification-type",d.textContent=n.charAt(0).toUpperCase()+n.slice(1),l.appendChild(d);const h=document.createElement("div");if(h.className="notification-message",e.includes("<"))h.innerHTML=e||"No message";else {const u=(e||"No message").split(`
`).map(m=>m.trim()).filter(m=>m.length>0).join("<br>");h.innerHTML=u;}l.appendChild(h),a.appendChild(l);const c=document.createElement("button");c.className="notification-close",c.innerHTML="&times;",c.addEventListener("click",()=>{this.removeNotification(a);}),a.appendChild(c),i.appendChild(a),requestAnimationFrame(()=>{a.classList.add("show");});const p={element:a,timerId:window.setTimeout(()=>{this.removeNotification(a);},r)};return f.notifications.push(p),p}catch(i){return console.error("[NotificationManager] createNotification failed",i),null}}removeNotification(e){if(!e)return;const n=f.notifications.find(r=>r.element===e);n?.timerId&&window.clearTimeout(n.timerId),e.classList.remove("show"),window.setTimeout(()=>{try{e.remove(),f.notifications=f.notifications.filter(r=>r.element!==e);}catch(r){console.error("[NotificationManager] removeNotification cleanup failed",r);}},500);}}const St="https://www.nicovideo.jp",Ct=`${St}/search`,Mt=`${St}/watch`,Xe={searchBase:Ct,watchBase:Mt},Fi=t=>`${Mt}/${t}`,Et=t=>`${Ct}/${encodeURIComponent(t)}`,xe=t=>new Promise((e,n)=>{Ei({url:t.url,method:t.method??"GET",headers:t.headers,data:t.data,responseType:t.responseType??"text",timeout:t.timeout,onprogress:t.onprogress,onload:r=>{e({status:r.status,statusText:r.statusText,response:r.response,finalUrl:r.finalUrl,headers:r.responseHeaders});},onerror:r=>{const i=r?.error??"unknown error";n(new Error(`GM_xmlhttpRequest failed: ${i}`));},ontimeout:()=>{n(new Error("GM_xmlhttpRequest timeout"));}});}),be=F("dAnime:NicoApiFetcher");class Z{apiData=null;comments=null;get lastApiData(){return this.apiData}get cachedComments(){return this.comments}async fetchApiData(e){try{const n=this.sanitizeVideoId(e),i=(await xe({method:"GET",url:Fi(n),headers:{Accept:"text/html"}})).response,o=new DOMParser().parseFromString(i,"text/html").querySelector('meta[name="server-response"]');if(!o)throw new Error("API data element not found in response");const l=o.getAttribute("content");if(!l)throw new Error("API data content is empty");const d=this.decodeServerResponse(l),c=JSON.parse(d).data?.response;if(!c)throw new Error("Invalid API data structure");return this.apiData=c,c}catch(n){throw be.error("NicoApiFetcher.fetchApiData",n),n}}async fetchComments(){try{if(!this.apiData)throw new Error("API data must be fetched first");const e=this.apiData.comment?.nvComment;if(!e?.server||!e.params||!e.threadKey)throw new Error("Required comment server data is missing");const n=await xe({method:"POST",url:`${e.server}/v1/threads`,headers:{"Content-Type":"application/json","x-client-os-type":"others","X-Frontend-Id":"6","X-Frontend-Version":"0"},data:JSON.stringify({params:e.params,threadKey:e.threadKey,additionals:{}})}),s=(JSON.parse(n.response).data?.threads??[]).filter(o=>o.fork==="main").sort((o,l)=>(l.commentCount||0)-(o.commentCount||0))[0];if(!s)throw new Error("Main thread not found in comment response");const a=(s.comments??[]).map(o=>({text:o.body??"",vposMs:o.vposMs??0,commands:o.commands??[]}));return this.comments=a,a}catch(e){throw be.error("NicoApiFetcher.fetchComments",e),e}}async fetchAllData(e){return await this.fetchApiData(e),this.fetchComments()}sanitizeVideoId(e){try{let n=encodeURIComponent(e);return n=n.replace(/%([0-9A-F]{2})/gi,(r,i)=>{const s=parseInt(i,16);return s>=65&&s<=90||s>=97&&s<=122||s>=48&&s<=57||s===45||s===95||s===46||s===126?String.fromCharCode(s):r}),n}catch(n){return be.error("NicoApiFetcher.sanitizeVideoId",n,{videoId:e}),e}}decodeServerResponse(e){try{return decodeURIComponent(e)}catch(n){try{const r=e.replace(/%(?![0-9A-F]{2})/gi,"%25");return decodeURIComponent(r)}catch{throw new Error(`API data decode failed: ${n.message}`)}}}}const Je=F("dAnime:NicoVideoSearcher"),Ri="dアニメストア ニコニコ支店";class R{cache=new Map;static isOfficialVideo(e,n){const r=e.owner?.nickname??e.owner?.name??e.channel?.name??"";return !!(r===Ri||r===n||r.startsWith(n+" "))}static filterOfficialVideos(e,n){return e.filter(r=>R.isOfficialVideo(r,n))}async search(e){if(!e.trim())return [];if(this.cache.has(e))return this.cache.get(e)??[];const n=Et(e),r=await this.fetchText(n),i=this.parseServerContext(r).map(o=>{const l=this.calculateLevenshteinDistance(e,o.title),d=Math.max(e.length,o.title.length),h=d>0?(1-l/d)*100:0;return {...o,levenshteinDistance:l,similarity:h}}),s=[],a=new Set;for(const o of i)o?.videoId&&(a.has(o.videoId)||(a.add(o.videoId),s.push(o)));return s.sort((o,l)=>{if(o.commentCount!==l.commentCount)return l.commentCount-o.commentCount;const d=o.similarity??-1,h=l.similarity??-1;return d!==h?h-d:l.viewCount-o.viewCount}),this.cache.set(e,s),s}async fetchText(e){return (await xe({method:"GET",url:e})).response}parseServerContext(e){try{const r=new DOMParser().parseFromString(e,"text/html").querySelector('meta[name="server-response"]');if(!r)return [];const i=r.getAttribute("content")??"",s=this.decodeHtmlEntities(i);let a;try{a=JSON.parse(s);}catch(o){return Je.error("NicoVideoSearcher.parseServerContext",o),[]}return this.extractVideoItems(a??{})}catch(n){return Je.error("NicoVideoSearcher.parseServerContext",n),[]}}decodeHtmlEntities(e){if(!e)return "";let n=e.replace(/&quot;/g,'"').replace(/&#39;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">");return n=n.replace(/&#(\d+);/g,(r,i)=>String.fromCharCode(parseInt(i,10))),n=n.replace(/&#x([0-9a-fA-F]+);/g,(r,i)=>String.fromCharCode(parseInt(i,16))),n}extractVideoItems(e){const n=[],r=s=>{const a=(s?.id??s?.contentId??s?.watchId??"").toString();if(!a)return;const o=(s?.title??s?.shortTitle??"").toString(),l=s?.count??{},d=Number(l.view??s?.viewCounter??0)||0,h=Number(l.comment??s?.commentCounter??0)||0,c=Number(l.mylist??s?.mylistCounter??0)||0,p=s?.thumbnail??{},u=(p.nHdUrl||p.listingUrl||p.largeUrl||p.middleUrl||p.url||s?.thumbnailUrl||"").toString(),m=(s?.registeredAt||s?.startTime||s?.postedDateTime||"")?.toString?.()??"",y=s?.owner&&typeof s.owner=="object"?{nickname:(s.owner.nickname??s.owner.name??"")||void 0,name:(s.owner.name??s.owner.nickname??"")||void 0}:null,x=(s?.isChannelVideo||s?.owner?.ownerType==="channel")&&s?.owner?{name:s.owner.name??""}:null;o&&n.push({videoId:a,title:o,viewCount:d,commentCount:h,mylistCount:c,thumbnail:u,postedAt:m,owner:y,channel:x});},i=s=>{if(!s)return;if(Array.isArray(s)){s.forEach(i);return}if(typeof s!="object"||s===null)return;const a=s;(a.id||a.contentId||a.watchId)&&r(a),Object.values(s).forEach(i);};return i(e),n}calculateLevenshteinDistance(e,n){const r=e?e.length:0,i=n?n.length:0;if(r===0)return i;if(i===0)return r;const s=new Array(i+1);for(let o=0;o<=i;++o){const l=s[o]=new Array(r+1);l[0]=o;}const a=s[0];for(let o=1;o<=r;++o)a[o]=o;for(let o=1;o<=i;++o)for(let l=1;l<=r;++l){const d=e[l-1]===n[o-1]?0:1;s[o][l]=Math.min(s[o-1][l]+1,s[o][l-1]+1,s[o-1][l-1]+d);}return s[i][r]}}const k={mypageHeaderTitle:".p-mypageHeader__title",mypageListContainer:".p-mypageMain",watchVideoElement:"video#video",mypageItem:".itemModule.list",mypageItemTitle:".line1",mypageEpisodeNumber:".number.line1 span",mypageEpisodeTitle:".episode.line1 span",watchPageAnimeTitle:".backInfoTxt1",watchPageEpisodeNumber:".backInfoTxt2",watchPageEpisodeTitle:".backInfoTxt3"};class Pe{delay;timers=new Map;funcIds=new Map;nextId=1;constructor(e){this.delay=e;}getFuncId(e){return this.funcIds.has(e)||this.funcIds.set(e,this.nextId++),this.funcIds.get(e)??0}exec(e){const n=this.getFuncId(e),r=Date.now(),i=this.timers.get(n)?.lastExec??0,s=r-i;if(s>this.delay)e(),this.timers.set(n,{lastExec:r});else {clearTimeout(this.timers.get(n)?.timerId??void 0);const a=setTimeout(()=>{e(),this.timers.set(n,{lastExec:Date.now()});},this.delay-s);this.timers.set(n,{timerId:a,lastExec:i});}}execOnce(e){const n=this.getFuncId(e),r=this.timers.get(n);if(r?.executedOnce){r.timerId&&clearTimeout(r.timerId);return}r?.timerId&&clearTimeout(r.timerId);const i=setTimeout(()=>{try{e();}finally{this.timers.set(n,{executedOnce:true,lastExec:Date.now(),timerId:null});}},this.delay);this.timers.set(n,{timerId:i,executedOnce:false,scheduled:true});}cancel(e){const n=this.getFuncId(e),r=this.timers.get(n);r?.timerId&&clearTimeout(r.timerId),this.timers.delete(n);}resetExecution(e){const n=this.getFuncId(e),r=this.timers.get(n);r&&(r.timerId&&clearTimeout(r.timerId),this.timers.set(n,{executedOnce:false,scheduled:false}));}clearAll(){for(const[,e]of this.timers)e.timerId&&clearTimeout(e.timerId);this.timers.clear(),this.funcIds.clear();}}const P=F("dAnime:VideoEventLogger");class kt{constructor(e=""){this.prefix=e;}video=null;lastCurrentTime=0;eventListeners=new Map;isEnabled=true;TRACKED_EVENTS=["loadstart","loadedmetadata","loadeddata","canplay","canplaythrough","play","playing","pause","seeking","seeked","timeupdate","ended","emptied","stalled","suspend","waiting","error","abort"];enable(){this.isEnabled=true,P.info(`${this.prefix}:enabled`);}disable(){this.isEnabled=false,P.info(`${this.prefix}:disabled`);}attach(e){this.detach(),this.video=e,this.lastCurrentTime=e.currentTime,P.info(`${this.prefix}:attach`,{src:this.getVideoSource(e),duration:e.duration,currentTime:e.currentTime,readyState:e.readyState}),this.TRACKED_EVENTS.forEach(n=>{const r=()=>{this.handleEvent(n);};this.eventListeners.set(n,r),e.addEventListener(n,r);}),this.setupCurrentTimeWatcher();}detach(){this.video&&(this.eventListeners.forEach((e,n)=>{this.video?.removeEventListener(n,e);}),this.eventListeners.clear(),P.info(`${this.prefix}:detach`,{src:this.getVideoSource(this.video),finalTime:this.video.currentTime}),this.video=null);}handleEvent(e){if(!this.isEnabled||!this.video)return;const n=this.video,r={event:e,currentTime:n.currentTime,duration:n.duration,readyState:n.readyState,paused:n.paused,ended:n.ended,src:this.getVideoSource(n),networkState:n.networkState,timestamp:Date.now()},i=Math.abs(n.currentTime-this.lastCurrentTime);if(e==="timeupdate"){i>.1&&(this.lastCurrentTime=n.currentTime);return}switch(i>.1?(P.info(`${this.prefix}:event:${e}`,{...r,timeDiff:i.toFixed(2),direction:n.currentTime>this.lastCurrentTime?"forward":"backward"}),this.lastCurrentTime=n.currentTime):P.debug(`${this.prefix}:event:${e}`,r),e){case "error":P.error(`${this.prefix}:videoError`,new Error("Video error detected"),{errorCode:n.error?.code??null,errorMessage:n.error?.message??null,...r});break;case "ended":P.warn(`${this.prefix}:videoEnded`,{...r,message:"動画再生が終了しました"});break;case "emptied":P.warn(`${this.prefix}:videoEmptied`,{...r,message:"動画要素が空になりました（src変更の可能性）"});break;case "seeking":P.warn(`${this.prefix}:seeking`,{...r,from:this.lastCurrentTime,to:n.currentTime,diff:(n.currentTime-this.lastCurrentTime).toFixed(2)});break}}setupCurrentTimeWatcher(){if(!Object.getOwnPropertyDescriptor(HTMLMediaElement.prototype,"currentTime")?.set){P.warn(`${this.prefix}:currentTimeWatcher:unsupported`);return}P.debug(`${this.prefix}:currentTimeWatcher:setup`);}logManualSeek(e,n,r){this.isEnabled&&P.warn(`${this.prefix}:manualSeek`,{from:e.toFixed(2),to:n.toFixed(2),diff:(n-e).toFixed(2),reason:r,stackTrace:new Error().stack});}getVideoSource(e){const n=typeof e.currentSrc=="string"?e.currentSrc:"";if(n.length>0)return n.length>100?`${n.slice(0,100)}...`:n;const r=e.getAttribute("src")??"";return r.length>0?r.length>100?`${r.slice(0,100)}...`:r:null}}let ye=null;function Ze(){return ye||(ye=new kt("global")),ye}const Di=1e3,Ni=100,Hi=30,Qe=1e4,et=100,zi=/watch\/(?:([a-z]{2}))?(\d+)/gi,v=F("dAnime:VideoSwitchHandler"),tt=t=>{if(!t?.video)return null;const e=t.video.registeredAt,n=e?new Date(e).toLocaleString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:false}):void 0;return {videoId:t.video.id,title:t.video.title,viewCount:t.video.count?.view,mylistCount:t.video.count?.mylist,commentCount:t.video.count?.comment,postedAt:n,thumbnail:t.video.thumbnail?.url,owner:t.owner??null,channel:t.channel??null}},Oi=t=>{const e=[];let n;for(;(n=zi.exec(t))!==null;){const[,r="",i=""]=n;i&&e.push(`${r}${i}`);}return e};class Tt{constructor(e,n,r,i=Di,s=Ni){this.renderer=e,this.fetcher=n,this.settingsManager=r,this.monitorInterval=i,this.debounce=new Pe(s),this.videoEventLogger=new kt("VideoSwitchHandler");}nextVideoId=null;preloadedComments=null;lastPreloadedComments=null;lastVideoId=null;lastVideoSource=null;checkIntervalId=null;isSwitching=false;debounce;videoEventLogger;resetVideoSource(){v.info("videoSwitch:resetVideoSource",{previousSource:this.lastVideoSource,previousLastPreloadedCount:this.lastPreloadedComments?.length??0,previousPreloadedCount:this.preloadedComments?.length??0,previousNextVideoId:this.nextVideoId}),this.lastVideoSource=null,this.lastPreloadedComments=null,this.preloadedComments=null,this.nextVideoId=null;}updateRenderer(e){v.info("videoSwitch:updateRenderer",{oldRendererExists:!!this.renderer,newRendererExists:!!e}),this.renderer=e;}startMonitoring(){this.stopMonitoring(),this.checkIntervalId=window.setInterval(()=>{this.checkVideoEnd();},this.monitorInterval);}stopMonitoring(){this.checkIntervalId&&(window.clearInterval(this.checkIntervalId),this.checkIntervalId=null);}async onVideoSwitch(e){if(this.isSwitching){v.warn("videoSwitch:alreadySwitching",{timestamp:Date.now()});return}this.isSwitching=true;try{v.warn("videoSwitch:entry",{videoElementProvided:!!e,currentRendererComments:this.renderer.getCommentsSnapshot().length,lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId,lastVideoSource:this.lastVideoSource,rendererVideoElement:this.renderer.getVideoElement()?"attached":"detached",rendererVideoSrc:this.renderer.getCurrentVideoSource(),sampleCurrentComments:this.renderer.getCommentsSnapshot().slice(0,3).map(h=>({text:h.text?.substring(0,30),vposMs:h.vposMs}))});const n=await this.resolveVideoElement(e)??null,r=this.preloadedComments??this.lastPreloadedComments??null,i=n?.dataset?.videoId??n?.getAttribute?.("data-video-id")??null,s=this.nextVideoId??i??this.lastVideoId;if(v.warn("videoSwitch:videoIdResolution",{videoId:s??null,nextVideoId:this.nextVideoId,elementId:i,lastVideoId:this.lastVideoId,hasBackupPreloaded:!!r,backupPreloadedCount:r?.length??0}),!n||!s&&!r){v.warn("videoSwitch:earlyReturn",{reason:n?"no videoId and no backup":"no video element",hasVideoElement:!!n,hasVideoId:!!s,hasBackupPreloaded:!!r}),this.handleMissingVideoInfo(r);return}v.warn("videoSwitch:start",{videoId:s??null,elementVideoId:n.dataset?.videoId??null,preloadedCount:r?.length??0,currentTime:n.currentTime,duration:n.duration,readyState:n.readyState,currentSrc:n.currentSrc,lastVideoSource:this.lastVideoSource}),f.show("動画の切り替わりを検知しました...","info"),this.videoEventLogger.attach(n),this.resetRendererState(n);const a=this.renderer.getVideoElement();if(a!==n&&n)v.debug("videoSwitch:rebind",{previousSrc:this.renderer.getCurrentVideoSource(),newSrc:typeof n.currentSrc=="string"&&n.currentSrc.length>0?n.currentSrc:n.getAttribute("src")??null}),this.renderer.initialize(n);else if(a===n&&n&&this.hasVideoSourceChanged(n))v.debug("videoSwitch:rebind:sameElement",{previousSrc:this.lastVideoSource??null,newSrc:this.getVideoSource(n)}),this.renderer.clearComments(),this.renderer.destroy(),this.renderer.initialize(n);else if(!a&&!n){v.warn("videoSwitch:missingVideoElement",{lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId}),this.isSwitching=!1;return}let o=null;s&&(o=await this.fetchVideoApiData(s,r),o&&(this.persistVideoMetadata(o),this.lastVideoId=s));const l=await this.populateComments(s,r);l===0?(this.renderer.clearComments(),f.show("コメントを取得できませんでした","warning"),v.warn("videoSwitch:commentsMissing",{videoId:s??null})):v.warn("videoSwitch:commentsLoaded",{videoId:s??null,count:l}),this.nextVideoId=null,this.preloadedComments=null,this.lastVideoSource=this.getVideoSource(n);const d=this.renderer.getCommentsSnapshot();if(v.warn("videoSwitch:complete",{videoId:s??null,finalTime:n.currentTime,loadedCount:l,finalCommentsCount:d.length,rendererVideoSrc:this.renderer.getCurrentVideoSource(),sampleFinalComments:d.slice(0,5).map(h=>({text:h.text?.substring(0,30),vposMs:h.vposMs,vposSec:(h.vposMs/1e3).toFixed(2)}))}),o){const h=tt(o);if(h){const c=`コメントソースを更新しました: ${h.title??"不明なタイトル"}（${l}件）`;f.show(c,l>0?"success":"warning");}}}catch(n){v.error("videoSwitch:error",n,{nextVideoId:this.nextVideoId,lastVideoId:this.lastVideoId}),f.show(`動画切り替えエラー: ${n.message}`,"error"),this.renderer.clearComments();}finally{this.isSwitching=false;}}async resolveVideoElement(e){if(e){const i=this.getVideoSource(e),s=this.lastVideoSource;return (!i||i===s)&&await this.waitForSourceChange(e),e}const n=Date.now()+Qe;let r=null;for(;Date.now()<n;){const i=document.querySelector(k.watchVideoElement);if(i){r=i;const s=this.hasVideoSourceChanged(i);if(i.readyState>=2||!i.paused||s)return s&&(this.lastVideoSource=null),i}await new Promise(s=>window.setTimeout(s,et));}return r}async waitForSourceChange(e){const n=this.getVideoSource(e);if(!n)return;const r=Date.now()+Qe;for(;Date.now()<r;){const i=this.getVideoSource(e);if(i&&i!==n){this.lastVideoSource=null;return}await new Promise(s=>window.setTimeout(s,et));}}hasVideoSourceChanged(e){const n=this.getVideoSource(e);return n?this.lastVideoSource?this.lastVideoSource!==n:true:false}getVideoSource(e){if(!e)return null;const n=typeof e.currentSrc=="string"?e.currentSrc:"";if(n.length>0)return n;const r=e.getAttribute("src")??"";if(r.length>0)return r;const i=e.querySelector("source[src]");return i&&typeof i.src=="string"&&i.src.length>0?i.src:null}resetRendererState(e){const n=e.currentTime,r=this.getVideoSource(e),i=this.lastVideoSource!==r,s=this.renderer.getCommentsSnapshot().length;if(v.warn("videoSwitch:resetRendererState:before",{currentTime:n,duration:e.duration,src:r,lastSrc:this.lastVideoSource??null,sourceChanged:i,readyState:e.readyState,paused:e.paused,commentsCount:s}),i)try{this.videoEventLogger.logManualSeek(n,0,"resetRendererState: video source changed"),e.currentTime=0,v.warn("videoSwitch:resetRendererState:seeked",{currentTime:e.currentTime,timeDiff:e.currentTime-n});}catch(a){v.debug("videoSwitch:resetCurrentTimeFailed",a);}else v.warn("videoSwitch:resetRendererState:skipSeek",{reason:"same video source, skipping currentTime reset",currentTime:n,willClearComments:true});v.warn("videoSwitch:resetRendererState:clearingComments",{commentsBeforeClear:s,sourceChanged:i,currentVideoSrc:this.renderer.getCurrentVideoSource()}),this.renderer.clearComments(),v.warn("videoSwitch:resetRendererState:commentsCleared",{commentsAfterClear:this.renderer.getCommentsSnapshot().length,rendererVideoSrc:this.renderer.getCurrentVideoSource()});}async checkVideoEnd(){const e=this.renderer.getVideoElement();if(!(!e||!Number.isFinite(e.duration)||e.duration-e.currentTime>Hi)){if(!this.nextVideoId){const r=async()=>{await this.findNextVideoId();};this.debounce.execOnce(r);}if(this.nextVideoId&&!this.preloadedComments){const r=async()=>{await this.preloadComments();};this.debounce.execOnce(r);}}}handleMissingVideoInfo(e){v.warn("videoSwitch:handleMissingVideoInfo",{hasBackupPreloaded:!!e,backupPreloadedCount:e?.length??0,hasLastPreloadedComments:!!this.lastPreloadedComments,lastPreloadedCount:this.lastPreloadedComments?.length??0,willClearComments:!e&&!this.lastPreloadedComments}),!e&&!this.lastPreloadedComments?(v.warn("videoSwitch:clearingCommentsInMissingInfo",{currentCommentCount:this.renderer.getCommentsSnapshot().length}),this.renderer.clearComments(),f.show("次の動画のコメントを取得できませんでした。コメント表示をクリアします。","warning")):v.info("videoSwitch:preservingComments",{reason:"backup or last preloaded comments available",currentCommentCount:this.renderer.getCommentsSnapshot().length});}async fetchVideoApiData(e,n){try{const r=await this.fetcher.fetchApiData(e);return v.debug("videoSwitch:apiFetched",{videoId:e}),r}catch(r){if(v.error("videoSwitch:apiFetchError",r,{videoId:e}),!n)throw r;return null}}persistVideoMetadata(e){const n=tt(e);n&&this.settingsManager.saveVideoData(n.title??"",n);}async populateComments(e,n){let r=null;if(v.warn("videoSwitch:populateComments:start",{videoId:e,backupPreloadedCount:n?.length??0,hasBackupPreloaded:!!n}),Array.isArray(n)&&n.length>0)r=n,v.warn("videoSwitch:populateComments:usingBackup",{count:r.length});else if(e)try{v.warn("videoSwitch:populateComments:fetching",{videoId:e}),r=await this.fetcher.fetchAllData(e),v.warn("videoSwitch:commentsFetched",{videoId:e,count:r.length});}catch(s){v.error("videoSwitch:commentsFetchError",s,{videoId:e}),f.show(`コメント取得エラー: ${s.message}`,"error"),r=null;}if(!r||r.length===0)return v.warn("videoSwitch:populateComments:noComments"),0;const i=r.filter(s=>!this.renderer.isNGComment(s.text));return v.warn("videoSwitch:populateComments:addingToRenderer",{filteredCount:i.length,totalCount:r.length,rendererCommentsBeforeAdd:this.renderer.getCommentsSnapshot().length,rendererVideoElement:this.renderer.getVideoElement()?"attached":"detached",rendererVideoSrc:this.renderer.getCurrentVideoSource()}),i.forEach((s,a)=>{this.renderer.addComment(s.text,s.vposMs,s.commands),a<3&&v.warn(`videoSwitch:populateComments:addedComment[${a}]`,{text:s.text.substring(0,30),vposMs:s.vposMs,vposSec:(s.vposMs/1e3).toFixed(2),commands:s.commands});}),v.warn("videoSwitch:populateComments:complete",{addedCount:i.length,rendererCommentsAfterAdd:this.renderer.getCommentsSnapshot().length,rendererVideoSrcAfterAdd:this.renderer.getCurrentVideoSource(),sampleComments:this.renderer.getCommentsSnapshot().slice(0,3).map(s=>({text:s.text?.substring(0,30),vposMs:s.vposMs}))}),this.lastPreloadedComments=[...i],i.length}async findNextVideoId(){try{const e=this.fetcher.lastApiData;if(!e)return;const n=e.series?.video?.next?.id;if(n){this.nextVideoId=n,v.debug("videoSwitch:detectedNext",{videoId:n});return}const r=e.video?.description??"";if(!r)return;const i=Oi(r);if(i.length===0)return;const s=[...i].sort((a,o)=>{const l=parseInt(a.replace(/^[a-z]{2}/i,""),10)||0;return (parseInt(o.replace(/^[a-z]{2}/i,""),10)||0)-l});this.nextVideoId=s[0]??null,this.nextVideoId&&v.debug("videoSwitch:candidateFromDescription",{candidate:this.nextVideoId});}catch(e){v.error("videoSwitch:nextIdError",e,{lastVideoId:this.lastVideoId});}}async preloadComments(){if(this.nextVideoId)try{const n=(await this.fetcher.fetchAllData(this.nextVideoId)).filter(r=>!this.renderer.isNGComment(r.text));this.preloadedComments=n.length>0?n:null,v.debug("videoSwitch:preloaded",{videoId:this.nextVideoId,count:n.length});}catch(e){v.error("videoSwitch:preloadError",e,{videoId:this.nextVideoId}),this.preloadedComments=null;}}}const $i=`
.nico-comment-shadow-host {
  display: block;
  position: relative;
}
`;class _t{static initialize(){Mi($i);}}var Wi="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7.07,18.28C7.5,17.38 10.12,16.5 12,16.5C13.88,16.5 16.5,17.38 16.93,18.28C15.57,19.36 13.86,20 12,20C10.14,20 8.43,19.36 7.07,18.28M18.36,16.83C16.93,15.09 13.46,14.5 12,14.5C10.54,14.5 7.07,15.09 5.64,16.83C4.62,15.5 4,13.82 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,13.82 19.38,15.5 18.36,16.83M12,6C10.06,6 8.5,7.56 8.5,9.5C8.5,11.44 10.06,13 12,13C13.94,13 15.5,11.44 15.5,9.5C15.5,7.56 13.94,6 12,6M12,11A1.5,1.5 0 0,1 10.5,9.5A1.5,1.5 0 0,1 12,8A1.5,1.5 0 0,1 13.5,9.5A1.5,1.5 0 0,1 12,11Z",qi="M6 1V3H5C3.89 3 3 3.89 3 5V19C3 20.1 3.89 21 5 21H11.1C12.36 22.24 14.09 23 16 23C19.87 23 23 19.87 23 16C23 14.09 22.24 12.36 21 11.1V5C21 3.9 20.11 3 19 3H18V1H16V3H8V1M5 5H19V7H5M5 9H19V9.67C18.09 9.24 17.07 9 16 9C12.13 9 9 12.13 9 16C9 17.07 9.24 18.09 9.67 19H5M16 11.15C18.68 11.15 20.85 13.32 20.85 16C20.85 18.68 18.68 20.85 16 20.85C13.32 20.85 11.15 18.68 11.15 16C11.15 13.32 13.32 11.15 16 11.15M15 13V16.69L18.19 18.53L18.94 17.23L16.5 15.82V13Z",Bi="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",Ui="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10Z",Gi="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M5,5V7H19V5H5M5,9V11H13V9H5M5,13V15H15V13H5Z",Ki="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10M6,7H18V9H6V7M6,11H15V13H6V11Z",ji="M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9M12,4.5C17,4.5 21.27,7.61 23,12C21.27,16.39 17,19.5 12,19.5C7,19.5 2.73,16.39 1,12C2.73,7.61 7,4.5 12,4.5M3.18,12C4.83,15.36 8.24,17.5 12,17.5C15.76,17.5 19.17,15.36 20.82,12C19.17,8.64 15.76,6.5 12,6.5C8.24,6.5 4.83,8.64 3.18,12Z",Yi="M5,4V7H10.5V19H13.5V7H19V4H5Z",Xi="M16,17H5V7H16L19.55,12M17.63,5.84C17.27,5.33 16.67,5 16,5H5A2,2 0 0,0 3,7V17A2,2 0 0,0 5,19H16C16.67,19 17.27,18.66 17.63,18.15L22,12L17.63,5.84Z",Ji="M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z",Zi="M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z",Qi="M8,5.14V19.14L19,12.14L8,5.14Z",es="M17 19.1L19.5 20.6L18.8 17.8L21 15.9L18.1 15.7L17 13L15.9 15.6L13 15.9L15.2 17.8L14.5 20.6L17 19.1M3 14H11V16H3V14M3 6H15V8H3V6M3 10H15V12H3V10Z",ts="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z",ns="M12,18A6,6 0 0,1 6,12C6,11 6.25,10.03 6.7,9.2L5.24,7.74C4.46,8.97 4,10.43 4,12A8,8 0 0,0 12,20V23L16,19L12,15M12,4V1L8,5L12,9V6A6,6 0 0,1 18,12C18,13 17.75,13.97 17.3,14.8L18.76,16.26C19.54,15.03 20,13.57 20,12A8,8 0 0,0 12,4Z";function V(t,e=24){const n=String(e),r=String(e);return `<svg xmlns="http://www.w3.org/2000/svg" width="${n}" height="${r}" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true" focusable="false"><path d="${t}"></path></svg>`}const re=V(Qi),rs=V(Bi),is=V(Zi),ie=V(Ji),se=V(Ui),ss=V(Xi),nt=V(Yi),we=V(Wi),Se=V(ji),Ce=V(Ki),as=V(es),os=V(qi),ls=V(Gi),cs=V(ts),ds=V(ns),U=F("dAnime:SettingsUI"),b={searchInput:"#searchInput",searchAnimeTitle:"#searchAnimeTitle",searchEpisodeNumber:"#searchEpisodeNumber",searchEpisodeTitle:"#searchEpisodeTitle",searchButton:"#searchButton",openSearchPage:"#openSearchPageDirect",searchResults:"#searchResults",saveButton:"#saveSettings",opacitySlider:"#commentOpacity",opacityValue:"#opacityValue",visibilityToggle:"#commentVisibilityToggle",autoSearchToggle:"#autoSearchToggle",autoSearchOptionRow:"#autoSearchOptionRow",fixedPlaybackToggle:"#fixedPlaybackToggle",playbackOptionRow:"#playbackOptionRow",currentTitle:"#currentTitle",currentVideoId:"#currentVideoId",currentOwner:"#currentOwner",currentViewCount:"#currentViewCount",currentCommentCount:"#currentCommentCount",currentMylistCount:"#currentMylistCount",currentPostedAt:"#currentPostedAt",currentThumbnail:"#currentThumbnail",colorHexInput:"#colorHexInput",colorPickerInput:"#colorPickerInput",previewComment:"#previewComment",previewHiddenMsg:"#previewHiddenMsg",ngWords:"#ngWords",ngRegexps:"#ngRegexps",showNgWords:"#showNgWords",showNgRegexps:"#showNgRegexp",playCurrentVideo:"#playCurrentVideo",settingsModal:"#settingsModal",closeSettingsModal:"#closeSettingsModal",modalOverlay:".settings-modal__overlay",modalTabs:".settings-modal__tab",modalPane:".settings-modal__pane",searchSectionNote:"#searchSectionNote"},X=["search","display","ng"],rt=`
...
`;class de extends Ie{static FAB_HOST_ID="danime-settings-fab-host";settingsManager;fetcher;searcher;settings;playbackSettings;currentVideoInfo;hostElement=null;lastAutoButtonElement=null;activeTab="search";modalElement=null;overlayElement=null;closeButtonElement=null;fabElement=null;fabHostElement=null;fabShadowRoot=null;handleFabClick=e=>{e.preventDefault(),this.openSettingsModal();};handleOverlayClick=()=>{this.closeSettingsModal();};handleCloseClick=()=>{this.closeSettingsModal();};handlePlaybackSettingsChanged;constructor(e,n=new Z,r=new R){super(),this.settingsManager=e,this.fetcher=n,this.searcher=r,this.settings=this.settingsManager.getSettings(),this.playbackSettings=this.settingsManager.getPlaybackSettings(),this.currentVideoInfo=this.settingsManager.loadVideoData(),this.handlePlaybackSettingsChanged=i=>{this.playbackSettings=i,this.applyPlaybackSettingsToUI();},this.settingsManager.addPlaybackObserver(this.handlePlaybackSettingsChanged);}insertIntoMypage(){const e=document.querySelector(k.mypageHeaderTitle);e&&(this.hostElement=this.createSettingsUI(),e.parentElement?.insertBefore(this.hostElement,e.nextSibling));}addAutoCommentButtons(){}async waitMypageListStable(){}tryRestoreByDanimeIds(){return  false}createSettingsUI(){const e=document.createElement("div");e.className="nico-comment-shadow-host settings-host",this.createShadowDOM(e),this.addStyles(ce.getCommonStyles());const n=this.buildSettingsHtml();return this.setHTML(n),this.applySettingsToUI(),this.addStyles(rt),this.setupEventListeners(),e}buildSettingsHtml(){const e=a=>typeof a=="number"?a.toLocaleString():"-",n=a=>{if(!a)return "-";try{return new Date(a).toLocaleDateString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return a}},r=this.currentVideoInfo,i=r?.thumbnail??"",s=!!r?.videoId;return `
      <div class="nico-comment-settings">
        <h2>
          <span class="settings-title">d-anime-nico-comment-renderer</span>
          <span class="version-badge" aria-label="バージョン">${Ci}</span>
        </h2>
            ...
            <div class="video-card__info">
              ...
              <div class="video-card__meta-row">
                <div class="video-card__id" title="動画ID">
                  <span class="video-card__id-icon" aria-hidden="true">${ss}</span>
                  <span class="sr-only">動画ID</span>
                  <span id="currentVideoId">${r?.videoId??"未設定"}</span>
                </div>
                <div class="video-card__date" title="投稿日">
                  <span class="video-card__date-icon" aria-hidden="true">${os}</span>
              ...
              <div class="video-card__stats">
                ...
                <div class="video-card__stat" title="マイリスト数">
                  <span class="video-card__stat-icon" aria-hidden="true">${as}</span>
            ...
            <section class="settings-modal__pane is-active" data-pane="search" role="tabpanel" id="settingsPaneSearch" aria-labelledby="settingsTabSearch">
              <div class="setting-group search-section">
                ...
                <p id="searchSectionNote" class="search-section__note" style="background: ${this.settings.autoSearchEnabled?"#7F5AF0":"#2CB67D"}; color: #FFFFFE; padding: 12px; border-radius: 8px; margin-bottom: 16px; font-size: 14px;">
                  ...
                  手動で検索したい場合は、以下のフォームをご利用ください。`:`🔧 <strong>手動設定モード</strong><br>
                ...
                <div class="display-panel__controls">
                  ...
                  <section class="display-section" aria-labelledby="displayAppearanceTitle">
                    <div class="display-section__header">
                      ...
                      >
                        <span class="visibility-badge__icon" aria-hidden="true">${this.settings.isCommentVisible?se:ie}</span>
...
`)}</textarea>
          ...
          <footer class="settings-modal__footer">
            <button id="playCurrentVideo" class="settings-modal__play-button" type="button" title="この動画を再生">
              <span class="settings-modal__play-icon" aria-hidden="true">${re}</span>
    ...
    `}setupEventListeners(){this.setupModalControls(),this.setupModalTabs(),this.setupColorPresets(),this.setupColorPicker(),this.setupColorHexInput(),this.setupOpacitySlider(),this.setupVisibilityToggle(),this.setupAutoSearchToggle(),this.setupPlaybackToggle(),this.setupNgControls(),this.setupSaveButton(),this.setupSearch(),this.setupPlayButton();}setupModalControls(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick);const e=this.createOrUpdateFab(),n=this.queryModalElement(b.settingsModal),r=this.queryModalElement(b.closeSettingsModal),i=this.queryModalElement(b.modalOverlay);this.modalElement=n??null,this.closeButtonElement=r??null,this.overlayElement=i??null,!(!n||!r||!i||!e)&&(this.fabElement?.removeEventListener("click",this.handleFabClick),e.addEventListener("click",this.handleFabClick),e.setAttribute("aria-controls",n.id),e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false"),this.fabElement=e,r.addEventListener("click",this.handleCloseClick),i.addEventListener("click",this.handleOverlayClick),this.shadowRoot?.addEventListener("keydown",s=>{const a=s;a.key==="Escape"&&!this.modalElement?.classList.contains("hidden")&&(a.preventDefault(),this.closeSettingsModal());}),this.applySettingsToUI());}setupModalTabs(){const e=Array.from(this.queryModalSelectorAll(b.modalTabs)),n=Array.from(this.queryModalSelectorAll(b.modalPane));if(e.length===0||n.length===0)return;const r=i=>{e.forEach(s=>{const o=this.toModalTabKey(s.dataset.tab)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-selected",String(o)),s.setAttribute("tabindex",o?"0":"-1");}),n.forEach(s=>{const o=this.toModalTabKey(s.dataset.pane)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-hidden",String(!o));}),this.activeTab=i;};e.forEach(i=>{i.addEventListener("click",()=>{const s=this.toModalTabKey(i.dataset.tab);s&&r(s);}),i.addEventListener("keydown",s=>{const a=s;if(a.key!=="ArrowRight"&&a.key!=="ArrowLeft")return;a.preventDefault();const o=this.toModalTabKey(i.dataset.tab);if(!o)return;const l=a.key==="ArrowRight"?1:-1,d=(X.indexOf(o)+l+X.length)%X.length,h=X[d];r(h),e.find(p=>this.toModalTabKey(p.dataset.tab)===h)?.focus({preventScroll:true});});}),r(this.activeTab);}openSettingsModal(e=true){!this.modalElement||!this.fabElement||(this.modalElement.classList.remove("hidden"),this.modalElement.setAttribute("aria-hidden","false"),this.fabElement.setAttribute("aria-expanded","true"),e&&this.queryModalElement(`${b.modalTabs}.is-active`)?.focus({preventScroll:true}));}closeSettingsModal(){!this.modalElement||!this.fabElement||(this.modalElement.classList.add("hidden"),this.modalElement.setAttribute("aria-hidden","true"),this.fabElement.setAttribute("aria-expanded","false"),this.fabElement?.isConnected&&this.fabElement.focus({preventScroll:true}));}toModalTabKey(e){return e&&X.includes(e)?e:null}setupColorPresets(){this.queryModalSelectorAll(".color-preset-btn").forEach(n=>{n.addEventListener("click",()=>{const r=n.dataset.color;r&&(this.settings.commentColor=r,this.updateColorUI(r),this.updatePreview());});});}setupColorPicker(){const e=this.queryModalElement(b.colorPickerInput);e&&e.addEventListener("input",()=>{this.settings.commentColor=e.value,this.updateColorUI(e.value),this.updatePreview();});}setupColorHexInput(){const e=this.queryModalElement(b.colorHexInput);e&&(e.addEventListener("input",()=>{const n=e.value.trim();/^#[0-9A-Fa-f]{6}$/.test(n)&&(this.settings.commentColor=n,this.updateColorUI(n,false),this.updatePreview());}),e.addEventListener("blur",()=>{e.value=this.settings.commentColor;}));}updateColorUI(e,n=true){const r=this.queryModalElement(b.colorPickerInput),i=this.queryModalElement(b.colorHexInput);r&&(r.value=e),i&&n&&(i.value=e);}setupOpacitySlider(){const e=this.queryModalElement(b.opacitySlider),n=this.queryModalElement(b.opacityValue);e&&(e.value=(this.settings.commentOpacity??1).toString(),e.addEventListener("input",()=>{const r=Number(e.value);Number.isNaN(r)||(this.settings.commentOpacity=r,n&&(n.textContent=`${Math.round(r*100)}%`),this.updatePreview());}));}setupVisibilityToggle(){const e=this.queryModalElement(b.visibilityToggle);e&&(e.addEventListener("click",()=>{this.settings.isCommentVisible=!this.settings.isCommentVisible,this.updateVisibilityToggleState(e),this.updatePreview();}),this.updateVisibilityToggleState(e));}setupAutoSearchToggle(){const e=this.queryModalElement(b.autoSearchToggle),n=this.queryModalElement(b.autoSearchOptionRow);if(!e||!n)return;const r=()=>{this.settings.autoSearchEnabled=!this.settings.autoSearchEnabled,this.updateAutoSearchToggleState(),this.updateSearchSectionNote(),this.settingsManager.updateSettings(this.settings),f.show(this.settings.autoSearchEnabled?"自動検索を有効にしました":"自動検索を無効にしました（手動設定モード）","success");};n.addEventListener("click",i=>{i.target.closest(".playback-option__toggle")||r();}),n.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r());}),e.addEventListener("change",()=>{r();}),this.updateAutoSearchToggleState();}updateAutoSearchToggleState(){const e=this.settings.autoSearchEnabled,n=this.queryModalElement(b.autoSearchToggle),r=this.queryModalElement(b.autoSearchOptionRow),i=r?.querySelector(".playback-option__icon-wrapper");n&&(n.checked=e),r&&(r.classList.toggle("playback-option--active",e),r.setAttribute("aria-pressed",e?"true":"false")),i&&i.classList.toggle("playback-option__icon-wrapper--active",e);}updateSearchSectionNote(){const e=this.queryModalElement(b.searchSectionNote);if(!e)return;const n=this.settings.autoSearchEnabled;e.style.background=n?"#7F5AF0":"#2CB67D",e.innerHTML=n?`ℹ️ <strong>自動設定機能が有効です</strong><br>
        視聴ページを開くと、アニメタイトル・話数・エピソードタイトルから自動的にコメント数が最も多いニコニコ動画を検索して表示します。<br>
        手動で検索したい場合は、以下のフォームをご利用ください。`:`🔧 <strong>手動設定モード</strong><br>
        自動検索が無効になっています。以下のフォームから動画を検索して選択してください。<br>
        自動検索を有効にするには「表示」タブの設定を変更してください。`;}setupPlaybackToggle(){const e=this.queryModalElement(b.fixedPlaybackToggle),n=this.queryModalElement(b.playbackOptionRow);if(!e||!n)return;const r=()=>{const i=!this.playbackSettings.fixedModeEnabled,s={...this.playbackSettings,fixedModeEnabled:i};if(!this.settingsManager.updatePlaybackSettings(s)){f.show("再生速度の設定変更に失敗しました","error"),this.applyPlaybackSettingsToUI();return}this.playbackSettings=s,this.updatePlaybackToggleState(),f.show(i?`${this.formatPlaybackRateLabel(this.playbackSettings.fixedRate)}固定モードを有効にしました`:"固定再生モードを無効にしました","success");};n.addEventListener("click",i=>{i.target.closest(".playback-option__toggle")||r();}),n.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r());}),e.addEventListener("change",()=>{r();}),this.updatePlaybackToggleState();}setupNgControls(){const e=this.queryModalElement(b.ngWords);e&&e.classList.remove("hidden");const n=this.queryModalElement(b.ngRegexps);n&&n.classList.remove("hidden");}setupSaveButton(){const e=this.queryModalElement(b.saveButton);e&&e.addEventListener("click",()=>this.saveSettings());}setupSearch(){const e=this.queryModalElement(b.searchInput),n=this.queryModalElement(b.searchAnimeTitle),r=this.queryModalElement(b.searchEpisodeNumber),i=this.queryModalElement(b.searchEpisodeTitle),s=this.queryModalElement(b.searchButton),a=this.queryModalElement(b.openSearchPage),o=this.settingsManager.loadManualSearchSettings();o&&(n&&(n.value=o.animeTitle),r&&(r.value=o.episodeNumber),i&&(i.value=o.episodeTitle));const l=()=>{const p=e?.value.trim()??"";if(p)return p;const u=n?.value.trim()??"",m=r?.value.trim()??"",y=i?.value.trim()??"";return [u,m,y].filter(Boolean).join(" ")},d=()=>{const p=n?.value.trim()??"",u=r?.value.trim()??"",m=i?.value.trim()??"";(p||u)&&this.settingsManager.saveManualSearchSettings({animeTitle:p,episodeNumber:u,episodeTitle:m});},h=async()=>{const p=l();if(!p){f.show("検索キーワードを入力してください","warning");return}d();const u=n?.value.trim()??"";await this.executeSearch(p,u);};s?.addEventListener("click",h);const c=p=>{p.key==="Enter"&&h();};e?.addEventListener("keydown",c),n?.addEventListener("keydown",c),r?.addEventListener("keydown",c),i?.addEventListener("keydown",c),a?.addEventListener("click",p=>{p.preventDefault();const u=l(),m=u?Et(u):Xe.searchBase;Me().open(m,"_blank","noopener");});}async executeSearch(e,n){try{f.show(`「${e}」を検索中...`,"info");const r=await this.searcher.search(e);let i=r;if(n){const s=R.filterOfficialVideos(r,n);s.length>0?(i=s,U.info("SettingsUI.executeSearch:officialFiltered",{totalResults:r.length,officialResults:s.length,animeTitle:n})):(U.warn("SettingsUI.executeSearch:noOfficialVideos",{totalResults:r.length,animeTitle:n}),f.show("公式動画が見つかりませんでした。全ての検索結果を表示しています。","warning"));}return this.renderSearchResults(i,s=>this.renderSearchResultItem(s)),i.length===0&&f.show("検索結果が見つかりませんでした","warning"),i}catch(r){return U.error("SettingsUI.executeSearch",r),[]}}setSearchKeyword(e){const n=this.queryModalElement(b.searchInput);n&&(n.value=e,n.focus({preventScroll:true}));}renderSearchResults(e,n){const r=this.queryModalElement(b.searchResults);if(!r)return;r.innerHTML=e.map(s=>n(s)).join(""),r.querySelectorAll(".search-result-item").forEach((s,a)=>{s.addEventListener("click",()=>{const l=e[a];this.applySearchResult(l);});const o=s.querySelector(".open-search-page-direct-btn");o&&o.addEventListener("click",l=>{l.stopPropagation();});});}renderSearchResultItem(e){const n=this.formatSearchResultDate(e.postedAt),r=typeof e.similarity=="number"?`
      ...
      <div class="search-result-item">
        ...
        <div class="search-result-info">
          ...
          <a href="${Xe.watchBase}/${e.videoId}" target="_blank" rel="noopener"
             class="open-search-page-direct-btn" style="margin-top: 8px; margin-left: 8px; display: inline-block; text-decoration: none;">
            視聴ページ
          </a>
        </div>
      </div>
    `}async applySearchResult(e){try{const n=await this.fetcher.fetchApiData(e.videoId);await this.fetcher.fetchComments(),f.show(`「${e.title}」のコメントを設定しました`,"success"),this.updateCurrentVideoInfo(this.buildVideoMetadata(e,n));}catch(n){U.error("SettingsUI.applySearchResult",n);}}buildVideoMetadata(e,n){return {videoId:e.videoId,title:e.title,viewCount:n.video?.count?.view??e.viewCount,commentCount:n.video?.count?.comment??e.commentCount,mylistCount:n.video?.count?.mylist??e.mylistCount,postedAt:n.video?.registeredAt??e.postedAt,thumbnail:n.video?.thumbnail?.url??e.thumbnail,owner:n.owner??e.owner??void 0,channel:n.channel??e.channel??void 0}}applySettingsToUI(){const e=this.queryModalElement(b.opacitySlider),n=this.queryModalElement(b.opacityValue),r=this.queryModalElement(b.visibilityToggle),i=this.queryModalElement(b.colorPickerInput),s=this.queryModalElement(b.colorHexInput),a=this.queryModalElement(b.ngWords),o=this.queryModalElement(b.ngRegexps);e&&(e.value=(this.settings.commentOpacity??1).toString()),n&&(n.textContent=`${Math.round((this.settings.commentOpacity??1)*100)}%`),r&&this.updateVisibilityToggleState(r),i&&this.settings.commentColor&&(i.value=this.settings.commentColor),s&&this.settings.commentColor&&(s.value=this.settings.commentColor),a&&(a.value=(this.settings.ngWords??[]).join(`
`)),o&&(o.value=(this.settings.ngRegexps??[]).join(`
`)),this.applyPlaybackSettingsToUI(),this.updateAutoSearchToggleState(),this.updateSearchSectionNote(),this.updatePlayButtonState(this.currentVideoInfo),this.updatePreview();}saveSettings(){const e=this.queryModalElement(b.opacitySlider),n=this.queryModalElement(b.ngWords),r=this.queryModalElement(b.ngRegexps);if(e){const i=Number(e.value);Number.isNaN(i)||(this.settings.commentOpacity=i);}n&&(this.settings.ngWords=n.value.split(`
`).map(i=>i.trim()).filter(Boolean)),r&&(this.settings.ngRegexps=r.value.split(`
`).map(i=>i.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings);}updateCurrentVideoInfo(e){this.currentVideoInfo=e,[["currentTitle",e.title??"-"],["currentVideoId",e.videoId??"-"],["currentOwner",e.owner?.nickname??e.channel?.name??"-"],["currentViewCount",this.formatNumber(e.viewCount)],["currentCommentCount",this.formatNumber(e.commentCount)],["currentMylistCount",this.formatNumber(e.mylistCount)],["currentPostedAt",this.formatSearchResultDate(e.postedAt)]].forEach(([a,o])=>{const l=this.querySelector(b[a]);l&&(l.textContent=o);});const r=this.querySelector(b.currentThumbnail);r&&e.thumbnail&&(r.src=e.thumbnail,r.alt=e.title??"サムネイル");const i=this.querySelector("#currentVideoAmbient");i&&e.thumbnail&&(i.style.backgroundImage=`url('${e.thumbnail}')`);const s=this.querySelector(".video-card");s&&s.classList.toggle("video-card--empty",!e.videoId);try{this.settingsManager.saveVideoData(e.title??"",e);}catch(a){U.error("SettingsUI.updateCurrentVideoInfo",a);}this.updatePlayButtonState(e);}formatNumber(e){return typeof e=="number"?e.toLocaleString():"-"}formatSearchResultDate(e){if(!e)return "-";const n=new Date(e);return Number.isNaN(n.getTime())?e:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(n)}formatPlaybackRateLabel(e){return `${(Number.isFinite(e)?e:1.11).toFixed(2).replace(/\.?0+$/,"")}倍`}setupPlayButton(){const e=this.queryModalElement(b.playCurrentVideo);e&&(e.addEventListener("click",()=>{try{if(!this.currentVideoInfo?.videoId){f.show("再生できる動画が設定されていません","warning");return}const r=this.lastAutoButtonElement?.closest(".itemModule.list");if(this.lastAutoButtonElement){const i=r?.querySelector(".thumbnailContainer > a, .thumbnail-container > a");if(i){f.show(`「${this.currentVideoInfo?.title||"動画"}」を再生します...`,"success"),setTimeout(()=>{i.click();},300);return}}f.show("再生リンクが見つかりませんでした（対象アイテム内に限定して検索済み）","warning");}catch(n){U.error("SettingsUI.playCurrentVideo",n),f.show(`再生エラー: ${n.message}`,"error");}}),this.updatePlayButtonState(this.currentVideoInfo));}updatePlayButtonState(e){const n=this.queryModalElement(b.playCurrentVideo);if(!n)return;const r=!!e?.videoId;n.disabled=!r,n.setAttribute("aria-disabled",(!r).toString());}updateVisibilityToggleState(e){const n=this.settings.isCommentVisible;e.classList.toggle("visibility-badge--off",!n),e.setAttribute("aria-pressed",n?"true":"false");const r=e.querySelector(".visibility-badge__icon"),i=e.querySelector(".visibility-badge__label");r&&(r.innerHTML=n?se:ie),i&&(i.textContent=n?"表示中":"非表示");}applyPlaybackSettingsToUI(){this.updatePlaybackToggleState();}updatePlaybackToggleState(){const e=this.playbackSettings.fixedModeEnabled,n=this.queryModalElement(b.fixedPlaybackToggle),r=this.queryModalElement(b.playbackOptionRow),i=r?.querySelector(".playback-option__icon-wrapper");n&&(n.checked=e),r&&(r.classList.toggle("playback-option--active",e),r.setAttribute("aria-pressed",e?"true":"false")),i&&i.classList.toggle("playback-option__icon-wrapper--active",e);}updatePreview(){const e=this.queryModalElement(b.previewComment),n=this.queryModalElement(b.previewHiddenMsg);e&&(e.style.color=this.settings.commentColor,e.style.opacity=String(this.settings.commentOpacity??1),e.style.display=this.settings.isCommentVisible?"block":"none"),n&&(n.style.display=this.settings.isCommentVisible?"none":"flex");}destroy(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),this.settingsManager.removePlaybackObserver(this.handlePlaybackSettingsChanged),super.destroy();}createOrUpdateFab(){if(!document.body)return null;let e=this.fabHostElement;!e||!e.isConnected?(e?.remove(),e=document.createElement("div"),e.id=de.FAB_HOST_ID,e.style.position="fixed",e.style.bottom="32px",e.style.right="32px",e.style.zIndex="2147483646",e.style.display="inline-block",this.fabShadowRoot=e.attachShadow({mode:"open"}),document.body.appendChild(e),this.fabHostElement=e):this.fabShadowRoot||(this.fabShadowRoot=e.shadowRoot??e.attachShadow({mode:"open"}));const n=this.fabShadowRoot;if(!n)return null;let r=n.querySelector("style[data-role='fab-base-style']");r||(r=document.createElement("style"),r.dataset.role="fab-base-style",r.textContent=ce.getCommonStyles(),n.appendChild(r));let i=n.querySelector("style[data-role='fab-style']");i||(i=document.createElement("style"),i.dataset.role="fab-style",i.textContent=`
        :host {
          all: initial;
        }
