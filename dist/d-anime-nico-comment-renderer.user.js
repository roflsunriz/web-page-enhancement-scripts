...
(function () {
  ...
  const et={debug:"debug",info:"info",warn:"warn",error:"error"},S=r=>{const t=`[${r}]`,e={};return Object.keys(et).forEach(n=>{const i=et[n];e[n]=(...o)=>{(console[i]??console.log)(t,...o);};}),e};function H(){return typeof unsafeWindow<"u"?unsafeWindow:window}const Ft={commentColor:"#FFFFFF",commentOpacity:.75,isCommentVisible:true,ngWords:[],ngRegexps:[]},z=Ft,v=()=>({...z,ngWords:[...z.ngWords],ngRegexps:[...z.ngRegexps]});var Ot=typeof GM_addStyle<"u"?GM_addStyle:void 0,N=typeof GM_getValue<"u"?GM_getValue:void 0,F=typeof GM_setValue<"u"?GM_setValue:void 0,Dt=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0;const nt="settings",rt="currentVideo",it="lastDanimeIds",Pt=r=>({...r,ngWords:[...r.ngWords],ngRegexps:[...r.ngRegexps]});class U{constructor(t){this.notifier=t,this.settings=v(),this.currentVideo=null,this.loadSettings(),this.currentVideo=this.loadVideoData();}settings;currentVideo;observers=new Set;getSettings(){return Pt(this.settings)}loadSettings(){try{const t=N(nt,null);if(!t)return this.settings=v(),this.settings;if(typeof t=="string"){const e=JSON.parse(t);this.settings={...v(),...e,ngWords:Array.isArray(e?.ngWords)?[...e.ngWords]:[],ngRegexps:Array.isArray(e?.ngRegexps)?[...e.ngRegexps]:[]};}else this.settings={...v(),...t,ngWords:Array.isArray(t.ngWords)?[...t.ngWords]:[],ngRegexps:Array.isArray(t.ngRegexps)?[...t.ngRegexps]:[]};return this.notifyObservers(),this.settings}catch(t){return console.error("[SettingsManager] 設定の読み込みに失敗しました",t),this.notify("設定の読み込みに失敗しました","error"),this.settings=v(),this.settings}}saveSettings(){try{return F(nt,JSON.stringify(this.settings)),this.notifyObservers(),this.notify("設定を保存しました","success"),!0}catch(t){return console.error("[SettingsManager] 設定の保存に失敗しました",t),this.notify("設定の保存に失敗しました","error"),false}}updateSettings(t){return this.settings={...this.settings,...t,ngWords:t.ngWords?[...t.ngWords]:[...this.settings.ngWords],ngRegexps:t.ngRegexps?[...t.ngRegexps]:[...this.settings.ngRegexps]},this.saveSettings()}addObserver(t){this.observers.add(t);}removeObserver(t){this.observers.delete(t);}notifyObservers(){const t=this.getSettings();for(const e of this.observers)try{e(t);}catch(n){console.error("[SettingsManager] 設定変更通知でエラー",n);}}loadVideoData(){try{return N(rt,null)??null}catch(t){return console.error("[SettingsManager] 動画データの読み込みに失敗しました",t),this.notify("動画データの読み込みに失敗しました","error"),null}}saveVideoData(t,e){try{const n={videoId:e.videoId,title:e.title,viewCount:e.viewCount,commentCount:e.commentCount,mylistCount:e.mylistCount,postedAt:e.postedAt,thumbnail:e.thumbnail,owner:e.owner??null,channel:e.channel??null};return F(rt,n),this.currentVideo=n,!0}catch(n){return console.error("[SettingsManager] 動画データの保存に失敗しました",n),this.notify("動画データの保存に失敗しました","error"),false}}getCurrentVideo(){return this.currentVideo?{...this.currentVideo}:null}saveLastDanimeIds(t){try{return F(it,t),!0}catch(e){return console.error("[SettingsManager] saveLastDanimeIds failed",e),this.notify("ID情報の保存に失敗しました","error"),false}}loadLastDanimeIds(){try{return N(it,null)??null}catch(t){return console.error("[SettingsManager] loadLastDanimeIds failed",t),this.notify("ID情報の読込に失敗しました","error"),null}}notify(t,e="info"){this.notifier?.show(t,e);}}const O=S("dAnime:Comment");class $t{text;vpos;commands;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily="Arial";opacity;isActive=false;hasShown=false;isPaused=false;lastUpdateTime=0;reservationWidth=0;constructor(t,e,n=[],i){if(typeof t!="string")throw new Error("Comment text must be a string");if(!Number.isFinite(e)||e<0)throw new Error("Comment vpos must be a non-negative number");this.text=t,this.vpos=e,this.commands=Array.isArray(n)?n:[],this.color=i.commentColor,this.opacity=i.commentOpacity;}prepare(t,e,n){try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(e)||!Number.isFinite(n))throw new Error("Canvas dimensions must be numbers");this.fontSize=Math.max(24,Math.floor(n*.05)),t.font=`${this.fontSize}px ${this.fontFamily}`,this.width=t.measureText(this.text).width,this.height=this.fontSize;const i=t.measureText("あ".repeat(150)).width;this.reservationWidth=Math.min(i,this.width*5),this.x=e,this.baseSpeed=(e+this.reservationWidth)/720,this.speed=this.baseSpeed,this.lastUpdateTime=performance.now();}catch(i){throw O.error("Comment.prepare",i,{text:this.text,canvasWidth:e,canvasHeight:n,hasContext:!!t}),i}}update(t=1,e=false){try{if(!this.isActive||this.isPaused)return;const n=performance.now(),i=(n-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*t,this.x-=this.speed*i,this.x<-this.width&&(this.isActive=!1),this.lastUpdateTime=n,this.isPaused=e;}catch(n){O.error("Comment.update",n,{text:this.text,playbackRate:t,isPaused:e,isActive:this.isActive});}}draw(t,e=null){try{if(!this.isActive||!t)return;t.save(),t.globalAlpha=this.opacity,t.font=`${this.fontSize}px ${this.fontFamily}`;const n=e??this.x,i=this.y+this.fontSize;t.strokeStyle="#000000",t.lineWidth=Math.max(3,this.fontSize/8),t.lineJoin="round",t.strokeText(this.text,n,i),t.fillStyle=this.color,t.fillText(this.text,n,i),t.restore();}catch(n){O.error("Comment.draw",n,{text:this.text,isActive:this.isActive,hasContext:!!t,interpolatedX:e});}}}const Wt=new Set(["INPUT","TEXTAREA"]),D=r=>r.length===1?r.toUpperCase():r,qt=r=>r?`${r}+`:"";class wt{shortcuts=new Map;boundHandler;isEnabled=true;isListening=false;constructor(){this.boundHandler=this.handleKeyDown.bind(this);}addShortcut(t,e,n){const i=this.createShortcutKey(D(t),e);this.shortcuts.set(i,n);}removeShortcut(t,e){const n=this.createShortcutKey(D(t),e);this.shortcuts.delete(n);}startListening(){this.isListening||(document.addEventListener("keydown",this.boundHandler,false),this.isListening=true);}stopListening(){this.isListening&&(document.removeEventListener("keydown",this.boundHandler,false),this.isListening=false);}setEnabled(t){this.isEnabled=t;}createShortcutKey(t,e){return `${qt(e)}${t}`}extractModifier(t){const e=[];return t.ctrlKey&&e.push("Ctrl"),t.altKey&&e.push("Alt"),t.shiftKey&&e.push("Shift"),t.metaKey&&e.push("Meta"),e.length>0?e.join("+"):null}handleKeyDown(t){if(!this.isEnabled)return;const n=t.target?.tagName??"";if(Wt.has(n))return;const i=this.extractModifier(t),o=this.createShortcutKey(D(t.key),i),s=this.shortcuts.get(o);s&&(t.preventDefault(),s());}}var Bt=(function(){if(typeof document>"u")return "transform";for(var r=["oTransform","msTransform","mozTransform","webkitTransform","transform"],t=document.createElement("div").style,e=0;e<r.length;e++)if(r[e]in t)return r[e];return "transform"})();function Ht(r){var t=document.createElement("div");if(t.style.cssText="position:absolute;",typeof r.render=="function"){var e=r.render();if(e instanceof HTMLElement)return t.appendChild(e),t}if(t.textContent=r.text,r.style)for(var n in r.style)t.style[n]=r.style[n];return t}function Ut(){var r=document.createElement("div");return r.style.cssText="overflow:hidden;white-space:nowrap;transform:translateZ(0);",r}function Gt(r){for(var t=r.lastChild;t;)r.removeChild(t),t=r.lastChild;}function jt(r,t,e){r.style.width=t+"px",r.style.height=e+"px";}function Kt(){}function Yt(r,t){var e=document.createDocumentFragment(),n=0,i=null;for(n=0;n<t.length;n++)i=t[n],i.node=i.node||Ht(i),e.appendChild(i.node);for(t.length&&r.appendChild(e),n=0;n<t.length;n++)i=t[n],i.width=i.width||i.node.offsetWidth,i.height=i.height||i.node.offsetHeight;}function Xt(r,t){t.node.style[Bt]="translate("+t.x+"px,"+t.y+"px)";}function Jt(r,t){r.removeChild(t.node),this.media||(t.node=null);}var Zt={name:"dom",init:Ut,clear:Gt,resize:jt,framing:Kt,setup:Yt,render:Xt,remove:Jt},w=typeof window<"u"&&window.devicePixelRatio||1,P=Object.create(null);function Qt(r,t){if(P[r])return P[r];var e=12,n=/(\d+(?:\.\d+)?)(px|%|em|rem)(?:\s*\/\s*(\d+(?:\.\d+)?)(px|%|em|rem)?)?/,i=r.match(n);if(i){var o=i[1]*1||10,s=i[2],a=i[3]*1||1.2,c=i[4];s==="%"&&(o*=t.container/100),s==="em"&&(o*=t.container),s==="rem"&&(o*=t.root),c==="px"&&(e=a),c==="%"&&(e=o*a/100),c==="em"&&(e=o*a),c==="rem"&&(e=t.root*a),c===void 0&&(e=o*a);}return P[r]=e,e}function te(r,t){if(typeof r.render=="function"){var e=r.render();if(e instanceof HTMLCanvasElement)return r.width=e.width,r.height=e.height,e}var n=document.createElement("canvas"),i=n.getContext("2d"),o=r.style||{};o.font=o.font||"10px sans-serif",o.textBaseline=o.textBaseline||"bottom";var s=o.lineWidth*1;s=s>0&&s!==1/0?Math.ceil(s):!!o.strokeStyle*1,i.font=o.font,r.width=r.width||Math.max(1,Math.ceil(i.measureText(r.text).width)+s*2),r.height=r.height||Math.ceil(Qt(o.font,t))+s*2,n.width=r.width*w,n.height=r.height*w,i.scale(w,w);for(var a in o)i[a]=o[a];var c=0;switch(o.textBaseline){case "top":case "hanging":c=s;break;case "middle":c=r.height>>1;break;default:c=r.height-s;}return o.strokeStyle&&i.strokeText(r.text,s,c),i.fillText(r.text,s,c),n}function ot(r){return window.getComputedStyle(r,null).getPropertyValue("font-size").match(/(.+)px/)[1]*1}function ee(r){var t=document.createElement("canvas");return t.context=t.getContext("2d"),t._fontSize={root:ot(document.getElementsByTagName("html")[0]),container:ot(r)},t}function ne(r,t){r.context.clearRect(0,0,r.width,r.height);for(var e=0;e<t.length;e++)t[e].canvas=null;}function re(r,t,e){r.width=t*w,r.height=e*w,r.style.width=t+"px",r.style.height=e+"px";}function ie(r){r.context.clearRect(0,0,r.width,r.height);}function oe(r,t){for(var e=0;e<t.length;e++){var n=t[e];n.canvas=te(n,r._fontSize);}}function se(r,t){r.context.drawImage(t.canvas,t.x*w,t.y*w);}function ae(r,t){t.canvas=null;}var ce={name:"canvas",init:ee,clear:ne,resize:re,framing:ie,setup:oe,render:se,remove:ae},st=(function(){if(typeof window<"u"){var r=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame;if(r)return r.bind(window)}return function(t){return setTimeout(t,50/3)}})(),le=(function(){if(typeof window<"u"){var r=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame;if(r)return r.bind(window)}return clearTimeout})();function St(r,t,e){for(var n=0,i=0,o=r.length;i<o-1;)n=i+o>>1,e>=r[n][t]?i=n:o=n;return r[i]&&e<r[i][t]?i:o}function Ct(r){return /^(ltr|top|bottom)$/i.test(r)?r.toLowerCase():"rtl"}function _(){var r=9007199254740991;return [{range:0,time:-r,width:r,height:0},{range:r,time:r,width:0,height:0}]}function Et(r){r.ltr=_(),r.rtl=_(),r.top=_(),r.bottom=_();}function M(){return typeof window.performance<"u"&&window.performance.now?window.performance.now():Date.now()}function de(r){var t=this,e=this.media?this.media.currentTime:M()/1e3,n=this.media?this.media.playbackRate:1;function i(y,f){if(f.mode==="top"||f.mode==="bottom")return e-y.time<t._.duration;var A=t._.width+y.width,E=A*(e-y.time)*n/t._.duration;if(y.width>E)return  true;var k=t._.duration+y.time-e,Q=t._.width+f.width,V=t.media?f.time:f._utc,tt=Q*(e-V)*n/t._.duration,zt=t._.width-tt,Nt=t._.duration*zt/(t._.width+f.width);return k>Nt}for(var o=this._.space[r.mode],s=0,a=0,c=1;c<o.length;c++){var l=o[c],d=r.height;if((r.mode==="top"||r.mode==="bottom")&&(d+=l.height),l.range-l.height-o[s].range>=d){a=c;break}i(l,r)&&(s=c);}var h=o[s].range,m={range:h+r.height,time:this.media?r.time:r._utc,width:r.width,height:r.height};return o.splice(s+1,a-s-1,m),r.mode==="bottom"?this._.height-r.height-h%this._.height:h%(this._.height-r.height)}function he(r,t,e,n){return function(i){r(this._.stage);var o=i||M(),s=o/1e3,a=this.media?this.media.currentTime:s,c=this.media?this.media.playbackRate:1,l=null,d=0,h=0;for(h=this._.runningList.length-1;h>=0;h--)l=this._.runningList[h],d=this.media?l.time:l._utc,a-d>this._.duration&&(n(this._.stage,l),this._.runningList.splice(h,1));for(var m=[];this._.position<this.comments.length&&(l=this.comments[this._.position],d=this.media?l.time:l._utc,!(d>=a));){if(a-d>this._.duration){++this._.position;continue}this.media&&(l._utc=s-(this.media.currentTime-l.time)),m.push(l),++this._.position;}for(t(this._.stage,m),h=0;h<m.length;h++)l=m[h],l.y=de.call(this,l),this._.runningList.push(l);for(h=0;h<this._.runningList.length;h++){l=this._.runningList[h];var y=this._.width+l.width,f=y*(s-l._utc)*c/this._.duration;l.mode==="ltr"&&(l.x=f-l.width),l.mode==="rtl"&&(l.x=this._.width-f),(l.mode==="top"||l.mode==="bottom")&&(l.x=this._.width-l.width>>1),e(this._.stage,l);}}}function G(){if(!this._.visible||!this._.paused)return this;if(this._.paused=false,this.media)for(var r=0;r<this._.runningList.length;r++){var t=this._.runningList[r];t._utc=M()/1e3-(this.media.currentTime-t.time);}var e=this,n=he(this._.engine.framing.bind(this),this._.engine.setup.bind(this),this._.engine.render.bind(this),this._.engine.remove.bind(this));function i(o){n.call(e,o),e._.requestID=st(i);}return this._.requestID=st(i),this}function j(){return !this._.visible||this._.paused?this:(this._.paused=true,le(this._.requestID),this._.requestID=0,this)}function K(){if(!this.media)return this;this.clear(),Et(this._.space);var r=St(this.comments,"time",this.media.currentTime);return this._.position=Math.max(0,r-1),this}function ue(r){r.play=G.bind(this),r.pause=j.bind(this),r.seeking=K.bind(this),this.media.addEventListener("play",r.play),this.media.addEventListener("pause",r.pause),this.media.addEventListener("playing",r.play),this.media.addEventListener("waiting",r.pause),this.media.addEventListener("seeking",r.seeking);}function pe(r){this.media.removeEventListener("play",r.play),this.media.removeEventListener("pause",r.pause),this.media.removeEventListener("playing",r.play),this.media.removeEventListener("waiting",r.pause),this.media.removeEventListener("seeking",r.seeking),r.play=null,r.pause=null,r.seeking=null;}function me(r){this._={},this.container=r.container||document.createElement("div"),this.media=r.media,this._.visible=true,this.engine=(r.engine||"DOM").toLowerCase(),this._.engine=this.engine==="canvas"?ce:Zt,this._.requestID=0,this._.speed=Math.max(0,r.speed)||144,this._.duration=4,this.comments=r.comments||[],this.comments.sort(function(e,n){return e.time-n.time});for(var t=0;t<this.comments.length;t++)this.comments[t].mode=Ct(this.comments[t].mode);return this._.runningList=[],this._.position=0,this._.paused=true,this.media&&(this._.listener={},ue.call(this,this._.listener)),this._.stage=this._.engine.init(this.container),this._.stage.style.cssText+="position:relative;pointer-events:none;",this.resize(),this.container.appendChild(this._.stage),this._.space={},Et(this._.space),(!this.media||!this.media.paused)&&(K.call(this),G.call(this)),this}function ge(){if(!this.container)return this;j.call(this),this.clear(),this.container.removeChild(this._.stage),this.media&&pe.call(this,this._.listener);for(var r in this)Object.prototype.hasOwnProperty.call(this,r)&&(this[r]=null);return this}var T=["mode","time","text","render","style"];function fe(r){if(!r||Object.prototype.toString.call(r)!=="[object Object]")return this;for(var t={},e=0;e<T.length;e++)r[T[e]]!==void 0&&(t[T[e]]=r[T[e]]);if(t.text=(t.text||"").toString(),t.mode=Ct(t.mode),t._utc=M()/1e3,this.media){var n=0;t.time===void 0?(t.time=this.media.currentTime,n=this._.position):(n=St(this.comments,"time",t.time),n<this._.position&&(this._.position+=1)),this.comments.splice(n,0,t);}else this.comments.push(t);return this}function be(){return this._.visible?this:(this._.visible=true,this.media&&this.media.paused?this:(K.call(this),G.call(this),this))}function ye(){return this._.visible?(j.call(this),this.clear(),this._.visible=false,this):this}function xe(){return this._.engine.clear(this._.stage,this._.runningList),this._.runningList=[],this}function ve(){return this._.width=this.container.offsetWidth,this._.height=this.container.offsetHeight,this._.engine.resize(this._.stage,this._.width,this._.height),this._.duration=this._.width/this._.speed,this}var we={get:function(){return this._.speed},set:function(r){return typeof r!="number"||isNaN(r)||!isFinite(r)||r<=0?this._.speed:(this._.speed=r,this._.width&&(this._.duration=this._.width/r),r)}};function C(r){r&&me.call(this,r);}C.prototype.destroy=function(){return ge.call(this)};C.prototype.emit=function(r){return fe.call(this,r)};C.prototype.show=function(){return be.call(this)};C.prototype.hide=function(){return ye.call(this)};C.prototype.clear=function(){return xe.call(this)};C.prototype.resize=function(){return ve.call(this)};Object.defineProperty(C.prototype,"speed",we);const x=S("dAnime:CommentRenderer"),L=r=>r*1e3,Se="bold",Ce="'MS PGothic', 'sans-serif'",at=24,Ee="1px 1px 2px #000, -1px -1px 2px #000, 1px -1px 2px #000, -1px 1px 2px #000",ct=2e3,lt=16,$=4,ke=18,Ie=60,dt=1.2,ht=["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"],ut=()=>{const r=document;return r.fullscreenElement??r.webkitFullscreenElement??r.mozFullScreenElement??r.msFullscreenElement??null};class kt{_settings;danmaku=null;allComments=[];lastEmittedIndex=-1;canvas=null;videoElement=null;currentTime=0;duration=0;finalPhaseActive=false;keyboardHandler=null;sizeObserver=null;isResizeObserverAvailable;container=null;fullscreenEventsAttached=false;scrollListenerAttached=false;cachedFontSizePx=at;constructor(t){this._settings=t?{...t}:v(),this.isResizeObserverAvailable=typeof ResizeObserver<"u";}get settings(){return this._settings}set settings(t){this._settings={...t};}initialize(t){try{x.debug("initialize:start",{readyState:t.readyState,duration:t.duration}),this.danmaku&&this.destroy(),this.videoElement=t,this.duration=L(t.duration),x.info("videoRenderer:boundVideo",{src:this.resolveVideoSource(t),videoId:t.dataset?.videoId??null,durationMs:this.duration});const e=document.createElement("div");e.style.position="absolute",e.style.pointerEvents="none",e.style.zIndex="1000",e.style.top="0px",e.style.left="0px";const n=t.getBoundingClientRect();e.style.width=`${n.width}px`,e.style.height=`${n.height}px`;const i=t.parentElement??document.body;i.style.position=i.style.position||"relative",i.appendChild(e),this.container=e;const o=n.width/$;this.danmaku=new C({container:e,media:t,comments:[],engine:"canvas",speed:o}),this.canvas=e.querySelector("canvas"),this.setupVideoEventListeners(t),this.setupKeyboardShortcuts(),this.setupResizeListener(e,t),x.debug("initialize:completed");}catch(e){throw x.error("CommentRenderer.initialize",e),e}}addComment(t,e,n){if(this.isNGComment(t)||this.allComments.some(s=>s.text===t&&s.time===e/1e3))return null;const o={text:t,time:e/1e3,style:this.createCommentStyle(),commands:n?[...n]:void 0};return this.allComments.push(o),this.allComments.sort((s,a)=>s.time-a.time),o}clearComments(){this.allComments=[],this.lastEmittedIndex=-1,this.finalPhaseActive=false,this.danmaku?.clear();}resetState(){this.clearComments(),this.currentTime=0,this.finalPhaseActive=false;}destroy(){const t=this.videoElement;t&&x.info("videoRenderer:unbindVideo",{src:this.resolveVideoSource(t),videoId:t.dataset?.videoId??null}),this.keyboardHandler?.stopListening(),this.keyboardHandler=null,this.teardownResizeListener(),this.danmaku?.destroy(),this.danmaku=null,this.videoElement=null,this.container=null;}updateSettings(t){const e=this.settings;this.settings=t,this.danmaku&&this.syncWithDanmaku(e);}getVideoElement(){return this.videoElement}getCurrentVideoSource(){const t=this.videoElement;return t?this.resolveVideoSource(t):null}getCommentsSnapshot(){return this.allComments.map(t=>({...t,style:{...t.style},commands:t.commands?[...t.commands]:void 0}))}isNGComment(t){try{return typeof t!="string"||Array.isArray(this._settings.ngWords)&&this._settings.ngWords.some(e=>typeof e=="string"&&e.length&&t.includes(e))?!0:Array.isArray(this._settings.ngRegexps)?this._settings.ngRegexps.some(e=>{try{return typeof e=="string"&&e.length?new RegExp(e).test(t):!1}catch(n){return x.error("CommentRenderer.isNGComment.regex",n,{pattern:e,text:t}),!1}}):!1}catch(e){return x.error("CommentRenderer.isNGComment",e,{text:t}),true}}updateComments(){const t=this.videoElement;if(!t||!this.danmaku)return;this.currentTime=L(t.currentTime);const e=this.duration>0&&this.duration-this.currentTime<=1e4;e&&!this.finalPhaseActive&&(this.finalPhaseActive=true,this.danmaku.clear()),!e&&this.finalPhaseActive&&(this.finalPhaseActive=false);const n=this.currentTime+2e3;for(let i=this.lastEmittedIndex+1;i<this.allComments.length;i++){const o=this.allComments[i];if(o.time*1e3<n)this.isNGComment(o.text)||this.danmaku.emit({...o,style:this.createCommentStyle(o.style)}),this.lastEmittedIndex=i;else break}}onSeek(){if(!this.videoElement||!this.danmaku)return;this.finalPhaseActive=false,this.currentTime=L(this.videoElement.currentTime),this.danmaku.clear();const t=this.videoElement.currentTime;let e=-1;for(let n=0;n<this.allComments.length;n++)if(this.allComments[n].time>=t){e=n-1;break}this.lastEmittedIndex=e;}resize(t,e){if(!this.danmaku||!this.container)return;const n=this.videoElement,i=n?.getBoundingClientRect(),o=t??i?.width??this.container.clientWidth,s=e??i?.height??this.container.clientHeight;o<=0||s<=0||(n&&i&&this.updateContainerPlacement(i),this.container.style.width=`${o}px`,this.container.style.height=`${s}px`,this.danmaku.resize(),this.danmaku.speed=o/$*(this.videoElement?.playbackRate??1));}setupVideoEventListeners(t){try{t.addEventListener("seeking",()=>this.onSeek()),t.addEventListener("ratechange",()=>{if(this.danmaku){const n=(this.container?.clientWidth??0)/$;this.danmaku.speed=n*t.playbackRate;}}),t.addEventListener("timeupdate",()=>this.updateComments());}catch(e){throw x.error("CommentRenderer.setupVideoEventListeners",e),e}}setupKeyboardShortcuts(){try{this.keyboardHandler=new wt,this.keyboardHandler.addShortcut("C","Shift",()=>{try{this._settings.isCommentVisible=!this._settings.isCommentVisible,this._settings.isCommentVisible?this.danmaku?.show():this.danmaku?.hide(),window.dAniRenderer?.settingsManager?.updateSettings(this._settings);}catch(t){x.error(t,"CommentRenderer.keyboardShortcut");}}),this.keyboardHandler.startListening();}catch(t){x.error(t,"CommentRenderer.setupKeyboardShortcuts");}}setupResizeListener(t,e){try{this.teardownResizeListener(),this.isResizeObserverAvailable?(this.sizeObserver=new ResizeObserver(n=>{try{const i=n.find(o=>o.target===e);if(!i)return;this.resize(i.contentRect.width,i.contentRect.height);}catch(i){x.error(i,"CommentRenderer.resizeObserver");}}),this.sizeObserver.observe(e)):window.addEventListener("resize",this.handleWindowResize),this.addViewportEventListeners(),this.resize();}catch(n){x.error(n,"CommentRenderer.setupResizeListener");}}teardownResizeListener(){this.sizeObserver&&(this.sizeObserver.disconnect(),this.sizeObserver=null),this.isResizeObserverAvailable||window.removeEventListener("resize",this.handleWindowResize),this.removeViewportEventListeners();}handleWindowResize=()=>{this.resize();};handleWindowScroll=()=>{this.resize();};handleFullscreenChange=()=>{this.resize();};addViewportEventListeners(){this.scrollListenerAttached||(window.addEventListener("scroll",this.handleWindowScroll,{passive:true}),this.scrollListenerAttached=true),this.fullscreenEventsAttached||(ht.forEach(t=>{document.addEventListener(t,this.handleFullscreenChange);}),this.fullscreenEventsAttached=true);}removeViewportEventListeners(){this.scrollListenerAttached&&(window.removeEventListener("scroll",this.handleWindowScroll),this.scrollListenerAttached=false),this.fullscreenEventsAttached&&(ht.forEach(t=>{document.removeEventListener(t,this.handleFullscreenChange);}),this.fullscreenEventsAttached=false);}updateContainerPlacement(t){const e=this.container,n=this.videoElement;if(!e||!n)return;this.syncContainerParent();const i=!!ut(),o=e.parentElement;if(o){if(i)e.style.position="fixed",e.style.top=`${t.top}px`,e.style.left=`${t.left}px`;else {const s=o.getBoundingClientRect(),a=t.top-s.top,c=t.left-s.left;e.style.position="absolute",e.style.top=`${a}px`,e.style.left=`${c}px`;}e.style.width=`${t.width}px`,e.style.height=`${t.height}px`,e.style.overflow="hidden";}}syncContainerParent(){const t=this.container,e=this.videoElement;if(!t||!e)return;const n=ut(),o=n?.contains(e)??false?n:e.parentElement;if(!o||t.parentElement===o)return;t.remove();const s=o instanceof HTMLElement?o.style:null;s&&!s.position&&(s.position="relative"),o.appendChild(t);}createCommentStyle(t){const e=this.computeFontSizePx(),n=this.composeFontString(t?.font,e),i=Number.isFinite(this._settings.commentOpacity)?Math.max(0,Math.min(1,this._settings.commentOpacity)):1,o=this.resolveStrokeWidth(t?.lineWidth,e);return {font:n,textShadow:t?.textShadow??Ee,color:this._settings.commentColor,fillStyle:this._settings.commentColor,strokeStyle:t?.strokeStyle??"#000000",lineWidth:o,opacity:i.toString(),globalAlpha:i}}computeFontSizePx(){const t=this.getContainerHeight();if(t<=0)return this.cachedFontSizePx=at,this.cachedFontSizePx;const e=t/(lt*dt),n=Math.min(Ie,Math.max(ke,e)),i=Math.round(n);return this.cachedFontSizePx=i,i}getContainerHeight(){if(this.container){const{height:n}=this.container.getBoundingClientRect();if(Number.isFinite(n)&&n>0)return n}const e=this.videoElement?.getBoundingClientRect()?.height;return Number.isFinite(e)&&e!==void 0&&e>0?e:this.cachedFontSizePx*lt*dt}composeFontString(t,e){if(typeof t=="string"&&t.trim().length>0){const n=/\d+(?:\.\d+)?px/iu;if(n.test(t))return t.replace(n,`${e}px`).trim()}return `${Se} ${e}px ${Ce}`}resolveStrokeWidth(t,e){return Number.isFinite(t)&&t!==void 0?t:Math.max(2,Math.floor(e/12))}applySettingsToComments(){this.allComments=this.allComments.map(t=>({...t,style:this.createCommentStyle(t.style)}));}syncWithDanmaku(t){const e=this.danmaku;if(!e||(this.settings.isCommentVisible?e.show():e.hide(),!(t.commentColor!==this.settings.commentColor||t.commentOpacity!==this.settings.commentOpacity||!this.areNgListsEqual(t,this.settings))))return;this.applySettingsToComments();const i=this.videoElement,o=i?L(i.currentTime):0,s=o-ct;e.clear(),this.allComments.filter(c=>{const l=c.time*1e3;return l>o+ct||l<s?false:!this.isNGComment(c.text)}).forEach(c=>{e.emit({...c,style:this.createCommentStyle(c.style)});});}areNgListsEqual(t,e){const n=t.ngWords??[],i=e.ngWords??[],o=t.ngRegexps??[],s=e.ngRegexps??[];return n.length!==i.length||o.length!==s.length||n.some((l,d)=>l!==i[d])?false:!o.some((l,d)=>l!==s[d])}resolveVideoSource(t){if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const e=t.getAttribute("src");return e&&e.length>0?e:null}}class Y{shadowRoot=null;container=null;createShadowDOM(t,e={mode:"closed"}){if(!t)throw new Error("Host element is required for shadow DOM creation");return this.shadowRoot=t.attachShadow(e),this.container=document.createElement("div"),this.shadowRoot.appendChild(this.container),this.shadowRoot}addStyles(t){if(!this.shadowRoot)throw new Error("Shadow root not initialized");const e=document.createElement("style");e.textContent=t,this.shadowRoot.appendChild(e);}querySelector(t){return this.shadowRoot?this.shadowRoot.querySelector(t):null}querySelectorAll(t){return this.shadowRoot?this.shadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}setHTML(t){if(!this.container)throw new Error("Container not initialized");this.container.innerHTML=t;}destroy(){this.shadowRoot?.host&&this.shadowRoot.host.remove(),this.shadowRoot=null,this.container=null;}}const Ae=`\r
/* 基本カラーパレット - ダークモード */\r
:host {\r
...
`;class R{static getCommonStyles(){return Ae}static getNotificationStyles(){return Ve}static getAutoButtonStyles(){return _e}}const pt={success:"✔",warning:"⚠",error:"✖",info:"ℹ"};class p extends Y{static instance=null;static notifications=[];hostElement=null;initialized=false;static getInstance(){return this.instance||(this.instance=new p),this.instance}static show(t,e="info",n=3e3){try{const i=this.getInstance();return i.initialize(),i.initialized?i.createNotification(t,e,n):null}catch(i){return console.error("[NotificationManager] show failed",i),null}}static removeNotification(t){this.getInstance().removeNotification(t.element);}show(t,e="info"){p.show(t,e);}initialize(){if(!this.initialized)try{this.hostElement=document.createElement("div"),this.hostElement.className="nico-comment-shadow-host notification-host",this.hostElement.style.cssText=["position: fixed","top: 0","right: 0","z-index: 10000","pointer-events: none"].join(";"),document.body.appendChild(this.hostElement),this.createShadowDOM(this.hostElement),this.addStyles(R.getNotificationStyles()),this.setHTML('<div class="notification-container"></div>'),this.initialized=!0;}catch(t){console.error("[NotificationManager] initialize failed",t),this.initialized=false;}}destroy(){p.notifications.forEach(t=>{t.timerId&&window.clearTimeout(t.timerId);}),p.notifications=[],this.hostElement?.parentNode&&this.hostElement.parentNode.removeChild(this.hostElement),this.hostElement=null,this.initialized=false,p.instance=null;}createNotification(t,e,n){try{const i=this.querySelector(".notification-container");if(!i)throw new Error("Notification container not found");const o=pt[e]??pt.info,s=document.createElement("div");s.className=`notification-item ${e}`;const a=document.createElement("div");a.className="notification-icon",a.innerHTML=`<span>${o}</span>`,s.appendChild(a);const c=document.createElement("div");c.className="notification-content";const l=document.createElement("div");l.className="notification-type",l.textContent=e.charAt(0).toUpperCase()+e.slice(1),c.appendChild(l);const d=document.createElement("div");d.className="notification-message",d.textContent=t||"No message",c.appendChild(d),s.appendChild(c);const h=document.createElement("button");h.className="notification-close",h.innerHTML="&times;",h.addEventListener("click",()=>{this.removeNotification(s);}),s.appendChild(h),i.appendChild(s),requestAnimationFrame(()=>{s.classList.add("show");});const m={element:s,timerId:window.setTimeout(()=>{this.removeNotification(s);},n)};return p.notifications.push(m),m}catch(i){return console.error("[NotificationManager] createNotification failed",i),null}}removeNotification(t){if(!t)return;const e=p.notifications.find(n=>n.element===t);e?.timerId&&window.clearTimeout(e.timerId),t.classList.remove("show"),window.setTimeout(()=>{try{t.remove(),p.notifications=p.notifications.filter(n=>n.element!==t);}catch(n){console.error("[NotificationManager] removeNotification cleanup failed",n);}},500);}}const It="https://www.nicovideo.jp",At=`${It}/search`,Vt=`${It}/watch`,mt={searchBase:At,watchBase:Vt},Te=r=>`${Vt}/${r}`,_t=r=>`${At}/${encodeURIComponent(r)}`,B=r=>new Promise((t,e)=>{Dt({url:r.url,method:r.method??"GET",headers:r.headers,data:r.data,responseType:r.responseType??"text",timeout:r.timeout,onprogress:r.onprogress,onload:n=>{t({status:n.status,statusText:n.statusText,response:n.response,finalUrl:n.finalUrl,headers:n.responseHeaders});},onerror:n=>{const i=n?.error??"unknown error";e(new Error(`GM_xmlhttpRequest failed: ${i}`));},ontimeout:()=>{e(new Error("GM_xmlhttpRequest timeout"));}});}),W=S("dAnime:NicoApiFetcher");class X{apiData=null;comments=null;get lastApiData(){return this.apiData}get cachedComments(){return this.comments}async fetchApiData(t){try{const e=this.sanitizeVideoId(t),i=(await B({method:"GET",url:Te(e),headers:{Accept:"text/html"}})).response,a=new DOMParser().parseFromString(i,"text/html").querySelector('meta[name="server-response"]');if(!a)throw new Error("API data element not found in response");const c=a.getAttribute("content");if(!c)throw new Error("API data content is empty");const l=this.decodeServerResponse(c),h=JSON.parse(l).data?.response;if(!h)throw new Error("Invalid API data structure");return this.apiData=h,h}catch(e){throw W.error("NicoApiFetcher.fetchApiData",e),e}}async fetchComments(){try{if(!this.apiData)throw new Error("API data must be fetched first");const t=this.apiData.comment?.nvComment;if(!t?.server||!t.params||!t.threadKey)throw new Error("Required comment server data is missing");const e=await B({method:"POST",url:`${t.server}/v1/threads`,headers:{"Content-Type":"application/json","x-client-os-type":"others","X-Frontend-Id":"6","X-Frontend-Version":"0"},data:JSON.stringify({params:t.params,threadKey:t.threadKey,additionals:{}})}),o=(JSON.parse(e.response).data?.threads??[]).filter(a=>a.fork==="main").sort((a,c)=>(c.commentCount||0)-(a.commentCount||0))[0];if(!o)throw new Error("Main thread not found in comment response");const s=(o.comments??[]).map(a=>({text:a.body??"",vpos:a.vposMs??0,commands:a.commands??[]}));return this.comments=s,s}catch(t){throw W.error("NicoApiFetcher.fetchComments",t),t}}async fetchAllData(t){return await this.fetchApiData(t),this.fetchComments()}sanitizeVideoId(t){try{let e=encodeURIComponent(t);return e=e.replace(/%([0-9A-F]{2})/gi,(n,i)=>{const o=parseInt(i,16);return o>=65&&o<=90||o>=97&&o<=122||o>=48&&o<=57||o===45||o===95||o===46||o===126?String.fromCharCode(o):n}),e}catch(e){return W.error("NicoApiFetcher.sanitizeVideoId",e,{videoId:t}),t}}decodeServerResponse(t){try{return decodeURIComponent(t)}catch(e){try{const n=t.replace(/%(?![0-9A-F]{2})/gi,"%25");return decodeURIComponent(n)}catch{throw new Error(`API data decode failed: ${e.message}`)}}}}const gt=S("dAnime:NicoVideoSearcher");class Tt{cache=new Map;async search(t){if(!t.trim())return [];if(this.cache.has(t))return this.cache.get(t)??[];const e=_t(t),n=await this.fetchText(e),i=this.parseServerContext(n).map(a=>{const c=this.calculateLevenshteinDistance(t,a.title),l=Math.max(t.length,a.title.length),d=l>0?(1-c/l)*100:0;return {...a,levenshteinDistance:c,similarity:d}}),o=[],s=new Set;for(const a of i)a?.videoId&&(s.has(a.videoId)||(s.add(a.videoId),o.push(a)));return o.sort((a,c)=>{const l=a.similarity??-1,d=c.similarity??-1;return l!==d?d-l:c.viewCount-a.viewCount}),this.cache.set(t,o),o}async fetchText(t){return (await B({method:"GET",url:t})).response}parseServerContext(t){try{const n=new DOMParser().parseFromString(t,"text/html").querySelector('meta[name="server-response"]');if(!n)return [];const i=n.getAttribute("content")??"",o=this.decodeHtmlEntities(i);let s;try{s=JSON.parse(o);}catch(a){return gt.error("NicoVideoSearcher.parseServerContext",a),[]}return this.extractVideoItems(s??{})}catch(e){return gt.error("NicoVideoSearcher.parseServerContext",e),[]}}decodeHtmlEntities(t){if(!t)return "";let e=t.replace(/&quot;/g,'"').replace(/&#39;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">");return e=e.replace(/&#(\d+);/g,(n,i)=>String.fromCharCode(parseInt(i,10))),e=e.replace(/&#x([0-9a-fA-F]+);/g,(n,i)=>String.fromCharCode(parseInt(i,16))),e}extractVideoItems(t){const e=[],n=o=>{const s=(o?.id??o?.contentId??o?.watchId??"").toString();if(!s)return;const a=(o?.title??o?.shortTitle??"").toString(),c=o?.count??{},l=Number(c.view??o?.viewCounter??0)||0,d=Number(c.comment??o?.commentCounter??0)||0,h=Number(c.mylist??o?.mylistCounter??0)||0,m=o?.thumbnail??{},y=(m.nHdUrl||m.listingUrl||m.largeUrl||m.middleUrl||m.url||o?.thumbnailUrl||"").toString(),f=(o?.registeredAt||o?.startTime||o?.postedDateTime||"")?.toString?.()??"",A=o?.owner&&typeof o.owner=="object"?{nickname:(o.owner.nickname??o.owner.name??"")||void 0,name:(o.owner.name??o.owner.nickname??"")||void 0}:null,E=(o?.isChannelVideo||o?.owner?.ownerType==="channel")&&o?.owner?{name:o.owner.name??""}:null;a&&e.push({videoId:s,title:a,viewCount:l,commentCount:d,mylistCount:h,thumbnail:y,postedAt:f,owner:A,channel:E});},i=o=>{if(!o)return;if(Array.isArray(o)){o.forEach(i);return}if(typeof o!="object"||o===null)return;const s=o;(s.id||s.contentId||s.watchId)&&n(s),Object.values(o).forEach(i);};return i(t),e}calculateLevenshteinDistance(t,e){const n=t?t.length:0,i=e?e.length:0;if(n===0)return i;if(i===0)return n;const o=new Array(i+1);for(let a=0;a<=i;++a){const c=o[a]=new Array(n+1);c[0]=a;}const s=o[0];for(let a=1;a<=n;++a)s[a]=a;for(let a=1;a<=i;++a)for(let c=1;c<=n;++c){const l=t[c-1]===e[a-1]?0:1;o[a][c]=Math.min(o[a-1][c]+1,o[a][c-1]+1,o[a-1][c-1]+l);}return o[i][n]}}const b={mypageHeaderTitle:".p-mypageHeader__title",mypageListContainer:".p-mypageMain",watchVideoElement:"video#video",mypageItem:".itemModule.list",mypageItemTitle:".line1",mypageEpisodeNumber:".number.line1 span",mypageEpisodeTitle:".episode.line1 span"};class J{delay;timers=new Map;funcIds=new Map;nextId=1;constructor(t){this.delay=t;}getFuncId(t){return this.funcIds.has(t)||this.funcIds.set(t,this.nextId++),this.funcIds.get(t)??0}exec(t){const e=this.getFuncId(t),n=Date.now(),i=this.timers.get(e)?.lastExec??0,o=n-i;if(o>this.delay)t(),this.timers.set(e,{lastExec:n});else {clearTimeout(this.timers.get(e)?.timerId??void 0);const s=setTimeout(()=>{t(),this.timers.set(e,{lastExec:Date.now()});},this.delay-o);this.timers.set(e,{timerId:s,lastExec:i});}}execOnce(t){const e=this.getFuncId(t),n=this.timers.get(e);if(n?.executedOnce){n.timerId&&clearTimeout(n.timerId);return}n?.timerId&&clearTimeout(n.timerId);const i=setTimeout(()=>{try{t();}finally{this.timers.set(e,{executedOnce:true,lastExec:Date.now(),timerId:null});}},this.delay);this.timers.set(e,{timerId:i,executedOnce:false,scheduled:true});}cancel(t){const e=this.getFuncId(t),n=this.timers.get(e);n?.timerId&&clearTimeout(n.timerId),this.timers.delete(e);}resetExecution(t){const e=this.getFuncId(t),n=this.timers.get(e);n&&(n.timerId&&clearTimeout(n.timerId),this.timers.set(e,{executedOnce:false,scheduled:false}));}clearAll(){for(const[,t]of this.timers)t.timerId&&clearTimeout(t.timerId);this.timers.clear(),this.funcIds.clear();}}const Le=1e3,Re=100,Me=30,ft=1e4,bt=100,ze=/watch\/(?:([a-z]{2}))?(\d+)/gi,g=S("dAnime:VideoSwitchHandler"),yt=r=>{if(!r?.video)return null;const t=r.video.registeredAt,e=t?new Date(t).toLocaleString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:false}):void 0;return {videoId:r.video.id,title:r.video.title,viewCount:r.video.count?.view,mylistCount:r.video.count?.mylist,commentCount:r.video.count?.comment,postedAt:e,thumbnail:r.video.thumbnail?.url,owner:r.owner??null,channel:r.channel??null}},Ne=r=>{const t=[];let e;for(;(e=ze.exec(r))!==null;){const[,n="",i=""]=e;i&&t.push(`${n}${i}`);}return t};class Lt{constructor(t,e,n,i=Le,o=Re){this.renderer=t,this.fetcher=e,this.settingsManager=n,this.monitorInterval=i,this.debounce=new J(o);}nextVideoId=null;preloadedComments=null;lastPreloadedComments=null;lastVideoId=null;lastVideoSource=null;checkIntervalId=null;isSwitching=false;debounce;startMonitoring(){this.stopMonitoring(),this.checkIntervalId=window.setInterval(()=>{this.checkVideoEnd();},this.monitorInterval);}stopMonitoring(){this.checkIntervalId&&(window.clearInterval(this.checkIntervalId),this.checkIntervalId=null);}async onVideoSwitch(t){if(!this.isSwitching){this.isSwitching=true;try{const e=await this.resolveVideoElement(t)??null,n=this.preloadedComments??this.lastPreloadedComments??null,i=e?.dataset?.videoId??e?.getAttribute?.("data-video-id")??null,o=this.nextVideoId??i??this.lastVideoId;if(!e||!o&&!n){this.handleMissingVideoInfo(n);return}g.info("videoSwitch:start",{videoId:o??null,elementVideoId:e.dataset?.videoId??null,preloadedCount:n?.length??0}),p.show("動画の切り替わりを検知しました...","info"),this.resetRendererState(e);const s=this.renderer.getVideoElement();if(s!==e&&e)g.debug("videoSwitch:rebind",{previousSrc:this.renderer.getCurrentVideoSource(),newSrc:typeof e.currentSrc=="string"&&e.currentSrc.length>0?e.currentSrc:e.getAttribute("src")??null}),this.renderer.initialize(e);else if(s===e&&e&&this.hasVideoSourceChanged(e))g.debug("videoSwitch:rebind:sameElement",{previousSrc:this.lastVideoSource??null,newSrc:this.getVideoSource(e)}),this.renderer.destroy(),this.renderer.initialize(e);else if(!s&&!e){g.warn("videoSwitch:missingVideoElement",{lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId}),this.isSwitching=!1;return}let a=null;o&&(a=await this.fetchVideoApiData(o,n),a&&(this.persistVideoMetadata(a),this.lastVideoId=o));const c=await this.populateComments(o,n);if(c===0?(this.renderer.clearComments(),p.show("コメントを取得できませんでした","warning"),g.warn("videoSwitch:commentsMissing",{videoId:o??null})):g.info("videoSwitch:commentsLoaded",{videoId:o??null,count:c}),this.nextVideoId=null,this.preloadedComments=null,this.lastVideoSource=this.getVideoSource(e),a){const l=yt(a);if(l){const d=`コメントソースを更新しました: ${l.title??"不明なタイトル"}（${c}件）`;p.show(d,c>0?"success":"warning");}}}catch(e){g.error("videoSwitch:error",e,{nextVideoId:this.nextVideoId,lastVideoId:this.lastVideoId}),p.show(`動画切り替えエラー: ${e.message}`,"error"),this.renderer.clearComments();}finally{this.isSwitching=false;}}}async resolveVideoElement(t){if(t){const i=this.getVideoSource(t),o=this.lastVideoSource;return (!i||i===o)&&await this.waitForSourceChange(t),t}const e=Date.now()+ft;let n=null;for(;Date.now()<e;){const i=document.querySelector(b.watchVideoElement);if(i){n=i;const o=this.hasVideoSourceChanged(i);if(i.readyState>=2||!i.paused||o)return o&&(this.lastVideoSource=null),i}await new Promise(o=>window.setTimeout(o,bt));}return n}async waitForSourceChange(t){const e=this.getVideoSource(t);if(!e)return;const n=Date.now()+ft;for(;Date.now()<n;){const i=this.getVideoSource(t);if(i&&i!==e){this.lastVideoSource=null;return}await new Promise(o=>window.setTimeout(o,bt));}}hasVideoSourceChanged(t){const e=this.getVideoSource(t);return e?this.lastVideoSource?this.lastVideoSource!==e:true:false}getVideoSource(t){if(!t)return null;if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const e=t.getAttribute("src");return e&&e.length>0?e:null}resetRendererState(t){try{t.currentTime=0;}catch(e){g.debug("videoSwitch:resetCurrentTimeFailed",e);}this.renderer.clearComments();}async checkVideoEnd(){const t=this.renderer.getVideoElement();if(!(!t||!Number.isFinite(t.duration)||t.duration-t.currentTime>Me)){if(!this.nextVideoId){const n=async()=>{await this.findNextVideoId();};this.debounce.execOnce(n);}if(this.nextVideoId&&!this.preloadedComments){const n=async()=>{await this.preloadComments();};this.debounce.execOnce(n);}}}handleMissingVideoInfo(t){t||(this.renderer.clearComments(),p.show("次の動画のコメントを取得できませんでした。コメント表示をクリアします。","warning"));}async fetchVideoApiData(t,e){try{const n=await this.fetcher.fetchApiData(t);return g.debug("videoSwitch:apiFetched",{videoId:t}),n}catch(n){if(g.error("videoSwitch:apiFetchError",n,{videoId:t}),!e)throw n;return null}}persistVideoMetadata(t){const e=yt(t);e&&this.settingsManager.saveVideoData(e.title??"",e);}async populateComments(t,e){let n=null;if(Array.isArray(e)&&e.length>0)n=e;else if(t)try{n=await this.fetcher.fetchAllData(t),g.debug("videoSwitch:commentsFetched",{videoId:t,count:n.length});}catch(o){g.error("videoSwitch:commentsFetchError",o,{videoId:t}),p.show(`コメント取得エラー: ${o.message}`,"error"),n=null;}if(!n||n.length===0)return 0;const i=n.filter(o=>!this.renderer.isNGComment(o.text));return i.forEach(o=>{this.renderer.addComment(o.text,o.vpos,o.commands);}),this.lastPreloadedComments=[...i],i.length}async findNextVideoId(){try{const t=this.fetcher.lastApiData;if(!t)return;const e=t.series?.video?.next?.id;if(e){this.nextVideoId=e,g.debug("videoSwitch:detectedNext",{videoId:e});return}const n=t.video?.description??"";if(!n)return;const i=Ne(n);if(i.length===0)return;const o=[...i].sort((s,a)=>{const c=parseInt(s.replace(/^[a-z]{2}/i,""),10)||0;return (parseInt(a.replace(/^[a-z]{2}/i,""),10)||0)-c});this.nextVideoId=o[0]??null,this.nextVideoId&&g.debug("videoSwitch:candidateFromDescription",{candidate:this.nextVideoId});}catch(t){g.error("videoSwitch:nextIdError",t,{lastVideoId:this.lastVideoId});}}async preloadComments(){if(this.nextVideoId)try{const e=(await this.fetcher.fetchAllData(this.nextVideoId)).filter(n=>!this.renderer.isNGComment(n.text));this.preloadedComments=e.length>0?e:null,g.debug("videoSwitch:preloaded",{videoId:this.nextVideoId,count:e.length});}catch(t){g.error("videoSwitch:preloadError",t,{videoId:this.nextVideoId}),this.preloadedComments=null;}}}const Fe=`
.nico-comment-shadow-host {
  display: block;
  position: relative;
}
`;class Rt{static initialize(){Ot(Fe);}}var Oe="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10Z",De="M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z",Pe="M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z";function Z(r,t=24){const e=String(t),n=String(t);return `<svg xmlns="http://www.w3.org/2000/svg" width="${e}" height="${n}" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true" focusable="false"><path d="${r}"></path></svg>`}const $e=Z(Pe),xt=Z(De),We=Z(Oe),I=S("dAnime:SettingsUI"),u={searchInput:"#searchInput",searchButton:"#searchButton",openSearchPage:"#openSearchPageDirect",searchResults:"#searchResults",saveButton:"#saveSettings",opacitySelect:"#commentOpacity",visibilityToggle:"#commentVisibilityToggle",currentTitle:"#currentTitle",currentVideoId:"#currentVideoId",currentOwner:"#currentOwner",currentViewCount:"#currentViewCount",currentCommentCount:"#currentCommentCount",currentMylistCount:"#currentMylistCount",currentPostedAt:"#currentPostedAt",currentThumbnail:"#currentThumbnail",colorValue:".color-value",colorPreview:".color-preview",colorPicker:"#colorPicker",colorPickerInput:"#colorPickerInput",openColorPicker:"#openColorPicker",ngWords:"#ngWords",ngRegexps:"#ngRegexps",showNgWords:"#showNgWords",showNgRegexps:"#showNgRegexp",playCurrentVideo:"#playCurrentVideo"};class Mt extends Y{settingsManager;fetcher;searcher;settings;currentVideoInfo;hostElement=null;lastAutoButtonElement=null;constructor(t,e=new X,n=new Tt){super(),this.settingsManager=t,this.fetcher=e,this.searcher=n,this.settings=this.settingsManager.getSettings(),this.currentVideoInfo=this.settingsManager.loadVideoData();}insertIntoMypage(){const t=document.querySelector(b.mypageHeaderTitle);t&&(this.hostElement=this.createSettingsUI(),t.parentElement?.insertBefore(this.hostElement,t.nextSibling),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(e){console.warn("[SettingsUI] restore failed:",e);}}));}addAutoCommentButtons(){document.querySelectorAll(b.mypageItem).forEach(e=>{const n=e.querySelector(b.mypageItemTitle);if(!n||n.querySelector(".auto-comment-button-host"))return;const i=n.querySelector("span")?.textContent?.trim()??"",o=e.querySelector(b.mypageEpisodeNumber)?.textContent?.trim()??"",s=e.querySelector(b.mypageEpisodeTitle)?.textContent?.trim()??"",a=document.createElement("div");a.className="nico-comment-shadow-host auto-comment-button-host",a.style.cssText="position:absolute;left:150px;top:3px;margin-left:8px;";const c=a.attachShadow({mode:"closed"}),l=document.createElement("style");l.textContent=R.getAutoButtonStyles(),c.appendChild(l);const d=document.createElement("button");d.className="auto-comment-button",d.innerHTML=We,d.setAttribute("aria-label","コメント設定"),d.setAttribute("title","コメント設定"),d.setAttribute("type","button"),d.addEventListener("click",async h=>{h.preventDefault(),h.stopPropagation(),h.stopImmediatePropagation();try{const m=[i,o,s].filter(Boolean).join(" ");this.scrollToSettings(),this.setSearchKeyword(m),this.lastAutoButtonElement=a;try{const f=e.querySelector('input[name="workId"]')?.value?.trim()??"",A=e.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),E=e.querySelector('a.textContainer[href*="partId="]');let k="";const V=(A?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);V?k=V[1]:E?.href&&(k=(new URL(E.href,location.origin).searchParams.get("partId")??"").trim()),f&&k&&this.settingsManager.saveLastDanimeIds({workId:f,partId:k});}catch(f){console.warn("[SettingsUI] save (workId, partId) skipped:",f);}const y=await this.executeSearch(m);if(y.length===0)return;await this.applySearchResult(y[0]);}catch(m){I.error("SettingsUI.autoCommentButton",m);}}),c.appendChild(d),n.appendChild(a),this.lastAutoButtonElement=a;}),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(e){console.warn("[SettingsUI] restore failed:",e);}});}async waitMypageListStable(){const t=document.querySelector(b.mypageListContainer);if(!t)return;let e=t.querySelectorAll(b.mypageItem).length;const n=Date.now()+1500;return new Promise(i=>{const o=new MutationObserver(()=>{const s=t.querySelectorAll(b.mypageItem).length;if(s!==e){e=s;return}Date.now()>=n&&(o.disconnect(),i());});o.observe(t,{childList:true,subtree:true}),setTimeout(()=>{try{o.disconnect();}catch(s){I.debug("waitMypageListStable: observer already disconnected",s);}i();},1600);})}tryRestoreByDanimeIds(){const t=this.settingsManager.loadLastDanimeIds();if(!t)return  false;const e=Array.from(document.querySelectorAll(b.mypageItem));for(const n of e){if(n.querySelector('input[name="workId"]')?.value?.trim()!==t.workId)continue;const o=n.querySelector('a.textContainer[href*="partId="]'),s=o?.href?(new URL(o.href,location.origin).searchParams.get("partId")??"")===t.partId:false,a=n.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),c=(()=>{const d=(a?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);return !!d&&d[1]===t.partId})();if(s||c){const l=n.querySelector(".auto-comment-button-host")??n;return this.lastAutoButtonElement=l,this.updatePlayButtonState(this.currentVideoInfo),true}}return  false}createSettingsUI(){const t=document.createElement("div");t.className="nico-comment-shadow-host settings-host",this.createShadowDOM(t),this.addStyles(R.getCommonStyles());const e=this.buildSettingsHtml();return this.setHTML(e),this.applySettingsToUI(),this.addStyles(`
    ...
    `),this.setupEventListeners(),t}buildSettingsHtml(){const t=i=>typeof i=="number"?i.toLocaleString():"-",e=i=>{if(!i)return "-";try{return new Date(i).toLocaleDateString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return i}},n=this.currentVideoInfo;return `
        ...
        <div class="setting-group display-settings-group">
          ...
          <div class="color-picker-container">
              <button id="openColorPicker" class="color-picker-button" type="button">
                <span class="color-picker-button__icon" aria-hidden="true">${$e}</span>
        ...
        <div class="setting-group">
          ...
          <div class="ng-words-container">
            <button id="showNgWords" class="mask-button" type="button">
              <span class="mask-button__icon" aria-hidden="true">${xt}</span>
    ...
    `}setupEventListeners(){this.setupColorPresets(),this.setupColorPicker(),this.setupOpacitySelect(),this.setupVisibilityToggle(),this.setupNgControls(),this.setupSaveButton(),this.setupSearch(),this.setupPlayButton();}setupColorPresets(){this.querySelectorAll(".color-preset-btn").forEach(e=>{e.addEventListener("click",()=>{const n=e.dataset.color;if(!n)return;this.settings.commentColor=n;const i=this.querySelector(u.colorPreview),o=this.querySelector(u.colorValue);i&&(i.style.backgroundColor=n),o&&(o.textContent=n);});});}setupColorPicker(){const t=this.querySelector(u.openColorPicker),e=this.querySelector(u.colorPicker),n=this.querySelector(u.colorPickerInput);!t||!e||!n||(t.addEventListener("click",()=>{e.classList.toggle("hidden");}),n.addEventListener("input",()=>{this.settings.commentColor=n.value;const i=this.querySelector(u.colorPreview),o=this.querySelector(u.colorValue);i&&(i.style.backgroundColor=n.value),o&&(o.textContent=n.value);}));}setupOpacitySelect(){const t=this.querySelector(u.opacitySelect);t&&(t.value=this.settings.commentOpacity.toString(),t.addEventListener("change",()=>{const e=Number(t.value);Number.isNaN(e)||(this.settings.commentOpacity=e);}));}setupVisibilityToggle(){const t=this.querySelector(u.visibilityToggle);t&&(t.addEventListener("click",()=>{this.settings.isCommentVisible=!this.settings.isCommentVisible,this.updateVisibilityToggleState(t);}),this.updateVisibilityToggleState(t));}setupNgControls(){const t=this.querySelector(u.ngWords),e=this.querySelector(u.ngRegexps),n=this.querySelector(u.showNgWords),i=this.querySelector(u.showNgRegexps);n?.addEventListener("click",()=>{if(!t||!n)return;t.classList.toggle("hidden");const o=t.classList.contains("hidden")?"NGワードを表示":"NGワードを非表示";this.updateMaskButtonText(n,o);}),i?.addEventListener("click",()=>{if(!e||!i)return;e.classList.toggle("hidden");const o=e.classList.contains("hidden")?"NG正規表現を表示":"NG正規表現を非表示";this.updateMaskButtonText(i,o);});}setupSaveButton(){const t=this.querySelector(u.saveButton);t&&t.addEventListener("click",()=>this.saveSettings());}setupSearch(){const t=this.querySelector(u.searchInput),e=this.querySelector(u.searchButton),n=this.querySelector(u.openSearchPage),i=async()=>{const o=t?.value.trim();if(!o){p.show("キーワードを入力してください","warning");return}await this.executeSearch(o);};e?.addEventListener("click",i),t?.addEventListener("keydown",o=>{o.key==="Enter"&&i();}),n?.addEventListener("click",o=>{o.preventDefault();const s=t?.value.trim(),a=s?_t(s):mt.searchBase;H().open(a,"_blank","noopener");});}async executeSearch(t){try{p.show(`「${t}」を検索中...`,"info");const e=await this.searcher.search(t);return this.renderSearchResults(e,n=>this.renderSearchResultItem(n)),e.length===0&&p.show("検索結果が見つかりませんでした","warning"),e}catch(e){return I.error("SettingsUI.executeSearch",e),[]}}scrollToSettings(){this.hostElement&&this.hostElement.scrollIntoView({behavior:"smooth",block:"start"});}setSearchKeyword(t){const e=this.querySelector(u.searchInput);e&&(e.value=t,e.focus({preventScroll:true}));}renderSearchResults(t,e){const n=this.querySelector(u.searchResults);if(!n)return;n.innerHTML=t.map(o=>e(o)).join(""),n.querySelectorAll(".search-result-item").forEach((o,s)=>{o.addEventListener("click",()=>{const c=t[s];this.applySearchResult(c);});const a=o.querySelector(".open-search-page-direct-btn");a&&a.addEventListener("click",c=>{c.stopPropagation();});});}renderSearchResultItem(t){const e=this.formatSearchResultDate(t.postedAt),n=typeof t.similarity=="number"?`
      ...
      <div class="search-result-item">
        ...
        <div class="search-result-info">
          ...
          <div class="stats">再生 ${t.viewCount.toLocaleString()} / コメ ${t.commentCount.toLocaleString()} / マイ ${t.mylistCount.toLocaleString()} ${n}</div>
          <div class="date">${e}</div>
          <a href="${mt.watchBase}/${t.videoId}" target="_blank" rel="noopener"
...
`).map(i=>i.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings)?p.show("設定を保存しました","success"):p.show("設定の保存に失敗しました","error");}updateCurrentVideoInfo(t){this.currentVideoInfo=t,[["currentTitle",t.title??"-"],["currentVideoId",t.videoId??"-"],["currentOwner",t.owner?.nickname??t.channel?.name??"-"],["currentViewCount",this.formatNumber(t.viewCount)],["currentCommentCount",this.formatNumber(t.commentCount)],["currentMylistCount",this.formatNumber(t.mylistCount)],["currentPostedAt",this.formatSearchResultDate(t.postedAt)]].forEach(([i,o])=>{const s=this.querySelector(u[i]);s&&(s.textContent=o);});const n=this.querySelector(u.currentThumbnail);n&&t.thumbnail&&(n.src=t.thumbnail,n.alt=t.title??"サムネイル");try{this.settingsManager.saveVideoData(t.title??"",t);}catch(i){I.error("SettingsUI.updateCurrentVideoInfo",i);}this.updatePlayButtonState(t);}formatNumber(t){return typeof t=="number"?t.toLocaleString():"-"}formatSearchResultDate(t){if(!t)return "-";const e=new Date(t);return Number.isNaN(e.getTime())?t:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(e)}setupPlayButton(){const t=this.querySelector(u.playCurrentVideo);t&&(t.addEventListener("click",()=>{try{if(!this.currentVideoInfo?.videoId){p.show("再生できる動画が設定されていません","warning");return}const n=this.lastAutoButtonElement?.closest(".itemModule.list");if(this.lastAutoButtonElement){const i=n?.querySelector(".thumbnailContainer > a, .thumbnail-container > a");if(i){p.show(`「${this.currentVideoInfo?.title||"動画"}」を再生します...`,"success"),setTimeout(()=>{i.click();},300);return}}p.show("再生リンクが見つかりませんでした（対象アイテム内に限定して検索済み）","warning");}catch(e){I.error("SettingsUI.playCurrentVideo",e),p.show(`再生エラー: ${e.message}`,"error");}}),this.updatePlayButtonState(this.currentVideoInfo));}updatePlayButtonState(t){const e=this.querySelector(u.playCurrentVideo);if(!e)return;const n=!!t?.videoId;e.disabled=!n,e.setAttribute("aria-disabled",(!n).toString());}updateVisibilityToggleState(t){t.textContent=this.settings.isCommentVisible?"表示中":"非表示中",t.classList.toggle("off",!this.settings.isCommentVisible);}updateMaskButtonText(t,e){const n=t.querySelector(".mask-button__text");n&&(n.textContent=e);}}const vt=async()=>{},qe=()=>{const r=H();if(!r.dAniRenderer){const t={};r.dAniRenderer={classes:{Comment:$t,CommentRenderer:kt,NicoApiFetcher:X,NotificationManager:p,StyleManager:Rt,SettingsUI:Mt,NicoVideoSearcher:Tt,VideoSwitchHandler:Lt,SettingsManager:U,KeyboardShortcutHandler:wt,DebounceExecutor:J,ShadowDOMComponent:Y,ShadowStyleManager:R},instances:t,utils:{initialize:vt,initializeWithVideo:vt},debug:{showState:()=>{console.log("Current instances:",t);},showSettings:()=>{const e=t.settingsManager;if(!e){console.log("SettingsManager not initialized");return}console.log("Current settings:",e.getSettings());},showComments:()=>{const e=t.renderer;if(!e){console.log("CommentRenderer not initialized");return}console.log("Current comments:",e.getCommentsSnapshot());}},defaultSettings:v};}return r.dAniRenderer},Be=100,He=1e3,Ue=3e3;class Ge{constructor(t){this.global=t;}initialized=false;switchDebounce=new J(He);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement();}async ensureDocumentReady(){document.readyState!=="complete"&&await new Promise(t=>{window.addEventListener("load",()=>t(),{once:true});});}waitForVideoElement(){if(this.initialized)return;const t=document.querySelector(b.watchVideoElement);if(!t){window.setTimeout(()=>this.waitForVideoElement(),Be);return}if(t.readyState===0){t.addEventListener("loadedmetadata",()=>{this.initializeWithVideo(t);},{once:true});return}this.initializeWithVideo(t);}async initializeWithVideo(t){if(!this.initialized){this.initialized=true;try{p.show("コメントローダーを初期化中...");const e=p.getInstance(),n=this.global.settingsManager??new U(e);this.global.settingsManager=n,this.global.instances.settingsManager=n;const i=n.loadVideoData();if(!i?.videoId)throw new Error("動画データが見つかりません。マイページで設定してください。");const o=new X;this.global.instances.fetcher=o,await o.fetchApiData(i.videoId);const s=await o.fetchComments(),a=this.mergeSettings(n.loadSettings()),c=new kt(a);c.initialize(t),this.global.instances.renderer=c,this.currentVideoElement=t,n.addObserver(d=>{c.settings=this.mergeSettings(d);}),s.forEach(d=>{c.addComment(d.text,d.vpos,d.commands);});const l=new Lt(c,o,n);l.startMonitoring(),this.global.instances.switchHandler=l,this.setupSwitchHandling(t,l),this.observeVideoElement(),p.show(`コメントの読み込みが完了しました（${s.length}件）`,"success");}catch(e){throw this.initialized=false,p.show(`初期化エラー: ${e.message}`,"error"),e}}}mergeSettings(t){const e=v();return {...e,...t,ngWords:[...t.ngWords??e.ngWords],ngRegexps:[...t.ngRegexps??e.ngRegexps]}}setupSwitchHandling(t,e){this.currentVideoElement=t,this.switchCallback=()=>{const n=Date.now();if(n-this.lastSwitchTimestamp<Ue)return;this.lastSwitchTimestamp=n;const i=this.currentVideoElement;e.onVideoSwitch(i);},this.videoMutationObserver?.disconnect(),this.videoMutationObserver=new MutationObserver(n=>{if(this.switchCallback)for(const i of n)i.type==="attributes"&&i.attributeName==="src"&&i.target===this.currentVideoElement&&(this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));}),this.videoMutationObserver.observe(t,{attributes:true,attributeFilter:["src"]}),this.global.utils.initializeWithVideo=async n=>{n&&(this.rebindVideoElement(n),await e.onVideoSwitch(n));},this.currentVideoElement=t;}observeVideoElement(){const t=this.currentVideoElement;t&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{const e=document.querySelector(b.watchVideoElement);!e||e===this.currentVideoElement||this.rebindVideoElement(e);}),this.domMutationObserver.observe(document.body,{childList:true,subtree:true}),this.attachVideoEventListeners(t));}rebindVideoElement(t){this.detachVideoEventListeners(),this.currentVideoElement=t;const e=this.global.instances.renderer,n=this.global.instances.switchHandler;e&&(e.destroy(),e.initialize(t)),n&&(n.onVideoSwitch(t),this.setupSwitchHandling(t,n)),this.attachVideoEventListeners(t);}attachVideoEventListeners(t){this.detachVideoEventListeners();const e=()=>{this.switchCallback&&(this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));};t.addEventListener("ended",e),this.videoEndedListener=e;}detachVideoEventListeners(){const t=this.currentVideoElement;t&&this.videoEndedListener&&t.removeEventListener("ended",this.videoEndedListener),this.videoEndedListener=null;}}const je=100;class Ke{constructor(t){this.global=t;}initialize(){const t=p.getInstance(),e=this.global.settingsManager??new U(t);this.global.settingsManager=e,this.global.instances.settingsManager=e;const n=new Mt(e);this.waitForHeader(n);}waitForHeader(t){if(!document.querySelector(b.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(t),je);return}t.insertIntoMypage(),t.addAutoCommentButtons(),this.observeList(t);}observeList(t){const e=document.querySelector(b.mypageListContainer);if(!e)return;new MutationObserver(()=>{try{t.addAutoCommentButtons();}catch(i){console.error("[MypageController] auto comment buttons update failed",i);}}).observe(e,{childList:true,subtree:true});}}class Ye{log;global=qe();watchController=null;mypageController=null;constructor(){this.log=S("DanimeApp");}start(){this.log.info("starting renderer"),Rt.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener("load",()=>{this.initialize();});}async initialize(){if(!this.acquireInstanceLock()){this.log.info("renderer already initialized, skipping");return}const t=location.pathname.toLowerCase();try{t.includes("/animestore/sc_d_pc")?(this.watchController=new Ge(this.global),await this.watchController.initialize()):t.includes("/animestore/mp_viw_pc")?(this.mypageController=new Ke(this.global),this.mypageController.initialize()):this.log.info("page not supported, initialization skipped");}catch(e){this.log.error("initialization failed",e);}}acquireInstanceLock(){const t=H();return t.__dAnimeNicoCommentRenderer2Instance=(t.__dAnimeNicoCommentRenderer2Instance??0)+1,t.__dAnimeNicoCommentRenderer2Instance===1}}const q=S("dAnimeNicoCommentRenderer2");async function Xe(){q.info("bootstrap start");try{new Ye().start(),q.info("bootstrap completed");}catch(r){q.error("bootstrap failed",r);}}Xe();
