...
(function () {
  ...
  const Pt={debug:"debug",info:"info",warn:"warn",error:"error"},N=e=>{const t=`[${e}]`,n={};return Object.keys(Pt).forEach(i=>{const r=Pt[i];n[i]=(...s)=>{(console[r]??console.log)(t,...s);};}),n};function St(){return typeof unsafeWindow<"u"?unsafeWindow:window}const ke={small:.8,medium:1,big:1.4},Te={defont:'"MS PGothic","Hiragino Kaku Gothic ProN","Hiragino Kaku Gothic Pro","Yu Gothic UI","Yu Gothic","Meiryo","Segoe UI","Osaka","Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","IPAPGothic","TakaoPGothic","Roboto","Helvetica Neue","Helvetica","Arial","sans-serif"',gothic:'"Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","Yu Gothic","Yu Gothic Medium","Meiryo","MS PGothic","Hiragino Kaku Gothic ProN","Segoe UI","Helvetica","Arial","sans-serif"',mincho:'"MS PMincho","MS Mincho","Hiragino Mincho ProN","Hiragino Mincho Pro","Yu Mincho","Noto Serif CJK JP","Noto Serif JP","Source Han Serif JP","Times New Roman","serif"'},te={white:"#FFFFFC",red:"#FF8888",pink:"#FFA5CC",orange:"#FFBA66",yellow:"#FFFFAA",green:"#88FF88",cyan:"#88FFFF",blue:"#8899FF",purple:"#D9A5FF",black:"#444444",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},wt=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,Ae=/^[,.:;]+/,Ve=/[,.:;]+$/,Le=e=>{const t=e.trim();return t?wt.test(t)?t:t.replace(Ae,"").replace(Ve,""):""},Ie=e=>wt.test(e)?e.toUpperCase():null,ee=e=>{const t=e.trim();if(!t)return null;const n=t.toLowerCase().endsWith("px")?t.slice(0,-2):t,i=Number.parseFloat(n);return Number.isFinite(i)?i:null},Pe=e=>{const t=e.trim();if(!t)return null;if(t.endsWith("%")){const n=Number.parseFloat(t.slice(0,-1));return Number.isFinite(n)?n/100:null}return ee(t)},Re=e=>Number.isFinite(e)?Math.min(100,Math.max(-100,e)):0,Fe=e=>!Number.isFinite(e)||e===0?1:Math.min(5,Math.max(.25,e)),_e=e=>e==="naka"||e==="ue"||e==="shita",De=e=>e==="small"||e==="medium"||e==="big",He=e=>e==="defont"||e==="gothic"||e==="mincho",Oe=e=>e in te,Ne=(e,t)=>{let n="naka",i="medium",r="defont",s=null,a=1,o=null,l=false,d=0,h=1;for(const m of e){const g=Le(typeof m=="string"?m:"");if(!g)continue;if(wt.test(g)){const x=Ie(g);if(x){s=x;continue}}const f=g.toLowerCase();if(_e(f)){n=f;continue}if(De(f)){i=f;continue}if(He(f)){r=f;continue}if(Oe(f)){s=te[f].toUpperCase();continue}if(f==="_live"){o=.5;continue}if(f==="invisible"){a=0,l=true;continue}if(f.startsWith("ls:")||f.startsWith("letterspacing:")){const x=g.indexOf(":");if(x>=0){const S=ee(g.slice(x+1));S!==null&&(d=Re(S));}continue}if(f.startsWith("lh:")||f.startsWith("lineheight:")){const x=g.indexOf(":");if(x>=0){const S=Pe(g.slice(x+1));S!==null&&(h=Fe(S));}continue}}const c=Math.max(0,Math.min(1,a)),u=(s??t.defaultColor).toUpperCase(),p=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:n,size:i,sizeScale:ke[i],font:r,fontFamily:Te[r],resolvedColor:u,colorOverride:s,opacityMultiplier:c,opacityOverride:p,isInvisible:l,letterSpacing:d,lineHeight:h}},ze=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,et=e=>e.length===1?e.repeat(2):e,O=e=>Number.parseInt(e,16),P=e=>!Number.isFinite(e)||e<=0?0:e>=1?1:e,ne=(e,t)=>{const n=ze.exec(e);if(!n)return e;const i=n[1];let r,s,a,o=1;i.length===3||i.length===4?(r=O(et(i[0])),s=O(et(i[1])),a=O(et(i[2])),i.length===4&&(o=O(et(i[3]))/255)):(r=O(i.slice(0,2)),s=O(i.slice(2,4)),a=O(i.slice(4,6)),i.length===8&&(o=O(i.slice(6,8))/255));const l=P(o*P(t));return `rgba(${r}, ${s}, ${a}, ${l})`},$e=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),ie=()=>$e(),R=e=>e*1e3,We=e=>!Number.isFinite(e)||e<0?null:Math.round(e),Ct=4e3,Rt=1800,qe=3,Be=.25,Ue=32,Ge=48,ot=120,Ke=4e3,ut=120,Ye=800,je=2,X=4e3,W=4e3,_=W+Ct,Xe=1e3,Ft=1,re=12,se=24,T=.001,z=50,Je=5,Ze=2,_t=8,Qe=12,tn=500,en=3e3,Dt={debug:0,info:1,warn:2,error:3},nn=(e,t,n)=>{const i=[`[${t}]`,...n];switch(e){case "debug":console.debug(...i);break;case "info":console.info(...i);break;case "warn":console.warn(...i);break;case "error":console.error(...i);break;default:console.log(...i);}},ae=(e,t={})=>{const{level:n="info",emitter:i=nn}=t,r=Dt[n],s=(a,o)=>{Dt[a]<r||i(a,e,o);};return {debug:(...a)=>s("debug",a),info:(...a)=>s("info",a),warn:(...a)=>s("warn",a),error:(...a)=>s("error",a)}},Mt=ae("CommentEngine:Comment"),Ht=new WeakMap,rn=e=>{let t=Ht.get(e);return t||(t=new Map,Ht.set(e,t)),t},lt=(e,t)=>{if(!e)return 0;const n=`${e.font??""}::${t}`,i=rn(e),r=i.get(n);if(r!==void 0)return r;const s=e.measureText(t).width;return i.set(n,s),s},sn=e=>{if(e.includes(`
`)){const t=e.split(/\r?\n/);return t.length>0?t:[""]}return [e]},Ot=e=>Math.max(24,e),pt=(e,t)=>{let n=0;const i=e.letterSpacing;for(const a of e.lines){const o=lt(t,a),l=a.length>1?i*(a.length-1):0,d=Math.max(0,o+l);d>n&&(n=d);}e.width=n;const r=Math.max(1,Math.floor(e.fontSize*e.lineHeightMultiplier));e.lineHeightPx=r;const s=e.lines.length>1?(e.lines.length-1)*r:0;e.height=e.fontSize+s;},an=(e,t,n,i,r)=>{try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(n)||!Number.isFinite(i))throw new Error("Canvas dimensions must be numbers");if(!r)throw new Error("Prepare options are required");const s=Math.max(n,1),a=Ot(Math.floor(i*.05)),o=Ot(Math.floor(a*e.sizeScale));e.fontSize=o,t.font=`${e.fontSize}px ${e.fontFamily}`,e.lines=sn(e.text),pt(e,t);const l=!e.isScrolling&&(e.layout==="ue"||e.layout==="shita");if(l){const I=Math.max(1,s-_t*2);if(e.width>I){const H=Math.max(Qe,Math.min(e.fontSize,Math.floor(a*.6))),ht=I/Math.max(e.width,1),K=Math.max(H,Math.floor(e.fontSize*Math.min(ht,1)));K<e.fontSize&&(e.fontSize=K,t.font=`${e.fontSize}px ${e.fontFamily}`,pt(e,t));let Lt=0;for(;e.width>I&&e.fontSize>H&&Lt<5;){const Ee=I/Math.max(e.width,1),It=Math.max(H,Math.floor(e.fontSize*Math.max(Ee,.7)));It>=e.fontSize?e.fontSize=Math.max(H,e.fontSize-1):e.fontSize=It,t.font=`${e.fontSize}px ${e.fontFamily}`,pt(e,t),Lt+=1;}}}if(!e.isScrolling){e.bufferWidth=0;const I=l?_t:0,H=Math.max((s-e.width)/2,I),ht=Math.max(I,s-e.width-I),K=Math.min(H,Math.max(ht,I));e.virtualStartX=K,e.x=K,e.baseSpeed=0,e.speed=0,e.speedPixelsPerMs=0,e.visibleDurationMs=W,e.preCollisionDurationMs=W,e.totalDurationMs=W,e.reservationWidth=e.width,e.staticExpiryTimeMs=e.vposMs+W,e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1;return}e.staticExpiryTimeMs=null;const d=lt(t,"??".repeat(150)),h=e.width*Math.max(r.bufferRatio,0);e.bufferWidth=Math.max(r.baseBufferPx,h);const c=Math.max(r.entryBufferPx,e.bufferWidth),u=e.scrollDirection,p=u==="rtl"?s+r.virtualExtension:-e.width-e.bufferWidth-r.virtualExtension,m=u==="rtl"?-e.width-e.bufferWidth-c:s+c,g=u==="rtl"?s+c:-c,f=u==="rtl"?p+e.width+e.bufferWidth:p-e.bufferWidth;e.virtualStartX=p,e.x=p,e.exitThreshold=m;const x=s>0?e.width/s:0,S=r.maxVisibleDurationMs===r.minVisibleDurationMs;let C=r.maxVisibleDurationMs;if(!S&&x>1){const I=Math.min(x,r.maxWidthRatio),H=r.maxVisibleDurationMs/Math.max(I,1);C=Math.max(r.minVisibleDurationMs,Math.floor(H));}const w=s+e.width+e.bufferWidth+c,L=Math.max(C,1),F=w/L,U=F*1e3/60;e.baseSpeed=U,e.speed=e.baseSpeed,e.speedPixelsPerMs=F;const G=Math.abs(m-p),dt=u==="rtl"?Math.max(0,f-g):Math.max(0,g-f),Vt=Math.max(F,Number.EPSILON);e.visibleDurationMs=C,e.preCollisionDurationMs=Math.max(0,Math.ceil(dt/Vt)),e.totalDurationMs=Math.max(e.preCollisionDurationMs,Math.ceil(G/Vt));const Me=e.width+e.bufferWidth+c;e.reservationWidth=Math.min(d,Me),e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1;}catch(s){throw Mt.error("Comment.prepare",s,{text:e.text,visibleWidth:n,canvasHeight:i,hasContext:!!t}),s}},oe=5,D={enabled:false,maxLogsPerCategory:oe},at=new Map,on=e=>{if(e===void 0||!Number.isFinite(e))return oe;const t=Math.max(1,Math.floor(e));return Math.min(1e4,t)},ln=e=>{D.enabled=!!e.enabled,D.maxLogsPerCategory=on(e.maxLogsPerCategory),D.enabled||at.clear();},B=()=>D.enabled,cn=e=>{const t=at.get(e)??0;return t>=D.maxLogsPerCategory?(t===D.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${e}]`,"Further logs suppressed."),at.set(e,t+1)),false):(at.set(e,t+1),true)},M=(e,...t)=>{D.enabled&&cn(e)&&console.debug(`[CommentOverlay][${e}]`,...t);},Z=(e,t=32)=>e.length<=t?e:`${e.slice(0,t)}…`,dn=(e,t)=>{D.enabled&&(console.group(`[CommentOverlay][state-dump] ${e}`),console.table({"Current Time":`${t.currentTime.toFixed(2)}ms`,Duration:`${t.duration.toFixed(2)}ms`,"Is Playing":t.isPlaying,"Epoch ID":t.epochId,"Total Comments":t.totalComments,"Active Comments":t.activeComments,"Reserved Lanes":t.reservedLanes,"Final Phase":t.finalPhaseActive,"Playback Begun":t.playbackHasBegun,"Is Stalled":t.isStalled}),console.groupEnd());},hn=(e,t,n)=>{D.enabled&&M("epoch-change",`Epoch changed: ${e} → ${t} (reason: ${n})`);},v={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},Nt=()=>{if(!B())return;const e=performance.now();if(e-v.lastReported<=5e3)return;const t=v.hits+v.misses,n=t>0?v.hits/t*100:0,i=v.creates>0?(v.totalCharactersDrawn/v.creates).toFixed(1):"0",r=v.outlineCallsInCache+v.outlineCallsInFallback,s=v.fillCallsInCache+v.fillCallsInFallback;console.log("[TextureCache Stats]",`
  ...
  Avg Characters/Comment: ${i}`),v.lastReported=e;},un=()=>typeof OffscreenCanvas<"u",le=e=>{const t=Math.max(1,Math.round(e*.08)),n=[[-t,0],[t,0],[0,-t],[0,t]];if(t>1){const i=Math.max(1,Math.round(t*.7));n.push([-i,-i],[-i,i],[i,-i],[i,i]);}return n},ce=(e,t,n,i,r)=>(s,a,o,l=0)=>{if(s.length===0)return;const d=s.match(/^[\u3000\u00A0]+/),h=d?d[0].length:0,c=h>0?lt(n,d[0]):0,u=r+c+l,p=h>0?s.substring(h):s,m=()=>{i==="cache"?o==="outline"?v.outlineCallsInCache++:v.fillCallsInCache++:o==="outline"?v.outlineCallsInFallback++:v.fillCallsInFallback++;};if(Math.abs(e.letterSpacing)<Number.EPSILON){m(),t.fillText(p,u,a);return}let g=u;for(let f=0;f<p.length;f+=1){const x=p[f];m(),t.fillText(x,g,a);const S=lt(n,x);g+=S,f<p.length-1&&(g+=e.letterSpacing);}},pn=e=>`v2::${e.text}::${e.fontSize}::${e.fontFamily}::${e.color}::${e.opacity}::${e.renderStyle}::${e.letterSpacing}::${e.lines.length}`,mn=(e,t)=>{if(!un())return null;const n=Math.abs(e.letterSpacing)>=Number.EPSILON,i=e.lines.length>1;n&&v.letterSpacingComments++,i&&v.multiLineComments++,!n&&!i&&v.normalComments++,v.totalCharactersDrawn+=e.text.length;const r=Math.max(10,e.fontSize*.5),s=Math.ceil(e.width+r*2),a=Math.ceil(e.height+r*2),o=new OffscreenCanvas(s,a),l=o.getContext("2d");if(!l)return null;l.save(),l.font=`${e.fontSize}px ${e.fontFamily}`;const d=P(e.opacity),h=r,c=e.lines.length>0?e.lines:[e.text],u=e.lines.length>1&&e.lineHeightPx>0?e.lineHeightPx:e.fontSize,p=r+e.fontSize,m=ce(e,l,t,"cache",h),g=le(e.fontSize),f=()=>{const C=P(d*.6);l.save(),l.fillStyle=`rgba(0, 0, 0, ${C})`;for(const[w,L]of g)c.forEach((F,U)=>{const G=p+U*u+L;m(F,G,"outline",w);});l.restore();},x=C=>{l.save(),l.fillStyle=C,c.forEach((w,L)=>{const F=p+L*u;m(w,F,"fill");}),l.restore();};if(f(),e.renderStyle==="classic"){const C=Math.max(1,e.fontSize*.04),w=e.fontSize*.18;[{offsetXMultiplier:.9,offsetYMultiplier:1.1,blurMultiplier:.55,alpha:.52,rgb:"20, 28, 40"},{offsetXMultiplier:2.4,offsetYMultiplier:2.7,blurMultiplier:1.45,alpha:.32,rgb:"0, 0, 0"},{offsetXMultiplier:-0.7,offsetYMultiplier:-0.6,blurMultiplier:.4,alpha:.42,rgb:"255, 255, 255"}].forEach(L=>{const F=P(L.alpha*d);l.save(),l.shadowColor=`rgba(${L.rgb}, ${F})`,l.shadowBlur=w*L.blurMultiplier,l.shadowOffsetX=C*L.offsetXMultiplier,l.shadowOffsetY=C*L.offsetYMultiplier,l.fillStyle="rgba(0, 0, 0, 0)",c.forEach((U,G)=>{const dt=p+G*u;m(U,dt,"fill");}),l.restore();});}const S=ne(e.color,d);return x(S),l.restore(),o},gn=(e,t,n)=>{v.fallbacks++,t.save(),t.font=`${e.fontSize}px ${e.fontFamily}`;const i=P(e.opacity),r=n??e.x,s=e.lines.length>0?e.lines:[e.text],a=e.lines.length>1&&e.lineHeightPx>0?e.lineHeightPx:e.fontSize,o=e.y+e.fontSize,l=ce(e,t,t,"fallback",r),d=le(e.fontSize),h=()=>{const p=P(i*.6);t.save(),t.fillStyle=`rgba(0, 0, 0, ${p})`;for(const[m,g]of d)s.forEach((f,x)=>{const S=o+x*a+g;l(f,S,"outline",m);});t.restore();},c=p=>{t.save(),t.fillStyle=p,s.forEach((m,g)=>{const f=o+g*a;l(m,f,"fill");}),t.restore();};if(h(),e.renderStyle==="classic"){const p=Math.max(1,e.fontSize*.04),m=e.fontSize*.18;[{offsetXMultiplier:.9,offsetYMultiplier:1.1,blurMultiplier:.55,alpha:.52,rgb:"20, 28, 40"},{offsetXMultiplier:2.4,offsetYMultiplier:2.7,blurMultiplier:1.45,alpha:.32,rgb:"0, 0, 0"},{offsetXMultiplier:-0.7,offsetYMultiplier:-0.6,blurMultiplier:.4,alpha:.42,rgb:"255, 255, 255"}].forEach(g=>{const f=P(g.alpha*i);t.save(),t.shadowColor=`rgba(${g.rgb}, ${f})`,t.shadowBlur=m*g.blurMultiplier,t.shadowOffsetX=p*g.offsetXMultiplier,t.shadowOffsetY=p*g.offsetYMultiplier,t.fillStyle="rgba(0, 0, 0, 0)",s.forEach((x,S)=>{const C=o+S*a;l(x,C,"fill");}),t.restore();});}const u=ne(e.color,i);c(u),t.restore();},fn=(e,t,n)=>{try{if(!e.isActive||!t)return;const i=pn(e),r=e.getCachedTexture();if(e.getTextureCacheKey()!==i||!r){v.misses++,v.creates++;const a=mn(e,t);e.setCachedTexture(a),e.setTextureCacheKey(i);}else v.hits++;const s=e.getCachedTexture();if(s){const a=n??e.x,o=Math.max(10,e.fontSize*.5);t.drawImage(s,a-o,e.y-o),Nt();return}gn(e,t,n),Nt();}catch(i){Mt.error("Comment.draw",i,{text:e.text,isActive:e.isActive,hasContext:!!t,interpolatedX:n});}},bn=e=>e==="ltr"?"ltr":"rtl",yn=e=>e==="ltr"?1:-1;class de{text;vposMs;commands;layout;isScrolling;sizeScale;opacityMultiplier;opacityOverride;colorOverride;isInvisible;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily;opacity;activationTimeMs=null;staticExpiryTimeMs=null;isActive=false;hasShown=false;isPaused=false;lastUpdateTime=0;reservationWidth=0;bufferWidth=0;visibleDurationMs=0;totalDurationMs=0;preCollisionDurationMs=0;speedPixelsPerMs=0;virtualStartX=0;exitThreshold=0;scrollDirection="rtl";renderStyle="outline-only";creationIndex=0;letterSpacing=0;lineHeightMultiplier=1;lineHeightPx=0;lines=[];epochId=0;directionSign=-1;timeSource;lastSyncedSettingsVersion=-1;cachedTexture=null;textureCacheKey="";constructor(t,n,i,r,s={}){if(typeof t!="string")throw new Error("Comment text must be a string");if(!Number.isFinite(n)||n<0)throw new Error("Comment vposMs must be a non-negative number");this.text=t,this.vposMs=n,this.commands=Array.isArray(i)?[...i]:[];const a=Ne(this.commands,{defaultColor:r.commentColor});this.layout=a.layout,this.isScrolling=this.layout==="naka",this.sizeScale=a.sizeScale,this.opacityMultiplier=a.opacityMultiplier,this.opacityOverride=a.opacityOverride,this.colorOverride=a.colorOverride,this.isInvisible=a.isInvisible,this.fontFamily=a.fontFamily,this.color=a.resolvedColor,this.opacity=this.getEffectiveOpacity(r.commentOpacity),this.renderStyle=r.renderStyle,this.letterSpacing=a.letterSpacing,this.lineHeightMultiplier=a.lineHeight,this.timeSource=s.timeSource??ie(),this.applyScrollDirection(r.scrollDirection),this.syncWithSettings(r,s.settingsVersion);}prepare(t,n,i,r){an(this,t,n,i,r);}draw(t,n=null){fn(this,t,n);}update(t=1,n=false){try{if(!this.isActive){this.isPaused=n;return}const i=this.timeSource.now();if(!this.isScrolling){this.isPaused=n,this.lastUpdateTime=i;return}if(n){this.isPaused=!0,this.lastUpdateTime=i;return}const r=(i-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*t,this.x+=this.speed*r*this.directionSign,(this.scrollDirection==="rtl"&&this.x<=this.exitThreshold||this.scrollDirection==="ltr"&&this.x>=this.exitThreshold)&&(this.isActive=!1),this.lastUpdateTime=i,this.isPaused=!1;}catch(i){Mt.error("Comment.update",i,{text:this.text,playbackRate:t,isPaused:n,isActive:this.isActive});}}syncWithSettings(t,n){typeof n=="number"&&n===this.lastSyncedSettingsVersion||(this.color=this.getEffectiveColor(t.commentColor),this.opacity=this.getEffectiveOpacity(t.commentOpacity),this.applyScrollDirection(t.scrollDirection),this.renderStyle=t.renderStyle,typeof n=="number"&&(this.lastSyncedSettingsVersion=n));}getEffectiveColor(t){const n=this.colorOverride??t;return typeof n!="string"||n.length===0?t:n.toUpperCase()}getEffectiveOpacity(t){if(typeof this.opacityOverride=="number")return P(this.opacityOverride);const n=t*this.opacityMultiplier;return Number.isFinite(n)?P(n):0}markActivated(t){this.activationTimeMs=t;}clearActivation(){this.activationTimeMs=null,this.isScrolling||(this.staticExpiryTimeMs=null),this.resetTextureCache();}hasStaticExpired(t){return this.isScrolling||this.staticExpiryTimeMs===null?false:t>=this.staticExpiryTimeMs}getDirectionSign(){return this.directionSign}getTimeSource(){return this.timeSource}getTextureCacheKey(){return this.textureCacheKey}setTextureCacheKey(t){this.textureCacheKey=t;}getCachedTexture(){return this.cachedTexture}setCachedTexture(t){this.cachedTexture=t;}resetTextureCache(){this.cachedTexture=null,this.textureCacheKey="";}applyScrollDirection(t){const n=bn(t);this.scrollDirection=n,this.directionSign=yn(n);}}const vn=4e3,mt={commentColor:"#FFFFFF",commentOpacity:1,isCommentVisible:true,useContainerResizeObserver:true,ngWords:[],ngRegexps:[],scrollDirection:"rtl",renderStyle:"outline-only",syncMode:"raf",scrollVisibleDurationMs:vn,useFixedLaneCount:false,fixedLaneCount:12,useDprScaling:true,enableAutoHardReset:true},he=()=>({...mt,ngWords:[...mt.ngWords],ngRegexps:[...mt.ngRegexps]}),xn=e=>Number.isFinite(e)?e<=0?0:e>=1?1:e:1,ue=(e,t=0)=>t===0?Je:Ze,nt=e=>{const t=e.scrollVisibleDurationMs,n=t==null?null:Number.isFinite(t)?Math.max(1,Math.floor(t)):null;return {...e,scrollDirection:e.scrollDirection==="ltr"?"ltr":"rtl",commentOpacity:xn(e.commentOpacity),renderStyle:e.renderStyle==="classic"?"classic":"outline-only",scrollVisibleDurationMs:n,syncMode:e.syncMode==="video-frame"?"video-frame":"raf",useDprScaling:!!e.useDprScaling,enableAutoHardReset:e.enableAutoHardReset!==false}},Sn=e=>typeof window<"u"&&typeof window.requestAnimationFrame=="function"&&typeof window.cancelAnimationFrame=="function"?{request:t=>window.requestAnimationFrame(t),cancel:t=>window.cancelAnimationFrame(t)}:{request:t=>globalThis.setTimeout(()=>{t(e.now());},16),cancel:t=>{globalThis.clearTimeout(t);}},wn=()=>typeof document>"u"?()=>{throw new Error("Document is not available. Provide a custom createCanvasElement implementation.")}:()=>document.createElement("canvas"),Cn=e=>{if(!e||typeof e!="object")return  false;const t=e;return typeof t.commentColor=="string"&&typeof t.commentOpacity=="number"&&typeof t.isCommentVisible=="boolean"},Mn=function(e){if(!Array.isArray(e)||e.length===0)return [];const t=[];this.commentDependencies.settingsVersion=this.settingsVersion;for(const n of e){const{text:i,vposMs:r,commands:s=[]}=n,a=Z(i);if(this.isNGComment(i)){M("comment-skip-ng",{preview:a,vposMs:r});continue}const o=We(r);if(o===null){this.log.warn("CommentRenderer.addComment.invalidVpos",{text:i,vposMs:r}),M("comment-skip-invalid-vpos",{preview:a,vposMs:r});continue}if(this.comments.some(d=>d.text===i&&d.vposMs===o)||t.some(d=>d.text===i&&d.vposMs===o)){M("comment-skip-duplicate",{preview:a,vposMs:o});continue}const l=new de(i,o,s,this._settings,this.commentDependencies);l.creationIndex=this.commentSequence++,l.epochId=this.epochId,t.push(l),M("comment-added",{preview:a,vposMs:o,commands:l.commands.length,layout:l.layout,isScrolling:l.isScrolling,invisible:l.isInvisible});}return t.length===0?[]:(this.comments.push(...t),this.finalPhaseActive&&(this.finalPhaseScheduleDirty=true),this.comments.sort((n,i)=>{const r=n.vposMs-i.vposMs;return Math.abs(r)>T?r:n.creationIndex-i.creationIndex}),t)},En=function(e,t,n=[]){const[i]=this.addComments([{text:e,vposMs:t,commands:n}]);return i??null},kn=function(){if(this.comments.length=0,this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.commentSequence=0,this.ctx&&this.canvas){const e=this.canvasDpr>0?this.canvasDpr:1,t=this.displayWidth>0?this.displayWidth:this.canvas.width/e,n=this.displayHeight>0?this.displayHeight:this.canvas.height/e;this.ctx.clearRect(0,0,t,n);}},Tn=function(){this.clearComments(),this.currentTime=0,this.resetFinalPhaseState(),this.playbackHasBegun=false,this.skipDrawingForCurrentFrame=false,this.isStalled=false,this.pendingInitialSync=false;},pe=function(){const e=this._settings,t=Array.isArray(e.ngWords)?e.ngWords:[];this.normalizedNgWords=t.filter(i=>typeof i=="string");const n=Array.isArray(e.ngRegexps)?e.ngRegexps:[];this.compiledNgRegexps=n.map(i=>{if(typeof i!="string")return null;try{return new RegExp(i,"i")}catch(r){return this.log.warn("CommentRenderer.invalidNgRegexp",r,{entry:i}),null}}).filter(i=>!!i);},An=function(e){return typeof e!="string"||e.length===0?false:this.normalizedNgWords.some(t=>t.length>0&&e.includes(t))?true:this.compiledNgRegexps.some(t=>t.test(e))},Vn=e=>{e.prototype.addComments=Mn,e.prototype.addComment=En,e.prototype.clearComments=kn,e.prototype.resetState=Tn,e.prototype.rebuildNgMatchers=pe,e.prototype.isNGComment=An;},Ln=function(){const e=this.canvas,t=this.ctx,n=this.timeSource.now();if(this.lastHardResetAt=n,this.incrementEpoch("manual-reset"),this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.comments.forEach(i=>{i.isActive=false,i.hasShown=false,i.lane=-1,i.clearActivation(),i.epochId=this.epochId;}),e&&t){const i=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:e.width/i,s=this.displayHeight>0?this.displayHeight:e.height/i;t.clearRect(0,0,r,s);}this.pendingInitialSync=true,this.resetFinalPhaseState(),this.emitStateSnapshot("hardReset");},In=function(){this.finalPhaseActive=false,this.finalPhaseStartTime=null,this.finalPhaseScheduleDirty=false,this.finalPhaseVposOverrides.clear();},Pn=function(e){const t=this.epochId;if(this.epochId+=1,hn(t,this.epochId,e),this.eventHooks.onEpochChange){const n={previousEpochId:t,newEpochId:this.epochId,reason:e,timestamp:this.timeSource.now()};try{this.eventHooks.onEpochChange(n);}catch(i){this.log.error("CommentRenderer.incrementEpoch.callback",i,{info:n});}}this.comments.forEach(n=>{n.epochId=this.epochId;});},Rn=function(e){const t=this.timeSource.now();if(t-this.lastSnapshotEmitTime<this.snapshotEmitThrottleMs)return;const n={currentTime:this.currentTime,duration:this.duration,isPlaying:this.isPlaying,epochId:this.epochId,totalComments:this.comments.length,activeComments:this.activeComments.size,reservedLanes:this.reservedLanes.size,finalPhaseActive:this.finalPhaseActive,playbackHasBegun:this.playbackHasBegun,isStalled:this.isStalled};if(dn(e,n),this.eventHooks.onStateSnapshot)try{this.eventHooks.onStateSnapshot(n);}catch(i){this.log.error("CommentRenderer.emitStateSnapshot.callback",i);}this.lastSnapshotEmitTime=t;},Fn=function(e){return this.finalPhaseActive&&this.finalPhaseScheduleDirty&&this.recomputeFinalPhaseTimeline(),this.finalPhaseVposOverrides.get(e)??e.vposMs},_n=function(e){if(!e.isScrolling)return W;const t=[];return Number.isFinite(e.visibleDurationMs)&&e.visibleDurationMs>0&&t.push(e.visibleDurationMs),Number.isFinite(e.totalDurationMs)&&e.totalDurationMs>0&&t.push(e.totalDurationMs),t.length>0?Math.max(...t):Ct},Dn=function(e){if(!this.finalPhaseActive||this.finalPhaseStartTime===null)return this.finalPhaseVposOverrides.delete(e),e.vposMs;this.finalPhaseScheduleDirty&&this.recomputeFinalPhaseTimeline();const t=this.finalPhaseVposOverrides.get(e);if(t!==void 0)return t;const n=Math.max(e.vposMs,this.finalPhaseStartTime);return this.finalPhaseVposOverrides.set(e,n),n},Hn=function(){if(!this.finalPhaseActive||this.finalPhaseStartTime===null){this.finalPhaseVposOverrides.clear(),this.finalPhaseScheduleDirty=false;return}const e=this.finalPhaseStartTime,t=this.duration>0?this.duration:e+X,n=Math.max(e+X,t),i=this.comments.filter(l=>l.hasShown||l.isInvisible||this.isNGComment(l.text)?false:l.vposMs>=e-_).sort((l,d)=>{const h=l.vposMs-d.vposMs;return Math.abs(h)>T?h:l.creationIndex-d.creationIndex});if(this.finalPhaseVposOverrides.clear(),i.length===0){this.finalPhaseScheduleDirty=false;return}const r=Math.max(n-e,X)/Math.max(i.length,1),s=Number.isFinite(r)?r:ut,a=Math.max(ut,Math.min(s,Ye));let o=e;i.forEach((l,d)=>{const h=Math.max(1,this.getFinalPhaseDisplayDuration(l)),c=n-h;let u=Math.max(e,Math.min(o,c));Number.isFinite(u)||(u=e);const p=je*d;u+p<=c&&(u+=p),this.finalPhaseVposOverrides.set(l,u);const m=Math.max(ut,Math.min(h/2,a));o=u+m;}),this.finalPhaseScheduleDirty=false;},On=e=>{e.prototype.hardReset=Ln,e.prototype.resetFinalPhaseState=In,e.prototype.incrementEpoch=Pn,e.prototype.emitStateSnapshot=Rn,e.prototype.getEffectiveCommentVpos=Fn,e.prototype.getFinalPhaseDisplayDuration=_n,e.prototype.resolveFinalPhaseVpos=Dn,e.prototype.recomputeFinalPhaseTimeline=Hn;},Nn=function(){return !this.playbackHasBegun&&!this.isPlaying&&this.currentTime<=z},zn=function(){this.playbackHasBegun||(this.isPlaying||this.currentTime>z)&&(this.playbackHasBegun=true);},$n=e=>{e.prototype.shouldSuppressRendering=Nn,e.prototype.updatePlaybackProgressState=zn;},Wn=function(e){const t=this.videoElement,n=this.canvas,i=this.ctx;if(!t||!n||!i)return;const r=typeof e=="number"?e:R(t.currentTime);if(this.currentTime=r,this.playbackRate=t.playbackRate,this.isPlaying=!t.paused,this.updatePlaybackProgressState(),this.skipDrawingForCurrentFrame=this.shouldSuppressRendering(),this.skipDrawingForCurrentFrame)return;const s=this.canvasDpr>0?this.canvasDpr:1,a=this.displayWidth>0?this.displayWidth:n.width/s,o=this.displayHeight>0?this.displayHeight:n.height/s,l=this.buildPrepareOptions(a),d=this.duration>0&&this.duration-this.currentTime<=Ke;d&&!this.finalPhaseActive&&(this.finalPhaseActive=true,this.finalPhaseStartTime=this.currentTime,this.finalPhaseVposOverrides.clear(),this.finalPhaseScheduleDirty=true,i.clearRect(0,0,a,o),this.comments.forEach(c=>{c.isActive=false,c.clearActivation();}),this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0),!d&&this.finalPhaseActive&&this.resetFinalPhaseState(),this.finalPhaseActive&&this.finalPhaseScheduleDirty&&this.recomputeFinalPhaseTimeline(),this.pruneStaticLaneReservations(this.currentTime);for(const c of Array.from(this.activeComments)){const u=this.getEffectiveCommentVpos(c),p=u<this.currentTime-_,m=u>this.currentTime+_;if(p||m){c.isActive=false,this.activeComments.delete(c),c.clearActivation(),c.lane>=0&&(c.layout==="ue"?this.releaseStaticLane("ue",c.lane):c.layout==="shita"&&this.releaseStaticLane("shita",c.lane));continue}c.isScrolling&&c.hasShown&&(c.scrollDirection==="rtl"&&c.x<=c.exitThreshold||c.scrollDirection==="ltr"&&c.x>=c.exitThreshold)&&(c.isActive=false,this.activeComments.delete(c),c.clearActivation());}const h=this.getCommentsInTimeWindow(this.currentTime,_);for(const c of h){const u=B(),p=u?Z(c.text):"";if(u&&M("comment-evaluate",{stage:"update",preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),currentTime:this.currentTime,isActive:c.isActive,hasShown:c.hasShown}),this.isNGComment(c.text)){u&&M("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"ng-runtime"});continue}if(c.isInvisible){u&&M("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"invisible"}),c.isActive=false,this.activeComments.delete(c),c.hasShown=true,c.clearActivation();continue}if(c.syncWithSettings(this._settings,this.settingsVersion),this.shouldActivateCommentAtTime(c,this.currentTime,p)&&this.activateComment(c,i,a,o,l,this.currentTime),c.isActive){if(c.layout!=="naka"&&c.hasStaticExpired(this.currentTime)){const m=c.layout==="ue"?"ue":"shita";this.releaseStaticLane(m,c.lane),c.isActive=false,this.activeComments.delete(c),c.clearActivation();continue}if(c.layout==="naka"&&this.getEffectiveCommentVpos(c)>this.currentTime+z){c.x=c.virtualStartX,c.lastUpdateTime=this.timeSource.now();continue}if(c.hasShown=true,c.update(this.playbackRate,!this.isPlaying),!c.isScrolling&&c.hasStaticExpired(this.currentTime)){const m=c.layout==="ue"?"ue":"shita";this.releaseStaticLane(m,c.lane),c.isActive=false,this.activeComments.delete(c),c.clearActivation();}}}},qn=function(e){const t=this._settings.scrollVisibleDurationMs;let n=Ct,i=Rt;return t!==null&&(n=t,i=Math.max(1,Math.min(t,Rt))),{visibleWidth:e,virtualExtension:Xe,maxVisibleDurationMs:n,minVisibleDurationMs:i,maxWidthRatio:qe,bufferRatio:Be,baseBufferPx:Ue,entryBufferPx:Ge}},Bn=function(e){const t=this.currentTime;this.pruneLaneReservations(t),this.pruneStaticLaneReservations(t);const n=this.getLanePriorityOrder(t),i=this.createLaneReservation(e,t);for(const s of n)if(this.isLaneAvailable(s,i,t))return this.storeLaneReservation(s,i),s;const r=n[0]??0;return this.storeLaneReservation(r,i),r},Un=e=>{e.prototype.updateComments=Wn,e.prototype.buildPrepareOptions=qn,e.prototype.findAvailableLane=Bn;},Gn=function(e,t){let n=0,i=e.length;for(;n<i;){const r=Math.floor((n+i)/2),s=e[r];s!==void 0&&s.totalEndTime+ot<=t?n=r+1:i=r;}return n},Kn=function(e){for(const[t,n]of this.reservedLanes.entries()){const i=this.findFirstValidReservationIndex(n,e);i>=n.length?this.reservedLanes.delete(t):i>0&&this.reservedLanes.set(t,n.slice(i));}},Yn=function(e){const t=r=>r.filter(s=>s.releaseTime>e),n=t(this.topStaticLaneReservations),i=t(this.bottomStaticLaneReservations);this.topStaticLaneReservations.length=0,this.topStaticLaneReservations.push(...n),this.bottomStaticLaneReservations.length=0,this.bottomStaticLaneReservations.push(...i);},jn=e=>{e.prototype.findFirstValidReservationIndex=Gn,e.prototype.pruneLaneReservations=Kn,e.prototype.pruneStaticLaneReservations=Yn;},Xn=function(e){let t=0,n=this.comments.length;for(;t<n;){const i=Math.floor((t+n)/2),r=this.comments[i];r!==void 0&&r.vposMs<e?t=i+1:n=i;}return t},Jn=function(e,t){if(this.comments.length===0)return [];const n=e-t,i=e+t,r=this.findCommentIndexAtOrAfter(n),s=[];for(let a=r;a<this.comments.length;a++){const o=this.comments[a];if(o){if(o.vposMs>i)break;s.push(o);}}return s},Zn=function(e){return e==="ue"?this.topStaticLaneReservations:this.bottomStaticLaneReservations},Qn=function(e){return e==="ue"?this.topStaticLaneReservations.length:this.bottomStaticLaneReservations.length},ti=function(e){const t=e==="ue"?"shita":"ue",n=this.getStaticLaneDepth(t),i=this.laneCount-n;return i<=0?-1:i-1},ei=function(e){return Math.max(0,this.laneCount-1-e)},ni=function(e,t,n,i){const r=Math.max(1,n),s=Math.max(i.height,i.fontSize),a=5,o=2;if(e==="ue"){let c=a;const u=this.getStaticReservations(e).filter(m=>m.lane<t).sort((m,g)=>m.lane-g.lane);for(const m of u){const g=m.yEnd-m.yStart;c+=g+o;}const p=Math.max(a,r-s-a);return Math.max(a,Math.min(c,p))}let l=r-a;const d=this.getStaticReservations(e).filter(c=>c.lane<t).sort((c,u)=>c.lane-u.lane);for(const c of d){const u=c.yEnd-c.yStart;l-=u+o;}const h=l-s;return Math.max(a,h)},ii=function(){const e=new Set;for(const t of this.topStaticLaneReservations)e.add(t.lane);for(const t of this.bottomStaticLaneReservations)e.add(this.getGlobalLaneIndexForBottom(t.lane));return e},ri=e=>{e.prototype.findCommentIndexAtOrAfter=Xn,e.prototype.getCommentsInTimeWindow=Jn,e.prototype.getStaticReservations=Zn,e.prototype.getStaticLaneDepth=Qn,e.prototype.getStaticLaneLimit=ti,e.prototype.getGlobalLaneIndexForBottom=ei,e.prototype.resolveStaticCommentOffset=ni,e.prototype.getStaticReservedLaneSet=ii;},si=function(e,t,n=""){const i=n.length>0&&B(),r=this.resolveFinalPhaseVpos(e);return this.finalPhaseActive&&this.finalPhaseStartTime!==null&&e.vposMs<this.finalPhaseStartTime-T?(i&&M("comment-eval-skip",{preview:n,vposMs:e.vposMs,effectiveVposMs:r,reason:"final-phase-trimmed",finalPhaseStartTime:this.finalPhaseStartTime}),this.finalPhaseVposOverrides.delete(e),false):e.isInvisible?(i&&M("comment-eval-skip",{preview:n,vposMs:e.vposMs,effectiveVposMs:r,reason:"invisible"}),false):e.isActive?(i&&M("comment-eval-skip",{preview:n,vposMs:e.vposMs,effectiveVposMs:r,reason:"already-active"}),false):e.hasShown&&r<=t?(i&&M("comment-eval-skip",{preview:n,vposMs:e.vposMs,effectiveVposMs:r,reason:"already-shown",currentTime:t}),false):r>t+z?(i&&M("comment-eval-pending",{preview:n,vposMs:e.vposMs,effectiveVposMs:r,reason:"future",currentTime:t}),false):r<t-_?(i&&M("comment-eval-skip",{preview:n,vposMs:e.vposMs,effectiveVposMs:r,reason:"expired-window",currentTime:t}),false):(i&&M("comment-eval-ready",{preview:n,vposMs:e.vposMs,effectiveVposMs:r,currentTime:t}),true)},ai=function(e,t,n,i,r,s){e.prepare(t,n,i,r);const a=this.resolveFinalPhaseVpos(e);if(B()&&M("comment-prepared",{preview:Z(e.text),layout:e.layout,isScrolling:e.isScrolling,width:e.width,height:e.height,bufferWidth:e.bufferWidth,visibleDurationMs:e.visibleDurationMs,effectiveVposMs:a}),e.layout==="naka"){const o=Math.max(0,s-a),l=e.speedPixelsPerMs*o;if(this.finalPhaseActive&&this.finalPhaseStartTime!==null){const p=this.duration>0?this.duration:this.finalPhaseStartTime+X,m=Math.max(this.finalPhaseStartTime+X,p),g=e.width+n,f=g>0?g/Math.max(e.speedPixelsPerMs,1):0;if(a+f>m){const x=m-s,S=Math.max(0,x)*e.speedPixelsPerMs,C=e.scrollDirection==="rtl"?Math.max(e.virtualStartX-l,n-S):Math.min(e.virtualStartX+l,S-e.width);e.x=C;}else e.x=e.scrollDirection==="rtl"?e.virtualStartX-l:e.virtualStartX+l;}else e.x=e.scrollDirection==="rtl"?e.virtualStartX-l:e.virtualStartX+l;const d=this.findAvailableLane(e);e.lane=d;const h=Math.max(1,this.laneHeight),c=Math.max(0,i-e.height),u=d*h;e.y=Math.max(0,Math.min(u,c));}else {const o=e.layout==="ue"?"ue":"shita",l=this.assignStaticLane(o,e,i,s),d=this.resolveStaticCommentOffset(o,l,i,e);e.x=Math.max(0,Math.min(n-e.width,e.virtualStartX)),e.y=d,e.lane=o==="ue"?l:this.getGlobalLaneIndexForBottom(l),e.speed=0,e.baseSpeed=0,e.speedPixelsPerMs=0,e.visibleDurationMs=W;const h=s+e.visibleDurationMs;this.activeComments.add(e),e.isActive=true,e.hasShown=true,e.isPaused=!this.isPlaying,e.markActivated(s),e.lastUpdateTime=this.timeSource.now(),e.staticExpiryTimeMs=h,this.reserveStaticLane(o,e,l,h),B()&&M("comment-activate-static",{preview:Z(e.text),lane:e.lane,position:o,displayEnd:h,effectiveVposMs:a});return}this.activeComments.add(e),e.isActive=true,e.hasShown=true,e.isPaused=!this.isPlaying,e.markActivated(s),e.lastUpdateTime=this.timeSource.now();},oi=function(e,t,n,i){const r=this.getStaticReservations(e),s=this.getStaticLaneLimit(e),a=s>=0?s+1:0,o=Array.from({length:a},(h,c)=>c);for(const h of o){const c=this.resolveStaticCommentOffset(e,h,n,t),u=Math.max(t.height,t.fontSize),p=ue(t.fontSize,h),m=c-p,g=c+u+p;if(!r.some(f=>f.releaseTime>i?!(g<=f.yStart||m>=f.yEnd):false))return h}let l=o[0]??0,d=Number.POSITIVE_INFINITY;for(const h of r)h.releaseTime<d&&(d=h.releaseTime,l=h.lane);return l},li=function(e,t,n,i){const r=this.getStaticReservations(e),s=Math.max(t.height,t.fontSize),a=ue(t.fontSize,n),o=t.y-a,l=t.y+s+a;r.push({comment:t,releaseTime:i,yStart:o,yEnd:l,lane:n});},ci=function(e,t){if(t<0)return;const n=this.getStaticReservations(e),i=n.findIndex(r=>r.lane===t);i>=0&&n.splice(i,1);},di=e=>{e.prototype.shouldActivateCommentAtTime=si,e.prototype.activateComment=ai,e.prototype.assignStaticLane=oi,e.prototype.reserveStaticLane=li,e.prototype.releaseStaticLane=ci;},hi=function(e){const t=Array.from({length:this.laneCount},(s,a)=>a).sort((s,a)=>{const o=this.getLaneNextAvailableTime(s,e),l=this.getLaneNextAvailableTime(a,e);return Math.abs(o-l)<=T?s-a:o-l}),n=this.getStaticReservedLaneSet();if(n.size===0)return t;const i=t.filter(s=>!n.has(s));if(i.length===0)return t;const r=t.filter(s=>n.has(s));return [...i,...r]},ui=function(e,t){const n=this.reservedLanes.get(e);if(!n||n.length===0)return t;const i=this.findFirstValidReservationIndex(n,t),r=n[i];return r?Math.max(t,r.endTime+ot):t},pi=function(e,t){const n=Math.max(e.speedPixelsPerMs,T),i=this.getEffectiveCommentVpos(e),r=Number.isFinite(i)?i:t,s=Math.max(0,r),a=s+e.preCollisionDurationMs+ot,o=s+e.totalDurationMs+ot;return {comment:e,startTime:s,endTime:Math.max(s,a),totalEndTime:Math.max(s,o),startLeft:e.virtualStartX,width:e.width,speed:n,buffer:e.bufferWidth,directionSign:e.getDirectionSign()}},mi=function(e,t,n){const i=this.reservedLanes.get(e);if(!i||i.length===0)return  true;const r=this.findFirstValidReservationIndex(i,n);for(let s=r;s<i.length;s+=1){const a=i[s];if(a&&this.areReservationsConflicting(a,t))return  false}return  true},gi=function(e,t){const n=[...this.reservedLanes.get(e)??[],t].sort((i,r)=>i.totalEndTime-r.totalEndTime);this.reservedLanes.set(e,n);},fi=function(e,t){const n=Math.max(e.startTime,t.startTime),i=Math.min(e.endTime,t.endTime);if(n>=i)return  false;const r=new Set([n,i,n+(i-n)/2]),s=this.solveLeftRightEqualityTime(e,t);s!==null&&s>=n-T&&s<=i+T&&r.add(s);const a=this.solveLeftRightEqualityTime(t,e);a!==null&&a>=n-T&&a<=i+T&&r.add(a);for(const o of r){if(o<n-T||o>i+T)continue;const l=this.computeForwardGap(e,t,o),d=this.computeForwardGap(t,e,o);if(l<=T&&d<=T)return  true}return  false},bi=function(e,t,n){const i=this.getBufferedEdges(e,n),r=this.getBufferedEdges(t,n);return i.left-r.right},yi=function(e,t){const n=Math.max(0,t-e.startTime),i=e.speed*n,r=e.startLeft+e.directionSign*i,s=r-e.buffer,a=r+e.width+e.buffer;return {left:s,right:a}},vi=function(e,t){const n=e.directionSign,i=t.directionSign,r=i*t.speed-n*e.speed;if(Math.abs(r)<T)return null;const s=(t.startLeft+i*t.speed*t.startTime+t.width+t.buffer-e.startLeft-n*e.speed*e.startTime+e.buffer)/r;return Number.isFinite(s)?s:null},xi=e=>{e.prototype.getLanePriorityOrder=hi,e.prototype.getLaneNextAvailableTime=ui,e.prototype.createLaneReservation=pi,e.prototype.isLaneAvailable=mi,e.prototype.storeLaneReservation=gi,e.prototype.areReservationsConflicting=fi,e.prototype.computeForwardGap=bi,e.prototype.getBufferedEdges=yi,e.prototype.solveLeftRightEqualityTime=vi;},Si=function(){const e=this.canvas,t=this.ctx;if(!e||!t)return;const n=this.canvasDpr>0?this.canvasDpr:1,i=this.displayWidth>0?this.displayWidth:e.width/n,r=this.displayHeight>0?this.displayHeight:e.height/n,s=this.timeSource.now();if(this.skipDrawingForCurrentFrame||this.shouldSuppressRendering()||this.isStalled){t.clearRect(0,0,i,r),this.lastDrawTime=s;return}t.clearRect(0,0,i,r);const a=Array.from(this.activeComments);if(this._settings.isCommentVisible){const o=(s-this.lastDrawTime)/16.666666666666668;a.sort((l,d)=>{const h=this.getEffectiveCommentVpos(l),c=this.getEffectiveCommentVpos(d),u=h-c;return Math.abs(u)>T?u:l.isScrolling!==d.isScrolling?l.isScrolling?1:-1:l.creationIndex-d.creationIndex}),a.forEach(l=>{const d=this.isPlaying&&!l.isPaused?l.x+l.getDirectionSign()*l.speed*o:l.x;l.draw(t,d);});}this.lastDrawTime=s;},wi=function(e){const t=this.videoElement,n=this.canvas,i=this.ctx;if(!t||!n||!i)return;const r=typeof e=="number"?e:R(t.currentTime);this.currentTime=r,this.lastDrawTime=this.timeSource.now();const s=this.canvasDpr>0?this.canvasDpr:1,a=this.displayWidth>0?this.displayWidth:n.width/s,o=this.displayHeight>0?this.displayHeight:n.height/s,l=this.buildPrepareOptions(a);this.getCommentsInTimeWindow(this.currentTime,_).forEach(d=>{if(this.isNGComment(d.text)||d.isInvisible){d.isActive=false,this.activeComments.delete(d),d.clearActivation();return}if(d.syncWithSettings(this._settings,this.settingsVersion),d.isActive=false,this.activeComments.delete(d),d.lane=-1,d.clearActivation(),this.shouldActivateCommentAtTime(d,this.currentTime)){this.activateComment(d,i,a,o,l,this.currentTime);return}this.getEffectiveCommentVpos(d)<this.currentTime-_?d.hasShown=true:d.hasShown=false;});},Ci=e=>{e.prototype.draw=Si,e.prototype.performInitialSync=wi;},Mi=function(e){this.videoElement&&this._settings.isCommentVisible&&(this.pendingInitialSync&&(this.performInitialSync(e),this.pendingInitialSync=false),this.updateComments(e),this.draw());},Ei=function(){const e=this.frameId;this.frameId=null,e!==null&&this.animationFrameProvider.cancel(e),this.processFrame(),this.scheduleNextFrame();},ki=function(e,t){this.videoFrameHandle=null;const n=typeof t?.mediaTime=="number"?t.mediaTime*1e3:void 0;this.processFrame(typeof n=="number"?n:void 0),this.scheduleNextFrame();},Ti=function(){if(this._settings.syncMode!=="video-frame")return  false;const e=this.videoElement;return !!e&&typeof e.requestVideoFrameCallback=="function"&&typeof e.cancelVideoFrameCallback=="function"},Ai=function(){const e=this.videoElement;if(e){if(this.shouldUseVideoFrameCallback()){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback();const t=e.requestVideoFrameCallback;typeof t=="function"&&(this.videoFrameHandle=t.call(e,this.handleVideoFrame));return}this.cancelVideoFrameCallback(),this.frameId=this.animationFrameProvider.request(this.handleAnimationFrame);}},Vi=function(){this.frameId!==null&&(this.animationFrameProvider.cancel(this.frameId),this.frameId=null);},Li=function(){if(this.videoFrameHandle===null)return;const e=this.videoElement;e&&typeof e.cancelVideoFrameCallback=="function"&&e.cancelVideoFrameCallback(this.videoFrameHandle),this.videoFrameHandle=null;},Ii=function(){this.stopAnimation(),this.scheduleNextFrame();},Pi=function(){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback();},Ri=function(){const e=this.canvas,t=this.ctx,n=this.videoElement;if(!e||!t||!n)return;const i=R(n.currentTime),r=Math.abs(i-this.currentTime),s=this.timeSource.now();if(s-this.lastPlayResumeTime<this.playResumeSeekIgnoreDurationMs){this.currentTime=i,this._settings.isCommentVisible&&(this.lastDrawTime=s,this.draw());return}const a=r>z;if(this.currentTime=i,this.resetFinalPhaseState(),this.updatePlaybackProgressState(),!a){this._settings.isCommentVisible&&(this.lastDrawTime=this.timeSource.now(),this.draw());return}this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0;const o=this.canvasDpr>0?this.canvasDpr:1,l=this.displayWidth>0?this.displayWidth:e.width/o,d=this.displayHeight>0?this.displayHeight:e.height/o,h=this.buildPrepareOptions(l);this.getCommentsInTimeWindow(this.currentTime,_).forEach(c=>{const u=B(),p=u?Z(c.text):"";if(u&&M("comment-evaluate",{stage:"seek",preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),currentTime:this.currentTime,isActive:c.isActive,hasShown:c.hasShown}),this.isNGComment(c.text)){u&&M("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"ng-runtime"}),c.isActive=false,this.activeComments.delete(c),c.clearActivation();return}if(c.isInvisible){u&&M("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"invisible"}),c.isActive=false,this.activeComments.delete(c),c.hasShown=true,c.clearActivation();return}if(c.syncWithSettings(this._settings,this.settingsVersion),c.isActive=false,this.activeComments.delete(c),c.lane=-1,c.clearActivation(),this.shouldActivateCommentAtTime(c,this.currentTime,p)){this.activateComment(c,t,l,d,h,this.currentTime);return}this.getEffectiveCommentVpos(c)<this.currentTime-_?c.hasShown=true:c.hasShown=false;}),this._settings.isCommentVisible&&(this.lastDrawTime=this.timeSource.now(),this.draw());},Fi=e=>{e.prototype.processFrame=Mi,e.prototype.handleAnimationFrame=Ei,e.prototype.handleVideoFrame=ki,e.prototype.shouldUseVideoFrameCallback=Ti,e.prototype.scheduleNextFrame=Ai,e.prototype.cancelAnimationFrameRequest=Vi,e.prototype.cancelVideoFrameCallback=Li,e.prototype.startAnimation=Ii,e.prototype.stopAnimation=Pi,e.prototype.onSeek=Ri;},vt=e=>e._settings.enableAutoHardReset,Q=(e,t)=>{!vt(e)||e.timeSource.now()-e.lastHardResetAt<e.autoHardResetDedupWindowMs||e.hardReset();},_i=e=>{vt(e)&&(e.initialPlaybackAutoResetTriggered||e.initialPlaybackAutoResetTimer===null&&(e.initialPlaybackAutoResetTimer=globalThis.setTimeout(()=>{e.initialPlaybackAutoResetTimer=null,vt(e)&&(e.initialPlaybackAutoResetTriggered=true,Q(e));},e.initialPlaybackAutoResetDelayMs)));},tt=e=>{e.initialPlaybackAutoResetTimer!==null&&(globalThis.clearTimeout(e.initialPlaybackAutoResetTimer),e.initialPlaybackAutoResetTimer=null),e.initialPlaybackAutoResetTriggered=false;},Di=function(e,t){if(e)return e;if(t.parentElement)return t.parentElement;if(typeof document<"u"&&document.body)return document.body;throw new Error("Cannot resolve container element. Provide container explicitly when DOM is unavailable.")},Hi=function(e){if(typeof getComputedStyle=="function"){getComputedStyle(e).position==="static"&&(e.style.position="relative");return}e.style.position||(e.style.position="relative");},Oi=function(e){try{this.destroyCanvasOnly();const t=e instanceof HTMLVideoElement?e:e.video,n=e instanceof HTMLVideoElement?e.parentElement:e.container??e.video.parentElement,i=this.resolveContainer(n??null,t);this.videoElement=t,this.containerElement=i,this.lastVideoSource=this.getCurrentVideoSource(),this.duration=Number.isFinite(t.duration)?R(t.duration):0,this.currentTime=R(t.currentTime),this.playbackRate=t.playbackRate,this.isPlaying=!t.paused,this.isStalled=!1,this.lastDrawTime=this.timeSource.now(),this.playbackHasBegun=this.isPlaying||this.currentTime>z,this.skipDrawingForCurrentFrame=this.shouldSuppressRendering();const r=this.createCanvasElement(),s=r.getContext("2d");if(!s)throw new Error("Failed to acquire 2D canvas context");r.style.position="absolute",r.style.top="0",r.style.left="0",r.style.pointerEvents="none",r.style.zIndex="1000";const a=this.containerElement;a instanceof HTMLElement&&(this.ensureContainerPositioning(a),a.appendChild(r)),this.canvas=r,this.ctx=s,this.resize(),this.calculateLaneMetrics(),this.setupVideoEventListeners(t),this.setupResizeHandling(t),this.setupFullscreenHandling(),this.setupVideoChangeDetection(t,i),this.startAnimation(),this.setupVisibilityHandling();}catch(t){throw this.log.error("CommentRenderer.initialize",t),t}},Ni=function(){this.stopAnimation(),this.cleanupResizeHandling(),this.runCleanupTasks(),tt(this),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.videoElement=null,this.containerElement=null,this.comments.length=0,this.activeComments.clear(),this.reservedLanes.clear(),this.resetFinalPhaseState(),this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1,this.commentSequence=0,this.playbackHasBegun=false,this.skipDrawingForCurrentFrame=false,this.isStalled=false,this.pendingInitialSync=false;},zi=function(){this.stopAnimation(),tt(this),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1,this.fullscreenActive=false;},$i=e=>{e.prototype.resolveContainer=Di,e.prototype.ensureContainerPositioning=Hi,e.prototype.initialize=Oi,e.prototype.destroy=Ni,e.prototype.destroyCanvasOnly=zi;},Wi=function(e){try{const t=()=>{const u=this.isPlaying;this.isPlaying=!0,this.playbackHasBegun=!0;const p=this.timeSource.now();this.lastDrawTime=p,this.lastPlayResumeTime=p,this.comments.forEach(m=>{m.lastUpdateTime=p,m.isPaused=!1;}),u||Q(this,"play-resume"),_i(this);},n=()=>{this.isPlaying=!1;const u=this.timeSource.now();this.comments.forEach(p=>{p.lastUpdateTime=u,p.isPaused=!0;});},i=()=>{this.onSeek();},r=()=>{this.onSeek(),Q(this,"seeked");},s=()=>{this.playbackRate=e.playbackRate;const u=this.timeSource.now();this.comments.forEach(p=>{p.lastUpdateTime=u;});},a=()=>{this.handleVideoMetadataLoaded(e);},o=()=>{this.duration=Number.isFinite(e.duration)?R(e.duration):0;},l=()=>{this.handleVideoSourceChange();},d=()=>{this.handleVideoStalled();},h=()=>{this.handleVideoCanPlay();},c=()=>{this.handleVideoCanPlay();};e.addEventListener("play",t),e.addEventListener("pause",n),e.addEventListener("seeking",i),e.addEventListener("seeked",r),e.addEventListener("ratechange",s),e.addEventListener("loadedmetadata",a),e.addEventListener("durationchange",o),e.addEventListener("emptied",l),e.addEventListener("waiting",d),e.addEventListener("canplay",h),e.addEventListener("playing",c),this.addCleanup(()=>e.removeEventListener("play",t)),this.addCleanup(()=>e.removeEventListener("pause",n)),this.addCleanup(()=>e.removeEventListener("seeking",i)),this.addCleanup(()=>e.removeEventListener("seeked",r)),this.addCleanup(()=>e.removeEventListener("ratechange",s)),this.addCleanup(()=>e.removeEventListener("loadedmetadata",a)),this.addCleanup(()=>e.removeEventListener("durationchange",o)),this.addCleanup(()=>e.removeEventListener("emptied",l)),this.addCleanup(()=>e.removeEventListener("waiting",d)),this.addCleanup(()=>e.removeEventListener("canplay",h)),this.addCleanup(()=>e.removeEventListener("playing",c));}catch(t){throw this.log.error("CommentRenderer.setupVideoEventListeners",t),t}},qi=function(e){this.lastVideoSource=this.getCurrentVideoSource(),this.incrementEpoch("metadata-loaded"),this.handleVideoSourceChange(e),this.resize(),this.calculateLaneMetrics(),this.hardReset(),this.onSeek(),this.emitStateSnapshot("metadata-loaded"),tt(this);},Bi=function(){const e=this.canvas,t=this.ctx;if(!e||!t)return;this.isStalled=true;const n=this.canvasDpr>0?this.canvasDpr:1,i=this.displayWidth>0?this.displayWidth:e.width/n,r=this.displayHeight>0?this.displayHeight:e.height/n;t.clearRect(0,0,i,r),this.comments.forEach(s=>{s.isActive&&(s.lastUpdateTime=this.timeSource.now());});},Ui=function(){this.isStalled&&(this.isStalled=false,this.videoElement&&(this.currentTime=R(this.videoElement.currentTime),this.isPlaying=!this.videoElement.paused),this.lastDrawTime=this.timeSource.now());},Gi=function(e){const t=e??this.videoElement;if(!t){this.lastVideoSource=null,this.isPlaying=false,this.resetFinalPhaseState(),this.resetCommentActivity(),tt(this);return}const n=this.getCurrentVideoSource();n!==this.lastVideoSource&&(this.lastVideoSource=n,this.incrementEpoch("source-change"),this.syncVideoState(t),this.resetFinalPhaseState(),this.resetCommentActivity(),this.emitStateSnapshot("source-change"),tt(this));},Ki=function(e){this.duration=Number.isFinite(e.duration)?R(e.duration):0,this.currentTime=R(e.currentTime),this.playbackRate=e.playbackRate,this.isPlaying=!e.paused,this.isStalled=false,this.playbackHasBegun=this.isPlaying||this.currentTime>z,this.lastDrawTime=this.timeSource.now();},Yi=function(){const e=this.timeSource.now(),t=this.canvas,n=this.ctx;if(this.resetFinalPhaseState(),this.skipDrawingForCurrentFrame=false,this.isStalled=false,this.pendingInitialSync=false,this.playbackHasBegun=this.isPlaying||this.currentTime>z,t&&n){const i=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:t.width/i,s=this.displayHeight>0?this.displayHeight:t.height/i;n.clearRect(0,0,r,s);}this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.comments.forEach(i=>{i.isActive=false,i.isPaused=!this.isPlaying,i.hasShown=false,i.lane=-1,i.x=i.virtualStartX,i.speed=i.baseSpeed,i.lastUpdateTime=e,i.clearActivation();}),this.activeComments.clear();},ji=function(e,t){if(typeof MutationObserver>"u"){this.log.debug("MutationObserver is not available in this environment. Video change detection is disabled.");return}const n=new MutationObserver(r=>{for(const s of r){if(s.type==="attributes"&&s.attributeName==="src"){const a=s.target;let o=null,l=null;if((a instanceof HTMLVideoElement||a instanceof HTMLSourceElement)&&(o=typeof s.oldValue=="string"?s.oldValue:null,l=a.getAttribute("src")),o===l)continue;this.handleVideoSourceChange(e);return}if(s.type==="childList"){for(const a of s.addedNodes)if(a instanceof HTMLSourceElement){this.handleVideoSourceChange(e);return}for(const a of s.removedNodes)if(a instanceof HTMLSourceElement){this.handleVideoSourceChange(e);return}}}});n.observe(e,{attributes:true,attributeFilter:["src"],attributeOldValue:true,childList:true,subtree:true}),this.addCleanup(()=>n.disconnect());const i=new MutationObserver(r=>{for(const s of r)if(s.type==="childList"){for(const a of s.addedNodes){const o=this.extractVideoElement(a);if(o&&o!==this.videoElement){this.initialize(o);return}}for(const a of s.removedNodes){if(a===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}if(a instanceof Element){const o=a.querySelector("video");if(o&&o===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}}}}});i.observe(t,{childList:true,subtree:true}),this.addCleanup(()=>i.disconnect());},Xi=function(e){if(e instanceof HTMLVideoElement)return e;if(e instanceof Element){const t=e.querySelector("video");if(t instanceof HTMLVideoElement)return t}return null},Ji=e=>{e.prototype.setupVideoEventListeners=Wi,e.prototype.handleVideoMetadataLoaded=qi,e.prototype.handleVideoStalled=Bi,e.prototype.handleVideoCanPlay=Ui,e.prototype.handleVideoSourceChange=Gi,e.prototype.syncVideoState=Ki,e.prototype.resetCommentActivity=Yi,e.prototype.setupVideoChangeDetection=ji,e.prototype.extractVideoElement=Xi;},Zi=function(){if(typeof document>"u"||typeof document.addEventListener!="function"||typeof document.removeEventListener!="function")return;const e=()=>{if(document.visibilityState!=="visible"){this.stopAnimation();return}this._settings.isCommentVisible&&(this.handleVisibilityRestore(),this.startAnimation());};document.addEventListener("visibilitychange",e),this.addCleanup(()=>document.removeEventListener("visibilitychange",e)),document.visibilityState!=="visible"&&this.stopAnimation();},Qi=function(){const e=this.canvas,t=this.ctx,n=this.videoElement;!e||!t||!n||(this.currentTime=R(n.currentTime),this.lastDrawTime=this.timeSource.now(),this.isPlaying=!n.paused,this.isStalled=false,this.pendingInitialSync=true,this.resetFinalPhaseState(),this.updatePlaybackProgressState(),Q(this),this.draw());},tr=e=>{e.prototype.setupVisibilityHandling=Zi,e.prototype.handleVisibilityRestore=Qi;},er=function(e,t){const n=this.videoElement,i=this.canvas,r=this.ctx;if(!n||!i)return;const s=n.getBoundingClientRect(),a=this.canvasDpr>0?this.canvasDpr:1,o=this.displayWidth>0?this.displayWidth:i.width/a,l=this.displayHeight>0?this.displayHeight:i.height/a,d=e??s.width??o,h=t??s.height??l;if(!Number.isFinite(d)||!Number.isFinite(h)||d<=0||h<=0)return;const c=Math.max(1,Math.floor(d)),u=Math.max(1,Math.floor(h)),p=this.displayWidth>0?this.displayWidth:c,m=this.displayHeight>0?this.displayHeight:u,g=this._settings.useDprScaling?this.resolveDevicePixelRatio():1,f=Math.max(1,Math.round(c*g)),x=Math.max(1,Math.round(u*g));if(!(this.displayWidth!==c||this.displayHeight!==u||Math.abs(this.canvasDpr-g)>Number.EPSILON||i.width!==f||i.height!==x))return;this.displayWidth=c,this.displayHeight=u,this.canvasDpr=g,i.width=f,i.height=x,i.style.width=`${c}px`,i.style.height=`${u}px`,r&&(r.setTransform(1,0,0,1,0,0),this._settings.useDprScaling&&r.scale(g,g));const S=p>0?c/p:1,C=m>0?u/m:1;(S!==1||C!==1)&&this.comments.forEach(w=>{w.isActive&&(w.x*=S,w.y*=C,w.width*=S,w.fontSize=Math.max(se,Math.floor(Math.max(1,w.fontSize)*C)),w.height=w.fontSize,w.virtualStartX*=S,w.exitThreshold*=S,w.baseSpeed*=S,w.speed*=S,w.speedPixelsPerMs*=S,w.bufferWidth*=S,w.reservationWidth*=S);}),this.calculateLaneMetrics(),Q(this);},nr=function(){if(typeof window>"u")return 1;const e=Number(window.devicePixelRatio);return !Number.isFinite(e)||e<=0?1:e},ir=function(){const e=this.canvas;if(!e)return;const t=this.displayHeight>0?this.displayHeight:e.height/Math.max(this.canvasDpr,1),n=Math.max(se,Math.floor(t*.05));this.laneHeight=n*1.2;const i=Math.floor(t/Math.max(this.laneHeight,1));if(this._settings.useFixedLaneCount){const r=Number.isFinite(this._settings.fixedLaneCount)?Math.floor(this._settings.fixedLaneCount):re,s=Math.max(Ft,Math.min(i,r));this.laneCount=s;}else this.laneCount=Math.max(Ft,i);this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0;},rr=function(e){if(this.cleanupResizeHandling(),this._settings.useContainerResizeObserver&&this.isResizeObserverAvailable){const t=this.resolveResizeObserverTarget(e),n=new ResizeObserver(i=>{for(const r of i){const{width:s,height:a}=r.contentRect;s>0&&a>0?this.resize(s,a):this.resize();}});n.observe(t),this.resizeObserver=n,this.resizeObserverTarget=t;}else if(typeof window<"u"&&typeof window.addEventListener=="function"){const t=()=>{this.resize();};window.addEventListener("resize",t),this.addCleanup(()=>window.removeEventListener("resize",t));}else this.log.debug("Resize handling is disabled because neither ResizeObserver nor window APIs are available.");},sr=function(){this.resizeObserver&&this.resizeObserverTarget&&this.resizeObserver.unobserve(this.resizeObserverTarget),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.resizeObserverTarget=null;},ar=e=>{e.prototype.resize=er,e.prototype.resolveDevicePixelRatio=nr,e.prototype.calculateLaneMetrics=ir,e.prototype.setupResizeHandling=rr,e.prototype.cleanupResizeHandling=sr;},or=function(){if(typeof document>"u"||typeof document.addEventListener!="function"||typeof document.removeEventListener!="function")return;const e=()=>{this.handleFullscreenChange();};["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].forEach(t=>{document.addEventListener(t,e),this.addCleanup(()=>document.removeEventListener(t,e));}),this.handleFullscreenChange();},lr=function(e){return this.resolveFullscreenContainer(e)||(e.parentElement??e)},cr=async function(){const e=this.canvas,t=this.videoElement;if(!e||!t)return;const n=this.containerElement??t.parentElement??null,i=this.getFullscreenElement(),r=this.resolveActiveOverlayContainer(t,n,i);if(!(r instanceof HTMLElement))return;e.parentElement!==r?(this.ensureContainerPositioning(r),r.appendChild(e)):this.ensureContainerPositioning(r);const s=(i instanceof HTMLElement&&i.contains(t)?i:null)!==null;this.fullscreenActive!==s&&(this.fullscreenActive=s,this.setupResizeHandling(t)),e.style.position="absolute",e.style.top="0",e.style.left="0",this.resize();},dr=function(e){const t=this.getFullscreenElement();return t instanceof HTMLElement&&(t===e||t.contains(e))?t:null},hr=function(e,t,n){return n instanceof HTMLElement&&n.contains(e)?n instanceof HTMLVideoElement&&t instanceof HTMLElement?t:n:t??null},ur=function(){if(typeof document>"u")return null;const e=document;return document.fullscreenElement??e.webkitFullscreenElement??e.mozFullScreenElement??e.msFullscreenElement??null},pr=e=>{e.prototype.setupFullscreenHandling=or,e.prototype.resolveResizeObserverTarget=lr,e.prototype.handleFullscreenChange=cr,e.prototype.resolveFullscreenContainer=dr,e.prototype.resolveActiveOverlayContainer=hr,e.prototype.getFullscreenElement=ur;},mr=function(e){this.cleanupTasks.push(e);},gr=function(){for(;this.cleanupTasks.length>0;){const e=this.cleanupTasks.pop();try{e?.();}catch(t){this.log.error("CommentRenderer.cleanupTask",t);}}},fr=e=>{e.prototype.addCleanup=mr,e.prototype.runCleanupTasks=gr;};class E{_settings;comments=[];activeComments=new Set;reservedLanes=new Map;topStaticLaneReservations=[];bottomStaticLaneReservations=[];log;timeSource;animationFrameProvider;createCanvasElement;commentDependencies;settingsVersion=0;normalizedNgWords=[];compiledNgRegexps=[];canvas=null;ctx=null;videoElement=null;containerElement=null;fullscreenActive=false;laneCount=re;laneHeight=0;displayWidth=0;displayHeight=0;canvasDpr=1;currentTime=0;duration=0;playbackRate=1;isPlaying=true;isStalled=false;lastDrawTime=0;finalPhaseActive=false;finalPhaseStartTime=null;finalPhaseScheduleDirty=false;playbackHasBegun=false;skipDrawingForCurrentFrame=false;pendingInitialSync=false;finalPhaseVposOverrides=new Map;frameId=null;videoFrameHandle=null;resizeObserver=null;resizeObserverTarget=null;isResizeObserverAvailable=typeof ResizeObserver<"u";cleanupTasks=[];commentSequence=0;epochId=0;eventHooks;lastSnapshotEmitTime=0;snapshotEmitThrottleMs=1e3;lastPlayResumeTime=0;playResumeSeekIgnoreDurationMs=500;lastVideoSource=null;lastHardResetAt=0;autoHardResetDedupWindowMs=tn;initialPlaybackAutoResetDelayMs=en;initialPlaybackAutoResetTimer=null;initialPlaybackAutoResetTriggered=false;rebuildNgMatchers(){pe.call(this);}constructor(t=null,n=void 0){let i,r;if(Cn(t))i=nt({...t}),r=n??{};else {const s=t??n??{};r=typeof s=="object"?s:{},i=nt(he());}this._settings=nt(i),this.timeSource=r.timeSource??ie(),this.animationFrameProvider=r.animationFrameProvider??Sn(this.timeSource),this.createCanvasElement=r.createCanvasElement??wn(),this.commentDependencies={timeSource:this.timeSource,settingsVersion:this.settingsVersion},this.log=ae(r.loggerNamespace??"CommentRenderer"),this.eventHooks=r.eventHooks??{},this.handleAnimationFrame=this.handleAnimationFrame.bind(this),this.handleVideoFrame=this.handleVideoFrame.bind(this),this.rebuildNgMatchers(),r.debug&&ln(r.debug);}get settings(){return this._settings}set settings(t){this._settings=nt(t),this.settingsVersion+=1,this.commentDependencies.settingsVersion=this.settingsVersion,this.rebuildNgMatchers();}getVideoElement(){return this.videoElement}getCurrentVideoSource(){const t=this.videoElement;if(!t)return null;if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const n=t.getAttribute("src");if(n&&n.length>0)return n;const i=t.querySelector("source[src]");return i&&typeof i.src=="string"?i.src:null}getCommentsSnapshot(){return [...this.comments]}}Vn(E);On(E);$n(E);Un(E);jn(E);ri(E);di(E);xi(E);Ci(E);Fi(E);$i(E);Ji(E);tr(E);ar(E);pr(E);fr(E);const $=()=>({...he(),enableAutoHardReset:true}),br="v6.13.0";var yr=typeof GM_addStyle<"u"?GM_addStyle:void 0,it=typeof GM_getValue<"u"?GM_getValue:void 0,rt=typeof GM_setValue<"u"?GM_setValue:void 0,vr=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0;const zt="settings",$t="currentVideo",Wt="lastDanimeIds",qt="playbackSettings",xr=e=>({...e,ngWords:[...e.ngWords],ngRegexps:[...e.ngRegexps]}),Y={fixedModeEnabled:false,fixedRate:1.11},st=e=>({fixedModeEnabled:e.fixedModeEnabled,fixedRate:e.fixedRate});class Et{constructor(t){this.notifier=t,this.settings=$(),this.currentVideo=null,this.loadSettings(),this.currentVideo=this.loadVideoData(),this.playbackSettings=st(Y),this.loadPlaybackSettings();}settings;currentVideo;observers=new Set;playbackSettings;playbackObservers=new Set;getSettings(){return xr(this.settings)}loadSettings(){try{const t=it(zt,null);if(!t)return this.settings=$(),this.settings;if(typeof t=="string"){const n=JSON.parse(t);this.settings={...$(),...n,ngWords:Array.isArray(n?.ngWords)?[...n.ngWords]:[],ngRegexps:Array.isArray(n?.ngRegexps)?[...n.ngRegexps]:[]};}else this.settings={...$(),...t,ngWords:Array.isArray(t.ngWords)?[...t.ngWords]:[],ngRegexps:Array.isArray(t.ngRegexps)?[...t.ngRegexps]:[]};return this.notifyObservers(),this.settings}catch(t){return console.error("[SettingsManager] 設定の読み込みに失敗しました",t),this.notify("設定の読み込みに失敗しました","error"),this.settings=$(),this.settings}}getPlaybackSettings(){return st(this.playbackSettings)}loadPlaybackSettings(){try{const t=it(qt,null);if(!t)return this.playbackSettings=st(Y),this.notifyPlaybackObservers(),this.playbackSettings;if(typeof t=="string"){const n=JSON.parse(t);this.playbackSettings={fixedModeEnabled:typeof n.fixedModeEnabled=="boolean"?n.fixedModeEnabled:Y.fixedModeEnabled,fixedRate:typeof n.fixedRate=="number"?n.fixedRate:Y.fixedRate};}else this.playbackSettings={fixedModeEnabled:t.fixedModeEnabled,fixedRate:t.fixedRate};return this.notifyPlaybackObservers(),this.playbackSettings}catch(t){return console.error("[SettingsManager] 再生設定の読み込みに失敗しました",t),this.notify("再生設定の読み込みに失敗しました","error"),this.playbackSettings=st(Y),this.notifyPlaybackObservers(),this.playbackSettings}}updatePlaybackSettings(t){return this.playbackSettings={...this.playbackSettings,...t},this.savePlaybackSettings()}savePlaybackSettings(){try{return rt(qt,JSON.stringify(this.playbackSettings)),this.notifyPlaybackObservers(),!0}catch(t){return console.error("[SettingsManager] 再生設定の保存に失敗しました",t),this.notify("再生設定の保存に失敗しました","error"),false}}saveSettings(){try{return rt(zt,JSON.stringify(this.settings)),this.notifyObservers(),this.notify("設定を保存しました","success"),!0}catch(t){return console.error("[SettingsManager] 設定の保存に失敗しました",t),this.notify("設定の保存に失敗しました","error"),false}}updateSettings(t){return this.settings={...this.settings,...t,ngWords:t.ngWords?[...t.ngWords]:[...this.settings.ngWords??[]],ngRegexps:t.ngRegexps?[...t.ngRegexps]:[...this.settings.ngRegexps??[]]},this.saveSettings()}addObserver(t){this.observers.add(t);}removeObserver(t){this.observers.delete(t);}addPlaybackObserver(t){this.playbackObservers.add(t);try{t(this.getPlaybackSettings());}catch(n){console.error("[SettingsManager] 再生設定の登録通知でエラー",n);}}removePlaybackObserver(t){this.playbackObservers.delete(t);}notifyObservers(){const t=this.getSettings();for(const n of this.observers)try{n(t);}catch(i){console.error("[SettingsManager] 設定変更通知でエラー",i);}}notifyPlaybackObservers(){const t=this.getPlaybackSettings();for(const n of this.playbackObservers)try{n(t);}catch(i){console.error("[SettingsManager] 再生設定通知でエラー",i);}}loadVideoData(){try{return it($t,null)??null}catch(t){return console.error("[SettingsManager] 動画データの読み込みに失敗しました",t),this.notify("動画データの読み込みに失敗しました","error"),null}}saveVideoData(t,n){try{const i={videoId:n.videoId,title:n.title,viewCount:n.viewCount,commentCount:n.commentCount,mylistCount:n.mylistCount,postedAt:n.postedAt,thumbnail:n.thumbnail,owner:n.owner??null,channel:n.channel??null};return rt($t,i),this.currentVideo=i,!0}catch(i){return console.error("[SettingsManager] 動画データの保存に失敗しました",i),this.notify("動画データの保存に失敗しました","error"),false}}getCurrentVideo(){return this.currentVideo?{...this.currentVideo}:null}saveLastDanimeIds(t){try{return rt(Wt,t),!0}catch(n){return console.error("[SettingsManager] saveLastDanimeIds failed",n),this.notify("ID情報の保存に失敗しました","error"),false}}loadLastDanimeIds(){try{return it(Wt,null)??null}catch(t){return console.error("[SettingsManager] loadLastDanimeIds failed",t),this.notify("ID情報の読込に失敗しました","error"),null}}notify(t,n="info"){this.notifier?.show(t,n);}}const Sr=new Set(["INPUT","TEXTAREA"]),gt=e=>e.length===1?e.toUpperCase():e,wr=e=>e?`${e}+`:"";class me{shortcuts=new Map;boundHandler;isEnabled=true;isListening=false;constructor(){this.boundHandler=this.handleKeyDown.bind(this);}addShortcut(t,n,i){const r=this.createShortcutKey(gt(t),n);this.shortcuts.set(r,i);}removeShortcut(t,n){const i=this.createShortcutKey(gt(t),n);this.shortcuts.delete(i);}startListening(){this.isListening||(document.addEventListener("keydown",this.boundHandler,false),this.isListening=true);}stopListening(){this.isListening&&(document.removeEventListener("keydown",this.boundHandler,false),this.isListening=false);}setEnabled(t){this.isEnabled=t;}createShortcutKey(t,n){return `${wr(n)}${t}`}extractModifier(t){const n=[];return t.ctrlKey&&n.push("Ctrl"),t.altKey&&n.push("Alt"),t.shiftKey&&n.push("Shift"),t.metaKey&&n.push("Meta"),n.length>0?n.join("+"):null}handleKeyDown(t){if(!this.isEnabled)return;const i=t.target?.tagName??"";if(Sr.has(i))return;const r=this.extractModifier(t),s=this.createShortcutKey(gt(t.key),r),a=this.shortcuts.get(s);a&&(t.preventDefault(),a());}}const Cr=N("dAnime:CommentRenderer"),Bt=e=>({loggerNamespace:"dAnime:CommentRenderer",...e??{}}),Mr=e=>{if(!e||typeof e!="object")return  false;const t=e;return typeof t.commentColor=="string"&&typeof t.commentOpacity=="number"&&typeof t.isCommentVisible=="boolean"};class ge{renderer;keyboardHandler=null;constructor(t,n){Mr(t)||t===null?this.renderer=new E(t??null,Bt(n)):this.renderer=new E(Bt(t));}get settings(){return this.renderer.settings}set settings(t){this.renderer.settings=t;}initialize(t){this.renderer.initialize(t),this.setupKeyboardShortcuts();}addComment(t,n,i=[]){return this.renderer.addComment(t,n,i)}clearComments(){this.renderer.clearComments();}resetState(){this.renderer.resetState();}hardReset(){this.renderer.hardReset();}destroy(){this.teardownKeyboardShortcuts(),this.renderer.destroy();}updateSettings(t){this.renderer.updateSettings(t);}getVideoElement(){return this.renderer.getVideoElement()}getCurrentVideoSource(){return this.renderer.getCurrentVideoSource()}getCommentsSnapshot(){return this.renderer.getCommentsSnapshot()}isNGComment(t){return this.renderer.isNGComment(t)}resize(t,n){this.renderer.resize(t,n);}setupKeyboardShortcuts(){this.teardownKeyboardShortcuts();const t=new me;t.addShortcut("C","Shift",()=>{try{const n=this.renderer.settings,i={...n,isCommentVisible:!n.isCommentVisible};this.renderer.updateSettings(i),this.syncGlobalSettings(i);}catch(n){Cr.error("CommentRenderer.keyboardShortcut",n);}}),t.startListening(),this.keyboardHandler=t;}teardownKeyboardShortcuts(){this.keyboardHandler?.stopListening(),this.keyboardHandler=null;}syncGlobalSettings(t){window.dAniRenderer?.settingsManager?.updateSettings(t);}}class kt{shadowRoot=null;container=null;createShadowDOM(t,n={mode:"closed"}){if(!t)throw new Error("Host element is required for shadow DOM creation");return this.shadowRoot=t.attachShadow(n),this.container=document.createElement("div"),this.shadowRoot.appendChild(this.container),this.shadowRoot}addStyles(t){if(!this.shadowRoot)throw new Error("Shadow root not initialized");const n=document.createElement("style");n.textContent=t,this.shadowRoot.appendChild(n);}querySelector(t){return this.shadowRoot?this.shadowRoot.querySelector(t):null}querySelectorAll(t){return this.shadowRoot?this.shadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}setHTML(t){if(!this.container)throw new Error("Container not initialized");this.container.innerHTML=t;}destroy(){this.shadowRoot?.host&&this.shadowRoot.host.remove(),this.shadowRoot=null,this.container=null;}}const Er=`\r
/* 基本カラーパレット - ダークモード */\r
:host {\r
...
`;class ct extends kt{static FAB_HOST_ID="danime-settings-fab-host";settingsManager;fetcher;searcher;settings;playbackSettings;currentVideoInfo;hostElement=null;lastAutoButtonElement=null;activeTab="search";modalElement=null;overlayElement=null;closeButtonElement=null;fabElement=null;fabHostElement=null;fabShadowRoot=null;handleFabClick=t=>{t.preventDefault(),this.openSettingsModal();};handleOverlayClick=()=>{this.closeSettingsModal();};handleCloseClick=()=>{this.closeSettingsModal();};handlePlaybackSettingsChanged;constructor(t,n=new Tt,i=new xe){super(),this.settingsManager=t,this.fetcher=n,this.searcher=i,this.settings=this.settingsManager.getSettings(),this.playbackSettings=this.settingsManager.getPlaybackSettings(),this.currentVideoInfo=this.settingsManager.loadVideoData(),this.handlePlaybackSettingsChanged=r=>{this.playbackSettings=r,this.applyPlaybackSettingsToUI();},this.settingsManager.addPlaybackObserver(this.handlePlaybackSettingsChanged);}insertIntoMypage(){const t=document.querySelector(A.mypageHeaderTitle);t&&(this.hostElement=this.createSettingsUI(),t.parentElement?.insertBefore(this.hostElement,t.nextSibling),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(n){console.warn("[SettingsUI] restore failed:",n);}}));}addAutoCommentButtons(){document.querySelectorAll(A.mypageItem).forEach(n=>{const i=n.querySelector(A.mypageItemTitle);if(!i||i.querySelector(".auto-comment-button-host"))return;const r=i.querySelector("span")?.textContent?.trim()??"",s=n.querySelector(A.mypageEpisodeNumber)?.textContent?.trim()??"",a=n.querySelector(A.mypageEpisodeTitle)?.textContent?.trim()??"",o=document.createElement("div");o.className="nico-comment-shadow-host auto-comment-button-host",o.style.cssText="position:absolute;left:150px;top:3px;margin-left:8px;";const l=o.attachShadow({mode:"closed"}),d=document.createElement("style");d.textContent=J.getAutoButtonStyles(),l.appendChild(d);const h=document.createElement("button");h.className="auto-comment-button",h.innerHTML=bt,h.setAttribute("aria-label","コメント設定"),h.setAttribute("title","コメント設定"),h.setAttribute("type","button"),h.addEventListener("click",async c=>{c.preventDefault(),c.stopPropagation(),c.stopImmediatePropagation();try{const u=[r,s,a].filter(Boolean).join(" ");this.openSettingsModal(!1),this.setSearchKeyword(u),this.lastAutoButtonElement=o;try{const m=n.querySelector('input[name="workId"]')?.value?.trim()??"",g=n.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),f=n.querySelector('a.textContainer[href*="partId="]');let x="";const C=(g?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);C?x=C[1]:f?.href&&(x=(new URL(f.href,location.origin).searchParams.get("partId")??"").trim()),m&&x&&this.settingsManager.saveLastDanimeIds({workId:m,partId:x});}catch(m){console.warn("[SettingsUI] save (workId, partId) skipped:",m);}const p=await this.executeSearch(u);if(p.length===0)return;await this.applySearchResult(p[0]);}catch(u){q.error("SettingsUI.autoCommentButton",u);}}),l.appendChild(h),i.appendChild(o),this.lastAutoButtonElement=o;}),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(n){console.warn("[SettingsUI] restore failed:",n);}});}async waitMypageListStable(){const t=document.querySelector(A.mypageListContainer);if(!t)return;let n=t.querySelectorAll(A.mypageItem).length;const i=Date.now()+1500;return new Promise(r=>{const s=new MutationObserver(()=>{const a=t.querySelectorAll(A.mypageItem).length;if(a!==n){n=a;return}Date.now()>=i&&(s.disconnect(),r());});s.observe(t,{childList:true,subtree:true}),setTimeout(()=>{try{s.disconnect();}catch(a){q.debug("waitMypageListStable: observer already disconnected",a);}r();},1600);})}tryRestoreByDanimeIds(){const t=this.settingsManager.loadLastDanimeIds();if(!t)return  false;const n=Array.from(document.querySelectorAll(A.mypageItem));for(const i of n){if(i.querySelector('input[name="workId"]')?.value?.trim()!==t.workId)continue;const s=i.querySelector('a.textContainer[href*="partId="]'),a=s?.href?(new URL(s.href,location.origin).searchParams.get("partId")??"")===t.partId:false,o=i.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),l=(()=>{const h=(o?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);return !!h&&h[1]===t.partId})();if(a||l){const d=i.querySelector(".auto-comment-button-host")??i;return this.lastAutoButtonElement=d,this.updatePlayButtonState(this.currentVideoInfo),true}}return  false}createSettingsUI(){const t=document.createElement("div");t.className="nico-comment-shadow-host settings-host",this.createShadowDOM(t),this.addStyles(J.getCommonStyles());const n=this.buildSettingsHtml();return this.setHTML(n),this.applySettingsToUI(),this.addStyles(Zt),this.setupEventListeners(),t}buildSettingsHtml(){const t=r=>typeof r=="number"?r.toLocaleString():"-",n=r=>{if(!r)return "-";try{return new Date(r).toLocaleDateString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return r}},i=this.currentVideoInfo;return `
      <div class="nico-comment-settings">
        <h2>
          <span class="settings-title">d-anime-nico-comment-renderer</span>
          <span class="version-badge" aria-label="バージョン">${br}</span>
        </h2>
          ...
          <div id="currentVideoInfo" class="current-video-info">
            ...
            <div class="info-container" role="list">
              ...
              <div class="info-item info-item--wide" role="listitem" title="タイトル">
                <span class="info-icon" aria-hidden="true">${Qr}</span>
              ...
              <div class="info-item info-item--wide" role="listitem" title="投稿者">
                <span class="info-icon" aria-hidden="true">${ts}</span>
              ...
              <div class="info-item" role="listitem" title="再生数">
                <span class="info-icon" aria-hidden="true">${es}</span>
        ...
        <div class="settings-modal__content">
          ...
          <div class="settings-modal__tabs" role="tablist">
            <button class="settings-modal__tab is-active" type="button" data-tab="search" role="tab" aria-selected="true" aria-controls="settingsPaneSearch" id="settingsTabSearch">
              <span class="settings-modal__tab-icon" aria-hidden="true">${bt}</span>
            ...
            <button class="settings-modal__tab" type="button" data-tab="display" role="tab" aria-selected="false" aria-controls="settingsPaneDisplay" id="settingsTabDisplay" tabindex="-1">
              <span class="settings-modal__tab-icon" aria-hidden="true">${Xr}</span>
            ...
            <button class="settings-modal__tab" type="button" data-tab="ng" role="tab" aria-selected="false" aria-controls="settingsPaneNg" id="settingsTabNg" tabindex="-1">
              <span class="settings-modal__tab-icon" aria-hidden="true">${Jr}</span>
...
`).map(r=>r.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings)?y.show("設定を保存しました","success"):y.show("設定の保存に失敗しました","error");}updateCurrentVideoInfo(t){this.currentVideoInfo=t,[["currentTitle",t.title??"-"],["currentVideoId",t.videoId??"-"],["currentOwner",t.owner?.nickname??t.channel?.name??"-"],["currentViewCount",this.formatNumber(t.viewCount)],["currentCommentCount",this.formatNumber(t.commentCount)],["currentMylistCount",this.formatNumber(t.mylistCount)],["currentPostedAt",this.formatSearchResultDate(t.postedAt)]].forEach(([r,s])=>{const a=this.querySelector(b[r]);a&&(a.textContent=s);});const i=this.querySelector(b.currentThumbnail);i&&t.thumbnail&&(i.src=t.thumbnail,i.alt=t.title??"サムネイル");try{this.settingsManager.saveVideoData(t.title??"",t);}catch(r){q.error("SettingsUI.updateCurrentVideoInfo",r);}this.updatePlayButtonState(t);}formatNumber(t){return typeof t=="number"?t.toLocaleString():"-"}formatSearchResultDate(t){if(!t)return "-";const n=new Date(t);return Number.isNaN(n.getTime())?t:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(n)}formatPlaybackRateLabel(t){return `${(Number.isFinite(t)?t:1.11).toFixed(2).replace(/\.?0+$/,"")}倍`}setupPlayButton(){const t=this.queryModalElement(b.playCurrentVideo);t&&(t.addEventListener("click",()=>{try{if(!this.currentVideoInfo?.videoId){y.show("再生できる動画が設定されていません","warning");return}const i=this.lastAutoButtonElement?.closest(".itemModule.list");if(this.lastAutoButtonElement){const r=i?.querySelector(".thumbnailContainer > a, .thumbnail-container > a");if(r){y.show(`「${this.currentVideoInfo?.title||"動画"}」を再生します...`,"success"),setTimeout(()=>{r.click();},300);return}}y.show("再生リンクが見つかりませんでした（対象アイテム内に限定して検索済み）","warning");}catch(n){q.error("SettingsUI.playCurrentVideo",n),y.show(`再生エラー: ${n.message}`,"error");}}),this.updatePlayButtonState(this.currentVideoInfo));}updatePlayButtonState(t){const n=this.queryModalElement(b.playCurrentVideo);if(!n)return;const i=!!t?.videoId;n.disabled=!i,n.setAttribute("aria-disabled",(!i).toString());}updateVisibilityToggleState(t){t.textContent=this.settings.isCommentVisible?"表示中":"非表示中",t.classList.toggle("off",!this.settings.isCommentVisible);}applyPlaybackSettingsToUI(){const t=this.queryModalElement(b.fixedPlaybackToggle);t&&this.updatePlaybackToggleState(t);}updatePlaybackToggleState(t){const n=this.playbackSettings.fixedModeEnabled;t.textContent=n?`${this.formatPlaybackRateLabel(this.playbackSettings.fixedRate)}固定中`:"標準速度",t.classList.toggle("off",!n),t.setAttribute("aria-pressed",n?"true":"false");}destroy(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),this.settingsManager.removePlaybackObserver(this.handlePlaybackSettingsChanged),super.destroy();}createOrUpdateFab(){if(!document.body)return null;let t=this.fabHostElement;!t||!t.isConnected?(t?.remove(),t=document.createElement("div"),t.id=ct.FAB_HOST_ID,t.style.position="fixed",t.style.bottom="32px",t.style.right="32px",t.style.zIndex="2147483646",t.style.display="inline-block",this.fabShadowRoot=t.attachShadow({mode:"open"}),document.body.appendChild(t),this.fabHostElement=t):this.fabShadowRoot||(this.fabShadowRoot=t.shadowRoot??t.attachShadow({mode:"open"}));const n=this.fabShadowRoot;if(!n)return null;let i=n.querySelector("style[data-role='fab-base-style']");i||(i=document.createElement("style"),i.dataset.role="fab-base-style",i.textContent=J.getCommonStyles(),n.appendChild(i));let r=n.querySelector("style[data-role='fab-style']");r||(r=document.createElement("style"),r.dataset.role="fab-style",r.textContent=`
      ...
      <span class="fab-button__icon" aria-hidden="true">${bt}</span>
      <span class="fab-button__label">設定</span>
    `,l.setAttribute("aria-label","ニコニココメント設定を開く"),l.setAttribute("aria-haspopup","dialog");let d=o.querySelector(b.settingsModal);return d||(o.insertAdjacentHTML("beforeend",this.buildModalHtml()),d=o.querySelector(b.settingsModal)),this.modalElement=d??null,l}removeFabElement(){this.fabElement&&this.fabElement.removeEventListener("click",this.handleFabClick),this.fabHostElement?.isConnected&&this.fabHostElement.remove(),this.fabElement=null,this.fabHostElement=null,this.fabShadowRoot=null;}queryModalElement(t){return this.fabShadowRoot?this.fabShadowRoot.querySelector(t):null}queryModalSelectorAll(t){return this.fabShadowRoot?this.fabShadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}}const ls=N("dAnime:PlaybackRateController"),cs=1,ds=200,hs=1e-4;class Ce{constructor(t){this.settingsManager=t,this.playbackSettings=this.settingsManager.getPlaybackSettings(),this.settingsObserver=n=>{this.playbackSettings=n,this.applyCurrentMode();},this.settingsManager.addPlaybackObserver(this.settingsObserver);}currentVideo=null;playbackSettings;settingsObserver;isApplying=false;retryTimer=null;handleLoadedMetadata=()=>{this.applyCurrentMode();};handleRateChange=()=>{this.isApplying||this.playbackSettings.fixedModeEnabled&&this.scheduleApply();};handlePlay=()=>{this.applyCurrentMode();};handleEmptied=()=>{this.scheduleApply();};bind(t){if(this.currentVideo===t){this.applyCurrentMode();return}this.detachVideoListeners(),this.cancelScheduledApply(),this.currentVideo=t,this.attachVideoListeners(t),this.applyCurrentMode();}unbind(){this.cancelScheduledApply(),this.detachVideoListeners(),this.currentVideo=null;}dispose(){this.unbind(),this.settingsManager.removePlaybackObserver(this.settingsObserver);}attachVideoListeners(t){t.addEventListener("loadedmetadata",this.handleLoadedMetadata),t.addEventListener("ratechange",this.handleRateChange),t.addEventListener("play",this.handlePlay),t.addEventListener("emptied",this.handleEmptied);}detachVideoListeners(){this.currentVideo&&(this.currentVideo.removeEventListener("loadedmetadata",this.handleLoadedMetadata),this.currentVideo.removeEventListener("ratechange",this.handleRateChange),this.currentVideo.removeEventListener("play",this.handlePlay),this.currentVideo.removeEventListener("emptied",this.handleEmptied));}applyCurrentMode(){const t=this.currentVideo;t&&(this.playbackSettings.fixedModeEnabled?this.setPlaybackRate(t,this.playbackSettings.fixedRate):this.setPlaybackRate(t,cs));}setPlaybackRate(t,n){if(!(!Number.isFinite(n)||n<=0)&&!(Math.abs(t.playbackRate-n)<=hs)){this.isApplying=true;try{t.playbackRate=n;}catch(i){ls.warn("再生速度の設定に失敗しました",i),this.scheduleApply();}finally{window.setTimeout(()=>{this.isApplying=false;},0);}}}scheduleApply(){this.cancelScheduledApply(),this.retryTimer=window.setTimeout(()=>{this.retryTimer=null,this.applyCurrentMode();},ds);}cancelScheduledApply(){this.retryTimer!==null&&(window.clearTimeout(this.retryTimer),this.retryTimer=null);}}const Qt=async()=>{},us=()=>{const e=St();if(!e.dAniRenderer){const t={};e.dAniRenderer={classes:{Comment:de,CommentRenderer:ge,NicoApiFetcher:Tt,NotificationManager:y,StyleManager:we,SettingsUI:ct,NicoVideoSearcher:xe,VideoSwitchHandler:Se,SettingsManager:Et,KeyboardShortcutHandler:me,DebounceExecutor:At,ShadowDOMComponent:kt,ShadowStyleManager:J,PlaybackRateController:Ce},instances:t,utils:{initialize:Qt,initializeWithVideo:Qt},debug:{showState:()=>{console.log("Current instances:",t);},showSettings:()=>{const n=t.settingsManager;if(!n){console.log("SettingsManager not initialized");return}console.log("Current settings:",n.getSettings());},showComments:()=>{const n=t.renderer;if(!n){console.log("CommentRenderer not initialized");return}console.log("Current comments:",n.getCommentsSnapshot());}},defaultSettings:$};}return e.dAniRenderer},ps=100,ms=1e3,gs=3e3;class fs{constructor(t){this.global=t;}initialized=false;switchDebounce=new At(ms);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;playbackRateController=null;async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement();}async ensureDocumentReady(){document.readyState!=="complete"&&await new Promise(t=>{window.addEventListener("load",()=>t(),{once:true});});}waitForVideoElement(){if(this.initialized)return;const t=document.querySelector(A.watchVideoElement);if(!t){window.setTimeout(()=>this.waitForVideoElement(),ps);return}if(t.readyState===0){t.addEventListener("loadedmetadata",()=>{this.initializeWithVideo(t);},{once:true});return}this.initializeWithVideo(t);}async initializeWithVideo(t){if(!this.initialized){this.initialized=true;try{y.show("コメントローダーを初期化中...");const n=y.getInstance(),i=this.global.settingsManager??new Et(n);this.global.settingsManager=i,this.global.instances.settingsManager=i;const r=i.loadVideoData();if(!r?.videoId)throw new Error("動画データが見つかりません。マイページで設定してください。");const s=new Tt;this.global.instances.fetcher=s,await s.fetchApiData(r.videoId);const a=await s.fetchComments(),o=this.mergeSettings(i.loadSettings()),l=new ge(o);l.initialize(t),this.global.instances.renderer=l,this.currentVideoElement=t;const d=this.playbackRateController??new Ce(i);this.playbackRateController=d,this.global.instances.playbackRateController=d,d.bind(t),i.addObserver(c=>{l.settings=this.mergeSettings(c);}),a.forEach(c=>{l.addComment(c.text,c.vposMs,c.commands);});const h=new Se(l,s,i);h.startMonitoring(),this.global.instances.switchHandler=h,this.setupSwitchHandling(t,h),this.observeVideoElement(),y.show(`コメントの読み込みが完了しました（${a.length}件）`,"success");}catch(n){throw this.initialized=false,y.show(`初期化エラー: ${n.message}`,"error"),n}}}mergeSettings(t){const n=$();return {...n,...t,ngWords:[...t.ngWords??n.ngWords],ngRegexps:[...t.ngRegexps??n.ngRegexps]}}setupSwitchHandling(t,n){this.currentVideoElement=t,this.switchCallback=()=>{const i=Date.now();if(i-this.lastSwitchTimestamp<gs)return;this.lastSwitchTimestamp=i;const r=this.currentVideoElement;n.onVideoSwitch(r);},this.global.utils.initializeWithVideo=async i=>{i&&(this.rebindVideoElement(i),this.playbackRateController?.bind(i),await n.onVideoSwitch(i));},this.currentVideoElement=t;}observeVideoElement(){const t=this.currentVideoElement;t&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{const n=document.querySelector(A.watchVideoElement);!n||n===this.currentVideoElement||this.rebindVideoElement(n);}),this.domMutationObserver.observe(document.body,{childList:true,subtree:true}),this.attachVideoEventListeners(t));}rebindVideoElement(t){this.detachVideoEventListeners(),this.currentVideoElement=t;const n=this.global.instances.renderer,i=this.global.instances.switchHandler;n&&(n.clearComments(),n.destroy(),n.initialize(t),n.resize()),this.playbackRateController?.bind(t),i&&(i.onVideoSwitch(t),this.setupSwitchHandling(t,i)),this.attachVideoEventListeners(t);}attachVideoEventListeners(t){this.detachVideoEventListeners();const n=()=>{this.switchCallback&&(this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));};t.addEventListener("ended",n),t.addEventListener("loadedmetadata",n),t.addEventListener("emptied",n),this.videoEndedListener=n;}detachVideoEventListeners(){const t=this.currentVideoElement;t&&this.videoEndedListener&&(t.removeEventListener("ended",this.videoEndedListener),t.removeEventListener("loadedmetadata",this.videoEndedListener),t.removeEventListener("emptied",this.videoEndedListener)),this.videoEndedListener=null;}}const bs=100;class ys{constructor(t){this.global=t;}initialize(){const t=y.getInstance(),n=this.global.settingsManager??new Et(t);this.global.settingsManager=n,this.global.instances.settingsManager=n;const i=new ct(n);this.waitForHeader(i);}waitForHeader(t){if(!document.querySelector(A.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(t),bs);return}t.insertIntoMypage(),t.addAutoCommentButtons(),this.observeList(t);}observeList(t){const n=document.querySelector(A.mypageListContainer);if(!n)return;new MutationObserver(()=>{try{t.addAutoCommentButtons();}catch(r){console.error("[MypageController] auto comment buttons update failed",r);}}).observe(n,{childList:true,subtree:true});}}class vs{log;global=us();watchController=null;mypageController=null;constructor(){this.log=N("DanimeApp");}start(){this.log.info("starting renderer"),we.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener("load",()=>{this.initialize();});}async initialize(){if(!this.acquireInstanceLock()){this.log.info("renderer already initialized, skipping");return}const t=location.pathname.toLowerCase();try{t.includes("/animestore/sc_d_pc")?(this.watchController=new fs(this.global),await this.watchController.initialize()):t.includes("/animestore/mp_viw_pc")?(this.mypageController=new ys(this.global),this.mypageController.initialize()):this.log.info("page not supported, initialization skipped");}catch(n){this.log.error("initialization failed",n);}}acquireInstanceLock(){const t=St();return t.__dAnimeNicoCommentRenderer2Instance=(t.__dAnimeNicoCommentRenderer2Instance??0)+1,t.__dAnimeNicoCommentRenderer2Instance===1}}const yt=N("dAnimeNicoCommentRenderer2");async function xs(){yt.info("bootstrap start");try{new vs().start(),yt.info("bootstrap completed");}catch(e){yt.error("bootstrap failed",e);}}xs();
