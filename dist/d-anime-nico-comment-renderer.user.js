...
(function () {
  ...
  const et={debug:"debug",info:"info",warn:"warn",error:"error"},M=a=>{const t=`[${a}]`,e={};return Object.keys(et).forEach(n=>{const r=et[n];e[n]=(...i)=>{(console[r]??console.log)(t,...i);};}),e};function Y(){return typeof unsafeWindow<"u"?unsafeWindow:window}const nt={debug:0,info:1,warn:2,error:3},Nt=(a,t,e)=>{const n=[`[${t}]`,...e];switch(a){case "debug":console.debug(...n);break;case "info":console.info(...n);break;case "warn":console.warn(...n);break;case "error":console.error(...n);break;default:console.log(...n);}},xt=(a,t={})=>{const{level:e="info",emitter:n=Nt}=t,r=nt[e],i=(s,o)=>{nt[s]<r||n(s,a,o);};return {debug:(...s)=>i("debug",s),info:(...s)=>i("info",s),warn:(...s)=>i("warn",s),error:(...s)=>i("error",s)}},Pt={small:.8,medium:1,big:1.4},Dt={defont:'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", "Hiragino Kaku Gothic ProN", "Hiragino Sans", "Noto Sans JP", "Yu Gothic UI", sans-serif',gothic:'"Noto Sans JP", "Yu Gothic", "Yu Gothic Medium", "Hiragino Kaku Gothic ProN", "Meiryo", "Segoe UI", sans-serif',mincho:'"Noto Serif JP", "Yu Mincho", "Hiragino Mincho ProN", "MS Mincho", "Times New Roman", serif'},wt={white:"#FFFFFF",red:"#FF0000",pink:"#FF8080",orange:"#FF9900",yellow:"#FFFF00",green:"#00FF00",cyan:"#00FFFF",blue:"#0000FF",purple:"#C000FF",black:"#000000",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},j=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,Ht=/^[,.:;]+/,qt=/[,.:;]+$/,$t=a=>{const t=a.trim();return t?j.test(t)?t:t.replace(Ht,"").replace(qt,""):""},Bt=a=>j.test(a)?a.toUpperCase():null,Wt=a=>a==="naka"||a==="ue"||a==="shita",Ut=a=>a==="small"||a==="medium"||a==="big",Gt=a=>a==="defont"||a==="gothic"||a==="mincho",Kt=a=>a in wt,Yt=(a,t)=>{let e="naka",n="medium",r="defont",i=null,s=1,o=null,l=false;for(const p of a){const b=$t(typeof p=="string"?p:"");if(!b)continue;if(j.test(b)){const w=Bt(b);if(w){i=w;continue}}const g=b.toLowerCase();if(Wt(g)){e=g;continue}if(Ut(g)){n=g;continue}if(Gt(g)){r=g;continue}if(Kt(g)){i=wt[g].toUpperCase();continue}if(g==="_live"){o=.5;continue}g==="invisible"&&(s=0,l=true);}const c=Math.max(0,Math.min(1,s)),d=(i??t.defaultColor).toUpperCase(),u=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:e,size:n,sizeScale:Pt[n],font:r,fontFamily:Dt[r],resolvedColor:d,colorOverride:i,opacityMultiplier:c,opacityOverride:u,isInvisible:l}},D=xt("CommentEngine:Comment"),T=4e3,jt=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,k=a=>!Number.isFinite(a)||a<=0?0:a>=1?1:a,z=a=>a.length===1?a.repeat(2):a,S=a=>Number.parseInt(a,16),Xt=(a,t)=>{const e=jt.exec(a);if(!e)return a;const n=e[1];let r,i,s,o=1;n.length===3||n.length===4?(r=S(z(n[0])),i=S(z(n[1])),s=S(z(n[2])),n.length===4&&(o=S(z(n[3]))/255)):(r=S(n.slice(0,2)),i=S(n.slice(2,4)),s=S(n.slice(4,6)),n.length===8&&(o=S(n.slice(6,8))/255));const l=k(o*k(t));return `rgba(${r}, ${i}, ${s}, ${l})`},Zt=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),St=()=>Zt();class Ct{text;vpos;commands;layout;isScrolling;sizeScale;opacityMultiplier;opacityOverride;colorOverride;isInvisible;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily;opacity;activationTimeMs=null;staticExpiryTimeMs=null;isActive=false;hasShown=false;isPaused=false;lastUpdateTime=0;reservationWidth=0;bufferWidth=0;visibleDurationMs=0;totalDurationMs=0;preCollisionDurationMs=0;speedPixelsPerMs=0;virtualStartX=0;timeSource;constructor(t,e,n,r,i={}){if(typeof t!="string")throw new Error("Comment text must be a string");if(!Number.isFinite(e)||e<0)throw new Error("Comment vpos must be a non-negative number");this.text=t,this.vpos=e,this.commands=Array.isArray(n)?[...n]:[];const s=Yt(this.commands,{defaultColor:r.commentColor});this.layout=s.layout,this.isScrolling=this.layout==="naka",this.sizeScale=s.sizeScale,this.opacityMultiplier=s.opacityMultiplier,this.opacityOverride=s.opacityOverride,this.colorOverride=s.colorOverride,this.isInvisible=s.isInvisible,this.fontFamily=s.fontFamily,this.color=s.resolvedColor,this.opacity=this.getEffectiveOpacity(r.commentOpacity),this.timeSource=i.timeSource??St(),this.syncWithSettings(r);}prepare(t,e,n,r){try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(e)||!Number.isFinite(n))throw new Error("Canvas dimensions must be numbers");if(!r)throw new Error("Prepare options are required");const i=Math.max(e,1),s=Math.max(24,Math.floor(n*.05)),o=Math.max(24,Math.floor(s*this.sizeScale));if(this.fontSize=o,t.font=`${this.fontSize}px ${this.fontFamily}`,this.width=t.measureText(this.text).width,this.height=this.fontSize,!this.isScrolling){this.bufferWidth=0;const F=Math.max((i-this.width)/2,0);this.virtualStartX=F,this.x=F,this.baseSpeed=0,this.speed=0,this.speedPixelsPerMs=0,this.visibleDurationMs=T,this.preCollisionDurationMs=T,this.totalDurationMs=T,this.reservationWidth=this.width,this.staticExpiryTimeMs=this.vpos+T,this.lastUpdateTime=this.timeSource.now(),this.isPaused=!1;return}this.staticExpiryTimeMs=null;const l=t.measureText("??".repeat(150)).width,c=this.width*Math.max(r.bufferRatio,0);this.bufferWidth=Math.max(r.baseBufferPx,c);const d=Math.max(r.entryBufferPx,this.bufferWidth);this.virtualStartX=i+r.virtualExtension,this.x=this.virtualStartX;const u=this.width/i;let p=r.maxVisibleDurationMs;if(u>1){const F=Math.min(u,r.maxWidthRatio),Ot=r.maxVisibleDurationMs/Math.max(F,1);p=Math.max(r.minVisibleDurationMs,Math.floor(Ot));}const b=i+this.width+this.bufferWidth+d,g=Math.max(p,1),w=b/g,A=w*1e3/60;this.baseSpeed=A,this.speed=this.baseSpeed,this.speedPixelsPerMs=w;const V=this.virtualStartX+this.width+this.bufferWidth+d,tt=i+d,R=this.virtualStartX+this.width+this.bufferWidth,P=Math.max(w,Number.EPSILON),Ft=Math.max(0,R-tt);this.visibleDurationMs=p,this.preCollisionDurationMs=Math.max(0,Math.ceil(Ft/P)),this.totalDurationMs=Math.max(this.preCollisionDurationMs,Math.ceil(V/P));const zt=this.width+this.bufferWidth+d;this.reservationWidth=Math.min(l,zt),this.lastUpdateTime=this.timeSource.now(),this.isPaused=!1;}catch(i){throw D.error("Comment.prepare",i,{text:this.text,visibleWidth:e,canvasHeight:n,hasContext:!!t}),i}}update(t=1,e=false){try{if(!this.isActive){this.isPaused=e;return}const n=this.timeSource.now();if(!this.isScrolling){this.isPaused=e,this.lastUpdateTime=n;return}if(e){this.isPaused=!0,this.lastUpdateTime=n;return}const r=(n-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*t,this.x-=this.speed*r,this.x<-this.width&&(this.isActive=!1),this.lastUpdateTime=n,this.isPaused=!1;}catch(n){D.error("Comment.update",n,{text:this.text,playbackRate:t,isPaused:e,isActive:this.isActive});}}draw(t,e=null){try{if(!this.isActive||!t)return;t.save(),t.font=`${this.fontSize}px ${this.fontFamily}`;const n=k(this.opacity);t.globalAlpha=n;const r=e??this.x,i=this.y+this.fontSize;t.strokeStyle="#000000",t.lineWidth=Math.max(3,this.fontSize/8),t.lineJoin="round",t.strokeText(this.text,r,i),t.globalAlpha=1;const s=Math.max(1,this.fontSize*.04),o=this.fontSize*.18;[{offsetXMultiplier:.9,offsetYMultiplier:1.1,blurMultiplier:.55,alpha:.52,rgb:"20, 28, 40"},{offsetXMultiplier:2.4,offsetYMultiplier:2.7,blurMultiplier:1.45,alpha:.32,rgb:"0, 0, 0"},{offsetXMultiplier:-.7,offsetYMultiplier:-.6,blurMultiplier:.4,alpha:.42,rgb:"255, 255, 255"}].forEach(l=>{const c=k(l.alpha*n);t.shadowColor=`rgba(${l.rgb}, ${c})`,t.shadowBlur=o*l.blurMultiplier,t.shadowOffsetX=s*l.offsetXMultiplier,t.shadowOffsetY=s*l.offsetYMultiplier,t.fillStyle="rgba(0, 0, 0, 0)",t.fillText(this.text,r,i);}),t.shadowColor="transparent",t.shadowBlur=0,t.shadowOffsetX=0,t.shadowOffsetY=0,t.globalAlpha=1,t.fillStyle=Xt(this.color,n),t.fillText(this.text,r,i),t.restore();}catch(n){D.error("Comment.draw",n,{text:this.text,isActive:this.isActive,hasContext:!!t,interpolatedX:e});}}syncWithSettings(t){this.color=this.getEffectiveColor(t.commentColor),this.opacity=this.getEffectiveOpacity(t.commentOpacity);}getEffectiveColor(t){const e=this.colorOverride??t;return typeof e!="string"||e.length===0?t:e.toUpperCase()}getEffectiveOpacity(t){if(typeof this.opacityOverride=="number")return k(this.opacityOverride);const e=t*this.opacityMultiplier;return Number.isFinite(e)?k(e):0}markActivated(t){this.activationTimeMs=t;}clearActivation(){this.activationTimeMs=null,this.isScrolling||(this.staticExpiryTimeMs=null);}hasStaticExpired(t){return this.isScrolling||this.staticExpiryTimeMs===null?false:t>=this.staticExpiryTimeMs}}const H={commentColor:"#FFFFFF",commentOpacity:.75,isCommentVisible:true,useContainerResizeObserver:true,ngWords:[],ngRegexps:[]},Et=()=>({...H,ngWords:[...H.ngWords],ngRegexps:[...H.ngRegexps]}),C=a=>a*1e3,Jt=1e4,rt=2e3,Qt=1e3,te=4e3,ee=1800,ne=3,re=.25,ie=32,se=48,O=120,oe=1,ae=12,it=24,x=.001,st=50,le=a=>typeof window<"u"&&typeof window.requestAnimationFrame=="function"&&typeof window.cancelAnimationFrame=="function"?{request:t=>window.requestAnimationFrame(t),cancel:t=>window.cancelAnimationFrame(t)}:{request:t=>globalThis.setTimeout(()=>{t(a.now());},16),cancel:t=>{globalThis.clearTimeout(t);}},ce=()=>typeof document>"u"?()=>{throw new Error("Document is not available. Provide a custom createCanvasElement implementation.")}:()=>document.createElement("canvas"),de=a=>{if(!a||typeof a!="object")return  false;const t=a;return typeof t.commentColor=="string"&&typeof t.commentOpacity=="number"&&typeof t.isCommentVisible=="boolean"};class ot{_settings;comments=[];reservedLanes=new Map;topStaticLaneReservations=new Map;bottomStaticLaneReservations=new Map;log;timeSource;animationFrameProvider;createCanvasElement;commentDependencies;canvas=null;ctx=null;videoElement=null;containerElement=null;laneCount=ae;laneHeight=0;currentTime=0;duration=0;playbackRate=1;isPlaying=true;lastDrawTime=0;finalPhaseActive=false;frameId=null;resizeObserver=null;resizeObserverTarget=null;isResizeObserverAvailable=typeof ResizeObserver<"u";cleanupTasks=[];constructor(t=null,e=void 0){let n,r;if(de(t))n={...t},r=e??{};else {const i=t??e??{};r=typeof i=="object"?i:{},n=Et();}this.timeSource=r.timeSource??St(),this.animationFrameProvider=r.animationFrameProvider??le(this.timeSource),this.createCanvasElement=r.createCanvasElement??ce(),this.commentDependencies={timeSource:this.timeSource},this._settings={...n},this.log=xt(r.loggerNamespace??"CommentRenderer");}get settings(){return this._settings}set settings(t){this._settings={...t};}resolveContainer(t,e){if(t)return t;if(e.parentElement)return e.parentElement;if(typeof document<"u"&&document.body)return document.body;throw new Error("Cannot resolve container element. Provide container explicitly when DOM is unavailable.")}ensureContainerPositioning(t){if(typeof getComputedStyle=="function"){getComputedStyle(t).position==="static"&&(t.style.position="relative");return}t.style.position||(t.style.position="relative");}initialize(t){try{this.destroyCanvasOnly();const e=t instanceof HTMLVideoElement?t:t.video,n=t instanceof HTMLVideoElement?t.parentElement:t.container??t.video.parentElement,r=this.resolveContainer(n??null,e);this.videoElement=e,this.containerElement=r,this.duration=Number.isFinite(e.duration)?C(e.duration):0,this.currentTime=C(e.currentTime),this.playbackRate=e.playbackRate,this.isPlaying=!e.paused,this.lastDrawTime=this.timeSource.now();const i=this.createCanvasElement(),s=i.getContext("2d");if(!s)throw new Error("Failed to acquire 2D canvas context");i.style.position="absolute",i.style.top="0",i.style.left="0",i.style.pointerEvents="none",i.style.zIndex="1000";const o=this.containerElement;o instanceof HTMLElement&&(this.ensureContainerPositioning(o),o.appendChild(i)),this.canvas=i,this.ctx=s,this.resize(),this.calculateLaneMetrics(),this.setupVideoEventListeners(e),this.setupResizeHandling(e),this.setupVideoChangeDetection(e,r),this.startAnimation();}catch(e){throw this.log.error("CommentRenderer.initialize",e),e}}addComment(t,e,n=[]){if(this.isNGComment(t)||this.comments.some(i=>i.text===t&&i.vpos===e))return null;const r=new Ct(t,e,n,this._settings,this.commentDependencies);return this.comments.push(r),this.comments.sort((i,s)=>i.vpos-s.vpos),r}clearComments(){this.comments.length=0,this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear(),this.ctx&&this.canvas&&this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);}resetState(){this.clearComments(),this.currentTime=0,this.finalPhaseActive=false;}destroy(){this.stopAnimation(),this.cleanupResizeHandling(),this.runCleanupTasks(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.videoElement=null,this.containerElement=null,this.comments.length=0,this.reservedLanes.clear(),this.finalPhaseActive=false;}updateSettings(t){const e=this._settings.useContainerResizeObserver;this.settings=t,this.comments.forEach(n=>{n.syncWithSettings(this._settings);}),!this._settings.isCommentVisible&&this.ctx&&this.canvas&&(this.comments.forEach(n=>{n.isActive=false,n.clearActivation();}),this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear()),e!==this._settings.useContainerResizeObserver&&this.videoElement&&this.setupResizeHandling(this.videoElement);}getVideoElement(){return this.videoElement}getCurrentVideoSource(){const t=this.videoElement;if(!t)return null;if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const e=t.getAttribute("src");if(e&&e.length>0)return e;const n=t.querySelector("source[src]");return n&&typeof n.src=="string"?n.src:null}getCommentsSnapshot(){return [...this.comments]}isNGComment(t){try{return typeof t!="string"||Array.isArray(this._settings.ngWords)&&this._settings.ngWords.some(e=>typeof e=="string"&&e.length>0&&t.includes(e))?!0:Array.isArray(this._settings.ngRegexps)?this._settings.ngRegexps.some(e=>{if(typeof e!="string"||e.length===0)return !1;try{return new RegExp(e).test(t)}catch(n){return this.log.error("CommentRenderer.isNGComment.regex",n,{pattern:e,text:t}),!1}}):!1}catch(e){return this.log.error("CommentRenderer.isNGComment",e,{text:t}),true}}resize(t,e){const n=this.videoElement,r=this.canvas;if(!n||!r)return;const i=n.getBoundingClientRect(),s=t??i.width??r.width,o=e??i.height??r.height;if(!Number.isFinite(s)||!Number.isFinite(o)||s<=0||o<=0)return;const l=Math.max(1,Math.floor(s)),c=Math.max(1,Math.floor(o));if(!Number.isFinite(l)||!Number.isFinite(c))return;const d=r.width||l,u=r.height||c;if(d===l&&u===c)return;r.width=l,r.height=c,r.style.width=`${l}px`,r.style.height=`${c}px`;const p=d>0?l/d:1,b=u>0?c/u:1;(p!==1||b!==1)&&this.comments.forEach(g=>{g.isActive&&(g.x*=p,g.y*=b,g.baseSpeed*=p,g.speed*=p,g.fontSize=Math.max(it,Math.floor(c*.05)));}),this.calculateLaneMetrics();}destroyCanvasOnly(){this.stopAnimation(),this.cleanupResizeHandling(),this.runCleanupTasks(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null;}calculateLaneMetrics(){const t=this.canvas;if(!t)return;const e=Math.max(it,Math.floor(t.height*.05));this.laneHeight=e*1.2;const n=Math.floor(t.height/Math.max(this.laneHeight,1));this.laneCount=Math.max(oe,n),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear();}updateComments(){const t=this.videoElement,e=this.canvas,n=this.ctx;if(!t||!e||!n)return;this.currentTime=C(t.currentTime),this.playbackRate=t.playbackRate,this.isPlaying=!t.paused;const r=this.buildPrepareOptions(e.width),i=this.duration>0&&this.duration-this.currentTime<=Jt;i&&!this.finalPhaseActive&&(this.finalPhaseActive=true,n.clearRect(0,0,e.width,e.height),this.comments.forEach(s=>{s.isActive=false,s.clearActivation();}),this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear()),!i&&this.finalPhaseActive&&(this.finalPhaseActive=false),this.pruneStaticLaneReservations(this.currentTime);for(const s of this.comments)if(!this.isNGComment(s.text)){if(s.isInvisible){s.isActive=false,s.hasShown=true,s.clearActivation();continue}if(s.syncWithSettings(this._settings),this.shouldActivateCommentAtTime(s,this.currentTime)&&this.activateComment(s,n,e.width,e.height,r,this.currentTime),s.isActive){if(s.layout!=="naka"&&s.hasStaticExpired(this.currentTime)){const o=s.layout==="ue"?"ue":"shita";this.releaseStaticLane(o,s.lane),s.isActive=false,s.clearActivation();continue}if(s.layout==="naka"&&s.vpos>this.currentTime+st){s.x=s.virtualStartX,s.lastUpdateTime=this.timeSource.now();continue}if(s.hasShown=true,s.update(this.playbackRate,!this.isPlaying),!s.isScrolling&&s.hasStaticExpired(this.currentTime)){const o=s.layout==="ue"?"ue":"shita";this.releaseStaticLane(o,s.lane),s.isActive=false,s.clearActivation();}}}for(const s of this.comments)s.isActive&&s.isScrolling&&s.x<-s.width&&(s.isActive=false,s.clearActivation());}buildPrepareOptions(t){return {visibleWidth:t,virtualExtension:Qt,maxVisibleDurationMs:te,minVisibleDurationMs:ee,maxWidthRatio:ne,bufferRatio:re,baseBufferPx:ie,entryBufferPx:se}}findAvailableLane(t){const e=this.currentTime;this.pruneLaneReservations(e),this.pruneStaticLaneReservations(e);const n=this.getLanePriorityOrder(e),r=this.createLaneReservation(t,e);for(const s of n)if(this.isLaneAvailable(s,r,e))return this.storeLaneReservation(s,r),s;const i=n[0]??0;return this.storeLaneReservation(i,r),i}pruneLaneReservations(t){for(const[e,n]of this.reservedLanes.entries()){const r=n.filter(i=>i.totalEndTime+O>t);r.length>0?this.reservedLanes.set(e,r):this.reservedLanes.delete(e);}}pruneStaticLaneReservations(t){for(const[e,n]of this.topStaticLaneReservations.entries())n<=t&&this.topStaticLaneReservations.delete(e);for(const[e,n]of this.bottomStaticLaneReservations.entries())n<=t&&this.bottomStaticLaneReservations.delete(e);}getStaticLaneMap(t){return t==="ue"?this.topStaticLaneReservations:this.bottomStaticLaneReservations}getStaticReservedLaneSet(){const t=new Set;for(const e of this.topStaticLaneReservations.keys())t.add(e);for(const e of this.bottomStaticLaneReservations.keys())t.add(e);return t}shouldActivateCommentAtTime(t,e){return !(t.isInvisible||t.isActive||t.vpos>e+st||t.vpos<e-rt)}activateComment(t,e,n,r,i,s){if(t.prepare(e,n,r,i),t.layout==="naka"){const d=Math.max(0,s-t.vpos),u=t.speedPixelsPerMs*d,p=t.virtualStartX-u;if(p<=-t.width){t.isActive=false,t.hasShown=true,t.clearActivation(),t.lane=-1;return}t.lane=this.findAvailableLane(t),t.y=t.lane*this.laneHeight,t.x=p,t.isActive=true,t.hasShown=true,t.isPaused=!this.isPlaying,t.markActivated(s),t.lastUpdateTime=this.timeSource.now();return}const o=t.vpos+T;if(s>o){t.isActive=false,t.hasShown=true,t.clearActivation(),t.lane=-1;return}const l=t.layout==="ue"?"ue":"shita",c=this.assignStaticLane(l);t.lane=c,t.y=c*this.laneHeight,t.x=t.virtualStartX,t.isActive=true,t.hasShown=true,t.isPaused=!this.isPlaying,t.markActivated(s),t.lastUpdateTime=this.timeSource.now(),t.staticExpiryTimeMs=o,this.reserveStaticLane(l,c,o);}assignStaticLane(t){const e=this.getStaticLaneMap(t),n=Array.from({length:this.laneCount},(s,o)=>o);t==="shita"&&n.reverse();for(const s of n)if(!e.has(s))return s;let r=n[0]??0,i=Number.POSITIVE_INFINITY;for(const[s,o]of e.entries())o<i&&(i=o,r=s);return r}reserveStaticLane(t,e,n){this.getStaticLaneMap(t).set(e,n);}releaseStaticLane(t,e){e<0||this.getStaticLaneMap(t).delete(e);}getLanePriorityOrder(t){const e=Array.from({length:this.laneCount},(s,o)=>o).sort((s,o)=>{const l=this.getLaneNextAvailableTime(s,t),c=this.getLaneNextAvailableTime(o,t);return Math.abs(l-c)<=x?s-o:l-c}),n=this.getStaticReservedLaneSet();if(n.size===0)return e;const r=e.filter(s=>!n.has(s));if(r.length===0)return e;const i=e.filter(s=>n.has(s));return [...r,...i]}getLaneNextAvailableTime(t,e){const n=this.reservedLanes.get(t);if(!n||n.length===0)return e;let r=e;for(const i of n)r=Math.max(r,i.endTime);return r}createLaneReservation(t,e){const n=Math.max(t.speedPixelsPerMs,x),r=e+t.preCollisionDurationMs+O,i=e+t.totalDurationMs+O;return {comment:t,startTime:e,endTime:Math.max(e,r),totalEndTime:Math.max(e,i),startLeft:t.virtualStartX,width:t.width,speed:n,buffer:t.bufferWidth}}isLaneAvailable(t,e,n){const r=this.reservedLanes.get(t);if(!r||r.length===0)return  true;for(const i of r)if(!(i.totalEndTime+O<=n)&&this.areReservationsConflicting(i,e))return  false;return  true}storeLaneReservation(t,e){const n=[...this.reservedLanes.get(t)??[],e].sort((r,i)=>r.endTime-i.endTime);this.reservedLanes.set(t,n);}areReservationsConflicting(t,e){const n=Math.max(t.startTime,e.startTime),r=Math.min(t.endTime,e.endTime);if(n>=r)return  false;const i=new Set([n,r,n+(r-n)/2]),s=this.solveLeftRightEqualityTime(t,e);s!==null&&s>=n-x&&s<=r+x&&i.add(s);const o=this.solveLeftRightEqualityTime(e,t);o!==null&&o>=n-x&&o<=r+x&&i.add(o);for(const l of i){if(l<n-x||l>r+x)continue;const c=this.computeForwardGap(t,e,l),d=this.computeForwardGap(e,t,l);if(c<=x&&d<=x)return  true}return  false}computeForwardGap(t,e,n){const r=this.getBufferedEdges(t,n),i=this.getBufferedEdges(e,n);return r.left-i.right}getBufferedEdges(t,e){const n=Math.max(0,e-t.startTime),r=t.speed*n,i=t.startLeft-r,s=i-t.buffer,o=i+t.width+t.buffer;return {left:s,right:o}}solveLeftRightEqualityTime(t,e){const n=e.speed-t.speed;if(Math.abs(n)<x)return null;const r=(e.startLeft+e.speed*e.startTime+e.width+e.buffer-t.startLeft-t.speed*t.startTime+t.buffer)/n;return Number.isFinite(r)?r:null}draw(){const t=this.canvas,e=this.ctx;if(!t||!e)return;e.clearRect(0,0,t.width,t.height);const n=this.comments.filter(i=>i.isActive),r=this.timeSource.now();if(this._settings.isCommentVisible){const i=(r-this.lastDrawTime)/16.666666666666668;n.forEach(s=>{const o=s.x-s.speed*i;s.draw(e,o);});}this.lastDrawTime=r;}updateFrame=()=>{if(this.videoElement){if(!this._settings.isCommentVisible){this.frameId=this.animationFrameProvider.request(this.updateFrame);return}this.updateComments(),this.draw(),this.frameId=this.animationFrameProvider.request(this.updateFrame);}};startAnimation(){this.stopAnimation(),this.frameId=this.animationFrameProvider.request(this.updateFrame);}stopAnimation(){this.frameId!==null&&(this.animationFrameProvider.cancel(this.frameId),this.frameId=null);}onSeek(){const t=this.canvas,e=this.ctx,n=this.videoElement;if(!t||!e||!n)return;const r=C(n.currentTime);this.finalPhaseActive=false,this.currentTime=r,this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear();const i=this.buildPrepareOptions(t.width);this.comments.forEach(s=>{if(this.isNGComment(s.text)){s.isActive=false,s.clearActivation();return}if(s.isInvisible){s.isActive=false,s.hasShown=true,s.clearActivation();return}if(s.syncWithSettings(this._settings),s.isActive=false,s.lane=-1,s.clearActivation(),this.shouldActivateCommentAtTime(s,this.currentTime)){this.activateComment(s,e,t.width,t.height,i,this.currentTime);return}s.vpos<this.currentTime-rt?s.hasShown=true:s.hasShown=false;});}setupVideoEventListeners(t){try{const e=()=>{this.isPlaying=!0;const d=this.timeSource.now();this.lastDrawTime=d,this.comments.forEach(u=>{u.lastUpdateTime=d,u.isPaused=!1;});},n=()=>{this.isPlaying=!1;const d=this.timeSource.now();this.comments.forEach(u=>{u.lastUpdateTime=d,u.isPaused=!0;});},r=()=>{this.onSeek();},i=()=>{this.onSeek();},s=()=>{this.playbackRate=t.playbackRate;const d=this.timeSource.now();this.comments.forEach(u=>{u.lastUpdateTime=d;});},o=()=>{this.handleVideoMetadataLoaded(t);},l=()=>{this.duration=Number.isFinite(t.duration)?C(t.duration):0;},c=()=>{this.handleVideoSourceChange();};t.addEventListener("play",e),t.addEventListener("pause",n),t.addEventListener("seeking",r),t.addEventListener("seeked",i),t.addEventListener("ratechange",s),t.addEventListener("loadedmetadata",o),t.addEventListener("durationchange",l),t.addEventListener("emptied",c),this.addCleanup(()=>t.removeEventListener("play",e)),this.addCleanup(()=>t.removeEventListener("pause",n)),this.addCleanup(()=>t.removeEventListener("seeking",r)),this.addCleanup(()=>t.removeEventListener("seeked",i)),this.addCleanup(()=>t.removeEventListener("ratechange",s)),this.addCleanup(()=>t.removeEventListener("loadedmetadata",o)),this.addCleanup(()=>t.removeEventListener("durationchange",l)),this.addCleanup(()=>t.removeEventListener("emptied",c));}catch(e){throw this.log.error("CommentRenderer.setupVideoEventListeners",e),e}}handleVideoMetadataLoaded(t){this.handleVideoSourceChange(t),this.resize(),this.calculateLaneMetrics(),this.onSeek();}handleVideoSourceChange(t){const e=t??this.videoElement;if(!e){this.isPlaying=false,this.finalPhaseActive=false,this.resetCommentActivity();return}this.syncVideoState(e),this.finalPhaseActive=false,this.resetCommentActivity();}syncVideoState(t){this.duration=Number.isFinite(t.duration)?C(t.duration):0,this.currentTime=C(t.currentTime),this.playbackRate=t.playbackRate,this.isPlaying=!t.paused,this.lastDrawTime=this.timeSource.now();}resetCommentActivity(){const t=this.timeSource.now(),e=this.canvas,n=this.ctx;e&&n&&n.clearRect(0,0,e.width,e.height),this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear(),this.comments.forEach(r=>{r.isActive=false,r.isPaused=!this.isPlaying,r.hasShown=false,r.lane=-1,r.x=r.virtualStartX,r.speed=r.baseSpeed,r.lastUpdateTime=t,r.clearActivation();});}setupVideoChangeDetection(t,e){if(typeof MutationObserver>"u"){this.log.debug("MutationObserver is not available in this environment. Video change detection is disabled.");return}const n=new MutationObserver(i=>{for(const s of i){if(s.type==="attributes"&&s.attributeName==="src"){const o=s.target;let l=null,c=null;if((o instanceof HTMLVideoElement||o instanceof HTMLSourceElement)&&(l=typeof s.oldValue=="string"?s.oldValue:null,c=o.getAttribute("src")),l===c)continue;this.handleVideoSourceChange(t);return}if(s.type==="childList"){for(const o of s.addedNodes)if(o instanceof HTMLSourceElement){this.handleVideoSourceChange(t);return}for(const o of s.removedNodes)if(o instanceof HTMLSourceElement){this.handleVideoSourceChange(t);return}}}});n.observe(t,{attributes:true,attributeFilter:["src"],attributeOldValue:true,childList:true,subtree:true}),this.addCleanup(()=>n.disconnect());const r=new MutationObserver(i=>{for(const s of i)if(s.type==="childList"){for(const o of s.addedNodes){const l=this.extractVideoElement(o);if(l&&l!==this.videoElement){this.initialize(l);return}}for(const o of s.removedNodes){if(o===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}if(o instanceof Element){const l=o.querySelector("video");if(l&&l===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}}}}});r.observe(e,{childList:true,subtree:true}),this.addCleanup(()=>r.disconnect());}extractVideoElement(t){if(t instanceof HTMLVideoElement)return t;if(t instanceof Element){const e=t.querySelector("video");if(e instanceof HTMLVideoElement)return e}return null}setupResizeHandling(t){if(this.cleanupResizeHandling(),this._settings.useContainerResizeObserver&&this.isResizeObserverAvailable){const e=t.parentElement??t,n=new ResizeObserver(r=>{for(const i of r){const{width:s,height:o}=i.contentRect;s>0&&o>0?this.resize(s,o):this.resize();}});n.observe(e),this.resizeObserver=n,this.resizeObserverTarget=e;}else if(typeof window<"u"&&typeof window.addEventListener=="function"){const e=()=>{this.resize();};window.addEventListener("resize",e),this.addCleanup(()=>window.removeEventListener("resize",e));}else this.log.debug("Resize handling is disabled because neither ResizeObserver nor window APIs are available.");}cleanupResizeHandling(){this.resizeObserver&&this.resizeObserverTarget&&this.resizeObserver.unobserve(this.resizeObserverTarget),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.resizeObserverTarget=null;}addCleanup(t){this.cleanupTasks.push(t);}runCleanupTasks(){for(;this.cleanupTasks.length>0;){const t=this.cleanupTasks.pop();try{t?.();}catch(e){this.log.error("CommentRenderer.cleanupTask",e);}}}}const E=()=>Et(),he="v6.5.1";var ue=typeof GM_addStyle<"u"?GM_addStyle:void 0,q=typeof GM_getValue<"u"?GM_getValue:void 0,$=typeof GM_setValue<"u"?GM_setValue:void 0,me=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0;const at="settings",lt="currentVideo",ct="lastDanimeIds",pe=a=>({...a,ngWords:[...a.ngWords],ngRegexps:[...a.ngRegexps]});class X{constructor(t){this.notifier=t,this.settings=E(),this.currentVideo=null,this.loadSettings(),this.currentVideo=this.loadVideoData();}settings;currentVideo;observers=new Set;getSettings(){return pe(this.settings)}loadSettings(){try{const t=q(at,null);if(!t)return this.settings=E(),this.settings;if(typeof t=="string"){const e=JSON.parse(t);this.settings={...E(),...e,ngWords:Array.isArray(e?.ngWords)?[...e.ngWords]:[],ngRegexps:Array.isArray(e?.ngRegexps)?[...e.ngRegexps]:[]};}else this.settings={...E(),...t,ngWords:Array.isArray(t.ngWords)?[...t.ngWords]:[],ngRegexps:Array.isArray(t.ngRegexps)?[...t.ngRegexps]:[]};return this.notifyObservers(),this.settings}catch(t){return console.error("[SettingsManager] 設定の読み込みに失敗しました",t),this.notify("設定の読み込みに失敗しました","error"),this.settings=E(),this.settings}}saveSettings(){try{return $(at,JSON.stringify(this.settings)),this.notifyObservers(),this.notify("設定を保存しました","success"),!0}catch(t){return console.error("[SettingsManager] 設定の保存に失敗しました",t),this.notify("設定の保存に失敗しました","error"),false}}updateSettings(t){return this.settings={...this.settings,...t,ngWords:t.ngWords?[...t.ngWords]:[...this.settings.ngWords],ngRegexps:t.ngRegexps?[...t.ngRegexps]:[...this.settings.ngRegexps]},this.saveSettings()}addObserver(t){this.observers.add(t);}removeObserver(t){this.observers.delete(t);}notifyObservers(){const t=this.getSettings();for(const e of this.observers)try{e(t);}catch(n){console.error("[SettingsManager] 設定変更通知でエラー",n);}}loadVideoData(){try{return q(lt,null)??null}catch(t){return console.error("[SettingsManager] 動画データの読み込みに失敗しました",t),this.notify("動画データの読み込みに失敗しました","error"),null}}saveVideoData(t,e){try{const n={videoId:e.videoId,title:e.title,viewCount:e.viewCount,commentCount:e.commentCount,mylistCount:e.mylistCount,postedAt:e.postedAt,thumbnail:e.thumbnail,owner:e.owner??null,channel:e.channel??null};return $(lt,n),this.currentVideo=n,!0}catch(n){return console.error("[SettingsManager] 動画データの保存に失敗しました",n),this.notify("動画データの保存に失敗しました","error"),false}}getCurrentVideo(){return this.currentVideo?{...this.currentVideo}:null}saveLastDanimeIds(t){try{return $(ct,t),!0}catch(e){return console.error("[SettingsManager] saveLastDanimeIds failed",e),this.notify("ID情報の保存に失敗しました","error"),false}}loadLastDanimeIds(){try{return q(ct,null)??null}catch(t){return console.error("[SettingsManager] loadLastDanimeIds failed",t),this.notify("ID情報の読込に失敗しました","error"),null}}notify(t,e="info"){this.notifier?.show(t,e);}}const ge=new Set(["INPUT","TEXTAREA"]),B=a=>a.length===1?a.toUpperCase():a,fe=a=>a?`${a}+`:"";class Mt{shortcuts=new Map;boundHandler;isEnabled=true;isListening=false;constructor(){this.boundHandler=this.handleKeyDown.bind(this);}addShortcut(t,e,n){const r=this.createShortcutKey(B(t),e);this.shortcuts.set(r,n);}removeShortcut(t,e){const n=this.createShortcutKey(B(t),e);this.shortcuts.delete(n);}startListening(){this.isListening||(document.addEventListener("keydown",this.boundHandler,false),this.isListening=true);}stopListening(){this.isListening&&(document.removeEventListener("keydown",this.boundHandler,false),this.isListening=false);}setEnabled(t){this.isEnabled=t;}createShortcutKey(t,e){return `${fe(e)}${t}`}extractModifier(t){const e=[];return t.ctrlKey&&e.push("Ctrl"),t.altKey&&e.push("Alt"),t.shiftKey&&e.push("Shift"),t.metaKey&&e.push("Meta"),e.length>0?e.join("+"):null}handleKeyDown(t){if(!this.isEnabled)return;const n=t.target?.tagName??"";if(ge.has(n))return;const r=this.extractModifier(t),i=this.createShortcutKey(B(t.key),r),s=this.shortcuts.get(i);s&&(t.preventDefault(),s());}}const be=M("dAnime:CommentRenderer"),dt=a=>({loggerNamespace:"dAnime:CommentRenderer",...a??{}}),ye=a=>{if(!a||typeof a!="object")return  false;const t=a;return typeof t.commentColor=="string"&&typeof t.commentOpacity=="number"&&typeof t.isCommentVisible=="boolean"};class At{renderer;keyboardHandler=null;constructor(t,e){ye(t)||t===null?this.renderer=new ot(t??null,dt(e)):this.renderer=new ot(dt(t));}get settings(){return this.renderer.settings}set settings(t){this.renderer.settings=t;}initialize(t){this.renderer.initialize(t),this.setupKeyboardShortcuts();}addComment(t,e,n=[]){return this.renderer.addComment(t,e,n)}clearComments(){this.renderer.clearComments();}resetState(){this.renderer.resetState();}destroy(){this.teardownKeyboardShortcuts(),this.renderer.destroy();}updateSettings(t){this.renderer.updateSettings(t);}getVideoElement(){return this.renderer.getVideoElement()}getCurrentVideoSource(){return this.renderer.getCurrentVideoSource()}getCommentsSnapshot(){return this.renderer.getCommentsSnapshot()}isNGComment(t){return this.renderer.isNGComment(t)}resize(t,e){this.renderer.resize(t,e);}setupKeyboardShortcuts(){this.teardownKeyboardShortcuts();const t=new Mt;t.addShortcut("C","Shift",()=>{try{const e=this.renderer.settings,n={...e,isCommentVisible:!e.isCommentVisible};this.renderer.updateSettings(n),this.syncGlobalSettings(n);}catch(e){be.error("CommentRenderer.keyboardShortcut",e);}}),t.startListening(),this.keyboardHandler=t;}teardownKeyboardShortcuts(){this.keyboardHandler?.stopListening(),this.keyboardHandler=null;}syncGlobalSettings(t){window.dAniRenderer?.settingsManager?.updateSettings(t);}}class Z{shadowRoot=null;container=null;createShadowDOM(t,e={mode:"closed"}){if(!t)throw new Error("Host element is required for shadow DOM creation");return this.shadowRoot=t.attachShadow(e),this.container=document.createElement("div"),this.shadowRoot.appendChild(this.container),this.shadowRoot}addStyles(t){if(!this.shadowRoot)throw new Error("Shadow root not initialized");const e=document.createElement("style");e.textContent=t,this.shadowRoot.appendChild(e);}querySelector(t){return this.shadowRoot?this.shadowRoot.querySelector(t):null}querySelectorAll(t){return this.shadowRoot?this.shadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}setHTML(t){if(!this.container)throw new Error("Container not initialized");this.container.innerHTML=t;}destroy(){this.shadowRoot?.host&&this.shadowRoot.host.remove(),this.shadowRoot=null,this.container=null;}}const ve=`\r
/* 基本カラーパレット - ダークモード */\r
:host {\r
...
`;class _{static getCommonStyles(){return ve}static getNotificationStyles(){return xe}static getAutoButtonStyles(){return we}}const ht={success:"✔",warning:"⚠",error:"✖",info:"ℹ"};class m extends Z{static instance=null;static notifications=[];hostElement=null;initialized=false;static getInstance(){return this.instance||(this.instance=new m),this.instance}static show(t,e="info",n=3e3){try{const r=this.getInstance();return r.initialize(),r.initialized?r.createNotification(t,e,n):null}catch(r){return console.error("[NotificationManager] show failed",r),null}}static removeNotification(t){this.getInstance().removeNotification(t.element);}show(t,e="info"){m.show(t,e);}initialize(){if(!this.initialized)try{this.hostElement=document.createElement("div"),this.hostElement.className="nico-comment-shadow-host notification-host",this.hostElement.style.cssText=["position: fixed","top: 0","right: 0","z-index: 2147483647","pointer-events: none"].join(";"),document.body.appendChild(this.hostElement),this.createShadowDOM(this.hostElement),this.addStyles(_.getNotificationStyles()),this.setHTML('<div class="notification-container"></div>'),this.initialized=!0;}catch(t){console.error("[NotificationManager] initialize failed",t),this.initialized=false;}}destroy(){m.notifications.forEach(t=>{t.timerId&&window.clearTimeout(t.timerId);}),m.notifications=[],this.hostElement?.parentNode&&this.hostElement.parentNode.removeChild(this.hostElement),this.hostElement=null,this.initialized=false,m.instance=null;}createNotification(t,e,n){try{const r=this.querySelector(".notification-container");if(!r)throw new Error("Notification container not found");const i=ht[e]??ht.info,s=document.createElement("div");s.className=`notification-item ${e}`;const o=document.createElement("div");o.className="notification-icon",o.innerHTML=`<span>${i}</span>`,s.appendChild(o);const l=document.createElement("div");l.className="notification-content";const c=document.createElement("div");c.className="notification-type",c.textContent=e.charAt(0).toUpperCase()+e.slice(1),l.appendChild(c);const d=document.createElement("div");d.className="notification-message",d.textContent=t||"No message",l.appendChild(d),s.appendChild(l);const u=document.createElement("button");u.className="notification-close",u.innerHTML="&times;",u.addEventListener("click",()=>{this.removeNotification(s);}),s.appendChild(u),r.appendChild(s),requestAnimationFrame(()=>{s.classList.add("show");});const p={element:s,timerId:window.setTimeout(()=>{this.removeNotification(s);},n)};return m.notifications.push(p),p}catch(r){return console.error("[NotificationManager] createNotification failed",r),null}}removeNotification(t){if(!t)return;const e=m.notifications.find(n=>n.element===t);e?.timerId&&window.clearTimeout(e.timerId),t.classList.remove("show"),window.setTimeout(()=>{try{t.remove(),m.notifications=m.notifications.filter(n=>n.element!==t);}catch(n){console.error("[NotificationManager] removeNotification cleanup failed",n);}},500);}}const Vt="https://www.nicovideo.jp",Lt=`${Vt}/search`,kt=`${Vt}/watch`,ut={searchBase:Lt,watchBase:kt},Se=a=>`${kt}/${a}`,It=a=>`${Lt}/${encodeURIComponent(a)}`,K=a=>new Promise((t,e)=>{me({url:a.url,method:a.method??"GET",headers:a.headers,data:a.data,responseType:a.responseType??"text",timeout:a.timeout,onprogress:a.onprogress,onload:n=>{t({status:n.status,statusText:n.statusText,response:n.response,finalUrl:n.finalUrl,headers:n.responseHeaders});},onerror:n=>{const r=n?.error??"unknown error";e(new Error(`GM_xmlhttpRequest failed: ${r}`));},ontimeout:()=>{e(new Error("GM_xmlhttpRequest timeout"));}});}),W=M("dAnime:NicoApiFetcher");class J{apiData=null;comments=null;get lastApiData(){return this.apiData}get cachedComments(){return this.comments}async fetchApiData(t){try{const e=this.sanitizeVideoId(t),r=(await K({method:"GET",url:Se(e),headers:{Accept:"text/html"}})).response,o=new DOMParser().parseFromString(r,"text/html").querySelector('meta[name="server-response"]');if(!o)throw new Error("API data element not found in response");const l=o.getAttribute("content");if(!l)throw new Error("API data content is empty");const c=this.decodeServerResponse(l),u=JSON.parse(c).data?.response;if(!u)throw new Error("Invalid API data structure");return this.apiData=u,u}catch(e){throw W.error("NicoApiFetcher.fetchApiData",e),e}}async fetchComments(){try{if(!this.apiData)throw new Error("API data must be fetched first");const t=this.apiData.comment?.nvComment;if(!t?.server||!t.params||!t.threadKey)throw new Error("Required comment server data is missing");const e=await K({method:"POST",url:`${t.server}/v1/threads`,headers:{"Content-Type":"application/json","x-client-os-type":"others","X-Frontend-Id":"6","X-Frontend-Version":"0"},data:JSON.stringify({params:t.params,threadKey:t.threadKey,additionals:{}})}),i=(JSON.parse(e.response).data?.threads??[]).filter(o=>o.fork==="main").sort((o,l)=>(l.commentCount||0)-(o.commentCount||0))[0];if(!i)throw new Error("Main thread not found in comment response");const s=(i.comments??[]).map(o=>({text:o.body??"",vpos:o.vposMs??0,commands:o.commands??[]}));return this.comments=s,s}catch(t){throw W.error("NicoApiFetcher.fetchComments",t),t}}async fetchAllData(t){return await this.fetchApiData(t),this.fetchComments()}sanitizeVideoId(t){try{let e=encodeURIComponent(t);return e=e.replace(/%([0-9A-F]{2})/gi,(n,r)=>{const i=parseInt(r,16);return i>=65&&i<=90||i>=97&&i<=122||i>=48&&i<=57||i===45||i===95||i===46||i===126?String.fromCharCode(i):n}),e}catch(e){return W.error("NicoApiFetcher.sanitizeVideoId",e,{videoId:t}),t}}decodeServerResponse(t){try{return decodeURIComponent(t)}catch(e){try{const n=t.replace(/%(?![0-9A-F]{2})/gi,"%25");return decodeURIComponent(n)}catch{throw new Error(`API data decode failed: ${e.message}`)}}}}const mt=M("dAnime:NicoVideoSearcher");class Tt{cache=new Map;async search(t){if(!t.trim())return [];if(this.cache.has(t))return this.cache.get(t)??[];const e=It(t),n=await this.fetchText(e),r=this.parseServerContext(n).map(o=>{const l=this.calculateLevenshteinDistance(t,o.title),c=Math.max(t.length,o.title.length),d=c>0?(1-l/c)*100:0;return {...o,levenshteinDistance:l,similarity:d}}),i=[],s=new Set;for(const o of r)o?.videoId&&(s.has(o.videoId)||(s.add(o.videoId),i.push(o)));return i.sort((o,l)=>{const c=o.similarity??-1,d=l.similarity??-1;return c!==d?d-c:l.viewCount-o.viewCount}),this.cache.set(t,i),i}async fetchText(t){return (await K({method:"GET",url:t})).response}parseServerContext(t){try{const n=new DOMParser().parseFromString(t,"text/html").querySelector('meta[name="server-response"]');if(!n)return [];const r=n.getAttribute("content")??"",i=this.decodeHtmlEntities(r);let s;try{s=JSON.parse(i);}catch(o){return mt.error("NicoVideoSearcher.parseServerContext",o),[]}return this.extractVideoItems(s??{})}catch(e){return mt.error("NicoVideoSearcher.parseServerContext",e),[]}}decodeHtmlEntities(t){if(!t)return "";let e=t.replace(/&quot;/g,'"').replace(/&#39;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">");return e=e.replace(/&#(\d+);/g,(n,r)=>String.fromCharCode(parseInt(r,10))),e=e.replace(/&#x([0-9a-fA-F]+);/g,(n,r)=>String.fromCharCode(parseInt(r,16))),e}extractVideoItems(t){const e=[],n=i=>{const s=(i?.id??i?.contentId??i?.watchId??"").toString();if(!s)return;const o=(i?.title??i?.shortTitle??"").toString(),l=i?.count??{},c=Number(l.view??i?.viewCounter??0)||0,d=Number(l.comment??i?.commentCounter??0)||0,u=Number(l.mylist??i?.mylistCounter??0)||0,p=i?.thumbnail??{},b=(p.nHdUrl||p.listingUrl||p.largeUrl||p.middleUrl||p.url||i?.thumbnailUrl||"").toString(),g=(i?.registeredAt||i?.startTime||i?.postedDateTime||"")?.toString?.()??"",w=i?.owner&&typeof i.owner=="object"?{nickname:(i.owner.nickname??i.owner.name??"")||void 0,name:(i.owner.name??i.owner.nickname??"")||void 0}:null,A=(i?.isChannelVideo||i?.owner?.ownerType==="channel")&&i?.owner?{name:i.owner.name??""}:null;o&&e.push({videoId:s,title:o,viewCount:c,commentCount:d,mylistCount:u,thumbnail:b,postedAt:g,owner:w,channel:A});},r=i=>{if(!i)return;if(Array.isArray(i)){i.forEach(r);return}if(typeof i!="object"||i===null)return;const s=i;(s.id||s.contentId||s.watchId)&&n(s),Object.values(i).forEach(r);};return r(t),e}calculateLevenshteinDistance(t,e){const n=t?t.length:0,r=e?e.length:0;if(n===0)return r;if(r===0)return n;const i=new Array(r+1);for(let o=0;o<=r;++o){const l=i[o]=new Array(n+1);l[0]=o;}const s=i[0];for(let o=1;o<=n;++o)s[o]=o;for(let o=1;o<=r;++o)for(let l=1;l<=n;++l){const c=t[l-1]===e[o-1]?0:1;i[o][l]=Math.min(i[o-1][l]+1,i[o][l-1]+1,i[o-1][l-1]+c);}return i[r][n]}}const y={mypageHeaderTitle:".p-mypageHeader__title",mypageListContainer:".p-mypageMain",watchVideoElement:"video#video",mypageItem:".itemModule.list",mypageItemTitle:".line1",mypageEpisodeNumber:".number.line1 span",mypageEpisodeTitle:".episode.line1 span"};class Q{delay;timers=new Map;funcIds=new Map;nextId=1;constructor(t){this.delay=t;}getFuncId(t){return this.funcIds.has(t)||this.funcIds.set(t,this.nextId++),this.funcIds.get(t)??0}exec(t){const e=this.getFuncId(t),n=Date.now(),r=this.timers.get(e)?.lastExec??0,i=n-r;if(i>this.delay)t(),this.timers.set(e,{lastExec:n});else {clearTimeout(this.timers.get(e)?.timerId??void 0);const s=setTimeout(()=>{t(),this.timers.set(e,{lastExec:Date.now()});},this.delay-i);this.timers.set(e,{timerId:s,lastExec:r});}}execOnce(t){const e=this.getFuncId(t),n=this.timers.get(e);if(n?.executedOnce){n.timerId&&clearTimeout(n.timerId);return}n?.timerId&&clearTimeout(n.timerId);const r=setTimeout(()=>{try{t();}finally{this.timers.set(e,{executedOnce:true,lastExec:Date.now(),timerId:null});}},this.delay);this.timers.set(e,{timerId:r,executedOnce:false,scheduled:true});}cancel(t){const e=this.getFuncId(t),n=this.timers.get(e);n?.timerId&&clearTimeout(n.timerId),this.timers.delete(e);}resetExecution(t){const e=this.getFuncId(t),n=this.timers.get(e);n&&(n.timerId&&clearTimeout(n.timerId),this.timers.set(e,{executedOnce:false,scheduled:false}));}clearAll(){for(const[,t]of this.timers)t.timerId&&clearTimeout(t.timerId);this.timers.clear(),this.funcIds.clear();}}const Ce=1e3,Ee=100,Me=30,pt=1e4,gt=100,Ae=/watch\/(?:([a-z]{2}))?(\d+)/gi,f=M("dAnime:VideoSwitchHandler"),ft=a=>{if(!a?.video)return null;const t=a.video.registeredAt,e=t?new Date(t).toLocaleString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:false}):void 0;return {videoId:a.video.id,title:a.video.title,viewCount:a.video.count?.view,mylistCount:a.video.count?.mylist,commentCount:a.video.count?.comment,postedAt:e,thumbnail:a.video.thumbnail?.url,owner:a.owner??null,channel:a.channel??null}},Ve=a=>{const t=[];let e;for(;(e=Ae.exec(a))!==null;){const[,n="",r=""]=e;r&&t.push(`${n}${r}`);}return t};class _t{constructor(t,e,n,r=Ce,i=Ee){this.renderer=t,this.fetcher=e,this.settingsManager=n,this.monitorInterval=r,this.debounce=new Q(i);}nextVideoId=null;preloadedComments=null;lastPreloadedComments=null;lastVideoId=null;lastVideoSource=null;checkIntervalId=null;isSwitching=false;debounce;startMonitoring(){this.stopMonitoring(),this.checkIntervalId=window.setInterval(()=>{this.checkVideoEnd();},this.monitorInterval);}stopMonitoring(){this.checkIntervalId&&(window.clearInterval(this.checkIntervalId),this.checkIntervalId=null);}async onVideoSwitch(t){if(!this.isSwitching){this.isSwitching=true;try{const e=await this.resolveVideoElement(t)??null,n=this.preloadedComments??this.lastPreloadedComments??null,r=e?.dataset?.videoId??e?.getAttribute?.("data-video-id")??null,i=this.nextVideoId??r??this.lastVideoId;if(!e||!i&&!n){this.handleMissingVideoInfo(n);return}f.info("videoSwitch:start",{videoId:i??null,elementVideoId:e.dataset?.videoId??null,preloadedCount:n?.length??0}),m.show("動画の切り替わりを検知しました...","info"),this.resetRendererState(e);const s=this.renderer.getVideoElement();if(s!==e&&e)f.debug("videoSwitch:rebind",{previousSrc:this.renderer.getCurrentVideoSource(),newSrc:typeof e.currentSrc=="string"&&e.currentSrc.length>0?e.currentSrc:e.getAttribute("src")??null}),this.renderer.initialize(e);else if(s===e&&e&&this.hasVideoSourceChanged(e))f.debug("videoSwitch:rebind:sameElement",{previousSrc:this.lastVideoSource??null,newSrc:this.getVideoSource(e)}),this.renderer.destroy(),this.renderer.initialize(e);else if(!s&&!e){f.warn("videoSwitch:missingVideoElement",{lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId}),this.isSwitching=!1;return}let o=null;i&&(o=await this.fetchVideoApiData(i,n),o&&(this.persistVideoMetadata(o),this.lastVideoId=i));const l=await this.populateComments(i,n);if(l===0?(this.renderer.clearComments(),m.show("コメントを取得できませんでした","warning"),f.warn("videoSwitch:commentsMissing",{videoId:i??null})):f.info("videoSwitch:commentsLoaded",{videoId:i??null,count:l}),this.nextVideoId=null,this.preloadedComments=null,this.lastVideoSource=this.getVideoSource(e),o){const c=ft(o);if(c){const d=`コメントソースを更新しました: ${c.title??"不明なタイトル"}（${l}件）`;m.show(d,l>0?"success":"warning");}}}catch(e){f.error("videoSwitch:error",e,{nextVideoId:this.nextVideoId,lastVideoId:this.lastVideoId}),m.show(`動画切り替えエラー: ${e.message}`,"error"),this.renderer.clearComments();}finally{this.isSwitching=false;}}}async resolveVideoElement(t){if(t){const r=this.getVideoSource(t),i=this.lastVideoSource;return (!r||r===i)&&await this.waitForSourceChange(t),t}const e=Date.now()+pt;let n=null;for(;Date.now()<e;){const r=document.querySelector(y.watchVideoElement);if(r){n=r;const i=this.hasVideoSourceChanged(r);if(r.readyState>=2||!r.paused||i)return i&&(this.lastVideoSource=null),r}await new Promise(i=>window.setTimeout(i,gt));}return n}async waitForSourceChange(t){const e=this.getVideoSource(t);if(!e)return;const n=Date.now()+pt;for(;Date.now()<n;){const r=this.getVideoSource(t);if(r&&r!==e){this.lastVideoSource=null;return}await new Promise(i=>window.setTimeout(i,gt));}}hasVideoSourceChanged(t){const e=this.getVideoSource(t);return e?this.lastVideoSource?this.lastVideoSource!==e:true:false}getVideoSource(t){if(!t)return null;const e=typeof t.currentSrc=="string"?t.currentSrc:"";if(e.length>0)return e;const n=t.getAttribute("src")??"";if(n.length>0)return n;const r=t.querySelector("source[src]");return r&&typeof r.src=="string"&&r.src.length>0?r.src:null}resetRendererState(t){try{t.currentTime=0;}catch(e){f.debug("videoSwitch:resetCurrentTimeFailed",e);}this.renderer.clearComments();}async checkVideoEnd(){const t=this.renderer.getVideoElement();if(!(!t||!Number.isFinite(t.duration)||t.duration-t.currentTime>Me)){if(!this.nextVideoId){const n=async()=>{await this.findNextVideoId();};this.debounce.execOnce(n);}if(this.nextVideoId&&!this.preloadedComments){const n=async()=>{await this.preloadComments();};this.debounce.execOnce(n);}}}handleMissingVideoInfo(t){t||(this.renderer.clearComments(),m.show("次の動画のコメントを取得できませんでした。コメント表示をクリアします。","warning"));}async fetchVideoApiData(t,e){try{const n=await this.fetcher.fetchApiData(t);return f.debug("videoSwitch:apiFetched",{videoId:t}),n}catch(n){if(f.error("videoSwitch:apiFetchError",n,{videoId:t}),!e)throw n;return null}}persistVideoMetadata(t){const e=ft(t);e&&this.settingsManager.saveVideoData(e.title??"",e);}async populateComments(t,e){let n=null;if(Array.isArray(e)&&e.length>0)n=e;else if(t)try{n=await this.fetcher.fetchAllData(t),f.debug("videoSwitch:commentsFetched",{videoId:t,count:n.length});}catch(i){f.error("videoSwitch:commentsFetchError",i,{videoId:t}),m.show(`コメント取得エラー: ${i.message}`,"error"),n=null;}if(!n||n.length===0)return 0;const r=n.filter(i=>!this.renderer.isNGComment(i.text));return r.forEach(i=>{this.renderer.addComment(i.text,i.vpos,i.commands);}),this.lastPreloadedComments=[...r],r.length}async findNextVideoId(){try{const t=this.fetcher.lastApiData;if(!t)return;const e=t.series?.video?.next?.id;if(e){this.nextVideoId=e,f.debug("videoSwitch:detectedNext",{videoId:e});return}const n=t.video?.description??"";if(!n)return;const r=Ve(n);if(r.length===0)return;const i=[...r].sort((s,o)=>{const l=parseInt(s.replace(/^[a-z]{2}/i,""),10)||0;return (parseInt(o.replace(/^[a-z]{2}/i,""),10)||0)-l});this.nextVideoId=i[0]??null,this.nextVideoId&&f.debug("videoSwitch:candidateFromDescription",{candidate:this.nextVideoId});}catch(t){f.error("videoSwitch:nextIdError",t,{lastVideoId:this.lastVideoId});}}async preloadComments(){if(this.nextVideoId)try{const e=(await this.fetcher.fetchAllData(this.nextVideoId)).filter(n=>!this.renderer.isNGComment(n.text));this.preloadedComments=e.length>0?e:null,f.debug("videoSwitch:preloaded",{videoId:this.nextVideoId,count:e.length});}catch(t){f.error("videoSwitch:preloadError",t,{videoId:this.nextVideoId}),this.preloadedComments=null;}}}const Le=`
.nico-comment-shadow-host {
  display: block;
  position: relative;
}
`;class Rt{static initialize(){ue(Le);}}var ke="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7.07,18.28C7.5,17.38 10.12,16.5 12,16.5C13.88,16.5 16.5,17.38 16.93,18.28C15.57,19.36 13.86,20 12,20C10.14,20 8.43,19.36 7.07,18.28M18.36,16.83C16.93,15.09 13.46,14.5 12,14.5C10.54,14.5 7.07,15.09 5.64,16.83C4.62,15.5 4,13.82 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,13.82 19.38,15.5 18.36,16.83M12,6C10.06,6 8.5,7.56 8.5,9.5C8.5,11.44 10.06,13 12,13C13.94,13 15.5,11.44 15.5,9.5C15.5,7.56 13.94,6 12,6M12,11A1.5,1.5 0 0,1 10.5,9.5A1.5,1.5 0 0,1 12,8A1.5,1.5 0 0,1 13.5,9.5A1.5,1.5 0 0,1 12,11Z",Ie="M6 1V3H5C3.89 3 3 3.89 3 5V19C3 20.1 3.89 21 5 21H11.1C12.36 22.24 14.09 23 16 23C19.87 23 23 19.87 23 16C23 14.09 22.24 12.36 21 11.1V5C21 3.9 20.11 3 19 3H18V1H16V3H8V1M5 5H19V7H5M5 9H19V9.67C18.09 9.24 17.07 9 16 9C12.13 9 9 12.13 9 16C9 17.07 9.24 18.09 9.67 19H5M16 11.15C18.68 11.15 20.85 13.32 20.85 16C20.85 18.68 18.68 20.85 16 20.85C13.32 20.85 11.15 18.68 11.15 16C11.15 13.32 13.32 11.15 16 11.15M15 13V16.69L18.19 18.53L18.94 17.23L16.5 15.82V13Z",Te="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",_e="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10Z",Re="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M5,5V7H19V5H5M5,9V11H13V9H5M5,13V15H15V13H5Z",Fe="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10M6,7H18V9H6V7M6,11H15V13H6V11Z",ze="M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9M12,4.5C17,4.5 21.27,7.61 23,12C21.27,16.39 17,19.5 12,19.5C7,19.5 2.73,16.39 1,12C2.73,7.61 7,4.5 12,4.5M3.18,12C4.83,15.36 8.24,17.5 12,17.5C15.76,17.5 19.17,15.36 20.82,12C19.17,8.64 15.76,6.5 12,6.5C8.24,6.5 4.83,8.64 3.18,12Z",Oe="M5,4V7H10.5V19H13.5V7H19V4H5Z",Ne="M16,17H5V7H16L19.55,12M17.63,5.84C17.27,5.33 16.67,5 16,5H5A2,2 0 0,0 3,7V17A2,2 0 0,0 5,19H16C16.67,19 17.27,18.66 17.63,18.15L22,12L17.63,5.84Z",Pe="M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z",De="M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z",He="M8,5.14V19.14L19,12.14L8,5.14Z",qe="M17 19.1L19.5 20.6L18.8 17.8L21 15.9L18.1 15.7L17 13L15.9 15.6L13 15.9L15.2 17.8L14.5 20.6L17 19.1M3 14H11V16H3V14M3 6H15V8H3V6M3 10H15V12H3V10Z",$e="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z";function v(a,t=24){const e=String(t),n=String(t);return `<svg xmlns="http://www.w3.org/2000/svg" width="${e}" height="${n}" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true" focusable="false"><path d="${a}"></path></svg>`}const bt=v(He),Be=v(Te),We=v(De),Ue=v(Pe),U=v(_e),Ge=v(Ne),Ke=v(Oe),Ye=v(ke),je=v(ze),Xe=v(Fe),Ze=v(qe),Je=v(Ie),Qe=v(Re),tn=v($e),L=M("dAnime:SettingsUI"),h={searchInput:"#searchInput",searchButton:"#searchButton",openSearchPage:"#openSearchPageDirect",searchResults:"#searchResults",saveButton:"#saveSettings",opacitySelect:"#commentOpacity",visibilityToggle:"#commentVisibilityToggle",currentTitle:"#currentTitle",currentVideoId:"#currentVideoId",currentOwner:"#currentOwner",currentViewCount:"#currentViewCount",currentCommentCount:"#currentCommentCount",currentMylistCount:"#currentMylistCount",currentPostedAt:"#currentPostedAt",currentThumbnail:"#currentThumbnail",colorValue:".color-value",colorPreview:".color-preview",colorPickerInput:"#colorPickerInput",ngWords:"#ngWords",ngRegexps:"#ngRegexps",showNgWords:"#showNgWords",showNgRegexps:"#showNgRegexp",playCurrentVideo:"#playCurrentVideo",settingsModal:"#settingsModal",closeSettingsModal:"#closeSettingsModal",modalOverlay:".settings-modal__overlay",modalTabs:".settings-modal__tab",modalPane:".settings-modal__pane"},I=["search","display","ng"],yt=`
          ...
          <div id="currentVideoInfo" class="current-video-info">
            ...
            <div class="info-container" role="list">
              ...
              <div class="info-item" role="listitem" title="マイリスト数">
                <span class="info-icon" aria-hidden="true">${Ze}</span>
        ...
        <div class="settings-modal__content">
          ...
          <div class="settings-modal__tabs" role="tablist">
            ...
            <button class="settings-modal__tab" type="button" data-tab="display" role="tab" aria-selected="false" aria-controls="settingsPaneDisplay" id="settingsTabDisplay" tabindex="-1">
              <span class="settings-modal__tab-icon" aria-hidden="true">${We}</span>
...
`)}</textarea>
          ...
          <footer class="settings-modal__footer">
            <button id="playCurrentVideo" class="settings-modal__play-button" type="button" title="この動画を再生">
              <span class="settings-modal__play-icon" aria-hidden="true">${bt}</span>
...
`).map(r=>r.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings)?m.show("設定を保存しました","success"):m.show("設定の保存に失敗しました","error");}updateCurrentVideoInfo(t){this.currentVideoInfo=t,[["currentTitle",t.title??"-"],["currentVideoId",t.videoId??"-"],["currentOwner",t.owner?.nickname??t.channel?.name??"-"],["currentViewCount",this.formatNumber(t.viewCount)],["currentCommentCount",this.formatNumber(t.commentCount)],["currentMylistCount",this.formatNumber(t.mylistCount)],["currentPostedAt",this.formatSearchResultDate(t.postedAt)]].forEach(([r,i])=>{const s=this.querySelector(h[r]);s&&(s.textContent=i);});const n=this.querySelector(h.currentThumbnail);n&&t.thumbnail&&(n.src=t.thumbnail,n.alt=t.title??"サムネイル");try{this.settingsManager.saveVideoData(t.title??"",t);}catch(r){L.error("SettingsUI.updateCurrentVideoInfo",r);}this.updatePlayButtonState(t);}formatNumber(t){return typeof t=="number"?t.toLocaleString():"-"}formatSearchResultDate(t){if(!t)return "-";const e=new Date(t);return Number.isNaN(e.getTime())?t:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(e)}setupPlayButton(){const t=this.queryModalElement(h.playCurrentVideo);t&&(t.addEventListener("click",()=>{try{if(!this.currentVideoInfo?.videoId){m.show("再生できる動画が設定されていません","warning");return}const n=this.lastAutoButtonElement?.closest(".itemModule.list");if(this.lastAutoButtonElement){const r=n?.querySelector(".thumbnailContainer > a, .thumbnail-container > a");if(r){m.show(`「${this.currentVideoInfo?.title||"動画"}」を再生します...`,"success"),setTimeout(()=>{r.click();},300);return}}m.show("再生リンクが見つかりませんでした（対象アイテム内に限定して検索済み）","warning");}catch(e){L.error("SettingsUI.playCurrentVideo",e),m.show(`再生エラー: ${e.message}`,"error");}}),this.updatePlayButtonState(this.currentVideoInfo));}updatePlayButtonState(t){const e=this.queryModalElement(h.playCurrentVideo);if(!e)return;const n=!!t?.videoId;e.disabled=!n,e.setAttribute("aria-disabled",(!n).toString());}updateVisibilityToggleState(t){t.textContent=this.settings.isCommentVisible?"表示中":"非表示中",t.classList.toggle("off",!this.settings.isCommentVisible);}destroy(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),super.destroy();}createOrUpdateFab(){if(!document.body)return null;let t=this.fabHostElement;!t||!t.isConnected?(t?.remove(),t=document.createElement("div"),t.id=N.FAB_HOST_ID,t.style.position="fixed",t.style.bottom="32px",t.style.right="32px",t.style.zIndex="2147483646",t.style.display="inline-block",this.fabShadowRoot=t.attachShadow({mode:"open"}),document.body.appendChild(t),this.fabHostElement=t):this.fabShadowRoot||(this.fabShadowRoot=t.shadowRoot??t.attachShadow({mode:"open"}));const e=this.fabShadowRoot;if(!e)return null;let n=e.querySelector("style[data-role='fab-base-style']");n||(n=document.createElement("style"),n.dataset.role="fab-base-style",n.textContent=_.getCommonStyles(),e.appendChild(n));let r=e.querySelector("style[data-role='fab-style']");r||(r=document.createElement("style"),r.dataset.role="fab-style",r.textContent=`
      ...
      `,e.appendChild(r));let i=e.querySelector("style[data-role='similarity-style']");i||(i=document.createElement("style"),i.dataset.role="similarity-style",i.textContent=yt,e.appendChild(i));let s=e.querySelector("style[data-role='modal-play-button-style']");s||(s=document.createElement("style"),s.dataset.role="modal-play-button-style",s.textContent=en,e.appendChild(s));let o=e.querySelector(".fab-container");o||(o=document.createElement("div"),o.className="fab-container",e.appendChild(o));let l=o.querySelector("button.fab-button");l||(l=document.createElement("button"),l.type="button",l.className="fab-button",o.appendChild(l)),l.innerHTML=`
      <span class="fab-button__icon" aria-hidden="true">${U}</span>
      <span class="fab-button__label">設定</span>
    `,l.setAttribute("aria-label","ニコニココメント設定を開く"),l.setAttribute("aria-haspopup","dialog");let c=o.querySelector(h.settingsModal);return c||(o.insertAdjacentHTML("beforeend",this.buildModalHtml()),c=o.querySelector(h.settingsModal)),this.modalElement=c??null,l}removeFabElement(){this.fabElement&&this.fabElement.removeEventListener("click",this.handleFabClick),this.fabHostElement?.isConnected&&this.fabHostElement.remove(),this.fabElement=null,this.fabHostElement=null,this.fabShadowRoot=null;}queryModalElement(t){return this.fabShadowRoot?this.fabShadowRoot.querySelector(t):null}queryModalSelectorAll(t){return this.fabShadowRoot?this.fabShadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}}const vt=async()=>{},nn=()=>{const a=Y();if(!a.dAniRenderer){const t={};a.dAniRenderer={classes:{Comment:Ct,CommentRenderer:At,NicoApiFetcher:J,NotificationManager:m,StyleManager:Rt,SettingsUI:N,NicoVideoSearcher:Tt,VideoSwitchHandler:_t,SettingsManager:X,KeyboardShortcutHandler:Mt,DebounceExecutor:Q,ShadowDOMComponent:Z,ShadowStyleManager:_},instances:t,utils:{initialize:vt,initializeWithVideo:vt},debug:{showState:()=>{console.log("Current instances:",t);},showSettings:()=>{const e=t.settingsManager;if(!e){console.log("SettingsManager not initialized");return}console.log("Current settings:",e.getSettings());},showComments:()=>{const e=t.renderer;if(!e){console.log("CommentRenderer not initialized");return}console.log("Current comments:",e.getCommentsSnapshot());}},defaultSettings:E};}return a.dAniRenderer},rn=100,sn=1e3,on=3e3;class an{constructor(t){this.global=t;}initialized=false;switchDebounce=new Q(sn);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement();}async ensureDocumentReady(){document.readyState!=="complete"&&await new Promise(t=>{window.addEventListener("load",()=>t(),{once:true});});}waitForVideoElement(){if(this.initialized)return;const t=document.querySelector(y.watchVideoElement);if(!t){window.setTimeout(()=>this.waitForVideoElement(),rn);return}if(t.readyState===0){t.addEventListener("loadedmetadata",()=>{this.initializeWithVideo(t);},{once:true});return}this.initializeWithVideo(t);}async initializeWithVideo(t){if(!this.initialized){this.initialized=true;try{m.show("コメントローダーを初期化中...");const e=m.getInstance(),n=this.global.settingsManager??new X(e);this.global.settingsManager=n,this.global.instances.settingsManager=n;const r=n.loadVideoData();if(!r?.videoId)throw new Error("動画データが見つかりません。マイページで設定してください。");const i=new J;this.global.instances.fetcher=i,await i.fetchApiData(r.videoId);const s=await i.fetchComments(),o=this.mergeSettings(n.loadSettings()),l=new At(o);l.initialize(t),this.global.instances.renderer=l,this.currentVideoElement=t,n.addObserver(d=>{l.settings=this.mergeSettings(d);}),s.forEach(d=>{l.addComment(d.text,d.vpos,d.commands);});const c=new _t(l,i,n);c.startMonitoring(),this.global.instances.switchHandler=c,this.setupSwitchHandling(t,c),this.observeVideoElement(),m.show(`コメントの読み込みが完了しました（${s.length}件）`,"success");}catch(e){throw this.initialized=false,m.show(`初期化エラー: ${e.message}`,"error"),e}}}mergeSettings(t){const e=E();return {...e,...t,ngWords:[...t.ngWords??e.ngWords],ngRegexps:[...t.ngRegexps??e.ngRegexps]}}setupSwitchHandling(t,e){this.currentVideoElement=t,this.switchCallback=()=>{const n=Date.now();if(n-this.lastSwitchTimestamp<on)return;this.lastSwitchTimestamp=n;const r=this.currentVideoElement;e.onVideoSwitch(r);},this.global.utils.initializeWithVideo=async n=>{n&&(this.rebindVideoElement(n),await e.onVideoSwitch(n));},this.currentVideoElement=t;}observeVideoElement(){const t=this.currentVideoElement;t&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{const e=document.querySelector(y.watchVideoElement);!e||e===this.currentVideoElement||this.rebindVideoElement(e);}),this.domMutationObserver.observe(document.body,{childList:true,subtree:true}),this.attachVideoEventListeners(t));}rebindVideoElement(t){this.detachVideoEventListeners(),this.currentVideoElement=t;const e=this.global.instances.renderer,n=this.global.instances.switchHandler;e&&(e.destroy(),e.initialize(t),e.resize()),n&&(n.onVideoSwitch(t),this.setupSwitchHandling(t,n)),this.attachVideoEventListeners(t);}attachVideoEventListeners(t){this.detachVideoEventListeners();const e=()=>{this.switchCallback&&(this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));};t.addEventListener("ended",e),t.addEventListener("loadedmetadata",e),t.addEventListener("emptied",e),this.videoEndedListener=e;}detachVideoEventListeners(){const t=this.currentVideoElement;t&&this.videoEndedListener&&(t.removeEventListener("ended",this.videoEndedListener),t.removeEventListener("loadedmetadata",this.videoEndedListener),t.removeEventListener("emptied",this.videoEndedListener)),this.videoEndedListener=null;}}const ln=100;class cn{constructor(t){this.global=t;}initialize(){const t=m.getInstance(),e=this.global.settingsManager??new X(t);this.global.settingsManager=e,this.global.instances.settingsManager=e;const n=new N(e);this.waitForHeader(n);}waitForHeader(t){if(!document.querySelector(y.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(t),ln);return}t.insertIntoMypage(),t.addAutoCommentButtons(),this.observeList(t);}observeList(t){const e=document.querySelector(y.mypageListContainer);if(!e)return;new MutationObserver(()=>{try{t.addAutoCommentButtons();}catch(r){console.error("[MypageController] auto comment buttons update failed",r);}}).observe(e,{childList:true,subtree:true});}}class dn{log;global=nn();watchController=null;mypageController=null;constructor(){this.log=M("DanimeApp");}start(){this.log.info("starting renderer"),Rt.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener("load",()=>{this.initialize();});}async initialize(){if(!this.acquireInstanceLock()){this.log.info("renderer already initialized, skipping");return}const t=location.pathname.toLowerCase();try{t.includes("/animestore/sc_d_pc")?(this.watchController=new an(this.global),await this.watchController.initialize()):t.includes("/animestore/mp_viw_pc")?(this.mypageController=new cn(this.global),this.mypageController.initialize()):this.log.info("page not supported, initialization skipped");}catch(e){this.log.error("initialization failed",e);}}acquireInstanceLock(){const t=Y();return t.__dAnimeNicoCommentRenderer2Instance=(t.__dAnimeNicoCommentRenderer2Instance??0)+1,t.__dAnimeNicoCommentRenderer2Instance===1}}const G=M("dAnimeNicoCommentRenderer2");async function hn(){G.info("bootstrap start");try{new dn().start(),G.info("bootstrap completed");}catch(a){G.error("bootstrap failed",a);}}hn();
