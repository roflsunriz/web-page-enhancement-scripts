...
(function () {
  ...
  const lt={debug:"debug",info:"info",warn:"warn",error:"error"},_=a=>{const t=`[${a}]`,e={};return Object.keys(lt).forEach(n=>{const r=lt[n];e[n]=(...i)=>{(console[r]??console.log)(t,...i);};}),e};function tt(){return typeof unsafeWindow<"u"?unsafeWindow:window}const ct={debug:0,info:1,warn:2,error:3},Zt=(a,t,e)=>{const n=[`[${t}]`,...e];switch(a){case "debug":console.debug(...n);break;case "info":console.info(...n);break;case "warn":console.warn(...n);break;case "error":console.error(...n);break;default:console.log(...n);}},kt=(a,t={})=>{const{level:e="info",emitter:n=Zt}=t,r=ct[e],i=(s,o)=>{ct[s]<r||n(s,a,o);};return {debug:(...s)=>i("debug",s),info:(...s)=>i("info",s),warn:(...s)=>i("warn",s),error:(...s)=>i("error",s)}},Qt={small:.8,medium:1,big:1.4},te={defont:'"MS PGothic","Hiragino Kaku Gothic ProN","Hiragino Kaku Gothic Pro","Yu Gothic UI","Yu Gothic","Meiryo","Segoe UI","Osaka","Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","IPAPGothic","TakaoPGothic","Roboto","Helvetica Neue","Helvetica","Arial","sans-serif"',gothic:'"Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","Yu Gothic","Yu Gothic Medium","Meiryo","MS PGothic","Hiragino Kaku Gothic ProN","Segoe UI","Helvetica","Arial","sans-serif"',mincho:'"MS PMincho","MS Mincho","Hiragino Mincho ProN","Hiragino Mincho Pro","Yu Mincho","Noto Serif CJK JP","Noto Serif JP","Source Han Serif JP","Times New Roman","serif"'},Tt={white:"#FFFFFF",red:"#FF0000",pink:"#FF8080",orange:"#FF9900",yellow:"#FFFF00",green:"#00FF00",cyan:"#00FFFF",blue:"#0000FF",purple:"#C000FF",black:"#000000",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},et=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,ee=/^[,.:;]+/,ne=/[,.:;]+$/,re=a=>{const t=a.trim();return t?et.test(t)?t:t.replace(ee,"").replace(ne,""):""},ie=a=>et.test(a)?a.toUpperCase():null,It=a=>{const t=a.trim();if(!t)return null;const e=t.toLowerCase().endsWith("px")?t.slice(0,-2):t,n=Number.parseFloat(e);return Number.isFinite(n)?n:null},se=a=>{const t=a.trim();if(!t)return null;if(t.endsWith("%")){const e=Number.parseFloat(t.slice(0,-1));return Number.isFinite(e)?e/100:null}return It(t)},oe=a=>Number.isFinite(a)?Math.min(100,Math.max(-100,a)):0,ae=a=>!Number.isFinite(a)||a===0?1:Math.min(5,Math.max(.25,a)),le=a=>a==="naka"||a==="ue"||a==="shita",ce=a=>a==="small"||a==="medium"||a==="big",de=a=>a==="defont"||a==="gothic"||a==="mincho",he=a=>a in Tt,ue=(a,t)=>{let e="naka",n="medium",r="defont",i=null,s=1,o=null,l=false,c=0,h=1;for(const b of a){const y=re(typeof b=="string"?b:"");if(!y)continue;if(et.test(y)){const v=ie(y);if(v){i=v;continue}}const p=y.toLowerCase();if(le(p)){e=p;continue}if(ce(p)){n=p;continue}if(de(p)){r=p;continue}if(he(p)){i=Tt[p].toUpperCase();continue}if(p==="_live"){o=.5;continue}if(p==="invisible"){s=0,l=true;continue}if(p.startsWith("ls:")||p.startsWith("letterspacing:")){const v=y.indexOf(":");if(v>=0){const C=It(y.slice(v+1));C!==null&&(c=oe(C));}continue}if(p.startsWith("lh:")||p.startsWith("lineheight:")){const v=y.indexOf(":");if(v>=0){const C=se(y.slice(v+1));C!==null&&(h=ae(C));}continue}}const d=Math.max(0,Math.min(1,s)),u=(i??t.defaultColor).toUpperCase(),g=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:e,size:n,sizeScale:Qt[n],font:r,fontFamily:te[r],resolvedColor:u,colorOverride:i,opacityMultiplier:d,opacityOverride:g,isInvisible:l,letterSpacing:c,lineHeight:h}},U=kt("CommentEngine:Comment"),F=4e3,pe=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,D=a=>!Number.isFinite(a)||a<=0?0:a>=1?1:a,P=a=>a.length===1?a.repeat(2):a,L=a=>Number.parseInt(a,16),me=(a,t)=>{const e=pe.exec(a);if(!e)return a;const n=e[1];let r,i,s,o=1;n.length===3||n.length===4?(r=L(P(n[0])),i=L(P(n[1])),s=L(P(n[2])),n.length===4&&(o=L(P(n[3]))/255)):(r=L(n.slice(0,2)),i=L(n.slice(2,4)),s=L(n.slice(4,6)),n.length===8&&(o=L(n.slice(6,8))/255));const l=D(o*D(t));return `rgba(${r}, ${i}, ${s}, ${l})`},ge=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),_t=()=>ge(),fe=a=>a==="ltr"?"ltr":"rtl",be=a=>a==="ltr"?1:-1;class Rt{text;vpos;commands;layout;isScrolling;sizeScale;opacityMultiplier;opacityOverride;colorOverride;isInvisible;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily;opacity;activationTimeMs=null;staticExpiryTimeMs=null;isActive=false;hasShown=false;isPaused=false;lastUpdateTime=0;reservationWidth=0;bufferWidth=0;visibleDurationMs=0;totalDurationMs=0;preCollisionDurationMs=0;speedPixelsPerMs=0;virtualStartX=0;exitThreshold=0;scrollDirection="rtl";renderStyle="outline-only";creationIndex=0;letterSpacing=0;lineHeightMultiplier=1;lineHeightPx=0;lines=[];directionSign=-1;timeSource;constructor(t,e,n,r,i={}){if(typeof t!="string")throw new Error("Comment text must be a string");if(!Number.isFinite(e)||e<0)throw new Error("Comment vpos must be a non-negative number");this.text=t,this.vpos=e,this.commands=Array.isArray(n)?[...n]:[];const s=ue(this.commands,{defaultColor:r.commentColor});this.layout=s.layout,this.isScrolling=this.layout==="naka",this.sizeScale=s.sizeScale,this.opacityMultiplier=s.opacityMultiplier,this.opacityOverride=s.opacityOverride,this.colorOverride=s.colorOverride,this.isInvisible=s.isInvisible,this.fontFamily=s.fontFamily,this.color=s.resolvedColor,this.opacity=this.getEffectiveOpacity(r.commentOpacity),this.renderStyle=r.renderStyle,this.letterSpacing=s.letterSpacing,this.lineHeightMultiplier=s.lineHeight,this.timeSource=i.timeSource??_t(),this.applyScrollDirection(r.scrollDirection),this.syncWithSettings(r);}prepare(t,e,n,r){try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(e)||!Number.isFinite(n))throw new Error("Canvas dimensions must be numbers");if(!r)throw new Error("Prepare options are required");const i=Math.max(e,1),s=Math.max(24,Math.floor(n*.05)),o=Math.max(24,Math.floor(s*this.sizeScale));this.fontSize=o,t.font=`${this.fontSize}px ${this.fontFamily}`;const l=this.text.includes(`
`)?this.text.split(/\r?\n/):[this.text];this.lines=l.length>0?l:[""];let c=0;const h=this.letterSpacing;for(const V of this.lines){const B=t.measureText(V).width,Jt=V.length>1?h*(V.length-1):0,at=Math.max(0,B+Jt);at>c&&(c=at);}this.width=c;const d=Math.max(1,Math.floor(this.fontSize*this.lineHeightMultiplier));if(this.lineHeightPx=d,this.height=this.fontSize+(this.lines.length>1?(this.lines.length-1)*d:0),!this.isScrolling){this.bufferWidth=0;const V=Math.max((i-this.width)/2,0);this.virtualStartX=V,this.x=V,this.baseSpeed=0,this.speed=0,this.speedPixelsPerMs=0,this.visibleDurationMs=F,this.preCollisionDurationMs=F,this.totalDurationMs=F,this.reservationWidth=this.width,this.staticExpiryTimeMs=this.vpos+F,this.lastUpdateTime=this.timeSource.now(),this.isPaused=!1;return}this.staticExpiryTimeMs=null;const u=t.measureText("??".repeat(150)).width,g=this.width*Math.max(r.bufferRatio,0);this.bufferWidth=Math.max(r.baseBufferPx,g);const b=Math.max(r.entryBufferPx,this.bufferWidth),y=this.scrollDirection,p=y==="rtl"?i+r.virtualExtension:-this.width-this.bufferWidth-r.virtualExtension,v=y==="rtl"?-this.width-this.bufferWidth-b:i+b,C=y==="rtl"?i+b:-b,S=y==="rtl"?p+this.width+this.bufferWidth:p-this.bufferWidth;this.virtualStartX=p,this.x=p,this.exitThreshold=v;const k=i>0?this.width/i:0,x=r.maxVisibleDurationMs===r.minVisibleDurationMs;let q=r.maxVisibleDurationMs;if(!x&&k>1){const V=Math.min(k,r.maxWidthRatio),B=r.maxVisibleDurationMs/Math.max(V,1);q=Math.max(r.minVisibleDurationMs,Math.floor(B));}const Ut=i+this.width+this.bufferWidth+b,Gt=Math.max(q,1),$=Ut/Gt,Kt=$*1e3/60;this.baseSpeed=Kt,this.speed=this.baseSpeed,this.speedPixelsPerMs=$;const Yt=Math.abs(v-p),jt=y==="rtl"?Math.max(0,S-C):Math.max(0,C-S),ot=Math.max($,Number.EPSILON);this.visibleDurationMs=q,this.preCollisionDurationMs=Math.max(0,Math.ceil(jt/ot)),this.totalDurationMs=Math.max(this.preCollisionDurationMs,Math.ceil(Yt/ot));const Xt=this.width+this.bufferWidth+b;this.reservationWidth=Math.min(u,Xt),this.lastUpdateTime=this.timeSource.now(),this.isPaused=!1;}catch(i){throw U.error("Comment.prepare",i,{text:this.text,visibleWidth:e,canvasHeight:n,hasContext:!!t}),i}}update(t=1,e=false){try{if(!this.isActive){this.isPaused=e;return}const n=this.timeSource.now();if(!this.isScrolling){this.isPaused=e,this.lastUpdateTime=n;return}if(e){this.isPaused=!0,this.lastUpdateTime=n;return}const r=(n-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*t,this.x+=this.speed*r*this.directionSign,(this.scrollDirection==="rtl"&&this.x<=this.exitThreshold||this.scrollDirection==="ltr"&&this.x>=this.exitThreshold)&&(this.isActive=!1),this.lastUpdateTime=n,this.isPaused=!1;}catch(n){U.error("Comment.update",n,{text:this.text,playbackRate:t,isPaused:e,isActive:this.isActive});}}draw(t,e=null){try{if(!this.isActive||!t)return;t.save(),t.font=`${this.fontSize}px ${this.fontFamily}`;const n=D(this.opacity),r=e??this.x,i=this.lines.length>0?this.lines:[this.text],s=this.lines.length>1&&this.lineHeightPx>0?this.lineHeightPx:this.fontSize,o=this.y+this.fontSize,l=(d,u,g)=>{if(d.length===0)return;if(Math.abs(this.letterSpacing)<Number.EPSILON){g==="stroke"?t.strokeText(d,r,u):t.fillText(d,r,u);return}let b=r;for(let y=0;y<d.length;y+=1){const p=d[y];g==="stroke"?t.strokeText(p,b,u):t.fillText(p,b,u);const v=t.measureText(p),C=Number.isFinite(v.width)?v.width:0;b+=C,y<d.length-1&&(b+=this.letterSpacing);}},c=()=>{t.globalAlpha=n,t.strokeStyle="#000000",t.lineWidth=Math.max(3,this.fontSize/8),t.lineJoin="round",i.forEach((d,u)=>{const g=o+u*s;l(d,g,"stroke");}),t.globalAlpha=1;},h=()=>{i.forEach((d,u)=>{const g=o+u*s;l(d,g,"fill");});};if(c(),this.renderStyle==="classic"){const d=Math.max(1,this.fontSize*.04),u=this.fontSize*.18;[{offsetXMultiplier:.9,offsetYMultiplier:1.1,blurMultiplier:.55,alpha:.52,rgb:"20, 28, 40"},{offsetXMultiplier:2.4,offsetYMultiplier:2.7,blurMultiplier:1.45,alpha:.32,rgb:"0, 0, 0"},{offsetXMultiplier:-.7,offsetYMultiplier:-.6,blurMultiplier:.4,alpha:.42,rgb:"255, 255, 255"}].forEach(g=>{const b=D(g.alpha*n);t.shadowColor=`rgba(${g.rgb}, ${b})`,t.shadowBlur=u*g.blurMultiplier,t.shadowOffsetX=d*g.offsetXMultiplier,t.shadowOffsetY=d*g.offsetYMultiplier,t.fillStyle="rgba(0, 0, 0, 0)",h();}),t.shadowColor="transparent",t.shadowBlur=0,t.shadowOffsetX=0,t.shadowOffsetY=0;}else t.shadowColor="transparent",t.shadowBlur=0,t.shadowOffsetX=0,t.shadowOffsetY=0;t.globalAlpha=1,t.fillStyle=me(this.color,n),h(),t.restore();}catch(n){U.error("Comment.draw",n,{text:this.text,isActive:this.isActive,hasContext:!!t,interpolatedX:e});}}syncWithSettings(t){this.color=this.getEffectiveColor(t.commentColor),this.opacity=this.getEffectiveOpacity(t.commentOpacity),this.applyScrollDirection(t.scrollDirection),this.renderStyle=t.renderStyle;}getEffectiveColor(t){const e=this.colorOverride??t;return typeof e!="string"||e.length===0?t:e.toUpperCase()}getEffectiveOpacity(t){if(typeof this.opacityOverride=="number")return D(this.opacityOverride);const e=t*this.opacityMultiplier;return Number.isFinite(e)?D(e):0}markActivated(t){this.activationTimeMs=t;}clearActivation(){this.activationTimeMs=null,this.isScrolling||(this.staticExpiryTimeMs=null);}hasStaticExpired(t){return this.isScrolling||this.staticExpiryTimeMs===null?false:t>=this.staticExpiryTimeMs}getDirectionSign(){return this.directionSign}applyScrollDirection(t){const e=fe(t);this.scrollDirection=e,this.directionSign=be(e);}}const ye=4e3,G={commentColor:"#FFFFFF",commentOpacity:1,isCommentVisible:true,useContainerResizeObserver:true,ngWords:[],ngRegexps:[],scrollDirection:"rtl",renderStyle:"outline-only",syncMode:"raf",scrollVisibleDurationMs:ye,useFixedLaneCount:false,fixedLaneCount:12,useDprScaling:true},Ft=()=>({...G,ngWords:[...G.ngWords],ngRegexps:[...G.ngRegexps]}),T=a=>a*1e3,ve=10,xe=a=>{if(!Number.isFinite(a))return 0;const t=Math.max(0,a);return Math.round(t*ve)},Dt=4e3,we=1800,Se=3,Ce=.25,Ee=32,Me=48,z=120,Ae=4e3,dt=F+Dt,Ve=1e3,ht=1,ut=12,pt=24,A=.001,mt=50,Le=a=>Number.isFinite(a)?a<=0?0:a>=1?1:a:1,O=a=>{const t=a.scrollVisibleDurationMs,e=t==null?null:Number.isFinite(t)?Math.max(1,Math.floor(t)):null;return {...a,scrollDirection:a.scrollDirection==="ltr"?"ltr":"rtl",commentOpacity:Le(a.commentOpacity),renderStyle:a.renderStyle==="classic"?"classic":"outline-only",scrollVisibleDurationMs:e,syncMode:a.syncMode==="video-frame"?"video-frame":"raf",useDprScaling:!!a.useDprScaling}},ke=a=>typeof window<"u"&&typeof window.requestAnimationFrame=="function"&&typeof window.cancelAnimationFrame=="function"?{request:t=>window.requestAnimationFrame(t),cancel:t=>window.cancelAnimationFrame(t)}:{request:t=>globalThis.setTimeout(()=>{t(a.now());},16),cancel:t=>{globalThis.clearTimeout(t);}},Te=()=>typeof document>"u"?()=>{throw new Error("Document is not available. Provide a custom createCanvasElement implementation.")}:()=>document.createElement("canvas"),Ie=a=>{if(!a||typeof a!="object")return  false;const t=a;return typeof t.commentColor=="string"&&typeof t.commentOpacity=="number"&&typeof t.isCommentVisible=="boolean"};class gt{_settings;comments=[];reservedLanes=new Map;topStaticLaneReservations=new Map;bottomStaticLaneReservations=new Map;log;timeSource;animationFrameProvider;createCanvasElement;commentDependencies;canvas=null;ctx=null;videoElement=null;containerElement=null;laneCount=ut;laneHeight=0;displayWidth=0;displayHeight=0;canvasDpr=1;currentTime=0;duration=0;playbackRate=1;isPlaying=true;lastDrawTime=0;finalPhaseActive=false;frameId=null;videoFrameHandle=null;resizeObserver=null;resizeObserverTarget=null;isResizeObserverAvailable=typeof ResizeObserver<"u";cleanupTasks=[];commentSequence=0;constructor(t=null,e=void 0){let n,r;if(Ie(t))n=O({...t}),r=e??{};else {const i=t??e??{};r=typeof i=="object"?i:{},n=O(Ft());}this.timeSource=r.timeSource??_t(),this.animationFrameProvider=r.animationFrameProvider??ke(this.timeSource),this.createCanvasElement=r.createCanvasElement??Te(),this.commentDependencies={timeSource:this.timeSource},this._settings=O(n),this.log=kt(r.loggerNamespace??"CommentRenderer");}get settings(){return this._settings}set settings(t){this._settings=O(t);}resolveContainer(t,e){if(t)return t;if(e.parentElement)return e.parentElement;if(typeof document<"u"&&document.body)return document.body;throw new Error("Cannot resolve container element. Provide container explicitly when DOM is unavailable.")}ensureContainerPositioning(t){if(typeof getComputedStyle=="function"){getComputedStyle(t).position==="static"&&(t.style.position="relative");return}t.style.position||(t.style.position="relative");}initialize(t){try{this.destroyCanvasOnly();const e=t instanceof HTMLVideoElement?t:t.video,n=t instanceof HTMLVideoElement?t.parentElement:t.container??t.video.parentElement,r=this.resolveContainer(n??null,e);this.videoElement=e,this.containerElement=r,this.duration=Number.isFinite(e.duration)?T(e.duration):0,this.currentTime=T(e.currentTime),this.playbackRate=e.playbackRate,this.isPlaying=!e.paused,this.lastDrawTime=this.timeSource.now();const i=this.createCanvasElement(),s=i.getContext("2d");if(!s)throw new Error("Failed to acquire 2D canvas context");i.style.position="absolute",i.style.top="0",i.style.left="0",i.style.pointerEvents="none",i.style.zIndex="1000";const o=this.containerElement;o instanceof HTMLElement&&(this.ensureContainerPositioning(o),o.appendChild(i)),this.canvas=i,this.ctx=s,this.resize(),this.calculateLaneMetrics(),this.setupVideoEventListeners(e),this.setupResizeHandling(e),this.setupVideoChangeDetection(e,r),this.startAnimation();}catch(e){throw this.log.error("CommentRenderer.initialize",e),e}}addComment(t,e,n=[]){if(this.isNGComment(t))return null;const r=xe(e);if(this.comments.some(s=>s.text===t&&s.vpos===r))return null;const i=new Rt(t,r,n,this._settings,this.commentDependencies);return i.creationIndex=this.commentSequence++,this.comments.push(i),this.comments.sort((s,o)=>{const l=s.vpos-o.vpos;return Math.abs(l)>A?l:s.creationIndex-o.creationIndex}),i}clearComments(){if(this.comments.length=0,this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear(),this.commentSequence=0,this.ctx&&this.canvas){const t=this.canvasDpr>0?this.canvasDpr:1,e=this.displayWidth>0?this.displayWidth:this.canvas.width/t,n=this.displayHeight>0?this.displayHeight:this.canvas.height/t;this.ctx.clearRect(0,0,e,n);}}resetState(){this.clearComments(),this.currentTime=0,this.finalPhaseActive=false;}destroy(){this.stopAnimation(),this.cleanupResizeHandling(),this.runCleanupTasks(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.videoElement=null,this.containerElement=null,this.comments.length=0,this.reservedLanes.clear(),this.finalPhaseActive=false,this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1,this.commentSequence=0;}updateSettings(t){const e=this._settings.useContainerResizeObserver,n=this._settings.scrollDirection,r=this._settings.useDprScaling,i=this._settings.syncMode;this.settings=t;const s=n!==this._settings.scrollDirection,o=r!==this._settings.useDprScaling,l=i!==this._settings.syncMode;if(this.comments.forEach(c=>{c.syncWithSettings(this._settings);}),s&&this.resetCommentActivity(),!this._settings.isCommentVisible&&this.ctx&&this.canvas){this.comments.forEach(u=>{u.isActive=false,u.clearActivation();});const c=this.canvasDpr>0?this.canvasDpr:1,h=this.displayWidth>0?this.displayWidth:this.canvas.width/c,d=this.displayHeight>0?this.displayHeight:this.canvas.height/c;this.ctx.clearRect(0,0,h,d),this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear();}e!==this._settings.useContainerResizeObserver&&this.videoElement&&this.setupResizeHandling(this.videoElement),o&&this.resize(),l&&this.videoElement&&this.startAnimation();}getVideoElement(){return this.videoElement}getCurrentVideoSource(){const t=this.videoElement;if(!t)return null;if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const e=t.getAttribute("src");if(e&&e.length>0)return e;const n=t.querySelector("source[src]");return n&&typeof n.src=="string"?n.src:null}getCommentsSnapshot(){return [...this.comments]}isNGComment(t){try{if(typeof t!="string")return !0;if(Array.isArray(this._settings.ngWords)&&this._settings.ngWords.length>0){const e=t.toLowerCase();if(this._settings.ngWords.some(n=>{if(typeof n!="string")return !1;const r=n.trim().toLowerCase();return r.length===0?!1:e.includes(r)}))return !0}return Array.isArray(this._settings.ngRegexps)?this._settings.ngRegexps.some(e=>{if(typeof e!="string"||e.length===0)return !1;try{return new RegExp(e).test(t)}catch(n){return this.log.error("CommentRenderer.isNGComment.regex",n,{pattern:e,text:t}),!1}}):!1}catch(e){return this.log.error("CommentRenderer.isNGComment",e,{text:t}),true}}resize(t,e){const n=this.videoElement,r=this.canvas,i=this.ctx;if(!n||!r)return;const s=n.getBoundingClientRect(),o=this.canvasDpr>0?this.canvasDpr:1,l=this.displayWidth>0?this.displayWidth:r.width/o,c=this.displayHeight>0?this.displayHeight:r.height/o,h=t??s.width??l,d=e??s.height??c;if(!Number.isFinite(h)||!Number.isFinite(d)||h<=0||d<=0)return;const u=Math.max(1,Math.floor(h)),g=Math.max(1,Math.floor(d)),b=this.displayWidth>0?this.displayWidth:u,y=this.displayHeight>0?this.displayHeight:g,p=this._settings.useDprScaling?this.resolveDevicePixelRatio():1,v=Math.max(1,Math.round(u*p)),C=Math.max(1,Math.round(g*p));if(!(this.displayWidth!==u||this.displayHeight!==g||Math.abs(this.canvasDpr-p)>Number.EPSILON||r.width!==v||r.height!==C))return;this.displayWidth=u,this.displayHeight=g,this.canvasDpr=p,r.width=v,r.height=C,r.style.width=`${u}px`,r.style.height=`${g}px`,i&&(i.setTransform(1,0,0,1,0,0),this._settings.useDprScaling&&i.scale(p,p));const S=b>0?u/b:1,k=y>0?g/y:1;(S!==1||k!==1)&&this.comments.forEach(x=>{x.isActive&&(x.x*=S,x.y*=k,x.width*=S,x.fontSize=Math.max(pt,Math.floor(Math.max(1,x.fontSize)*k)),x.height=x.fontSize,x.virtualStartX*=S,x.exitThreshold*=S,x.baseSpeed*=S,x.speed*=S,x.speedPixelsPerMs*=S,x.bufferWidth*=S,x.reservationWidth*=S);}),this.calculateLaneMetrics();}resolveDevicePixelRatio(){if(typeof window>"u")return 1;const t=Number(window.devicePixelRatio);return !Number.isFinite(t)||t<=0?1:t}destroyCanvasOnly(){this.stopAnimation(),this.cleanupResizeHandling(),this.runCleanupTasks(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1;}calculateLaneMetrics(){const t=this.canvas;if(!t)return;const e=this.displayHeight>0?this.displayHeight:t.height/Math.max(this.canvasDpr,1),n=Math.max(pt,Math.floor(e*.05));this.laneHeight=n*1.2;const r=Math.floor(e/Math.max(this.laneHeight,1));if(this._settings.useFixedLaneCount){const i=Number.isFinite(this._settings.fixedLaneCount)?Math.floor(this._settings.fixedLaneCount):ut,s=Math.max(ht,Math.min(r,i));this.laneCount=s;}else this.laneCount=Math.max(ht,r);this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear();}updateComments(t){const e=this.videoElement,n=this.canvas,r=this.ctx;if(!e||!n||!r)return;const i=typeof t=="number"?t:T(e.currentTime);this.currentTime=i,this.playbackRate=e.playbackRate,this.isPlaying=!e.paused;const s=this.canvasDpr>0?this.canvasDpr:1,o=this.displayWidth>0?this.displayWidth:n.width/s,l=this.displayHeight>0?this.displayHeight:n.height/s,c=this.buildPrepareOptions(o),h=this.duration>0&&this.duration-this.currentTime<=Ae;h&&!this.finalPhaseActive&&(this.finalPhaseActive=true,r.clearRect(0,0,o,l),this.comments.forEach(d=>{d.isActive=false,d.clearActivation();}),this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear()),!h&&this.finalPhaseActive&&(this.finalPhaseActive=false),this.pruneStaticLaneReservations(this.currentTime);for(const d of this.comments)if(!this.isNGComment(d.text)){if(d.isInvisible){d.isActive=false,d.hasShown=true,d.clearActivation();continue}if(d.syncWithSettings(this._settings),this.shouldActivateCommentAtTime(d,this.currentTime)&&this.activateComment(d,r,o,l,c,this.currentTime),d.isActive){if(d.layout!=="naka"&&d.hasStaticExpired(this.currentTime)){const u=d.layout==="ue"?"ue":"shita";this.releaseStaticLane(u,d.lane),d.isActive=false,d.clearActivation();continue}if(d.layout==="naka"&&d.vpos>this.currentTime+mt){d.x=d.virtualStartX,d.lastUpdateTime=this.timeSource.now();continue}if(d.hasShown=true,d.update(this.playbackRate,!this.isPlaying),!d.isScrolling&&d.hasStaticExpired(this.currentTime)){const u=d.layout==="ue"?"ue":"shita";this.releaseStaticLane(u,d.lane),d.isActive=false,d.clearActivation();}}}for(const d of this.comments)d.isActive&&d.isScrolling&&(d.scrollDirection==="rtl"&&d.x<=d.exitThreshold||d.scrollDirection==="ltr"&&d.x>=d.exitThreshold)&&(d.isActive=false,d.clearActivation());}buildPrepareOptions(t){const e=this._settings.scrollVisibleDurationMs;return {visibleWidth:t,virtualExtension:Ve,maxVisibleDurationMs:e!==null?e:Dt,minVisibleDurationMs:e!==null?e:we,maxWidthRatio:Se,bufferRatio:Ce,baseBufferPx:Ee,entryBufferPx:Me}}findAvailableLane(t){const e=this.currentTime;this.pruneLaneReservations(e),this.pruneStaticLaneReservations(e);const n=this.getLanePriorityOrder(e),r=this.createLaneReservation(t,e);for(const s of n)if(this.isLaneAvailable(s,r,e))return this.storeLaneReservation(s,r),s;const i=n[0]??0;return this.storeLaneReservation(i,r),i}pruneLaneReservations(t){for(const[e,n]of this.reservedLanes.entries()){const r=n.filter(i=>i.totalEndTime+z>t);r.length>0?this.reservedLanes.set(e,r):this.reservedLanes.delete(e);}}pruneStaticLaneReservations(t){for(const[e,n]of this.topStaticLaneReservations.entries())n<=t&&this.topStaticLaneReservations.delete(e);for(const[e,n]of this.bottomStaticLaneReservations.entries())n<=t&&this.bottomStaticLaneReservations.delete(e);}getStaticLaneMap(t){return t==="ue"?this.topStaticLaneReservations:this.bottomStaticLaneReservations}getStaticReservedLaneSet(){const t=new Set;for(const e of this.topStaticLaneReservations.keys())t.add(e);for(const e of this.bottomStaticLaneReservations.keys())t.add(e);return t}shouldActivateCommentAtTime(t,e){return !(t.isInvisible||t.isActive||t.vpos>e+mt||t.vpos<e-dt)}activateComment(t,e,n,r,i,s){if(t.prepare(e,n,r,i),t.layout==="naka"){const h=Math.max(0,s-t.vpos),d=t.speedPixelsPerMs*h,u=t.getDirectionSign(),g=t.virtualStartX+u*d,b=t.exitThreshold,y=t.scrollDirection;if(y==="rtl"&&g<=b||y==="ltr"&&g>=b){t.isActive=false,t.hasShown=true,t.clearActivation(),t.lane=-1;return}t.lane=this.findAvailableLane(t),t.y=t.lane*this.laneHeight,t.x=g,t.isActive=true,t.hasShown=true,t.isPaused=!this.isPlaying,t.markActivated(s),t.lastUpdateTime=this.timeSource.now();return}const o=t.vpos+F;if(s>o){t.isActive=false,t.hasShown=true,t.clearActivation(),t.lane=-1;return}const l=t.layout==="ue"?"ue":"shita",c=this.assignStaticLane(l);t.lane=c,t.y=c*this.laneHeight,t.x=t.virtualStartX,t.isActive=true,t.hasShown=true,t.isPaused=!this.isPlaying,t.markActivated(s),t.lastUpdateTime=this.timeSource.now(),t.staticExpiryTimeMs=o,this.reserveStaticLane(l,c,o);}assignStaticLane(t){const e=this.getStaticLaneMap(t),n=Array.from({length:this.laneCount},(s,o)=>o);t==="shita"&&n.reverse();for(const s of n)if(!e.has(s))return s;let r=n[0]??0,i=Number.POSITIVE_INFINITY;for(const[s,o]of e.entries())o<i&&(i=o,r=s);return r}reserveStaticLane(t,e,n){this.getStaticLaneMap(t).set(e,n);}releaseStaticLane(t,e){e<0||this.getStaticLaneMap(t).delete(e);}getLanePriorityOrder(t){const e=Array.from({length:this.laneCount},(s,o)=>o).sort((s,o)=>{const l=this.getLaneNextAvailableTime(s,t),c=this.getLaneNextAvailableTime(o,t);return Math.abs(l-c)<=A?s-o:l-c}),n=this.getStaticReservedLaneSet();if(n.size===0)return e;const r=e.filter(s=>!n.has(s));if(r.length===0)return e;const i=e.filter(s=>n.has(s));return [...r,...i]}getLaneNextAvailableTime(t,e){const n=this.reservedLanes.get(t);if(!n||n.length===0)return e;let r=e;for(const i of n)r=Math.max(r,i.endTime);return r}createLaneReservation(t,e){const n=Math.max(t.speedPixelsPerMs,A),r=Number.isFinite(t.vpos)?t.vpos:e,i=Math.max(0,r),s=i+t.preCollisionDurationMs+z,o=i+t.totalDurationMs+z;return {comment:t,startTime:i,endTime:Math.max(i,s),totalEndTime:Math.max(i,o),startLeft:t.virtualStartX,width:t.width,speed:n,buffer:t.bufferWidth,directionSign:t.getDirectionSign()}}isLaneAvailable(t,e,n){const r=this.reservedLanes.get(t);if(!r||r.length===0)return  true;for(const i of r)if(!(i.totalEndTime+z<=n)&&this.areReservationsConflicting(i,e))return  false;return  true}storeLaneReservation(t,e){const n=[...this.reservedLanes.get(t)??[],e].sort((r,i)=>r.endTime-i.endTime);this.reservedLanes.set(t,n);}areReservationsConflicting(t,e){const n=Math.max(t.startTime,e.startTime),r=Math.min(t.endTime,e.endTime);if(n>=r)return  false;const i=new Set([n,r,n+(r-n)/2]),s=this.solveLeftRightEqualityTime(t,e);s!==null&&s>=n-A&&s<=r+A&&i.add(s);const o=this.solveLeftRightEqualityTime(e,t);o!==null&&o>=n-A&&o<=r+A&&i.add(o);for(const l of i){if(l<n-A||l>r+A)continue;const c=this.computeForwardGap(t,e,l),h=this.computeForwardGap(e,t,l);if(c<=A&&h<=A)return  true}return  false}computeForwardGap(t,e,n){const r=this.getBufferedEdges(t,n),i=this.getBufferedEdges(e,n);return r.left-i.right}getBufferedEdges(t,e){const n=Math.max(0,e-t.startTime),r=t.speed*n,i=t.startLeft+t.directionSign*r,s=i-t.buffer,o=i+t.width+t.buffer;return {left:s,right:o}}solveLeftRightEqualityTime(t,e){const n=t.directionSign,r=e.directionSign,i=r*e.speed-n*t.speed;if(Math.abs(i)<A)return null;const s=(e.startLeft+r*e.speed*e.startTime+e.width+e.buffer-t.startLeft-n*t.speed*t.startTime+t.buffer)/i;return Number.isFinite(s)?s:null}draw(){const t=this.canvas,e=this.ctx;if(!t||!e)return;const n=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:t.width/n,i=this.displayHeight>0?this.displayHeight:t.height/n;e.clearRect(0,0,r,i);const s=this.comments.filter(l=>l.isActive),o=this.timeSource.now();if(this._settings.isCommentVisible){const l=(o-this.lastDrawTime)/16.666666666666668;s.sort((c,h)=>{const d=c.vpos-h.vpos;return Math.abs(d)>A?d:c.isScrolling!==h.isScrolling?c.isScrolling?1:-1:c.creationIndex-h.creationIndex}),s.forEach(c=>{const h=this.isPlaying&&!c.isPaused?c.x+c.getDirectionSign()*c.speed*l:c.x;c.draw(e,h);});}this.lastDrawTime=o;}processFrame(t){this.videoElement&&this._settings.isCommentVisible&&(this.updateComments(t),this.draw());}handleAnimationFrame=()=>{const t=this.frameId;this.frameId=null,t!==null&&this.animationFrameProvider.cancel(t),this.processFrame(),this.scheduleNextFrame();};handleVideoFrame=(t,e)=>{this.videoFrameHandle=null;const n=typeof e?.mediaTime=="number"?e.mediaTime*1e3:void 0;this.processFrame(typeof n=="number"?n:void 0),this.scheduleNextFrame();};shouldUseVideoFrameCallback(){if(this._settings.syncMode!=="video-frame")return  false;const t=this.videoElement;return !!t&&typeof t.requestVideoFrameCallback=="function"&&typeof t.cancelVideoFrameCallback=="function"}scheduleNextFrame(){const t=this.videoElement;if(t){if(this.shouldUseVideoFrameCallback()){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback();const e=t.requestVideoFrameCallback;typeof e=="function"&&(this.videoFrameHandle=e.call(t,this.handleVideoFrame));return}this.cancelVideoFrameCallback(),this.frameId=this.animationFrameProvider.request(this.handleAnimationFrame);}}cancelAnimationFrameRequest(){this.frameId!==null&&(this.animationFrameProvider.cancel(this.frameId),this.frameId=null);}cancelVideoFrameCallback(){if(this.videoFrameHandle===null)return;const t=this.videoElement;t&&typeof t.cancelVideoFrameCallback=="function"&&t.cancelVideoFrameCallback(this.videoFrameHandle),this.videoFrameHandle=null;}startAnimation(){this.stopAnimation(),this.scheduleNextFrame();}stopAnimation(){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback();}onSeek(){const t=this.canvas,e=this.ctx,n=this.videoElement;if(!t||!e||!n)return;const r=T(n.currentTime);this.finalPhaseActive=false,this.currentTime=r,this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear();const i=this.canvasDpr>0?this.canvasDpr:1,s=this.displayWidth>0?this.displayWidth:t.width/i,o=this.displayHeight>0?this.displayHeight:t.height/i,l=this.buildPrepareOptions(s);this.comments.forEach(c=>{if(this.isNGComment(c.text)){c.isActive=false,c.clearActivation();return}if(c.isInvisible){c.isActive=false,c.hasShown=true,c.clearActivation();return}if(c.syncWithSettings(this._settings),c.isActive=false,c.lane=-1,c.clearActivation(),this.shouldActivateCommentAtTime(c,this.currentTime)){this.activateComment(c,e,s,o,l,this.currentTime);return}c.vpos<this.currentTime-dt?c.hasShown=true:c.hasShown=false;}),this._settings.isCommentVisible&&(this.lastDrawTime=this.timeSource.now(),this.draw());}setupVideoEventListeners(t){try{const e=()=>{this.isPlaying=!0;const h=this.timeSource.now();this.lastDrawTime=h,this.comments.forEach(d=>{d.lastUpdateTime=h,d.isPaused=!1;});},n=()=>{this.isPlaying=!1;const h=this.timeSource.now();this.comments.forEach(d=>{d.lastUpdateTime=h,d.isPaused=!0;});},r=()=>{this.onSeek();},i=()=>{this.onSeek();},s=()=>{this.playbackRate=t.playbackRate;const h=this.timeSource.now();this.comments.forEach(d=>{d.lastUpdateTime=h;});},o=()=>{this.handleVideoMetadataLoaded(t);},l=()=>{this.duration=Number.isFinite(t.duration)?T(t.duration):0;},c=()=>{this.handleVideoSourceChange();};t.addEventListener("play",e),t.addEventListener("pause",n),t.addEventListener("seeking",r),t.addEventListener("seeked",i),t.addEventListener("ratechange",s),t.addEventListener("loadedmetadata",o),t.addEventListener("durationchange",l),t.addEventListener("emptied",c),this.addCleanup(()=>t.removeEventListener("play",e)),this.addCleanup(()=>t.removeEventListener("pause",n)),this.addCleanup(()=>t.removeEventListener("seeking",r)),this.addCleanup(()=>t.removeEventListener("seeked",i)),this.addCleanup(()=>t.removeEventListener("ratechange",s)),this.addCleanup(()=>t.removeEventListener("loadedmetadata",o)),this.addCleanup(()=>t.removeEventListener("durationchange",l)),this.addCleanup(()=>t.removeEventListener("emptied",c));}catch(e){throw this.log.error("CommentRenderer.setupVideoEventListeners",e),e}}handleVideoMetadataLoaded(t){this.handleVideoSourceChange(t),this.resize(),this.calculateLaneMetrics(),this.onSeek();}handleVideoSourceChange(t){const e=t??this.videoElement;if(!e){this.isPlaying=false,this.finalPhaseActive=false,this.resetCommentActivity();return}this.syncVideoState(e),this.finalPhaseActive=false,this.resetCommentActivity();}syncVideoState(t){this.duration=Number.isFinite(t.duration)?T(t.duration):0,this.currentTime=T(t.currentTime),this.playbackRate=t.playbackRate,this.isPlaying=!t.paused,this.lastDrawTime=this.timeSource.now();}resetCommentActivity(){const t=this.timeSource.now(),e=this.canvas,n=this.ctx;if(e&&n){const r=this.canvasDpr>0?this.canvasDpr:1,i=this.displayWidth>0?this.displayWidth:e.width/r,s=this.displayHeight>0?this.displayHeight:e.height/r;n.clearRect(0,0,i,s);}this.reservedLanes.clear(),this.topStaticLaneReservations.clear(),this.bottomStaticLaneReservations.clear(),this.comments.forEach(r=>{r.isActive=false,r.isPaused=!this.isPlaying,r.hasShown=false,r.lane=-1,r.x=r.virtualStartX,r.speed=r.baseSpeed,r.lastUpdateTime=t,r.clearActivation();});}setupVideoChangeDetection(t,e){if(typeof MutationObserver>"u"){this.log.debug("MutationObserver is not available in this environment. Video change detection is disabled.");return}const n=new MutationObserver(i=>{for(const s of i){if(s.type==="attributes"&&s.attributeName==="src"){const o=s.target;let l=null,c=null;if((o instanceof HTMLVideoElement||o instanceof HTMLSourceElement)&&(l=typeof s.oldValue=="string"?s.oldValue:null,c=o.getAttribute("src")),l===c)continue;this.handleVideoSourceChange(t);return}if(s.type==="childList"){for(const o of s.addedNodes)if(o instanceof HTMLSourceElement){this.handleVideoSourceChange(t);return}for(const o of s.removedNodes)if(o instanceof HTMLSourceElement){this.handleVideoSourceChange(t);return}}}});n.observe(t,{attributes:true,attributeFilter:["src"],attributeOldValue:true,childList:true,subtree:true}),this.addCleanup(()=>n.disconnect());const r=new MutationObserver(i=>{for(const s of i)if(s.type==="childList"){for(const o of s.addedNodes){const l=this.extractVideoElement(o);if(l&&l!==this.videoElement){this.initialize(l);return}}for(const o of s.removedNodes){if(o===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}if(o instanceof Element){const l=o.querySelector("video");if(l&&l===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}}}}});r.observe(e,{childList:true,subtree:true}),this.addCleanup(()=>r.disconnect());}extractVideoElement(t){if(t instanceof HTMLVideoElement)return t;if(t instanceof Element){const e=t.querySelector("video");if(e instanceof HTMLVideoElement)return e}return null}setupResizeHandling(t){if(this.cleanupResizeHandling(),this._settings.useContainerResizeObserver&&this.isResizeObserverAvailable){const e=t.parentElement??t,n=new ResizeObserver(r=>{for(const i of r){const{width:s,height:o}=i.contentRect;s>0&&o>0?this.resize(s,o):this.resize();}});n.observe(e),this.resizeObserver=n,this.resizeObserverTarget=e;}else if(typeof window<"u"&&typeof window.addEventListener=="function"){const e=()=>{this.resize();};window.addEventListener("resize",e),this.addCleanup(()=>window.removeEventListener("resize",e));}else this.log.debug("Resize handling is disabled because neither ResizeObserver nor window APIs are available.");}cleanupResizeHandling(){this.resizeObserver&&this.resizeObserverTarget&&this.resizeObserver.unobserve(this.resizeObserverTarget),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.resizeObserverTarget=null;}addCleanup(t){this.cleanupTasks.push(t);}runCleanupTasks(){for(;this.cleanupTasks.length>0;){const t=this.cleanupTasks.pop();try{t?.();}catch(e){this.log.error("CommentRenderer.cleanupTask",e);}}}}const I=()=>Ft(),_e="v6.6.1";var Re=typeof GM_addStyle<"u"?GM_addStyle:void 0,K=typeof GM_getValue<"u"?GM_getValue:void 0,Y=typeof GM_setValue<"u"?GM_setValue:void 0,Fe=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0;const ft="settings",bt="currentVideo",yt="lastDanimeIds",De=a=>({...a,ngWords:[...a.ngWords],ngRegexps:[...a.ngRegexps]});class nt{constructor(t){this.notifier=t,this.settings=I(),this.currentVideo=null,this.loadSettings(),this.currentVideo=this.loadVideoData();}settings;currentVideo;observers=new Set;getSettings(){return De(this.settings)}loadSettings(){try{const t=K(ft,null);if(!t)return this.settings=I(),this.settings;if(typeof t=="string"){const e=JSON.parse(t);this.settings={...I(),...e,ngWords:Array.isArray(e?.ngWords)?[...e.ngWords]:[],ngRegexps:Array.isArray(e?.ngRegexps)?[...e.ngRegexps]:[]};}else this.settings={...I(),...t,ngWords:Array.isArray(t.ngWords)?[...t.ngWords]:[],ngRegexps:Array.isArray(t.ngRegexps)?[...t.ngRegexps]:[]};return this.notifyObservers(),this.settings}catch(t){return console.error("[SettingsManager] 設定の読み込みに失敗しました",t),this.notify("設定の読み込みに失敗しました","error"),this.settings=I(),this.settings}}saveSettings(){try{return Y(ft,JSON.stringify(this.settings)),this.notifyObservers(),this.notify("設定を保存しました","success"),!0}catch(t){return console.error("[SettingsManager] 設定の保存に失敗しました",t),this.notify("設定の保存に失敗しました","error"),false}}updateSettings(t){return this.settings={...this.settings,...t,ngWords:t.ngWords?[...t.ngWords]:[...this.settings.ngWords],ngRegexps:t.ngRegexps?[...t.ngRegexps]:[...this.settings.ngRegexps]},this.saveSettings()}addObserver(t){this.observers.add(t);}removeObserver(t){this.observers.delete(t);}notifyObservers(){const t=this.getSettings();for(const e of this.observers)try{e(t);}catch(n){console.error("[SettingsManager] 設定変更通知でエラー",n);}}loadVideoData(){try{return K(bt,null)??null}catch(t){return console.error("[SettingsManager] 動画データの読み込みに失敗しました",t),this.notify("動画データの読み込みに失敗しました","error"),null}}saveVideoData(t,e){try{const n={videoId:e.videoId,title:e.title,viewCount:e.viewCount,commentCount:e.commentCount,mylistCount:e.mylistCount,postedAt:e.postedAt,thumbnail:e.thumbnail,owner:e.owner??null,channel:e.channel??null};return Y(bt,n),this.currentVideo=n,!0}catch(n){return console.error("[SettingsManager] 動画データの保存に失敗しました",n),this.notify("動画データの保存に失敗しました","error"),false}}getCurrentVideo(){return this.currentVideo?{...this.currentVideo}:null}saveLastDanimeIds(t){try{return Y(yt,t),!0}catch(e){return console.error("[SettingsManager] saveLastDanimeIds failed",e),this.notify("ID情報の保存に失敗しました","error"),false}}loadLastDanimeIds(){try{return K(yt,null)??null}catch(t){return console.error("[SettingsManager] loadLastDanimeIds failed",t),this.notify("ID情報の読込に失敗しました","error"),null}}notify(t,e="info"){this.notifier?.show(t,e);}}const He=new Set(["INPUT","TEXTAREA"]),j=a=>a.length===1?a.toUpperCase():a,Ne=a=>a?`${a}+`:"";class Ht{shortcuts=new Map;boundHandler;isEnabled=true;isListening=false;constructor(){this.boundHandler=this.handleKeyDown.bind(this);}addShortcut(t,e,n){const r=this.createShortcutKey(j(t),e);this.shortcuts.set(r,n);}removeShortcut(t,e){const n=this.createShortcutKey(j(t),e);this.shortcuts.delete(n);}startListening(){this.isListening||(document.addEventListener("keydown",this.boundHandler,false),this.isListening=true);}stopListening(){this.isListening&&(document.removeEventListener("keydown",this.boundHandler,false),this.isListening=false);}setEnabled(t){this.isEnabled=t;}createShortcutKey(t,e){return `${Ne(e)}${t}`}extractModifier(t){const e=[];return t.ctrlKey&&e.push("Ctrl"),t.altKey&&e.push("Alt"),t.shiftKey&&e.push("Shift"),t.metaKey&&e.push("Meta"),e.length>0?e.join("+"):null}handleKeyDown(t){if(!this.isEnabled)return;const n=t.target?.tagName??"";if(He.has(n))return;const r=this.extractModifier(t),i=this.createShortcutKey(j(t.key),r),s=this.shortcuts.get(i);s&&(t.preventDefault(),s());}}const Pe=_("dAnime:CommentRenderer"),vt=a=>({loggerNamespace:"dAnime:CommentRenderer",...a??{}}),ze=a=>{if(!a||typeof a!="object")return  false;const t=a;return typeof t.commentColor=="string"&&typeof t.commentOpacity=="number"&&typeof t.isCommentVisible=="boolean"};class Nt{renderer;keyboardHandler=null;constructor(t,e){ze(t)||t===null?this.renderer=new gt(t??null,vt(e)):this.renderer=new gt(vt(t));}get settings(){return this.renderer.settings}set settings(t){this.renderer.settings=t;}initialize(t){this.renderer.initialize(t),this.setupKeyboardShortcuts();}addComment(t,e,n=[]){return this.renderer.addComment(t,e,n)}clearComments(){this.renderer.clearComments();}resetState(){this.renderer.resetState();}destroy(){this.teardownKeyboardShortcuts(),this.renderer.destroy();}updateSettings(t){this.renderer.updateSettings(t);}getVideoElement(){return this.renderer.getVideoElement()}getCurrentVideoSource(){return this.renderer.getCurrentVideoSource()}getCommentsSnapshot(){return this.renderer.getCommentsSnapshot()}isNGComment(t){return this.renderer.isNGComment(t)}resize(t,e){this.renderer.resize(t,e);}setupKeyboardShortcuts(){this.teardownKeyboardShortcuts();const t=new Ht;t.addShortcut("C","Shift",()=>{try{const e=this.renderer.settings,n={...e,isCommentVisible:!e.isCommentVisible};this.renderer.updateSettings(n),this.syncGlobalSettings(n);}catch(e){Pe.error("CommentRenderer.keyboardShortcut",e);}}),t.startListening(),this.keyboardHandler=t;}teardownKeyboardShortcuts(){this.keyboardHandler?.stopListening(),this.keyboardHandler=null;}syncGlobalSettings(t){window.dAniRenderer?.settingsManager?.updateSettings(t);}}class rt{shadowRoot=null;container=null;createShadowDOM(t,e={mode:"closed"}){if(!t)throw new Error("Host element is required for shadow DOM creation");return this.shadowRoot=t.attachShadow(e),this.container=document.createElement("div"),this.shadowRoot.appendChild(this.container),this.shadowRoot}addStyles(t){if(!this.shadowRoot)throw new Error("Shadow root not initialized");const e=document.createElement("style");e.textContent=t,this.shadowRoot.appendChild(e);}querySelector(t){return this.shadowRoot?this.shadowRoot.querySelector(t):null}querySelectorAll(t){return this.shadowRoot?this.shadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}setHTML(t){if(!this.container)throw new Error("Container not initialized");this.container.innerHTML=t;}destroy(){this.shadowRoot?.host&&this.shadowRoot.host.remove(),this.shadowRoot=null,this.container=null;}}const Oe=`\r
/* 基本カラーパレット - ダークモード */\r
:host {\r
...
`;class N{static getCommonStyles(){return Oe}static getNotificationStyles(){return We}static getAutoButtonStyles(){return qe}}const xt={success:"✔",warning:"⚠",error:"✖",info:"ℹ"};class f extends rt{static instance=null;static notifications=[];hostElement=null;initialized=false;static getInstance(){return this.instance||(this.instance=new f),this.instance}static show(t,e="info",n=3e3){try{const r=this.getInstance();return r.initialize(),r.initialized?r.createNotification(t,e,n):null}catch(r){return console.error("[NotificationManager] show failed",r),null}}static removeNotification(t){this.getInstance().removeNotification(t.element);}show(t,e="info"){f.show(t,e);}initialize(){if(!this.initialized)try{this.hostElement=document.createElement("div"),this.hostElement.className="nico-comment-shadow-host notification-host",this.hostElement.style.cssText=["position: fixed","top: 0","right: 0","z-index: 2147483647","pointer-events: none"].join(";"),document.body.appendChild(this.hostElement),this.createShadowDOM(this.hostElement),this.addStyles(N.getNotificationStyles()),this.setHTML('<div class="notification-container"></div>'),this.initialized=!0;}catch(t){console.error("[NotificationManager] initialize failed",t),this.initialized=false;}}destroy(){f.notifications.forEach(t=>{t.timerId&&window.clearTimeout(t.timerId);}),f.notifications=[],this.hostElement?.parentNode&&this.hostElement.parentNode.removeChild(this.hostElement),this.hostElement=null,this.initialized=false,f.instance=null;}createNotification(t,e,n){try{const r=this.querySelector(".notification-container");if(!r)throw new Error("Notification container not found");const i=xt[e]??xt.info,s=document.createElement("div");s.className=`notification-item ${e}`;const o=document.createElement("div");o.className="notification-icon",o.innerHTML=`<span>${i}</span>`,s.appendChild(o);const l=document.createElement("div");l.className="notification-content";const c=document.createElement("div");c.className="notification-type",c.textContent=e.charAt(0).toUpperCase()+e.slice(1),l.appendChild(c);const h=document.createElement("div");h.className="notification-message",h.textContent=t||"No message",l.appendChild(h),s.appendChild(l);const d=document.createElement("button");d.className="notification-close",d.innerHTML="&times;",d.addEventListener("click",()=>{this.removeNotification(s);}),s.appendChild(d),r.appendChild(s),requestAnimationFrame(()=>{s.classList.add("show");});const u={element:s,timerId:window.setTimeout(()=>{this.removeNotification(s);},n)};return f.notifications.push(u),u}catch(r){return console.error("[NotificationManager] createNotification failed",r),null}}removeNotification(t){if(!t)return;const e=f.notifications.find(n=>n.element===t);e?.timerId&&window.clearTimeout(e.timerId),t.classList.remove("show"),window.setTimeout(()=>{try{t.remove(),f.notifications=f.notifications.filter(n=>n.element!==t);}catch(n){console.error("[NotificationManager] removeNotification cleanup failed",n);}},500);}}const Pt="https://www.nicovideo.jp",zt=`${Pt}/search`,Ot=`${Pt}/watch`,wt={searchBase:zt,watchBase:Ot},$e=a=>`${Ot}/${a}`,Wt=a=>`${zt}/${encodeURIComponent(a)}`,Q=a=>new Promise((t,e)=>{Fe({url:a.url,method:a.method??"GET",headers:a.headers,data:a.data,responseType:a.responseType??"text",timeout:a.timeout,onprogress:a.onprogress,onload:n=>{t({status:n.status,statusText:n.statusText,response:n.response,finalUrl:n.finalUrl,headers:n.responseHeaders});},onerror:n=>{const r=n?.error??"unknown error";e(new Error(`GM_xmlhttpRequest failed: ${r}`));},ontimeout:()=>{e(new Error("GM_xmlhttpRequest timeout"));}});}),X=_("dAnime:NicoApiFetcher");class it{apiData=null;comments=null;get lastApiData(){return this.apiData}get cachedComments(){return this.comments}async fetchApiData(t){try{const e=this.sanitizeVideoId(t),r=(await Q({method:"GET",url:$e(e),headers:{Accept:"text/html"}})).response,o=new DOMParser().parseFromString(r,"text/html").querySelector('meta[name="server-response"]');if(!o)throw new Error("API data element not found in response");const l=o.getAttribute("content");if(!l)throw new Error("API data content is empty");const c=this.decodeServerResponse(l),d=JSON.parse(c).data?.response;if(!d)throw new Error("Invalid API data structure");return this.apiData=d,d}catch(e){throw X.error("NicoApiFetcher.fetchApiData",e),e}}async fetchComments(){try{if(!this.apiData)throw new Error("API data must be fetched first");const t=this.apiData.comment?.nvComment;if(!t?.server||!t.params||!t.threadKey)throw new Error("Required comment server data is missing");const e=await Q({method:"POST",url:`${t.server}/v1/threads`,headers:{"Content-Type":"application/json","x-client-os-type":"others","X-Frontend-Id":"6","X-Frontend-Version":"0"},data:JSON.stringify({params:t.params,threadKey:t.threadKey,additionals:{}})}),i=(JSON.parse(e.response).data?.threads??[]).filter(o=>o.fork==="main").sort((o,l)=>(l.commentCount||0)-(o.commentCount||0))[0];if(!i)throw new Error("Main thread not found in comment response");const s=(i.comments??[]).map(o=>({text:o.body??"",vpos:o.vposMs??0,commands:o.commands??[]}));return this.comments=s,s}catch(t){throw X.error("NicoApiFetcher.fetchComments",t),t}}async fetchAllData(t){return await this.fetchApiData(t),this.fetchComments()}sanitizeVideoId(t){try{let e=encodeURIComponent(t);return e=e.replace(/%([0-9A-F]{2})/gi,(n,r)=>{const i=parseInt(r,16);return i>=65&&i<=90||i>=97&&i<=122||i>=48&&i<=57||i===45||i===95||i===46||i===126?String.fromCharCode(i):n}),e}catch(e){return X.error("NicoApiFetcher.sanitizeVideoId",e,{videoId:t}),t}}decodeServerResponse(t){try{return decodeURIComponent(t)}catch(e){try{const n=t.replace(/%(?![0-9A-F]{2})/gi,"%25");return decodeURIComponent(n)}catch{throw new Error(`API data decode failed: ${e.message}`)}}}}const St=_("dAnime:NicoVideoSearcher");class qt{cache=new Map;async search(t){if(!t.trim())return [];if(this.cache.has(t))return this.cache.get(t)??[];const e=Wt(t),n=await this.fetchText(e),r=this.parseServerContext(n).map(o=>{const l=this.calculateLevenshteinDistance(t,o.title),c=Math.max(t.length,o.title.length),h=c>0?(1-l/c)*100:0;return {...o,levenshteinDistance:l,similarity:h}}),i=[],s=new Set;for(const o of r)o?.videoId&&(s.has(o.videoId)||(s.add(o.videoId),i.push(o)));return i.sort((o,l)=>{const c=o.similarity??-1,h=l.similarity??-1;return c!==h?h-c:l.viewCount-o.viewCount}),this.cache.set(t,i),i}async fetchText(t){return (await Q({method:"GET",url:t})).response}parseServerContext(t){try{const n=new DOMParser().parseFromString(t,"text/html").querySelector('meta[name="server-response"]');if(!n)return [];const r=n.getAttribute("content")??"",i=this.decodeHtmlEntities(r);let s;try{s=JSON.parse(i);}catch(o){return St.error("NicoVideoSearcher.parseServerContext",o),[]}return this.extractVideoItems(s??{})}catch(e){return St.error("NicoVideoSearcher.parseServerContext",e),[]}}decodeHtmlEntities(t){if(!t)return "";let e=t.replace(/&quot;/g,'"').replace(/&#39;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">");return e=e.replace(/&#(\d+);/g,(n,r)=>String.fromCharCode(parseInt(r,10))),e=e.replace(/&#x([0-9a-fA-F]+);/g,(n,r)=>String.fromCharCode(parseInt(r,16))),e}extractVideoItems(t){const e=[],n=i=>{const s=(i?.id??i?.contentId??i?.watchId??"").toString();if(!s)return;const o=(i?.title??i?.shortTitle??"").toString(),l=i?.count??{},c=Number(l.view??i?.viewCounter??0)||0,h=Number(l.comment??i?.commentCounter??0)||0,d=Number(l.mylist??i?.mylistCounter??0)||0,u=i?.thumbnail??{},g=(u.nHdUrl||u.listingUrl||u.largeUrl||u.middleUrl||u.url||i?.thumbnailUrl||"").toString(),b=(i?.registeredAt||i?.startTime||i?.postedDateTime||"")?.toString?.()??"",y=i?.owner&&typeof i.owner=="object"?{nickname:(i.owner.nickname??i.owner.name??"")||void 0,name:(i.owner.name??i.owner.nickname??"")||void 0}:null,p=(i?.isChannelVideo||i?.owner?.ownerType==="channel")&&i?.owner?{name:i.owner.name??""}:null;o&&e.push({videoId:s,title:o,viewCount:c,commentCount:h,mylistCount:d,thumbnail:g,postedAt:b,owner:y,channel:p});},r=i=>{if(!i)return;if(Array.isArray(i)){i.forEach(r);return}if(typeof i!="object"||i===null)return;const s=i;(s.id||s.contentId||s.watchId)&&n(s),Object.values(i).forEach(r);};return r(t),e}calculateLevenshteinDistance(t,e){const n=t?t.length:0,r=e?e.length:0;if(n===0)return r;if(r===0)return n;const i=new Array(r+1);for(let o=0;o<=r;++o){const l=i[o]=new Array(n+1);l[0]=o;}const s=i[0];for(let o=1;o<=n;++o)s[o]=o;for(let o=1;o<=r;++o)for(let l=1;l<=n;++l){const c=t[l-1]===e[o-1]?0:1;i[o][l]=Math.min(i[o-1][l]+1,i[o][l-1]+1,i[o-1][l-1]+c);}return i[r][n]}}const E={mypageHeaderTitle:".p-mypageHeader__title",mypageListContainer:".p-mypageMain",watchVideoElement:"video#video",mypageItem:".itemModule.list",mypageItemTitle:".line1",mypageEpisodeNumber:".number.line1 span",mypageEpisodeTitle:".episode.line1 span"};class st{delay;timers=new Map;funcIds=new Map;nextId=1;constructor(t){this.delay=t;}getFuncId(t){return this.funcIds.has(t)||this.funcIds.set(t,this.nextId++),this.funcIds.get(t)??0}exec(t){const e=this.getFuncId(t),n=Date.now(),r=this.timers.get(e)?.lastExec??0,i=n-r;if(i>this.delay)t(),this.timers.set(e,{lastExec:n});else {clearTimeout(this.timers.get(e)?.timerId??void 0);const s=setTimeout(()=>{t(),this.timers.set(e,{lastExec:Date.now()});},this.delay-i);this.timers.set(e,{timerId:s,lastExec:r});}}execOnce(t){const e=this.getFuncId(t),n=this.timers.get(e);if(n?.executedOnce){n.timerId&&clearTimeout(n.timerId);return}n?.timerId&&clearTimeout(n.timerId);const r=setTimeout(()=>{try{t();}finally{this.timers.set(e,{executedOnce:true,lastExec:Date.now(),timerId:null});}},this.delay);this.timers.set(e,{timerId:r,executedOnce:false,scheduled:true});}cancel(t){const e=this.getFuncId(t),n=this.timers.get(e);n?.timerId&&clearTimeout(n.timerId),this.timers.delete(e);}resetExecution(t){const e=this.getFuncId(t),n=this.timers.get(e);n&&(n.timerId&&clearTimeout(n.timerId),this.timers.set(e,{executedOnce:false,scheduled:false}));}clearAll(){for(const[,t]of this.timers)t.timerId&&clearTimeout(t.timerId);this.timers.clear(),this.funcIds.clear();}}const Be=1e3,Ue=100,Ge=30,Ct=1e4,Et=100,Ke=/watch\/(?:([a-z]{2}))?(\d+)/gi,w=_("dAnime:VideoSwitchHandler"),Mt=a=>{if(!a?.video)return null;const t=a.video.registeredAt,e=t?new Date(t).toLocaleString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:false}):void 0;return {videoId:a.video.id,title:a.video.title,viewCount:a.video.count?.view,mylistCount:a.video.count?.mylist,commentCount:a.video.count?.comment,postedAt:e,thumbnail:a.video.thumbnail?.url,owner:a.owner??null,channel:a.channel??null}},Ye=a=>{const t=[];let e;for(;(e=Ke.exec(a))!==null;){const[,n="",r=""]=e;r&&t.push(`${n}${r}`);}return t};class $t{constructor(t,e,n,r=Be,i=Ue){this.renderer=t,this.fetcher=e,this.settingsManager=n,this.monitorInterval=r,this.debounce=new st(i);}nextVideoId=null;preloadedComments=null;lastPreloadedComments=null;lastVideoId=null;lastVideoSource=null;checkIntervalId=null;isSwitching=false;debounce;startMonitoring(){this.stopMonitoring(),this.checkIntervalId=window.setInterval(()=>{this.checkVideoEnd();},this.monitorInterval);}stopMonitoring(){this.checkIntervalId&&(window.clearInterval(this.checkIntervalId),this.checkIntervalId=null);}async onVideoSwitch(t){if(!this.isSwitching){this.isSwitching=true;try{const e=await this.resolveVideoElement(t)??null,n=this.preloadedComments??this.lastPreloadedComments??null,r=e?.dataset?.videoId??e?.getAttribute?.("data-video-id")??null,i=this.nextVideoId??r??this.lastVideoId;if(!e||!i&&!n){this.handleMissingVideoInfo(n);return}w.info("videoSwitch:start",{videoId:i??null,elementVideoId:e.dataset?.videoId??null,preloadedCount:n?.length??0}),f.show("動画の切り替わりを検知しました...","info"),this.resetRendererState(e);const s=this.renderer.getVideoElement();if(s!==e&&e)w.debug("videoSwitch:rebind",{previousSrc:this.renderer.getCurrentVideoSource(),newSrc:typeof e.currentSrc=="string"&&e.currentSrc.length>0?e.currentSrc:e.getAttribute("src")??null}),this.renderer.initialize(e);else if(s===e&&e&&this.hasVideoSourceChanged(e))w.debug("videoSwitch:rebind:sameElement",{previousSrc:this.lastVideoSource??null,newSrc:this.getVideoSource(e)}),this.renderer.destroy(),this.renderer.initialize(e);else if(!s&&!e){w.warn("videoSwitch:missingVideoElement",{lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId}),this.isSwitching=!1;return}let o=null;i&&(o=await this.fetchVideoApiData(i,n),o&&(this.persistVideoMetadata(o),this.lastVideoId=i));const l=await this.populateComments(i,n);if(l===0?(this.renderer.clearComments(),f.show("コメントを取得できませんでした","warning"),w.warn("videoSwitch:commentsMissing",{videoId:i??null})):w.info("videoSwitch:commentsLoaded",{videoId:i??null,count:l}),this.nextVideoId=null,this.preloadedComments=null,this.lastVideoSource=this.getVideoSource(e),o){const c=Mt(o);if(c){const h=`コメントソースを更新しました: ${c.title??"不明なタイトル"}（${l}件）`;f.show(h,l>0?"success":"warning");}}}catch(e){w.error("videoSwitch:error",e,{nextVideoId:this.nextVideoId,lastVideoId:this.lastVideoId}),f.show(`動画切り替えエラー: ${e.message}`,"error"),this.renderer.clearComments();}finally{this.isSwitching=false;}}}async resolveVideoElement(t){if(t){const r=this.getVideoSource(t),i=this.lastVideoSource;return (!r||r===i)&&await this.waitForSourceChange(t),t}const e=Date.now()+Ct;let n=null;for(;Date.now()<e;){const r=document.querySelector(E.watchVideoElement);if(r){n=r;const i=this.hasVideoSourceChanged(r);if(r.readyState>=2||!r.paused||i)return i&&(this.lastVideoSource=null),r}await new Promise(i=>window.setTimeout(i,Et));}return n}async waitForSourceChange(t){const e=this.getVideoSource(t);if(!e)return;const n=Date.now()+Ct;for(;Date.now()<n;){const r=this.getVideoSource(t);if(r&&r!==e){this.lastVideoSource=null;return}await new Promise(i=>window.setTimeout(i,Et));}}hasVideoSourceChanged(t){const e=this.getVideoSource(t);return e?this.lastVideoSource?this.lastVideoSource!==e:true:false}getVideoSource(t){if(!t)return null;const e=typeof t.currentSrc=="string"?t.currentSrc:"";if(e.length>0)return e;const n=t.getAttribute("src")??"";if(n.length>0)return n;const r=t.querySelector("source[src]");return r&&typeof r.src=="string"&&r.src.length>0?r.src:null}resetRendererState(t){try{t.currentTime=0;}catch(e){w.debug("videoSwitch:resetCurrentTimeFailed",e);}this.renderer.clearComments();}async checkVideoEnd(){const t=this.renderer.getVideoElement();if(!(!t||!Number.isFinite(t.duration)||t.duration-t.currentTime>Ge)){if(!this.nextVideoId){const n=async()=>{await this.findNextVideoId();};this.debounce.execOnce(n);}if(this.nextVideoId&&!this.preloadedComments){const n=async()=>{await this.preloadComments();};this.debounce.execOnce(n);}}}handleMissingVideoInfo(t){t||(this.renderer.clearComments(),f.show("次の動画のコメントを取得できませんでした。コメント表示をクリアします。","warning"));}async fetchVideoApiData(t,e){try{const n=await this.fetcher.fetchApiData(t);return w.debug("videoSwitch:apiFetched",{videoId:t}),n}catch(n){if(w.error("videoSwitch:apiFetchError",n,{videoId:t}),!e)throw n;return null}}persistVideoMetadata(t){const e=Mt(t);e&&this.settingsManager.saveVideoData(e.title??"",e);}async populateComments(t,e){let n=null;if(Array.isArray(e)&&e.length>0)n=e;else if(t)try{n=await this.fetcher.fetchAllData(t),w.debug("videoSwitch:commentsFetched",{videoId:t,count:n.length});}catch(i){w.error("videoSwitch:commentsFetchError",i,{videoId:t}),f.show(`コメント取得エラー: ${i.message}`,"error"),n=null;}if(!n||n.length===0)return 0;const r=n.filter(i=>!this.renderer.isNGComment(i.text));return r.forEach(i=>{this.renderer.addComment(i.text,i.vpos,i.commands);}),this.lastPreloadedComments=[...r],r.length}async findNextVideoId(){try{const t=this.fetcher.lastApiData;if(!t)return;const e=t.series?.video?.next?.id;if(e){this.nextVideoId=e,w.debug("videoSwitch:detectedNext",{videoId:e});return}const n=t.video?.description??"";if(!n)return;const r=Ye(n);if(r.length===0)return;const i=[...r].sort((s,o)=>{const l=parseInt(s.replace(/^[a-z]{2}/i,""),10)||0;return (parseInt(o.replace(/^[a-z]{2}/i,""),10)||0)-l});this.nextVideoId=i[0]??null,this.nextVideoId&&w.debug("videoSwitch:candidateFromDescription",{candidate:this.nextVideoId});}catch(t){w.error("videoSwitch:nextIdError",t,{lastVideoId:this.lastVideoId});}}async preloadComments(){if(this.nextVideoId)try{const e=(await this.fetcher.fetchAllData(this.nextVideoId)).filter(n=>!this.renderer.isNGComment(n.text));this.preloadedComments=e.length>0?e:null,w.debug("videoSwitch:preloaded",{videoId:this.nextVideoId,count:e.length});}catch(t){w.error("videoSwitch:preloadError",t,{videoId:this.nextVideoId}),this.preloadedComments=null;}}}const je=`
.nico-comment-shadow-host {
  display: block;
  position: relative;
}
`;class Bt{static initialize(){Re(je);}}var Xe="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7.07,18.28C7.5,17.38 10.12,16.5 12,16.5C13.88,16.5 16.5,17.38 16.93,18.28C15.57,19.36 13.86,20 12,20C10.14,20 8.43,19.36 7.07,18.28M18.36,16.83C16.93,15.09 13.46,14.5 12,14.5C10.54,14.5 7.07,15.09 5.64,16.83C4.62,15.5 4,13.82 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,13.82 19.38,15.5 18.36,16.83M12,6C10.06,6 8.5,7.56 8.5,9.5C8.5,11.44 10.06,13 12,13C13.94,13 15.5,11.44 15.5,9.5C15.5,7.56 13.94,6 12,6M12,11A1.5,1.5 0 0,1 10.5,9.5A1.5,1.5 0 0,1 12,8A1.5,1.5 0 0,1 13.5,9.5A1.5,1.5 0 0,1 12,11Z",Je="M6 1V3H5C3.89 3 3 3.89 3 5V19C3 20.1 3.89 21 5 21H11.1C12.36 22.24 14.09 23 16 23C19.87 23 23 19.87 23 16C23 14.09 22.24 12.36 21 11.1V5C21 3.9 20.11 3 19 3H18V1H16V3H8V1M5 5H19V7H5M5 9H19V9.67C18.09 9.24 17.07 9 16 9C12.13 9 9 12.13 9 16C9 17.07 9.24 18.09 9.67 19H5M16 11.15C18.68 11.15 20.85 13.32 20.85 16C20.85 18.68 18.68 20.85 16 20.85C13.32 20.85 11.15 18.68 11.15 16C11.15 13.32 13.32 11.15 16 11.15M15 13V16.69L18.19 18.53L18.94 17.23L16.5 15.82V13Z",Ze="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",Qe="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10Z",tn="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M5,5V7H19V5H5M5,9V11H13V9H5M5,13V15H15V13H5Z",en="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10M6,7H18V9H6V7M6,11H15V13H6V11Z",nn="M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9M12,4.5C17,4.5 21.27,7.61 23,12C21.27,16.39 17,19.5 12,19.5C7,19.5 2.73,16.39 1,12C2.73,7.61 7,4.5 12,4.5M3.18,12C4.83,15.36 8.24,17.5 12,17.5C15.76,17.5 19.17,15.36 20.82,12C19.17,8.64 15.76,6.5 12,6.5C8.24,6.5 4.83,8.64 3.18,12Z",rn="M5,4V7H10.5V19H13.5V7H19V4H5Z",sn="M16,17H5V7H16L19.55,12M17.63,5.84C17.27,5.33 16.67,5 16,5H5A2,2 0 0,0 3,7V17A2,2 0 0,0 5,19H16C16.67,19 17.27,18.66 17.63,18.15L22,12L17.63,5.84Z",on="M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z",an="M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z",ln="M8,5.14V19.14L19,12.14L8,5.14Z",cn="M17 19.1L19.5 20.6L18.8 17.8L21 15.9L18.1 15.7L17 13L15.9 15.6L13 15.9L15.2 17.8L14.5 20.6L17 19.1M3 14H11V16H3V14M3 6H15V8H3V6M3 10H15V12H3V10Z",dn="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z";function M(a,t=24){const e=String(t),n=String(t);return `<svg xmlns="http://www.w3.org/2000/svg" width="${e}" height="${n}" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true" focusable="false"><path d="${a}"></path></svg>`}const At=M(ln),hn=M(Ze),un=M(an),pn=M(on),J=M(Qe),mn=M(sn),gn=M(rn),fn=M(Xe),bn=M(nn),yn=M(en),vn=M(cn),xn=M(Je),wn=M(tn),Sn=M(dn),R=_("dAnime:SettingsUI"),m={searchInput:"#searchInput",searchButton:"#searchButton",openSearchPage:"#openSearchPageDirect",searchResults:"#searchResults",saveButton:"#saveSettings",opacitySelect:"#commentOpacity",visibilityToggle:"#commentVisibilityToggle",currentTitle:"#currentTitle",currentVideoId:"#currentVideoId",currentOwner:"#currentOwner",currentViewCount:"#currentViewCount",currentCommentCount:"#currentCommentCount",currentMylistCount:"#currentMylistCount",currentPostedAt:"#currentPostedAt",currentThumbnail:"#currentThumbnail",colorValue:".color-value",colorPreview:".color-preview",colorPickerInput:"#colorPickerInput",ngWords:"#ngWords",ngRegexps:"#ngRegexps",showNgWords:"#showNgWords",showNgRegexps:"#showNgRegexp",playCurrentVideo:"#playCurrentVideo",settingsModal:"#settingsModal",closeSettingsModal:"#closeSettingsModal",modalOverlay:".settings-modal__overlay",modalTabs:".settings-modal__tab",modalPane:".settings-modal__pane"},H=["search","display","ng"],Vt=`
...
`;class W extends rt{static FAB_HOST_ID="danime-settings-fab-host";settingsManager;fetcher;searcher;settings;currentVideoInfo;hostElement=null;lastAutoButtonElement=null;activeTab="search";modalElement=null;overlayElement=null;closeButtonElement=null;fabElement=null;fabHostElement=null;fabShadowRoot=null;handleFabClick=t=>{t.preventDefault(),this.openSettingsModal();};handleOverlayClick=()=>{this.closeSettingsModal();};handleCloseClick=()=>{this.closeSettingsModal();};constructor(t,e=new it,n=new qt){super(),this.settingsManager=t,this.fetcher=e,this.searcher=n,this.settings=this.settingsManager.getSettings(),this.currentVideoInfo=this.settingsManager.loadVideoData();}insertIntoMypage(){const t=document.querySelector(E.mypageHeaderTitle);t&&(this.hostElement=this.createSettingsUI(),t.parentElement?.insertBefore(this.hostElement,t.nextSibling),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(e){console.warn("[SettingsUI] restore failed:",e);}}));}addAutoCommentButtons(){document.querySelectorAll(E.mypageItem).forEach(e=>{const n=e.querySelector(E.mypageItemTitle);if(!n||n.querySelector(".auto-comment-button-host"))return;const r=n.querySelector("span")?.textContent?.trim()??"",i=e.querySelector(E.mypageEpisodeNumber)?.textContent?.trim()??"",s=e.querySelector(E.mypageEpisodeTitle)?.textContent?.trim()??"",o=document.createElement("div");o.className="nico-comment-shadow-host auto-comment-button-host",o.style.cssText="position:absolute;left:150px;top:3px;margin-left:8px;";const l=o.attachShadow({mode:"closed"}),c=document.createElement("style");c.textContent=N.getAutoButtonStyles(),l.appendChild(c);const h=document.createElement("button");h.className="auto-comment-button",h.innerHTML=J,h.setAttribute("aria-label","コメント設定"),h.setAttribute("title","コメント設定"),h.setAttribute("type","button"),h.addEventListener("click",async d=>{d.preventDefault(),d.stopPropagation(),d.stopImmediatePropagation();try{const u=[r,i,s].filter(Boolean).join(" ");this.openSettingsModal(!1),this.setSearchKeyword(u),this.lastAutoButtonElement=o;try{const b=e.querySelector('input[name="workId"]')?.value?.trim()??"",y=e.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),p=e.querySelector('a.textContainer[href*="partId="]');let v="";const S=(y?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);S?v=S[1]:p?.href&&(v=(new URL(p.href,location.origin).searchParams.get("partId")??"").trim()),b&&v&&this.settingsManager.saveLastDanimeIds({workId:b,partId:v});}catch(b){console.warn("[SettingsUI] save (workId, partId) skipped:",b);}const g=await this.executeSearch(u);if(g.length===0)return;await this.applySearchResult(g[0]);}catch(u){R.error("SettingsUI.autoCommentButton",u);}}),l.appendChild(h),n.appendChild(o),this.lastAutoButtonElement=o;}),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(e){console.warn("[SettingsUI] restore failed:",e);}});}async waitMypageListStable(){const t=document.querySelector(E.mypageListContainer);if(!t)return;let e=t.querySelectorAll(E.mypageItem).length;const n=Date.now()+1500;return new Promise(r=>{const i=new MutationObserver(()=>{const s=t.querySelectorAll(E.mypageItem).length;if(s!==e){e=s;return}Date.now()>=n&&(i.disconnect(),r());});i.observe(t,{childList:true,subtree:true}),setTimeout(()=>{try{i.disconnect();}catch(s){R.debug("waitMypageListStable: observer already disconnected",s);}r();},1600);})}tryRestoreByDanimeIds(){const t=this.settingsManager.loadLastDanimeIds();if(!t)return  false;const e=Array.from(document.querySelectorAll(E.mypageItem));for(const n of e){if(n.querySelector('input[name="workId"]')?.value?.trim()!==t.workId)continue;const i=n.querySelector('a.textContainer[href*="partId="]'),s=i?.href?(new URL(i.href,location.origin).searchParams.get("partId")??"")===t.partId:false,o=n.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),l=(()=>{const h=(o?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);return !!h&&h[1]===t.partId})();if(s||l){const c=n.querySelector(".auto-comment-button-host")??n;return this.lastAutoButtonElement=c,this.updatePlayButtonState(this.currentVideoInfo),true}}return  false}createSettingsUI(){const t=document.createElement("div");t.className="nico-comment-shadow-host settings-host",this.createShadowDOM(t),this.addStyles(N.getCommonStyles());const e=this.buildSettingsHtml();return this.setHTML(e),this.applySettingsToUI(),this.addStyles(Vt),this.setupEventListeners(),t}buildSettingsHtml(){const t=r=>typeof r=="number"?r.toLocaleString():"-",e=r=>{if(!r)return "-";try{return new Date(r).toLocaleDateString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return r}},n=this.currentVideoInfo;return `
      <div class="nico-comment-settings">
        <h2>
          <span class="settings-title">d-anime-nico-comment-renderer</span>
          <span class="version-badge" aria-label="バージョン">${_e}</span>
        </h2>
          ...
          <div id="currentVideoInfo" class="current-video-info">
            ...
            <div class="info-container" role="list">
              ...
              <div class="info-item" role="listitem" title="投稿日">
                <span class="info-icon" aria-hidden="true">${xn}</span>
        ...
        <div class="settings-modal__content">
          ...
          <div class="settings-modal__tabs" role="tablist">
            <button class="settings-modal__tab is-active" type="button" data-tab="search" role="tab" aria-selected="true" aria-controls="settingsPaneSearch" id="settingsTabSearch">
              <span class="settings-modal__tab-icon" aria-hidden="true">${J}</span>
            ...
            <button class="settings-modal__tab" type="button" data-tab="display" role="tab" aria-selected="false" aria-controls="settingsPaneDisplay" id="settingsTabDisplay" tabindex="-1">
              <span class="settings-modal__tab-icon" aria-hidden="true">${un}</span>
...
`)}</textarea>
          ...
          <footer class="settings-modal__footer">
            <button id="playCurrentVideo" class="settings-modal__play-button" type="button" title="この動画を再生">
              <span class="settings-modal__play-icon" aria-hidden="true">${At}</span>
    ...
    `}setupEventListeners(){this.setupModalControls(),this.setupModalTabs(),this.setupColorPresets(),this.setupColorPicker(),this.setupOpacitySelect(),this.setupVisibilityToggle(),this.setupNgControls(),this.setupSaveButton(),this.setupSearch(),this.setupPlayButton();}setupModalControls(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick);const t=this.createOrUpdateFab(),e=this.queryModalElement(m.settingsModal),n=this.queryModalElement(m.closeSettingsModal),r=this.queryModalElement(m.modalOverlay);this.modalElement=e??null,this.closeButtonElement=n??null,this.overlayElement=r??null,!(!e||!n||!r||!t)&&(this.fabElement?.removeEventListener("click",this.handleFabClick),t.addEventListener("click",this.handleFabClick),t.setAttribute("aria-controls",e.id),t.setAttribute("aria-haspopup","dialog"),t.setAttribute("aria-expanded","false"),this.fabElement=t,n.addEventListener("click",this.handleCloseClick),r.addEventListener("click",this.handleOverlayClick),this.shadowRoot?.addEventListener("keydown",i=>{const s=i;s.key==="Escape"&&!this.modalElement?.classList.contains("hidden")&&(s.preventDefault(),this.closeSettingsModal());}),this.applySettingsToUI());}setupModalTabs(){const t=Array.from(this.queryModalSelectorAll(m.modalTabs)),e=Array.from(this.queryModalSelectorAll(m.modalPane));if(t.length===0||e.length===0)return;const n=r=>{t.forEach(i=>{const o=this.toModalTabKey(i.dataset.tab)===r;i.classList.toggle("is-active",o),i.setAttribute("aria-selected",String(o)),i.setAttribute("tabindex",o?"0":"-1");}),e.forEach(i=>{const o=this.toModalTabKey(i.dataset.pane)===r;i.classList.toggle("is-active",o),i.setAttribute("aria-hidden",String(!o));}),this.activeTab=r;};t.forEach(r=>{r.addEventListener("click",()=>{const i=this.toModalTabKey(r.dataset.tab);i&&n(i);}),r.addEventListener("keydown",i=>{const s=i;if(s.key!=="ArrowRight"&&s.key!=="ArrowLeft")return;s.preventDefault();const o=this.toModalTabKey(r.dataset.tab);if(!o)return;const l=s.key==="ArrowRight"?1:-1,c=(H.indexOf(o)+l+H.length)%H.length,h=H[c];n(h),t.find(u=>this.toModalTabKey(u.dataset.tab)===h)?.focus({preventScroll:true});});}),n(this.activeTab);}openSettingsModal(t=true){!this.modalElement||!this.fabElement||(this.modalElement.classList.remove("hidden"),this.modalElement.setAttribute("aria-hidden","false"),this.fabElement.setAttribute("aria-expanded","true"),t&&this.queryModalElement(`${m.modalTabs}.is-active`)?.focus({preventScroll:true}));}closeSettingsModal(){!this.modalElement||!this.fabElement||(this.modalElement.classList.add("hidden"),this.modalElement.setAttribute("aria-hidden","true"),this.fabElement.setAttribute("aria-expanded","false"),this.fabElement?.isConnected&&this.fabElement.focus({preventScroll:true}));}toModalTabKey(t){return t&&H.includes(t)?t:null}setupColorPresets(){this.queryModalSelectorAll(".color-preset-btn").forEach(e=>{e.addEventListener("click",()=>{const n=e.dataset.color;if(!n)return;this.settings.commentColor=n;const r=this.queryModalElement(m.colorPreview),i=this.queryModalElement(m.colorValue);r&&(r.style.backgroundColor=n),i&&(i.textContent=n);});});}setupColorPicker(){const t=this.queryModalElement(m.colorPickerInput);t&&t.addEventListener("input",()=>{this.settings.commentColor=t.value;const e=this.queryModalElement(m.colorPreview),n=this.queryModalElement(m.colorValue);e&&(e.style.backgroundColor=t.value),n&&(n.textContent=t.value);});}setupOpacitySelect(){const t=this.queryModalElement(m.opacitySelect);t&&(t.value=this.settings.commentOpacity.toString(),t.addEventListener("change",()=>{const e=Number(t.value);Number.isNaN(e)||(this.settings.commentOpacity=e);}));}setupVisibilityToggle(){const t=this.queryModalElement(m.visibilityToggle);t&&(t.addEventListener("click",()=>{this.settings.isCommentVisible=!this.settings.isCommentVisible,this.updateVisibilityToggleState(t);}),this.updateVisibilityToggleState(t));}setupNgControls(){const t=this.queryModalElement(m.ngWords);t&&t.classList.remove("hidden");const e=this.queryModalElement(m.ngRegexps);e&&e.classList.remove("hidden");}setupSaveButton(){const t=this.queryModalElement(m.saveButton);t&&t.addEventListener("click",()=>this.saveSettings());}setupSearch(){const t=this.queryModalElement(m.searchInput),e=this.queryModalElement(m.searchButton),n=this.queryModalElement(m.openSearchPage),r=async()=>{const i=t?.value.trim();if(!i){f.show("キーワードを入力してください","warning");return}await this.executeSearch(i);};e?.addEventListener("click",r),t?.addEventListener("keydown",i=>{i.key==="Enter"&&r();}),n?.addEventListener("click",i=>{i.preventDefault();const s=t?.value.trim(),o=s?Wt(s):wt.searchBase;tt().open(o,"_blank","noopener");});}async executeSearch(t){try{f.show(`「${t}」を検索中...`,"info");const e=await this.searcher.search(t);return this.renderSearchResults(e,n=>this.renderSearchResultItem(n)),e.length===0&&f.show("検索結果が見つかりませんでした","warning"),e}catch(e){return R.error("SettingsUI.executeSearch",e),[]}}setSearchKeyword(t){const e=this.queryModalElement(m.searchInput);e&&(e.value=t,e.focus({preventScroll:true}));}renderSearchResults(t,e){const n=this.queryModalElement(m.searchResults);if(!n)return;n.innerHTML=t.map(i=>e(i)).join(""),n.querySelectorAll(".search-result-item").forEach((i,s)=>{i.addEventListener("click",()=>{const l=t[s];this.applySearchResult(l);});const o=i.querySelector(".open-search-page-direct-btn");o&&o.addEventListener("click",l=>{l.stopPropagation();});});}renderSearchResultItem(t){const e=this.formatSearchResultDate(t.postedAt),n=typeof t.similarity=="number"?`
    ...
    `}async applySearchResult(t){try{const e=await this.fetcher.fetchApiData(t.videoId);await this.fetcher.fetchComments(),f.show(`「${t.title}」のコメントを設定しました`,"success"),this.updateCurrentVideoInfo(this.buildVideoMetadata(t,e));}catch(e){R.error("SettingsUI.applySearchResult",e);}}buildVideoMetadata(t,e){return {videoId:t.videoId,title:t.title,viewCount:e.video?.count?.view??t.viewCount,commentCount:e.video?.count?.comment??t.commentCount,mylistCount:e.video?.count?.mylist??t.mylistCount,postedAt:e.video?.registeredAt??t.postedAt,thumbnail:e.video?.thumbnail?.url??t.thumbnail,owner:e.owner??t.owner??void 0,channel:e.channel??t.channel??void 0}}applySettingsToUI(){const t=this.queryModalElement(m.opacitySelect),e=this.queryModalElement(m.visibilityToggle),n=this.queryModalElement(m.colorPreview),r=this.queryModalElement(m.colorValue),i=this.queryModalElement(m.ngWords),s=this.queryModalElement(m.ngRegexps);t&&(t.value=this.settings.commentOpacity.toString()),e&&this.updateVisibilityToggleState(e),n&&(n.style.backgroundColor=this.settings.commentColor),r&&(r.textContent=this.settings.commentColor),i&&(i.value=this.settings.ngWords.join(`
`)),s&&(s.value=this.settings.ngRegexps.join(`
`)),this.updatePlayButtonState(this.currentVideoInfo);}saveSettings(){const t=this.queryModalElement(m.opacitySelect),e=this.queryModalElement(m.ngWords),n=this.queryModalElement(m.ngRegexps);if(t){const r=Number(t.value);Number.isNaN(r)||(this.settings.commentOpacity=r);}e&&(this.settings.ngWords=e.value.split(`
`).map(r=>r.trim()).filter(Boolean)),n&&(this.settings.ngRegexps=n.value.split(`
`).map(r=>r.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings)?f.show("設定を保存しました","success"):f.show("設定の保存に失敗しました","error");}updateCurrentVideoInfo(t){this.currentVideoInfo=t,[["currentTitle",t.title??"-"],["currentVideoId",t.videoId??"-"],["currentOwner",t.owner?.nickname??t.channel?.name??"-"],["currentViewCount",this.formatNumber(t.viewCount)],["currentCommentCount",this.formatNumber(t.commentCount)],["currentMylistCount",this.formatNumber(t.mylistCount)],["currentPostedAt",this.formatSearchResultDate(t.postedAt)]].forEach(([r,i])=>{const s=this.querySelector(m[r]);s&&(s.textContent=i);});const n=this.querySelector(m.currentThumbnail);n&&t.thumbnail&&(n.src=t.thumbnail,n.alt=t.title??"サムネイル");try{this.settingsManager.saveVideoData(t.title??"",t);}catch(r){R.error("SettingsUI.updateCurrentVideoInfo",r);}this.updatePlayButtonState(t);}formatNumber(t){return typeof t=="number"?t.toLocaleString():"-"}formatSearchResultDate(t){if(!t)return "-";const e=new Date(t);return Number.isNaN(e.getTime())?t:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(e)}setupPlayButton(){const t=this.queryModalElement(m.playCurrentVideo);t&&(t.addEventListener("click",()=>{try{if(!this.currentVideoInfo?.videoId){f.show("再生できる動画が設定されていません","warning");return}const n=this.lastAutoButtonElement?.closest(".itemModule.list");if(this.lastAutoButtonElement){const r=n?.querySelector(".thumbnailContainer > a, .thumbnail-container > a");if(r){f.show(`「${this.currentVideoInfo?.title||"動画"}」を再生します...`,"success"),setTimeout(()=>{r.click();},300);return}}f.show("再生リンクが見つかりませんでした（対象アイテム内に限定して検索済み）","warning");}catch(e){R.error("SettingsUI.playCurrentVideo",e),f.show(`再生エラー: ${e.message}`,"error");}}),this.updatePlayButtonState(this.currentVideoInfo));}updatePlayButtonState(t){const e=this.queryModalElement(m.playCurrentVideo);if(!e)return;const n=!!t?.videoId;e.disabled=!n,e.setAttribute("aria-disabled",(!n).toString());}updateVisibilityToggleState(t){t.textContent=this.settings.isCommentVisible?"表示中":"非表示中",t.classList.toggle("off",!this.settings.isCommentVisible);}destroy(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),super.destroy();}createOrUpdateFab(){if(!document.body)return null;let t=this.fabHostElement;!t||!t.isConnected?(t?.remove(),t=document.createElement("div"),t.id=W.FAB_HOST_ID,t.style.position="fixed",t.style.bottom="32px",t.style.right="32px",t.style.zIndex="2147483646",t.style.display="inline-block",this.fabShadowRoot=t.attachShadow({mode:"open"}),document.body.appendChild(t),this.fabHostElement=t):this.fabShadowRoot||(this.fabShadowRoot=t.shadowRoot??t.attachShadow({mode:"open"}));const e=this.fabShadowRoot;if(!e)return null;let n=e.querySelector("style[data-role='fab-base-style']");n||(n=document.createElement("style"),n.dataset.role="fab-base-style",n.textContent=N.getCommonStyles(),e.appendChild(n));let r=e.querySelector("style[data-role='fab-style']");r||(r=document.createElement("style"),r.dataset.role="fab-style",r.textContent=`
        :host {
          all: initial;
        }
      ...
      `,e.appendChild(r));let i=e.querySelector("style[data-role='similarity-style']");i||(i=document.createElement("style"),i.dataset.role="similarity-style",i.textContent=Vt,e.appendChild(i));let s=e.querySelector("style[data-role='modal-play-button-style']");s||(s=document.createElement("style"),s.dataset.role="modal-play-button-style",s.textContent=Cn,e.appendChild(s));let o=e.querySelector(".fab-container");o||(o=document.createElement("div"),o.className="fab-container",e.appendChild(o));let l=o.querySelector("button.fab-button");l||(l=document.createElement("button"),l.type="button",l.className="fab-button",o.appendChild(l)),l.innerHTML=`
      <span class="fab-button__icon" aria-hidden="true">${J}</span>
      <span class="fab-button__label">設定</span>
    `,l.setAttribute("aria-label","ニコニココメント設定を開く"),l.setAttribute("aria-haspopup","dialog");let c=o.querySelector(m.settingsModal);return c||(o.insertAdjacentHTML("beforeend",this.buildModalHtml()),c=o.querySelector(m.settingsModal)),this.modalElement=c??null,l}removeFabElement(){this.fabElement&&this.fabElement.removeEventListener("click",this.handleFabClick),this.fabHostElement?.isConnected&&this.fabHostElement.remove(),this.fabElement=null,this.fabHostElement=null,this.fabShadowRoot=null;}queryModalElement(t){return this.fabShadowRoot?this.fabShadowRoot.querySelector(t):null}queryModalSelectorAll(t){return this.fabShadowRoot?this.fabShadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}}const Lt=async()=>{},En=()=>{const a=tt();if(!a.dAniRenderer){const t={};a.dAniRenderer={classes:{Comment:Rt,CommentRenderer:Nt,NicoApiFetcher:it,NotificationManager:f,StyleManager:Bt,SettingsUI:W,NicoVideoSearcher:qt,VideoSwitchHandler:$t,SettingsManager:nt,KeyboardShortcutHandler:Ht,DebounceExecutor:st,ShadowDOMComponent:rt,ShadowStyleManager:N},instances:t,utils:{initialize:Lt,initializeWithVideo:Lt},debug:{showState:()=>{console.log("Current instances:",t);},showSettings:()=>{const e=t.settingsManager;if(!e){console.log("SettingsManager not initialized");return}console.log("Current settings:",e.getSettings());},showComments:()=>{const e=t.renderer;if(!e){console.log("CommentRenderer not initialized");return}console.log("Current comments:",e.getCommentsSnapshot());}},defaultSettings:I};}return a.dAniRenderer},Mn=100,An=1e3,Vn=3e3;class Ln{constructor(t){this.global=t;}initialized=false;switchDebounce=new st(An);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement();}async ensureDocumentReady(){document.readyState!=="complete"&&await new Promise(t=>{window.addEventListener("load",()=>t(),{once:true});});}waitForVideoElement(){if(this.initialized)return;const t=document.querySelector(E.watchVideoElement);if(!t){window.setTimeout(()=>this.waitForVideoElement(),Mn);return}if(t.readyState===0){t.addEventListener("loadedmetadata",()=>{this.initializeWithVideo(t);},{once:true});return}this.initializeWithVideo(t);}async initializeWithVideo(t){if(!this.initialized){this.initialized=true;try{f.show("コメントローダーを初期化中...");const e=f.getInstance(),n=this.global.settingsManager??new nt(e);this.global.settingsManager=n,this.global.instances.settingsManager=n;const r=n.loadVideoData();if(!r?.videoId)throw new Error("動画データが見つかりません。マイページで設定してください。");const i=new it;this.global.instances.fetcher=i,await i.fetchApiData(r.videoId);const s=await i.fetchComments(),o=this.mergeSettings(n.loadSettings()),l=new Nt(o);l.initialize(t),this.global.instances.renderer=l,this.currentVideoElement=t,n.addObserver(h=>{l.settings=this.mergeSettings(h);}),s.forEach(h=>{l.addComment(h.text,h.vpos,h.commands);});const c=new $t(l,i,n);c.startMonitoring(),this.global.instances.switchHandler=c,this.setupSwitchHandling(t,c),this.observeVideoElement(),f.show(`コメントの読み込みが完了しました（${s.length}件）`,"success");}catch(e){throw this.initialized=false,f.show(`初期化エラー: ${e.message}`,"error"),e}}}mergeSettings(t){const e=I();return {...e,...t,ngWords:[...t.ngWords??e.ngWords],ngRegexps:[...t.ngRegexps??e.ngRegexps]}}setupSwitchHandling(t,e){this.currentVideoElement=t,this.switchCallback=()=>{const n=Date.now();if(n-this.lastSwitchTimestamp<Vn)return;this.lastSwitchTimestamp=n;const r=this.currentVideoElement;e.onVideoSwitch(r);},this.global.utils.initializeWithVideo=async n=>{n&&(this.rebindVideoElement(n),await e.onVideoSwitch(n));},this.currentVideoElement=t;}observeVideoElement(){const t=this.currentVideoElement;t&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{const e=document.querySelector(E.watchVideoElement);!e||e===this.currentVideoElement||this.rebindVideoElement(e);}),this.domMutationObserver.observe(document.body,{childList:true,subtree:true}),this.attachVideoEventListeners(t));}rebindVideoElement(t){this.detachVideoEventListeners(),this.currentVideoElement=t;const e=this.global.instances.renderer,n=this.global.instances.switchHandler;e&&(e.destroy(),e.initialize(t),e.resize()),n&&(n.onVideoSwitch(t),this.setupSwitchHandling(t,n)),this.attachVideoEventListeners(t);}attachVideoEventListeners(t){this.detachVideoEventListeners();const e=()=>{this.switchCallback&&(this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));};t.addEventListener("ended",e),t.addEventListener("loadedmetadata",e),t.addEventListener("emptied",e),this.videoEndedListener=e;}detachVideoEventListeners(){const t=this.currentVideoElement;t&&this.videoEndedListener&&(t.removeEventListener("ended",this.videoEndedListener),t.removeEventListener("loadedmetadata",this.videoEndedListener),t.removeEventListener("emptied",this.videoEndedListener)),this.videoEndedListener=null;}}const kn=100;class Tn{constructor(t){this.global=t;}initialize(){const t=f.getInstance(),e=this.global.settingsManager??new nt(t);this.global.settingsManager=e,this.global.instances.settingsManager=e;const n=new W(e);this.waitForHeader(n);}waitForHeader(t){if(!document.querySelector(E.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(t),kn);return}t.insertIntoMypage(),t.addAutoCommentButtons(),this.observeList(t);}observeList(t){const e=document.querySelector(E.mypageListContainer);if(!e)return;new MutationObserver(()=>{try{t.addAutoCommentButtons();}catch(r){console.error("[MypageController] auto comment buttons update failed",r);}}).observe(e,{childList:true,subtree:true});}}class In{log;global=En();watchController=null;mypageController=null;constructor(){this.log=_("DanimeApp");}start(){this.log.info("starting renderer"),Bt.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener("load",()=>{this.initialize();});}async initialize(){if(!this.acquireInstanceLock()){this.log.info("renderer already initialized, skipping");return}const t=location.pathname.toLowerCase();try{t.includes("/animestore/sc_d_pc")?(this.watchController=new Ln(this.global),await this.watchController.initialize()):t.includes("/animestore/mp_viw_pc")?(this.mypageController=new Tn(this.global),this.mypageController.initialize()):this.log.info("page not supported, initialization skipped");}catch(e){this.log.error("initialization failed",e);}}acquireInstanceLock(){const t=tt();return t.__dAnimeNicoCommentRenderer2Instance=(t.__dAnimeNicoCommentRenderer2Instance??0)+1,t.__dAnimeNicoCommentRenderer2Instance===1}}const Z=_("dAnimeNicoCommentRenderer2");async function _n(){Z.info("bootstrap start");try{new In().start(),Z.info("bootstrap completed");}catch(a){Z.error("bootstrap failed",a);}}_n();
