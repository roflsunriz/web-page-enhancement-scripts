...
(function () {
  ...
  const Ne={debug:"debug",info:"info",warn:"warn",error:"error"},F=t=>{const e=`[${t}]`,n={};return Object.keys(Ne).forEach(r=>{const i=Ne[r];n[r]=(...s)=>{(console[i]??console.log)(e,...s);};}),n};function ke(){return typeof unsafeWindow<"u"?unsafeWindow:window}const Dt={small:.8,medium:1,big:1.4},Nt={defont:'"MS PGothic","Hiragino Kaku Gothic ProN","Hiragino Kaku Gothic Pro","Yu Gothic UI","Yu Gothic","Meiryo","Segoe UI","Osaka","Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","IPAPGothic","TakaoPGothic","Roboto","Helvetica Neue","Helvetica","Arial","sans-serif"',gothic:'"Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","Yu Gothic","Yu Gothic Medium","Meiryo","MS PGothic","Hiragino Kaku Gothic ProN","Segoe UI","Helvetica","Arial","sans-serif"',mincho:'"MS PMincho","MS Mincho","Hiragino Mincho ProN","Hiragino Mincho Pro","Yu Mincho","Noto Serif CJK JP","Noto Serif JP","Source Han Serif JP","Times New Roman","serif"'},ct={white:"#FFFFFC",red:"#FF8888",pink:"#FFA5CC",orange:"#FFBA66",yellow:"#FFFFAA",green:"#88FF88",cyan:"#88FFFF",blue:"#8899FF",purple:"#D9A5FF",black:"#444444",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},Te=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,Ht=/^[,.:;]+/,zt=/[,.:;]+$/,Ot=t=>{const e=t.trim();return e?Te.test(e)?e:e.replace(Ht,"").replace(zt,""):""},$t=t=>Te.test(t)?t.toUpperCase():null,dt=t=>{const e=t.trim();if(!e)return null;const n=e.toLowerCase().endsWith("px")?e.slice(0,-2):e,r=Number.parseFloat(n);return Number.isFinite(r)?r:null},Wt=t=>{const e=t.trim();if(!e)return null;if(e.endsWith("%")){const n=Number.parseFloat(e.slice(0,-1));return Number.isFinite(n)?n/100:null}return dt(e)},qt=t=>Number.isFinite(t)?Math.min(100,Math.max(-100,t)):0,Bt=t=>!Number.isFinite(t)||t===0?1:Math.min(5,Math.max(.25,t)),Ut=t=>t==="naka"||t==="ue"||t==="shita",Gt=t=>t==="small"||t==="medium"||t==="big",Kt=t=>t==="defont"||t==="gothic"||t==="mincho",jt=t=>t in ct,Yt=(t,e)=>{let n="naka",r="medium",i="defont",s=null,a=1,o=null,l=false,d=0,h=1;for(const g of t){const y=Ot(typeof g=="string"?g:"");if(!y)continue;if(Te.test(y)){const w=$t(y);if(w){s=w;continue}}const x=y.toLowerCase();if(Ut(x)){n=x;continue}if(Gt(x)){r=x;continue}if(Kt(x)){i=x;continue}if(jt(x)){s=ct[x].toUpperCase();continue}if(x==="_live"){o=.5;continue}if(x==="invisible"){a=0,l=true;continue}if(x.startsWith("ls:")||x.startsWith("letterspacing:")){const w=y.indexOf(":");if(w>=0){const C=dt(y.slice(w+1));C!==null&&(d=qt(C));}continue}if(x.startsWith("lh:")||x.startsWith("lineheight:")){const w=y.indexOf(":");if(w>=0){const C=Wt(y.slice(w+1));C!==null&&(h=Bt(C));}continue}}const c=Math.max(0,Math.min(1,a)),p=(s??e.defaultColor).toUpperCase(),u=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:n,size:r,sizeScale:Dt[r],font:i,fontFamily:Nt[i],resolvedColor:p,colorOverride:s,opacityMultiplier:c,opacityOverride:u,isInvisible:l,letterSpacing:d,lineHeight:h}},Xt=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,te=t=>t.length===1?t.repeat(2):t,z=t=>Number.parseInt(t,16),B=t=>!Number.isFinite(t)||t<=0?0:t>=1?1:t,ht=(t,e)=>{const n=Xt.exec(t);if(!n)return t;const r=n[1];let i,s,a,o=1;r.length===3||r.length===4?(i=z(te(r[0])),s=z(te(r[1])),a=z(te(r[2])),r.length===4&&(o=z(te(r[3]))/255)):(i=z(r.slice(0,2)),s=z(r.slice(2,4)),a=z(r.slice(4,6)),r.length===8&&(o=z(r.slice(6,8))/255));const l=B(o*B(e));return `rgba(${i}, ${s}, ${a}, ${l})`},Jt=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),pt=()=>Jt(),L=t=>t*1e3,Zt=t=>!Number.isFinite(t)||t<0?null:Math.round(t),_e=4e3,He=1800,Qt=3,en=.25,tn=32,nn=48,oe=120,rn=4e3,pe=120,sn=800,an=2,Q=4e3,q=4e3,D=q+_e,on=1e3,ze=1,ut=12,mt=24,_=.001,$=50,ln=5,cn=2,Oe=8,dn=12,$e={debug:0,info:1,warn:2,error:3},hn=(t,e,n)=>{const r=[`[${e}]`,...n];switch(t){case "debug":console.debug(...r);break;case "info":console.info(...r);break;case "warn":console.warn(...r);break;case "error":console.error(...r);break;default:console.log(...r);}},gt=(t,e={})=>{const{level:n="info",emitter:r=hn}=e,i=$e[n],s=(a,o)=>{$e[a]<i||r(a,t,o);};return {debug:(...a)=>s("debug",a),info:(...a)=>s("info",a),warn:(...a)=>s("warn",a),error:(...a)=>s("error",a)}},Ve=gt("CommentEngine:Comment"),We=new WeakMap,pn=t=>{let e=We.get(t);return e||(e=new Map,We.set(t,e)),e},Ie=(t,e)=>{if(!t)return 0;const n=`${t.font??""}::${e}`,r=pn(t),i=r.get(n);if(i!==void 0)return i;const s=t.measureText(e).width;return r.set(n,s),s},un=t=>{if(t.includes(`
`)){const e=t.split(/\r?\n/);return e.length>0?e:[""]}return [t]},qe=t=>Math.max(24,t),ue=(t,e)=>{let n=0;const r=t.letterSpacing;for(const a of t.lines){const o=Ie(e,a),l=a.length>1?r*(a.length-1):0,d=Math.max(0,o+l);d>n&&(n=d);}t.width=n;const i=Math.max(1,Math.floor(t.fontSize*t.lineHeightMultiplier));t.lineHeightPx=i;const s=t.lines.length>1?(t.lines.length-1)*i:0;t.height=t.fontSize+s;},mn=(t,e,n,r,i)=>{try{if(!e)throw new Error("Canvas context is required");if(!Number.isFinite(n)||!Number.isFinite(r))throw new Error("Canvas dimensions must be numbers");if(!i)throw new Error("Prepare options are required");const s=Math.max(n,1),a=qe(Math.floor(r*.05)),o=qe(Math.floor(a*t.sizeScale));t.fontSize=o,e.font=`${t.fontSize}px ${t.fontFamily}`,t.lines=un(t.text),ue(t,e);const l=!t.isScrolling&&(t.layout==="ue"||t.layout==="shita");if(l){const A=Math.max(1,s-Oe*2);if(t.width>A){const H=Math.max(dn,Math.min(t.fontSize,Math.floor(a*.6))),he=A/Math.max(t.width,1),j=Math.max(H,Math.floor(t.fontSize*Math.min(he,1)));j<t.fontSize&&(t.fontSize=j,e.font=`${t.fontSize}px ${t.fontFamily}`,ue(t,e));let Re=0;for(;t.width>A&&t.fontSize>H&&Re<5;){const Rt=A/Math.max(t.width,1),De=Math.max(H,Math.floor(t.fontSize*Math.max(Rt,.7)));De>=t.fontSize?t.fontSize=Math.max(H,t.fontSize-1):t.fontSize=De,e.font=`${t.fontSize}px ${t.fontFamily}`,ue(t,e),Re+=1;}}}if(!t.isScrolling){t.bufferWidth=0;const A=l?Oe:0,H=Math.max((s-t.width)/2,A),he=Math.max(A,s-t.width-A),j=Math.min(H,Math.max(he,A));t.virtualStartX=j,t.x=j,t.baseSpeed=0,t.speed=0,t.speedPixelsPerMs=0,t.visibleDurationMs=q,t.preCollisionDurationMs=q,t.totalDurationMs=q,t.reservationWidth=t.width,t.staticExpiryTimeMs=t.vposMs+q,t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;return}t.staticExpiryTimeMs=null;const d=Ie(e,"??".repeat(150)),h=t.width*Math.max(i.bufferRatio,0);t.bufferWidth=Math.max(i.baseBufferPx,h);const c=Math.max(i.entryBufferPx,t.bufferWidth),p=t.scrollDirection,u=p==="rtl"?s+i.virtualExtension:-t.width-t.bufferWidth-i.virtualExtension,g=p==="rtl"?-t.width-t.bufferWidth-c:s+c,y=p==="rtl"?s+c:-c,x=p==="rtl"?u+t.width+t.bufferWidth:u-t.bufferWidth;t.virtualStartX=u,t.x=u,t.exitThreshold=g;const w=s>0?t.width/s:0,C=i.maxVisibleDurationMs===i.minVisibleDurationMs;let I=i.maxVisibleDurationMs;if(!C&&w>1){const A=Math.min(w,i.maxWidthRatio),H=i.maxVisibleDurationMs/Math.max(A,1);I=Math.max(i.minVisibleDurationMs,Math.floor(H));}const M=s+t.width+t.bufferWidth+c,It=Math.max(I,1),de=M/It,Pt=de*1e3/60;t.baseSpeed=Pt,t.speed=t.baseSpeed,t.speedPixelsPerMs=de;const At=Math.abs(g-u),Lt=p==="rtl"?Math.max(0,x-y):Math.max(0,y-x),Fe=Math.max(de,Number.EPSILON);t.visibleDurationMs=I,t.preCollisionDurationMs=Math.max(0,Math.ceil(Lt/Fe)),t.totalDurationMs=Math.max(t.preCollisionDurationMs,Math.ceil(At/Fe));const Ft=t.width+t.bufferWidth+c;t.reservationWidth=Math.min(d,Ft),t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;}catch(s){throw Ve.error("Comment.prepare",s,{text:t.text,visibleWidth:n,canvasHeight:r,hasContext:!!e}),s}},ft=5,N={enabled:false,maxLogsPerCategory:ft},ae=new Map,gn=t=>{if(t===void 0||!Number.isFinite(t))return ft;const e=Math.max(1,Math.floor(t));return Math.min(1e4,e)},fn=t=>{N.enabled=!!t.enabled,N.maxLogsPerCategory=gn(t.maxLogsPerCategory),N.enabled||ae.clear();},O=()=>N.enabled,bn=t=>{const e=ae.get(t)??0;return e>=N.maxLogsPerCategory?(e===N.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${t}]`,"Further logs suppressed."),ae.set(t,e+1)),false):(ae.set(t,e+1),true)},E=(t,...e)=>{N.enabled&&bn(t)&&console.debug(`[CommentOverlay][${t}]`,...e);},ee=(t,e=32)=>t.length<=e?t:`${t.slice(0,e)}…`,yn=(t,e)=>{N.enabled&&(console.group(`[CommentOverlay][state-dump] ${t}`),console.table({"Current Time":`${e.currentTime.toFixed(2)}ms`,Duration:`${e.duration.toFixed(2)}ms`,"Is Playing":e.isPlaying,"Epoch ID":e.epochId,"Total Comments":e.totalComments,"Active Comments":e.activeComments,"Reserved Lanes":e.reservedLanes,"Final Phase":e.finalPhaseActive,"Playback Begun":e.playbackHasBegun,"Is Stalled":e.isStalled}),console.groupEnd());},vn=(t,e,n)=>{N.enabled&&E("epoch-change",`Epoch changed: ${t} → ${e} (reason: ${n})`);},S={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},Be=()=>{if(!O())return;const t=performance.now();if(t-S.lastReported<=5e3)return;const e=S.hits+S.misses,n=e>0?S.hits/e*100:0,r=S.creates>0?(S.totalCharactersDrawn/S.creates).toFixed(1):"0",i=S.outlineCallsInCache+S.outlineCallsInFallback,s=S.fillCallsInCache+S.fillCallsInFallback;console.log("[TextureCache Stats]",`
            ...
            <div class="video-card__info">
              ...
              <div class="video-card__main">
                ...
                <div class="video-card__owner" title="投稿者">
                  <span class="video-card__owner-icon" aria-hidden="true">${Se}</span>
              ...
              <div class="video-card__stats">
                ...
                <div class="video-card__stat" title="コメント数">
                  <span class="video-card__stat-icon" aria-hidden="true">${Me}</span>
    ...
    `}setupEventListeners(){this.setupModalControls(),this.setupModalTabs(),this.setupColorPresets(),this.setupColorPicker(),this.setupColorHexInput(),this.setupOpacitySlider(),this.setupVisibilityToggle(),this.setupAutoSearchToggle(),this.setupPlaybackToggle(),this.setupNgControls(),this.setupSaveButton(),this.setupSearch();}setupModalControls(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick);const e=this.createOrUpdateFab(),n=this.queryModalElement(b.settingsModal),r=this.queryModalElement(b.closeSettingsModal),i=this.queryModalElement(b.modalOverlay);this.modalElement=n??null,this.closeButtonElement=r??null,this.overlayElement=i??null,!(!n||!r||!i||!e)&&(this.fabElement?.removeEventListener("click",this.handleFabClick),e.addEventListener("click",this.handleFabClick),e.setAttribute("aria-controls",n.id),e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false"),this.fabElement=e,r.addEventListener("click",this.handleCloseClick),i.addEventListener("click",this.handleOverlayClick),this.shadowRoot?.addEventListener("keydown",s=>{const a=s;a.key==="Escape"&&!this.modalElement?.classList.contains("hidden")&&(a.preventDefault(),this.closeSettingsModal());}),this.applySettingsToUI());}setupModalTabs(){const e=Array.from(this.queryModalSelectorAll(b.modalTabs)),n=Array.from(this.queryModalSelectorAll(b.modalPane));if(e.length===0||n.length===0)return;const r=i=>{e.forEach(s=>{const o=this.toModalTabKey(s.dataset.tab)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-selected",String(o)),s.setAttribute("tabindex",o?"0":"-1");}),n.forEach(s=>{const o=this.toModalTabKey(s.dataset.pane)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-hidden",String(!o));}),this.activeTab=i;};e.forEach(i=>{i.addEventListener("click",()=>{const s=this.toModalTabKey(i.dataset.tab);s&&r(s);}),i.addEventListener("keydown",s=>{const a=s;if(a.key!=="ArrowRight"&&a.key!=="ArrowLeft")return;a.preventDefault();const o=this.toModalTabKey(i.dataset.tab);if(!o)return;const l=a.key==="ArrowRight"?1:-1,d=(J.indexOf(o)+l+J.length)%J.length,h=J[d];r(h),e.find(p=>this.toModalTabKey(p.dataset.tab)===h)?.focus({preventScroll:true});});}),r(this.activeTab);}openSettingsModal(e=true){!this.modalElement||!this.fabElement||(this.modalElement.classList.remove("hidden"),this.modalElement.setAttribute("aria-hidden","false"),this.fabElement.setAttribute("aria-expanded","true"),e&&this.queryModalElement(`${b.modalTabs}.is-active`)?.focus({preventScroll:true}));}closeSettingsModal(){!this.modalElement||!this.fabElement||(this.modalElement.classList.add("hidden"),this.modalElement.setAttribute("aria-hidden","true"),this.fabElement.setAttribute("aria-expanded","false"),this.fabElement?.isConnected&&this.fabElement.focus({preventScroll:true}));}toModalTabKey(e){return e&&J.includes(e)?e:null}setupColorPresets(){this.queryModalSelectorAll(".color-preset-btn").forEach(n=>{n.addEventListener("click",()=>{const r=n.dataset.color;r&&(this.settings.commentColor=r,this.updateColorUI(r),this.updatePreview());});});}setupColorPicker(){const e=this.queryModalElement(b.colorPickerInput);e&&e.addEventListener("input",()=>{this.settings.commentColor=e.value,this.updateColorUI(e.value),this.updatePreview();});}setupColorHexInput(){const e=this.queryModalElement(b.colorHexInput);e&&(e.addEventListener("input",()=>{const n=e.value.trim();/^#[0-9A-Fa-f]{6}$/.test(n)&&(this.settings.commentColor=n,this.updateColorUI(n,false),this.updatePreview());}),e.addEventListener("blur",()=>{e.value=this.settings.commentColor;}));}updateColorUI(e,n=true){const r=this.queryModalElement(b.colorPickerInput),i=this.queryModalElement(b.colorHexInput);r&&(r.value=e),i&&n&&(i.value=e);}setupOpacitySlider(){const e=this.queryModalElement(b.opacitySlider),n=this.queryModalElement(b.opacityValue);e&&(e.value=(this.settings.commentOpacity??1).toString(),e.addEventListener("input",()=>{const r=Number(e.value);Number.isNaN(r)||(this.settings.commentOpacity=r,n&&(n.textContent=`${Math.round(r*100)}%`),this.updatePreview());}));}setupVisibilityToggle(){const e=this.queryModalElement(b.visibilityToggle);e&&(e.addEventListener("click",()=>{this.settings.isCommentVisible=!this.settings.isCommentVisible,this.updateVisibilityToggleState(e),this.updatePreview();}),this.updateVisibilityToggleState(e));}setupAutoSearchToggle(){const e=this.queryModalElement(b.autoSearchToggle),n=this.queryModalElement(b.autoSearchOptionRow);if(!e||!n)return;const r=()=>{this.settings.autoSearchEnabled=!this.settings.autoSearchEnabled,this.updateAutoSearchToggleState(),this.updateSearchSectionNote(),this.settingsManager.updateSettings(this.settings),f.show(this.settings.autoSearchEnabled?"自動検索を有効にしました":"自動検索を無効にしました（手動設定モード）","success");};n.addEventListener("click",i=>{i.target.closest(".playback-option__toggle")||r();}),n.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r());}),e.addEventListener("change",()=>{r();}),this.updateAutoSearchToggleState();}updateAutoSearchToggleState(){const e=this.settings.autoSearchEnabled,n=this.queryModalElement(b.autoSearchToggle),r=this.queryModalElement(b.autoSearchOptionRow),i=r?.querySelector(".playback-option__icon-wrapper");n&&(n.checked=e),r&&(r.classList.toggle("playback-option--active",e),r.setAttribute("aria-pressed",e?"true":"false")),i&&i.classList.toggle("playback-option__icon-wrapper--active",e);}updateSearchSectionNote(){const e=this.queryModalElement(b.searchSectionNote);if(!e)return;const n=this.settings.autoSearchEnabled;e.style.background=n?"#7F5AF0":"#2CB67D",e.innerHTML=n?`ℹ️ <strong>自動設定機能が有効です</strong><br>
      ...
      <div class="search-result-item">
        ...
        <div class="search-result-info">
          ...
          <a href="${Ze.watchBase}/${e.videoId}" target="_blank" rel="noopener"
...
`).map(i=>i.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings);}updateCurrentVideoInfo(e){this.currentVideoInfo=e,[["currentTitle",e.title??"-"],["currentVideoId",e.videoId??"-"],["currentOwner",e.owner?.nickname??e.channel?.name??"-"],["currentViewCount",this.formatNumber(e.viewCount)],["currentCommentCount",this.formatNumber(e.commentCount)],["currentMylistCount",this.formatNumber(e.mylistCount)],["currentPostedAt",this.formatSearchResultDate(e.postedAt)]].forEach(([a,o])=>{const l=this.querySelector(b[a]);l&&(l.textContent=o);});const r=this.querySelector(b.currentThumbnail);r&&e.thumbnail&&(r.src=e.thumbnail,r.alt=e.title??"サムネイル");const i=this.querySelector("#currentVideoAmbient");i&&e.thumbnail&&(i.style.backgroundImage=`url('${e.thumbnail}')`);const s=this.querySelector(".video-card");s&&s.classList.toggle("video-card--empty",!e.videoId);try{this.settingsManager.saveVideoData(e.title??"",e);}catch(a){X.error("SettingsUI.updateCurrentVideoInfo",a);}}formatNumber(e){return typeof e=="number"?e.toLocaleString():"-"}formatSearchResultDate(e){if(!e)return "-";const n=new Date(e);return Number.isNaN(n.getTime())?e:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(n)}formatPlaybackRateLabel(e){return `${(Number.isFinite(e)?e:1.11).toFixed(2).replace(/\.?0+$/,"")}倍`}updateVisibilityToggleState(e){const n=this.settings.isCommentVisible;e.classList.toggle("visibility-badge--off",!n),e.setAttribute("aria-pressed",n?"true":"false");const r=e.querySelector(".visibility-badge__icon"),i=e.querySelector(".visibility-badge__label");r&&(r.innerHTML=n?se:ie),i&&(i.textContent=n?"表示中":"非表示");}applyPlaybackSettingsToUI(){this.updatePlaybackToggleState();}updatePlaybackToggleState(){const e=this.playbackSettings.fixedModeEnabled,n=this.queryModalElement(b.fixedPlaybackToggle),r=this.queryModalElement(b.playbackOptionRow),i=r?.querySelector(".playback-option__icon-wrapper");n&&(n.checked=e),r&&(r.classList.toggle("playback-option--active",e),r.setAttribute("aria-pressed",e?"true":"false")),i&&i.classList.toggle("playback-option__icon-wrapper--active",e);}updatePreview(){const e=this.queryModalElement(b.previewComment),n=this.queryModalElement(b.previewHiddenMsg);e&&(e.style.color=this.settings.commentColor,e.style.opacity=String(this.settings.commentOpacity??1),e.style.display=this.settings.isCommentVisible?"block":"none"),n&&(n.style.display=this.settings.isCommentVisible?"none":"flex");}destroy(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),this.settingsManager.removePlaybackObserver(this.handlePlaybackSettingsChanged),super.destroy();}createOrUpdateFab(){if(!document.body)return null;let e=this.fabHostElement;!e||!e.isConnected?(e?.remove(),e=document.createElement("div"),e.id=ce.FAB_HOST_ID,e.style.position="fixed",e.style.bottom="32px",e.style.right="32px",e.style.zIndex="2147483646",e.style.display="inline-block",this.fabShadowRoot=e.attachShadow({mode:"open"}),document.body.appendChild(e),this.fabHostElement=e):this.fabShadowRoot||(this.fabShadowRoot=e.shadowRoot??e.attachShadow({mode:"open"}));const n=this.fabShadowRoot;if(!n)return null;let r=n.querySelector("style[data-role='fab-base-style']");r||(r=document.createElement("style"),r.dataset.role="fab-base-style",r.textContent=le.getCommonStyles(),n.appendChild(r));let i=n.querySelector("style[data-role='fab-style']");i||(i=document.createElement("style"),i.dataset.role="fab-style",i.textContent=`
      ...
      `,n.appendChild(i));let s=n.querySelector("style[data-role='similarity-style']");s||(s=document.createElement("style"),s.dataset.role="similarity-style",s.textContent=st,n.appendChild(s));let a=n.querySelector("style[data-role='search-fields-style']");a||(a=document.createElement("style"),a.dataset.role="search-fields-style",a.textContent=hs,n.appendChild(a));let o=n.querySelector(".fab-container");o||(o=document.createElement("div"),o.className="fab-container",n.appendChild(o));let l=o.querySelector("button.fab-button");l||(l=document.createElement("button"),l.type="button",l.className="fab-button",o.appendChild(l)),l.innerHTML=`
      <span class="fab-button__icon" aria-hidden="true">${se}</span>
      <span class="fab-button__label">設定</span>
    `,l.setAttribute("aria-label","ニコニココメント設定を開く"),l.setAttribute("aria-haspopup","dialog");let d=o.querySelector(b.settingsModal);return d||(o.insertAdjacentHTML("beforeend",this.buildModalHtml()),d=o.querySelector(b.settingsModal)),this.modalElement=d??null,l}removeFabElement(){this.fabElement&&this.fabElement.removeEventListener("click",this.handleFabClick),this.fabHostElement?.isConnected&&this.fabHostElement.remove(),this.fabElement=null,this.fabHostElement=null,this.fabShadowRoot=null;}queryModalElement(e){return this.fabShadowRoot?this.fabShadowRoot.querySelector(e):null}queryModalSelectorAll(e){return this.fabShadowRoot?this.fabShadowRoot.querySelectorAll(e):document.createDocumentFragment().childNodes}}const ps=F("dAnime:PlaybackRateController"),us=1,ms=200,gs=1e-4;class Ee{constructor(e){this.settingsManager=e,this.playbackSettings=this.settingsManager.getPlaybackSettings(),this.settingsObserver=n=>{this.playbackSettings=n,this.applyCurrentMode();},this.settingsManager.addPlaybackObserver(this.settingsObserver);}currentVideo=null;playbackSettings;settingsObserver;isApplying=false;retryTimer=null;handleLoadedMetadata=()=>{this.applyCurrentMode();};handleRateChange=()=>{this.isApplying||this.playbackSettings.fixedModeEnabled&&this.scheduleApply();};handlePlay=()=>{this.applyCurrentMode();};handleEmptied=()=>{this.scheduleApply();};bind(e){if(this.currentVideo===e){this.applyCurrentMode();return}this.detachVideoListeners(),this.cancelScheduledApply(),this.currentVideo=e,this.attachVideoListeners(e),this.applyCurrentMode();}unbind(){this.cancelScheduledApply(),this.detachVideoListeners(),this.currentVideo=null;}dispose(){this.unbind(),this.settingsManager.removePlaybackObserver(this.settingsObserver);}attachVideoListeners(e){e.addEventListener("loadedmetadata",this.handleLoadedMetadata),e.addEventListener("ratechange",this.handleRateChange),e.addEventListener("play",this.handlePlay),e.addEventListener("emptied",this.handleEmptied);}detachVideoListeners(){this.currentVideo&&(this.currentVideo.removeEventListener("loadedmetadata",this.handleLoadedMetadata),this.currentVideo.removeEventListener("ratechange",this.handleRateChange),this.currentVideo.removeEventListener("play",this.handlePlay),this.currentVideo.removeEventListener("emptied",this.handleEmptied));}applyCurrentMode(){const e=this.currentVideo;e&&(this.playbackSettings.fixedModeEnabled?this.setPlaybackRate(e,this.playbackSettings.fixedRate):this.setPlaybackRate(e,us));}setPlaybackRate(e,n){if(!(!Number.isFinite(n)||n<=0)&&!(Math.abs(e.playbackRate-n)<=gs)){this.isApplying=true;try{e.playbackRate=n;}catch(r){ps.warn("再生速度の設定に失敗しました",r),this.scheduleApply();}finally{window.setTimeout(()=>{this.isApplying=false;},0);}}}scheduleApply(){this.cancelScheduledApply(),this.retryTimer=window.setTimeout(()=>{this.retryTimer=null,this.applyCurrentMode();},ms);}cancelScheduledApply(){this.retryTimer!==null&&(window.clearTimeout(this.retryTimer),this.retryTimer=null);}}const at=async()=>{},fs=()=>{const t=ke();if(!t.dAniRenderer){const e={};t.dAniRenderer={classes:{Comment:vt,CommentRenderer:Z,NicoApiFetcher:K,NotificationManager:f,StyleManager:Vt,SettingsUI:ce,NicoVideoSearcher:R,VideoSwitchHandler:we,SettingsManager:Pe,KeyboardShortcutHandler:Ct,DebounceExecutor:Le,ShadowDOMComponent:Ae,ShadowStyleManager:le,PlaybackRateController:Ee},instances:e,utils:{initialize:at,initializeWithVideo:at},debug:{showState:()=>{console.log("Current instances:",e);},showSettings:()=>{const n=e.settingsManager;if(!n){console.log("SettingsManager not initialized");return}console.log("Current settings:",n.getSettings());},showComments:()=>{const n=e.renderer;if(!n){console.log("CommentRenderer not initialized");return}console.log("Current comments:",n.getCommentsSnapshot());}},defaultSettings:W};}return t.dAniRenderer},bs=100,ys=1e3,ot=3e3,vs=2e3,lt="cachedAnimeTitle",m=F("dAnime:WatchPageController");class xs{constructor(e){this.global=e;try{this.cachedAnimeTitle=U(lt,null),this.cachedAnimeTitle&&m.info("watchPageController:constructor:loadedCachedTitle",{cachedAnimeTitle:this.cachedAnimeTitle});}catch(n){m.error("watchPageController:constructor:loadCacheFailed",n),this.cachedAnimeTitle=null;}}initialized=false;switchDebounce=new Le(ys);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;playbackRateController=null;lastPartId=null;partIdMonitorIntervalId=null;isPartIdChanging=false;cachedAnimeTitle=null;lastEpisodeNumber=null;async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement();}async ensureDocumentReady(){document.readyState!=="complete"&&await new Promise(e=>{window.addEventListener("load",()=>e(),{once:true});});}waitForVideoElement(){if(this.initialized)return;const e=document.querySelector(k.watchVideoElement);if(!e){window.setTimeout(()=>this.waitForVideoElement(),bs);return}if(e.readyState===0){e.addEventListener("loadedmetadata",()=>{this.initializeWithVideo(e);},{once:true});return}this.initializeWithVideo(e);}async initializeWithVideo(e){if(!this.initialized){this.initialized=true;try{f.show("コメントローダーを初期化中...");const n=f.getInstance(),r=this.global.settingsManager??new Pe(n);this.global.settingsManager=r,this.global.instances.settingsManager=r;const i=r.loadSettings();if(!i.isCommentVisible){m.info("watchPageController:initializeWithVideo:skipDueToVisibility",{isCommentVisible:i.isCommentVisible}),f.show("コメントは非表示に設定されています。設定を変更するにはフローティングボタンをクリックしてください。","info");return}if(!i.autoSearchEnabled){m.info("watchPageController:initializeWithVideo:manualMode",{autoSearchEnabled:i.autoSearchEnabled});const u=r.loadVideoData();if(!u?.videoId){f.show("手動設定モードです。フローティングボタンから検索タブを開いて動画を選択してください。","info");return}m.info("watchPageController:initializeWithVideo:manualMode:loadSavedVideo",{videoId:u.videoId,title:u.title}),await this.loadCommentsFromSavedVideo(e,r,u);return}if(await this.waitForMetadataElements(),!await this.autoSetupComments(r))throw new Error("視聴ページからの自動取得に失敗しました。メタデータが取得できませんでした。");const a=r.loadVideoData();if(!a?.videoId)throw new Error("動画データが見つかりません。");const o=new K;this.global.instances.fetcher=o,await o.fetchApiData(a.videoId);const l=await o.fetchComments(),d=this.mergeSettings(r.loadSettings()),h=new Z(d);h.initialize(e),this.global.instances.renderer=h,this.currentVideoElement=e;const c=this.playbackRateController??new Ee(r);this.playbackRateController=c,this.global.instances.playbackRateController=c,c.bind(e),r.addObserver(u=>{h.settings=this.mergeSettings(u);}),l.forEach(u=>{h.addComment(u.text,u.vposMs,u.commands);});const p=new we(h,o,r);p.startMonitoring(),this.global.instances.switchHandler=p,this.setupSwitchHandling(e,p),this.observeVideoElement(),this.startPartIdMonitoring(),f.show(`コメントの読み込みが完了しました（${l.length}件）`,"success");}catch(n){throw this.initialized=false,f.show(`初期化エラー: ${n.message}`,"error"),n}}}mergeSettings(e){const n=W();return {...n,...e,ngWords:[...e.ngWords??n.ngWords],ngRegexps:[...e.ngRegexps??n.ngRegexps]}}setupSwitchHandling(e,n){this.currentVideoElement=e,this.switchCallback=()=>{if(this.isPartIdChanging){m.info("watchPageController:switchBlocked",{reason:"partId change in progress"});return}const r=Date.now();if(r-this.lastSwitchTimestamp<ot){m.debug("watchPageController:switchCooldown",{timeSinceLastSwitch:r-this.lastSwitchTimestamp,cooldownMs:ot});return}this.lastSwitchTimestamp=r;const i=this.currentVideoElement;m.info("watchPageController:switchHandlerTriggered",{currentTime:i?.currentTime??null,duration:i?.duration??null}),n.onVideoSwitch(i);},this.global.utils.initializeWithVideo=async r=>{r&&(this.rebindVideoElement(r),this.playbackRateController?.bind(r),await n.onVideoSwitch(r));},this.currentVideoElement=e;}observeVideoElement(){const e=this.currentVideoElement;e&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{const n=document.querySelector(k.watchVideoElement);!n||n===this.currentVideoElement||this.rebindVideoElement(n);}),this.domMutationObserver.observe(document.body,{childList:true,subtree:true}),this.attachVideoEventListeners(e));}rebindVideoElement(e){this.detachVideoEventListeners(),this.currentVideoElement=e;const n=this.global.instances.renderer,r=this.global.instances.switchHandler;n&&(n.clearComments(),n.destroy(),n.initialize(e),n.resize()),this.playbackRateController?.bind(e),r&&(r.onVideoSwitch(e),this.setupSwitchHandling(e,r)),this.attachVideoEventListeners(e);}attachVideoEventListeners(e){this.detachVideoEventListeners(),et().attach(e);const r=()=>{this.switchCallback&&(m.info("watchPageController:eventTriggered",{currentTime:e.currentTime,duration:e.duration,ended:e.ended,paused:e.paused}),this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));};e.addEventListener("ended",r),e.addEventListener("loadedmetadata",r),e.addEventListener("emptied",r),this.videoEndedListener=r;}detachVideoEventListeners(){const e=this.currentVideoElement;et().detach(),e&&this.videoEndedListener&&(e.removeEventListener("ended",this.videoEndedListener),e.removeEventListener("loadedmetadata",this.videoEndedListener),e.removeEventListener("emptied",this.videoEndedListener)),this.videoEndedListener=null;}async waitForMetadataElements(e,n){const s=Date.now();for(let l=0;l<50;l++){const d=this.getCurrentPartId(),h=document.querySelector(k.watchPageAnimeTitle),c=document.querySelector(k.watchPageEpisodeNumber),p=document.querySelector(k.watchPageEpisodeTitle),u=h?.textContent?.trim()??"",g=c?.textContent?.trim()??"",y=p?.textContent?.trim()??"";if(l===0&&m.info("watchPageController:waitForMetadata:start",{currentPartId:d,expectedPartId:e,episodeNumber:g,episodeTitle:y,animeTitle:u||"(empty)",cachedAnimeTitle:this.cachedAnimeTitle||"(empty)",previousEpisodeNumber:n||"(none)"}),!e&&!this.cachedAnimeTitle&&l<20&&!u){await new Promise(M=>window.setTimeout(M,100));continue}if((!e||d===e)&&(g&&y)&&(!n||g!==n)){m.info("watchPageController:waitForMetadata:success",{attempts:l+1,waited:Date.now()-s,currentPartId:d,expectedPartId:e,episodeNumber:g,episodeTitle:y,animeTitle:u||"(empty)",previousEpisodeNumber:n||"(none)"});return}await new Promise(M=>window.setTimeout(M,100));}const a=document.querySelector(k.watchPageEpisodeNumber)?.textContent?.trim()??"",o=document.querySelector(k.watchPageEpisodeTitle)?.textContent?.trim()??"";throw m.error("watchPageController:waitForMetadata:timeout",{maxRetries:50,waited:Date.now()-s,currentPartId:this.getCurrentPartId(),expectedPartId:e,previousEpisodeNumber:n||"(none)",finalEpisodeNumber:a,finalEpisodeTitle:o}),new Error(`DOM更新のタイムアウト: partId=${e}, 前回エピソード="${n||"なし"}", 現在エピソード="${a}"`)}extractMetadataFromPage(){try{const e=document.querySelector(k.watchPageAnimeTitle),n=document.querySelector(k.watchPageEpisodeNumber),r=document.querySelector(k.watchPageEpisodeTitle);let i=e?.textContent?.trim()??"";const s=n?.textContent?.trim()??"",a=r?.textContent?.trim()??"";if(i){this.cachedAnimeTitle=i;try{G(lt,i),m.info("watchPageController:extractMetadata:cachedTitle",{animeTitle:i});}catch(o){m.error("watchPageController:extractMetadata:saveCacheFailed",o);}}else this.cachedAnimeTitle&&(i=this.cachedAnimeTitle,m.info("watchPageController:extractMetadata:usedCachedTitle",{cachedAnimeTitle:this.cachedAnimeTitle}));return m.info("watchPageController:extractMetadata:rawValues",{animeTitle:i||"(empty)",animeTitleElementExists:!!e,animeTitleFromCache:!e&&!!this.cachedAnimeTitle,episodeNumber:s,episodeNumberElementExists:!!n,episodeTitle:a,episodeTitleElementExists:!!r,currentPartId:this.getCurrentPartId()}),s?(i||m.warn("watchPageController:extractMetadata:noAnimeTitle",{hasCache:!!this.cachedAnimeTitle}),this.lastEpisodeNumber=s,{animeTitle:i,episodeNumber:s,episodeTitle:a}):(m.warn("watchPageController:extractMetadata:insufficient",{episodeNumber:s||"(empty)",episodeTitle:a||"(empty)"}),null)}catch(e){return m.error("watchPageController:extractMetadata:error",e),null}}async autoSetupComments(e){try{const n=this.extractMetadataFromPage();if(!n)return m.warn("watchPageController:autoSetup:noMetadata"),!1;if(!n.animeTitle)return m.warn("watchPageController:autoSetup:noAnimeTitle",{episodeNumber:n.episodeNumber,episodeTitle:n.episodeTitle,cachedAnimeTitle:this.cachedAnimeTitle}),f.show("アニメタイトルが取得できませんでした。検索精度が低下する可能性があります。","warning"),!1;const r=[n.animeTitle,n.episodeNumber,n.episodeTitle].filter(Boolean).join(" ");m.info("watchPageController:autoSetup",{keyword:r,animeTitle:n.animeTitle,episodeNumber:n.episodeNumber,episodeTitle:n.episodeTitle,usingCachedTitle:!!this.cachedAnimeTitle&&!n.animeTitle}),f.show(`「${r}」を検索中...`,"info");const s=await new R().search(r);if(s.length===0)return f.show("ニコニコ動画が見つかりませんでした","warning"),!1;const a=R.filterOfficialVideos(s,n.animeTitle);m.info("watchPageController:autoSetup:officialFilter",{totalResults:s.length,officialResults:a.length,animeTitle:n.animeTitle}),a.length===0&&(m.warn("watchPageController:autoSetup:noOfficialVideos",{animeTitle:n.animeTitle,firstResultOwner:s[0]?.owner?.nickname??s[0]?.channel?.name??"不明"}),f.show("公式動画が見つかりませんでした。検索結果の最初の動画を使用します。","warning"));const o=a.length>0?a[0]:s[0],d=await new K().fetchApiData(o.videoId),h={videoId:o.videoId,title:o.title,viewCount:d.video?.count?.view??o.viewCount,commentCount:d.video?.count?.comment??o.commentCount,mylistCount:d.video?.count?.mylist??o.mylistCount,postedAt:d.video?.registeredAt??o.postedAt,thumbnail:d.video?.thumbnail?.url??o.thumbnail,owner:d.owner??o.owner??null,channel:d.channel??o.channel??null};if(e.saveVideoData(o.title,h)){m.info("watchPageController:autoSetup:success",{videoId:o.videoId,title:o.title,commentCount:o.commentCount});const p=o.owner?.nickname||o.channel?.name||"不明",u=['<div style="font-weight: 600; margin-bottom: 8px;">ニコニコ動画を自動設定しました</div>','<div style="display: flex; align-items: center; gap: 6px; margin-top: 8px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${it}</span>`,`  <span style="flex: 1; word-break: break-word;">${o.title}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 6px; margin-top: 4px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Se}</span>`,`  <span>${p}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">','  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Ce}</span>`,`    <span>${o.viewCount.toLocaleString()}</span>`,"  </div>",'  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Me}</span>`,`    <span>${o.commentCount.toLocaleString()}</span>`,"  </div>","</div>"].join("");return f.show(u,"success",5e3),!0}return !1}catch(n){return m.error("watchPageController:autoSetup:error",n),f.show(`自動設定エラー: ${n.message}`,"error"),false}}getCurrentPartId(){try{return new URLSearchParams(window.location.search).get("partId")}catch(e){return m.error("watchPageController:getCurrentPartId:error",e),null}}startPartIdMonitoring(){this.stopPartIdMonitoring(),this.lastPartId=this.getCurrentPartId(),this.partIdMonitorIntervalId=window.setInterval(()=>{this.checkPartIdChange();},vs);}stopPartIdMonitoring(){this.partIdMonitorIntervalId!==null&&(window.clearInterval(this.partIdMonitorIntervalId),this.partIdMonitorIntervalId=null);}async checkPartIdChange(){const e=this.getCurrentPartId();e===null||e===this.lastPartId||(m.warn("watchPageController:partIdChanged",{oldPartId:this.lastPartId,newPartId:e,url:window.location.href,timestamp:new Date().toISOString()}),this.lastPartId=e,await this.onPartIdChanged());}async waitForVideoReady(e){const i=Date.now();for(m.info("watchPageController:waitForVideoReady:start",{readyState:e.readyState,duration:e.duration,src:e.currentSrc});e.readyState<2&&Date.now()-i<5e3;)await new Promise(s=>window.setTimeout(s,100));m.info("watchPageController:waitForVideoReady:complete",{readyState:e.readyState,duration:e.duration,waited:Date.now()-i});}async onPartIdChanged(){this.isPartIdChanging=true;try{const e=this.global.settingsManager;if(!e){m.warn("watchPageController:onPartIdChanged:noSettingsManager");return}const n=e.getSettings();if(!n.isCommentVisible){m.info("watchPageController:onPartIdChanged:skipDueToVisibility",{isCommentVisible:n.isCommentVisible}),f.show("コメント非表示設定のためスキップしました","info");return}const r=this.lastEpisodeNumber??document.querySelector(k.watchPageEpisodeNumber)?.textContent?.trim()??null;if(!n.autoSearchEnabled){m.info("watchPageController:onPartIdChanged:manualMode",{autoSearchEnabled:n.autoSearchEnabled});const a=e.loadManualSearchSettings();if(!a?.animeTitle){f.show("手動設定モードです。フローティングボタンから検索タブを開いてアニメタイトルを設定してください。","info");const o=this.global.instances.renderer;o&&o.clearComments();return}await this.handleManualModeEpisodeSwitch(e,a.animeTitle,r);return}m.info("watchPageController:onPartIdChanged:start",{currentVideoElement:this.currentVideoElement?"present":"null",rendererExists:!!this.global.instances.renderer,switchHandlerExists:!!this.global.instances.switchHandler,isPartIdChanging:this.isPartIdChanging,newPartId:this.getCurrentPartId(),previousEpisodeNumber:r}),f.show("エピソード切り替えを検知しました...","info");const i=this.getCurrentPartId();m.info("watchPageController:onPartIdChanged:waitingForDomUpdate",{newPartId:i,previousEpisodeNumber:r});try{await this.waitForMetadataElements(i??void 0,r??void 0);}catch(a){m.error("watchPageController:onPartIdChanged:waitMetadataFailed",a),f.show(`DOM更新の待機に失敗しました: ${a.message}`,"error");return}const s=await this.autoSetupComments(e);if(m.info("watchPageController:onPartIdChanged:autoSetup",{success:s}),s){const a=e.loadVideoData();m.warn("watchPageController:onPartIdChanged:loadedVideoData",{videoId:a?.videoId??null,title:a?.title??null});const o=this.currentVideoElement??document.querySelector(k.watchVideoElement);if(m.warn("watchPageController:onPartIdChanged:videoElement",{videoElementFound:!!o,currentTime:o?.currentTime??null,duration:o?.duration??null,src:o?.currentSrc??null,readyState:o?.readyState??null}),o&&a?.videoId){await this.waitForVideoReady(o),o.dataset.videoId=a.videoId;const l=this.global.instances.renderer,d=this.global.instances.switchHandler;if(m.warn("watchPageController:onPartIdChanged:beforeSwitch",{rendererCommentCount:l?.getCommentsSnapshot().length??0,videoCurrentTime:o.currentTime,videoReadyState:o.readyState,videoSrc:o.currentSrc,videoId:a.videoId}),l&&d){m.warn("watchPageController:onPartIdChanged:destroyBefore",{commentsBeforeDestroy:l.getCommentsSnapshot().length,currentVideoSrc:l.getCurrentVideoSource(),videoElement:l.getVideoElement()?"attached":"detached"});const h=l.settings;l.destroy(),m.warn("watchPageController:onPartIdChanged:createNew",{savedSettings:h});const c=new Z(h,{loggerNamespace:"dAnime:CommentRenderer"});this.global.instances.renderer=c,m.warn("watchPageController:onPartIdChanged:reinitialize",{videoElementSrc:o.currentSrc,videoElementReadyState:o.readyState,videoElementCurrentTime:o.currentTime}),c.initialize(o),m.warn("watchPageController:onPartIdChanged:reinitializeComplete",{commentsAfterReinitialize:c.getCommentsSnapshot().length,newVideoSrc:c.getCurrentVideoSource()}),d.updateRenderer(c),d.resetVideoSource(),await d.onVideoSwitch(o),m.warn("watchPageController:onPartIdChanged:afterSwitch",{rendererCommentCount:c.getCommentsSnapshot().length,videoCurrentTime:o.currentTime,finalVideoSrc:c.getCurrentVideoSource()});}}}m.info("watchPageController:onPartIdChanged:complete");}catch(e){m.error("watchPageController:onPartIdChanged:error",e),f.show(`エピソード切り替えエラー: ${e.message}`,"error");}finally{this.isPartIdChanging=false,m.info("watchPageController:onPartIdChanged:flagReset",{isPartIdChanging:this.isPartIdChanging});}}async loadCommentsFromSavedVideo(e,n,r){try{const i=new K;this.global.instances.fetcher=i,await i.fetchApiData(r.videoId);const s=await i.fetchComments(),a=this.mergeSettings(n.loadSettings()),o=new Z(a);o.initialize(e),this.global.instances.renderer=o,this.currentVideoElement=e;const l=this.playbackRateController??new Ee(n);this.playbackRateController=l,this.global.instances.playbackRateController=l,l.bind(e),n.addObserver(h=>{o.settings=this.mergeSettings(h);}),s.forEach(h=>{o.addComment(h.text,h.vposMs,h.commands);});const d=new we(o,i,n);d.startMonitoring(),this.global.instances.switchHandler=d,this.setupSwitchHandling(e,d),this.observeVideoElement(),this.startPartIdMonitoring(),f.show(`【手動設定モード】コメントの読み込みが完了しました（${s.length}件）
動画: ${r.title}`,"success");}catch(i){m.error("watchPageController:loadCommentsFromSavedVideo:error",i),f.show(`コメント読み込みエラー: ${i.message}
フローティングボタンから別の動画を選択してください。`,"error");}}async handleManualModeEpisodeSwitch(e,n,r){try{const i=this.getCurrentPartId();m.info("watchPageController:manualModeSwitch:waitingForDomUpdate",{newPartId:i,previousEpisodeNumber:r,savedAnimeTitle:n});try{await this.waitForMetadataElements(i??void 0,r??void 0);}catch(w){m.error("watchPageController:manualModeSwitch:waitMetadataFailed",w),f.show(`DOM更新の待機に失敗しました: ${w.message}`,"error");return}const s=document.querySelector(k.watchPageEpisodeNumber)?.textContent?.trim()??"";if(!s){m.warn("watchPageController:manualModeSwitch:noEpisodeNumber"),f.show("エピソード話数を取得できませんでした","warning");return}const a=`${n} ${s}`;m.info("watchPageController:manualModeSwitch:search",{keyword:a,savedAnimeTitle:n,newEpisodeNumber:s}),f.show(`「${a}」を検索中...`,"info");const l=await new R().search(a);if(l.length===0){f.show("ニコニコ動画が見つかりませんでした。手動で検索してください。","warning");const w=this.global.instances.renderer;w&&w.clearComments();return}const d=R.filterOfficialVideos(l,n);if(m.info("watchPageController:manualModeSwitch:officialFilter",{totalResults:l.length,officialResults:d.length,savedAnimeTitle:n}),d.length===0){f.show("公式動画が見つかりませんでした。手動で検索してください。","warning");const w=this.global.instances.renderer;w&&w.clearComments();return}const h=d[0],p=await new K().fetchApiData(h.videoId),u={videoId:h.videoId,title:h.title,viewCount:p.video?.count?.view??h.viewCount,commentCount:p.video?.count?.comment??h.commentCount,mylistCount:p.video?.count?.mylist??h.mylistCount,postedAt:p.video?.registeredAt??h.postedAt,thumbnail:p.video?.thumbnail?.url??h.thumbnail,owner:p.owner??h.owner??null,channel:p.channel??h.channel??null};e.saveVideoData(h.title,u),e.saveManualSearchSettings({animeTitle:n,episodeNumber:s,episodeTitle:""});const g=this.currentVideoElement??document.querySelector(k.watchVideoElement);if(g){await this.waitForVideoReady(g),g.dataset.videoId=h.videoId;const w=this.global.instances.renderer,C=this.global.instances.switchHandler;if(w&&C){const I=w.settings;w.destroy();const M=new Z(I,{loggerNamespace:"dAnime:CommentRenderer"});this.global.instances.renderer=M,M.initialize(g),C.updateRenderer(M),C.resetVideoSource(),await C.onVideoSwitch(g);}}const y=h.owner?.nickname??h.channel?.name??"不明",x=['<div style="font-weight: 600; margin-bottom: 8px;">次のエピソードを自動設定しました</div>','<div style="display: flex; align-items: center; gap: 6px; margin-top: 8px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${it}</span>`,`  <span style="flex: 1; word-break: break-word;">${h.title}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 6px; margin-top: 4px;">',`  <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Se}</span>`,`  <span>${y}</span>`,"</div>",'<div style="display: flex; align-items: center; gap: 12px; margin-top: 4px;">','  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Ce}</span>`,`    <span>${h.viewCount.toLocaleString()}</span>`,"  </div>",'  <div style="display: flex; align-items: center; gap: 4px;">',`    <span style="flex-shrink: 0; width: 18px; height: 18px; opacity: 0.8;">${Me}</span>`,`    <span>${h.commentCount.toLocaleString()}</span>`,"  </div>","</div>"].join("");f.show(x,"success",5e3),m.info("watchPageController:manualModeSwitch:success",{videoId:h.videoId,title:h.title,commentCount:h.commentCount});}catch(i){m.error("watchPageController:manualModeSwitch:error",i),f.show(`エピソード切り替えエラー: ${i.message}`,"error");}}}const ws=100;class Ss{constructor(e){this.global=e;}initialize(){const e=f.getInstance(),n=this.global.settingsManager??new Pe(e);this.global.settingsManager=n,this.global.instances.settingsManager=n;const r=new ce(n);this.waitForHeader(r);}waitForHeader(e){if(!document.querySelector(k.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(e),ws);return}e.insertIntoMypage(),e.addAutoCommentButtons(),this.observeList(e);}observeList(e){const n=document.querySelector(k.mypageListContainer);if(!n)return;new MutationObserver(()=>{try{e.addAutoCommentButtons();}catch(i){console.error("[MypageController] auto comment buttons update failed",i);}}).observe(n,{childList:true,subtree:true});}}class Cs{log;global=fs();watchController=null;mypageController=null;constructor(){this.log=F("DanimeApp");}start(){this.log.info("starting renderer"),Vt.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener("load",()=>{this.initialize();});}async initialize(){if(!this.acquireInstanceLock()){this.log.info("renderer already initialized, skipping");return}const e=location.pathname.toLowerCase();try{e.includes("/animestore/sc_d_pc")?(this.watchController=new xs(this.global),await this.watchController.initialize()):e.includes("/animestore/mp_viw_pc")?(this.mypageController=new Ss(this.global),this.mypageController.initialize()):this.log.info("page not supported, initialization skipped");}catch(n){this.log.error("initialization failed",n);}}acquireInstanceLock(){const e=ke();return e.__dAnimeNicoCommentRenderer2Instance=(e.__dAnimeNicoCommentRenderer2Instance??0)+1,e.__dAnimeNicoCommentRenderer2Instance===1}}const ve=F("dAnimeNicoCommentRenderer2");async function Ms(){ve.info("bootstrap start");try{new Cs().start(),ve.info("bootstrap completed");}catch(t){ve.error("bootstrap failed",t);}}Ms();
