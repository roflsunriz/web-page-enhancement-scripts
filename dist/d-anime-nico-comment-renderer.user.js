...
(function () {
  ...
  const je={debug:"debug",info:"info",warn:"warn",error:"error"},Ke={debug:10,info:20,warn:30,error:40};let kn=t=>Ke[t]>=Ke.warn;const P=t=>{const e=`[${t}]`,n={};return Object.keys(je).forEach(r=>{const i=je[r];n[r]=(...s)=>{if(!kn(r))return;(console[i]??console.log)(e,...s);};}),n};function Pe(){return typeof unsafeWindow<"u"?unsafeWindow:window}const _n={small:.6666666666666666,medium:1,big:1.4444444444444444},Vn={defont:'Arial,"ＭＳ Ｐゴシック","MS PGothic",MSPGothic,MS-PGothic',gothic:'"游ゴシック体","游ゴシック","Yu Gothic",YuGothic,yugothic,YuGo-Medium,"宋体",SimSun,Arial,"ＭＳ Ｐゴシック","MS PGothic",MSPGothic,MS-PGothic',mincho:'"游明朝体","游明朝","Yu Mincho",YuMincho,yumincho,YuMin-Medium,"宋体",SimSun,Arial,"ＭＳ Ｐゴシック","MS PGothic",MSPGothic,MS-PGothic'},In={defont:"600",gothic:"",mincho:""},Yt={white:"#FFFFFF",red:"#FF0000",pink:"#FFA5CC",orange:"#FFBA66",yellow:"#FFFFAA",green:"#00FF00",cyan:"#88FFFF",blue:"#8899FF",purple:"#D9A5FF",black:"#000000",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},Fe=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,An=/^[,.:;]+/,Ln=/[,.:;]+$/,Pn=t=>{const e=t.trim();return e?Fe.test(e)?e:e.replace(An,"").replace(Ln,""):""},Fn=t=>Fe.test(t)?t.toUpperCase():null,Ut=t=>{const e=t.trim();if(!e)return null;const n=e.toLowerCase().endsWith("px")?e.slice(0,-2):e,r=Number.parseFloat(n);return Number.isFinite(r)?r:null},Rn=t=>{const e=t.trim();if(!e)return null;if(e.endsWith("%")){const n=Number.parseFloat(e.slice(0,-1));return Number.isFinite(n)?n/100:null}return Ut(e)},Dn=t=>Number.isFinite(t)?Math.min(100,Math.max(-100,t)):0,Hn=t=>!Number.isFinite(t)||t===0?1:Math.min(5,Math.max(.25,t)),zn=t=>t==="naka"||t==="ue"||t==="shita",On=t=>t==="small"||t==="medium"||t==="big",Nn=t=>t==="defont"||t==="gothic"||t==="mincho",$n=t=>t in Yt,Wn=(t,e)=>{let n="naka",r="medium",i="defont",s=null,a=1,o=null,l=false,d=false,h=false,c=0,u=1;for(const y of t){const f=Pn(typeof y=="string"?y:"");if(!f)continue;if(Fe.test(f)){const M=Fn(f);if(M){s=M;continue}}const v=f.toLowerCase();if(zn(v)){n=v;continue}if(On(v)){r=v;continue}if(Nn(v)){i=v;continue}if($n(v)){s=Yt[v].toUpperCase();continue}if(v==="_live"){o=.5;continue}if(v==="invisible"){a=0,l=true;continue}if(v==="full"){d=true;continue}if(v==="ender"){h=true;continue}if(v.startsWith("ls:")||v.startsWith("letterspacing:")){const M=f.indexOf(":");if(M>=0){const k=Ut(f.slice(M+1));k!==null&&(c=Dn(k));}continue}if(v.startsWith("lh:")||v.startsWith("lineheight:")){const M=f.indexOf(":");if(M>=0){const k=Rn(f.slice(M+1));k!==null&&(u=Hn(k));}continue}}const p=Math.max(0,Math.min(1,a)),m=(s??e.defaultColor).toUpperCase(),x=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:n,size:r,sizeScale:_n[r],font:i,fontFamily:Vn[i],fontWeight:In[i],resolvedColor:m,colorOverride:s,opacityMultiplier:p,opacityOverride:x,isInvisible:l,isFull:d,isEnder:h,letterSpacing:c,lineHeight:u}},Bn=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,ae=t=>t.length===1?t.repeat(2):t,z=t=>Number.parseInt(t,16),$=t=>!Number.isFinite(t)||t<=0?0:t>=1?1:t,Re=(t,e)=>{const n=Bn.exec(t);if(!n)return t;const r=n[1];let i,s,a,o=1;r.length===3||r.length===4?(i=z(ae(r[0])),s=z(ae(r[1])),a=z(ae(r[2])),r.length===4&&(o=z(ae(r[3]))/255)):(i=z(r.slice(0,2)),s=z(r.slice(2,4)),a=z(r.slice(4,6)),r.length===8&&(o=z(r.slice(6,8))/255));const l=$(o*$(e));return `rgba(${i}, ${s}, ${a}, ${l})`},qn=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),Gt=()=>qn(),L=t=>t*1e3,Yn=t=>!Number.isFinite(t)||t<0?null:Math.round(t),De=6e3,Xe=2700,Un=3,Gn=.35,jn=48,Kn=48,ue=0,Xn=6e3,be=120,Zn=800,Jn=2,ne=6e3,O=3e3,D=O+De,Qn=240,er=1800,Ze=1,jt=12,tr=24,A=.001,B=50,nr=2300,Je={debug:0,info:1,warn:2,error:3},rr=(t,e,n)=>{const r=[`[${e}]`,...n];switch(t){case "debug":console.debug(...r);break;case "info":console.info(...r);break;case "warn":console.warn(...r);break;case "error":console.error(...r);break;default:console.log(...r);}},Kt=(t,e={})=>{const{level:n="info",emitter:r=rr}=e,i=Je[n],s=(a,o)=>{Je[a]<i||r(a,t,o);};return {debug:(...a)=>s("debug",a),info:(...a)=>s("info",a),warn:(...a)=>s("warn",a),error:(...a)=>s("error",a)}},He=Kt("CommentEngine:Comment"),Qe=new WeakMap,ir=t=>{let e=Qe.get(t);return e||(e=new Map,Qe.set(t,e)),e},ze=(t,e)=>{if(!t)return 0;const n=`${t.font??""}::${e}`,r=ir(t),i=r.get(n);if(i!==void 0)return i;const s=t.measureText(e).width;return r.set(n,s),s},pe=t=>`${t.fontWeight?`${t.fontWeight} `:""}${t.fontSize}px ${t.fontFamily}`,sr=27/665,Z=665,ar=12,or="  ",lr=1252/597.38330078125,ve=[366/Z,510/Z,1662/Z],cr=566/Z,dr=806/665,hr=808/665,et=1176/665,tt=900/665,ur=1126/665,nt=810/665,pr=1126/665,rt=1046/665,it=1254/665,mr=1140/665,gr=878/665,fr=.25,br=160,vr=420,yr=80,xr=.18,wr=400,Sr=.2,Cr=420,Mr=250,Er=1.8,Tr=420,kr=20,_r=.045,Vr=850/1182,Ir=t=>Math.max(.01,t/Z),N=(t,e)=>t*Ir(e),Ar=t=>t.replaceAll("	",or),Xt=/[\s\u00a0\u2000-\u200f\u202f\u205f\u3000]/g,Lr=t=>{const e=Ar(t);if(e.includes(`
`)){const n=e.split(/\r?\n/);return n.length>0?n:[""]}return [e]},st=(t,e=ar)=>Math.max(e,t),Pr=(t,e)=>{if(t.fontSize>=35)return Math.round(e*cr);const n=t.text.split(/\r?\n/),r=Math.max(0,...n.map(i=>i.length));return t.isEnder&&r>=25||Math.max(0,...n.map(i=>(i.match(/\t/g)||[]).length))>=12||t.width>=1200?Math.round(e*ve[2]):t.width>=300?Math.round(e*ve[1]):Math.round(e*ve[0])},Fr=(t,e)=>Math.min(N(vr,e),Math.max(N(br,e),t*fr)),Rr=(t,e)=>{const n=N(wr,e);return Math.min(N(Cr,e),N(yr,e)+t.width*xr+Math.max(0,t.width-n)*Sr)},Dr=(t,e)=>Math.min(N(Tr,e),Math.max(0,t.width-N(Mr,e))*Er),Hr=(t,e)=>{if(t.isFull)return t.width;const n=Math.max(t.sizeScale,1),r=t.width/n,i=e*Vr;return Math.min(r,i)},zr=t=>t.lines.filter(e=>e.replace(Xt,"").length>0).length,at=t=>t.lines.length>1&&zr(t)===1,Or=t=>t.lines.map(e=>e.replace(Xt,"")).filter(e=>e.length>0),ot=t=>{if(t.lines.length<=1)return  false;const e=Or(t);return e.length===1&&/^[●○◉◎]+$/u.test(e[0])},oe=t=>t.size==="big"||t.fontSize>=35,Nr=(t,e)=>{let n=0;const r=t.letterSpacing;for(const a of t.lines){const o=ze(e,a),l=a.length>1?r*(a.length-1):0,d=Math.max(0,o+l);d>n&&(n=d);}t.width=n;const i=Math.max(1,Math.floor(t.fontSize*t.lineHeightMultiplier));t.lineHeightPx=i;const s=t.lines.length>1?(t.lines.length-1)*i:0;t.height=t.fontSize+s;},$r=(t,e,n,r,i)=>{try{if(!e)throw new Error("Canvas context is required");if(!Number.isFinite(n)||!Number.isFinite(r))throw new Error("Canvas dimensions must be numbers");if(!i)throw new Error("Prepare options are required");const s=Math.max(n,1),a=st(Math.floor(r*sr)),o=st(Math.floor(a*t.sizeScale));if(t.fontSize=o,e.font=pe(t),t.lines=Lr(t.text),Nr(t,e),t.isScrolling&&t.isFull){const F=t.lines.length>1&&(t.fontFamily.includes("Yu Mincho")||t.fontFamily.includes("游明朝"));if(F&&t.hasSameVposFullMinchoEnder&&!t.isEnder&&oe(t))t.width=Math.round(r*(ot(t)?rt:pr)),t.height=Math.max(t.height,Math.round(r*nt));else if(F&&t.hasSameVposFullMinchoEnder&&t.isEnder&&oe(t))t.width=Math.round(r*(at(t)?it:et)),t.height=Math.max(t.height,Math.round(r*tt));else if(F&&t.hasSameVposFullMinchoEnder&&t.isEnder)t.width=Math.round(r*(at(t)?it:mr)),t.height=Math.max(t.height,Math.round(r*gr));else if(F&&oe(t))t.width=Math.round(r*(ot(t)?rt:et)),t.height=Math.max(t.height,Math.round(r*tt));else if(F)t.width=Math.round(r*ur),t.height=Math.max(t.height,Math.round(r*nt));else {const G=oe(t)?hr:dr;t.width=Pr(t,r),t.height=Math.max(t.height,Math.round(r*G));}}if(!t.isScrolling){const F=s+a*2.6666666666666665;t.width>=F*.95&&t.fontSize>=35?t.width=Math.round(r*lr):t.width=Math.min(t.width,F),t.bufferWidth=0;const G=(s-t.width)/2;t.virtualStartX=G,t.x=G,t.baseSpeed=0,t.speed=0,t.speedPixelsPerMs=0,t.visibleDurationMs=O,t.preCollisionDurationMs=O,t.totalDurationMs=O,t.reservationWidth=t.width,t.staticExpiryTimeMs=t.vposMs+O,t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;return}t.staticExpiryTimeMs=null;const l=ze(e,"??".repeat(150)),d=t.width,h=d*Math.max(i.bufferRatio,0);t.bufferWidth=Math.max(i.baseBufferPx,h);const c=Math.max(i.entryBufferPx,t.bufferWidth),u=t.scrollDirection,p=Math.min(1,r/Z),m=t.isFull?i.virtualExtension*p:i.virtualExtension,x=t.isFull?Fr(t.width,r):0,y=t.isFull?N(kr,r)+t.width*_r:0,f=t.isFull?0:Rr(t,r),v=t.isFull?0:Dr(t,r),M=u==="rtl"?s+m+x+f:-d-t.bufferWidth-m-x-f,k=u==="rtl"?-d-t.bufferWidth-c+x-f-v:s+c-x+f+v,Y=u==="rtl"?s+c:-c;t.virtualStartX=M,t.x=M,t.exitThreshold=k;const U=s>0?d/s:0,yn=i.maxVisibleDurationMs===i.minVisibleDurationMs;let ge=i.maxVisibleDurationMs;if(!yn&&U>1&&!t.isFull){const F=Math.min(U,i.maxWidthRatio),G=i.maxVisibleDurationMs/Math.max(F,1);ge=Math.max(i.minVisibleDurationMs,Math.floor(G));}const xn=s+d+t.bufferWidth+c+m+y+f*2+v,wn=Math.max(ge,1),fe=xn/wn,Sn=fe*1e3/60;t.baseSpeed=Sn,t.speed=t.baseSpeed,t.speedPixelsPerMs=fe;const Cn=Math.abs(k-M),Ue=u==="rtl"?M+d+t.bufferWidth:M-t.bufferWidth,Mn=u==="rtl"?Math.max(0,Ue-Y):Math.max(0,Y-Ue),Ge=Math.max(fe,Number.EPSILON);t.visibleDurationMs=ge,t.preCollisionDurationMs=Math.max(0,Math.ceil(Mn/Ge)),t.totalDurationMs=Math.max(t.preCollisionDurationMs,Math.ceil(Cn/Ge));const En=d+t.bufferWidth+c,Tn=Hr(t,s);t.reservationWidth=Math.min(l,Math.max(En,Tn)),t.lastUpdateTime=t.getTimeSource().now(),t.isPaused=!1;}catch(s){throw He.error("Comment.prepare",s,{text:t.text,visibleWidth:n,canvasHeight:r,hasContext:!!e}),s}},Zt=5,H={enabled:false,maxLogsPerCategory:Zt},de=new Map,Wr=t=>{if(t===void 0||!Number.isFinite(t))return Zt;const e=Math.max(1,Math.floor(t));return Math.min(1e4,e)},Br=t=>{H.enabled=!!t.enabled,H.maxLogsPerCategory=Wr(t.maxLogsPerCategory),H.enabled||de.clear();},W=()=>H.enabled,qr=t=>{const e=de.get(t)??0;return e>=H.maxLogsPerCategory?(e===H.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${t}]`,"Further logs suppressed."),de.set(t,e+1)),false):(de.set(t,e+1),true)},T=(t,...e)=>{H.enabled&&qr(t)&&console.debug(`[CommentOverlay][${t}]`,...e);},se=(t,e=32)=>t.length<=e?t:`${t.slice(0,e)}…`,Yr=(t,e)=>{H.enabled&&(console.group(`[CommentOverlay][state-dump] ${t}`),console.table({"Current Time":`${e.currentTime.toFixed(2)}ms`,Duration:`${e.duration.toFixed(2)}ms`,"Is Playing":e.isPlaying,"Epoch ID":e.epochId,"Total Comments":e.totalComments,"Active Comments":e.activeComments,"Reserved Lanes":e.reservedLanes,"Final Phase":e.finalPhaseActive,"Playback Begun":e.playbackHasBegun,"Is Stalled":e.isStalled}),console.groupEnd());},Ur=(t,e,n)=>{H.enabled&&T("epoch-change",`Epoch changed: ${t} → ${e} (reason: ${n})`);},lt=t=>{if(typeof t=="string")return t;if(t!=null)return String(t)},Jt=()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now(),Gr=t=>{if(typeof t.getTransform!="function")return;const e=t.getTransform();return [e.a,e.b,e.c,e.d,e.e,e.f]},jr=t=>{const e=t.canvas;return e?{canvasWidth:e.width,canvasHeight:e.height}:{}},Kr=t=>t?{...t.no!==void 0?{no:t.no}:{},...t.fork!==void 0?{fork:t.fork}:{},...t.source!==void 0?{source:t.source}:{},...t.threadId!==void 0?{threadId:t.threadId}:{},...t.date!==void 0?{date:t.date}:{},...t.userIdHash!==void 0?{userIdHash:t.userIdHash}:{}}:{},Qt=t=>({text:t.text,vposMs:t.vposMs,...Kr(t.meta),layout:t.layout,lane:t.lane,fontSize:t.fontSize,width:t.width,height:t.height,color:t.color,opacity:t.opacity,creationIndex:t.creationIndex}),Ee=(t,e,n,r)=>{const i=globalThis.__COMMENT_OVERLAY_TRACE__;globalThis.__COMMENT_OVERLAY_TRACE_ENABLED__!==true||typeof i!="function"||i({source:"comment-overlay",op:t,timestampMs:Jt(),font:e.font,fillStyle:lt(e.fillStyle),strokeStyle:lt(e.strokeStyle),lineWidth:e.lineWidth,lineJoin:e.lineJoin,globalAlpha:e.globalAlpha,shadowColor:e.shadowColor,shadowBlur:e.shadowBlur,shadowOffsetX:e.shadowOffsetX,shadowOffsetY:e.shadowOffsetY,transform:Gr(e),...jr(e),comment:Qt(n),...r});},Xr=(t,e,n)=>{const r=globalThis.__COMMENT_OVERLAY_TRACE__;globalThis.__COMMENT_OVERLAY_TRACE_ENABLED__!==true||typeof r!="function"||r({source:"comment-overlay",op:t,timestampMs:Jt(),comment:Qt(e),...n});},C={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},ct=()=>{if(!W())return;const t=performance.now();if(t-C.lastReported<=5e3)return;const e=C.hits+C.misses,n=e>0?C.hits/e*100:0,r=C.creates>0?(C.totalCharactersDrawn/C.creates).toFixed(1):"0",i=C.outlineCallsInCache+C.outlineCallsInFallback,s=C.fillCallsInCache+C.fillCallsInFallback;console.log("[TextureCache Stats]",`
  ...
  Avg Characters/Comment: ${r}`),C.lastReported=t;},Zr=()=>typeof OffscreenCanvas<"u",Oe=(t,e,n)=>{if(t==="none")return {blur:0,alpha:0};const r={light:.06,medium:.1,strong:.15}[t],i={light:.6,medium:.8,strong:.95}[t],s=Math.max(2,e*r),a=$(n*i);return {blur:s,alpha:a}},Ne=()=>2.8,en=665,Jr=566,Te=808,dt=Jr/en,ht=Te/en,Qr=1098,ei=1530,ut=20.9,pt=58.9,mt=45.23908523908523/39,ti=14.9,ni=41.9,ri=28.92708257149126/27,gt=20,ft=11.4,bt=31.4,vt=23.87692307692307,ii=2.4,ye=2,yt=66.9,xt=55.6,si=59,ai=810,oi=21.5,tn=878,nn=900,li=10,ci=6.75,di=16.75,hi=12.11423203055002,ui=.5,pi=1.42,mi=.12,gi=t=>{const e=t.trim().toLowerCase();if(e==="black")return  true;const n=e.match(/^#([0-9a-f]{3,8})$/i);if(!n)return  false;const r=n[1],i=r.length===3||r.length===4,s=d=>d.length===1?`${d}${d}`:d,a=Number.parseInt(s(i?r[0]:r.slice(0,2)),16),o=Number.parseInt(s(i?r[1]:r.slice(2,4)),16),l=Number.parseInt(s(i?r[2]:r.slice(4,6)),16);return a===0&&o===0&&l===0},$e=t=>gi(t.color)?"rgba(255, 255, 255, 0.4)":"rgba(0, 0, 0, 0.4)",fi=(t,e)=>`${t.fontWeight?`${t.fontWeight} `:""}${e}px ${t.fontFamily}`,bi=(t,e)=>{if(!t.isScrolling)return e+t.fontSize;const n=t.fontSize<=18?t.fontSize*.08:0;return t.fontSize*1.5+n},rn=t=>{if(t.isScrolling&&t.isFull){if(t.hasSameVposFullMinchoEnder){const o=Math.ceil(t.height);return {paddingX:Math.max(10,t.fontSize*.5),paddingY:o>=nn?yt:o>=tn?xt:oi,textureWidth:Math.ceil(t.width),textureHeight:o}}const a=t.hasSameVposFullMinchoEnder&&t.isEnder?t.fontSize>=35?yt:xt:null;return {paddingX:Math.max(10,t.fontSize*.5),paddingY:a??(t.fontSize>=35?t.fontSize*.5:Math.max(18,t.fontSize))+ii,textureWidth:Math.ceil(t.width),textureHeight:Math.ceil(t.height)}}if(t.isScrolling&&t.lines.length>1){const a=t.fontSize*1.3333333333333333,o=t.fontSize;return {paddingX:a,paddingY:o,textureWidth:Math.ceil(t.width+a*2),textureHeight:Math.ceil(t.height+t.fontSize*6.1)}}if(!t.isScrolling){const a=Math.ceil(t.lines.length>1?t.height:t.height+t.fontSize/3);return {paddingX:0,paddingY:Math.max(0,(a-t.height)/2),textureWidth:Math.ceil(t.width+0),textureHeight:a}}const e=t.isScrolling?t.fontSize*1.15:Math.max(10,t.fontSize*.5),n=t.fontSize,r=t.isScrolling?Math.round(n*(40/9)):t.height+t.fontSize/3,i=Math.ceil(Math.max(t.height+Math.max(10,t.fontSize),r)),s=t.isScrolling?t.fontSize:Math.max(0,(i-t.height)/2);return {paddingX:e,paddingY:s,textureWidth:Math.ceil(t.isScrolling?t.width*2+e*2:t.width+e*2),textureHeight:i}},vi=t=>!t.isScrolling&&t.width>=1200&&t.fontSize>=35?.8:1,sn=t=>!t.isScrolling&&t.width>=1200&&t.fontSize>=35,an=t=>sn(t)&&(t.fontFamily.includes("Yu Mincho")||t.fontFamily.includes("YuMincho")||t.fontFamily.includes("游明朝")),yi=(t,e)=>an(t)?pi:e,xi=t=>Math.max(1,t.width+t.virtualStartX*2),wi=t=>t.isScrolling&&t.isFull&&t.hasSameVposFullMinchoEnder?si*Math.min(1,t.height/ai):0,Si=(t,e,n,r,i)=>{const s=yi(t,i);if(an(t))return {x:xi(t)*mi,scaleX:s,scaleY:i};const a=!t.isScrolling&&s!==1?e.width*(1-s)*ui:0;return {x:n-r+a+wi(t),scaleX:s,scaleY:i}},We=(t,e,n,r,i)=>(s,a,o,l=0)=>{if(s.length===0)return;const d=i+l,h=()=>{r==="cache"?o==="outline"?C.outlineCallsInCache++:C.fillCallsInCache++:o==="outline"?C.outlineCallsInFallback++:C.fillCallsInFallback++;},c=(p,m,x)=>{if(h(),o==="outline"){e.strokeText(p,m,a),Ee("strokeText",e,t,{text:p,x:m,y:a,meta:{statsTarget:r,mode:o,...x}});return}e.fillText(p,m,a),Ee("fillText",e,t,{text:p,x:m,y:a,meta:{statsTarget:r,mode:o,...x}});};if(Math.abs(t.letterSpacing)<Number.EPSILON){c(s,d);return}let u=d;for(let p=0;p<s.length;p+=1){const m=s[p];c(m,u,{characterIndex:p});const x=ze(n,m);u+=x,p<s.length-1&&(u+=t.letterSpacing);}},Ci=t=>`v8::${t.text}::${t.fontSize}::${t.fontFamily}::${t.fontWeight}::${t.color}::${t.opacity}::${t.renderStyle}::${t.letterSpacing}::${t.lineHeightPx}::${t.width}::${t.height}::${t.lines.length}`,wt=(t,e,n)=>{const r=new OffscreenCanvas(n.width,n.height),i=r.getContext("2d");if(!i)return null;i.save(),i.font=n.sourceFont?pe(t):fi(t,n.fontSize);const s=$(t.opacity),a=Re(t.color,s),o=t.renderStyle==="outline-only",l=o?{blur:0,alpha:0}:Oe(t.shadowIntensity,n.fontSize,s);i.shadowColor=`rgba(0, 0, 0, ${l.alpha})`,i.shadowBlur=l.blur,i.shadowOffsetX=0,i.shadowOffsetY=0,i.lineJoin="round",i.lineWidth=Ne(),i.strokeStyle=$e(t),i.fillStyle=a,typeof n.canvasScale=="number"&&i.scale(n.canvasScale,n.canvasScale);const d=t.lines.length>0?t.lines:[t.text],h=We(t,i,e,"cache",n.paddingX);return o&&d.forEach((c,u)=>{h(c,n.baselineY+u*n.lineHeight,"outline");}),d.forEach((c,u)=>{h(c,n.baselineY+u*n.lineHeight,"fill");}),i.restore(),r},Mi=(t,e,n)=>{for(const r of n.traces??[])wt(t,e,r);return wt(t,e,n.output)},Ei=(t,e,n)=>{if(t.isScrolling&&t.isFull&&t.fontSize>=35&&Math.abs(e-t.height*(dt/ht))<=2&&Math.abs(n-e*(ht/dt))<=3){const r=n/Te;return {traces:[{width:Math.round(Qr*r),height:Math.round(ei*r),fontSize:t.fontSize,paddingX:ut*r,baselineY:pt*r,lineHeight:t.fontSize*mt,sourceFont:true}],output:{width:e,height:n,fontSize:gt*r,paddingX:ft*r,baselineY:bt*r,lineHeight:vt*r}}}if(t.isScrolling&&t.isFull&&t.hasSameVposFullMinchoEnder){if(n<=tn-1){const r=n/Te;return {output:{width:e,height:n,fontSize:gt*r,paddingX:ft*r,baselineY:bt*r,lineHeight:vt*r,canvasScale:ye}}}return n<nn?{output:{width:e,height:n,fontSize:t.fontSize,paddingX:ti,baselineY:ni,lineHeight:t.fontSize*ri,canvasScale:ye,sourceFont:true}}:{output:{width:e,height:n,fontSize:t.fontSize,paddingX:ut,baselineY:pt,lineHeight:t.fontSize*mt,canvasScale:ye,sourceFont:true}}}return sn(t)?{output:{width:e,height:n,fontSize:li,paddingX:ci,baselineY:di,lineHeight:hi}}:null},Ti=(t,e)=>{if(!Zr())return null;const n=Math.abs(t.letterSpacing)>=Number.EPSILON,r=t.lines.length>1;n&&C.letterSpacingComments++,r&&C.multiLineComments++,!n&&!r&&C.normalComments++,C.totalCharactersDrawn+=t.text.length;const{paddingX:i,paddingY:s,textureWidth:a,textureHeight:o}=rn(t),l=Ei(t,a,o);if(l)return Mi(t,e,l);const d=new OffscreenCanvas(a,o),h=d.getContext("2d");if(!h)return null;h.save(),h.font=pe(t);const c=$(t.opacity),u=i,p=t.lines.length>0?t.lines:[t.text],m=t.lines.length>1&&t.lineHeightPx>0?t.lineHeightPx:t.fontSize,x=bi(t,s),y=We(t,h,e,"cache",u),f=Re(t.color,c),v=t.renderStyle==="outline-only",M=v?{blur:0,alpha:0}:Oe(t.shadowIntensity,t.fontSize,c);return W()&&console.log("[Shadow Debug - Cache]",`
  Text: "${t.text}"`,`
  FontSize: ${t.fontSize}`,`
  Shadow intensity: ${t.shadowIntensity}`,`
  Shadow blur: ${M.blur}px`,`
  Shadow alpha: ${M.alpha}`,`
  Fill style: ${f}`),h.save(),h.shadowColor=`rgba(0, 0, 0, ${M.alpha})`,h.shadowBlur=M.blur,h.shadowOffsetX=0,h.shadowOffsetY=0,h.lineJoin="round",h.lineWidth=Ne(),h.strokeStyle=$e(t),h.fillStyle=f,v&&p.forEach((k,Y)=>{const U=x+Y*m;y(k,U,"outline");}),p.forEach((k,Y)=>{const U=x+Y*m;y(k,U,"fill");}),h.restore(),h.restore(),d},ki=(t,e,n)=>{C.fallbacks++,e.save(),e.font=pe(t);const r=$(t.opacity),i=n??t.x,s=t.lines.length>0?t.lines:[t.text],a=t.lines.length>1&&t.lineHeightPx>0?t.lineHeightPx:t.fontSize,o=t.y+t.fontSize,l=We(t,e,e,"fallback",i),d=Re(t.color,r),h=t.renderStyle==="outline-only",c=h?{blur:0,alpha:0}:Oe(t.shadowIntensity,t.fontSize,r);W()&&console.log("[Shadow Debug - Fallback]",`
  Text: "${t.text}"`,`
  FontSize: ${t.fontSize}`,`
  Shadow intensity: ${t.shadowIntensity}`,`
  Shadow blur: ${c.blur}px`,`
  Shadow alpha: ${c.alpha}`,`
  Fill style: ${d}`),e.save(),e.shadowColor=`rgba(0, 0, 0, ${c.alpha})`,e.shadowBlur=c.blur,e.shadowOffsetX=0,e.shadowOffsetY=0,e.lineJoin="round",e.lineWidth=Ne(),e.strokeStyle=$e(t),e.fillStyle=d,h&&s.forEach((u,p)=>{const m=o+p*a;l(u,m,"outline");}),s.forEach((u,p)=>{const m=o+p*a;l(u,m,"fill");}),e.restore(),e.restore();},_i=(t,e,n)=>{try{if(!t.isActive||!e)return;const r=Ci(t),i=t.getCachedTexture();if(t.getTextureCacheKey()!==r||!i){C.misses++,C.creates++;const a=Ti(t,e);t.setCachedTexture(a),t.setTextureCacheKey(r);}else C.hits++;const s=t.getCachedTexture();if(s){const a=n??t.x,{paddingX:o,paddingY:l}=rn(t),d=vi(t),h=Si(t,s,a,o,d),c=h.x,u=t.isScrolling?t.y:t.y-l;h.scaleX===1&&h.scaleY===1?e.drawImage(s,c,u):e.drawImage(s,c,u,s.width*h.scaleX,s.height*h.scaleY),Ee("drawImage",e,t,{x:c,y:u,width:s.width*h.scaleX,height:s.height*h.scaleY,sourceWidth:s.width,sourceHeight:s.height,meta:{statsTarget:"cache",paddingX:o,paddingY:l,drawScale:d,drawScaleX:h.scaleX,drawScaleY:h.scaleY}}),ct();return}ki(t,e,n),ct();}catch(r){He.error("Comment.draw",r,{text:t.text,isActive:t.isActive,hasContext:!!e,interpolatedX:n});}},Vi=t=>t==="ltr"?"ltr":"rtl",Ii=t=>t==="ltr"?1:-1;class on{text;vposMs;commands;layout;isScrolling;size;sizeScale;opacityMultiplier;opacityOverride;colorOverride;isInvisible;isFull;isEnder;meta;hasSameVposFullMinchoEnder=false;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily;fontWeight;opacity;activationTimeMs=null;staticExpiryTimeMs=null;isActive=false;hasShown=false;isPaused=false;lastUpdateTime=0;reservationWidth=0;bufferWidth=0;visibleDurationMs=0;totalDurationMs=0;preCollisionDurationMs=0;speedPixelsPerMs=0;virtualStartX=0;exitThreshold=0;scrollDirection="rtl";renderStyle="outline-only";shadowIntensity="medium";creationIndex=0;letterSpacing=0;lineHeightMultiplier=1;lineHeightPx=0;lines=[];epochId=0;directionSign=-1;timeSource;lastSyncedSettingsVersion=-1;cachedTexture=null;textureCacheKey="";constructor(e,n,r,i,s={},a=null){if(typeof e!="string")throw new Error("Comment text must be a string");if(!Number.isFinite(n)||n<0)throw new Error("Comment vposMs must be a non-negative number");this.text=e,this.vposMs=n,this.commands=Array.isArray(r)?[...r]:[],this.meta=a?{...a}:null;const o=Wn(this.commands,{defaultColor:i.commentColor});this.layout=o.layout,this.isScrolling=this.layout==="naka",this.size=o.size,this.sizeScale=o.sizeScale,this.opacityMultiplier=o.opacityMultiplier,this.opacityOverride=o.opacityOverride,this.colorOverride=o.colorOverride,this.isInvisible=o.isInvisible,this.isFull=o.isFull,this.isEnder=o.isEnder,this.fontFamily=o.fontFamily,this.fontWeight=o.fontWeight,this.color=o.resolvedColor,this.opacity=this.getEffectiveOpacity(i.commentOpacity),this.renderStyle=i.renderStyle,this.shadowIntensity=i.shadowIntensity,this.letterSpacing=o.letterSpacing,this.lineHeightMultiplier=o.lineHeight,this.timeSource=s.timeSource??Gt(),this.applyScrollDirection(i.scrollDirection),this.syncWithSettings(i,s.settingsVersion);}prepare(e,n,r,i){$r(this,e,n,r,i);}draw(e,n=null){_i(this,e,n);}update(e=1,n=false){try{if(!this.isActive){this.isPaused=n;return}const r=this.timeSource.now();if(!this.isScrolling){this.isPaused=n,this.lastUpdateTime=r;return}if(n){this.isPaused=!0,this.lastUpdateTime=r;return}const i=(r-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*e,this.x+=this.speed*i*this.directionSign,(this.scrollDirection==="rtl"&&this.x<=this.exitThreshold||this.scrollDirection==="ltr"&&this.x>=this.exitThreshold)&&(this.isActive=!1),this.lastUpdateTime=r,this.isPaused=!1;}catch(r){He.error("Comment.update",r,{text:this.text,playbackRate:e,isPaused:n,isActive:this.isActive});}}syncWithSettings(e,n){typeof n=="number"&&n===this.lastSyncedSettingsVersion||(this.color=this.getEffectiveColor(e.commentColor),this.opacity=this.getEffectiveOpacity(e.commentOpacity),this.applyScrollDirection(e.scrollDirection),this.renderStyle=e.renderStyle,this.shadowIntensity=e.shadowIntensity,typeof n=="number"&&(this.lastSyncedSettingsVersion=n));}getEffectiveColor(e){const n=this.colorOverride??e;return typeof n!="string"||n.length===0?e:n.toUpperCase()}getEffectiveOpacity(e){if(typeof this.opacityOverride=="number")return $(this.opacityOverride);const n=e*this.opacityMultiplier;return Number.isFinite(n)?$(n):0}markActivated(e){this.activationTimeMs=e;}clearActivation(){this.activationTimeMs=null,this.isScrolling||(this.staticExpiryTimeMs=null),this.resetTextureCache();}hasStaticExpired(e){return this.isScrolling||this.staticExpiryTimeMs===null?false:e>=this.staticExpiryTimeMs}getDirectionSign(){return this.directionSign}getTimeSource(){return this.timeSource}getTextureCacheKey(){return this.textureCacheKey}setTextureCacheKey(e){this.textureCacheKey=e;}getCachedTexture(){return this.cachedTexture}setCachedTexture(e){this.cachedTexture=e;}resetTextureCache(){this.cachedTexture=null,this.textureCacheKey="";}applyScrollDirection(e){const n=Vi(e);this.scrollDirection=n,this.directionSign=Ii(n);}}const Ai=6700,xe={commentColor:"#FFFFFF",commentOpacity:1,isCommentVisible:true,useContainerResizeObserver:true,ngWords:[],ngRegexps:[],scrollDirection:"rtl",renderStyle:"outline-only",syncMode:"raf",scrollVisibleDurationMs:Ai,useFixedLaneCount:false,fixedLaneCount:12,useDprScaling:true,shadowIntensity:"medium"},ln=()=>({...xe,ngWords:[...xe.ngWords],ngRegexps:[...xe.ngRegexps]}),Li=t=>Number.isFinite(t)?t<=0?0:t>=1?1:t:1,le=t=>{const e=t.scrollVisibleDurationMs,n=e==null?null:Number.isFinite(e)?Math.max(1,Math.floor(e)):null;return {...t,scrollDirection:t.scrollDirection==="ltr"?"ltr":"rtl",commentOpacity:Li(t.commentOpacity),renderStyle:t.renderStyle==="classic"?"classic":"outline-only",scrollVisibleDurationMs:n,syncMode:t.syncMode==="video-frame"?"video-frame":"raf",useDprScaling:!!t.useDprScaling}},Pi=t=>typeof window<"u"&&typeof window.requestAnimationFrame=="function"&&typeof window.cancelAnimationFrame=="function"?{request:e=>window.requestAnimationFrame(e),cancel:e=>window.cancelAnimationFrame(Number(e))}:{request:e=>globalThis.setTimeout(()=>{e(t.now());},16),cancel:e=>{globalThis.clearTimeout(e);}},Fi=()=>typeof document>"u"?()=>{throw new Error("Document is not available. Provide a custom createCanvasElement implementation.")}:()=>document.createElement("canvas"),Ri=t=>{if(!t||typeof t!="object")return  false;const e=t;return typeof e.commentColor=="string"&&typeof e.commentOpacity=="number"&&typeof e.isCommentVisible=="boolean"},St=t=>t.isScrolling&&t.isFull&&t.text.includes(`
`)&&t.commands.some(e=>e.toLowerCase()==="mincho"),Di=t=>{const e=new Set;t.forEach(n=>{n.isEnder&&St(n)&&e.add(n.vposMs);}),t.forEach(n=>{n.hasSameVposFullMinchoEnder=e.has(n.vposMs)&&St(n);});},Ct=t=>{const e=t.meta?.no;return typeof e=="number"&&Number.isFinite(e)?e:null},Hi=function(t){if(!Array.isArray(t)||t.length===0)return [];const e=[];this.commentDependencies.settingsVersion=this.settingsVersion;for(const n of t){const{text:r,vposMs:i,commands:s=[],meta:a=null}=n,o=se(r);if(this.isNGComment(r)){T("comment-skip-ng",{preview:o,vposMs:i});continue}const l=Yn(i);if(l===null){this.log.warn("CommentRenderer.addComment.invalidVpos",{text:r,vposMs:i}),T("comment-skip-invalid-vpos",{preview:o,vposMs:i});continue}const d=a?.no!==void 0?`no:${a.source??""}:${a.fork??""}:${a.threadId??""}:${a.no}`:`fallback:${r}\0${l}`,h=u=>u.meta?.no!==void 0?`no:${u.meta.source??""}:${u.meta.fork??""}:${u.meta.threadId??""}:${u.meta.no}`:`fallback:${u.text}\0${u.vposMs}`;if(this.comments.some(u=>h(u)===d)||e.some(u=>h(u)===d)){T("comment-skip-duplicate",{preview:o,vposMs:l});continue}const c=new on(r,l,s,this._settings,this.commentDependencies,a);c.creationIndex=this.commentSequence++,c.epochId=this.epochId,e.push(c),T("comment-added",{preview:o,vposMs:l,commands:c.commands.length,layout:c.layout,isScrolling:c.isScrolling,invisible:c.isInvisible});}return e.length===0?[]:(this.comments.push(...e),Di(this.comments),this.finalPhaseActive&&(this.finalPhaseScheduleDirty=true),this.comments.sort((n,r)=>{const i=n.vposMs-r.vposMs;if(Math.abs(i)>A)return i;const s=Ct(n),a=Ct(r);return s!==null&&a!==null&&Math.abs(s-a)>A?s-a:n.creationIndex-r.creationIndex}),e)},zi=function(t,e,n=[],r=null){const[i]=this.addComments([{text:t,vposMs:e,commands:n,meta:r}]);return i??null},Oi=function(){if(this.comments.length=0,this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.commentSequence=0,this.ctx&&this.canvas){const t=this.canvasDpr>0?this.canvasDpr:1,e=this.displayWidth>0?this.displayWidth:this.canvas.width/t,n=this.displayHeight>0?this.displayHeight:this.canvas.height/t;this.ctx.clearRect(0,0,e,n);}},Ni=function(){this.clearComments(),this.currentTime=0,this.resetFinalPhaseState(),this.playbackHasBegun=false,this.skipDrawingForCurrentFrame=false,this.isStalled=false,this.pendingInitialSync=false;},cn=function(){const t=this._settings,e=Array.isArray(t.ngWords)?t.ngWords:[];this.normalizedNgWords=e.filter(r=>typeof r=="string");const n=Array.isArray(t.ngRegexps)?t.ngRegexps:[];this.compiledNgRegexps=n.map(r=>{if(typeof r!="string")return null;try{return new RegExp(r,"i")}catch(i){return this.log.warn("CommentRenderer.invalidNgRegexp",i,{entry:r}),null}}).filter(r=>!!r);},$i=function(t){return typeof t!="string"||t.length===0?false:this.normalizedNgWords.some(e=>e.length>0&&t.includes(e))?true:this.compiledNgRegexps.some(e=>e.test(t))},Wi=t=>{t.prototype.addComments=Hi,t.prototype.addComment=zi,t.prototype.clearComments=Oi,t.prototype.resetState=Ni,t.prototype.rebuildNgMatchers=cn,t.prototype.isNGComment=$i;},Bi=function(){this.finalPhaseActive=false,this.finalPhaseStartTime=null,this.finalPhaseScheduleDirty=false,this.finalPhaseVposOverrides.clear();},qi=function(t){const e=this.epochId;if(this.epochId+=1,Ur(e,this.epochId,t),this.eventHooks.onEpochChange){const n={previousEpochId:e,newEpochId:this.epochId,reason:t,timestamp:this.timeSource.now()};try{this.eventHooks.onEpochChange(n);}catch(r){this.log.error("CommentRenderer.incrementEpoch.callback",r,{info:n});}}this.comments.forEach(n=>{n.epochId=this.epochId;});},Yi=function(t){const e=this.timeSource.now();if(e-this.lastSnapshotEmitTime<this.snapshotEmitThrottleMs)return;const n={currentTime:this.currentTime,duration:this.duration,isPlaying:this.isPlaying,epochId:this.epochId,totalComments:this.comments.length,activeComments:this.activeComments.size,reservedLanes:this.reservedLanes.size,finalPhaseActive:this.finalPhaseActive,playbackHasBegun:this.playbackHasBegun,isStalled:this.isStalled};if(Yr(t,n),this.eventHooks.onStateSnapshot)try{this.eventHooks.onStateSnapshot(n);}catch(r){this.log.error("CommentRenderer.emitStateSnapshot.callback",r);}this.lastSnapshotEmitTime=e;},Ui=function(t){this.finalPhaseActive&&this.finalPhaseScheduleDirty&&this.recomputeFinalPhaseTimeline();const e=this.finalPhaseVposOverrides.get(t);return e!==void 0?e:dn(t)},dn=t=>{if(!t.isScrolling)return t.vposMs;const e=t.isFull?nr:er;return Math.max(0,t.vposMs-e)},Gi=function(t){if(!t.isScrolling)return O;const e=[];return Number.isFinite(t.visibleDurationMs)&&t.visibleDurationMs>0&&e.push(t.visibleDurationMs),Number.isFinite(t.totalDurationMs)&&t.totalDurationMs>0&&e.push(t.totalDurationMs),e.length>0?Math.max(...e):De},ji=function(t){if(!this.finalPhaseActive||this.finalPhaseStartTime===null)return this.finalPhaseVposOverrides.delete(t),dn(t);this.finalPhaseScheduleDirty&&this.recomputeFinalPhaseTimeline();const e=this.finalPhaseVposOverrides.get(t);if(e!==void 0)return e;const n=Math.max(t.vposMs,this.finalPhaseStartTime);return this.finalPhaseVposOverrides.set(t,n),n},Ki=function(){if(!this.finalPhaseActive||this.finalPhaseStartTime===null){this.finalPhaseVposOverrides.clear(),this.finalPhaseScheduleDirty=false;return}const t=this.finalPhaseStartTime,e=this.duration>0?this.duration:t+ne,n=Math.max(t+ne,e),r=this.comments.filter(l=>l.hasShown||l.isInvisible||this.isNGComment(l.text)?false:l.vposMs>=t-D).sort((l,d)=>{const h=l.vposMs-d.vposMs;return Math.abs(h)>A?h:l.creationIndex-d.creationIndex});if(this.finalPhaseVposOverrides.clear(),r.length===0){this.finalPhaseScheduleDirty=false;return}const i=Math.max(n-t,ne)/Math.max(r.length,1),s=Number.isFinite(i)?i:be,a=Math.max(be,Math.min(s,Zn));let o=t;r.forEach((l,d)=>{const h=Math.max(1,this.getFinalPhaseDisplayDuration(l)),c=n-h;let u=Math.max(t,Math.min(o,c));Number.isFinite(u)||(u=t);const p=Jn*d;u+p<=c&&(u+=p),this.finalPhaseVposOverrides.set(l,u);const m=Math.max(be,Math.min(h/2,a));o=u+m;}),this.finalPhaseScheduleDirty=false;},Xi=t=>{t.prototype.resetFinalPhaseState=Bi,t.prototype.incrementEpoch=qi,t.prototype.emitStateSnapshot=Yi,t.prototype.getEffectiveCommentVpos=Ui,t.prototype.getFinalPhaseDisplayDuration=Gi,t.prototype.resolveFinalPhaseVpos=ji,t.prototype.recomputeFinalPhaseTimeline=Ki;},Zi=function(){return !this.playbackHasBegun&&!this.isPlaying&&this.currentTime<=B},Ji=function(){this.playbackHasBegun||(this.isPlaying||this.currentTime>B)&&(this.playbackHasBegun=true);},Qi=t=>{t.prototype.shouldSuppressRendering=Zi,t.prototype.updatePlaybackProgressState=Ji;},es=function(t){const e=this.videoElement,n=this.canvas,r=this.ctx;if(!e||!n||!r)return;const i=typeof t=="number"?t:L(e.currentTime);if(this.currentTime=i,this.playbackRate=e.playbackRate,this.isPlaying=!e.paused,this.updatePlaybackProgressState(),this.skipDrawingForCurrentFrame=this.shouldSuppressRendering(),this.skipDrawingForCurrentFrame)return;const s=this.canvasDpr>0?this.canvasDpr:1,a=this.displayWidth>0?this.displayWidth:n.width/s,o=this.displayHeight>0?this.displayHeight:n.height/s,l=this.buildPrepareOptions(a),d=this.duration>0&&this.duration-this.currentTime<=Xn;d&&!this.finalPhaseActive&&(this.finalPhaseActive=true,this.finalPhaseStartTime=this.currentTime,this.finalPhaseVposOverrides.clear(),this.finalPhaseScheduleDirty=true,r.clearRect(0,0,a,o),this.comments.forEach(c=>{c.isActive=false,c.clearActivation();}),this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0),!d&&this.finalPhaseActive&&this.resetFinalPhaseState(),this.finalPhaseActive&&this.finalPhaseScheduleDirty&&this.recomputeFinalPhaseTimeline(),this.pruneStaticLaneReservations(this.currentTime);for(const c of Array.from(this.activeComments)){const u=this.getEffectiveCommentVpos(c),p=u<this.currentTime-D,m=u>this.currentTime+D;if(p||m){c.isActive=false,this.activeComments.delete(c),c.clearActivation(),c.lane>=0&&(c.layout==="ue"?this.releaseStaticLane("ue",c.lane):c.layout==="shita"&&this.releaseStaticLane("shita",c.lane));continue}c.isScrolling&&c.hasShown&&(c.scrollDirection==="rtl"&&c.x<=c.exitThreshold||c.scrollDirection==="ltr"&&c.x>=c.exitThreshold)&&(c.isActive=false,this.activeComments.delete(c),c.clearActivation());}const h=this.getCommentsInTimeWindow(this.currentTime,D);for(const c of h){const u=W(),p=u?se(c.text):"";if(u&&T("comment-evaluate",{stage:"update",preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),currentTime:this.currentTime,isActive:c.isActive,hasShown:c.hasShown}),this.isNGComment(c.text)){u&&T("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"ng-runtime"});continue}if(c.isInvisible){u&&T("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"invisible"}),c.isActive=false,this.activeComments.delete(c),c.hasShown=true,c.clearActivation();continue}if(c.syncWithSettings(this._settings,this.settingsVersion),this.shouldActivateCommentAtTime(c,this.currentTime,p)&&this.activateComment(c,r,a,o,l,this.currentTime),c.isActive){if(c.layout!=="naka"&&c.hasStaticExpired(this.currentTime)){const m=c.layout==="ue"?"ue":"shita";this.releaseStaticLane(m,c.lane),c.isActive=false,this.activeComments.delete(c),c.clearActivation();continue}if(c.layout==="naka"&&this.getEffectiveCommentVpos(c)>this.currentTime+B){c.x=c.virtualStartX,c.lastUpdateTime=this.timeSource.now();continue}if(c.hasShown=true,c.update(this.playbackRate,!this.isPlaying),!c.isScrolling&&c.hasStaticExpired(this.currentTime)){const m=c.layout==="ue"?"ue":"shita";this.releaseStaticLane(m,c.lane),c.isActive=false,this.activeComments.delete(c),c.clearActivation();}}}},ts=function(t){const e=this._settings.scrollVisibleDurationMs;let n=De,r=Xe;return e!==null&&(n=e,r=Math.max(1,Math.min(e,Xe))),{visibleWidth:t,virtualExtension:Qn,maxVisibleDurationMs:n,minVisibleDurationMs:r,maxWidthRatio:Un,bufferRatio:Gn,baseBufferPx:jn,entryBufferPx:Kn}},ns=function(t){const e=this.currentTime;this.pruneLaneReservations(e),this.pruneStaticLaneReservations(e);const n=this.getLanePriorityOrder(e),r=this.createLaneReservation(t,e),i=n.map(l=>{const d=(this.reservedLanes.get(l)??[]).find(h=>this.areReservationsConflicting(h,r));return {lane:l,available:d===void 0,nextAvailableTime:this.getLaneNextAvailableTime(l,e),blocker:d}}),s=i.find(l=>l.available),a=n[n.length-1]??0,o=s?.lane??a;return this.storeLaneReservation(o,r),Xr("laneDecision",t,{meta:{currentTimeMs:e,selectedLane:o,usedFallback:s===void 0,candidateLanes:i.map(l=>l.lane).join(","),availableLanes:i.filter(l=>l.available).map(l=>l.lane).join(","),nextAvailableTimes:i.map(l=>Math.round(l.nextAvailableTime)).join(","),blockedBy:i.map(l=>l.blocker?`${l.lane}:${l.blocker.comment.creationIndex}@${l.blocker.comment.vposMs}`:`${l.lane}:-`).join(","),reservationStartTimeMs:Math.round(r.startTime),reservationEndTimeMs:Math.round(r.endTime),reservationTotalEndTimeMs:Math.round(r.totalEndTime),reservationWidth:Math.round(r.width)}}),o},rs=t=>{t.prototype.updateComments=es,t.prototype.buildPrepareOptions=ts,t.prototype.findAvailableLane=ns;},is=function(t,e){let n=0,r=t.length;for(;n<r;){const i=Math.floor((n+r)/2),s=t[i];s!==void 0&&s.totalEndTime+ue<=e?n=i+1:r=i;}return n},ss=function(t){for(const[e,n]of this.reservedLanes.entries()){const r=this.findFirstValidReservationIndex(n,t);r>=n.length?this.reservedLanes.delete(e):r>0&&this.reservedLanes.set(e,n.slice(r));}},as=function(t){const e=i=>i.filter(s=>s.releaseTime>t),n=e(this.topStaticLaneReservations),r=e(this.bottomStaticLaneReservations);this.topStaticLaneReservations.length=0,this.topStaticLaneReservations.push(...n),this.bottomStaticLaneReservations.length=0,this.bottomStaticLaneReservations.push(...r);},os=t=>{t.prototype.findFirstValidReservationIndex=is,t.prototype.pruneLaneReservations=ss,t.prototype.pruneStaticLaneReservations=as;},ls=function(t){let e=0,n=this.comments.length;for(;e<n;){const r=Math.floor((e+n)/2),i=this.comments[r];i!==void 0&&i.vposMs<t?e=r+1:n=r;}return e},cs=function(t,e){if(this.comments.length===0)return [];const n=t-e,r=t+e,i=this.findCommentIndexAtOrAfter(n),s=[];for(let a=i;a<this.comments.length;a++){const o=this.comments[a];if(o){if(o.vposMs>r)break;s.push(o);}}return s},ds=function(t){return t==="ue"?this.topStaticLaneReservations:this.bottomStaticLaneReservations},hs=function(t){return t==="ue"?this.topStaticLaneReservations.length:this.bottomStaticLaneReservations.length},us=function(t){const e=t==="ue"?"shita":"ue",n=this.getStaticLaneDepth(e),r=this.laneCount-n;return r<=0?-1:r-1},ps=function(t){return Math.max(0,this.laneCount-1-t)},ms=t=>{const e=Math.ceil(t.lines.length>1?t.height:t.height+t.fontSize/3);return Math.max(0,(e-t.height)/2)},gs=function(t,e,n,r){const i=Math.max(1,n),s=Math.max(r.height,r.fontSize),a=5,o=0,l=ms(r);if(t==="ue"){const u=a+l;let p=u;const m=this.getStaticReservations(t).filter(y=>y.lane<e).sort((y,f)=>y.lane-f.lane);for(const y of m){const f=y.yEnd-y.yStart;p+=f+o;}const x=Math.max(a,i*2);return Math.max(u,Math.min(p,x))}let d=i-a;const h=this.getStaticReservations(t).filter(u=>u.lane<e).sort((u,p)=>u.lane-p.lane);for(const u of h){const p=u.yEnd-u.yStart;d-=p+o;}const c=d-s;return Math.max(a,c)},fs=function(){const t=new Set;for(const e of this.topStaticLaneReservations)t.add(e.lane);for(const e of this.bottomStaticLaneReservations)t.add(this.getGlobalLaneIndexForBottom(e.lane));return t},bs=t=>{t.prototype.findCommentIndexAtOrAfter=ls,t.prototype.getCommentsInTimeWindow=cs,t.prototype.getStaticReservations=ds,t.prototype.getStaticLaneDepth=hs,t.prototype.getStaticLaneLimit=us,t.prototype.getGlobalLaneIndexForBottom=ps,t.prototype.resolveStaticCommentOffset=gs,t.prototype.getStaticReservedLaneSet=fs;},vs=t=>!t.isScrolling&&t.width>=1200&&t.fontSize>=35,hn=t=>Math.max(1,t.fontSize*(vs(t)?.46:1)),ys=function(t,e,n=""){const r=n.length>0&&W(),i=this.resolveFinalPhaseVpos(t);return this.finalPhaseActive&&this.finalPhaseStartTime!==null&&t.vposMs<this.finalPhaseStartTime-A?(r&&T("comment-eval-skip",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,reason:"final-phase-trimmed",finalPhaseStartTime:this.finalPhaseStartTime}),this.finalPhaseVposOverrides.delete(t),false):t.isInvisible?(r&&T("comment-eval-skip",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,reason:"invisible"}),false):t.isActive?(r&&T("comment-eval-skip",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,reason:"already-active"}),false):t.hasShown&&i<=e?(r&&T("comment-eval-skip",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,reason:"already-shown",currentTime:e}),false):i>e+B?(r&&T("comment-eval-pending",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,reason:"future",currentTime:e}),false):i<e-D?(r&&T("comment-eval-skip",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,reason:"expired-window",currentTime:e}),false):!t.isScrolling&&i+O<=e?(r&&T("comment-eval-skip",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,reason:"static-expired",currentTime:e}),false):(r&&T("comment-eval-ready",{preview:n,vposMs:t.vposMs,effectiveVposMs:i,currentTime:e}),true)},xs=function(t,e,n,r,i,s){t.prepare(e,n,r,i);const a=this.resolveFinalPhaseVpos(t);if(W()&&T("comment-prepared",{preview:se(t.text),layout:t.layout,isScrolling:t.isScrolling,width:t.width,height:t.height,bufferWidth:t.bufferWidth,visibleDurationMs:t.visibleDurationMs,effectiveVposMs:a}),t.layout==="naka"){const o=Math.max(0,s-a),l=t.speedPixelsPerMs*o;if(this.finalPhaseActive&&this.finalPhaseStartTime!==null){const p=this.duration>0?this.duration:this.finalPhaseStartTime+ne,m=Math.max(this.finalPhaseStartTime+ne,p),x=t.width+n,y=x>0?x/Math.max(t.speedPixelsPerMs,1):0;if(a+y>m){const f=m-s,v=Math.max(0,f)*t.speedPixelsPerMs,M=t.scrollDirection==="rtl"?Math.max(t.virtualStartX-l,n-v):Math.min(t.virtualStartX+l,v-t.width);t.x=M;}else t.x=t.scrollDirection==="rtl"?t.virtualStartX-l:t.virtualStartX+l;}else t.x=t.scrollDirection==="rtl"?t.virtualStartX-l:t.virtualStartX+l;const d=this.findAvailableLane(t);t.lane=d;const h=Math.max(1,this.laneHeight),c=Math.max(0,r-t.height),u=d*h;t.y=t.isFull?0:Math.max(0,Math.min(u,c));}else {const o=t.layout==="ue"?"ue":"shita",l=this.assignStaticLane(o,t,r,s),d=this.resolveStaticCommentOffset(o,l,r,t);t.x=t.virtualStartX,t.y=d,t.lane=o==="ue"?l:this.getGlobalLaneIndexForBottom(l),t.speed=0,t.baseSpeed=0,t.speedPixelsPerMs=0;const h=a+O;t.visibleDurationMs=Math.max(0,h-s),this.activeComments.add(t),t.isActive=true,t.hasShown=true,t.isPaused=!this.isPlaying,t.markActivated(s),t.lastUpdateTime=this.timeSource.now(),t.staticExpiryTimeMs=h,this.reserveStaticLane(o,t,l,h),W()&&T("comment-activate-static",{preview:se(t.text),lane:t.lane,position:o,displayEnd:h,effectiveVposMs:a});return}this.activeComments.add(t),t.isActive=true,t.hasShown=true,t.isPaused=!this.isPlaying,t.markActivated(s),t.lastUpdateTime=this.timeSource.now();},ws=function(t,e,n,r){const i=this.getStaticReservations(t),s=hn(e),a=Math.max(1,s),o=Math.max(this.laneCount,Math.ceil(Math.max(1,n)/a)+i.length+1),l=Array.from({length:o},(c,u)=>u);for(const c of l){const u=this.resolveStaticCommentOffset(t,c,n,e),p=u,m=u+s;if(!i.some(x=>x.releaseTime>r?!(m<=x.yStart||p>=x.yEnd):false))return c}let d=l[0]??0,h=Number.POSITIVE_INFINITY;for(const c of i)c.releaseTime<h&&(h=c.releaseTime,d=c.lane);return d},Ss=function(t,e,n,r){const i=this.getStaticReservations(t),s=e.y,a=e.y+hn(e);i.push({comment:e,releaseTime:r,yStart:s,yEnd:a,lane:n});},Cs=function(t,e){if(e<0)return;const n=this.getStaticReservations(t),r=n.findIndex(i=>i.lane===e);r>=0&&n.splice(r,1);},Ms=t=>{t.prototype.shouldActivateCommentAtTime=ys,t.prototype.activateComment=xs,t.prototype.assignStaticLane=ws,t.prototype.reserveStaticLane=Ss,t.prototype.releaseStaticLane=Cs;},Es=.001,Ts=function(){return Array.from({length:this.laneCount},(t,e)=>e)},ks=function(t,e){const n=this.reservedLanes.get(t);if(!n||n.length===0)return e;const r=this.findFirstValidReservationIndex(n,e),i=n[r];return i?Math.max(e,i.endTime+ue):e},_s=function(t,e){const n=Math.max(t.speedPixelsPerMs,A),r=this.getEffectiveCommentVpos(t),i=Number.isFinite(r)?r:e,s=Math.max(0,i),a=Number.isFinite(t.width)&&t.width>0?t.width:t.reservationWidth,o=n>0?Math.max(a,0)/n:t.preCollisionDurationMs,l=s+o+ue,d=s+t.totalDurationMs+ue;return {comment:t,startTime:s,endTime:Math.max(s,l),totalEndTime:Math.max(s,d),startLeft:t.virtualStartX,width:a,speed:n,buffer:0,directionSign:t.getDirectionSign()}},Vs=function(t,e,n){const r=this.reservedLanes.get(t);if(!r||r.length===0)return  true;const i=this.findFirstValidReservationIndex(r,n);for(let s=i;s<r.length;s+=1){const a=r[s];if(a&&this.areReservationsConflicting(a,e))return  false}return  true},Is=function(t,e){const n=[...this.reservedLanes.get(t)??[],e].sort((r,i)=>r.totalEndTime-i.totalEndTime);this.reservedLanes.set(t,n);},As=function(t,e){if(t.directionSign===e.directionSign){const o=t.speed>0?Math.max(t.width,0)/t.speed:0,l=e.speed>0?Math.max(e.width,0)/e.speed:0,d=Math.max(o,l);return Math.abs(e.startTime-t.startTime)+Es<d}const n=Math.max(t.startTime,e.startTime),r=Math.min(t.endTime,e.endTime);if(n>=r)return  false;const i=new Set([n,r,n+(r-n)/2]),s=this.solveLeftRightEqualityTime(t,e);s!==null&&s>=n-A&&s<=r+A&&i.add(s);const a=this.solveLeftRightEqualityTime(e,t);a!==null&&a>=n-A&&a<=r+A&&i.add(a);for(const o of i){if(o<n-A||o>r+A)continue;const l=this.computeForwardGap(t,e,o),d=this.computeForwardGap(e,t,o);if(l<=-24&&d<=-24)return  true}return  false},Ls=function(t,e,n){const r=this.getBufferedEdges(t,n),i=this.getBufferedEdges(e,n);return r.left-i.right},Ps=function(t,e){const n=Math.max(0,e-t.startTime),r=t.speed*n,i=t.startLeft+t.directionSign*r,s=i-t.buffer,a=i+t.width+t.buffer;return {left:s,right:a}},Fs=function(t,e){const n=t.directionSign,r=e.directionSign,i=r*e.speed-n*t.speed;if(Math.abs(i)<A)return null;const s=(e.startLeft+r*e.speed*e.startTime+e.width+e.buffer-t.startLeft-n*t.speed*t.startTime+t.buffer)/i;return Number.isFinite(s)?s:null},Rs=t=>{t.prototype.getLanePriorityOrder=Ts,t.prototype.getLaneNextAvailableTime=ks,t.prototype.createLaneReservation=_s,t.prototype.isLaneAvailable=Vs,t.prototype.storeLaneReservation=Is,t.prototype.areReservationsConflicting=As,t.prototype.computeForwardGap=Ls,t.prototype.getBufferedEdges=Ps,t.prototype.solveLeftRightEqualityTime=Fs;},Ds=function(){const t=this.canvas,e=this.ctx;if(!t||!e)return;const n=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:t.width/n,i=this.displayHeight>0?this.displayHeight:t.height/n,s=this.timeSource.now();if(this.skipDrawingForCurrentFrame||this.shouldSuppressRendering()||this.isStalled){e.clearRect(0,0,r,i),this.lastDrawTime=s;return}e.clearRect(0,0,r,i);const a=Array.from(this.activeComments);if(this._settings.isCommentVisible){const o=(s-this.lastDrawTime)/16.666666666666668;a.sort((l,d)=>{const h=this.getEffectiveCommentVpos(l),c=this.getEffectiveCommentVpos(d),u=h-c;return Math.abs(u)>A?u:l.isScrolling!==d.isScrolling?l.isScrolling?1:-1:l.creationIndex-d.creationIndex}),a.forEach(l=>{const d=this.isPlaying&&!l.isPaused?l.x+l.getDirectionSign()*l.speed*o:l.x;l.draw(e,d);});}this.lastDrawTime=s;},Hs=function(t){const e=this.videoElement,n=this.canvas,r=this.ctx;if(!e||!n||!r)return;const i=typeof t=="number"?t:L(e.currentTime);this.currentTime=i,this.lastDrawTime=this.timeSource.now();const s=this.canvasDpr>0?this.canvasDpr:1,a=this.displayWidth>0?this.displayWidth:n.width/s,o=this.displayHeight>0?this.displayHeight:n.height/s,l=this.buildPrepareOptions(a);this.activeComments.forEach(d=>{d.isActive=false,d.clearActivation();}),this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.getCommentsInTimeWindow(this.currentTime,D).forEach(d=>{if(this.isNGComment(d.text)||d.isInvisible){d.isActive=false,this.activeComments.delete(d),d.clearActivation();return}if(d.syncWithSettings(this._settings,this.settingsVersion),d.isActive=false,this.activeComments.delete(d),d.lane=-1,d.hasShown=false,d.clearActivation(),this.shouldActivateCommentAtTime(d,this.currentTime)){this.activateComment(d,r,a,o,l,this.currentTime);return}this.getEffectiveCommentVpos(d)<this.currentTime-D?d.hasShown=true:d.hasShown=false;});},zs=t=>{t.prototype.draw=Ds,t.prototype.performInitialSync=Hs;},Os=function(t){this.videoElement&&this._settings.isCommentVisible&&(this.pendingInitialSync&&(this.performInitialSync(t),this.pendingInitialSync=false),this.updateComments(t),this.draw());},Ns=function(){const t=this.frameId;this.frameId=null,t!==null&&this.animationFrameProvider.cancel(t),this.processFrame(),this.scheduleNextFrame();},$s=function(t,e){this.videoFrameHandle=null;const n=typeof e?.mediaTime=="number"?e.mediaTime*1e3:void 0;this.processFrame(typeof n=="number"?n:void 0),this.scheduleNextFrame();},Ws=function(){if(this._settings.syncMode!=="video-frame")return  false;const t=this.videoElement;return !!t&&typeof t.requestVideoFrameCallback=="function"&&typeof t.cancelVideoFrameCallback=="function"},Bs=function(){const t=this.videoElement;if(t){if(this.shouldUseVideoFrameCallback()){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback();const e=t.requestVideoFrameCallback;typeof e=="function"&&(this.videoFrameHandle=e.call(t,this.handleVideoFrame));return}this.cancelVideoFrameCallback(),this.frameId=this.animationFrameProvider.request(this.handleAnimationFrame);}},qs=function(){this.frameId!==null&&(this.animationFrameProvider.cancel(this.frameId),this.frameId=null);},Ys=function(){if(this.videoFrameHandle===null)return;const t=this.videoElement;t&&typeof t.cancelVideoFrameCallback=="function"&&t.cancelVideoFrameCallback(this.videoFrameHandle),this.videoFrameHandle=null;},Us=function(){this.stopAnimation(),this.scheduleNextFrame();},Gs=function(){this.cancelAnimationFrameRequest(),this.cancelVideoFrameCallback();},js=function(){const t=this.canvas,e=this.ctx,n=this.videoElement;if(!t||!e||!n)return;const r=L(n.currentTime),i=Math.abs(r-this.currentTime),s=this.timeSource.now();if(s-this.lastPlayResumeTime<this.playResumeSeekIgnoreDurationMs){this.currentTime=r,this._settings.isCommentVisible&&(this.lastDrawTime=s,this.draw());return}const a=i>B;if(this.currentTime=r,this.resetFinalPhaseState(),this.updatePlaybackProgressState(),!a){this._settings.isCommentVisible&&(this.lastDrawTime=this.timeSource.now(),this.draw());return}this.activeComments.clear(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0;const o=this.canvasDpr>0?this.canvasDpr:1,l=this.displayWidth>0?this.displayWidth:t.width/o,d=this.displayHeight>0?this.displayHeight:t.height/o,h=this.buildPrepareOptions(l);this.getCommentsInTimeWindow(this.currentTime,D).forEach(c=>{const u=W(),p=u?se(c.text):"";if(u&&T("comment-evaluate",{stage:"seek",preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),currentTime:this.currentTime,isActive:c.isActive,hasShown:c.hasShown}),this.isNGComment(c.text)){u&&T("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"ng-runtime"}),c.isActive=false,this.activeComments.delete(c),c.clearActivation();return}if(c.isInvisible){u&&T("comment-eval-skip",{preview:p,vposMs:c.vposMs,effectiveVposMs:this.getEffectiveCommentVpos(c),reason:"invisible"}),c.isActive=false,this.activeComments.delete(c),c.hasShown=true,c.clearActivation();return}if(c.syncWithSettings(this._settings,this.settingsVersion),c.isActive=false,this.activeComments.delete(c),c.lane=-1,c.hasShown=false,c.clearActivation(),this.shouldActivateCommentAtTime(c,this.currentTime,p)){this.activateComment(c,e,l,d,h,this.currentTime);return}this.getEffectiveCommentVpos(c)<this.currentTime-D?c.hasShown=true:c.hasShown=false;}),this._settings.isCommentVisible&&(this.lastDrawTime=this.timeSource.now(),this.draw());},Ks=t=>{t.prototype.processFrame=Os,t.prototype.handleAnimationFrame=Ns,t.prototype.handleVideoFrame=$s,t.prototype.shouldUseVideoFrameCallback=Ws,t.prototype.scheduleNextFrame=Bs,t.prototype.cancelAnimationFrameRequest=qs,t.prototype.cancelVideoFrameCallback=Ys,t.prototype.startAnimation=Us,t.prototype.stopAnimation=Gs,t.prototype.onSeek=js;},Xs=function(t,e){if(t)return t;if(e.parentElement)return e.parentElement;if(typeof document<"u"&&document.body)return document.body;throw new Error("Cannot resolve container element. Provide container explicitly when DOM is unavailable.")},Zs=function(t){if(typeof getComputedStyle=="function"){getComputedStyle(t).position==="static"&&(t.style.position="relative");return}t.style.position||(t.style.position="relative");},Js=function(t){try{this.destroyCanvasOnly();const e=t instanceof HTMLVideoElement?t:t.video,n=t instanceof HTMLVideoElement?t.parentElement:t.container??t.video.parentElement,r=this.resolveContainer(n??null,e);this.videoElement=e,this.containerElement=r,this.lastVideoSource=this.getCurrentVideoSource(),this.duration=Number.isFinite(e.duration)?L(e.duration):0,this.currentTime=L(e.currentTime),this.playbackRate=e.playbackRate,this.isPlaying=!e.paused,this.isStalled=!1,this.lastDrawTime=this.timeSource.now(),this.playbackHasBegun=this.isPlaying||this.currentTime>B,this.skipDrawingForCurrentFrame=this.shouldSuppressRendering();const i=this.createCanvasElement(),s=i.getContext("2d");if(!s)throw new Error("Failed to acquire 2D canvas context");i.style.position="absolute",i.style.top="0",i.style.left="0",i.style.right="0",i.style.bottom="0",i.style.display="block",i.style.pointerEvents="none",i.style.zIndex="2147483647";const a=this.containerElement;a instanceof HTMLElement&&(this.ensureContainerPositioning(a),a.appendChild(i)),this.canvas=i,this.ctx=s,this.resize(),this.calculateLaneMetrics(),this.setupVideoEventListeners(e),this.setupResizeHandling(e),this.setupFullscreenHandling(),this.setupVideoChangeDetection(e,r),this.startAnimation(),this.setupVisibilityHandling();}catch(e){throw this.log.error("CommentRenderer.initialize",e),e}},Qs=function(){this.stopAnimation(),this.cleanupResizeHandling(),this.runCleanupTasks(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.videoElement=null,this.containerElement=null,this.comments.length=0,this.activeComments.clear(),this.reservedLanes.clear(),this.resetFinalPhaseState(),this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1,this.commentSequence=0,this.playbackHasBegun=false,this.skipDrawingForCurrentFrame=false,this.isStalled=false,this.pendingInitialSync=false;},ea=function(){this.stopAnimation(),this.canvas&&this.canvas.remove(),this.canvas=null,this.ctx=null,this.displayWidth=0,this.displayHeight=0,this.canvasDpr=1,this.fullscreenActive=false;},ta=t=>{t.prototype.resolveContainer=Xs,t.prototype.ensureContainerPositioning=Zs,t.prototype.initialize=Js,t.prototype.destroy=Qs,t.prototype.destroyCanvasOnly=ea;},na=function(t){try{const e=()=>{this.isPlaying=!0,this.playbackHasBegun=!0;const u=this.timeSource.now();this.lastDrawTime=u,this.lastPlayResumeTime=u,this.comments.forEach(p=>{p.lastUpdateTime=u,p.isPaused=!1;});},n=()=>{this.isPlaying=!1;const u=this.timeSource.now();this.comments.forEach(p=>{p.lastUpdateTime=u,p.isPaused=!0;});},r=()=>{this.onSeek();},i=()=>{this.onSeek();},s=()=>{this.playbackRate=t.playbackRate;const u=this.timeSource.now();this.comments.forEach(p=>{p.lastUpdateTime=u;});},a=()=>{this.handleVideoMetadataLoaded(t);},o=()=>{this.duration=Number.isFinite(t.duration)?L(t.duration):0;},l=()=>{this.handleVideoSourceChange();},d=()=>{this.handleVideoStalled();},h=()=>{this.handleVideoCanPlay();},c=()=>{this.handleVideoCanPlay();};t.addEventListener("play",e),t.addEventListener("pause",n),t.addEventListener("seeking",r),t.addEventListener("seeked",i),t.addEventListener("ratechange",s),t.addEventListener("loadedmetadata",a),t.addEventListener("durationchange",o),t.addEventListener("emptied",l),t.addEventListener("waiting",d),t.addEventListener("canplay",h),t.addEventListener("playing",c),this.addCleanup(()=>t.removeEventListener("play",e)),this.addCleanup(()=>t.removeEventListener("pause",n)),this.addCleanup(()=>t.removeEventListener("seeking",r)),this.addCleanup(()=>t.removeEventListener("seeked",i)),this.addCleanup(()=>t.removeEventListener("ratechange",s)),this.addCleanup(()=>t.removeEventListener("loadedmetadata",a)),this.addCleanup(()=>t.removeEventListener("durationchange",o)),this.addCleanup(()=>t.removeEventListener("emptied",l)),this.addCleanup(()=>t.removeEventListener("waiting",d)),this.addCleanup(()=>t.removeEventListener("canplay",h)),this.addCleanup(()=>t.removeEventListener("playing",c));}catch(e){throw this.log.error("CommentRenderer.setupVideoEventListeners",e),e}},ra=function(t){this.lastVideoSource=this.getCurrentVideoSource(),this.incrementEpoch("metadata-loaded"),this.handleVideoSourceChange(t),this.resize(),this.calculateLaneMetrics(),this.onSeek(),this.emitStateSnapshot("metadata-loaded");},ia=function(){const t=this.canvas,e=this.ctx;if(!t||!e)return;this.isStalled=true;const n=this.canvasDpr>0?this.canvasDpr:1,r=this.displayWidth>0?this.displayWidth:t.width/n,i=this.displayHeight>0?this.displayHeight:t.height/n;e.clearRect(0,0,r,i),this.comments.forEach(s=>{s.isActive&&(s.lastUpdateTime=this.timeSource.now());});},sa=function(){this.isStalled&&(this.isStalled=false,this.videoElement&&(this.currentTime=L(this.videoElement.currentTime),this.isPlaying=!this.videoElement.paused),this.lastDrawTime=this.timeSource.now());},aa=function(t){const e=t??this.videoElement;if(!e){this.lastVideoSource=null,this.isPlaying=false,this.resetFinalPhaseState(),this.resetCommentActivity();return}const n=this.getCurrentVideoSource();n!==this.lastVideoSource&&(this.lastVideoSource=n,this.incrementEpoch("source-change"),this.syncVideoState(e),this.resetFinalPhaseState(),this.resetCommentActivity(),this.emitStateSnapshot("source-change"));},oa=function(t){this.duration=Number.isFinite(t.duration)?L(t.duration):0,this.currentTime=L(t.currentTime),this.playbackRate=t.playbackRate,this.isPlaying=!t.paused,this.isStalled=false,this.playbackHasBegun=this.isPlaying||this.currentTime>B,this.lastDrawTime=this.timeSource.now();},la=function(){const t=this.timeSource.now(),e=this.canvas,n=this.ctx;if(this.resetFinalPhaseState(),this.skipDrawingForCurrentFrame=false,this.isStalled=false,this.pendingInitialSync=false,this.playbackHasBegun=this.isPlaying||this.currentTime>B,e&&n){const r=this.canvasDpr>0?this.canvasDpr:1,i=this.displayWidth>0?this.displayWidth:e.width/r,s=this.displayHeight>0?this.displayHeight:e.height/r;n.clearRect(0,0,i,s);}this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.comments.forEach(r=>{r.isActive=false,r.isPaused=!this.isPlaying,r.hasShown=false,r.lane=-1,r.x=r.virtualStartX,r.speed=r.baseSpeed,r.lastUpdateTime=t,r.clearActivation();}),this.activeComments.clear();},ca=function(t,e){if(typeof MutationObserver>"u"){this.log.debug("MutationObserver is not available in this environment. Video change detection is disabled.");return}const n=new MutationObserver(i=>{for(const s of i){if(s.type==="attributes"&&s.attributeName==="src"){const a=s.target;let o=null,l=null;if((a instanceof HTMLVideoElement||a instanceof HTMLSourceElement)&&(o=typeof s.oldValue=="string"?s.oldValue:null,l=a.getAttribute("src")),o===l)continue;this.handleVideoSourceChange(t);return}if(s.type==="childList"){for(const a of s.addedNodes)if(a instanceof HTMLSourceElement){this.handleVideoSourceChange(t);return}for(const a of s.removedNodes)if(a instanceof HTMLSourceElement){this.handleVideoSourceChange(t);return}}}});n.observe(t,{attributes:true,attributeFilter:["src"],attributeOldValue:true,childList:true,subtree:true}),this.addCleanup(()=>n.disconnect());const r=new MutationObserver(i=>{for(const s of i)if(s.type==="childList"){for(const a of s.addedNodes){const o=this.extractVideoElement(a);if(o&&o!==this.videoElement){this.initialize(o);return}}for(const a of s.removedNodes){if(a===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}if(a instanceof Element){const o=a.querySelector("video");if(o&&o===this.videoElement){this.videoElement=null,this.handleVideoSourceChange(null);return}}}}});r.observe(e,{childList:true,subtree:true}),this.addCleanup(()=>r.disconnect());},da=function(t){if(t instanceof HTMLVideoElement)return t;if(t instanceof Element){const e=t.querySelector("video");if(e instanceof HTMLVideoElement)return e}return null},ha=t=>{t.prototype.setupVideoEventListeners=na,t.prototype.handleVideoMetadataLoaded=ra,t.prototype.handleVideoStalled=ia,t.prototype.handleVideoCanPlay=sa,t.prototype.handleVideoSourceChange=aa,t.prototype.syncVideoState=oa,t.prototype.resetCommentActivity=la,t.prototype.setupVideoChangeDetection=ca,t.prototype.extractVideoElement=da;},ua=function(){if(typeof document>"u"||typeof document.addEventListener!="function"||typeof document.removeEventListener!="function")return;const t=()=>{if(document.visibilityState!=="visible"){this.stopAnimation();return}this._settings.isCommentVisible&&(this.handleVisibilityRestore(),this.startAnimation());};document.addEventListener("visibilitychange",t),this.addCleanup(()=>document.removeEventListener("visibilitychange",t)),document.visibilityState!=="visible"&&this.stopAnimation();},pa=function(){const t=this.canvas,e=this.ctx,n=this.videoElement;!t||!e||!n||(this.currentTime=L(n.currentTime),this.lastDrawTime=this.timeSource.now(),this.isPlaying=!n.paused,this.isStalled=false,this.pendingInitialSync=true,this.resetFinalPhaseState(),this.updatePlaybackProgressState(),this.draw());},ma=function(t){const e=this._settings.isCommentVisible;if(this._settings.isCommentVisible=t,e===t)return;this.settingsVersion+=1,this.commentDependencies.settingsVersion=this.settingsVersion;const n=this.canvas,r=this.ctx;if(!(!n||!r))if(t)this.lastDrawTime=this.timeSource.now(),this.pendingInitialSync=true,this.scheduleNextFrame();else {const i=this.canvasDpr>0?this.canvasDpr:1,s=this.displayWidth>0?this.displayWidth:n.width/i,a=this.displayHeight>0?this.displayHeight:n.height/i;r.clearRect(0,0,s,a);}},ga=t=>{t.prototype.setupVisibilityHandling=ua,t.prototype.handleVisibilityRestore=pa,t.prototype.setCommentVisibility=ma;},fa=2.1,ba=function(t,e){const n=this.videoElement,r=this.canvas,i=this.ctx;if(!n||!r)return;const s=(this.fullscreenActive&&r.parentElement instanceof HTMLElement?r.parentElement.getBoundingClientRect():null)??n.getBoundingClientRect(),a=this.canvasDpr>0?this.canvasDpr:1,o=this.displayWidth>0?this.displayWidth:r.width/a,l=this.displayHeight>0?this.displayHeight:r.height/a,d=t??s.width??o,h=e??s.height??l;if(!Number.isFinite(d)||!Number.isFinite(h)||d<=0||h<=0)return;const c=Math.max(1,Math.floor(d)),u=Math.max(1,Math.floor(h)),p=this._settings.useDprScaling?this.resolveDevicePixelRatio():1,m=Math.max(1,Math.round(c*p)),x=Math.max(1,Math.round(u*p));(this.displayWidth!==c||this.displayHeight!==u||Math.abs(this.canvasDpr-p)>Number.EPSILON||r.width!==m||r.height!==x)&&(this.displayWidth=c,this.displayHeight=u,this.canvasDpr=p,r.width=m,r.height=x,r.style.width=`${c}px`,r.style.height=`${u}px`,i&&(i.setTransform(1,0,0,1,0,0),this._settings.useDprScaling&&i.scale(p,p)),this.calculateLaneMetrics(),this.reservedLanes.clear(),this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0,this.performInitialSync(L(n.currentTime)),this.draw());},va=function(){if(typeof window>"u")return 1;const t=Number(window.devicePixelRatio);return !Number.isFinite(t)||t<=0?1:t},ya=function(){const t=this.canvas;if(!t)return;const e=this.displayHeight>0?this.displayHeight:t.height/Math.max(this.canvasDpr,1),n=Math.max(tr,Math.floor(e*(27/665)));this.laneHeight=n*fa;const r=Math.max(this.laneHeight,1),i=Math.floor(Math.max(0,e-r)/r);if(this._settings.useFixedLaneCount){const s=Number.isFinite(this._settings.fixedLaneCount)?Math.floor(this._settings.fixedLaneCount):jt,a=Math.max(Ze,Math.min(i,s));this.laneCount=a;}else this.laneCount=Math.max(Ze,i);this.topStaticLaneReservations.length=0,this.bottomStaticLaneReservations.length=0;},xa=function(t){this.cleanupResizeHandling();let e=false;const n=()=>{if(e)return;e=true;const i=()=>{e=false,this.resize();};if(typeof requestAnimationFrame=="function"){requestAnimationFrame(i);return}i();};if(this._settings.useContainerResizeObserver&&this.isResizeObserverAvailable){const i=this.resolveResizeObserverTarget(t),s=new ResizeObserver(a=>{for(const o of a){const{width:l,height:d}=o.contentRect;l>0&&d>0?this.resize(l,d):this.resize();}});s.observe(i),this.resizeObserver=s,this.resizeObserverTarget=i;}else this.log.debug("Resize handling is disabled because neither ResizeObserver nor window APIs are available.");typeof window<"u"&&typeof window.addEventListener=="function"&&(window.addEventListener("resize",n),this.addCleanup(()=>window.removeEventListener("resize",n)));const r=typeof window<"u"?window.visualViewport:void 0;r&&typeof r.addEventListener=="function"&&(r.addEventListener("resize",n),r.addEventListener("scroll",n),this.addCleanup(()=>{r.removeEventListener("resize",n),r.removeEventListener("scroll",n);}));},wa=function(){this.resizeObserver&&this.resizeObserverTarget&&this.resizeObserver.unobserve(this.resizeObserverTarget),this.resizeObserver?.disconnect(),this.resizeObserver=null,this.resizeObserverTarget=null;},Sa=t=>{t.prototype.resize=ba,t.prototype.resolveDevicePixelRatio=va,t.prototype.calculateLaneMetrics=ya,t.prototype.setupResizeHandling=xa,t.prototype.cleanupResizeHandling=wa;},Ca=function(){if(typeof document>"u"||typeof document.addEventListener!="function"||typeof document.removeEventListener!="function")return;const t=()=>{this.handleFullscreenChange();};["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].forEach(e=>{document.addEventListener(e,t),this.addCleanup(()=>document.removeEventListener(e,t));}),this.handleFullscreenChange();},Mt=t=>{const e=()=>{const n=t.getFullscreenElement();if(n instanceof HTMLElement){const r=n.getBoundingClientRect();t.resize(r.width,r.height);return}t.resize();};typeof requestAnimationFrame=="function"&&requestAnimationFrame(e),typeof setTimeout=="function"&&setTimeout(e,80);},Ma=function(t){return this.resolveFullscreenContainer(t)||(t.parentElement??t)},Ea=async function(){const t=this.canvas,e=this.videoElement;if(!t||!e)return;const n=this.containerElement??e.parentElement??null,r=this.getFullscreenElement(),i=this.resolveActiveOverlayContainer(e,n,r);if(!(i instanceof HTMLElement))return;t.parentElement!==i?(this.ensureContainerPositioning(i),i.appendChild(t)):this.ensureContainerPositioning(i);const s=r instanceof HTMLElement&&r.contains(e)?r:null,a=s!==null;if(this.fullscreenActive!==a&&(this.fullscreenActive=a,this.setupResizeHandling(e)),t.style.position="absolute",t.style.top="0",t.style.left="0",t.style.right="0",t.style.bottom="0",t.style.display="block",t.style.pointerEvents="none",t.style.zIndex="2147483647",s){const o=s.getBoundingClientRect();this.resize(o.width,o.height),Mt(this);return}this.resize(),Mt(this);},Ta=function(t){const e=this.getFullscreenElement();return e instanceof HTMLElement&&(e===t||e.contains(t))?e:null},ka=function(t,e,n){return n instanceof HTMLElement&&n.contains(t)?n instanceof HTMLVideoElement&&e instanceof HTMLElement?e:n:e??null},_a=function(){if(typeof document>"u")return null;const t=document;return document.fullscreenElement??t.webkitFullscreenElement??t.mozFullScreenElement??t.msFullscreenElement??null},Va=t=>{t.prototype.setupFullscreenHandling=Ca,t.prototype.resolveResizeObserverTarget=Ma,t.prototype.handleFullscreenChange=Ea,t.prototype.resolveFullscreenContainer=Ta,t.prototype.resolveActiveOverlayContainer=ka,t.prototype.getFullscreenElement=_a;},Ia=function(t){this.cleanupTasks.push(t);},Aa=function(){for(;this.cleanupTasks.length>0;){const t=this.cleanupTasks.pop();try{t?.();}catch(e){this.log.error("CommentRenderer.cleanupTask",e);}}},La=t=>{t.prototype.addCleanup=Ia,t.prototype.runCleanupTasks=Aa;};class _{_settings;comments=[];activeComments=new Set;reservedLanes=new Map;topStaticLaneReservations=[];bottomStaticLaneReservations=[];log;timeSource;animationFrameProvider;createCanvasElement;commentDependencies;settingsVersion=0;normalizedNgWords=[];compiledNgRegexps=[];canvas=null;ctx=null;videoElement=null;containerElement=null;fullscreenActive=false;laneCount=jt;laneHeight=0;displayWidth=0;displayHeight=0;canvasDpr=1;currentTime=0;duration=0;playbackRate=1;isPlaying=true;isStalled=false;lastDrawTime=0;finalPhaseActive=false;finalPhaseStartTime=null;finalPhaseScheduleDirty=false;playbackHasBegun=false;skipDrawingForCurrentFrame=false;pendingInitialSync=false;finalPhaseVposOverrides=new Map;frameId=null;videoFrameHandle=null;resizeObserver=null;resizeObserverTarget=null;isResizeObserverAvailable=typeof ResizeObserver<"u";cleanupTasks=[];commentSequence=0;epochId=0;eventHooks;lastSnapshotEmitTime=0;snapshotEmitThrottleMs=1e3;lastPlayResumeTime=0;playResumeSeekIgnoreDurationMs=500;lastVideoSource=null;rebuildNgMatchers(){cn.call(this);}constructor(e=null,n=void 0){let r,i;if(Ri(e))r=le({...e}),i=n??{};else {const s=e??n??{};i=typeof s=="object"?s:{},r=le(ln());}this._settings=le(r),this.timeSource=i.timeSource??Gt(),this.animationFrameProvider=i.animationFrameProvider??Pi(this.timeSource),this.createCanvasElement=i.createCanvasElement??Fi(),this.commentDependencies={timeSource:this.timeSource,settingsVersion:this.settingsVersion},this.log=Kt(i.loggerNamespace??"CommentRenderer"),this.eventHooks=i.eventHooks??{},this.handleAnimationFrame=this.handleAnimationFrame.bind(this),this.handleVideoFrame=this.handleVideoFrame.bind(this),this.rebuildNgMatchers(),i.debug&&Br(i.debug);}get settings(){return this._settings}set settings(e){this._settings=le(e),this.settingsVersion+=1,this.commentDependencies.settingsVersion=this.settingsVersion,this.rebuildNgMatchers();}getVideoElement(){return this.videoElement}getCurrentVideoSource(){const e=this.videoElement;if(!e)return null;if(typeof e.currentSrc=="string"&&e.currentSrc.length>0)return e.currentSrc;const n=e.getAttribute("src");if(n&&n.length>0)return n;const r=e.querySelector("source[src]");return r&&typeof r.src=="string"?r.src:null}getCommentsSnapshot(){return [...this.comments]}}Wi(_);Xi(_);Qi(_);rs(_);os(_);bs(_);Ms(_);Rs(_);zs(_);Ks(_);ta(_);ha(_);ga(_);Sa(_);Va(_);La(_);const q=()=>({...ln(),shadowIntensity:"strong",autoSearchEnabled:true}),Pa="v7.3.13";var Fa=typeof GM_addStyle<"u"?GM_addStyle:void 0,j=typeof GM_getValue<"u"?GM_getValue:void 0,K=typeof GM_setValue<"u"?GM_setValue:void 0,Ra=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0;const Et="settings",Tt="currentVideo",kt="lastDanimeIds",_t="playbackSettings",Vt="manualSearchSettings",Da=t=>({...t,ngWords:[...t.ngWords],ngRegexps:[...t.ngRegexps]}),J={fixedModeEnabled:false,fixedRate:1.11},ce=t=>({fixedModeEnabled:t.fixedModeEnabled,fixedRate:t.fixedRate});class Be{constructor(e){this.notifier=e,this.settings=q(),this.currentVideo=null,this.loadSettings(),this.currentVideo=this.loadVideoData(),this.playbackSettings=ce(J),this.loadPlaybackSettings();}settings;currentVideo;observers=new Set;playbackSettings;playbackObservers=new Set;getSettings(){return Da(this.settings)}loadSettings(){try{const e=j(Et,null);if(!e)return this.settings=q(),this.settings;if(typeof e=="string"){const n=JSON.parse(e);this.settings={...q(),...n,ngWords:Array.isArray(n?.ngWords)?[...n.ngWords]:[],ngRegexps:Array.isArray(n?.ngRegexps)?[...n.ngRegexps]:[]};}else this.settings={...q(),...e,ngWords:Array.isArray(e.ngWords)?[...e.ngWords]:[],ngRegexps:Array.isArray(e.ngRegexps)?[...e.ngRegexps]:[]};return this.notifyObservers(),this.settings}catch(e){return console.error("[SettingsManager] 設定の読み込みに失敗しました",e),this.notify("設定の読み込みに失敗しました","error"),this.settings=q(),this.settings}}getPlaybackSettings(){return ce(this.playbackSettings)}loadPlaybackSettings(){try{const e=j(_t,null);if(!e)return this.playbackSettings=ce(J),this.notifyPlaybackObservers(),this.playbackSettings;if(typeof e=="string"){const n=JSON.parse(e);this.playbackSettings={fixedModeEnabled:typeof n.fixedModeEnabled=="boolean"?n.fixedModeEnabled:J.fixedModeEnabled,fixedRate:typeof n.fixedRate=="number"?n.fixedRate:J.fixedRate};}else this.playbackSettings={fixedModeEnabled:e.fixedModeEnabled,fixedRate:e.fixedRate};return this.notifyPlaybackObservers(),this.playbackSettings}catch(e){return console.error("[SettingsManager] 再生設定の読み込みに失敗しました",e),this.notify("再生設定の読み込みに失敗しました","error"),this.playbackSettings=ce(J),this.notifyPlaybackObservers(),this.playbackSettings}}updatePlaybackSettings(e){return this.playbackSettings={...this.playbackSettings,...e},this.savePlaybackSettings()}savePlaybackSettings(){try{return K(_t,JSON.stringify(this.playbackSettings)),this.notifyPlaybackObservers(),!0}catch(e){return console.error("[SettingsManager] 再生設定の保存に失敗しました",e),this.notify("再生設定の保存に失敗しました","error"),false}}saveSettings(){const e=this.persistSettings();return e&&this.notify("設定を保存しました","success"),e}updateSettings(e){return this.settings={...this.settings,...e,ngWords:e.ngWords?[...e.ngWords]:[...this.settings.ngWords??[]],ngRegexps:e.ngRegexps?[...e.ngRegexps]:[...this.settings.ngRegexps??[]]},this.persistSettings()}persistSettings(){try{return K(Et,JSON.stringify(this.settings)),this.notifyObservers(),!0}catch(e){return console.error("[SettingsManager] 設定の保存に失敗しました",e),this.notify("設定の保存に失敗しました","error"),false}}addObserver(e){this.observers.add(e);}removeObserver(e){this.observers.delete(e);}addPlaybackObserver(e){this.playbackObservers.add(e);try{e(this.getPlaybackSettings());}catch(n){console.error("[SettingsManager] 再生設定の登録通知でエラー",n);}}removePlaybackObserver(e){this.playbackObservers.delete(e);}notifyObservers(){const e=this.getSettings();for(const n of this.observers)try{n(e);}catch(r){console.error("[SettingsManager] 設定変更通知でエラー",r);}}notifyPlaybackObservers(){const e=this.getPlaybackSettings();for(const n of this.playbackObservers)try{n(e);}catch(r){console.error("[SettingsManager] 再生設定通知でエラー",r);}}loadVideoData(){try{return j(Tt,null)??null}catch(e){return console.error("[SettingsManager] 動画データの読み込みに失敗しました",e),this.notify("動画データの読み込みに失敗しました","error"),null}}saveVideoData(e,n){try{const r={videoId:n.videoId,title:n.title,viewCount:n.viewCount,commentCount:n.commentCount,mylistCount:n.mylistCount,postedAt:n.postedAt,thumbnail:n.thumbnail,owner:n.owner??null,channel:n.channel??null};return K(Tt,r),this.currentVideo=r,!0}catch(r){return console.error("[SettingsManager] 動画データの保存に失敗しました",r),this.notify("動画データの保存に失敗しました","error"),false}}getCurrentVideo(){return this.currentVideo?{...this.currentVideo}:null}saveLastDanimeIds(e){try{return K(kt,e),!0}catch(n){return console.error("[SettingsManager] saveLastDanimeIds failed",n),this.notify("ID情報の保存に失敗しました","error"),false}}loadLastDanimeIds(){try{return j(kt,null)??null}catch(e){return console.error("[SettingsManager] loadLastDanimeIds failed",e),this.notify("ID情報の読込に失敗しました","error"),null}}saveManualSearchSettings(e){try{return K(Vt,e),!0}catch(n){return console.error("[SettingsManager] saveManualSearchSettings failed",n),this.notify("検索設定の保存に失敗しました","error"),false}}loadManualSearchSettings(){try{return j(Vt,null)??null}catch(e){return console.error("[SettingsManager] loadManualSearchSettings failed",e),this.notify("検索設定の読込に失敗しました","error"),null}}notify(e,n="info"){this.notifier?.show(e,n);}}const Ha=new Set(["INPUT","TEXTAREA"]),we=t=>t.length===1?t.toUpperCase():t,za=t=>t?`${t}+`:"";class un{shortcuts=new Map;boundHandler;isEnabled=true;isListening=false;constructor(){this.boundHandler=this.handleKeyDown.bind(this);}addShortcut(e,n,r){const i=this.createShortcutKey(we(e),n);this.shortcuts.set(i,r);}removeShortcut(e,n){const r=this.createShortcutKey(we(e),n);this.shortcuts.delete(r);}startListening(){this.isListening||(document.addEventListener("keydown",this.boundHandler,false),this.isListening=true);}stopListening(){this.isListening&&(document.removeEventListener("keydown",this.boundHandler,false),this.isListening=false);}setEnabled(e){this.isEnabled=e;}createShortcutKey(e,n){return `${za(n)}${e}`}extractModifier(e){const n=[];return e.ctrlKey&&n.push("Ctrl"),e.altKey&&n.push("Alt"),e.shiftKey&&n.push("Shift"),e.metaKey&&n.push("Meta"),n.length>0?n.join("+"):null}handleKeyDown(e){if(!this.isEnabled)return;const r=e.target?.tagName??"";if(Ha.has(r))return;const i=this.extractModifier(e),s=this.createShortcutKey(we(e.key),i),a=this.shortcuts.get(s);a&&(e.preventDefault(),a());}}const Oa=P("dAnime:CommentRenderer"),It=t=>({loggerNamespace:"dAnime:CommentRenderer",...t??{}}),Na=t=>{if(!t||typeof t!="object")return  false;const e=t;return typeof e.commentColor=="string"&&typeof e.commentOpacity=="number"&&typeof e.isCommentVisible=="boolean"};class te{renderer;keyboardHandler=null;constructor(e,n){Na(e)||e===null?this.renderer=new _(e??null,It(n)):this.renderer=new _(It(e));}get settings(){return this.renderer.settings}set settings(e){this.renderer.settings=e;}initialize(e){this.renderer.initialize(e),this.setupKeyboardShortcuts();}addComment(e,n,r=[]){return this.renderer.addComment(e,n,r)}clearComments(){this.renderer.clearComments();}resetState(){this.renderer.resetState();}destroy(){this.teardownKeyboardShortcuts(),this.renderer.destroy();}updateSettings(e){this.renderer.settings=e;}getVideoElement(){return this.renderer.getVideoElement()}getCurrentVideoSource(){return this.renderer.getCurrentVideoSource()}getCommentsSnapshot(){return this.renderer.getCommentsSnapshot()}isNGComment(e){return this.renderer.isNGComment(e)}resize(e,n){this.renderer.resize(e,n);}setCommentVisibility(e){this.renderer.setCommentVisibility(e);}setupKeyboardShortcuts(){this.teardownKeyboardShortcuts();const e=new un;e.addShortcut("C","Shift",()=>{try{const n=!this.renderer.settings.isCommentVisible;this.renderer.setCommentVisibility(n),this.syncGlobalSettings(this.renderer.settings);}catch(n){Oa.error("CommentRenderer.keyboardShortcut",n);}}),e.startListening(),this.keyboardHandler=e;}teardownKeyboardShortcuts(){this.keyboardHandler?.stopListening(),this.keyboardHandler=null;}syncGlobalSettings(e){window.dAniRenderer?.settingsManager?.updateSettings(e);}}class qe{shadowRoot=null;container=null;createShadowDOM(e,n={mode:"closed"}){if(!e)throw new Error("Host element is required for shadow DOM creation");return this.shadowRoot=e.attachShadow(n),this.container=document.createElement("div"),this.shadowRoot.appendChild(this.container),this.shadowRoot}addStyles(e){if(!this.shadowRoot)throw new Error("Shadow root not initialized");const n=document.createElement("style");n.textContent=e,this.shadowRoot.appendChild(n);}querySelector(e){return this.shadowRoot?this.shadowRoot.querySelector(e):null}querySelectorAll(e){return this.shadowRoot?this.shadowRoot.querySelectorAll(e):document.createDocumentFragment().childNodes}setHTML(e){if(!this.container)throw new Error("Container not initialized");this.container.innerHTML=e;}destroy(){this.shadowRoot?.host&&this.shadowRoot.host.remove(),this.shadowRoot=null,this.container=null;}}const $a=`\r
/* 基本カラーパレット - ダークモード */\r
:host {\r
            ...
            <div class="video-card__info">
              ...
              <div class="video-card__meta-row">
                <div class="video-card__id" title="動画ID">
                  <span class="video-card__id-icon" aria-hidden="true">${yo}</span>
                  <span class="sr-only">動画ID</span>
                  <span id="currentVideoId">${r?.videoId??"未設定"}</span>
                </div>
                <div class="video-card__date" title="投稿日">
                  <span class="video-card__date-icon" aria-hidden="true">${wo}</span>
              ...
              <div class="video-card__stats">
                ...
                <div class="video-card__stat" title="マイリスト数">
                  <span class="video-card__stat-icon" aria-hidden="true">${xo}</span>
    ...
    `}setupEventListeners(){this.setupModalControls(),this.setupModalTabs(),this.setupAutoSearchToggle(),this.setupNgControls(),this.setupSaveButton(),this.setupSearch(),this.setupTooltipBadges();}setupModalControls(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick);const e=this.createOrUpdateFab(),n=this.queryModalElement(S.settingsModal),r=this.queryModalElement(S.closeSettingsModal),i=this.queryModalElement(S.modalOverlay);this.modalElement=n??null,this.closeButtonElement=r??null,this.overlayElement=i??null,!(!n||!r||!i||!e)&&(this.fabElement?.removeEventListener("click",this.handleFabClick),e.addEventListener("click",this.handleFabClick),e.setAttribute("aria-controls",n.id),e.setAttribute("aria-haspopup","dialog"),e.setAttribute("aria-expanded","false"),this.fabElement=e,r.addEventListener("click",this.handleCloseClick),i.addEventListener("click",this.handleOverlayClick),this.shadowRoot?.addEventListener("keydown",s=>{const a=s;a.key==="Escape"&&!this.modalElement?.classList.contains("hidden")&&(a.preventDefault(),this.closeSettingsModal());}),this.applySettingsToUI());}setupModalTabs(){const e=Array.from(this.queryModalSelectorAll(S.modalTabs)),n=Array.from(this.queryModalSelectorAll(S.modalPane));if(e.length===0||n.length===0)return;const r=i=>{e.forEach(s=>{const o=this.toModalTabKey(s.dataset.tab)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-selected",String(o)),s.setAttribute("tabindex",o?"0":"-1");}),n.forEach(s=>{const o=this.toModalTabKey(s.dataset.pane)===i;s.classList.toggle("is-active",o),s.setAttribute("aria-hidden",String(!o));}),this.activeTab=i;};e.forEach(i=>{i.addEventListener("click",()=>{const s=this.toModalTabKey(i.dataset.tab);s&&r(s);}),i.addEventListener("keydown",s=>{const a=s;if(a.key!=="ArrowRight"&&a.key!=="ArrowLeft")return;a.preventDefault();const o=this.toModalTabKey(i.dataset.tab);if(!o)return;const l=a.key==="ArrowRight"?1:-1,d=(ee.indexOf(o)+l+ee.length)%ee.length,h=ee[d];r(h),e.find(u=>this.toModalTabKey(u.dataset.tab)===h)?.focus({preventScroll:true});});}),r(this.activeTab);}openSettingsModal(e=true){!this.modalElement||!this.fabElement||(this.modalElement.classList.remove("hidden"),this.modalElement.setAttribute("aria-hidden","false"),this.fabElement.setAttribute("aria-expanded","true"),e&&this.queryModalElement(`${S.modalTabs}.is-active`)?.focus({preventScroll:true}));}closeSettingsModal(){!this.modalElement||!this.fabElement||(this.modalElement.classList.add("hidden"),this.modalElement.setAttribute("aria-hidden","true"),this.fabElement.setAttribute("aria-expanded","false"),this.fabElement?.isConnected&&this.fabElement.focus({preventScroll:true}));}toModalTabKey(e){return e&&ee.includes(e)?e:null}setupAutoSearchToggle(){const e=this.queryModalElement(S.autoSearchToggle),n=this.queryModalElement(S.autoSearchOptionRow);if(!e||!n)return;const r=()=>{this.settings.autoSearchEnabled=!this.settings.autoSearchEnabled,this.updateAutoSearchToggleState(),this.updateSearchSectionNote(),this.settingsManager.updateSettings(this.settings),b.show(this.settings.autoSearchEnabled?"自動検索を有効にしました":"自動検索を無効にしました（手動設定モード）","success");};n.addEventListener("click",i=>{i.target.closest(".playback-option__toggle")||r();}),n.addEventListener("keydown",i=>{(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),r());}),e.addEventListener("change",()=>{r();}),this.updateAutoSearchToggleState();}updateAutoSearchToggleState(){const e=this.settings.autoSearchEnabled,n=this.queryModalElement(S.autoSearchToggle),r=this.queryModalElement(S.autoSearchOptionRow),i=r?.querySelector(".playback-option__icon-wrapper");n&&(n.checked=e),r&&(r.classList.toggle("playback-option--active",e),r.setAttribute("aria-pressed",e?"true":"false")),i&&i.classList.toggle("playback-option__icon-wrapper--active",e);}buildAutoSearchTooltipHtml(){return this.settings.autoSearchEnabled?`<strong style="color:#7F5AF0;">自動設定機能が有効です</strong><br>
      ...
      <div class="search-result-item">
        ...
        <div class="search-result-info">
          ...
          <a href="${Lt.watchBase}/${e.videoId}" target="_blank" rel="noopener"
