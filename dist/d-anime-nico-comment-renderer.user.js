...
(function () {
  ...
  const tt={debug:"debug",info:"info",warn:"warn",error:"error"},S=r=>{const t=`[${r}]`,e={};return Object.keys(tt).forEach(n=>{const i=tt[n];e[n]=(...o)=>{(console[i]??console.log)(t,...o);};}),e};function B(){return typeof unsafeWindow<"u"?unsafeWindow:window}const Nt={commentColor:"#FFFFFF",commentOpacity:.75,isCommentVisible:true,ngWords:[],ngRegexps:[]},z=Nt,v=()=>({...z,ngWords:[...z.ngWords],ngRegexps:[...z.ngRegexps]});var Ft=typeof GM_addStyle<"u"?GM_addStyle:void 0,N=typeof GM_getValue<"u"?GM_getValue:void 0,F=typeof GM_setValue<"u"?GM_setValue:void 0,Dt=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0;const et="settings",nt="currentVideo",rt="lastDanimeIds",Ot=r=>({...r,ngWords:[...r.ngWords],ngRegexps:[...r.ngRegexps]});class H{constructor(t){this.notifier=t,this.settings=v(),this.currentVideo=null,this.loadSettings(),this.currentVideo=this.loadVideoData();}settings;currentVideo;observers=new Set;getSettings(){return Ot(this.settings)}loadSettings(){try{const t=N(et,null);if(!t)return this.settings=v(),this.settings;if(typeof t=="string"){const e=JSON.parse(t);this.settings={...v(),...e,ngWords:Array.isArray(e?.ngWords)?[...e.ngWords]:[],ngRegexps:Array.isArray(e?.ngRegexps)?[...e.ngRegexps]:[]};}else this.settings={...v(),...t,ngWords:Array.isArray(t.ngWords)?[...t.ngWords]:[],ngRegexps:Array.isArray(t.ngRegexps)?[...t.ngRegexps]:[]};return this.notifyObservers(),this.settings}catch(t){return console.error("[SettingsManager] 設定の読み込みに失敗しました",t),this.notify("設定の読み込みに失敗しました","error"),this.settings=v(),this.settings}}saveSettings(){try{return F(et,JSON.stringify(this.settings)),this.notifyObservers(),this.notify("設定を保存しました","success"),!0}catch(t){return console.error("[SettingsManager] 設定の保存に失敗しました",t),this.notify("設定の保存に失敗しました","error"),false}}updateSettings(t){return this.settings={...this.settings,...t,ngWords:t.ngWords?[...t.ngWords]:[...this.settings.ngWords],ngRegexps:t.ngRegexps?[...t.ngRegexps]:[...this.settings.ngRegexps]},this.saveSettings()}addObserver(t){this.observers.add(t);}removeObserver(t){this.observers.delete(t);}notifyObservers(){const t=this.getSettings();for(const e of this.observers)try{e(t);}catch(n){console.error("[SettingsManager] 設定変更通知でエラー",n);}}loadVideoData(){try{return N(nt,null)??null}catch(t){return console.error("[SettingsManager] 動画データの読み込みに失敗しました",t),this.notify("動画データの読み込みに失敗しました","error"),null}}saveVideoData(t,e){try{const n={videoId:e.videoId,title:e.title,viewCount:e.viewCount,commentCount:e.commentCount,mylistCount:e.mylistCount,postedAt:e.postedAt,thumbnail:e.thumbnail,owner:e.owner??null,channel:e.channel??null};return F(nt,n),this.currentVideo=n,!0}catch(n){return console.error("[SettingsManager] 動画データの保存に失敗しました",n),this.notify("動画データの保存に失敗しました","error"),false}}getCurrentVideo(){return this.currentVideo?{...this.currentVideo}:null}saveLastDanimeIds(t){try{return F(rt,t),!0}catch(e){return console.error("[SettingsManager] saveLastDanimeIds failed",e),this.notify("ID情報の保存に失敗しました","error"),false}}loadLastDanimeIds(){try{return N(rt,null)??null}catch(t){return console.error("[SettingsManager] loadLastDanimeIds failed",t),this.notify("ID情報の読込に失敗しました","error"),null}}notify(t,e="info"){this.notifier?.show(t,e);}}const D=S("dAnime:Comment");class Pt{text;vpos;commands;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily="Arial";opacity;isActive=false;hasShown=false;isPaused=false;lastUpdateTime=0;reservationWidth=0;constructor(t,e,n=[],i){if(typeof t!="string")throw new Error("Comment text must be a string");if(!Number.isFinite(e)||e<0)throw new Error("Comment vpos must be a non-negative number");this.text=t,this.vpos=e,this.commands=Array.isArray(n)?n:[],this.color=i.commentColor,this.opacity=i.commentOpacity;}prepare(t,e,n){try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(e)||!Number.isFinite(n))throw new Error("Canvas dimensions must be numbers");this.fontSize=Math.max(24,Math.floor(n*.05)),t.font=`${this.fontSize}px ${this.fontFamily}`,this.width=t.measureText(this.text).width,this.height=this.fontSize;const i=t.measureText("あ".repeat(150)).width;this.reservationWidth=Math.min(i,this.width*5),this.x=e,this.baseSpeed=(e+this.reservationWidth)/720,this.speed=this.baseSpeed,this.lastUpdateTime=performance.now();}catch(i){throw D.error("Comment.prepare",i,{text:this.text,canvasWidth:e,canvasHeight:n,hasContext:!!t}),i}}update(t=1,e=false){try{if(!this.isActive||this.isPaused)return;const n=performance.now(),i=(n-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*t,this.x-=this.speed*i,this.x<-this.width&&(this.isActive=!1),this.lastUpdateTime=n,this.isPaused=e;}catch(n){D.error("Comment.update",n,{text:this.text,playbackRate:t,isPaused:e,isActive:this.isActive});}}draw(t,e=null){try{if(!this.isActive||!t)return;t.save(),t.globalAlpha=this.opacity,t.font=`${this.fontSize}px ${this.fontFamily}`;const n=e??this.x,i=this.y+this.fontSize;t.strokeStyle="#000000",t.lineWidth=Math.max(3,this.fontSize/8),t.lineJoin="round",t.strokeText(this.text,n,i),t.fillStyle=this.color,t.fillText(this.text,n,i),t.restore();}catch(n){D.error("Comment.draw",n,{text:this.text,isActive:this.isActive,hasContext:!!t,interpolatedX:e});}}}const $t=new Set(["INPUT","TEXTAREA"]),O=r=>r.length===1?r.toUpperCase():r,Wt=r=>r?`${r}+`:"";class vt{shortcuts=new Map;boundHandler;isEnabled=true;isListening=false;constructor(){this.boundHandler=this.handleKeyDown.bind(this);}addShortcut(t,e,n){const i=this.createShortcutKey(O(t),e);this.shortcuts.set(i,n);}removeShortcut(t,e){const n=this.createShortcutKey(O(t),e);this.shortcuts.delete(n);}startListening(){this.isListening||(document.addEventListener("keydown",this.boundHandler,false),this.isListening=true);}stopListening(){this.isListening&&(document.removeEventListener("keydown",this.boundHandler,false),this.isListening=false);}setEnabled(t){this.isEnabled=t;}createShortcutKey(t,e){return `${Wt(e)}${t}`}extractModifier(t){const e=[];return t.ctrlKey&&e.push("Ctrl"),t.altKey&&e.push("Alt"),t.shiftKey&&e.push("Shift"),t.metaKey&&e.push("Meta"),e.length>0?e.join("+"):null}handleKeyDown(t){if(!this.isEnabled)return;const n=t.target?.tagName??"";if($t.has(n))return;const i=this.extractModifier(t),o=this.createShortcutKey(O(t.key),i),s=this.shortcuts.get(o);s&&(t.preventDefault(),s());}}var qt=(function(){if(typeof document>"u")return "transform";for(var r=["oTransform","msTransform","mozTransform","webkitTransform","transform"],t=document.createElement("div").style,e=0;e<r.length;e++)if(r[e]in t)return r[e];return "transform"})();function Bt(r){var t=document.createElement("div");if(t.style.cssText="position:absolute;",typeof r.render=="function"){var e=r.render();if(e instanceof HTMLElement)return t.appendChild(e),t}if(t.textContent=r.text,r.style)for(var n in r.style)t.style[n]=r.style[n];return t}function Ht(){var r=document.createElement("div");return r.style.cssText="overflow:hidden;white-space:nowrap;transform:translateZ(0);",r}function Ut(r){for(var t=r.lastChild;t;)r.removeChild(t),t=r.lastChild;}function Gt(r,t,e){r.style.width=t+"px",r.style.height=e+"px";}function jt(){}function Kt(r,t){var e=document.createDocumentFragment(),n=0,i=null;for(n=0;n<t.length;n++)i=t[n],i.node=i.node||Bt(i),e.appendChild(i.node);for(t.length&&r.appendChild(e),n=0;n<t.length;n++)i=t[n],i.width=i.width||i.node.offsetWidth,i.height=i.height||i.node.offsetHeight;}function Yt(r,t){t.node.style[qt]="translate("+t.x+"px,"+t.y+"px)";}function Xt(r,t){r.removeChild(t.node),this.media||(t.node=null);}var Jt={name:"dom",init:Ht,clear:Ut,resize:Gt,framing:jt,setup:Kt,render:Yt,remove:Xt},w=typeof window<"u"&&window.devicePixelRatio||1,P=Object.create(null);function Zt(r,t){if(P[r])return P[r];var e=12,n=/(\d+(?:\.\d+)?)(px|%|em|rem)(?:\s*\/\s*(\d+(?:\.\d+)?)(px|%|em|rem)?)?/,i=r.match(n);if(i){var o=i[1]*1||10,s=i[2],a=i[3]*1||1.2,c=i[4];s==="%"&&(o*=t.container/100),s==="em"&&(o*=t.container),s==="rem"&&(o*=t.root),c==="px"&&(e=a),c==="%"&&(e=o*a/100),c==="em"&&(e=o*a),c==="rem"&&(e=t.root*a),c===void 0&&(e=o*a);}return P[r]=e,e}function Qt(r,t){if(typeof r.render=="function"){var e=r.render();if(e instanceof HTMLCanvasElement)return r.width=e.width,r.height=e.height,e}var n=document.createElement("canvas"),i=n.getContext("2d"),o=r.style||{};o.font=o.font||"10px sans-serif",o.textBaseline=o.textBaseline||"bottom";var s=o.lineWidth*1;s=s>0&&s!==1/0?Math.ceil(s):!!o.strokeStyle*1,i.font=o.font,r.width=r.width||Math.max(1,Math.ceil(i.measureText(r.text).width)+s*2),r.height=r.height||Math.ceil(Zt(o.font,t))+s*2,n.width=r.width*w,n.height=r.height*w,i.scale(w,w);for(var a in o)i[a]=o[a];var c=0;switch(o.textBaseline){case "top":case "hanging":c=s;break;case "middle":c=r.height>>1;break;default:c=r.height-s;}return o.strokeStyle&&i.strokeText(r.text,s,c),i.fillText(r.text,s,c),n}function it(r){return window.getComputedStyle(r,null).getPropertyValue("font-size").match(/(.+)px/)[1]*1}function te(r){var t=document.createElement("canvas");return t.context=t.getContext("2d"),t._fontSize={root:it(document.getElementsByTagName("html")[0]),container:it(r)},t}function ee(r,t){r.context.clearRect(0,0,r.width,r.height);for(var e=0;e<t.length;e++)t[e].canvas=null;}function ne(r,t,e){r.width=t*w,r.height=e*w,r.style.width=t+"px",r.style.height=e+"px";}function re(r){r.context.clearRect(0,0,r.width,r.height);}function ie(r,t){for(var e=0;e<t.length;e++){var n=t[e];n.canvas=Qt(n,r._fontSize);}}function oe(r,t){r.context.drawImage(t.canvas,t.x*w,t.y*w);}function se(r,t){t.canvas=null;}var ae={name:"canvas",init:te,clear:ee,resize:ne,framing:re,setup:ie,render:oe,remove:se},ot=(function(){if(typeof window<"u"){var r=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame;if(r)return r.bind(window)}return function(t){return setTimeout(t,50/3)}})(),ce=(function(){if(typeof window<"u"){var r=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame;if(r)return r.bind(window)}return clearTimeout})();function wt(r,t,e){for(var n=0,i=0,o=r.length;i<o-1;)n=i+o>>1,e>=r[n][t]?i=n:o=n;return r[i]&&e<r[i][t]?i:o}function St(r){return /^(ltr|top|bottom)$/i.test(r)?r.toLowerCase():"rtl"}function _(){var r=9007199254740991;return [{range:0,time:-r,width:r,height:0},{range:r,time:r,width:0,height:0}]}function Ct(r){r.ltr=_(),r.rtl=_(),r.top=_(),r.bottom=_();}function M(){return typeof window.performance<"u"&&window.performance.now?window.performance.now():Date.now()}function le(r){var t=this,e=this.media?this.media.currentTime:M()/1e3,n=this.media?this.media.playbackRate:1;function i(y,f){if(f.mode==="top"||f.mode==="bottom")return e-y.time<t._.duration;var A=t._.width+y.width,E=A*(e-y.time)*n/t._.duration;if(y.width>E)return  true;var k=t._.duration+y.time-e,Z=t._.width+f.width,V=t.media?f.time:f._utc,Q=Z*(e-V)*n/t._.duration,Mt=t._.width-Q,zt=t._.duration*Mt/(t._.width+f.width);return k>zt}for(var o=this._.space[r.mode],s=0,a=0,c=1;c<o.length;c++){var l=o[c],d=r.height;if((r.mode==="top"||r.mode==="bottom")&&(d+=l.height),l.range-l.height-o[s].range>=d){a=c;break}i(l,r)&&(s=c);}var h=o[s].range,m={range:h+r.height,time:this.media?r.time:r._utc,width:r.width,height:r.height};return o.splice(s+1,a-s-1,m),r.mode==="bottom"?this._.height-r.height-h%this._.height:h%(this._.height-r.height)}function de(r,t,e,n){return function(i){r(this._.stage);var o=i||M(),s=o/1e3,a=this.media?this.media.currentTime:s,c=this.media?this.media.playbackRate:1,l=null,d=0,h=0;for(h=this._.runningList.length-1;h>=0;h--)l=this._.runningList[h],d=this.media?l.time:l._utc,a-d>this._.duration&&(n(this._.stage,l),this._.runningList.splice(h,1));for(var m=[];this._.position<this.comments.length&&(l=this.comments[this._.position],d=this.media?l.time:l._utc,!(d>=a));){if(a-d>this._.duration){++this._.position;continue}this.media&&(l._utc=s-(this.media.currentTime-l.time)),m.push(l),++this._.position;}for(t(this._.stage,m),h=0;h<m.length;h++)l=m[h],l.y=le.call(this,l),this._.runningList.push(l);for(h=0;h<this._.runningList.length;h++){l=this._.runningList[h];var y=this._.width+l.width,f=y*(s-l._utc)*c/this._.duration;l.mode==="ltr"&&(l.x=f-l.width),l.mode==="rtl"&&(l.x=this._.width-f),(l.mode==="top"||l.mode==="bottom")&&(l.x=this._.width-l.width>>1),e(this._.stage,l);}}}function U(){if(!this._.visible||!this._.paused)return this;if(this._.paused=false,this.media)for(var r=0;r<this._.runningList.length;r++){var t=this._.runningList[r];t._utc=M()/1e3-(this.media.currentTime-t.time);}var e=this,n=de(this._.engine.framing.bind(this),this._.engine.setup.bind(this),this._.engine.render.bind(this),this._.engine.remove.bind(this));function i(o){n.call(e,o),e._.requestID=ot(i);}return this._.requestID=ot(i),this}function G(){return !this._.visible||this._.paused?this:(this._.paused=true,ce(this._.requestID),this._.requestID=0,this)}function j(){if(!this.media)return this;this.clear(),Ct(this._.space);var r=wt(this.comments,"time",this.media.currentTime);return this._.position=Math.max(0,r-1),this}function he(r){r.play=U.bind(this),r.pause=G.bind(this),r.seeking=j.bind(this),this.media.addEventListener("play",r.play),this.media.addEventListener("pause",r.pause),this.media.addEventListener("playing",r.play),this.media.addEventListener("waiting",r.pause),this.media.addEventListener("seeking",r.seeking);}function ue(r){this.media.removeEventListener("play",r.play),this.media.removeEventListener("pause",r.pause),this.media.removeEventListener("playing",r.play),this.media.removeEventListener("waiting",r.pause),this.media.removeEventListener("seeking",r.seeking),r.play=null,r.pause=null,r.seeking=null;}function pe(r){this._={},this.container=r.container||document.createElement("div"),this.media=r.media,this._.visible=true,this.engine=(r.engine||"DOM").toLowerCase(),this._.engine=this.engine==="canvas"?ae:Jt,this._.requestID=0,this._.speed=Math.max(0,r.speed)||144,this._.duration=4,this.comments=r.comments||[],this.comments.sort(function(e,n){return e.time-n.time});for(var t=0;t<this.comments.length;t++)this.comments[t].mode=St(this.comments[t].mode);return this._.runningList=[],this._.position=0,this._.paused=true,this.media&&(this._.listener={},he.call(this,this._.listener)),this._.stage=this._.engine.init(this.container),this._.stage.style.cssText+="position:relative;pointer-events:none;",this.resize(),this.container.appendChild(this._.stage),this._.space={},Ct(this._.space),(!this.media||!this.media.paused)&&(j.call(this),U.call(this)),this}function me(){if(!this.container)return this;G.call(this),this.clear(),this.container.removeChild(this._.stage),this.media&&ue.call(this,this._.listener);for(var r in this)Object.prototype.hasOwnProperty.call(this,r)&&(this[r]=null);return this}var T=["mode","time","text","render","style"];function ge(r){if(!r||Object.prototype.toString.call(r)!=="[object Object]")return this;for(var t={},e=0;e<T.length;e++)r[T[e]]!==void 0&&(t[T[e]]=r[T[e]]);if(t.text=(t.text||"").toString(),t.mode=St(t.mode),t._utc=M()/1e3,this.media){var n=0;t.time===void 0?(t.time=this.media.currentTime,n=this._.position):(n=wt(this.comments,"time",t.time),n<this._.position&&(this._.position+=1)),this.comments.splice(n,0,t);}else this.comments.push(t);return this}function fe(){return this._.visible?this:(this._.visible=true,this.media&&this.media.paused?this:(j.call(this),U.call(this),this))}function be(){return this._.visible?(G.call(this),this.clear(),this._.visible=false,this):this}function ye(){return this._.engine.clear(this._.stage,this._.runningList),this._.runningList=[],this}function xe(){return this._.width=this.container.offsetWidth,this._.height=this.container.offsetHeight,this._.engine.resize(this._.stage,this._.width,this._.height),this._.duration=this._.width/this._.speed,this}var ve={get:function(){return this._.speed},set:function(r){return typeof r!="number"||isNaN(r)||!isFinite(r)||r<=0?this._.speed:(this._.speed=r,this._.width&&(this._.duration=this._.width/r),r)}};function C(r){r&&pe.call(this,r);}C.prototype.destroy=function(){return me.call(this)};C.prototype.emit=function(r){return ge.call(this,r)};C.prototype.show=function(){return fe.call(this)};C.prototype.hide=function(){return be.call(this)};C.prototype.clear=function(){return ye.call(this)};C.prototype.resize=function(){return xe.call(this)};Object.defineProperty(C.prototype,"speed",ve);const x=S("dAnime:CommentRenderer"),L=r=>r*1e3,we="bold",Se="'MS PGothic', 'sans-serif'",st=24,Ce="1px 1px 2px #000, -1px -1px 2px #000, 1px -1px 2px #000, -1px 1px 2px #000",at=2e3,ct=16,Ee=18,ke=60,lt=1.2,dt=["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"],ht=()=>{const r=document;return r.fullscreenElement??r.webkitFullscreenElement??r.mozFullScreenElement??r.msFullscreenElement??null};class Et{_settings;danmaku=null;allComments=[];lastEmittedIndex=-1;canvas=null;videoElement=null;currentTime=0;duration=0;finalPhaseActive=false;keyboardHandler=null;sizeObserver=null;isResizeObserverAvailable;container=null;fullscreenEventsAttached=false;scrollListenerAttached=false;cachedFontSizePx=st;constructor(t){this._settings=t?{...t}:v(),this.isResizeObserverAvailable=typeof ResizeObserver<"u";}get settings(){return this._settings}set settings(t){this._settings={...t};}initialize(t){try{x.debug("initialize:start",{readyState:t.readyState,duration:t.duration}),this.danmaku&&this.destroy(),this.videoElement=t,this.duration=L(t.duration),x.info("videoRenderer:boundVideo",{src:this.resolveVideoSource(t),videoId:t.dataset?.videoId??null,durationMs:this.duration});const e=document.createElement("div");e.style.position="absolute",e.style.pointerEvents="none",e.style.zIndex="1000",e.style.top="0px",e.style.left="0px";const n=t.getBoundingClientRect();e.style.width=`${n.width}px`,e.style.height=`${n.height}px`;const i=t.parentElement??document.body;i.style.position=i.style.position||"relative",i.appendChild(e),this.container=e,this.danmaku=new C({container:e,media:t,comments:[],engine:"canvas",speed:144}),this.canvas=e.querySelector("canvas"),this.setupVideoEventListeners(t),this.setupKeyboardShortcuts(),this.setupResizeListener(e,t),x.debug("initialize:completed");}catch(e){throw x.error("CommentRenderer.initialize",e),e}}addComment(t,e,n){if(this.isNGComment(t)||this.allComments.some(s=>s.text===t&&s.time===e/1e3))return null;const o={text:t,time:e/1e3,style:this.createCommentStyle(),commands:n?[...n]:void 0};return this.allComments.push(o),this.allComments.sort((s,a)=>s.time-a.time),o}clearComments(){this.allComments=[],this.lastEmittedIndex=-1,this.finalPhaseActive=false,this.danmaku?.clear();}resetState(){this.clearComments(),this.currentTime=0,this.finalPhaseActive=false;}destroy(){const t=this.videoElement;t&&x.info("videoRenderer:unbindVideo",{src:this.resolveVideoSource(t),videoId:t.dataset?.videoId??null}),this.keyboardHandler?.stopListening(),this.keyboardHandler=null,this.teardownResizeListener(),this.danmaku?.destroy(),this.danmaku=null,this.videoElement=null,this.container=null;}updateSettings(t){const e=this.settings;this.settings=t,this.danmaku&&this.syncWithDanmaku(e);}getVideoElement(){return this.videoElement}getCurrentVideoSource(){const t=this.videoElement;return t?this.resolveVideoSource(t):null}getCommentsSnapshot(){return this.allComments.map(t=>({...t,style:{...t.style},commands:t.commands?[...t.commands]:void 0}))}isNGComment(t){try{return typeof t!="string"||Array.isArray(this._settings.ngWords)&&this._settings.ngWords.some(e=>typeof e=="string"&&e.length&&t.includes(e))?!0:Array.isArray(this._settings.ngRegexps)?this._settings.ngRegexps.some(e=>{try{return typeof e=="string"&&e.length?new RegExp(e).test(t):!1}catch(n){return x.error("CommentRenderer.isNGComment.regex",n,{pattern:e,text:t}),!1}}):!1}catch(e){return x.error("CommentRenderer.isNGComment",e,{text:t}),true}}updateComments(){const t=this.videoElement;if(!t||!this.danmaku)return;this.currentTime=L(t.currentTime);const e=this.duration>0&&this.duration-this.currentTime<=1e4;e&&!this.finalPhaseActive&&(this.finalPhaseActive=true,this.danmaku.clear()),!e&&this.finalPhaseActive&&(this.finalPhaseActive=false);const n=this.currentTime+2e3;for(let i=this.lastEmittedIndex+1;i<this.allComments.length;i++){const o=this.allComments[i];if(o.time*1e3<n)this.isNGComment(o.text)||this.danmaku.emit({...o,style:this.createCommentStyle(o.style)}),this.lastEmittedIndex=i;else break}}onSeek(){if(!this.videoElement||!this.danmaku)return;this.finalPhaseActive=false,this.currentTime=L(this.videoElement.currentTime),this.danmaku.clear();const t=this.videoElement.currentTime;let e=-1;for(let n=0;n<this.allComments.length;n++)if(this.allComments[n].time>=t){e=n-1;break}this.lastEmittedIndex=e;}resize(t,e){if(!this.danmaku||!this.container)return;const n=this.videoElement,i=n?.getBoundingClientRect(),o=t??i?.width??this.container.clientWidth,s=e??i?.height??this.container.clientHeight;o<=0||s<=0||(n&&i&&this.updateContainerPlacement(i),this.container.style.width=`${o}px`,this.container.style.height=`${s}px`,this.danmaku.resize());}setupVideoEventListeners(t){try{t.addEventListener("seeking",()=>this.onSeek()),t.addEventListener("ratechange",()=>{this.danmaku&&(this.danmaku.speed=144*t.playbackRate);}),t.addEventListener("timeupdate",()=>this.updateComments());}catch(e){throw x.error("CommentRenderer.setupVideoEventListeners",e),e}}setupKeyboardShortcuts(){try{this.keyboardHandler=new vt,this.keyboardHandler.addShortcut("C","Shift",()=>{try{this._settings.isCommentVisible=!this._settings.isCommentVisible,this._settings.isCommentVisible?this.danmaku?.show():this.danmaku?.hide(),window.dAniRenderer?.settingsManager?.updateSettings(this._settings);}catch(t){x.error(t,"CommentRenderer.keyboardShortcut");}}),this.keyboardHandler.startListening();}catch(t){x.error(t,"CommentRenderer.setupKeyboardShortcuts");}}setupResizeListener(t,e){try{this.teardownResizeListener(),this.isResizeObserverAvailable?(this.sizeObserver=new ResizeObserver(n=>{try{const i=n.find(o=>o.target===e);if(!i)return;this.resize(i.contentRect.width,i.contentRect.height);}catch(i){x.error(i,"CommentRenderer.resizeObserver");}}),this.sizeObserver.observe(e)):window.addEventListener("resize",this.handleWindowResize),this.addViewportEventListeners(),this.resize();}catch(n){x.error(n,"CommentRenderer.setupResizeListener");}}teardownResizeListener(){this.sizeObserver&&(this.sizeObserver.disconnect(),this.sizeObserver=null),this.isResizeObserverAvailable||window.removeEventListener("resize",this.handleWindowResize),this.removeViewportEventListeners();}handleWindowResize=()=>{this.resize();};handleWindowScroll=()=>{this.resize();};handleFullscreenChange=()=>{this.resize();};addViewportEventListeners(){this.scrollListenerAttached||(window.addEventListener("scroll",this.handleWindowScroll,{passive:true}),this.scrollListenerAttached=true),this.fullscreenEventsAttached||(dt.forEach(t=>{document.addEventListener(t,this.handleFullscreenChange);}),this.fullscreenEventsAttached=true);}removeViewportEventListeners(){this.scrollListenerAttached&&(window.removeEventListener("scroll",this.handleWindowScroll),this.scrollListenerAttached=false),this.fullscreenEventsAttached&&(dt.forEach(t=>{document.removeEventListener(t,this.handleFullscreenChange);}),this.fullscreenEventsAttached=false);}updateContainerPlacement(t){const e=this.container,n=this.videoElement;if(!e||!n)return;this.syncContainerParent();const i=!!ht(),o=e.parentElement;if(o){if(i)e.style.position="fixed",e.style.top=`${t.top}px`,e.style.left=`${t.left}px`;else {const s=o.getBoundingClientRect(),a=t.top-s.top,c=t.left-s.left;e.style.position="absolute",e.style.top=`${a}px`,e.style.left=`${c}px`;}e.style.width=`${t.width}px`,e.style.height=`${t.height}px`,e.style.overflow="hidden";}}syncContainerParent(){const t=this.container,e=this.videoElement;if(!t||!e)return;const n=ht(),o=n?.contains(e)??false?n:e.parentElement;if(!o||t.parentElement===o)return;t.remove();const s=o instanceof HTMLElement?o.style:null;s&&!s.position&&(s.position="relative"),o.appendChild(t);}createCommentStyle(t){const e=this.computeFontSizePx(),n=this.composeFontString(t?.font,e),i=Number.isFinite(this._settings.commentOpacity)?Math.max(0,Math.min(1,this._settings.commentOpacity)):1,o=this.resolveStrokeWidth(t?.lineWidth,e);return {font:n,textShadow:t?.textShadow??Ce,color:this._settings.commentColor,fillStyle:this._settings.commentColor,strokeStyle:t?.strokeStyle??"#000000",lineWidth:o,opacity:i.toString(),globalAlpha:i}}computeFontSizePx(){const t=this.getContainerHeight();if(t<=0)return this.cachedFontSizePx=st,this.cachedFontSizePx;const e=t/(ct*lt),n=Math.min(ke,Math.max(Ee,e)),i=Math.round(n);return this.cachedFontSizePx=i,i}getContainerHeight(){if(this.container){const{height:n}=this.container.getBoundingClientRect();if(Number.isFinite(n)&&n>0)return n}const e=this.videoElement?.getBoundingClientRect()?.height;return Number.isFinite(e)&&e!==void 0&&e>0?e:this.cachedFontSizePx*ct*lt}composeFontString(t,e){if(typeof t=="string"&&t.trim().length>0){const n=/\d+(?:\.\d+)?px/iu;if(n.test(t))return t.replace(n,`${e}px`).trim()}return `${we} ${e}px ${Se}`}resolveStrokeWidth(t,e){return Number.isFinite(t)&&t!==void 0?t:Math.max(2,Math.floor(e/12))}applySettingsToComments(){this.allComments=this.allComments.map(t=>({...t,style:this.createCommentStyle(t.style)}));}syncWithDanmaku(t){const e=this.danmaku;if(!e||(this.settings.isCommentVisible?e.show():e.hide(),!(t.commentColor!==this.settings.commentColor||t.commentOpacity!==this.settings.commentOpacity||!this.areNgListsEqual(t,this.settings))))return;this.applySettingsToComments();const i=this.videoElement,o=i?L(i.currentTime):0,s=o-at;e.clear(),this.allComments.filter(c=>{const l=c.time*1e3;return l>o+at||l<s?false:!this.isNGComment(c.text)}).forEach(c=>{e.emit({...c,style:this.createCommentStyle(c.style)});});}areNgListsEqual(t,e){const n=t.ngWords??[],i=e.ngWords??[],o=t.ngRegexps??[],s=e.ngRegexps??[];return n.length!==i.length||o.length!==s.length||n.some((l,d)=>l!==i[d])?false:!o.some((l,d)=>l!==s[d])}resolveVideoSource(t){if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const e=t.getAttribute("src");return e&&e.length>0?e:null}}class K{shadowRoot=null;container=null;createShadowDOM(t,e={mode:"closed"}){if(!t)throw new Error("Host element is required for shadow DOM creation");return this.shadowRoot=t.attachShadow(e),this.container=document.createElement("div"),this.shadowRoot.appendChild(this.container),this.shadowRoot}addStyles(t){if(!this.shadowRoot)throw new Error("Shadow root not initialized");const e=document.createElement("style");e.textContent=t,this.shadowRoot.appendChild(e);}querySelector(t){return this.shadowRoot?this.shadowRoot.querySelector(t):null}querySelectorAll(t){return this.shadowRoot?this.shadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}setHTML(t){if(!this.container)throw new Error("Container not initialized");this.container.innerHTML=t;}destroy(){this.shadowRoot?.host&&this.shadowRoot.host.remove(),this.shadowRoot=null,this.container=null;}}const Ie=`\r
/* 基本カラーパレット - ダークモード */\r
:host {\r
        ...
        <div class="setting-group display-settings-group">
          ...
          <div class="color-picker-container">
              <button id="openColorPicker" class="color-picker-button" type="button">
                <span class="color-picker-button__icon" aria-hidden="true">${Pe}</span>
        ...
        <div class="setting-group">
          ...
          <div class="ng-words-container">
            <button id="showNgWords" class="mask-button" type="button">
              <span class="mask-button__icon" aria-hidden="true">${yt}</span>
