...
(function () {
  ...
  const Pt={debug:"debug",info:"info",warn:"warn",error:"error"},O=e=>{const t=`[${e}]`,n={};return Object.keys(Pt).forEach(i=>{const r=Pt[i];n[i]=(...s)=>{(console[r]??console.log)(t,...s);};}),n};function St(){return typeof unsafeWindow<"u"?unsafeWindow:window}const ke={small:.8,medium:1,big:1.4},Te={defont:'"MS PGothic","Hiragino Kaku Gothic ProN","Hiragino Kaku Gothic Pro","Yu Gothic UI","Yu Gothic","Meiryo","Segoe UI","Osaka","Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","IPAPGothic","TakaoPGothic","Roboto","Helvetica Neue","Helvetica","Arial","sans-serif"',gothic:'"Noto Sans CJK JP","Noto Sans JP","Source Han Sans JP","Yu Gothic","Yu Gothic Medium","Meiryo","MS PGothic","Hiragino Kaku Gothic ProN","Segoe UI","Helvetica","Arial","sans-serif"',mincho:'"MS PMincho","MS Mincho","Hiragino Mincho ProN","Hiragino Mincho Pro","Yu Mincho","Noto Serif CJK JP","Noto Serif JP","Source Han Serif JP","Times New Roman","serif"'},te={white:"#FFFFFC",red:"#FF8888",pink:"#FFA5CC",orange:"#FFBA66",yellow:"#FFFFAA",green:"#88FF88",cyan:"#88FFFF",blue:"#8899FF",purple:"#D9A5FF",black:"#444444",white2:"#CC9",red2:"#C03",pink2:"#F3C",orange2:"#F60",yellow2:"#990",green2:"#0C6",cyan2:"#0CC",blue2:"#39F",purple2:"#63C",black2:"#666"},wt=/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i,Ae=/^[,.:;]+/,Ve=/[,.:;]+$/,Le=e=>{const t=e.trim();return t?wt.test(t)?t:t.replace(Ae,"").replace(Ve,""):""},Ie=e=>wt.test(e)?e.toUpperCase():null,ee=e=>{const t=e.trim();if(!t)return null;const n=t.toLowerCase().endsWith("px")?t.slice(0,-2):t,i=Number.parseFloat(n);return Number.isFinite(i)?i:null},Pe=e=>{const t=e.trim();if(!t)return null;if(t.endsWith("%")){const n=Number.parseFloat(t.slice(0,-1));return Number.isFinite(n)?n/100:null}return ee(t)},Re=e=>Number.isFinite(e)?Math.min(100,Math.max(-100,e)):0,Fe=e=>!Number.isFinite(e)||e===0?1:Math.min(5,Math.max(.25,e)),_e=e=>e==="naka"||e==="ue"||e==="shita",De=e=>e==="small"||e==="medium"||e==="big",He=e=>e==="defont"||e==="gothic"||e==="mincho",Oe=e=>e in te,ze=(e,t)=>{let n="naka",i="medium",r="defont",s=null,a=1,o=null,l=false,d=0,h=1;for(const f of e){const g=Le(typeof f=="string"?f:"");if(!g)continue;if(wt.test(g)){const x=Ie(g);if(x){s=x;continue}}const m=g.toLowerCase();if(_e(m)){n=m;continue}if(De(m)){i=m;continue}if(He(m)){r=m;continue}if(Oe(m)){s=te[m].toUpperCase();continue}if(m==="_live"){o=.5;continue}if(m==="invisible"){a=0,l=true;continue}if(m.startsWith("ls:")||m.startsWith("letterspacing:")){const x=g.indexOf(":");if(x>=0){const S=ee(g.slice(x+1));S!==null&&(d=Re(S));}continue}if(m.startsWith("lh:")||m.startsWith("lineheight:")){const x=g.indexOf(":");if(x>=0){const S=Pe(g.slice(x+1));S!==null&&(h=Fe(S));}continue}}const c=Math.max(0,Math.min(1,a)),u=(s??t.defaultColor).toUpperCase(),p=typeof o=="number"?Math.max(0,Math.min(1,o)):null;return {layout:n,size:i,sizeScale:ke[i],font:r,fontFamily:Te[r],resolvedColor:u,colorOverride:s,opacityMultiplier:c,opacityOverride:p,isInvisible:l,letterSpacing:d,lineHeight:h}},Ne=/^#([0-9A-F]{3}|[0-9A-F]{4}|[0-9A-F]{6}|[0-9A-F]{8})$/i,et=e=>e.length===1?e.repeat(2):e,H=e=>Number.parseInt(e,16),P=e=>!Number.isFinite(e)||e<=0?0:e>=1?1:e,ne=(e,t)=>{const n=Ne.exec(e);if(!n)return e;const i=n[1];let r,s,a,o=1;i.length===3||i.length===4?(r=H(et(i[0])),s=H(et(i[1])),a=H(et(i[2])),i.length===4&&(o=H(et(i[3]))/255)):(r=H(i.slice(0,2)),s=H(i.slice(2,4)),a=H(i.slice(4,6)),i.length===8&&(o=H(i.slice(6,8))/255));const l=P(o*P(t));return `rgba(${r}, ${s}, ${a}, ${l})`},$e=()=>({now:()=>typeof performance<"u"&&typeof performance.now=="function"?performance.now():Date.now()}),ie=()=>$e(),R=e=>e*1e3,We=e=>!Number.isFinite(e)||e<0?null:Math.round(e),Ct=4e3,Rt=1800,qe=3,Be=.25,Ue=32,Ge=48,ot=120,Ke=4e3,ut=120,Ye=800,je=2,X=4e3,$=4e3,W=$+Ct,Xe=1e3,Ft=1,re=12,se=24,T=.001,z=50,Je=.05,Ze=10,_t=8,Qe=12,tn=500,en=3e3,Dt={debug:0,info:1,warn:2,error:3},nn=(e,t,n)=>{const i=[`[${t}]`,...n];switch(e){case "debug":console.debug(...i);break;case "info":console.info(...i);break;case "warn":console.warn(...i);break;case "error":console.error(...i);break;default:console.log(...i);}},ae=(e,t={})=>{const{level:n="info",emitter:i=nn}=t,r=Dt[n],s=(a,o)=>{Dt[a]<r||i(a,e,o);};return {debug:(...a)=>s("debug",a),info:(...a)=>s("info",a),warn:(...a)=>s("warn",a),error:(...a)=>s("error",a)}},Mt=ae("CommentEngine:Comment"),Ht=new WeakMap,rn=e=>{let t=Ht.get(e);return t||(t=new Map,Ht.set(e,t)),t},lt=(e,t)=>{if(!e)return 0;const n=`${e.font??""}::${t}`,i=rn(e),r=i.get(n);if(r!==void 0)return r;const s=e.measureText(t).width;return i.set(n,s),s},sn=e=>{if(e.includes(`
`)){const t=e.split(/\r?\n/);return t.length>0?t:[""]}return [e]},Ot=e=>Math.max(24,e),pt=(e,t)=>{let n=0;const i=e.letterSpacing;for(const a of e.lines){const o=lt(t,a),l=a.length>1?i*(a.length-1):0,d=Math.max(0,o+l);d>n&&(n=d);}e.width=n;const r=Math.max(1,Math.floor(e.fontSize*e.lineHeightMultiplier));e.lineHeightPx=r;const s=e.lines.length>1?(e.lines.length-1)*r:0;e.height=e.fontSize+s;},an=(e,t,n,i,r)=>{try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(n)||!Number.isFinite(i))throw new Error("Canvas dimensions must be numbers");if(!r)throw new Error("Prepare options are required");const s=Math.max(n,1),a=Ot(Math.floor(i*.05)),o=Ot(Math.floor(a*e.sizeScale));e.fontSize=o,t.font=`${e.fontSize}px ${e.fontFamily}`,e.lines=sn(e.text),pt(e,t);const l=!e.isScrolling&&(e.layout==="ue"||e.layout==="shita");if(l){const I=Math.max(1,s-_t*2);if(e.width>I){const D=Math.max(Qe,Math.min(e.fontSize,Math.floor(a*.6))),ht=I/Math.max(e.width,1),K=Math.max(D,Math.floor(e.fontSize*Math.min(ht,1)));K<e.fontSize&&(e.fontSize=K,t.font=`${e.fontSize}px ${e.fontFamily}`,pt(e,t));let Lt=0;for(;e.width>I&&e.fontSize>D&&Lt<5;){const Ee=I/Math.max(e.width,1),It=Math.max(D,Math.floor(e.fontSize*Math.max(Ee,.7)));It>=e.fontSize?e.fontSize=Math.max(D,e.fontSize-1):e.fontSize=It,t.font=`${e.fontSize}px ${e.fontFamily}`,pt(e,t),Lt+=1;}}}if(!e.isScrolling){e.bufferWidth=0;const I=l?_t:0,D=Math.max((s-e.width)/2,I),ht=Math.max(I,s-e.width-I),K=Math.min(D,Math.max(ht,I));e.virtualStartX=K,e.x=K,e.baseSpeed=0,e.speed=0,e.speedPixelsPerMs=0,e.visibleDurationMs=$,e.preCollisionDurationMs=$,e.totalDurationMs=$,e.reservationWidth=e.width,e.staticExpiryTimeMs=e.vposMs+$,e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1;return}e.staticExpiryTimeMs=null;const d=lt(t,"??".repeat(150)),h=e.width*Math.max(r.bufferRatio,0);e.bufferWidth=Math.max(r.baseBufferPx,h);const c=Math.max(r.entryBufferPx,e.bufferWidth),u=e.scrollDirection,p=u==="rtl"?s+r.virtualExtension:-e.width-e.bufferWidth-r.virtualExtension,f=u==="rtl"?-e.width-e.bufferWidth-c:s+c,g=u==="rtl"?s+c:-c,m=u==="rtl"?p+e.width+e.bufferWidth:p-e.bufferWidth;e.virtualStartX=p,e.x=p,e.exitThreshold=f;const x=s>0?e.width/s:0,S=r.maxVisibleDurationMs===r.minVisibleDurationMs;let C=r.maxVisibleDurationMs;if(!S&&x>1){const I=Math.min(x,r.maxWidthRatio),D=r.maxVisibleDurationMs/Math.max(I,1);C=Math.max(r.minVisibleDurationMs,Math.floor(D));}const w=s+e.width+e.bufferWidth+c,L=Math.max(C,1),F=w/L,U=F*1e3/60;e.baseSpeed=U,e.speed=e.baseSpeed,e.speedPixelsPerMs=F;const G=Math.abs(f-p),dt=u==="rtl"?Math.max(0,m-g):Math.max(0,g-m),Vt=Math.max(F,Number.EPSILON);e.visibleDurationMs=C,e.preCollisionDurationMs=Math.max(0,Math.ceil(dt/Vt)),e.totalDurationMs=Math.max(e.preCollisionDurationMs,Math.ceil(G/Vt));const Me=e.width+e.bufferWidth+c;e.reservationWidth=Math.min(d,Me),e.lastUpdateTime=e.getTimeSource().now(),e.isPaused=!1;}catch(s){throw Mt.error("Comment.prepare",s,{text:e.text,visibleWidth:n,canvasHeight:i,hasContext:!!t}),s}},oe=5,_={enabled:false,maxLogsPerCategory:oe},at=new Map,on=e=>{if(e===void 0||!Number.isFinite(e))return oe;const t=Math.max(1,Math.floor(e));return Math.min(1e4,t)},ln=e=>{_.enabled=!!e.enabled,_.maxLogsPerCategory=on(e.maxLogsPerCategory),_.enabled||at.clear();},B=()=>_.enabled,cn=e=>{const t=at.get(e)??0;return t>=_.maxLogsPerCategory?(t===_.maxLogsPerCategory&&(console.debug(`[CommentOverlay][${e}]`,"Further logs suppressed."),at.set(e,t+1)),false):(at.set(e,t+1),true)},M=(e,...t)=>{_.enabled&&cn(e)&&console.debug(`[CommentOverlay][${e}]`,...t);},Z=(e,t=32)=>e.length<=t?e:`${e.slice(0,t)}…`,dn=(e,t)=>{_.enabled&&(console.group(`[CommentOverlay][state-dump] ${e}`),console.table({"Current Time":`${t.currentTime.toFixed(2)}ms`,Duration:`${t.duration.toFixed(2)}ms`,"Is Playing":t.isPlaying,"Epoch ID":t.epochId,"Total Comments":t.totalComments,"Active Comments":t.activeComments,"Reserved Lanes":t.reservedLanes,"Final Phase":t.finalPhaseActive,"Playback Begun":t.playbackHasBegun,"Is Stalled":t.isStalled}),console.groupEnd());},hn=(e,t,n)=>{_.enabled&&M("epoch-change",`Epoch changed: ${e} → ${t} (reason: ${n})`);},v={hits:0,misses:0,creates:0,fallbacks:0,outlineCallsInCache:0,fillCallsInCache:0,outlineCallsInFallback:0,fillCallsInFallback:0,letterSpacingComments:0,normalComments:0,multiLineComments:0,totalCharactersDrawn:0,lastReported:0},zt=()=>{if(!B())return;const e=performance.now();if(e-v.lastReported<=5e3)return;const t=v.hits+v.misses,n=t>0?v.hits/t*100:0,i=v.creates>0?(v.totalCharactersDrawn/v.creates).toFixed(1):"0",r=v.outlineCallsInCache+v.outlineCallsInFallback,s=v.fillCallsInCache+v.fillCallsInFallback;console.log("[TextureCache Stats]",`
