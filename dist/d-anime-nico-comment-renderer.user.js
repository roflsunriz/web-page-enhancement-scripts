...
(function () {
  ...
  const it={debug:"debug",info:"info",warn:"warn",error:"error"},C=r=>{const t=`[${r}]`,e={};return Object.keys(it).forEach(n=>{const i=it[n];e[n]=(...s)=>{(console[i]??console.log)(t,...s);};}),e};function j(){return typeof unsafeWindow<"u"?unsafeWindow:window}const Dt={commentColor:"#FFFFFF",commentOpacity:.75,isCommentVisible:true,useContainerResizeObserver:true,ngWords:[],ngRegexps:[]},O=Dt,w=()=>({...O,ngWords:[...O.ngWords],ngRegexps:[...O.ngRegexps]}),Ht="v6.1.0";var $t=typeof GM_addStyle<"u"?GM_addStyle:void 0,D=typeof GM_getValue<"u"?GM_getValue:void 0,H=typeof GM_setValue<"u"?GM_setValue:void 0,Pt=typeof GM_xmlhttpRequest<"u"?GM_xmlhttpRequest:void 0;const st="settings",ot="currentVideo",at="lastDanimeIds",qt=r=>({...r,ngWords:[...r.ngWords],ngRegexps:[...r.ngRegexps]});class Y{constructor(t){this.notifier=t,this.settings=w(),this.currentVideo=null,this.loadSettings(),this.currentVideo=this.loadVideoData();}settings;currentVideo;observers=new Set;getSettings(){return qt(this.settings)}loadSettings(){try{const t=D(st,null);if(!t)return this.settings=w(),this.settings;if(typeof t=="string"){const e=JSON.parse(t);this.settings={...w(),...e,ngWords:Array.isArray(e?.ngWords)?[...e.ngWords]:[],ngRegexps:Array.isArray(e?.ngRegexps)?[...e.ngRegexps]:[]};}else this.settings={...w(),...t,ngWords:Array.isArray(t.ngWords)?[...t.ngWords]:[],ngRegexps:Array.isArray(t.ngRegexps)?[...t.ngRegexps]:[]};return this.notifyObservers(),this.settings}catch(t){return console.error("[SettingsManager] 設定の読み込みに失敗しました",t),this.notify("設定の読み込みに失敗しました","error"),this.settings=w(),this.settings}}saveSettings(){try{return H(st,JSON.stringify(this.settings)),this.notifyObservers(),this.notify("設定を保存しました","success"),!0}catch(t){return console.error("[SettingsManager] 設定の保存に失敗しました",t),this.notify("設定の保存に失敗しました","error"),false}}updateSettings(t){return this.settings={...this.settings,...t,ngWords:t.ngWords?[...t.ngWords]:[...this.settings.ngWords],ngRegexps:t.ngRegexps?[...t.ngRegexps]:[...this.settings.ngRegexps]},this.saveSettings()}addObserver(t){this.observers.add(t);}removeObserver(t){this.observers.delete(t);}notifyObservers(){const t=this.getSettings();for(const e of this.observers)try{e(t);}catch(n){console.error("[SettingsManager] 設定変更通知でエラー",n);}}loadVideoData(){try{return D(ot,null)??null}catch(t){return console.error("[SettingsManager] 動画データの読み込みに失敗しました",t),this.notify("動画データの読み込みに失敗しました","error"),null}}saveVideoData(t,e){try{const n={videoId:e.videoId,title:e.title,viewCount:e.viewCount,commentCount:e.commentCount,mylistCount:e.mylistCount,postedAt:e.postedAt,thumbnail:e.thumbnail,owner:e.owner??null,channel:e.channel??null};return H(ot,n),this.currentVideo=n,!0}catch(n){return console.error("[SettingsManager] 動画データの保存に失敗しました",n),this.notify("動画データの保存に失敗しました","error"),false}}getCurrentVideo(){return this.currentVideo?{...this.currentVideo}:null}saveLastDanimeIds(t){try{return H(at,t),!0}catch(e){return console.error("[SettingsManager] saveLastDanimeIds failed",e),this.notify("ID情報の保存に失敗しました","error"),false}}loadLastDanimeIds(){try{return D(at,null)??null}catch(t){return console.error("[SettingsManager] loadLastDanimeIds failed",t),this.notify("ID情報の読込に失敗しました","error"),null}}notify(t,e="info"){this.notifier?.show(t,e);}}const $=C("dAnime:Comment");class Wt{text;vpos;commands;x=0;y=0;width=0;height=0;baseSpeed=0;speed=0;lane=-1;color;fontSize=0;fontFamily="Arial";opacity;isActive=false;hasShown=false;isPaused=false;lastUpdateTime=0;reservationWidth=0;constructor(t,e,n=[],i){if(typeof t!="string")throw new Error("Comment text must be a string");if(!Number.isFinite(e)||e<0)throw new Error("Comment vpos must be a non-negative number");this.text=t,this.vpos=e,this.commands=Array.isArray(n)?n:[],this.color=i.commentColor,this.opacity=i.commentOpacity;}prepare(t,e,n){try{if(!t)throw new Error("Canvas context is required");if(!Number.isFinite(e)||!Number.isFinite(n))throw new Error("Canvas dimensions must be numbers");this.fontSize=Math.max(24,Math.floor(n*.05)),t.font=`${this.fontSize}px ${this.fontFamily}`,this.width=t.measureText(this.text).width,this.height=this.fontSize;const i=t.measureText("あ".repeat(150)).width;this.reservationWidth=Math.min(i,this.width*5),this.x=e,this.baseSpeed=(e+this.reservationWidth)/720,this.speed=this.baseSpeed,this.lastUpdateTime=performance.now();}catch(i){throw $.error("Comment.prepare",i,{text:this.text,canvasWidth:e,canvasHeight:n,hasContext:!!t}),i}}update(t=1,e=false){try{if(!this.isActive||this.isPaused)return;const n=performance.now(),i=(n-this.lastUpdateTime)/(1e3/60);this.speed=this.baseSpeed*t,this.x-=this.speed*i,this.x<-this.width&&(this.isActive=!1),this.lastUpdateTime=n,this.isPaused=e;}catch(n){$.error("Comment.update",n,{text:this.text,playbackRate:t,isPaused:e,isActive:this.isActive});}}draw(t,e=null){try{if(!this.isActive||!t)return;t.save(),t.globalAlpha=this.opacity,t.font=`${this.fontSize}px ${this.fontFamily}`;const n=e??this.x,i=this.y+this.fontSize;t.strokeStyle="#000000",t.lineWidth=Math.max(3,this.fontSize/8),t.lineJoin="round",t.strokeText(this.text,n,i),t.fillStyle=this.color,t.fillText(this.text,n,i),t.restore();}catch(n){$.error("Comment.draw",n,{text:this.text,isActive:this.isActive,hasContext:!!t,interpolatedX:e});}}}const Bt=new Set(["INPUT","TEXTAREA"]),P=r=>r.length===1?r.toUpperCase():r,Ut=r=>r?`${r}+`:"";class Et{shortcuts=new Map;boundHandler;isEnabled=true;isListening=false;constructor(){this.boundHandler=this.handleKeyDown.bind(this);}addShortcut(t,e,n){const i=this.createShortcutKey(P(t),e);this.shortcuts.set(i,n);}removeShortcut(t,e){const n=this.createShortcutKey(P(t),e);this.shortcuts.delete(n);}startListening(){this.isListening||(document.addEventListener("keydown",this.boundHandler,false),this.isListening=true);}stopListening(){this.isListening&&(document.removeEventListener("keydown",this.boundHandler,false),this.isListening=false);}setEnabled(t){this.isEnabled=t;}createShortcutKey(t,e){return `${Ut(e)}${t}`}extractModifier(t){const e=[];return t.ctrlKey&&e.push("Ctrl"),t.altKey&&e.push("Alt"),t.shiftKey&&e.push("Shift"),t.metaKey&&e.push("Meta"),e.length>0?e.join("+"):null}handleKeyDown(t){if(!this.isEnabled)return;const n=t.target?.tagName??"";if(Bt.has(n))return;const i=this.extractModifier(t),s=this.createShortcutKey(P(t.key),i),o=this.shortcuts.get(s);o&&(t.preventDefault(),o());}}var Gt=(function(){if(typeof document>"u")return "transform";for(var r=["oTransform","msTransform","mozTransform","webkitTransform","transform"],t=document.createElement("div").style,e=0;e<r.length;e++)if(r[e]in t)return r[e];return "transform"})();function Kt(r){var t=document.createElement("div");if(t.style.cssText="position:absolute;",typeof r.render=="function"){var e=r.render();if(e instanceof HTMLElement)return t.appendChild(e),t}if(t.textContent=r.text,r.style)for(var n in r.style)t.style[n]=r.style[n];return t}function jt(){var r=document.createElement("div");return r.style.cssText="overflow:hidden;white-space:nowrap;transform:translateZ(0);",r}function Yt(r){for(var t=r.lastChild;t;)r.removeChild(t),t=r.lastChild;}function Zt(r,t,e){r.style.width=t+"px",r.style.height=e+"px";}function Xt(){}function Jt(r,t){var e=document.createDocumentFragment(),n=0,i=null;for(n=0;n<t.length;n++)i=t[n],i.node=i.node||Kt(i),e.appendChild(i.node);for(t.length&&r.appendChild(e),n=0;n<t.length;n++)i=t[n],i.width=i.width||i.node.offsetWidth,i.height=i.height||i.node.offsetHeight;}function Qt(r,t){t.node.style[Gt]="translate("+t.x+"px,"+t.y+"px)";}function te(r,t){r.removeChild(t.node),this.media||(t.node=null);}var ee={name:"dom",init:jt,clear:Yt,resize:Zt,framing:Xt,setup:Jt,render:Qt,remove:te},S=typeof window<"u"&&window.devicePixelRatio||1,q=Object.create(null);function ne(r,t){if(q[r])return q[r];var e=12,n=/(\d+(?:\.\d+)?)(px|%|em|rem)(?:\s*\/\s*(\d+(?:\.\d+)?)(px|%|em|rem)?)?/,i=r.match(n);if(i){var s=i[1]*1||10,o=i[2],a=i[3]*1||1.2,l=i[4];o==="%"&&(s*=t.container/100),o==="em"&&(s*=t.container),o==="rem"&&(s*=t.root),l==="px"&&(e=a),l==="%"&&(e=s*a/100),l==="em"&&(e=s*a),l==="rem"&&(e=t.root*a),l===void 0&&(e=s*a);}return q[r]=e,e}function re(r,t){if(typeof r.render=="function"){var e=r.render();if(e instanceof HTMLCanvasElement)return r.width=e.width,r.height=e.height,e}var n=document.createElement("canvas"),i=n.getContext("2d"),s=r.style||{};s.font=s.font||"10px sans-serif",s.textBaseline=s.textBaseline||"bottom";var o=s.lineWidth*1;o=o>0&&o!==1/0?Math.ceil(o):!!s.strokeStyle*1,i.font=s.font,r.width=r.width||Math.max(1,Math.ceil(i.measureText(r.text).width)+o*2),r.height=r.height||Math.ceil(ne(s.font,t))+o*2,n.width=r.width*S,n.height=r.height*S,i.scale(S,S);for(var a in s)i[a]=s[a];var l=0;switch(s.textBaseline){case "top":case "hanging":l=o;break;case "middle":l=r.height>>1;break;default:l=r.height-o;}return s.strokeStyle&&i.strokeText(r.text,o,l),i.fillText(r.text,o,l),n}function lt(r){return window.getComputedStyle(r,null).getPropertyValue("font-size").match(/(.+)px/)[1]*1}function ie(r){var t=document.createElement("canvas");return t.context=t.getContext("2d"),t._fontSize={root:lt(document.getElementsByTagName("html")[0]),container:lt(r)},t}function se(r,t){r.context.clearRect(0,0,r.width,r.height);for(var e=0;e<t.length;e++)t[e].canvas=null;}function oe(r,t,e){r.width=t*S,r.height=e*S,r.style.width=t+"px",r.style.height=e+"px";}function ae(r){r.context.clearRect(0,0,r.width,r.height);}function le(r,t){for(var e=0;e<t.length;e++){var n=t[e];n.canvas=re(n,r._fontSize);}}function ce(r,t){r.context.drawImage(t.canvas,t.x*S,t.y*S);}function de(r,t){t.canvas=null;}var he={name:"canvas",init:ie,clear:se,resize:oe,framing:ae,setup:le,render:ce,remove:de},ct=(function(){if(typeof window<"u"){var r=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame;if(r)return r.bind(window)}return function(t){return setTimeout(t,50/3)}})(),ue=(function(){if(typeof window<"u"){var r=window.cancelAnimationFrame||window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame;if(r)return r.bind(window)}return clearTimeout})();function _t(r,t,e){for(var n=0,i=0,s=r.length;i<s-1;)n=i+s>>1,e>=r[n][t]?i=n:s=n;return r[i]&&e<r[i][t]?i:s}function At(r){return /^(ltr|top|bottom)$/i.test(r)?r.toLowerCase():"rtl"}function T(){var r=9007199254740991;return [{range:0,time:-r,width:r,height:0},{range:r,time:r,width:0,height:0}]}function kt(r){r.ltr=T(),r.rtl=T(),r.top=T(),r.bottom=T();}function F(){return typeof window.performance<"u"&&window.performance.now?window.performance.now():Date.now()}function me(r){var t=this,e=this.media?this.media.currentTime:F()/1e3,n=this.media?this.media.playbackRate:1;function i(x,f){if(f.mode==="top"||f.mode==="bottom")return e-x.time<t._.duration;var I=t._.width+x.width,_=I*(e-x.time)*n/t._.duration;if(x.width>_)return  true;var A=t._.duration+x.time-e,nt=t._.width+f.width,L=t.media?f.time:f._utc,rt=nt*(e-L)*n/t._.duration,Nt=t._.width-rt,Ot=t._.duration*Nt/(t._.width+f.width);return A>Ot}for(var s=this._.space[r.mode],o=0,a=0,l=1;l<s.length;l++){var c=s[l],d=r.height;if((r.mode==="top"||r.mode==="bottom")&&(d+=c.height),c.range-c.height-s[o].range>=d){a=l;break}i(c,r)&&(o=l);}var u=s[o].range,p={range:u+r.height,time:this.media?r.time:r._utc,width:r.width,height:r.height};return s.splice(o+1,a-o-1,p),r.mode==="bottom"?this._.height-r.height-u%this._.height:u%(this._.height-r.height)}function pe(r,t,e,n){return function(i){r(this._.stage);var s=i||F(),o=s/1e3,a=this.media?this.media.currentTime:o,l=this.media?this.media.playbackRate:1,c=null,d=0,u=0;for(u=this._.runningList.length-1;u>=0;u--)c=this._.runningList[u],d=this.media?c.time:c._utc,a-d>this._.duration&&(n(this._.stage,c),this._.runningList.splice(u,1));for(var p=[];this._.position<this.comments.length&&(c=this.comments[this._.position],d=this.media?c.time:c._utc,!(d>=a));){if(a-d>this._.duration){++this._.position;continue}this.media&&(c._utc=o-(this.media.currentTime-c.time)),p.push(c),++this._.position;}for(t(this._.stage,p),u=0;u<p.length;u++)c=p[u],c.y=me.call(this,c),this._.runningList.push(c);for(u=0;u<this._.runningList.length;u++){c=this._.runningList[u];var x=this._.width+c.width,f=x*(o-c._utc)*l/this._.duration;c.mode==="ltr"&&(c.x=f-c.width),c.mode==="rtl"&&(c.x=this._.width-f),(c.mode==="top"||c.mode==="bottom")&&(c.x=this._.width-c.width>>1),e(this._.stage,c);}}}function Z(){if(!this._.visible||!this._.paused)return this;if(this._.paused=false,this.media)for(var r=0;r<this._.runningList.length;r++){var t=this._.runningList[r];t._utc=F()/1e3-(this.media.currentTime-t.time);}var e=this,n=pe(this._.engine.framing.bind(this),this._.engine.setup.bind(this),this._.engine.render.bind(this),this._.engine.remove.bind(this));function i(s){n.call(e,s),e._.requestID=ct(i);}return this._.requestID=ct(i),this}function X(){return !this._.visible||this._.paused?this:(this._.paused=true,ue(this._.requestID),this._.requestID=0,this)}function J(){if(!this.media)return this;this.clear(),kt(this._.space);var r=_t(this.comments,"time",this.media.currentTime);return this._.position=Math.max(0,r-1),this}function ge(r){r.play=Z.bind(this),r.pause=X.bind(this),r.seeking=J.bind(this),this.media.addEventListener("play",r.play),this.media.addEventListener("pause",r.pause),this.media.addEventListener("playing",r.play),this.media.addEventListener("waiting",r.pause),this.media.addEventListener("seeking",r.seeking);}function fe(r){this.media.removeEventListener("play",r.play),this.media.removeEventListener("pause",r.pause),this.media.removeEventListener("playing",r.play),this.media.removeEventListener("waiting",r.pause),this.media.removeEventListener("seeking",r.seeking),r.play=null,r.pause=null,r.seeking=null;}function be(r){this._={},this.container=r.container||document.createElement("div"),this.media=r.media,this._.visible=true,this.engine=(r.engine||"DOM").toLowerCase(),this._.engine=this.engine==="canvas"?he:ee,this._.requestID=0,this._.speed=Math.max(0,r.speed)||144,this._.duration=4,this.comments=r.comments||[],this.comments.sort(function(e,n){return e.time-n.time});for(var t=0;t<this.comments.length;t++)this.comments[t].mode=At(this.comments[t].mode);return this._.runningList=[],this._.position=0,this._.paused=true,this.media&&(this._.listener={},ge.call(this,this._.listener)),this._.stage=this._.engine.init(this.container),this._.stage.style.cssText+="position:relative;pointer-events:none;",this.resize(),this.container.appendChild(this._.stage),this._.space={},kt(this._.space),(!this.media||!this.media.paused)&&(J.call(this),Z.call(this)),this}function ye(){if(!this.container)return this;X.call(this),this.clear(),this.container.removeChild(this._.stage),this.media&&fe.call(this,this._.listener);for(var r in this)Object.prototype.hasOwnProperty.call(this,r)&&(this[r]=null);return this}var R=["mode","time","text","render","style"];function xe(r){if(!r||Object.prototype.toString.call(r)!=="[object Object]")return this;for(var t={},e=0;e<R.length;e++)r[R[e]]!==void 0&&(t[R[e]]=r[R[e]]);if(t.text=(t.text||"").toString(),t.mode=At(t.mode),t._utc=F()/1e3,this.media){var n=0;t.time===void 0?(t.time=this.media.currentTime,n=this._.position):(n=_t(this.comments,"time",t.time),n<this._.position&&(this._.position+=1)),this.comments.splice(n,0,t);}else this.comments.push(t);return this}function ve(){return this._.visible?this:(this._.visible=true,this.media&&this.media.paused?this:(J.call(this),Z.call(this),this))}function we(){return this._.visible?(X.call(this),this.clear(),this._.visible=false,this):this}function Se(){return this._.engine.clear(this._.stage,this._.runningList),this._.runningList=[],this}function Ce(){return this._.width=this.container.offsetWidth,this._.height=this.container.offsetHeight,this._.engine.resize(this._.stage,this._.width,this._.height),this._.duration=this._.width/this._.speed,this}var Ee={get:function(){return this._.speed},set:function(r){return typeof r!="number"||isNaN(r)||!isFinite(r)||r<=0?this._.speed:(this._.speed=r,this._.width&&(this._.duration=this._.width/r),r)}};function E(r){r&&be.call(this,r);}E.prototype.destroy=function(){return ye.call(this)};E.prototype.emit=function(r){return xe.call(this,r)};E.prototype.show=function(){return ve.call(this)};E.prototype.hide=function(){return we.call(this)};E.prototype.clear=function(){return Se.call(this)};E.prototype.resize=function(){return Ce.call(this)};Object.defineProperty(E.prototype,"speed",Ee);const v=C("dAnime:CommentRenderer"),z=r=>r*1e3,_e="bold",Ae="'MS PGothic', 'sans-serif'",dt=24,ke="1px 1px 2px #000, -1px -1px 2px #000, 1px -1px 2px #000, -1px 1px 2px #000",ht=2e3,ut=16,W=4,Ie=18,Ve=60,mt=1.2,pt=["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"],gt=()=>{const r=document;return r.fullscreenElement??r.webkitFullscreenElement??r.mozFullScreenElement??r.msFullscreenElement??null};class It{_settings;danmaku=null;allComments=[];lastEmittedIndex=-1;canvas=null;videoElement=null;currentTime=0;duration=0;finalPhaseActive=false;keyboardHandler=null;sizeObserver=null;isResizeObserverAvailable;container=null;resizeRetryHandle=null;fullscreenEventsAttached=false;scrollListenerAttached=false;cachedFontSizePx=dt;constructor(t){this._settings=t?{...t}:w(),this.isResizeObserverAvailable=typeof ResizeObserver<"u";}get settings(){return this._settings}set settings(t){this._settings={...t};}initialize(t){try{v.debug("initialize:start",{readyState:t.readyState,duration:t.duration}),this.danmaku&&this.destroy(),this.videoElement=t,this.duration=z(t.duration),v.info("videoRenderer:boundVideo",{src:this.resolveVideoSource(t),videoId:t.dataset?.videoId??null,durationMs:this.duration});const e=document.createElement("div");e.style.position="absolute",e.style.pointerEvents="none",e.style.zIndex="1000",e.style.top="0px",e.style.left="0px";const n=t.getBoundingClientRect();e.style.width=`${n.width}px`,e.style.height=`${n.height}px`;const i=t.parentElement??document.body;i.style.position=i.style.position||"relative",i.appendChild(e),this.container=e;const s=n.width/W;this.danmaku=new E({container:e,media:t,comments:[],engine:"canvas",speed:s}),this.canvas=e.querySelector("canvas"),this.setupVideoEventListeners(t),this.setupKeyboardShortcuts(),this.setupResizeListener(e),v.debug("initialize:completed");}catch(e){throw v.error("CommentRenderer.initialize",e),e}}addComment(t,e,n){if(this.isNGComment(t)||this.allComments.some(o=>o.text===t&&o.time===e/1e3))return null;const s={text:t,time:e/1e3,style:this.createCommentStyle(),commands:n?[...n]:void 0};return this.allComments.push(s),this.allComments.sort((o,a)=>o.time-a.time),s}clearComments(){this.allComments=[],this.lastEmittedIndex=-1,this.finalPhaseActive=false,this.danmaku?.clear();}resetState(){this.clearComments(),this.currentTime=0,this.finalPhaseActive=false;}destroy(){const t=this.videoElement;t&&v.info("videoRenderer:unbindVideo",{src:this.resolveVideoSource(t),videoId:t.dataset?.videoId??null}),this.keyboardHandler?.stopListening(),this.keyboardHandler=null,this.teardownResizeListener(),this.danmaku?.destroy(),this.danmaku=null,this.videoElement=null,this.container=null;}updateSettings(t){const e=this.settings;this.settings=t,this.danmaku&&this.syncWithDanmaku(e);}getVideoElement(){return this.videoElement}getCurrentVideoSource(){const t=this.videoElement;return t?this.resolveVideoSource(t):null}getCommentsSnapshot(){return this.allComments.map(t=>({...t,style:{...t.style},commands:t.commands?[...t.commands]:void 0}))}isNGComment(t){try{return typeof t!="string"||Array.isArray(this._settings.ngWords)&&this._settings.ngWords.some(e=>typeof e=="string"&&e.length&&t.includes(e))?!0:Array.isArray(this._settings.ngRegexps)?this._settings.ngRegexps.some(e=>{try{return typeof e=="string"&&e.length?new RegExp(e).test(t):!1}catch(n){return v.error("CommentRenderer.isNGComment.regex",n,{pattern:e,text:t}),!1}}):!1}catch(e){return v.error("CommentRenderer.isNGComment",e,{text:t}),true}}updateComments(){const t=this.videoElement;if(!t||!this.danmaku)return;this.currentTime=z(t.currentTime);const e=this.duration>0&&this.duration-this.currentTime<=1e4;e&&!this.finalPhaseActive&&(this.finalPhaseActive=true,this.danmaku.clear()),!e&&this.finalPhaseActive&&(this.finalPhaseActive=false);const n=this.currentTime+2e3;for(let i=this.lastEmittedIndex+1;i<this.allComments.length;i++){const s=this.allComments[i];if(s.time*1e3<n)this.isNGComment(s.text)||this.danmaku.emit({...s,style:this.createCommentStyle(s.style)}),this.lastEmittedIndex=i;else break}}onSeek(){if(!this.videoElement||!this.danmaku)return;this.finalPhaseActive=false,this.currentTime=z(this.videoElement.currentTime),this.danmaku.clear();const t=this.videoElement.currentTime;let e=-1;for(let n=0;n<this.allComments.length;n++)if(this.allComments[n].time>=t){e=n-1;break}this.lastEmittedIndex=e;}lastReportedZeroSize=false;resize(t,e){if(!this.danmaku||!this.container)return;this.resizeRetryHandle&&(cancelAnimationFrame(this.resizeRetryHandle),this.resizeRetryHandle=null);const n=this.videoElement,i=n?.getBoundingClientRect(),s=t??i?.width??this.container.clientWidth,o=e??i?.height??this.container.clientHeight;if(s<=0||o<=0){requestAnimationFrame(()=>this.resize());return}n&&i&&this.updateContainerPlacement(i);const a=window.devicePixelRatio||1;this.canvas&&this.canvas.getContext("2d")?.setTransform(a,0,0,a,0,0),this.container.style.width=`${s}px`,this.container.style.height=`${o}px`,this.danmaku.resize(),this.danmaku.speed=s/W*(this.videoElement?.playbackRate??1);}setupVideoEventListeners(t){try{t.addEventListener("seeking",()=>this.onSeek()),t.addEventListener("ratechange",()=>{if(this.danmaku){const n=(this.container?.clientWidth??0)/W;this.danmaku.speed=n*t.playbackRate;}}),t.addEventListener("timeupdate",()=>this.updateComments()),t.addEventListener("loadedmetadata",()=>{this.resize(),requestAnimationFrame(()=>this.resize());}),t.addEventListener("play",()=>{this.resize();});}catch(e){throw v.error("CommentRenderer.setupVideoEventListeners",e),e}}setupKeyboardShortcuts(){try{this.keyboardHandler=new Et,this.keyboardHandler.addShortcut("C","Shift",()=>{try{this._settings.isCommentVisible=!this._settings.isCommentVisible,this._settings.isCommentVisible?this.danmaku?.show():this.danmaku?.hide(),window.dAniRenderer?.settingsManager?.updateSettings(this._settings);}catch(t){v.error(t,"CommentRenderer.keyboardShortcut");}}),this.keyboardHandler.startListening();}catch(t){v.error(t,"CommentRenderer.setupKeyboardShortcuts");}}_observedEl;_onFullscreenChange;_lastDpr=1;_handleWindowResize;setupResizeListener(t){try{this.teardownResizeListener(),this.isResizeObserverAvailable?(this.sizeObserver=new ResizeObserver(e=>{try{const n=e.find(i=>i.target===t);if(!n)return;n.contentRect.width<=0||n.contentRect.height<=0?requestAnimationFrame(()=>this.resize()):this.resize(n.contentRect.width,n.contentRect.height);}catch(n){v.error(n,"CommentRenderer.resizeObserver");}}),this.sizeObserver.observe(t)):window.addEventListener("resize",this.handleWindowResize),this.addViewportEventListeners(),this.resize(),requestAnimationFrame(()=>this.resize()),this.resize();}catch(e){v.error(e,"CommentRenderer.setupResizeListener");}}teardownResizeListener(){if(this.sizeObserver){if(this._observedEl)try{this.sizeObserver.unobserve(this._observedEl);}catch{}this.sizeObserver.disconnect(),this.sizeObserver=null;}this.isResizeObserverAvailable||window.removeEventListener("resize",this.handleWindowResize),this._onFullscreenChange&&(document.removeEventListener("fullscreenchange",this._onFullscreenChange),this._onFullscreenChange=void 0),this.removeViewportEventListeners();}forceResizeByRect(t){const e=t.getBoundingClientRect();this.resize(e.width,e.height);}handleWindowResize=()=>{this.resize();};handleWindowScroll=()=>{this.resize();};handleFullscreenChange=()=>{this.resize(),requestAnimationFrame(()=>{this.resize();});};addViewportEventListeners(){this.scrollListenerAttached||(window.addEventListener("scroll",this.handleWindowScroll,{passive:true}),this.scrollListenerAttached=true),this.fullscreenEventsAttached||(pt.forEach(t=>{document.addEventListener(t,this.handleFullscreenChange);}),this.fullscreenEventsAttached=true);}removeViewportEventListeners(){this.scrollListenerAttached&&(window.removeEventListener("scroll",this.handleWindowScroll),this.scrollListenerAttached=false),this.fullscreenEventsAttached&&(pt.forEach(t=>{document.removeEventListener(t,this.handleFullscreenChange);}),this.fullscreenEventsAttached=false);}updateContainerPlacement(t){const e=this.container,n=this.videoElement;if(!e||!n)return;this.syncContainerParent();const i=!!gt(),s=e.parentElement;if(s){if(i)e.style.position="fixed",e.style.top=`${t.top}px`,e.style.left=`${t.left}px`;else {const o=s.getBoundingClientRect(),a=t.top-o.top,l=t.left-o.left;e.style.position="absolute",e.style.top=`${a}px`,e.style.left=`${l}px`;}e.style.width=`${t.width}px`,e.style.height=`${t.height}px`,e.style.overflow="hidden";}}syncContainerParent(){const t=this.container,e=this.videoElement;if(!t||!e)return;const n=gt(),s=n?.contains(e)??false?n:e.parentElement;if(!s||t.parentElement===s)return;t.remove();const o=s instanceof HTMLElement?s.style:null;o&&!o.position&&(o.position="relative"),s.appendChild(t);}createCommentStyle(t){const e=this.computeFontSizePx(),n=this.composeFontString(t?.font,e),i=Number.isFinite(this._settings.commentOpacity)?Math.max(0,Math.min(1,this._settings.commentOpacity)):1,s=this.resolveStrokeWidth(t?.lineWidth,e);return {font:n,textShadow:t?.textShadow??ke,color:this._settings.commentColor,fillStyle:this._settings.commentColor,strokeStyle:t?.strokeStyle??"#000000",lineWidth:s,opacity:i.toString(),globalAlpha:i}}computeFontSizePx(){const t=this.getContainerHeight();if(t<=0)return this.cachedFontSizePx=dt,this.cachedFontSizePx;const e=t/(ut*mt),n=Math.min(Ve,Math.max(Ie,e)),i=Math.round(n);return this.cachedFontSizePx=i,i}getContainerHeight(){if(this.container){const{height:n}=this.container.getBoundingClientRect();if(Number.isFinite(n)&&n>0)return n}const e=this.videoElement?.getBoundingClientRect()?.height;return Number.isFinite(e)&&e!==void 0&&e>0?e:this.cachedFontSizePx*ut*mt}composeFontString(t,e){if(typeof t=="string"&&t.trim().length>0){const n=/\d+(?:\.\d+)?px/iu;if(n.test(t))return t.replace(n,`${e}px`).trim()}return `${_e} ${e}px ${Ae}`}resolveStrokeWidth(t,e){return Number.isFinite(t)&&t!==void 0?t:Math.max(2,Math.floor(e/12))}applySettingsToComments(){this.allComments=this.allComments.map(t=>({...t,style:this.createCommentStyle(t.style)}));}syncWithDanmaku(t){const e=this.danmaku;if(!e||(this.settings.isCommentVisible?e.show():e.hide(),!(t.commentColor!==this.settings.commentColor||t.commentOpacity!==this.settings.commentOpacity||!this.areNgListsEqual(t,this.settings))))return;this.applySettingsToComments();const i=this.videoElement,s=i?z(i.currentTime):0,o=s-ht;e.clear(),this.allComments.filter(l=>{const c=l.time*1e3;return c>s+ht||c<o?false:!this.isNGComment(l.text)}).forEach(l=>{e.emit({...l,style:this.createCommentStyle(l.style)});});}areNgListsEqual(t,e){const n=t.ngWords??[],i=e.ngWords??[],s=t.ngRegexps??[],o=e.ngRegexps??[];return n.length!==i.length||s.length!==o.length||n.some((c,d)=>c!==i[d])?false:!s.some((c,d)=>c!==o[d])}resolveVideoSource(t){if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const e=t.getAttribute("src");return e&&e.length>0?e:null}}class Q{shadowRoot=null;container=null;createShadowDOM(t,e={mode:"closed"}){if(!t)throw new Error("Host element is required for shadow DOM creation");return this.shadowRoot=t.attachShadow(e),this.container=document.createElement("div"),this.shadowRoot.appendChild(this.container),this.shadowRoot}addStyles(t){if(!this.shadowRoot)throw new Error("Shadow root not initialized");const e=document.createElement("style");e.textContent=t,this.shadowRoot.appendChild(e);}querySelector(t){return this.shadowRoot?this.shadowRoot.querySelector(t):null}querySelectorAll(t){return this.shadowRoot?this.shadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}setHTML(t){if(!this.container)throw new Error("Container not initialized");this.container.innerHTML=t;}destroy(){this.shadowRoot?.host&&this.shadowRoot.host.remove(),this.shadowRoot=null,this.container=null;}}const Me=`\r
/* 基本カラーパレット - ダークモード */\r
:host {\r
...
`;class M{static getCommonStyles(){return Me}static getNotificationStyles(){return Le}static getAutoButtonStyles(){return Te}}const ft={success:"✔",warning:"⚠",error:"✖",info:"ℹ"};class m extends Q{static instance=null;static notifications=[];hostElement=null;initialized=false;static getInstance(){return this.instance||(this.instance=new m),this.instance}static show(t,e="info",n=3e3){try{const i=this.getInstance();return i.initialize(),i.initialized?i.createNotification(t,e,n):null}catch(i){return console.error("[NotificationManager] show failed",i),null}}static removeNotification(t){this.getInstance().removeNotification(t.element);}show(t,e="info"){m.show(t,e);}initialize(){if(!this.initialized)try{this.hostElement=document.createElement("div"),this.hostElement.className="nico-comment-shadow-host notification-host",this.hostElement.style.cssText=["position: fixed","top: 0","right: 0","z-index: 2147483647","pointer-events: none"].join(";"),document.body.appendChild(this.hostElement),this.createShadowDOM(this.hostElement),this.addStyles(M.getNotificationStyles()),this.setHTML('<div class="notification-container"></div>'),this.initialized=!0;}catch(t){console.error("[NotificationManager] initialize failed",t),this.initialized=false;}}destroy(){m.notifications.forEach(t=>{t.timerId&&window.clearTimeout(t.timerId);}),m.notifications=[],this.hostElement?.parentNode&&this.hostElement.parentNode.removeChild(this.hostElement),this.hostElement=null,this.initialized=false,m.instance=null;}createNotification(t,e,n){try{const i=this.querySelector(".notification-container");if(!i)throw new Error("Notification container not found");const s=ft[e]??ft.info,o=document.createElement("div");o.className=`notification-item ${e}`;const a=document.createElement("div");a.className="notification-icon",a.innerHTML=`<span>${s}</span>`,o.appendChild(a);const l=document.createElement("div");l.className="notification-content";const c=document.createElement("div");c.className="notification-type",c.textContent=e.charAt(0).toUpperCase()+e.slice(1),l.appendChild(c);const d=document.createElement("div");d.className="notification-message",d.textContent=t||"No message",l.appendChild(d),o.appendChild(l);const u=document.createElement("button");u.className="notification-close",u.innerHTML="&times;",u.addEventListener("click",()=>{this.removeNotification(o);}),o.appendChild(u),i.appendChild(o),requestAnimationFrame(()=>{o.classList.add("show");});const p={element:o,timerId:window.setTimeout(()=>{this.removeNotification(o);},n)};return m.notifications.push(p),p}catch(i){return console.error("[NotificationManager] createNotification failed",i),null}}removeNotification(t){if(!t)return;const e=m.notifications.find(n=>n.element===t);e?.timerId&&window.clearTimeout(e.timerId),t.classList.remove("show"),window.setTimeout(()=>{try{t.remove(),m.notifications=m.notifications.filter(n=>n.element!==t);}catch(n){console.error("[NotificationManager] removeNotification cleanup failed",n);}},500);}}const Vt="https://www.nicovideo.jp",Mt=`${Vt}/search`,Lt=`${Vt}/watch`,bt={searchBase:Mt,watchBase:Lt},Re=r=>`${Lt}/${r}`,Tt=r=>`${Mt}/${encodeURIComponent(r)}`,K=r=>new Promise((t,e)=>{Pt({url:r.url,method:r.method??"GET",headers:r.headers,data:r.data,responseType:r.responseType??"text",timeout:r.timeout,onprogress:r.onprogress,onload:n=>{t({status:n.status,statusText:n.statusText,response:n.response,finalUrl:n.finalUrl,headers:n.responseHeaders});},onerror:n=>{const i=n?.error??"unknown error";e(new Error(`GM_xmlhttpRequest failed: ${i}`));},ontimeout:()=>{e(new Error("GM_xmlhttpRequest timeout"));}});}),B=C("dAnime:NicoApiFetcher");class tt{apiData=null;comments=null;get lastApiData(){return this.apiData}get cachedComments(){return this.comments}async fetchApiData(t){try{const e=this.sanitizeVideoId(t),i=(await K({method:"GET",url:Re(e),headers:{Accept:"text/html"}})).response,a=new DOMParser().parseFromString(i,"text/html").querySelector('meta[name="server-response"]');if(!a)throw new Error("API data element not found in response");const l=a.getAttribute("content");if(!l)throw new Error("API data content is empty");const c=this.decodeServerResponse(l),u=JSON.parse(c).data?.response;if(!u)throw new Error("Invalid API data structure");return this.apiData=u,u}catch(e){throw B.error("NicoApiFetcher.fetchApiData",e),e}}async fetchComments(){try{if(!this.apiData)throw new Error("API data must be fetched first");const t=this.apiData.comment?.nvComment;if(!t?.server||!t.params||!t.threadKey)throw new Error("Required comment server data is missing");const e=await K({method:"POST",url:`${t.server}/v1/threads`,headers:{"Content-Type":"application/json","x-client-os-type":"others","X-Frontend-Id":"6","X-Frontend-Version":"0"},data:JSON.stringify({params:t.params,threadKey:t.threadKey,additionals:{}})}),s=(JSON.parse(e.response).data?.threads??[]).filter(a=>a.fork==="main").sort((a,l)=>(l.commentCount||0)-(a.commentCount||0))[0];if(!s)throw new Error("Main thread not found in comment response");const o=(s.comments??[]).map(a=>({text:a.body??"",vpos:a.vposMs??0,commands:a.commands??[]}));return this.comments=o,o}catch(t){throw B.error("NicoApiFetcher.fetchComments",t),t}}async fetchAllData(t){return await this.fetchApiData(t),this.fetchComments()}sanitizeVideoId(t){try{let e=encodeURIComponent(t);return e=e.replace(/%([0-9A-F]{2})/gi,(n,i)=>{const s=parseInt(i,16);return s>=65&&s<=90||s>=97&&s<=122||s>=48&&s<=57||s===45||s===95||s===46||s===126?String.fromCharCode(s):n}),e}catch(e){return B.error("NicoApiFetcher.sanitizeVideoId",e,{videoId:t}),t}}decodeServerResponse(t){try{return decodeURIComponent(t)}catch(e){try{const n=t.replace(/%(?![0-9A-F]{2})/gi,"%25");return decodeURIComponent(n)}catch{throw new Error(`API data decode failed: ${e.message}`)}}}}const yt=C("dAnime:NicoVideoSearcher");class Rt{cache=new Map;async search(t){if(!t.trim())return [];if(this.cache.has(t))return this.cache.get(t)??[];const e=Tt(t),n=await this.fetchText(e),i=this.parseServerContext(n).map(a=>{const l=this.calculateLevenshteinDistance(t,a.title),c=Math.max(t.length,a.title.length),d=c>0?(1-l/c)*100:0;return {...a,levenshteinDistance:l,similarity:d}}),s=[],o=new Set;for(const a of i)a?.videoId&&(o.has(a.videoId)||(o.add(a.videoId),s.push(a)));return s.sort((a,l)=>{const c=a.similarity??-1,d=l.similarity??-1;return c!==d?d-c:l.viewCount-a.viewCount}),this.cache.set(t,s),s}async fetchText(t){return (await K({method:"GET",url:t})).response}parseServerContext(t){try{const n=new DOMParser().parseFromString(t,"text/html").querySelector('meta[name="server-response"]');if(!n)return [];const i=n.getAttribute("content")??"",s=this.decodeHtmlEntities(i);let o;try{o=JSON.parse(s);}catch(a){return yt.error("NicoVideoSearcher.parseServerContext",a),[]}return this.extractVideoItems(o??{})}catch(e){return yt.error("NicoVideoSearcher.parseServerContext",e),[]}}decodeHtmlEntities(t){if(!t)return "";let e=t.replace(/&quot;/g,'"').replace(/&#39;/g,"'").replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">");return e=e.replace(/&#(\d+);/g,(n,i)=>String.fromCharCode(parseInt(i,10))),e=e.replace(/&#x([0-9a-fA-F]+);/g,(n,i)=>String.fromCharCode(parseInt(i,16))),e}extractVideoItems(t){const e=[],n=s=>{const o=(s?.id??s?.contentId??s?.watchId??"").toString();if(!o)return;const a=(s?.title??s?.shortTitle??"").toString(),l=s?.count??{},c=Number(l.view??s?.viewCounter??0)||0,d=Number(l.comment??s?.commentCounter??0)||0,u=Number(l.mylist??s?.mylistCounter??0)||0,p=s?.thumbnail??{},x=(p.nHdUrl||p.listingUrl||p.largeUrl||p.middleUrl||p.url||s?.thumbnailUrl||"").toString(),f=(s?.registeredAt||s?.startTime||s?.postedDateTime||"")?.toString?.()??"",I=s?.owner&&typeof s.owner=="object"?{nickname:(s.owner.nickname??s.owner.name??"")||void 0,name:(s.owner.name??s.owner.nickname??"")||void 0}:null,_=(s?.isChannelVideo||s?.owner?.ownerType==="channel")&&s?.owner?{name:s.owner.name??""}:null;a&&e.push({videoId:o,title:a,viewCount:c,commentCount:d,mylistCount:u,thumbnail:x,postedAt:f,owner:I,channel:_});},i=s=>{if(!s)return;if(Array.isArray(s)){s.forEach(i);return}if(typeof s!="object"||s===null)return;const o=s;(o.id||o.contentId||o.watchId)&&n(o),Object.values(s).forEach(i);};return i(t),e}calculateLevenshteinDistance(t,e){const n=t?t.length:0,i=e?e.length:0;if(n===0)return i;if(i===0)return n;const s=new Array(i+1);for(let a=0;a<=i;++a){const l=s[a]=new Array(n+1);l[0]=a;}const o=s[0];for(let a=1;a<=n;++a)o[a]=a;for(let a=1;a<=i;++a)for(let l=1;l<=n;++l){const c=t[l-1]===e[a-1]?0:1;s[a][l]=Math.min(s[a-1][l]+1,s[a][l-1]+1,s[a-1][l-1]+c);}return s[i][n]}}const b={mypageHeaderTitle:".p-mypageHeader__title",mypageListContainer:".p-mypageMain",watchVideoElement:"video#video",mypageItem:".itemModule.list",mypageItemTitle:".line1",mypageEpisodeNumber:".number.line1 span",mypageEpisodeTitle:".episode.line1 span"};class et{delay;timers=new Map;funcIds=new Map;nextId=1;constructor(t){this.delay=t;}getFuncId(t){return this.funcIds.has(t)||this.funcIds.set(t,this.nextId++),this.funcIds.get(t)??0}exec(t){const e=this.getFuncId(t),n=Date.now(),i=this.timers.get(e)?.lastExec??0,s=n-i;if(s>this.delay)t(),this.timers.set(e,{lastExec:n});else {clearTimeout(this.timers.get(e)?.timerId??void 0);const o=setTimeout(()=>{t(),this.timers.set(e,{lastExec:Date.now()});},this.delay-s);this.timers.set(e,{timerId:o,lastExec:i});}}execOnce(t){const e=this.getFuncId(t),n=this.timers.get(e);if(n?.executedOnce){n.timerId&&clearTimeout(n.timerId);return}n?.timerId&&clearTimeout(n.timerId);const i=setTimeout(()=>{try{t();}finally{this.timers.set(e,{executedOnce:true,lastExec:Date.now(),timerId:null});}},this.delay);this.timers.set(e,{timerId:i,executedOnce:false,scheduled:true});}cancel(t){const e=this.getFuncId(t),n=this.timers.get(e);n?.timerId&&clearTimeout(n.timerId),this.timers.delete(e);}resetExecution(t){const e=this.getFuncId(t),n=this.timers.get(e);n&&(n.timerId&&clearTimeout(n.timerId),this.timers.set(e,{executedOnce:false,scheduled:false}));}clearAll(){for(const[,t]of this.timers)t.timerId&&clearTimeout(t.timerId);this.timers.clear(),this.funcIds.clear();}}const ze=1e3,Fe=100,Ne=30,xt=1e4,vt=100,Oe=/watch\/(?:([a-z]{2}))?(\d+)/gi,g=C("dAnime:VideoSwitchHandler"),wt=r=>{if(!r?.video)return null;const t=r.video.registeredAt,e=t?new Date(t).toLocaleString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hour12:false}):void 0;return {videoId:r.video.id,title:r.video.title,viewCount:r.video.count?.view,mylistCount:r.video.count?.mylist,commentCount:r.video.count?.comment,postedAt:e,thumbnail:r.video.thumbnail?.url,owner:r.owner??null,channel:r.channel??null}},De=r=>{const t=[];let e;for(;(e=Oe.exec(r))!==null;){const[,n="",i=""]=e;i&&t.push(`${n}${i}`);}return t};class zt{constructor(t,e,n,i=ze,s=Fe){this.renderer=t,this.fetcher=e,this.settingsManager=n,this.monitorInterval=i,this.debounce=new et(s);}nextVideoId=null;preloadedComments=null;lastPreloadedComments=null;lastVideoId=null;lastVideoSource=null;checkIntervalId=null;isSwitching=false;debounce;startMonitoring(){this.stopMonitoring(),this.checkIntervalId=window.setInterval(()=>{this.checkVideoEnd();},this.monitorInterval);}stopMonitoring(){this.checkIntervalId&&(window.clearInterval(this.checkIntervalId),this.checkIntervalId=null);}async onVideoSwitch(t){if(!this.isSwitching){this.isSwitching=true;try{const e=await this.resolveVideoElement(t)??null,n=this.preloadedComments??this.lastPreloadedComments??null,i=e?.dataset?.videoId??e?.getAttribute?.("data-video-id")??null,s=this.nextVideoId??i??this.lastVideoId;if(!e||!s&&!n){this.handleMissingVideoInfo(n);return}g.info("videoSwitch:start",{videoId:s??null,elementVideoId:e.dataset?.videoId??null,preloadedCount:n?.length??0}),m.show("動画の切り替わりを検知しました...","info"),this.resetRendererState(e);const o=this.renderer.getVideoElement();if(o!==e&&e)g.debug("videoSwitch:rebind",{previousSrc:this.renderer.getCurrentVideoSource(),newSrc:typeof e.currentSrc=="string"&&e.currentSrc.length>0?e.currentSrc:e.getAttribute("src")??null}),this.renderer.initialize(e);else if(o===e&&e&&this.hasVideoSourceChanged(e))g.debug("videoSwitch:rebind:sameElement",{previousSrc:this.lastVideoSource??null,newSrc:this.getVideoSource(e)}),this.renderer.destroy(),this.renderer.initialize(e);else if(!o&&!e){g.warn("videoSwitch:missingVideoElement",{lastVideoId:this.lastVideoId,nextVideoId:this.nextVideoId}),this.isSwitching=!1;return}let a=null;s&&(a=await this.fetchVideoApiData(s,n),a&&(this.persistVideoMetadata(a),this.lastVideoId=s));const l=await this.populateComments(s,n);if(l===0?(this.renderer.clearComments(),m.show("コメントを取得できませんでした","warning"),g.warn("videoSwitch:commentsMissing",{videoId:s??null})):g.info("videoSwitch:commentsLoaded",{videoId:s??null,count:l}),this.nextVideoId=null,this.preloadedComments=null,this.lastVideoSource=this.getVideoSource(e),a){const c=wt(a);if(c){const d=`コメントソースを更新しました: ${c.title??"不明なタイトル"}（${l}件）`;m.show(d,l>0?"success":"warning");}}}catch(e){g.error("videoSwitch:error",e,{nextVideoId:this.nextVideoId,lastVideoId:this.lastVideoId}),m.show(`動画切り替えエラー: ${e.message}`,"error"),this.renderer.clearComments();}finally{this.isSwitching=false;}}}async resolveVideoElement(t){if(t){const i=this.getVideoSource(t),s=this.lastVideoSource;return (!i||i===s)&&await this.waitForSourceChange(t),t}const e=Date.now()+xt;let n=null;for(;Date.now()<e;){const i=document.querySelector(b.watchVideoElement);if(i){n=i;const s=this.hasVideoSourceChanged(i);if(i.readyState>=2||!i.paused||s)return s&&(this.lastVideoSource=null),i}await new Promise(s=>window.setTimeout(s,vt));}return n}async waitForSourceChange(t){const e=this.getVideoSource(t);if(!e)return;const n=Date.now()+xt;for(;Date.now()<n;){const i=this.getVideoSource(t);if(i&&i!==e){this.lastVideoSource=null;return}await new Promise(s=>window.setTimeout(s,vt));}}hasVideoSourceChanged(t){const e=this.getVideoSource(t);return e?this.lastVideoSource?this.lastVideoSource!==e:true:false}getVideoSource(t){if(!t)return null;if(typeof t.currentSrc=="string"&&t.currentSrc.length>0)return t.currentSrc;const e=t.getAttribute("src");return e&&e.length>0?e:null}resetRendererState(t){try{t.currentTime=0;}catch(e){g.debug("videoSwitch:resetCurrentTimeFailed",e);}this.renderer.clearComments();}async checkVideoEnd(){const t=this.renderer.getVideoElement();if(!(!t||!Number.isFinite(t.duration)||t.duration-t.currentTime>Ne)){if(!this.nextVideoId){const n=async()=>{await this.findNextVideoId();};this.debounce.execOnce(n);}if(this.nextVideoId&&!this.preloadedComments){const n=async()=>{await this.preloadComments();};this.debounce.execOnce(n);}}}handleMissingVideoInfo(t){t||(this.renderer.clearComments(),m.show("次の動画のコメントを取得できませんでした。コメント表示をクリアします。","warning"));}async fetchVideoApiData(t,e){try{const n=await this.fetcher.fetchApiData(t);return g.debug("videoSwitch:apiFetched",{videoId:t}),n}catch(n){if(g.error("videoSwitch:apiFetchError",n,{videoId:t}),!e)throw n;return null}}persistVideoMetadata(t){const e=wt(t);e&&this.settingsManager.saveVideoData(e.title??"",e);}async populateComments(t,e){let n=null;if(Array.isArray(e)&&e.length>0)n=e;else if(t)try{n=await this.fetcher.fetchAllData(t),g.debug("videoSwitch:commentsFetched",{videoId:t,count:n.length});}catch(s){g.error("videoSwitch:commentsFetchError",s,{videoId:t}),m.show(`コメント取得エラー: ${s.message}`,"error"),n=null;}if(!n||n.length===0)return 0;const i=n.filter(s=>!this.renderer.isNGComment(s.text));return i.forEach(s=>{this.renderer.addComment(s.text,s.vpos,s.commands);}),this.lastPreloadedComments=[...i],i.length}async findNextVideoId(){try{const t=this.fetcher.lastApiData;if(!t)return;const e=t.series?.video?.next?.id;if(e){this.nextVideoId=e,g.debug("videoSwitch:detectedNext",{videoId:e});return}const n=t.video?.description??"";if(!n)return;const i=De(n);if(i.length===0)return;const s=[...i].sort((o,a)=>{const l=parseInt(o.replace(/^[a-z]{2}/i,""),10)||0;return (parseInt(a.replace(/^[a-z]{2}/i,""),10)||0)-l});this.nextVideoId=s[0]??null,this.nextVideoId&&g.debug("videoSwitch:candidateFromDescription",{candidate:this.nextVideoId});}catch(t){g.error("videoSwitch:nextIdError",t,{lastVideoId:this.lastVideoId});}}async preloadComments(){if(this.nextVideoId)try{const e=(await this.fetcher.fetchAllData(this.nextVideoId)).filter(n=>!this.renderer.isNGComment(n.text));this.preloadedComments=e.length>0?e:null,g.debug("videoSwitch:preloaded",{videoId:this.nextVideoId,count:e.length});}catch(t){g.error("videoSwitch:preloadError",t,{videoId:this.nextVideoId}),this.preloadedComments=null;}}}const He=`
.nico-comment-shadow-host {
  display: block;
  position: relative;
}
`;class Ft{static initialize(){$t(He);}}var $e="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M7.07,18.28C7.5,17.38 10.12,16.5 12,16.5C13.88,16.5 16.5,17.38 16.93,18.28C15.57,19.36 13.86,20 12,20C10.14,20 8.43,19.36 7.07,18.28M18.36,16.83C16.93,15.09 13.46,14.5 12,14.5C10.54,14.5 7.07,15.09 5.64,16.83C4.62,15.5 4,13.82 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,13.82 19.38,15.5 18.36,16.83M12,6C10.06,6 8.5,7.56 8.5,9.5C8.5,11.44 10.06,13 12,13C13.94,13 15.5,11.44 15.5,9.5C15.5,7.56 13.94,6 12,6M12,11A1.5,1.5 0 0,1 10.5,9.5A1.5,1.5 0 0,1 12,8A1.5,1.5 0 0,1 13.5,9.5A1.5,1.5 0 0,1 12,11Z",Pe="M6 1V3H5C3.89 3 3 3.89 3 5V19C3 20.1 3.89 21 5 21H11.1C12.36 22.24 14.09 23 16 23C19.87 23 23 19.87 23 16C23 14.09 22.24 12.36 21 11.1V5C21 3.9 20.11 3 19 3H18V1H16V3H8V1M5 5H19V7H5M5 9H19V9.67C18.09 9.24 17.07 9 16 9C12.13 9 9 12.13 9 16C9 17.07 9.24 18.09 9.67 19H5M16 11.15C18.68 11.15 20.85 13.32 20.85 16C20.85 18.68 18.68 20.85 16 20.85C13.32 20.85 11.15 18.68 11.15 16C11.15 13.32 13.32 11.15 16 11.15M15 13V16.69L18.19 18.53L18.94 17.23L16.5 15.82V13Z",qe="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",We="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10Z",Be="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M5,5V7H19V5H5M5,9V11H13V9H5M5,13V15H15V13H5Z",Ue="M9,22A1,1 0 0,1 8,21V18H4A2,2 0 0,1 2,16V4C2,2.89 2.9,2 4,2H20A2,2 0 0,1 22,4V16A2,2 0 0,1 20,18H13.9L10.2,21.71C10,21.9 9.75,22 9.5,22V22H9M10,16V19.08L13.08,16H20V4H4V16H10M6,7H18V9H6V7M6,11H15V13H6V11Z",Ge="M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9M12,4.5C17,4.5 21.27,7.61 23,12C21.27,16.39 17,19.5 12,19.5C7,19.5 2.73,16.39 1,12C2.73,7.61 7,4.5 12,4.5M3.18,12C4.83,15.36 8.24,17.5 12,17.5C15.76,17.5 19.17,15.36 20.82,12C19.17,8.64 15.76,6.5 12,6.5C8.24,6.5 4.83,8.64 3.18,12Z",Ke="M5,4V7H10.5V19H13.5V7H19V4H5Z",je="M16,17H5V7H16L19.55,12M17.63,5.84C17.27,5.33 16.67,5 16,5H5A2,2 0 0,0 3,7V17A2,2 0 0,0 5,19H16C16.67,19 17.27,18.66 17.63,18.15L22,12L17.63,5.84Z",Ye="M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z",Ze="M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z",Xe="M8,5.14V19.14L19,12.14L8,5.14Z",Je="M17 19.1L19.5 20.6L18.8 17.8L21 15.9L18.1 15.7L17 13L15.9 15.6L13 15.9L15.2 17.8L14.5 20.6L17 19.1M3 14H11V16H3V14M3 6H15V8H3V6M3 10H15V12H3V10Z",Qe="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z";function y(r,t=24){const e=String(t),n=String(t);return `<svg xmlns="http://www.w3.org/2000/svg" width="${e}" height="${n}" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true" focusable="false"><path d="${r}"></path></svg>`}const tn=y(Xe),en=y(qe),nn=y(Ze),rn=y(Ye),U=y(We),sn=y(je),on=y(Ke),an=y($e),ln=y(Ge),cn=y(Ue),dn=y(Je),hn=y(Pe),un=y(Be),mn=y(Qe),k=C("dAnime:SettingsUI"),h={searchInput:"#searchInput",searchButton:"#searchButton",openSearchPage:"#openSearchPageDirect",searchResults:"#searchResults",saveButton:"#saveSettings",opacitySelect:"#commentOpacity",visibilityToggle:"#commentVisibilityToggle",currentTitle:"#currentTitle",currentVideoId:"#currentVideoId",currentOwner:"#currentOwner",currentViewCount:"#currentViewCount",currentCommentCount:"#currentCommentCount",currentMylistCount:"#currentMylistCount",currentPostedAt:"#currentPostedAt",currentThumbnail:"#currentThumbnail",colorValue:".color-value",colorPreview:".color-preview",colorPickerInput:"#colorPickerInput",ngWords:"#ngWords",ngRegexps:"#ngRegexps",showNgWords:"#showNgWords",showNgRegexps:"#showNgRegexp",playCurrentVideo:"#playCurrentVideo",settingsModal:"#settingsModal",closeSettingsModal:"#closeSettingsModal",modalOverlay:".settings-modal__overlay",modalTabs:".settings-modal__tab",modalPane:".settings-modal__pane"},V=["search","display","ng"],St=`
...
`;class N extends Q{static FAB_HOST_ID="danime-settings-fab-host";settingsManager;fetcher;searcher;settings;currentVideoInfo;hostElement=null;lastAutoButtonElement=null;activeTab="search";modalElement=null;overlayElement=null;closeButtonElement=null;fabElement=null;fabHostElement=null;fabShadowRoot=null;handleFabClick=t=>{t.preventDefault(),this.openSettingsModal();};handleOverlayClick=()=>{this.closeSettingsModal();};handleCloseClick=()=>{this.closeSettingsModal();};constructor(t,e=new tt,n=new Rt){super(),this.settingsManager=t,this.fetcher=e,this.searcher=n,this.settings=this.settingsManager.getSettings(),this.currentVideoInfo=this.settingsManager.loadVideoData();}insertIntoMypage(){const t=document.querySelector(b.mypageHeaderTitle);t&&(this.hostElement=this.createSettingsUI(),t.parentElement?.insertBefore(this.hostElement,t.nextSibling),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(e){console.warn("[SettingsUI] restore failed:",e);}}));}addAutoCommentButtons(){document.querySelectorAll(b.mypageItem).forEach(e=>{const n=e.querySelector(b.mypageItemTitle);if(!n||n.querySelector(".auto-comment-button-host"))return;const i=n.querySelector("span")?.textContent?.trim()??"",s=e.querySelector(b.mypageEpisodeNumber)?.textContent?.trim()??"",o=e.querySelector(b.mypageEpisodeTitle)?.textContent?.trim()??"",a=document.createElement("div");a.className="nico-comment-shadow-host auto-comment-button-host",a.style.cssText="position:absolute;left:150px;top:3px;margin-left:8px;";const l=a.attachShadow({mode:"closed"}),c=document.createElement("style");c.textContent=M.getAutoButtonStyles(),l.appendChild(c);const d=document.createElement("button");d.className="auto-comment-button",d.innerHTML=U,d.setAttribute("aria-label","コメント設定"),d.setAttribute("title","コメント設定"),d.setAttribute("type","button"),d.addEventListener("click",async u=>{u.preventDefault(),u.stopPropagation(),u.stopImmediatePropagation();try{const p=[i,s,o].filter(Boolean).join(" ");this.scrollToSettings(),this.setSearchKeyword(p),this.lastAutoButtonElement=a;try{const f=e.querySelector('input[name="workId"]')?.value?.trim()??"",I=e.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),_=e.querySelector('a.textContainer[href*="partId="]');let A="";const L=(I?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);L?A=L[1]:_?.href&&(A=(new URL(_.href,location.origin).searchParams.get("partId")??"").trim()),f&&A&&this.settingsManager.saveLastDanimeIds({workId:f,partId:A});}catch(f){console.warn("[SettingsUI] save (workId, partId) skipped:",f);}const x=await this.executeSearch(p);if(x.length===0)return;await this.applySearchResult(x[0]);}catch(p){k.error("SettingsUI.autoCommentButton",p);}}),l.appendChild(d),n.appendChild(a),this.lastAutoButtonElement=a;}),this.waitMypageListStable().then(()=>{try{this.tryRestoreByDanimeIds();}catch(e){console.warn("[SettingsUI] restore failed:",e);}});}async waitMypageListStable(){const t=document.querySelector(b.mypageListContainer);if(!t)return;let e=t.querySelectorAll(b.mypageItem).length;const n=Date.now()+1500;return new Promise(i=>{const s=new MutationObserver(()=>{const o=t.querySelectorAll(b.mypageItem).length;if(o!==e){e=o;return}Date.now()>=n&&(s.disconnect(),i());});s.observe(t,{childList:true,subtree:true}),setTimeout(()=>{try{s.disconnect();}catch(o){k.debug("waitMypageListStable: observer already disconnected",o);}i();},1600);})}tryRestoreByDanimeIds(){const t=this.settingsManager.loadLastDanimeIds();if(!t)return  false;const e=Array.from(document.querySelectorAll(b.mypageItem));for(const n of e){if(n.querySelector('input[name="workId"]')?.value?.trim()!==t.workId)continue;const s=n.querySelector('a.textContainer[href*="partId="]'),o=s?.href?(new URL(s.href,location.origin).searchParams.get("partId")??"")===t.partId:false,a=n.querySelector(".thumbnailContainer > a, .thumbnail-container > a"),l=(()=>{const d=(a?.getAttribute("onclick")??"").match(/mypageContentPlayWrapper\(["'](\d+)["']\)/);return !!d&&d[1]===t.partId})();if(o||l){const c=n.querySelector(".auto-comment-button-host")??n;return this.lastAutoButtonElement=c,this.updatePlayButtonState(this.currentVideoInfo),true}}return  false}createSettingsUI(){const t=document.createElement("div");t.className="nico-comment-shadow-host settings-host",this.createShadowDOM(t),this.addStyles(M.getCommonStyles());const e=this.buildSettingsHtml();return this.setHTML(e),this.applySettingsToUI(),this.addStyles(St),this.setupEventListeners(),t}buildSettingsHtml(){const t=i=>typeof i=="number"?i.toLocaleString():"-",e=i=>{if(!i)return "-";try{return new Date(i).toLocaleDateString("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return i}},n=this.currentVideoInfo;return `
...
`)}</textarea>
    ...
    `}async applySearchResult(t){try{const e=await this.fetcher.fetchApiData(t.videoId);await this.fetcher.fetchComments(),m.show(`「${t.title}」のコメントを設定しました`,"success"),this.updateCurrentVideoInfo(this.buildVideoMetadata(t,e));}catch(e){k.error("SettingsUI.applySearchResult",e);}}buildVideoMetadata(t,e){return {videoId:t.videoId,title:t.title,viewCount:e.video?.count?.view??t.viewCount,commentCount:e.video?.count?.comment??t.commentCount,mylistCount:e.video?.count?.mylist??t.mylistCount,postedAt:e.video?.registeredAt??t.postedAt,thumbnail:e.video?.thumbnail?.url??t.thumbnail,owner:e.owner??t.owner??void 0,channel:e.channel??t.channel??void 0}}applySettingsToUI(){const t=this.queryModalElement(h.opacitySelect),e=this.queryModalElement(h.visibilityToggle),n=this.queryModalElement(h.colorPreview),i=this.queryModalElement(h.colorValue),s=this.queryModalElement(h.ngWords),o=this.queryModalElement(h.ngRegexps);t&&(t.value=this.settings.commentOpacity.toString()),e&&this.updateVisibilityToggleState(e),n&&(n.style.backgroundColor=this.settings.commentColor),i&&(i.textContent=this.settings.commentColor),s&&(s.value=this.settings.ngWords.join(`
...
`).map(i=>i.trim()).filter(Boolean)),this.settingsManager.updateSettings(this.settings)?m.show("設定を保存しました","success"):m.show("設定の保存に失敗しました","error");}updateCurrentVideoInfo(t){this.currentVideoInfo=t,[["currentTitle",t.title??"-"],["currentVideoId",t.videoId??"-"],["currentOwner",t.owner?.nickname??t.channel?.name??"-"],["currentViewCount",this.formatNumber(t.viewCount)],["currentCommentCount",this.formatNumber(t.commentCount)],["currentMylistCount",this.formatNumber(t.mylistCount)],["currentPostedAt",this.formatSearchResultDate(t.postedAt)]].forEach(([i,s])=>{const o=this.querySelector(h[i]);o&&(o.textContent=s);});const n=this.querySelector(h.currentThumbnail);n&&t.thumbnail&&(n.src=t.thumbnail,n.alt=t.title??"サムネイル");try{this.settingsManager.saveVideoData(t.title??"",t);}catch(i){k.error("SettingsUI.updateCurrentVideoInfo",i);}this.updatePlayButtonState(t);}formatNumber(t){return typeof t=="number"?t.toLocaleString():"-"}formatSearchResultDate(t){if(!t)return "-";const e=new Date(t);return Number.isNaN(e.getTime())?t:new Intl.DateTimeFormat("ja-JP",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",hourCycle:"h23"}).format(e)}setupPlayButton(){const t=this.querySelector(h.playCurrentVideo);t&&(t.addEventListener("click",()=>{try{if(!this.currentVideoInfo?.videoId){m.show("再生できる動画が設定されていません","warning");return}const n=this.lastAutoButtonElement?.closest(".itemModule.list");if(this.lastAutoButtonElement){const i=n?.querySelector(".thumbnailContainer > a, .thumbnail-container > a");if(i){m.show(`「${this.currentVideoInfo?.title||"動画"}」を再生します...`,"success"),setTimeout(()=>{i.click();},300);return}}m.show("再生リンクが見つかりませんでした（対象アイテム内に限定して検索済み）","warning");}catch(e){k.error("SettingsUI.playCurrentVideo",e),m.show(`再生エラー: ${e.message}`,"error");}}),this.updatePlayButtonState(this.currentVideoInfo));}updatePlayButtonState(t){const e=this.querySelector(h.playCurrentVideo);if(!e)return;const n=!!t?.videoId;e.disabled=!n,e.setAttribute("aria-disabled",(!n).toString());}updateVisibilityToggleState(t){t.textContent=this.settings.isCommentVisible?"表示中":"非表示中",t.classList.toggle("off",!this.settings.isCommentVisible);}destroy(){this.closeButtonElement?.removeEventListener("click",this.handleCloseClick),this.overlayElement?.removeEventListener("click",this.handleOverlayClick),this.closeButtonElement=null,this.overlayElement=null,this.modalElement=null,this.removeFabElement(),super.destroy();}createOrUpdateFab(){if(!document.body)return null;let t=this.fabHostElement;!t||!t.isConnected?(t?.remove(),t=document.createElement("div"),t.id=N.FAB_HOST_ID,t.style.position="fixed",t.style.bottom="32px",t.style.right="32px",t.style.zIndex="2147483646",t.style.display="inline-block",this.fabShadowRoot=t.attachShadow({mode:"open"}),document.body.appendChild(t),this.fabHostElement=t):this.fabShadowRoot||(this.fabShadowRoot=t.shadowRoot??t.attachShadow({mode:"open"}));const e=this.fabShadowRoot;if(!e)return null;let n=e.querySelector("style[data-role='fab-base-style']");n||(n=document.createElement("style"),n.dataset.role="fab-base-style",n.textContent=M.getCommonStyles(),e.appendChild(n));let i=e.querySelector("style[data-role='fab-style']");i||(i=document.createElement("style"),i.dataset.role="fab-style",i.textContent=`
      ...
      `,e.appendChild(i));let s=e.querySelector("style[data-role='similarity-style']");s||(s=document.createElement("style"),s.dataset.role="similarity-style",s.textContent=St,e.appendChild(s));let o=e.querySelector(".fab-container");o||(o=document.createElement("div"),o.className="fab-container",e.appendChild(o));let a=o.querySelector("button.fab-button");a||(a=document.createElement("button"),a.type="button",a.className="fab-button",o.appendChild(a)),a.innerHTML=`
      <span class="fab-button__icon" aria-hidden="true">${U}</span>
      <span class="fab-button__label">設定</span>
    `,a.setAttribute("aria-label","ニコニココメント設定を開く"),a.setAttribute("aria-haspopup","dialog");let l=o.querySelector(h.settingsModal);return l||(o.insertAdjacentHTML("beforeend",this.buildModalHtml()),l=o.querySelector(h.settingsModal)),this.modalElement=l??null,a}removeFabElement(){this.fabElement&&this.fabElement.removeEventListener("click",this.handleFabClick),this.fabHostElement?.isConnected&&this.fabHostElement.remove(),this.fabElement=null,this.fabHostElement=null,this.fabShadowRoot=null;}queryModalElement(t){return this.fabShadowRoot?this.fabShadowRoot.querySelector(t):null}queryModalSelectorAll(t){return this.fabShadowRoot?this.fabShadowRoot.querySelectorAll(t):document.createDocumentFragment().childNodes}}const Ct=async()=>{},pn=()=>{const r=j();if(!r.dAniRenderer){const t={};r.dAniRenderer={classes:{Comment:Wt,CommentRenderer:It,NicoApiFetcher:tt,NotificationManager:m,StyleManager:Ft,SettingsUI:N,NicoVideoSearcher:Rt,VideoSwitchHandler:zt,SettingsManager:Y,KeyboardShortcutHandler:Et,DebounceExecutor:et,ShadowDOMComponent:Q,ShadowStyleManager:M},instances:t,utils:{initialize:Ct,initializeWithVideo:Ct},debug:{showState:()=>{console.log("Current instances:",t);},showSettings:()=>{const e=t.settingsManager;if(!e){console.log("SettingsManager not initialized");return}console.log("Current settings:",e.getSettings());},showComments:()=>{const e=t.renderer;if(!e){console.log("CommentRenderer not initialized");return}console.log("Current comments:",e.getCommentsSnapshot());}},defaultSettings:w};}return r.dAniRenderer},gn=100,fn=1e3,bn=3e3;class yn{constructor(t){this.global=t;}initialized=false;switchDebounce=new et(fn);switchCallback=null;lastSwitchTimestamp=0;currentVideoElement=null;videoMutationObserver=null;domMutationObserver=null;videoEndedListener=null;async initialize(){await this.ensureDocumentReady(),this.waitForVideoElement();}async ensureDocumentReady(){document.readyState!=="complete"&&await new Promise(t=>{window.addEventListener("load",()=>t(),{once:true});});}waitForVideoElement(){if(this.initialized)return;const t=document.querySelector(b.watchVideoElement);if(!t){window.setTimeout(()=>this.waitForVideoElement(),gn);return}if(t.readyState===0){t.addEventListener("loadedmetadata",()=>{this.initializeWithVideo(t);},{once:true});return}this.initializeWithVideo(t);}async initializeWithVideo(t){if(!this.initialized){this.initialized=true;try{m.show("コメントローダーを初期化中...");const e=m.getInstance(),n=this.global.settingsManager??new Y(e);this.global.settingsManager=n,this.global.instances.settingsManager=n;const i=n.loadVideoData();if(!i?.videoId)throw new Error("動画データが見つかりません。マイページで設定してください。");const s=new tt;this.global.instances.fetcher=s,await s.fetchApiData(i.videoId);const o=await s.fetchComments(),a=this.mergeSettings(n.loadSettings()),l=new It(a);l.initialize(t),this.global.instances.renderer=l,this.currentVideoElement=t,n.addObserver(d=>{l.settings=this.mergeSettings(d);}),o.forEach(d=>{l.addComment(d.text,d.vpos,d.commands);});const c=new zt(l,s,n);c.startMonitoring(),this.global.instances.switchHandler=c,this.setupSwitchHandling(t,c),this.observeVideoElement(),m.show(`コメントの読み込みが完了しました（${o.length}件）`,"success");}catch(e){throw this.initialized=false,m.show(`初期化エラー: ${e.message}`,"error"),e}}}mergeSettings(t){const e=w();return {...e,...t,ngWords:[...t.ngWords??e.ngWords],ngRegexps:[...t.ngRegexps??e.ngRegexps]}}setupSwitchHandling(t,e){this.currentVideoElement=t,this.switchCallback=()=>{const n=Date.now();if(n-this.lastSwitchTimestamp<bn)return;this.lastSwitchTimestamp=n;const i=this.currentVideoElement;e.onVideoSwitch(i);},this.videoMutationObserver?.disconnect(),this.videoMutationObserver=new MutationObserver(n=>{if(this.switchCallback)for(const i of n)i.type==="attributes"&&i.attributeName==="src"&&i.target===this.currentVideoElement&&(this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));}),this.videoMutationObserver.observe(t,{attributes:true,attributeFilter:["src"]}),this.global.utils.initializeWithVideo=async n=>{n&&(this.rebindVideoElement(n),await e.onVideoSwitch(n));},this.currentVideoElement=t;}observeVideoElement(){const t=this.currentVideoElement;t&&(this.domMutationObserver?.disconnect(),this.domMutationObserver=new MutationObserver(()=>{const e=document.querySelector(b.watchVideoElement);!e||e===this.currentVideoElement||this.rebindVideoElement(e);}),this.domMutationObserver.observe(document.body,{childList:true,subtree:true}),this.attachVideoEventListeners(t));}rebindVideoElement(t){this.detachVideoEventListeners(),this.currentVideoElement=t;const e=this.global.instances.renderer,n=this.global.instances.switchHandler;e&&(e.destroy(),e.initialize(t),e.resize()),n&&(n.onVideoSwitch(t),this.setupSwitchHandling(t,n)),this.attachVideoEventListeners(t);}attachVideoEventListeners(t){this.detachVideoEventListeners();const e=()=>{this.switchCallback&&(this.switchDebounce.resetExecution(this.switchCallback),this.switchDebounce.execOnce(this.switchCallback));};t.addEventListener("ended",e),this.videoEndedListener=e;}detachVideoEventListeners(){const t=this.currentVideoElement;t&&this.videoEndedListener&&t.removeEventListener("ended",this.videoEndedListener),this.videoEndedListener=null;}}const xn=100;class vn{constructor(t){this.global=t;}initialize(){const t=m.getInstance(),e=this.global.settingsManager??new Y(t);this.global.settingsManager=e,this.global.instances.settingsManager=e;const n=new N(e);this.waitForHeader(n);}waitForHeader(t){if(!document.querySelector(b.mypageHeaderTitle)){window.setTimeout(()=>this.waitForHeader(t),xn);return}t.insertIntoMypage(),t.addAutoCommentButtons(),this.observeList(t);}observeList(t){const e=document.querySelector(b.mypageListContainer);if(!e)return;new MutationObserver(()=>{try{t.addAutoCommentButtons();}catch(i){console.error("[MypageController] auto comment buttons update failed",i);}}).observe(e,{childList:true,subtree:true});}}class wn{log;global=pn();watchController=null;mypageController=null;constructor(){this.log=C("DanimeApp");}start(){this.log.info("starting renderer"),Ft.initialize(),this.global.utils.initialize=()=>this.initialize(),window.addEventListener("load",()=>{this.initialize();});}async initialize(){if(!this.acquireInstanceLock()){this.log.info("renderer already initialized, skipping");return}const t=location.pathname.toLowerCase();try{t.includes("/animestore/sc_d_pc")?(this.watchController=new yn(this.global),await this.watchController.initialize()):t.includes("/animestore/mp_viw_pc")?(this.mypageController=new vn(this.global),this.mypageController.initialize()):this.log.info("page not supported, initialization skipped");}catch(e){this.log.error("initialization failed",e);}}acquireInstanceLock(){const t=j();return t.__dAnimeNicoCommentRenderer2Instance=(t.__dAnimeNicoCommentRenderer2Instance??0)+1,t.__dAnimeNicoCommentRenderer2Instance===1}}const G=C("dAnimeNicoCommentRenderer2");async function Sn(){G.info("bootstrap start");try{new wn().start(),G.info("bootstrap completed");}catch(r){G.error("bootstrap failed",r);}}Sn();
