...
(function () {
  ...
  `,document.body.appendChild(e);const i=z.querySelector(".modal"),b=z.querySelector(".close-button"),g=z.querySelector(".cancel-button"),v=z.querySelector(".save-button"),s=z.querySelector(".success-text"),c=z.getElementById("notification-enabled"),a=z.getElementById("sound-enabled"),o=z.getElementById("sound-volume"),x=z.getElementById("volume-label"),l=z.getElementById("custom-sound"),n=()=>{e.style.display="none",s.textContent="";},d=()=>{x.textContent=`音量: ${o.value}`;},f=A=>{c.checked=A.showNotification,a.checked=A.playSound,o.value=String(A.soundVolume),l.value=A.customSoundUrl,d();},I=()=>{const A={showNotification:c.checked,playSound:a.checked,soundVolume:parseFloat(o.value),customSoundUrl:l.value.trim()};E(A),s.textContent="保存しました！",setTimeout(n,1e3);};i.addEventListener("click",A=>{A.target===i&&n();}),b.addEventListener("click",n),g.addEventListener("click",n),v.addEventListener("click",I),o.addEventListener("input",d),f(t);}function T(){S(()=>{const t=p();Q(t);}),GM_registerMenuCommand("設定",G);}T();
