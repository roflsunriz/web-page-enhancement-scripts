...
(function () {
  ...
  `,document.body.appendChild(A);const i=z.querySelector(".modal"),b=z.querySelector(".close-button"),v=z.querySelector(".cancel-button"),g=z.querySelector(".save-button"),s=z.querySelector(".success-text"),c=z.getElementById("notification-enabled"),a=z.getElementById("sound-enabled"),o=z.getElementById("sound-volume"),x=z.getElementById("volume-label"),l=z.getElementById("custom-sound"),n=()=>{A.style.display="none",s.textContent="";},d=()=>{x.textContent=`音量: ${o.value}`;},f=e=>{c.checked=e.showNotification,a.checked=e.playSound,o.value=String(e.soundVolume),l.value=e.customSoundUrl,d();},I=()=>{const e={showNotification:c.checked,playSound:a.checked,soundVolume:parseFloat(o.value),customSoundUrl:l.value.trim()};E(e),s.textContent="保存しました！",setTimeout(n,1e3);};i.addEventListener("click",e=>{e.target===i&&n();}),b.addEventListener("click",n),v.addEventListener("click",n),g.addEventListener("click",I),o.addEventListener("input",d),f(t);}function S(){C(()=>{const t=p();Q(t);}),GM_registerMenuCommand("設定",G);}S();
