...
`;class M{settingsManager;controller;overlay=null;styleElement=null;constructor(e,t){this.settingsManager=e,this.controller=t,this.injectStyles();}injectStyles(){this.styleElement||(this.styleElement=document.createElement("style"),this.styleElement.textContent=L,document.head.appendChild(this.styleElement));}show(){this.overlay||(this.overlay=this.createOverlay(),document.body.appendChild(this.overlay),setTimeout(()=>{this.showTab("visibility");},0));}hide(){this.overlay&&(this.overlay.remove(),this.overlay=null);}createOverlay(){const e=document.createElement("div");e.className="twitter-clean-ui-overlay",e.addEventListener("click",i=>{i.target===e&&this.hide();});const t=this.createModal();return e.appendChild(t),e}createModal(){const e=document.createElement("div");e.className="twitter-clean-ui-modal";const t=this.createHeader();e.appendChild(t);const i=this.createTabs();e.appendChild(i);const r=document.createElement("div");r.className="twitter-clean-ui-body",r.id="twitter-clean-ui-body",e.appendChild(r);const n=this.createFooter();return e.appendChild(n),e}createHeader(){const e=document.createElement("div");e.className="twitter-clean-ui-header";const t=document.createElement("h2");t.className="twitter-clean-ui-title",t.textContent=u("appName"),e.appendChild(t);const i=document.createElement("button");return i.className="twitter-clean-ui-close",i.textContent="×",i.addEventListener("click",()=>this.hide()),e.appendChild(i),e}createTabs(){const e=document.createElement("div");return e.className="twitter-clean-ui-tabs",[{id:"visibility",label:u("leftSidebarSettings")},{id:"rightSidebar",label:u("rightSidebarSettings")},{id:"layout",label:u("layoutSettings")},{id:"profiles",label:u("profileSettings")}].forEach((i,r)=>{const n=document.createElement("button");n.className=`twitter-clean-ui-tab ${r===0?"active":""}`,n.textContent=i.label,n.addEventListener("click",()=>{e.querySelectorAll(".twitter-clean-ui-tab").forEach(s=>{s.classList.remove("active");}),n.classList.add("active"),this.showTab(i.id);}),e.appendChild(n);}),e}showTab(e){const t=document.getElementById("twitter-clean-ui-body");if(t)switch(t.innerHTML="",e){case "visibility":t.appendChild(this.createVisibilityTab());break;case "rightSidebar":t.appendChild(this.createRightSidebarTab());break;case "layout":t.appendChild(this.createLayoutTab());break;case "profiles":t.appendChild(this.createProfilesTab());break}}createVisibilityTab(){const e=document.createElement("div"),t=this.settingsManager.getSettings(),i=this.createSection(u("leftSidebarSettings"));["leftSidebar_Logo","leftSidebar_HomeLink","leftSidebar_ExploreLink","leftSidebar_NotificationsLink","leftSidebar_MessagesLink","leftSidebar_GrokLink","leftSidebar_BookmarksLink","leftSidebar_ListsLink","leftSidebar_CommunitiesLink","leftSidebar_ProfileLink","leftSidebar_PremiumLink","leftSidebar_MoreMenu","leftSidebar_TweetButton","leftSidebar_ProfileMenu"].forEach(l=>{const o=t.visibility,c=this.createToggleControl(u(l),o[l]??true,h=>{const p={[l]:h};this.settingsManager.updateSettings({visibility:p}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});i.appendChild(c);}),e.appendChild(i);const n=this.createSection(u("mainContentSettings")),s=this.createToggleControl(u("mainContent_TweetComposer"),t.visibility.mainContent_TweetComposer,l=>{const o={mainContent_TweetComposer:l};this.settingsManager.updateSettings({visibility:o}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});n.appendChild(s);const d=this.createToggleControl(u("promotedTweets"),t.visibility.promotedTweets,l=>{const o={promotedTweets:l};this.settingsManager.updateSettings({visibility:o}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});return n.appendChild(d),e.appendChild(n),e}createRightSidebarTab(){const e=document.createElement("div"),t=this.settingsManager.getSettings(),i=this.createSection(u("rightSidebarSettings"));return ["rightSidebar","rightSidebar_SearchBox","rightSidebar_PremiumSubscribe","rightSidebar_TrendsList","rightSidebar_WhoToFollow","rightSidebar_Footer"].forEach(n=>{const s=t.visibility,d=this.createToggleControl(u(n),s[n]??true,l=>{const o={[n]:l};this.settingsManager.updateSettings({visibility:o}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});i.appendChild(d);}),e.appendChild(i),e}createLayoutTab(){const e=document.createElement("div"),t=this.settingsManager.getSettings(),i=this.createSection(u("layoutSettings")),r=this.createSliderControl(u("leftSidebarWidth"),t.layout.leftSidebarWidth,200,400,c=>{const h={leftSidebarWidth:c};this.settingsManager.updateSettings({layout:h}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(r);const n=this.createSliderControl(u("mainContentWidth"),t.layout.mainContentWidth,500,1200,c=>{const h={mainContentWidth:c};this.settingsManager.updateSettings({layout:h}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(n);const s=this.createSliderControl(u("rightSidebarWidth"),t.layout.rightSidebarWidth,300,500,c=>{const h={rightSidebarWidth:c};this.settingsManager.updateSettings({layout:h}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(s);const d=this.createSliderControl(u("timelineRightPadding"),t.layout.timelineRightPadding,0,100,c=>{const h={timelineRightPadding:c};this.settingsManager.updateSettings({layout:h}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(d);const l=this.createSliderControl(u("gap"),t.layout.gap,0,60,c=>{const h={gap:c};this.settingsManager.updateSettings({layout:h}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(l);const o=this.createToggleControl(u("enableRealTimePreview"),t.enableRealTimePreview,c=>{this.settingsManager.updateSettings({enableRealTimePreview:c});});return i.appendChild(o),e.appendChild(i),e}createProfilesTab(){const e=document.createElement("div"),t=this.createSection(u("profileSettings")),i=this.settingsManager.getAllProfiles(),r=this.settingsManager.getCurrentProfileId(),n=document.createElement("ul");n.className="twitter-clean-ui-profile-list",i.forEach(o=>{const c=document.createElement("li");c.className=`twitter-clean-ui-profile-item ${o.id===r?"active":""}`;const h=document.createElement("span");h.className="twitter-clean-ui-profile-name",h.textContent=o.name,c.appendChild(h);const p=document.createElement("div");if(p.className="twitter-clean-ui-profile-actions",o.id!==r){const g=document.createElement("button");g.className="twitter-clean-ui-icon-button",g.textContent="✓",g.title="切り替え",g.addEventListener("click",b=>{b.stopPropagation(),this.settingsManager.switchProfile(o.id),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab("profiles");}),p.appendChild(g);}if(o.id!=="default"){const g=document.createElement("button");g.className="twitter-clean-ui-icon-button",g.textContent="🗑",g.title="削除",g.addEventListener("click",b=>{b.stopPropagation(),confirm(`${o.name} を削除しますか？`)&&(this.settingsManager.deleteProfile(o.id),this.showTab("profiles"));}),p.appendChild(g);}c.appendChild(p),n.appendChild(c);}),t.appendChild(n);const s=document.createElement("button");s.className="twitter-clean-ui-button twitter-clean-ui-button-primary",s.textContent=u("createNewProfile"),s.style.marginTop="12px",s.addEventListener("click",()=>{const o=prompt("プロファイル名を入力してください:");o&&(this.settingsManager.createProfile(o),this.showTab("profiles"));}),t.appendChild(s);const d=document.createElement("button");d.className="twitter-clean-ui-button twitter-clean-ui-button-secondary",d.textContent=u("exportSettings"),d.style.marginTop="12px",d.addEventListener("click",()=>{const o=this.settingsManager.exportSettings(),c=new Blob([o],{type:"application/json"}),h=URL.createObjectURL(c),p=document.createElement("a");p.href=h,p.download=`twitter-clean-ui-settings-${Date.now()}.json`,p.click(),URL.revokeObjectURL(h);}),t.appendChild(d);const l=document.createElement("button");return l.className="twitter-clean-ui-button twitter-clean-ui-button-secondary",l.textContent=u("importSettings"),l.style.marginTop="12px",l.style.marginLeft="8px",l.addEventListener("click",()=>{const o=document.createElement("input");o.type="file",o.accept="application/json",o.addEventListener("change",async c=>{const h=c.target.files?.[0];if(h){const p=await h.text();this.settingsManager.importSettings(p)?(alert("設定をインポートしました"),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab("profiles")):alert("設定のインポートに失敗しました");}}),o.click();}),t.appendChild(l),e.appendChild(t),e}createSection(e){const t=document.createElement("div");t.className="twitter-clean-ui-section";const i=document.createElement("span");return i.className="twitter-clean-ui-section-title",i.textContent=e,t.appendChild(i),t}createToggleControl(e,t,i){const r=document.createElement("div");r.className="twitter-clean-ui-control";const n=document.createElement("span");n.className="twitter-clean-ui-label",n.textContent=e,r.appendChild(n);const s=document.createElement("div");s.className=`twitter-clean-ui-toggle ${t?"active":""}`;const d=document.createElement("div");return d.className="twitter-clean-ui-toggle-slider",s.appendChild(d),s.addEventListener("click",()=>{const l=s.classList.toggle("active");i(l);}),r.appendChild(s),r}createSliderControl(e,t,i,r,n){const s=document.createElement("div");s.className="twitter-clean-ui-control";const d=document.createElement("span");d.className="twitter-clean-ui-label",d.textContent=e,s.appendChild(d);const l=document.createElement("div");l.className="twitter-clean-ui-slider-container";const o=document.createElement("input");o.type="range",o.className="twitter-clean-ui-slider",o.min=String(i),o.max=String(r),o.value=String(t),l.appendChild(o);const c=document.createElement("span");return c.className="twitter-clean-ui-slider-value",c.textContent=`${t}px`,l.appendChild(c),o.addEventListener("input",()=>{const h=Number(o.value);c.textContent=`${h}px`,n(h);}),s.appendChild(l),s}createFooter(){const e=document.createElement("div");e.className="twitter-clean-ui-footer";const t=document.createElement("button");t.className="twitter-clean-ui-button twitter-clean-ui-button-danger",t.textContent=u("reset"),t.addEventListener("click",()=>{confirm("設定をリセットしますか？")&&(this.settingsManager.reset(),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab("visibility"));}),e.appendChild(t);const i=document.createElement("button");return i.className="twitter-clean-ui-button twitter-clean-ui-button-secondary",i.textContent=u("close"),i.addEventListener("click",()=>this.hide()),e.appendChild(i),e}destroy(){this.hide(),this.styleElement&&this.styleElement.parentNode&&this.styleElement.parentNode.removeChild(this.styleElement);}}class N{detector;controller;settingsManager;settingsUI;isInitialized=false;settingsWatcherInterval=null;mutationObserver=null;applySettingsDebounceTimer=null;constructor(){this.detector=new C,this.controller=new v(this.detector),this.settingsManager=new E,this.settingsUI=new M(this.settingsManager,this.controller);}async initialize(){if(this.isInitialized){console.log("[TwitterCleanUI] Already initialized");return}console.log("[TwitterCleanUI] Initializing...");try{const e=this.settingsManager.getSettings();T(e.language||P()),this.detector.detectAll();const t=this.detector.getStatistics();console.log(`[TwitterCleanUI] Detected ${t.detected}/${t.total} elements`),this.controller.applySettings(e),console.log("[TwitterCleanUI] Settings applied"),this.startMutationObserver(),this.registerMenuCommand(),this.startPromotedTweetsWatcher(),this.startSettingsWatcher(),this.isInitialized=!0,console.log("[TwitterCleanUI] Initialized successfully");}catch(e){console.error("[TwitterCleanUI] Initialization failed:",e);}}startMutationObserver(){this.mutationObserver=new MutationObserver(()=>{this.applySettingsDebounceTimer&&clearTimeout(this.applySettingsDebounceTimer),this.applySettingsDebounceTimer=setTimeout(()=>{this.detector.detectAll(),this.controller.applySettings(this.settingsManager.getSettings());},100);}),this.mutationObserver.observe(document.body,{childList:true,subtree:true});}startSettingsWatcher(){let e=0;const t=setInterval(()=>{this.detector.detectAll(),this.controller.applySettings(this.settingsManager.getSettings()),e++,e>=10&&clearInterval(t);},500);this.settingsWatcherInterval=setInterval(()=>{this.detector.detectAll(),this.controller.applySettings(this.settingsManager.getSettings());},3e3);}registerMenuCommand(){typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand("設定を開く",()=>{this.settingsUI.show();}):(document.addEventListener("keydown",e=>{e.ctrlKey&&e.shiftKey&&e.key==="X"&&(e.preventDefault(),this.settingsUI.show());}),console.log("[TwitterCleanUI] Keyboard shortcut registered: Ctrl + Shift + X"));}startPromotedTweetsWatcher(){this.settingsManager.getSettings().visibility.promotedTweets||setInterval(()=>{this.controller.hideAllPromotedTweets();},2e3);}destroy(){this.settingsWatcherInterval&&clearInterval(this.settingsWatcherInterval),this.applySettingsDebounceTimer&&clearTimeout(this.applySettingsDebounceTimer),this.mutationObserver&&this.mutationObserver.disconnect(),this.detector.stopObserving(),this.controller.destroy(),this.settingsUI.destroy(),this.isInitialized=false,console.log("[TwitterCleanUI] Destroyed");}}function R(){return new Promise(a=>{document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>a()):a();})}function I(a=1e4){return new Promise((e,t)=>{const i=Date.now(),r=()=>{if(document.getElementById("react-root")){e();return}if(Date.now()-i>a){t(new Error("Timeout waiting for react-root"));return}setTimeout(r,100);};r();})}(async()=>{try{console.log("[TwitterCleanUI] Starting..."),await R(),console.log("[TwitterCleanUI] Page loaded"),await I(),console.log("[TwitterCleanUI] React root found");const a=new N;await a.initialize(),window.twitterCleanUI=a;}catch(a){console.error("[TwitterCleanUI] Fatal error:",a);}})();
