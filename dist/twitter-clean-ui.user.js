...
`)}function s(t,n=window.location.pathname){let r=document.getElementById(e);if(!r){r=document.createElement(`style`),r.id=e,r.type=`text/css`;let t=document.head||document.documentElement;if(!t)return;t.appendChild(r)}r.textContent=o(t,n)}function c(){let t=document.getElementById(e);t&&(t.textContent=``)}function l(){document.getElementById(e)?.remove()}function u(e){return e.replace(/\[data-testid="sidebarColumn"\]\s*\{(?=[^}]*display\s*:\s*none)[^}]*\}/g,``)}var d=`twitter_clean_ui_settings`,f=`twitter_clean_ui_css_cache`;function p(e){return typeof e==`object`&&!!e}function m(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return null}}function h(){return typeof GM_getValue<`u`?GM_getValue(d,null):localStorage.getItem(d)}function g(){let e={...n},r=m(h());if(!p(r)||!p(r.settings)||!p(r.settings.visibility))return e;for(let n of t){let t=r.settings.visibility[n];typeof t==`boolean`&&(e[n]=t)}return e}try{s(g())}catch{}var _=[`leftSidebar`,`leftSidebar_Logo`,`leftSidebar_HomeLink`,`leftSidebar_ExploreLink`,`leftSidebar_NotificationsLink`,`leftSidebar_MessagesLink`,`leftSidebar_GrokLink`,`leftSidebar_ConnectLink`,`leftSidebar_BookmarksLink`,`leftSidebar_ListsLink`,`leftSidebar_CommunitiesLink`,`leftSidebar_ProfileLink`,`leftSidebar_PremiumLink`,`leftSidebar_BusinessLink`,`leftSidebar_CreatorStudioLink`,`leftSidebar_AdsLink`,`leftSidebar_CreateSpaceLink`,`leftSidebar_SettingsLink`,`leftSidebar_MoreMenu`,`leftSidebar_TweetButton`,`leftSidebar_ProfileMenu`],v=[`content_TimelineTabs`,`content_PostComposer`,`content_GrokDrawer`,`content_ChatDrawer`,`content_PostReplyAction`,`content_PostRepostAction`,`content_PostLikeAction`,`content_PostAnalyticsAction`,`content_PostBookmarkAction`],y=Object.fromEntries(_.map(e=>[e,!0])),b=Object.fromEntries(v.map(e=>[e,!0])),x={leftSidebar:`header[role="banner"]`,leftSidebar_Logo:`header[role="banner"] h1[role="heading"] a[href="/home"]`,leftSidebar_HomeLink:`header[role="banner"] a[data-testid="AppTabBar_Home_Link"]`,leftSidebar_ExploreLink:`header[role="banner"] a[data-testid="AppTabBar_Explore_Link"]`,leftSidebar_NotificationsLink:`header[role="banner"] a[data-testid="AppTabBar_Notifications_Link"]`,leftSidebar_MessagesLink:`header[role="banner"] a[data-testid="AppTabBar_DirectMessage_Link"]`,leftSidebar_GrokLink:`header[role="banner"] a[href="/i/grok"]`,leftSidebar_ConnectLink:`header[role="banner"] a[data-testid="AppTabBar_Follow_Link"]`,leftSidebar_BookmarksLink:`header[role="banner"] a[href="/i/bookmarks"]`,leftSidebar_ListsLink:`#layers [role="menu"] a[href$="/lists"]`,leftSidebar_CommunitiesLink:`#layers [role="menu"] a[href$="/communities"]`,leftSidebar_ProfileLink:`header[role="banner"] a[data-testid="AppTabBar_Profile_Link"]`,leftSidebar_PremiumLink:`header[role="banner"] a[data-testid="premium-signup-tab"]`,leftSidebar_BusinessLink:`#layers [role="menu"] a[href="/i/verified-orgs-signup"]`,leftSidebar_CreatorStudioLink:`#layers [role="menu"] a[href="/i/jf/creators/studio"]`,leftSidebar_AdsLink:`#layers [role="menu"] a[href^="https://ads.x.com/"]`,leftSidebar_CreateSpaceLink:`#layers [role="menu"] a[href="/i/spaces/start"]`,leftSidebar_SettingsLink:`#layers [role="menu"] a[data-testid="settings"][href="/settings"]`,leftSidebar_MoreMenu:`header[role="banner"] button[data-testid="AppTabBar_More_Menu"]`,leftSidebar_TweetButton:`header[role="banner"] a[data-testid="SideNav_NewTweet_Button"]`,leftSidebar_ProfileMenu:`header[role="banner"] button[data-testid="SideNav_AccountSwitcher_Button"]`},S={content_TimelineTabs:`[data-testid="primaryColumn"] > div > div:has([data-testid="ScrollSnap-List"][role="tablist"]):not(:has([data-testid="tweetTextarea_0"][role="textbox"]))`,content_PostComposer:`[data-testid="primaryColumn"] > div > div:has([data-testid="tweetTextarea_0"][role="textbox"])`,content_GrokDrawer:`[data-testid="GrokDrawer"]`,content_ChatDrawer:`[data-testid="chat-drawer-root"]`,content_PostReplyAction:`article[data-testid="tweet"] [role="group"] > div:has(button[data-testid="reply"])`,content_PostRepostAction:`article[data-testid="tweet"] [role="group"] > div:has(button:is([data-testid="retweet"], [data-testid="unretweet"]))`,content_PostLikeAction:`article[data-testid="tweet"] [role="group"] > div:has(button:is([data-testid="like"], [data-testid="unlike"]))`,content_PostAnalyticsAction:`article[data-testid="tweet"] [role="group"] > div:has(a[href$="/analytics"]), article[data-testid="tweet"] a[href$="/analytics"]`,content_PostBookmarkAction:`article[data-testid="tweet"] [role="group"] > div:has(button:is([data-testid="bookmark"], [data-testid="removeBookmark"]))`},C={visibility:{...y,...n,...b},layout:{mainContentWidth:600,timelineRightPadding:16},enableRealTimePreview:!0,language:`ja`},w={leftSidebar:`左サイドバー全体`,leftSidebar_Logo:`Xロゴ`,leftSidebar_HomeLink:`ホームリンク`,leftSidebar_ExploreLink:`話題を検索リンク`,leftSidebar_NotificationsLink:`通知リンク`,leftSidebar_MessagesLink:`メッセージリンク`,leftSidebar_GrokLink:`Grokリンク`,leftSidebar_ConnectLink:`フォローリンク`,leftSidebar_BookmarksLink:`ブックマークリンク`,leftSidebar_ListsLink:`リストリンク`,leftSidebar_CommunitiesLink:`コミュニティリンク`,leftSidebar_ProfileLink:`プロフィールリンク`,leftSidebar_PremiumLink:`Premiumリンク`,leftSidebar_BusinessLink:`ビジネスリンク`,leftSidebar_CreatorStudioLink:`クリエイタースタジオリンク`,leftSidebar_AdsLink:`広告リンク`,leftSidebar_CreateSpaceLink:`スペース作成リンク`,leftSidebar_SettingsLink:`設定とプライバシーリンク`,leftSidebar_MoreMenu:`もっと見るメニュー`,leftSidebar_TweetButton:`ポスト作成ボタン`,leftSidebar_ProfileMenu:`プロフィールメニュー`},T={rightSidebar:`右サイドバー全体`,rightSidebar_SearchBox:`検索ボックス`,rightSidebar_PremiumSubscribe:`Premiumサブスクライブセクション`,rightSidebar_TrendsList:`トレンド一覧`,rightSidebar_WhoToFollow:`おすすめユーザーセクション`,rightSidebar_TodayNews:`本日のニュースセクション`,rightSidebar_RelatedAccounts:`関連性の高いアカウント`,rightSidebar_Footer:`フッターリンク`},E={content_TimelineTabs:`タイムラインタブ`,content_PostComposer:`ホームの投稿入力欄`,content_GrokDrawer:`Grokドロワー`,content_ChatDrawer:`チャットドロワー`,content_PostReplyAction:`ポストの返信操作`,content_PostRepostAction:`ポストのリポスト操作`,content_PostLikeAction:`ポストのいいね操作`,content_PostAnalyticsAction:`ポストの表示数・アナリティクス`,content_PostBookmarkAction:`ポストのブックマーク操作`};function D(e,t,n,r){return{id:e,category:t,description:n,strategies:[{type:`querySelector`,selector:r,method:`verified CSS selector`,confidence:.95}]}}var O=[..._.map(e=>D(e,`leftSidebar`,w[e],x[e])),...t.map(e=>D(e,`rightSidebar`,T[e],r[e])),...v.map(e=>D(e,`content`,E[e],S[e]))],k=class{detectedElements=new Map;observer=null;detectionCache=new Map;cacheTimestamps=new Map;CACHE_DURATION=3e3;constructor(){this.setupObserver()}setupObserver(){this.observer=new MutationObserver(()=>{this.detectAll()})}startObserving(){this.observer&&this.observer.observe(document.body,{childList:!0,subtree:!0})}stopObserving(){this.observer&&this.observer.disconnect()}getCacheKey(e){return`${e.type}:${e.selector||e.xpath||e.method}`}getFromCache(e){let t=this.getCacheKey(e),n=this.cacheTimestamps.get(t);if(n&&Date.now()-n<this.CACHE_DURATION)return this.detectionCache.get(t)}saveToCache(e,t){let n=this.getCacheKey(e);this.detectionCache.set(n,t),this.cacheTimestamps.set(n,Date.now())}clearCache(){this.detectionCache.clear(),this.cacheTimestamps.clear()}executeStrategy(e){if(e.type!==`custom`){let t=this.getFromCache(e);if(t!==void 0)return t}try{let t=null;switch(e.type){case`querySelector`:if(!e.selector)return null;t=document.querySelector(e.selector);break;case`querySelectorAll`:{if(!e.selector)return null;let n=document.querySelectorAll(e.selector);t=n.length>0?n[0]:null;break}case`xpath`:if(!e.xpath)return null;t=document.evaluate(e.xpath,document,null,XPathResult.FIRST_ORDERED_NODE_TYPE,null).singleNodeValue;break;case`custom`:if(!e.finder)return null;t=e.finder();break;default:return null}return e.type!==`custom`&&this.saveToCache(e,t),t}catch(t){return console.warn(`[ElementDetector] Strategy failed: ${e.method}`,t),null}}detectElement(e){let t=O.find(t=>t.id===e);if(!t)return console.warn(`[ElementDetector] Definition not found: ${e}`),null;for(let n of t.strategies){let t=this.executeStrategy(n);if(t){let r={id:e,element:t,method:n.method,confidence:n.confidence};return this.detectedElements.set(e,r),r}}return this.detectedElements.delete(e),null}detectAll(){for(let e of O)this.detectElement(e.id)}getDetectedElement(e){return this.detectedElements.get(e)||null}getAllDetectedElements(){return new Map(this.detectedElements)}isDetected(e){return this.detectedElements.has(e)}getDetectedCount(){return this.detectedElements.size}getStatistics(){let e=O.length,t=this.detectedElements.size,n=e-t,r=0;return this.detectedElements.forEach(e=>{r+=e.confidence}),{total:e,detected:t,notDetected:n,averageConfidence:t>0?r/t:0}}destroy(){this.stopObserving(),this.detectedElements.clear(),this.clearCache()}},A={article:`article[data-testid="tweet"]`,statusLink:`a[href*="/status/"]`,tweetText:`div[data-testid="tweetText"]`,tweetPhoto:`div[data-testid="tweetPhoto"]`,tweetVideo:`div[data-testid="videoPlayer"]`,mediaCardSmall:`div[data-testid="card.layoutSmall.media"]`,mediaCardLarge:`div[data-testid="card.layoutLarge.media"]`,userName:`div[data-testid="User-Name"]`,userNameLinkSpan:`div[data-testid="User-Name"] a[role="link"] span`,quotedLink:`[data-testid="tweetQuotedLink"]`,tweetButtonsWithinArticle:`[data-testid="tweet"] [role="button"]`,tweetContainerCandidates:`[data-testid="cellInnerDiv"], [data-testid="tweet"], article`,tweetObserverTargets:`[data-testid="tweet"], [id^=id__], article[role="article"]`,tweetCandidates:`[data-testid="tweet"], [id^=id__]`,tweetRoot:`[data-testid="tweet"]`,retweetIndicator:`.r-15zivkp`,timelineMain:`main[role="main"]`,muteKeywordSpan:`div[role='link'] > div > div[dir='ltr']:first-child > span`,userLink:`a[role="link"][href^="/"]`,quotedAuthor:`div[dir="ltr"] > span`,quotedHandle:`div[dir="ltr"] span:nth-child(2)`,roleLink:`div[role="link"]`,roleGroup:`[role="group"]`,tweetMediaImage:`img[src*="pbs.twimg.com/media"]`,tweetMediaImageAlt:`img[src*="ton.twimg.com/media"]`};A.tweetPhoto,A.tweetVideo,A.mediaCardSmall,A.mediaCardLarge,[A.tweetMediaImage,A.tweetMediaImageAlt].join(`, `);var j={timelineContainer:`[data-testid="primaryColumn"] div:has(> [data-testid="cellInnerDiv"])`};function M(){let e=window.location.pathname;return e===`/settings`||e.startsWith(`/settings/`)}var N=class e{static STYLE_ELEMENT_ID=`twitter-clean-ui-static-styles`;styleElement;currentCSS=``;constructor(){this.styleElement=this.findOrCreateStyleElement()}findOrCreateStyleElement(){return document.getElementById(e.STYLE_ELEMENT_ID)||this.createStyleElement()}createStyleElement(){let t=document.createElement(`style`);return t.id=e.STYLE_ELEMENT_ID,t.type=`text/css`,(document.head||document.documentElement).appendChild(t),t}generateSelector(e){let t=O.find(t=>t.id===e);if(!t)return``;let n=t.strategies[0];if(!n)return``;switch(n.type){case`querySelector`:case`querySelectorAll`:return n.selector||``;case`xpath`:return``;case`custom`:return``;default:return``}}generateVisibilityCSS(e){let t=[],{visibility:n}=e;return Object.entries(n).forEach(([e,n])=>{let r=e;if(!i(r)&&n===!1){let e=this.generateSelector(r);e&&t.push(`${e} { display: none !important; }`)}}),t.join(`
...
`,Y=class{settingsManager;controller;overlay=null;styleElement=null;constructor(e,t){this.settingsManager=e,this.controller=t,this.injectStyles()}injectStyles(){this.styleElement||(this.styleElement=document.createElement(`style`),this.styleElement.textContent=J,document.head.appendChild(this.styleElement))}show(){this.overlay||(this.overlay=this.createOverlay(),this.overlay.dir=`auto`,document.body.appendChild(this.overlay),setTimeout(()=>{this.showTab(`visibility`)},0))}hide(){this.overlay&&=(this.overlay.remove(),null)}createOverlay(){let e=document.createElement(`div`);e.className=`twitter-clean-ui-overlay`,e.addEventListener(`click`,t=>{t.target===e&&this.hide()});let t=this.createModal();return e.appendChild(t),e}createModal(){let e=document.createElement(`div`);e.className=`twitter-clean-ui-modal`;let t=this.createHeader();e.appendChild(t);let n=this.createTabs();e.appendChild(n);let r=document.createElement(`div`);r.className=`twitter-clean-ui-body`,r.id=`twitter-clean-ui-body`,e.appendChild(r);let i=this.createFooter();return e.appendChild(i),e}createHeader(){let e=document.createElement(`div`);e.className=`twitter-clean-ui-header`;let t=document.createElement(`h2`);t.className=`twitter-clean-ui-title`,t.textContent=q(`appName`),e.appendChild(t);let n=document.createElement(`button`);return n.className=`twitter-clean-ui-close`,n.textContent=`×`,n.addEventListener(`click`,()=>this.hide()),e.appendChild(n),e}createTabs(){let e=document.createElement(`div`);return e.className=`twitter-clean-ui-tabs`,[{id:`visibility`,label:q(`leftSidebarSettings`)},{id:`rightSidebar`,label:q(`rightSidebarSettings`)},{id:`content`,label:q(`contentSettings`)},{id:`layout`,label:q(`layoutSettings`)},{id:`profiles`,label:q(`profileSettings`)}].forEach((t,n)=>{let r=document.createElement(`button`);r.className=`twitter-clean-ui-tab ${n===0?`active`:``}`,r.textContent=t.label,r.addEventListener(`click`,()=>{e.querySelectorAll(`.twitter-clean-ui-tab`).forEach(e=>{e.classList.remove(`active`)}),r.classList.add(`active`),this.showTab(t.id)}),e.appendChild(r)}),e}showTab(e){let t=document.getElementById(`twitter-clean-ui-body`);if(t)switch(t.innerHTML=``,e){case`visibility`:t.appendChild(this.createVisibilityTab());break;case`rightSidebar`:t.appendChild(this.createRightSidebarTab());break;case`content`:t.appendChild(this.createContentTab());break;case`layout`:t.appendChild(this.createLayoutTab());break;case`profiles`:t.appendChild(this.createProfilesTab());break}}createVisibilityTab(){let e=document.createElement(`div`),t=this.settingsManager.getSettings(),n=this.createSection(q(`leftSidebarSettings`));return[..._].forEach(e=>{let r=t.visibility,i=this.createToggleControl(q(e),r[e]??!0,t=>{let n={[e]:t};this.settingsManager.updateSettings({visibility:n}),this.settingsManager.getSettings().enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings())});n.appendChild(i)}),e.appendChild(n),e}createRightSidebarTab(){let e=document.createElement(`div`),n=this.settingsManager.getSettings(),r=this.createSection(q(`rightSidebarSettings`));return[...t].forEach(e=>{let t=n.visibility,i=this.createToggleControl(q(e),t[e]??!0,t=>{let n={[e]:t};this.settingsManager.updateSettings({visibility:n}),this.settingsManager.getSettings().enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings())});r.appendChild(i)}),e.appendChild(r),e}createContentTab(){let e=document.createElement(`div`),t=this.settingsManager.getSettings(),n=this.createSection(q(`contentSettings`));return v.forEach(e=>{let r=this.createToggleControl(q(e),t.visibility[e],t=>{this.settingsManager.updateSettings({visibility:{...this.settingsManager.getSettings().visibility,[e]:t}}),this.settingsManager.getSettings().enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings())});n.appendChild(r)}),e.appendChild(n),e}createLayoutTab(){let e=document.createElement(`div`),t=this.settingsManager.getSettings(),n=this.createSection(q(`layoutSettings`)),r=this.createSliderControl(q(`mainContentWidth`),t.layout.mainContentWidth,500,1200,e=>{let t={mainContentWidth:e};this.settingsManager.updateSettings({layout:t}),this.settingsManager.getSettings().enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings())});n.appendChild(r);let i=this.createSliderControl(q(`timelineRightPadding`),t.layout.timelineRightPadding,0,100,e=>{let t={timelineRightPadding:e};this.settingsManager.updateSettings({layout:t}),this.settingsManager.getSettings().enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings())});n.appendChild(i);let a=this.createToggleControl(q(`enableRealTimePreview`),t.enableRealTimePreview,e=>{this.settingsManager.updateSettings({enableRealTimePreview:e}),e&&this.controller.applySettings(this.settingsManager.getSettings())});return n.appendChild(a),e.appendChild(n),e}createProfilesTab(){let e=document.createElement(`div`),t=this.createSection(q(`profileSettings`)),n=this.settingsManager.getAllProfiles(),r=this.settingsManager.getCurrentProfileId(),i=document.createElement(`ul`);i.className=`twitter-clean-ui-profile-list`,n.forEach(e=>{let t=document.createElement(`li`);t.className=`twitter-clean-ui-profile-item ${e.id===r?`active`:``}`;let n=document.createElement(`span`);n.className=`twitter-clean-ui-profile-name`,n.textContent=e.name,t.appendChild(n);let a=document.createElement(`div`);if(a.className=`twitter-clean-ui-profile-actions`,e.id!==r){let t=document.createElement(`button`);t.className=`twitter-clean-ui-icon-button`,t.textContent=`✓`,t.title=q(`switchProfile`),t.addEventListener(`click`,t=>{t.stopPropagation(),this.settingsManager.switchProfile(e.id),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab(`profiles`)}),a.appendChild(t)}if(e.id!=="default"){let t=document.createElement(`button`);t.className=`twitter-clean-ui-icon-button`,t.textContent=q(`deleteButton`),t.title=q(`deleteProfile`),t.addEventListener(`click`,t=>{t.stopPropagation(),confirm(q(`deleteProfileConfirm`).replace(`{name}`,e.name))&&(this.settingsManager.deleteProfile(e.id),this.showTab(`profiles`))}),a.appendChild(t)}t.appendChild(a),i.appendChild(t)}),t.appendChild(i);let a=document.createElement(`button`);a.className=`twitter-clean-ui-button twitter-clean-ui-button-primary`,a.textContent=q(`createNewProfile`),a.style.marginTop=`12px`,a.addEventListener(`click`,()=>{let e=prompt(q(`enterProfileName`));e&&(this.settingsManager.createProfile(e),this.showTab(`profiles`))}),t.appendChild(a);let o=document.createElement(`button`);o.className=`twitter-clean-ui-button twitter-clean-ui-button-secondary`,o.textContent=q(`exportSettings`),o.style.marginTop=`12px`,o.addEventListener(`click`,()=>{let e=this.settingsManager.exportSettings(),t=new Blob([e],{type:`application/json`}),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`twitter-clean-ui-settings-${Date.now()}.json`,r.click(),URL.revokeObjectURL(n)}),t.appendChild(o);let s=document.createElement(`button`);return s.className=`twitter-clean-ui-button twitter-clean-ui-button-secondary`,s.textContent=q(`importSettings`),s.style.marginTop=`12px`,s.style.marginLeft=`8px`,s.addEventListener(`click`,()=>{let e=document.createElement(`input`);e.type=`file`,e.accept=`application/json`,e.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(t){let e=await t.text();this.settingsManager.importSettings(e)?(alert(q(`importSucceeded`)),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab(`profiles`)):alert(q(`importFailed`))}}),e.click()}),t.appendChild(s),e.appendChild(t),e}createSection(e){let t=document.createElement(`div`);t.className=`twitter-clean-ui-section`;let n=document.createElement(`span`);return n.className=`twitter-clean-ui-section-title`,n.textContent=e,t.appendChild(n),t}createToggleControl(e,t,n){let r=document.createElement(`div`);r.className=`twitter-clean-ui-control`;let i=document.createElement(`span`);i.className=`twitter-clean-ui-label`,i.textContent=e,r.appendChild(i);let a=document.createElement(`div`);a.className=`twitter-clean-ui-toggle ${t?`active`:``}`;let o=document.createElement(`div`);return o.className=`twitter-clean-ui-toggle-slider`,a.appendChild(o),a.addEventListener(`click`,()=>{n(a.classList.toggle(`active`))}),r.appendChild(a),r}createSliderControl(e,t,n,r,i){let a=document.createElement(`div`);a.className=`twitter-clean-ui-control`;let o=document.createElement(`span`);o.className=`twitter-clean-ui-label`,o.textContent=e,a.appendChild(o);let s=document.createElement(`div`);s.className=`twitter-clean-ui-slider-container`;let c=document.createElement(`input`);c.type=`range`,c.className=`twitter-clean-ui-slider`,c.min=String(n),c.max=String(r),c.value=String(t),s.appendChild(c);let l=document.createElement(`span`);return l.className=`twitter-clean-ui-slider-value`,l.textContent=`${t}px`,s.appendChild(l),c.addEventListener(`input`,()=>{let e=Number(c.value);l.textContent=`${e}px`,i(e)}),a.appendChild(s),a}createFooter(){let e=document.createElement(`div`);e.className=`twitter-clean-ui-footer`;let t=document.createElement(`button`);t.className=`twitter-clean-ui-button twitter-clean-ui-button-danger`,t.textContent=q(`reset`),t.addEventListener(`click`,()=>{confirm(q(`resetSettingsConfirm`))&&(this.settingsManager.reset(),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab(`visibility`))}),e.appendChild(t);let n=document.createElement(`button`);return n.className=`twitter-clean-ui-button twitter-clean-ui-button-secondary`,n.textContent=q(`close`),n.addEventListener(`click`,()=>this.hide()),e.appendChild(n),e}destroy(){this.hide(),this.styleElement&&this.styleElement.parentNode&&this.styleElement.parentNode.removeChild(this.styleElement)}};try{let e=null;if(e=typeof GM_getValue<`u`?GM_getValue(f,null):localStorage.getItem(f),e){let t=document.createElement(`style`);t.id=N.STYLE_ELEMENT_ID,t.type=`text/css`,t.textContent=u(e),(document.head||document.documentElement).appendChild(t)}}catch{}var X=class{detector;controller;settingsManager;settingsUI;isInitialized=!1;primaryMutationObserver=null;applySettingsDebounceTimer=null;rafId=null;lastUrl=``;isApplyingSettings=!1;primaryObservingBody=!1;constructor(){this.detector=new k,this.controller=new P(this.detector),this.settingsManager=new F,this.settingsUI=new Y(this.settingsManager,this.controller),this.lastUrl=location.href}async initialize(){if(!this.isInitialized)try{await this.settingsManager.initialize();let e=this.settingsManager.getSettings();G(e.language||K()),this.guardedApplySettings(e),this.startPrimaryMutationObserver(),this.registerMenuCommand(),this.setupNavigationInterception(),this.isInitialized=!0}catch(e){console.error(`[TwitterCleanUI] Initialization failed:`,e)}}guardedApplySettings(e){this.isApplyingSettings=!0;try{this.detector.detectAll(),e?this.controller.applySettings(e):this.controller.reapplySettings()}finally{this.isApplyingSettings=!1}}setupNavigationInterception(){let e=()=>{let e=location.href;e!==this.lastUrl&&(this.lastUrl=e,this.handleNavigation())},t=history.pushState.bind(history);history.pushState=(...n)=>{t(...n),e()};let n=history.replaceState.bind(history);history.replaceState=(...t)=>{n(...t),e()},window.addEventListener(`popstate`,()=>{e()})}handleNavigation(){this.guardedApplySettings()}startPrimaryMutationObserver(){this.primaryMutationObserver=new MutationObserver(()=>{this.isApplyingSettings||(this.rafId!==null&&cancelAnimationFrame(this.rafId),this.rafId=requestAnimationFrame(()=>{this.applySettingsDebounceTimer&&clearTimeout(this.applySettingsDebounceTimer),this.applySettingsDebounceTimer=setTimeout(()=>{this.guardedApplySettings(),this.reattachPrimaryObserverIfNeeded(),this.rafId=null},500)}))}),this.attachPrimaryObserver()}attachPrimaryObserver(){if(!this.primaryMutationObserver)return;this.primaryMutationObserver.disconnect();let e=document.querySelector(`[data-testid="primaryColumn"]`),t=e??document.body;this.primaryObservingBody=!e,this.primaryMutationObserver.observe(t,{childList:!0,subtree:!0})}reattachPrimaryObserverIfNeeded(){this.primaryObservingBody&&document.querySelector(`[data-testid="primaryColumn"]`)&&this.attachPrimaryObserver()}registerMenuCommand(){typeof GM_registerMenuCommand<`u`?GM_registerMenuCommand(q(`openSettings`),()=>{this.settingsUI.show()}):document.addEventListener(`keydown`,e=>{e.ctrlKey&&e.shiftKey&&e.key===`X`&&(e.preventDefault(),this.settingsUI.show())})}destroy(){this.applySettingsDebounceTimer&&clearTimeout(this.applySettingsDebounceTimer),this.rafId!==null&&cancelAnimationFrame(this.rafId),this.primaryMutationObserver&&this.primaryMutationObserver.disconnect(),this.detector.stopObserving(),this.controller.destroy(),this.settingsUI.destroy(),this.isInitialized=!1}};function Z(){return new Promise(e=>{document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>e()):e()})}function Q(e=1e4){return new Promise((t,n)=>{let r=Date.now(),i=()=>{if(document.getElementById(`react-root`)){t();return}if(Date.now()-r>e){n(Error(`Timeout waiting for react-root`));return}setTimeout(i,100)};i()})}(async()=>{try{await Z(),await Q();let e=new X;await e.initialize(),window.twitterCleanUI=e}catch(e){console.error(`[TwitterCleanUI] Fatal error:`,e)}})()})();
