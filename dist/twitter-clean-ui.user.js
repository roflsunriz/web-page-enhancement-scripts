...
`;class L{settingsManager;controller;overlay=null;styleElement=null;constructor(e,t){this.settingsManager=e,this.controller=t,this.injectStyles();}injectStyles(){this.styleElement||(this.styleElement=document.createElement("style"),this.styleElement.textContent=T,document.head.appendChild(this.styleElement));}show(){this.overlay||(this.overlay=this.createOverlay(),document.body.appendChild(this.overlay),setTimeout(()=>{this.showTab("visibility");},0));}hide(){this.overlay&&(this.overlay.remove(),this.overlay=null);}createOverlay(){const e=document.createElement("div");e.className="twitter-clean-ui-overlay",e.addEventListener("click",i=>{i.target===e&&this.hide();});const t=this.createModal();return e.appendChild(t),e}createModal(){const e=document.createElement("div");e.className="twitter-clean-ui-modal";const t=this.createHeader();e.appendChild(t);const i=this.createTabs();e.appendChild(i);const n=document.createElement("div");n.className="twitter-clean-ui-body",n.id="twitter-clean-ui-body",e.appendChild(n);const r=this.createFooter();return e.appendChild(r),e}createHeader(){const e=document.createElement("div");e.className="twitter-clean-ui-header";const t=document.createElement("h2");t.className="twitter-clean-ui-title",t.textContent=u("appName"),e.appendChild(t);const i=document.createElement("button");return i.className="twitter-clean-ui-close",i.textContent="×",i.addEventListener("click",()=>this.hide()),e.appendChild(i),e}createTabs(){const e=document.createElement("div");return e.className="twitter-clean-ui-tabs",[{id:"visibility",label:u("leftSidebarSettings")},{id:"rightSidebar",label:u("rightSidebarSettings")},{id:"layout",label:u("layoutSettings")},{id:"profiles",label:u("profileSettings")}].forEach((i,n)=>{const r=document.createElement("button");r.className=`twitter-clean-ui-tab ${n===0?"active":""}`,r.textContent=i.label,r.addEventListener("click",()=>{e.querySelectorAll(".twitter-clean-ui-tab").forEach(s=>{s.classList.remove("active");}),r.classList.add("active"),this.showTab(i.id);}),e.appendChild(r);}),e}showTab(e){const t=document.getElementById("twitter-clean-ui-body");if(t)switch(t.innerHTML="",e){case "visibility":t.appendChild(this.createVisibilityTab());break;case "rightSidebar":t.appendChild(this.createRightSidebarTab());break;case "layout":t.appendChild(this.createLayoutTab());break;case "profiles":t.appendChild(this.createProfilesTab());break}}createVisibilityTab(){const e=document.createElement("div"),t=this.settingsManager.getSettings(),i=this.createSection(u("leftSidebarSettings"));["leftSidebar_Logo","leftSidebar_HomeLink","leftSidebar_ExploreLink","leftSidebar_NotificationsLink","leftSidebar_MessagesLink","leftSidebar_BookmarksLink","leftSidebar_ListsLink","leftSidebar_ProfileLink","leftSidebar_PremiumLink","leftSidebar_MoreMenu","leftSidebar_TweetButton","leftSidebar_ProfileMenu"].forEach(l=>{const o=t.visibility,d=this.createToggleControl(u(l),o[l]??true,p=>{const g={[l]:p};this.settingsManager.updateSettings({visibility:g}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});i.appendChild(d);}),e.appendChild(i);const r=this.createSection(u("mainContentSettings")),s=this.createToggleControl(u("mainContent_TweetComposer"),t.visibility.mainContent_TweetComposer,l=>{const o={mainContent_TweetComposer:l};this.settingsManager.updateSettings({visibility:o}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});r.appendChild(s);const c=this.createToggleControl(u("promotedTweets"),t.visibility.promotedTweets,l=>{const o={promotedTweets:l};this.settingsManager.updateSettings({visibility:o}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});return r.appendChild(c),e.appendChild(r),e}createRightSidebarTab(){const e=document.createElement("div"),t=this.settingsManager.getSettings(),i=this.createSection(u("rightSidebarSettings"));return ["rightSidebar","rightSidebar_SearchBox","rightSidebar_PremiumSubscribe","rightSidebar_TrendsList","rightSidebar_WhoToFollow","rightSidebar_Footer"].forEach(r=>{const s=t.visibility,c=this.createToggleControl(u(r),s[r]??true,l=>{const o={[r]:l};this.settingsManager.updateSettings({visibility:o}),t.enableRealTimePreview&&this.controller.applySettings(this.settingsManager.getSettings());});i.appendChild(c);}),e.appendChild(i),e}createLayoutTab(){const e=document.createElement("div"),t=this.settingsManager.getSettings(),i=this.createSection(u("layoutSettings")),n=this.createSliderControl(u("leftSidebarWidth"),t.layout.leftSidebarWidth,200,400,d=>{const p={leftSidebarWidth:d};this.settingsManager.updateSettings({layout:p}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(n);const r=this.createSliderControl(u("mainContentWidth"),t.layout.mainContentWidth,500,1200,d=>{const p={mainContentWidth:d};this.settingsManager.updateSettings({layout:p}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(r);const s=this.createSliderControl(u("rightSidebarWidth"),t.layout.rightSidebarWidth,300,500,d=>{const p={rightSidebarWidth:d};this.settingsManager.updateSettings({layout:p}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(s);const c=this.createSliderControl(u("timelineRightPadding"),t.layout.timelineRightPadding,0,100,d=>{const p={timelineRightPadding:d};this.settingsManager.updateSettings({layout:p}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(c);const l=this.createSliderControl(u("gap"),t.layout.gap,0,60,d=>{const p={gap:d};this.settingsManager.updateSettings({layout:p}),t.enableRealTimePreview&&this.controller.applyLayout(this.settingsManager.getSettings());});i.appendChild(l);const o=this.createToggleControl(u("enableRealTimePreview"),t.enableRealTimePreview,d=>{this.settingsManager.updateSettings({enableRealTimePreview:d});});return i.appendChild(o),e.appendChild(i),e}createProfilesTab(){const e=document.createElement("div"),t=this.createSection(u("profileSettings")),i=this.settingsManager.getAllProfiles(),n=this.settingsManager.getCurrentProfileId(),r=document.createElement("ul");r.className="twitter-clean-ui-profile-list",i.forEach(o=>{const d=document.createElement("li");d.className=`twitter-clean-ui-profile-item ${o.id===n?"active":""}`;const p=document.createElement("span");p.className="twitter-clean-ui-profile-name",p.textContent=o.name,d.appendChild(p);const g=document.createElement("div");if(g.className="twitter-clean-ui-profile-actions",o.id!==n){const h=document.createElement("button");h.className="twitter-clean-ui-icon-button",h.textContent="✓",h.title="切り替え",h.addEventListener("click",b=>{b.stopPropagation(),this.settingsManager.switchProfile(o.id),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab("profiles");}),g.appendChild(h);}if(o.id!=="default"){const h=document.createElement("button");h.className="twitter-clean-ui-icon-button",h.textContent="🗑",h.title="削除",h.addEventListener("click",b=>{b.stopPropagation(),confirm(`${o.name} を削除しますか？`)&&(this.settingsManager.deleteProfile(o.id),this.showTab("profiles"));}),g.appendChild(h);}d.appendChild(g),r.appendChild(d);}),t.appendChild(r);const s=document.createElement("button");s.className="twitter-clean-ui-button twitter-clean-ui-button-primary",s.textContent=u("createNewProfile"),s.style.marginTop="12px",s.addEventListener("click",()=>{const o=prompt("プロファイル名を入力してください:");o&&(this.settingsManager.createProfile(o),this.showTab("profiles"));}),t.appendChild(s);const c=document.createElement("button");c.className="twitter-clean-ui-button twitter-clean-ui-button-secondary",c.textContent=u("exportSettings"),c.style.marginTop="12px",c.addEventListener("click",()=>{const o=this.settingsManager.exportSettings(),d=new Blob([o],{type:"application/json"}),p=URL.createObjectURL(d),g=document.createElement("a");g.href=p,g.download=`twitter-clean-ui-settings-${Date.now()}.json`,g.click(),URL.revokeObjectURL(p);}),t.appendChild(c);const l=document.createElement("button");return l.className="twitter-clean-ui-button twitter-clean-ui-button-secondary",l.textContent=u("importSettings"),l.style.marginTop="12px",l.style.marginLeft="8px",l.addEventListener("click",()=>{const o=document.createElement("input");o.type="file",o.accept="application/json",o.addEventListener("change",async d=>{const p=d.target.files?.[0];if(p){const g=await p.text();this.settingsManager.importSettings(g)?(alert("設定をインポートしました"),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab("profiles")):alert("設定のインポートに失敗しました");}}),o.click();}),t.appendChild(l),e.appendChild(t),e}createSection(e){const t=document.createElement("div");t.className="twitter-clean-ui-section";const i=document.createElement("span");return i.className="twitter-clean-ui-section-title",i.textContent=e,t.appendChild(i),t}createToggleControl(e,t,i){const n=document.createElement("div");n.className="twitter-clean-ui-control";const r=document.createElement("span");r.className="twitter-clean-ui-label",r.textContent=e,n.appendChild(r);const s=document.createElement("div");s.className=`twitter-clean-ui-toggle ${t?"active":""}`;const c=document.createElement("div");return c.className="twitter-clean-ui-toggle-slider",s.appendChild(c),s.addEventListener("click",()=>{const l=s.classList.toggle("active");i(l);}),n.appendChild(s),n}createSliderControl(e,t,i,n,r){const s=document.createElement("div");s.className="twitter-clean-ui-control";const c=document.createElement("span");c.className="twitter-clean-ui-label",c.textContent=e,s.appendChild(c);const l=document.createElement("div");l.className="twitter-clean-ui-slider-container";const o=document.createElement("input");o.type="range",o.className="twitter-clean-ui-slider",o.min=String(i),o.max=String(n),o.value=String(t),l.appendChild(o);const d=document.createElement("span");return d.className="twitter-clean-ui-slider-value",d.textContent=`${t}px`,l.appendChild(d),o.addEventListener("input",()=>{const p=Number(o.value);d.textContent=`${p}px`,r(p);}),s.appendChild(l),s}createFooter(){const e=document.createElement("div");e.className="twitter-clean-ui-footer";const t=document.createElement("button");t.className="twitter-clean-ui-button twitter-clean-ui-button-danger",t.textContent=u("reset"),t.addEventListener("click",()=>{confirm("設定をリセットしますか？")&&(this.settingsManager.reset(),this.controller.applySettings(this.settingsManager.getSettings()),this.showTab("visibility"));}),e.appendChild(t);const i=document.createElement("button");return i.className="twitter-clean-ui-button twitter-clean-ui-button-secondary",i.textContent=u("close"),i.addEventListener("click",()=>this.hide()),e.appendChild(i),e}destroy(){this.hide(),this.styleElement&&this.styleElement.parentNode&&this.styleElement.parentNode.removeChild(this.styleElement);}}class M{detector;controller;settingsManager;settingsUI;isInitialized=false;constructor(){this.detector=new w,this.controller=new E(this.detector),this.settingsManager=new C,this.settingsUI=new L(this.settingsManager,this.controller);}async initialize(){if(this.isInitialized){console.log("[TwitterCleanUI] Already initialized");return}console.log("[TwitterCleanUI] Initializing...");try{const e=this.settingsManager.getSettings();P(e.language||_()),this.detector.detectAll();const t=this.detector.getStatistics();console.log(`[TwitterCleanUI] Detected ${t.detected}/${t.total} elements`),this.controller.applySettings(e),console.log("[TwitterCleanUI] Settings applied"),this.detector.startObserving(),this.registerMenuCommand(),this.startPromotedTweetsWatcher(),this.isInitialized=!0,console.log("[TwitterCleanUI] Initialized successfully");}catch(e){console.error("[TwitterCleanUI] Initialization failed:",e);}}registerMenuCommand(){typeof GM_registerMenuCommand<"u"?GM_registerMenuCommand("設定を開く",()=>{this.settingsUI.show();}):(document.addEventListener("keydown",e=>{e.ctrlKey&&e.shiftKey&&e.key==="X"&&(e.preventDefault(),this.settingsUI.show());}),console.log("[TwitterCleanUI] Keyboard shortcut registered: Ctrl + Shift + X"));}startPromotedTweetsWatcher(){this.settingsManager.getSettings().visibility.promotedTweets||setInterval(()=>{this.controller.hideAllPromotedTweets();},2e3);}destroy(){this.detector.stopObserving(),this.controller.destroy(),this.settingsUI.destroy(),this.isInitialized=false,console.log("[TwitterCleanUI] Destroyed");}}function N(){return new Promise(a=>{document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>a()):a();})}function R(a=1e4){return new Promise((e,t)=>{const i=Date.now(),n=()=>{if(document.getElementById("react-root")){e();return}if(Date.now()-i>a){t(new Error("Timeout waiting for react-root"));return}setTimeout(n,100);};n();})}(async()=>{try{console.log("[TwitterCleanUI] Starting..."),await N(),console.log("[TwitterCleanUI] Page loaded"),await R(),console.log("[TwitterCleanUI] React root found");const a=new M;await a.initialize(),window.twitterCleanUI=a;}catch(a){console.error("[TwitterCleanUI] Fatal error:",a);}})();
