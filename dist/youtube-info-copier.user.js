...
(function () {
  ...
  const x={debug:"debug",info:"info",warn:"warn",error:"error"},w=o=>{const e=`[${o}]`,t={};return Object.keys(x).forEach(n=>{const r=x[n];t[n]=(...i)=>{(console[r]??console.log)(e,...i);};}),t},f=new WeakMap;function E(o){const{trustedTypes:e}=o;return !e||typeof e.createPolicy!="function"?null:e}function k(o,e){let t=f.get(o);t||(t=new Map,f.set(o,t));const n=t.get(e);if(n)return n;const r=o.createPolicy(e,{createHTML:i=>i});return r?(t.set(e,r),r):null}function S(o,e,t=window){const n=E(t);if(!n)return o;const r=k(n,e);return r?r.createHTML(o):o}function L(o,e,t){const r=(o.ownerDocument??document).defaultView??window,i=S(e,t,r);if(typeof i=="string"){o.innerHTML=i;return}o.innerHTML=i;}const T=w("youtube-info-copier:dom-utils");async function C(o=4e3){const e=Date.now(),n=["#description","ytd-expander#description","#meta-contents #description","#meta-contents"].map(a=>document.querySelector(a)).find(Boolean);if(!n)return;const r=()=>{const a=n.querySelector("ytd-text-inline-expander")||document.querySelector("ytd-text-inline-expander#description-inline-expander");if(a?.hasAttribute("is-expanded"))return  true;const s=/(もっと見る|もっと表示|もっと読む|Show more|SHOW MORE|More|一部を表示|…|...もっと見る)/i,c=[];a&&c.push(...Array.from(a.querySelectorAll("tp-yt-paper-button, button, a"))),c.push(...Array.from(document.querySelectorAll("tp-yt-paper-button, button, a")));for(const l of c)try{const h=(l.textContent||"").trim();if((l.getAttribute("aria-expanded")==="false"||s.test(h)||l.id&&/expand|more|collapse/i.test(l.id))&&typeof l.click=="function")return l.click(),T.info("概要欄の「もっと見る」ボタンをクリックしました。"),!0}catch{}return  false},i=()=>(n.querySelector("ytd-text-inline-expander")||document.querySelector("ytd-text-inline-expander#description-inline-expander"))?.hasAttribute("is-expanded")?true:(n.textContent||"").trim().length>200||n.querySelectorAll("span").length>3;if(i())return;const u=(n.textContent||"").length;if(r())return new Promise(a=>{const s=setInterval(()=>{const c=(n.textContent||"").length;(i()||c>u+20||Date.now()-e>o)&&(clearInterval(s),a());},80);})}var M="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",q="M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z",H="M7,2V13H10V22L17,10H13L17,2H7Z",F="M21,16H3V4H21M21,2H3C1.89,2 1,2.89 1,4V16A2,2 0 0,0 3,18H10V20H8V22H16V20H14V18H21A2,2 0 0,0 23,16V4C23,2.89 22.1,2 21,2Z";function g(o,e=24){const t=String(e),n=String(e);return `<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${n}" viewBox="0 0 24 24" fill="currentColor" role="img" aria-hidden="true" focusable="false"><path d="${o}"></path></svg>`}const I=g(F),V=g(q),R=g(H),A=g(M),P="youtube-info-copier-template";function z(){return `
    <style>
