...
export const DEFAULT_SETTINGS: YoutubeUiModifierSettings = {
  ...
  hideHomepageSuggestions: true,
  showHomepageRevealBox: true,
...
export const CATEGORIES: ReadonlyArray<YoutubeUiModifierCategoryDefinition> = [
  {
    ...
    options: [
      ...
      },
      {
        id: 'hideAds',
        label: '広告枠を隠す',
        description: 'ページ内の広告コンテナやプロモーション枠を非表示にします。',
      },
      {
        id: 'hideAllShorts',
        label: 'Shortsを隠す',
        description: 'ナビゲーション、棚、検索結果、動画カード内のShortsを隠します。',
      },
      {
      ...
      },
      {
        id: 'searchEngineMode',
        label: '検索エンジンモード',
        description: '検索バーと検索結果を中心に残し、YouTubeの他領域を抑制します。',
      },
      {
        id: 'scheduleEnabled',
        label: '平日の日中だけ有効化',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description: 'ホームのおすすめ非表示時に、一時表示用のボックスを表示します。',
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        label: '関連動画タグを絞る',
        description: '関連動画上部のタグを「All」「Related」相当だけに絞ります。',
      },
      {
        id: 'hideEndScreen',
        label: '終了画面のおすすめを隠す',
      ...
      },
      {
        ...
        description: '終了画面のおすすめ非表示時に、一時表示用のボックスを表示します。',
      },
      {
        id: 'hideInfoCards',
        label: '情報カードを隠す',
      ...
      },
      {
        id: 'autoSkipAds',
        label: '広告をスキップ・閉じる',
        description: 'スキップ可能な広告ボタンやオーバーレイ広告の閉じるボタンを押します。',
      },
      {
        id: 'disableAutoplay',
        label: '自動再生を無効化',
      ...
      },
      {
        ...
        label: 'アンビエントモードを無効化',
        description: 'プレイヤー設定メニュー内のアンビエントモードを可能な範囲でオフにします。',
      },
      {
        id: 'disableAnnotations',
        label: 'アノテーションを無効化',
        description: 'プレイヤー設定メニュー内のアノテーションを可能な範囲でオフにします。',
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description: '検索結果などのサムネイルスライドショー演出を非表示にします。',
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        label: 'プレイリストだけ表示',
        description: '左ナビでプレイリスト以外の主要リンクやセクションを抑制します。',
      },
      {
        id: 'disableLogoLink',
      ...
      },
      {
        ...
        description: '左ドロワーのMore from YouTube相当のセクションを非表示にします。',
      },
      {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description: '登録チャンネルページのMost relevantセクションを非表示にします。',
      },
      {
      ...
      },
      {
        ...
        label: '配信アーカイブを隠す',
        description: '登録チャンネルページのStreamed表記の動画を非表示にします。',
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        label: 'ホームをYouページへ',
        description: 'ホームアクセス時にYou/ライブラリ相当のページへ移動します。',
      },
    ],
  },
  {
    ...
    options: [
      ...
      },
      {
        id: 'hideContextBoxes',
        label: 'コンテキストボックスを隠す',
        description: '情報パネルや補足カードなどの文脈ボックスを非表示にします。',
      },
      {
