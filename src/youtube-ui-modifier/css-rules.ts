...
export const CSS_RULES: Partial<Record<YoutubeUiModifierSettingId, ReadonlyArray<string>>> = {
  hideAds: [
    '#masthead-ad',
  ...
  hideVideoThumbnails: ['ytd-thumbnail', 'yt-thumbnail-view-model', 'ytd-playlist-thumbnail'],
  ...
  hideWatchSidebar: ['#secondary > div.circle', '#related', 'ytm-item-section-renderer[section-identifier="related-items"]'],
  hideEntireWatchSidebar: ['#secondary'],
  hideSidebarInfiniteScroll: ['#secondary #contents ytd-continuation-item-renderer'],
  hideExtraSidebarTags: ['yt-chip-cloud-chip-renderer[data-youtube-ui-modifier-hide-chip="true"]'],
  hideEndScreen: ['.html5-endscreen', '.ytp-fullscreen-grid-stills-container'],
  hideInfoCards: ['.ytp-ce-element.ytp-ce-element'],
  hideOverlaySuggestions: ['.ytp-cards-teaser', 'button.ytp-button.ytp-cards-button', 'div.ytp-pause-overlay'],
  hideNextButton: ['a.ytp-next-button'],
  hideVideoActions: ['#menu-container', '#actions', 'ytm-slim-video-action-bar-renderer'],
  hideClipButton: ['#menu button[data-youtube-ui-modifier-clip-button="true"]'],
  hideVideoLikes: ['like-button-view-model .yt-spec-button-shape-next__button-text-content'],
  ...
  hideNonTimestampComments: ['ytd-comment-thread-renderer:not([data-youtube-ui-modifier-timestamp-comment="true"])'],
  ...
  hideCommentUpvotes: ['#vote-count-middle.ytd-comment-action-buttons-renderer'],
  hideSearchSuggestions: ['div.sbdd_a', '.searchbox-dropdown', '.ytSearchboxComponentSuggestionsContainer'],
  hideSearchShorts: [
  ...
  hideSearchInfiniteScroll: ['.ytd-search #contents > ytd-continuation-item-renderer'],
  hideLeftNavigation: ['tp-yt-app-drawer#guide', 'ytd-mini-guide-renderer[role="navigation"]', 'yt-icon-button#guide-button'],
  onlyShowPlaylists: [
  ...
  hideHomeLink: ['a:not(#logo)[href="/"]', 'ytm-pivot-bar-item-renderer:nth-child(1)'],
  hideExploreLink: [
  ...
  hideSubscriptionsSection: ['ytd-guide-section-renderer.style-scope:nth-of-type(2)'],
  hideQuickLinksSection: ['ytd-guide-section-renderer.style-scope:nth-of-type(3)'],
  hideExploreSection: ['ytd-guide-section-renderer.style-scope:nth-of-type(4)'],
  hideMoreFromYoutubeSection: ['ytd-guide-section-renderer.style-scope:nth-of-type(5)'],
  hideSettingsSection: ['ytd-guide-section-renderer.style-scope:nth-of-type(6)'],
  ...
  hideSubscriptionMostRelevant: ['ytd-rich-section-renderer[data-youtube-ui-modifier-most-relevant="true"]'],
